...
//wt wangxu2 add for tHONGMI-163652 of Modem Crash history 2023.03.20 begin
#include <linux/seq_file.h>
#include <linux/proc_fs.h>
//wt wangxu2 add for tHONGMI-163652 of Modem Crash history 2023.03.20 end
...
static void checknv_kobj_create(struct work_struct *work)
{
	...
	if (ret) {
        ...
        pr_info("wangxu start");
	kobject_uevent(checknv_kobj, KOBJ_ADD);
        pr_info("wangxu start success");
	return;
del_kobj:
	kobject_put(checknv_kobj);
	kset_unregister(checknv_kset);
