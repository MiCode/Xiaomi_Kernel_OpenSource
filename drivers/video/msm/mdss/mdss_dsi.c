...
#ifdef CONFIG_PROJECT_TIFFANY
    printk("D2 msm_dss_disable_vreg \n ");
...
#endif
    printk("lcm %s msm_dss_enable_vreg out\n", __func__);
	...
	struct platform_device *pdev, char *panel_cfg)
{
...
#endif
#ifdef CONFIG_PROJECT_TIFFANY
	if (!strcmp(panel_name, "qcom,mdss_dsi_ili7807_fhd_video")) {
	...
	}else if(!strcmp(panel_name, "qcom,mdss_dsi_td4310_fhd_video")){
