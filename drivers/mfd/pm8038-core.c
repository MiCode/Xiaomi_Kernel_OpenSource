...
static const struct resource resources_spk[] = {
	[0] = {
...
static struct mfd_cell spk_cell = {
	.name           = PM8XXX_SPK_DEV_NAME,
	.id             = -1,
...
static int pm8038_probe(struct platform_device *pdev)
{
...
static int pm8038_remove(struct platform_device *pdev)
{
