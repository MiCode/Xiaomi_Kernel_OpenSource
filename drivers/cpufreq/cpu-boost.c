...
#include <trace/events/inputboost.h>
...
static void do_input_boost(struct work_struct *work)
{
	...
	for_each_possible_cpu(i) {
		...
		trace_input_boost(i, i_sync_info->input_boost_min, i_sync_info->input_boost_freq);
	}
...
static void do_powerkey_input_boost(struct work_struct *work)
{
	...
	for_each_possible_cpu(i) {
		...
		trace_input_boost(i, i_sync_info->input_boost_min, i_sync_info->powerkey_input_boost_freq);
	}
