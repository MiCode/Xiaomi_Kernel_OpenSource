...
static int ghsic_data_port_alloc(unsigned int port_num, enum gadget_type gtype)
{
	struct gdata_port	*port;
	struct platform_driver	*pdrv;
	char			*name;
...
int ghsic_data_setup(unsigned int num_ports, enum gadget_type gtype)
{
