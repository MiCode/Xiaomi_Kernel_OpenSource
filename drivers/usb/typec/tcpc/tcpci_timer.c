...
#define TIMEOUT_RANGE(min, max)		((min * 9000 + max * 1000) / 10)
...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SINK_WAIT_CAP, 465, 620),
...
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_CCDEBOUNCE, 100, 150),
