...
/* vendor ID; makes whitelabel devices that
 * many other vendors like 4G Systems, Alcatel, ChinaBird,
 * Mobidata, etc sell under their own brand names.
 */
#define FFFF_VENDOR_ID			0x1c9e
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(FFFF_VENDOR_ID, FOUR_G_SYSTEMS_PRODUCT_W14),
	  .driver_info = NCTRL(0) | NCTRL(1) },
	{ USB_DEVICE(FFFF_VENDOR_ID, FOUR_G_SYSTEMS_PRODUCT_W100),
	  .driver_info = NCTRL(1) | NCTRL(2) | RSVD(3) },
	{USB_DEVICE(FFFF_VENDOR_ID, FUJISOFT_PRODUCT_FS040U),
	 .driver_info = RSVD(3)},
	{ USB_DEVICE_INTERFACE_CLASS(FFFF_VENDOR_ID, SPEEDUP_PRODUCT_SU9800, 0xff) },
	{ USB_DEVICE_INTERFACE_CLASS(FFFF_VENDOR_ID, 0x9801, 0xff),
	  .driver_info = RSVD(3) },
	{ USB_DEVICE_INTERFACE_CLASS(FFFF_VENDOR_ID, 0x9803, 0xff),
	  .driver_info = RSVD(4) },
	{ USB_DEVICE(FFFF_VENDOR_ID, ZOOM_PRODUCT_4597) },
	{ USB_DEVICE(FFFF_VENDOR_ID, IBALL_3_5G_CONNECT) },
