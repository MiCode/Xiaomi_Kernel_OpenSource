		...
		struct dwc3_request *req, int status)
{
	...
	req->trb = NULL;
	trace_dwc3_sprd_gadget_giveback(req);
		...
		u32 param)
{
	...
	trace_dwc3_sprd_gadget_generic_cmd(cmd, param, status);
		...
		struct dwc3_gadget_ep_cmd_params *params)
{
	...
	trace_dwc3_sprd_gadget_ep_cmd(dep, cmd, params, cmd_status);
...
out:
	trace_dwc3_sprd_gadget_ep_enable(dep);
...
static int __dwc3_gadget_ep_disable(struct dwc3_ep *dep)
{
	...
	trace_dwc3_sprd_gadget_ep_disable(dep);
		...
		gfp_t gfp_flags)
{
	...
	trace_dwc3_sprd_alloc_request(req);
		...
		struct usb_request *request)
{
	...
	trace_dwc3_sprd_free_request(req);
	kfree(req);
}
		...
		struct usb_request *request)
{
	...
	trace_dwc3_sprd_ep_dequeue(req);
...
{
	trace_dwc3_sprd_event(event->raw, dwc);
