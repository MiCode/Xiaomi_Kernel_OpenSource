...
extern VibeStatus VibeOSStartTimer(VibeUInt16 intervalMs,
				   VibeOSTimerProc timerProc,
				   VibeOSTimerHandle * pHandle);
...
extern VibeStatus VibeOSAcquireMutexWait(VibeOSMutexHandle hMutex,
					 VibeUInt32 nTimeOutMs);
