...
*/
VibeStatus ImmVibeSPI_ForceOut_SetSamples(VibeUInt8 nActuatorIndex,
...
*/
VibeStatus ImmVibeSPI_ForceOut_SetFrequency(VibeUInt8 nActuatorIndex,
...
*/
VibeStatus ImmVibeSPI_IVTFile_Save(const VibeUInt8 * pIVT, VibeUInt32 nIVTSize,
...
*/
VibeStatus ImmVibeSPI_Device_GetName(VibeUInt8 nActuatorIndex, char *szDevName,
				     int nSize)
{
