...
/* filtering rule is 4B aligned */
#if (IPA_MEM_v3_0_RAM_APPS_V4_FLT_OFST & 3)
#error filtering rule is not 4B aligned
#endif

#define IPA_MEM_v3_0_RAM_APPS_V6_FLT_OFST (IPA_MEM_v3_0_RAM_APPS_V4_FLT_OFST + \
	IPA_MEM_v3_0_RAM_APPS_V4_FLT_SIZE)
#define IPA_MEM_v3_0_RAM_APPS_V6_FLT_SIZE 0

/* filtering rule is 4B aligned */
#if (IPA_MEM_v3_0_RAM_APPS_V6_FLT_OFST & 3)
#error filtering rule is not 4B aligned
#endif

#define IPA_MEM_v3_0_RAM_END_OFST (IPA_MEM_v3_0_RAM_APPS_V6_FLT_OFST + \
	IPA_MEM_v3_0_RAM_APPS_V6_FLT_SIZE + IPA_MEM_CANARY_SIZE)
#define IPA_MEM_v3_0_RAM_APPS_V4_RT_OFST IPA_MEM_v3_0_RAM_END_OFST
#define IPA_MEM_v3_0_RAM_APPS_V4_RT_SIZE 0
#define IPA_MEM_v3_0_RAM_APPS_V6_RT_OFST IPA_MEM_v3_0_RAM_END_OFST
#define IPA_MEM_v3_0_RAM_APPS_V6_RT_SIZE 0
