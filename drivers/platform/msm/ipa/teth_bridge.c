...
int teth_bridge_init(struct teth_bridge_init_params *params)
{
	...
	params->private_data = (void *)IPA_DO_NOT_CONFIGURE_THIS_EP;
...
int teth_bridge_driver_init()
{
	...
	memset(&bridge_prod_params, 0, sizeof(bridge_prod_params));
