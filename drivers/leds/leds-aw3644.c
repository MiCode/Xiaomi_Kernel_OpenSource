/*
* Simple driver for Texas Instruments AW3644 LED Flash driver chip
...
#include <uapi/linux/leds-aw3644.h>
...
static void aw3644_ir_stop_timer(unsigned long data)
{
	struct aw3644_chip_data *chip = (struct aw3644_chip_data *)data;
				  ...
				  const struct i2c_device_id *id)
{
	...
	*/
	...
	setup_timer(&chip->ir_stop_timer, aw3644_ir_stop_timer,
		(unsigned long)chip);
	...
	chip->chr_class = class_create(THIS_MODULE, AW3644_CLASS_NAME);
...
MODULE_DESCRIPTION("Texas Instruments Flash Lighting driver for AW3644");
