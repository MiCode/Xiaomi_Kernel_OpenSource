...
static int force_set_brightness_flag = 0;

int mi_force_set_brightness_flag(int flag)
{
	force_set_brightness_flag = flag;
	return 0;
}
EXPORT_SYMBOL(mi_force_set_brightness_flag);
				...
				int brightness)
{
	...
	{
		if (force_set_brightness_flag == 0)
		{
			return 0;
		}
	}
					  ...
					  enum led_brightness brightness)
{
	...
	{
		if(force_set_brightness_flag == 1)
		{
