...
#define Bre_Imax          0x72   最大电流配置,0x00=omA,0x01=5mA,0x02=10mA,0x03=15mA,
#define Rise_t  0x02   呼吸上升时间,0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s,0x06=8.32s,0x07=16.64s
#define Fall_t   0x02   呼吸下降时间,0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s,0x06=8.32s,0x07=16.64s
#define Hold_time   0x03   呼吸到最亮时的保持时间0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s
#define Off_time      0x03   呼吸到灭时的保持时间0x00=0.13s,0x01=0.26s,0x02=0.52s,0x03=1.04s,0x04=2.08s,0x05=4.16s,0x06=8.32s,0x07=16.64s
#define Delay_time   0x00   呼吸启动后的延迟时间0x00=0s,0x01=0.13s,0x02=0.26s,0x03=0.52s,0x04=1.04s,0x05=2.08s,0x06=4.16s,0x07=8.32s,0x08=16.64s
#define Period_Num  0x00   呼吸次数0x00=无限次,0x01=1次,0x02=2次.....0x0f=15次
#define Imax_R 0x62
#define Imax_G 0x62
#define Imax_B 0x62
...
static int aw2013_has_inited = 0;
...
int aw2013_set_color_multicolor(struct aw2013_dev_data *aw2013, enum led_colors color)
{
	...
	{
		if(aw2013->leds[color].blinking)blink_flag = 0x10;
		aw2013_i2c_write(0x01, 0);
		aw2013_i2c_write(0x0, 0x55);
		mdelay(1);
		if(0 == aw2013_has_inited)
