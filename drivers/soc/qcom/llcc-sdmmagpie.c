...
static struct llcc_slice_config sdmmagpie_data[] =  {
	...
	SCT_ENTRY("modem",       8,  8, 512, 2, 1, 0xF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("modemhw",     9,  9, 512, 2, 1, 0xF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("gpuhtw",     11, 11, 256, 1, 0, 0xF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("gpu",        12, 12, 256, 1, 0, 0xF, 0x0, 0, 0, 0, 1, 0),
