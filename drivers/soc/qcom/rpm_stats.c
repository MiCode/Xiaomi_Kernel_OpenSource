...
/*2019.12.17 add longcheer xiaoxiongfeng "Increase the hibernation info of the rpmh subsystem" start*/
...
/*2019.12.17 add longcheer xiaoxiongfeng "Increase the hibernation info of the rpmh subsystem" end*/
