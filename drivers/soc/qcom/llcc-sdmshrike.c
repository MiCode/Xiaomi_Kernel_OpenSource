...
static struct llcc_slice_config sdmshrike_data[] =  {
	SCT_ENTRY("cpuss",       1, 1, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 1),
	SCT_ENTRY("vidsc0",      2, 2, 512, 2, 1, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("vidsc1",      3, 3, 512, 2, 1, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("rotator",     4, 4, 563, 2, 1, 0xFFF, 0x0, 2, 0, 0, 1, 0),
	SCT_ENTRY("voice",       5, 5, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("audio",       6, 6, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("modemhp_grow", 7, 7, 1024, 2, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("modem",       8, 8, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("compute",     10, 10, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("gpuhtw",      11, 11, 1024, 1, 1, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("gpu",         12, 12, 5120, 1, 1, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("mmuhwt",      13, 13, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 0, 1),
	SCT_ENTRY("compute_dma", 15, 15, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("display",     16, 16, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("videofw",     17, 17, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("modemhp_fix", 20, 20, 1024, 2, 1, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("modem_paging", 21, 21, 1024, 0, 1, 0xF,  0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("audiohw",     22, 22, 1024, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("npu",         23, 23, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("wlan_hw",     24, 24, 6144, 1, 0, 0xFFF, 0x0, 0, 0, 0, 1, 0),
	SCT_ENTRY("pimem",       25, 25, 512, 1, 1, 0xFFF, 0x0, 0, 0, 0, 1, 0),
};
