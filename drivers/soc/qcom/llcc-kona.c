...
static struct llcc_slice_config kona_data[] =  {
	SCT_ENTRY(LLCC_CPUSS,   1, 1024, 1, 0, 0xFFF, 0x0, 0, 0, 0, 0, 1, 1),
	...
	SCT_ENTRY(LLCC_MMUHWT,  13, 512, 1, 1, 0xFFF, 0x0, 0, 0, 0, 0, 0, 1),
