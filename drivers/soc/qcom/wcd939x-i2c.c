...
static int wcd_usbss_probe(struct i2c_client *i2c)
{
	...
	regmap_update_bits(priv->regmap, WCD_USBSS_FSM_OVERRIDE, 0xFF, 0x7F);
	regmap_update_bits(priv->regmap, WCD_USBSS_DP_EN, 0xFF, 0x0C);
	regmap_update_bits(priv->regmap, WCD_USBSS_DN_EN, 0xFF, 0x0C);
