...
static int wcnss_crash_num = 0;
module_param(wcnss_crash_num, int, 0644);

static int a506_zap_crash_num = 0;
module_param(a506_zap_crash_num, int, 0644);
#endif
