...
#define MT6789_TOP_AXI_PROT_EN__MD	(BIT(7))
#define MT6789_TOP_AXI_PROT_EN__VDNR_MD	(BIT(2) | BIT(12) |  \
			BIT(20))
#define MT6789_TOP_AXI_PROT_EN__CONN	(BIT(13) | BIT(18))
#define MT6789_TOP_AXI_PROT_EN__CONN_2ND	(BIT(14))
#define MT6789_TOP_AXI_PROT_EN__1_CONN	(BIT(10))
#define MT6789_TOP_AXI_PROT_EN__1_MFG1	(BIT(21))
#define MT6789_TOP_AXI_PROT_EN__2_MFG1	(BIT(5) | BIT(6))
#define MT6789_TOP_AXI_PROT_EN__MFG1	(BIT(21) | BIT(22))
#define MT6789_TOP_AXI_PROT_EN__2_MFG1_2ND	(BIT(7))
#define MT6789_TOP_AXI_PROT_EN__MM_2_ISP	(BIT(8))
#define MT6789_TOP_AXI_PROT_EN__MM_2_ISP_2ND	(BIT(9))
#define MT6789_TOP_AXI_PROT_EN__MM_IPE	(BIT(16))
#define MT6789_TOP_AXI_PROT_EN__MM_VDEC	(BIT(24))
#define MT6789_TOP_AXI_PROT_EN__MM_VENC	(BIT(26))
#define MT6789_TOP_AXI_PROT_EN__MM_VENC_2ND	(BIT(27))
#define MT6789_TOP_AXI_PROT_EN__MM_DISP	(BIT(10) | BIT(12))
#define MT6789_TOP_AXI_PROT_EN__DISP	(BIT(6) | BIT(23))
#define MT6789_TOP_AXI_PROT_EN__MM_DISP_2ND	(BIT(1) | BIT(3) |  \
			BIT(17) | BIT(25) |  \
			BIT(27))
#define MT6789_TOP_AXI_PROT_EN__MM_2_DISP	(BIT(9))
#define MT6789_TOP_AXI_PROT_EN__2_AUDIO	(BIT(4))
#define MT6789_TOP_AXI_PROT_EN__2_CAM	(BIT(0))
#define MT6789_TOP_AXI_PROT_EN__MM_CAM	(BIT(0) | BIT(2))
#define MT6789_TOP_AXI_PROT_EN__1_CAM	(BIT(22))
#define MT6789_TOP_AXI_PROT_EN__VDNR_CAM	(BIT(19))
