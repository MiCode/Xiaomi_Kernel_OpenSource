	...
	[MT6855_POWER_DOMAIN_ISP_MAIN] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x0C34, 0x0C38, 0x0C30, 0x0C3C,
				MT6855_TOP_AXI_PROT_EN_MMSYS2_ISP_MAIN),
		},
	},
	...
	[MT6855_POWER_DOMAIN_CAM_MAIN] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x0CC4, 0x0CC8, 0x0CC0, 0x0CCC,
				MT6855_TOP_AXI_PROT_EN_DRAMC0_CAM_MAIN),
			BUS_PROT_IGN(IFR_TYPE, 0x0C34, 0x0C38, 0x0C30, 0x0C3C,
				MT6855_TOP_AXI_PROT_EN_MMSYS2_CAM_MAIN),
			BUS_PROT_IGN(IFR_TYPE, 0x0CC4, 0x0CC8, 0x0CC0, 0x0CCC,
				MT6855_TOP_AXI_PROT_EN_DRAMC0_CAM_MAIN_2ND),
		},
	},
...
static const struct scp_subdomain scp_subdomain_mt6855[] = {
	{MT6855_POWER_DOMAIN_ISP_MAIN, MT6855_POWER_DOMAIN_ISP_DIP1},
	{MT6855_POWER_DOMAIN_ISP_MAIN, MT6855_POWER_DOMAIN_ISP_IPE},
	...
	{MT6855_POWER_DOMAIN_CAM_MAIN, MT6855_POWER_DOMAIN_CSI_RX},
};
