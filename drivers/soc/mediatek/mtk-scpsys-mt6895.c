...
static const struct scp_domain_data scp_domain_data_mt6895[] = {
	...
	[MT6895_POWER_DOMAIN_ISP_MAIN] = {
		...
		.child = {MT6895_POWER_DOMAIN_ISP_IPE, MT6895_POWER_DOMAIN_ISP_DIP1},
		.caps = MTK_SCPD_IS_PWR_CON_ON | MTK_SCPD_CHILD_OFF,
	},
	[MT6895_POWER_DOMAIN_ISP_DIP1] = {
		...
		.sram_pdn_bits = GENMASK(8, 8),
		.sram_pdn_ack_bits = GENMASK(12, 12),
		.caps = MTK_SCPD_IS_PWR_CON_ON | MTK_SCPD_BYPASS_CHILD,
	},
