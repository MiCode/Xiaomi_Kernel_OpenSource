...
static const char *panel_name = "panel_name=dsi_k16_38_0e_0b_dsc_vdo";
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	/* FFC Setting OSC 96.3MHz */
	lcm_dcs_write_seq_static(ctx, 0xF1, 0x5A, 0x5A, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x2C, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE0, 0x00, 0x03, 0xC2, 0x07, 0x85, 0x03, 0x39,
				      0x05, 0x6D, 0x05, 0x51, 0x06, 0xC3, 0x12, 0x9E, 0x44);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x38, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE0, 0xF3);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x41, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xE0, 0x13);
	lcm_dcs_write_seq_static(ctx, 0xF1, 0xA5, 0xA5, 0xA5, 0xA5);
	...
	lcm_dcs_write_seq_static(ctx, 0x9E, 0x11, 0x00, 0x00, 0x89, 0x30, 0x80, 0x09, 0x60,
				      0x04, 0x38, 0x00, 0x28, 0x02, 0x1C, 0x02, 0x1C, 0x02,
				      0x00, 0x02, 0x0E, 0x00, 0x20, 0x03, 0xDD, 0x00, 0x07,
				      0x00, 0x0C, 0x02, 0x77, 0x02, 0x8B, 0x18, 0x00, 0x10,
	...
	/* FPS Setting */
	lcm_dcs_write_seq_static(ctx, 0xF1, 0x5A, 0x5A, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx, 0xB0, 0x00, 0x2C, 0xF2, 0x01);
...
{
	int ret;
	char level_key_en[] = {0xF1, 0x5A, 0x5A, 0x5A, 0x5A};
	char level_key_dis[] = {0xF1, 0xA5, 0xA5, 0xA5, 0xA5};
...
static void panel_set_crc_srgb(struct drm_panel *panel)
{
	...
	char crc_srgb[] = {0xB1, 0xBC, 0x09, 0x05, 0x36, 0xE0, 0x13, 0x07, 0x07, 0xAB,
			   0x3C, 0xE5, 0xCC, 0xBF, 0x10, 0xB8, 0xF4, 0xE6, 0x17, 0xFF,
			   0xF7, 0xD6}; /* 0.3127 0.329 sRGB flat */
	char flat_mode_offset[] = {0xB0, 0x00, 0x88, 0xB1, 0x01};
...
static void panel_set_crc_p3_flat(struct drm_panel *panel)
{
	...
	char crc_on[] = {0xB1, 0x00};
	char crc_offset[] = {0xB0, 0x00, 0x01, 0xB1};
	char crc_p3_d65[] = {0xB1, 0xE9, 0x00, 0x00, 0x0B, 0xE8, 0x03, 0x08, 0x08, 0xBD,
			   0x12, 0xED, 0xCF, 0xE8, 0x07, 0xC8, 0xF1, 0xE5, 0x03,0xFF,
			   0xF7, 0xD6}; /* 0.3127 0.329 DCI-P3 flat */
	char flat_mode_offset[] = {0xB0, 0x00, 0x88, 0xB1, 0x01};
	char flat_mode_en[] = {0xB1, 0x27, 0x2D};
