...
bool prox_lcd_reset_keep_high = false;
...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	if (lcd_reset_keep_high) {
		pr_info("[LCM]%s:lcd_reset_keep_high = %d\n",lcd_reset_keep_high);
...
static const struct drm_display_mode mode_60hz = {
	.clock = 146884,//h_total * v_total * fps 60hz
...
static const struct drm_display_mode default_mode = {
	.clock = 146858,//h_total * v_total * fps 90hz
	.hdisplay = FRAME_WIDTH,
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "dsi_panel_c3v_43_02_0a_hd_vdo,lcm", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "dsi_panel_c3v_43_02_0a_hd_vdo",
		.owner = THIS_MODULE,
