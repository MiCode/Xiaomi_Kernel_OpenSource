...
static void lg_panel_init(struct lg_panel *ctx)
{
	...
	lg_dcs_write_seq_static(ctx, 0xC2, 0x83);
	...
	lg_dcs_write_seq_static(ctx, 0xE9, 0x00);
	lg_dcs_write_seq_static(ctx, 0xBD, 0x01);
	lg_dcs_write_seq_static(ctx, 0xE7, 0x00, 0x00, 0x01, 0x20, 0x01, 0x0E,
				0x08, 0xEE, 0x09);
	lg_dcs_write_seq_static(ctx, 0xBD, 0x02);
...
static struct mtk_panel_funcs ext_funcs = {
	.aod = enter_aod, .reset = panel_ext_reset,
};
#endif
...
MODULE_DESCRIPTION("lg 0565g40108 LCD Panel Driver");
