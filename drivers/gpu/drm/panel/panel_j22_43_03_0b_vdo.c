...
static const char *drm_dsi_ext_panel_name = "panel_j22_43_03_0b_vdo";
...
int get_lockdown_info_for_focal(unsigned char* p_lockdown_info) {
	int ret = 0;
	int i = 0;
	char cmd1[] = {0x00, 0x00};
	char cmd2[] = {0xFF, 0x87, 0x19, 0x01};
	char cmd3[] = {0x00, 0x80};
	char cmd4[] = {0xFF, 0x87, 0x19};
	char cmd5[] = {0x00, 0x50};
	u8 tx[10] = {0};
...
EXPORT_SYMBOL(get_lockdown_info_for_focal);
