...
static const char *panel_name = "panel_name=dsi_l83_44_02_0c_cphy_vdo";
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("l83_44_02_0c_cphy_vdo %s +\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "l83_44_02_0c_cphy_vdo,lcm",
		.owner = THIS_MODULE,
...
MODULE_PARM_DESC(WpAndMaxlum, "panel-l83-44-02-0c-cphy-vdo.WpAndMaxlum=<WpAndMaxlum> while <WpAndMaxlum> is 'WpAndMaxlum' ");

module_mipi_dsi_driver(lcm_driver);

MODULE_AUTHOR("Teng Zhang <zhangteng3@xiaomi.com>");
MODULE_DESCRIPTION("L83 44 02 0c chpy vdo lcd panel driver");
