...
bool prox_lcd_reset_keep_high1 = false;
void set_prox_lcd_reset_gpio_keep_high1(bool en)
{
          prox_lcd_reset_keep_high1 = en;
}
EXPORT_SYMBOL(set_prox_lcd_reset_gpio_keep_high1);
...
static struct LCM_setting_table init_setting[] = {
	...
	{0xDE,0x01,{0x43}},
	{0xDF,0x01,{0x02}},
	//Fix eye protection mode flash screen
	{0xFF,0x01,{0x2A}},
	{0xFB,0x01,{0x01}},
	{0xAE,0x01,{0xB2}},
	{0xB0,0x01,{0x86}},
...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	ctx->error = 0;
	ctx->prepared = false;
	if (prox_lcd_reset_keep_high1) {
	pr_info("[LCM]%s:prox_lcd_reset_keep_high1 = %d\n",prox_lcd_reset_keep_high1);
	return 0;
	}
...
static const struct drm_display_mode mode_60hz = {
	.clock = 146567,//h_total * v_total * fps 60hz
...
static const struct drm_display_mode default_mode = {
	.clock = 146592,//h_total * v_total * fps 90hz
	.hdisplay = FRAME_WIDTH,
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "dsi_panel_c3y_43_02_0a_hd_video",
		.owner = THIS_MODULE,
		.of_match_table = lcm_of_match,
	},
};
module_mipi_dsi_driver(lcm_driver);
MODULE_DESCRIPTION("dsi_panel_c3y_43_02_0a_hd_video panel driver");
