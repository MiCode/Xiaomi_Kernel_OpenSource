...
void (*fts_fwresume_work)(void)=NULL;
...
static struct LCM_setting_table init_setting[] = {
	...
	{0X00, 01, {0x80}},
	{0xCA, 12, {0xFA,0xE2,0xCD,0xBF,0xB3,0xA9,0xA0,0x99,0x93,0x8D,0x88,0x84}},
	{0X00, 01, {0x90}},
	{0xCA, 9, {0xFE,0xFF,0x66,0xF6,0xFF,0x66,0xFB,0xFF,0x32}},//cabc gamma code

	{0X00, 01, {0XA0}},
	{0XCA, 03, {0X06,0X06,0X06}},//cabc dimming

	{0x00, 01, {0xB0}},
	{0xCA, 03, {0x00, 0x00, 0x0C}},
	{0x00, 01, {0xB5}},
	{0xCA, 01, {0x04}},
	{0x11, 01, {0x00}},
	{REGFLAG_DELAY, 120, {}},
...
static const struct drm_display_mode mode_60hz = {
	.clock = 146754,//h_total * v_total * fps 60hz
...
static const struct drm_display_mode default_mode = {
	.clock = 146754,//h_total * v_total * fps 90hz
	.hdisplay = FRAME_WIDTH,
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "dsi_panel_c3v_35_03_0b_hd_vdo,lcm", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "dsi_panel_c3v_35_03_0b_hd_vdo",
		.owner = THIS_MODULE,
