...
void cts_set_prox_lcd_reset_gpio_keep_high(bool en)
{
          prox_lcd_reset_keep_high = en;
}
EXPORT_SYMBOL(cts_set_prox_lcd_reset_gpio_keep_high);
...
static struct LCM_setting_table init_setting[] = {
    ...
    {0xC1, 12,{0x10,0x20,0x20,0x36,0x04,0x30,0x30,0x04,0x72,0x06,0x22,0x70}},
    {0xC2, 2,{0x80,0x45}},
    {0xC4,10,{0x04,0x33,0xB8,0x49,0x00,0xBC,0x00,0xA0,0x00,0x09}},
    {0xD0, 5,{0x0C,0x23,0x18,0x00,0x00}},
    {0x35, 2,{0x00,0x00}},
    {0x53, 2,{0x2c,0x00}},
    {0x11, 2,{0x00,0x00}},
    {REGFLAG_DELAY, 100,{}},
...
static struct LCM_setting_table lcm_suspend_setting_before[] = {
    {0x6D, 2,{0x25,0x00}},
};
...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	pr_err("%s start lcm_unprepare\n", __func__);

        push_table(ctx, lcm_suspend_setting_before,
	sizeof(lcm_suspend_setting_before) / sizeof(struct LCM_setting_table));
...
static const struct drm_display_mode mode_60hz = {
	.clock = 146945,//h_total * v_total * fps 60hz
...
static const struct drm_display_mode default_mode = {
	.clock = 146945,//h_total * v_total * fps 90hz
	.hdisplay = FRAME_WIDTH,
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "dsi_panel_c3y_42_0f_0c_hd_video",
		.owner = THIS_MODULE,
		.of_match_table = lcm_of_match,
	},
};
module_mipi_dsi_driver(lcm_driver);
MODULE_DESCRIPTION("dsi_panel_c3y_42_0f_0c_hd_video panel driver");
