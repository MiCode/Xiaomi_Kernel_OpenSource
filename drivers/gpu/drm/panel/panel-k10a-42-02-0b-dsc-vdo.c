...
static char *panel_name = "panel_name=dsi_k10a_42_02_0b_dsc_vdo";
...
static int lcm_setbacklight_i2c(unsigned int level)
{
	bl_tb0[1] = (level >> 8) & 0x7;
	bl_tb0[2] = level & 0xFF;
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s- k10a 42 02 0b dsc vdo panel\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.driver = {
			...
			.name = "k10a_42_02_0b_dsc_vdo,lcm",
			.owner = THIS_MODULE,
