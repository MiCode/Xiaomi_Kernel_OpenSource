...
static const char *panel_name = "panel_name=dsi_panel_k7s_38_0c_0b_video";
...
//	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
	...
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x20); //elvss dim on
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA5);
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "dsi_panel_k7s_38_0c_0b_video",
	},
	{} };
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "dsi_panel_k7s_38_0c_0b_video",
		.owner = THIS_MODULE,
