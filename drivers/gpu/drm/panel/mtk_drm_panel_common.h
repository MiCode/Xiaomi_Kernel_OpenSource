...
#else
__weak int mtk_drm_gateic_set_backlight(unsigned int level, char func)
{
	return 0;
};

__weak int mtk_drm_gateic_enable_backlight(char func)
{
	return 0;
};
__weak int mtk_drm_gateic_power_on(char func)
{
	return 0;
};

__weak int mtk_drm_gateic_power_off(char func)
{
	return 0;
};
#endif
