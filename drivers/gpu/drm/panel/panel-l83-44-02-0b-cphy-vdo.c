...
static const char *panel_name = "panel_name=dsi_l83_44_02_0b_cphy_vdo";

#define MAX_CMDLINE_PARAM_LEN 64
static char led_wp_info_str[64] = {0};
struct lcm *ctx_panel;

extern int ktz8866_bl_bias_conf_44(void);
...
static struct LCM_setting_table lcm_init_setting[] = {
	...
	{0xBB,01,{0x13}},
	{0x35,01,{0x00}},
	{0x3B,05,{0x03,0x0C,0x1A,0x04,0x04}},
			...
			struct drm_connector *connector, unsigned int mode)
{
	...
	if (!ret){
		...
		mi_disp_feature_event_notify_by_type(mi_get_disp_id("primary"),
				MI_DISP_EVENT_FPS, sizeof(blank), blank);
#endif
	}
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("l83_44_02_0b_cphy_vdo %s +\n", __func__);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "l83_44_02_0b_cphy_vdo,lcm",
		.owner = THIS_MODULE,
...
MODULE_PARM_DESC(WpAndMaxlum, "panel-l83-44-02-0b-cphy-vdo.WpAndMaxlum=<WpAndMaxlum> while <WpAndMaxlum> is 'WpAndMaxlum' ");

module_mipi_dsi_driver(lcm_driver);

MODULE_AUTHOR("Teng Zhang <zhangteng3@xiaomi.com>");
MODULE_DESCRIPTION("L83 44 02 0b chpy vdo lcd panel driver");
