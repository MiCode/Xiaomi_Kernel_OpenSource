                     ...
                     s32 *inTileEnd)
{
    ...
    if (startTemp < (s32)(1 * precision))
    {
        *inTileStart = 0;
    }
    else
    {
        startTemp = (s32)(startTemp / precision) - 1;
        if ((0 == (startTemp & 0x1)) || (1 == inAlignment))
        {
    ...
    else
    {
        ...
        endTemp = (s32)((endTemp) / precision);
        if ((1 == (endTemp & 0x1)) || (1 == inAlignment))
        {
                    ...
                    s32 *chromaSubpixel)
{
    ...
    else
    {
        ...
        if ((0 == (outTemp & 0x1)) || (1 == outAlignment))
        {
    ...
    else
    {
        ...
        if ((1 == (outTemp & 0x1)) || (1 == outAlignment))
        {
            *outTileEnd = outTemp;
        }
        else
    ...
    subTemp = (s64)offsetCalStart * coeffStep + (s64)cropOffset * precision + cropSubpixel - (s64)inTileStart * precision; //Holmes

    *lumaOffset   = subTemp / precision;
    *lumaSubpixel = subTemp - precision * (*lumaOffset);

    if (1 == outAlignment)  /* YUV444 */
    {
    ...
    if ((1 == outAlignment) || (0 == ((*lumaOffset) & 0x1)))  /* YUV444 */
    {
                     ...
                     s32 *inTileEnd)
{
    ...
    {
#if TILE_SCALER_NEGATIVE_OFFSET
        startTemp = (s32)(startTemp / precision) - 3;
#else
        startTemp = (s32)(startTemp / precision) - 2;
#endif
        if ((0 == (startTemp & 0x1)) || (1 == inAlignment))
        {
            *inTileStart = (s32)startTemp;
                    ...
                    s32 *chromaSubpixel)
{
    ...
    else
    {
        ...
        outTemp = (int)(startTemp / coeffStep);
        if (((s64)outTemp * coeffStep) < startTemp)  /* ceiling be careful with value smaller than zero */
        {
            outTemp = outTemp + 1;
        }
                      ...
                      s32 *inTileEnd)
{
    ...
    else
    {
        ...
        if (((s64)inTemp * 2 * coeffStep) == (2 * endTemp + coeffStep + precision))
        {
            inTemp = inTemp - 1;
        }

        if ((1 == (inTemp & 0x1)) || (1 == inAlignment))
        {
            *inTileEnd = inTemp;
        }
        else
                     ...
                     s32 *chromaSubpixel)
{
    ...
    {
        startTemp = (s64)inTileStart * coeffStep - (((unsigned int)coeffStep) >> 1) - (s64)cropOffset * coeffStep - cropSubpixel;
    ...
    {
        endTemp = (s64)inTileEnd * coeffStep + (((unsigned int)coeffStep) >> 1) - (s64)cropOffset * coeffStep - cropSubpixel;
                      ...
                      s32 *inTileEnd)
{
...
#endif
        if ((0 == (outTemp & 0x1)) || (1 == inAlignment))
        {
            *inTileStart = outTemp;
        }
        else  /* not even */
    ...
    else
    {
        ...
        if ((1 == (outTemp & 0x1)) || (1 == inAlignment))
        {
            *inTileEnd = outTemp;
        }
        else  /* not odd */
