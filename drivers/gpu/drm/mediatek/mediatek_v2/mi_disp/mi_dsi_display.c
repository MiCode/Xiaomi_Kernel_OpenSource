...
extern void is_brightness_clone_level_zero(bool is_zero);
...
int mi_dsi_display_set_doze_brightness(void *display, int doze_brightness)
{
	...
	dsi_display->mi_cfg.user_doze_brightness = doze_brightness;
			...
			u32 brightness_clone)
{
	...
	is_brightness_clone_level_zero(brightness_clone == 0);
