...
EXPORT_SYMBOL(dsi_panel_state_count);
...
EXPORT_SYMBOL(dsi_panel_HBM_count);
...
EXPORT_SYMBOL(dsi_panel_backlight_count);
...
EXPORT_SYMBOL(dsi_panel_fps_count);
...
EXPORT_SYMBOL(dsi_panel_count_init);
