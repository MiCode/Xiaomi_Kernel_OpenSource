...
int mi_disp_panel_ddic_send_cmd(struct LCM_setting_table *table, unsigned int count, bool wait_te_send, bool block);
int mi_disp_panel_ddic_send_cmd_with_speed(struct LCM_setting_table *table,
	unsigned int count, bool wait_te_send, bool block, int speed);
