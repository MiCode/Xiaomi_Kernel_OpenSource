...
struct MIPI_TX_PLL_PWR_REG {
	unsigned BDG_AD_DSI_PLL_SDM_PWR_ON : 1;
	unsigned BDG_AD_DSI_PLL_SDM_ISO_EN : 1;
	unsigned RSV_02 : 30;
};
...
struct MIPI_TX_PLL_CON1_REG {
	unsigned BDG_RG_DSI_PLL_SDM_PCW_CHG : 1;
	unsigned RSV_01 : 3;
	unsigned BDG_RG_DSI_PLL_EN : 1;
	unsigned RSV_05 : 3;
...
struct MIPI_TX_PLL_CON2_REG {
	...
	unsigned BDG_RG_DSI_PLL_SDM_SSC_EN : 1;
	unsigned RSV_02 : 14;
