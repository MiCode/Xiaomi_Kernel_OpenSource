...
#define MT6885_MUTEX_SOF_DSI1 2
#define MT6885_MUTEX_SOF_DPI0 3
#define MT6885_MUTEX_EOF_DSI0 (MT6885_MUTEX_SOF_DSI0 << 6)
#define MT6885_MUTEX_EOF_DSI1 (MT6885_MUTEX_SOF_DSI1 << 6)
...
#define MT6983_MMSYS_OVL_CON	0xF08
	...
	#define DISP_OVL1_2L_TO_DISP_OVL1_2L_BLENDOUT_MOUT				BIT(4)
	#define DISP_OVL0_2L_TO_DISP_OVL1_2L_BLENDOUT_MOUT				BIT(4)
	#define DISP_OVL1_2L_TO_DISP_OVL0						BIT(5)
	#define DISP_OVL0_2L_TO_DISP_OVL0						BIT(5)
	#define DISP_OVL0_2L_NWCG_TO_DISP_OVL0_2L_NWCG_BLEND_MOUT		BIT(6)
	#define DISP_OVL1_2L_NWCG_TO_DISP_WDMA1					BIT(8)
	#define DISP_OVL1_2L_NWCG_TO_DISP_OVL0_2L_NWCG					BIT(9)
	#define DISP_OVL0_2L_TO_DISP_OVL0_2L_BLEND_MOUT			BIT(4)
#define MT6983_DISP_OVL0_UFDO_SEL_IN 0xF0C
	#define DISP_OVL0_UFDO_SEL_IN_FROM_DISP_RSZ0_MAIN_OVL_SOUT_SEL	0x0
#define MT6983_DISP_OVL0_PQ_SEL_IN 0xF10
	#define DISP_OVL0_PQ_SEL_IN_FROM_DISP_RSZ0_MAIN_OVL_SOUT_SEL	0x1
#define MT6983_DISP_RSZ0_SEL_IN 0xF24
	#define DISP_RSZ0_SEL_IN_FROM_DISP_OVL1_2L_BLEND_MOUT_EN	0x1
	#define DISP_RSZ0_SEL_IN_FROM_DISP_OVL1_2L      0x4
...
#define MT6983_DISP_RDMA0_POS_SEL_IN	0xF40
	#define DISP_RDMA0_POS_SEL_IN_FROM_DISP_RDMA0_SOUT_SEL	0x1
#define MT6983_DISP_RDMA1_SEL_IN	0xF58
	#define DISP_RDMA1_SEL_IN_FROM_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN	0x1
#define MT6983_DISP_RDMA1_POS_SEL_IN	0xF5C
	#define DISP_RDMA1_POS_SEL_IN_FROM_DISP_RDMA1_SOUT_SEL	0x1
...
#define MT6983_DISP_OVL0_BLEND_MOUT_EN	0xFCC
	#define DISP_OVL0_BLEND_MOUT_EN_TO_DISP_MAIN_OVL_DISP_WDMA_SEL	BIT(2)
	#define DISP_OVL0_BLEND_MOUT_EN_TO_DISP_MAIN_OVL_DISP_PQ_SEL	BIT(4)
#define	MT6983_DISP_OVL1_2L_BLEND_MOUT_EN 0xFD4
	#define DISP_OVL1_2L_BLEND_MOUT_EN_TO_DISP_RSZ0_SEL_IN	BIT(0)
#define	MT6983_DISP_RSZ0_MOUT_EN 0xFD8
	#define DISP_RSZ0_MOUT_EN_TO_DISP_RSZ0_MAIN_OVL_SOUT_SEL BIT(0)
	#define DISP_RSZ0_MOUT_EN_TO_DISP_MAIN_OVL_DMDP_SEL BIT(1)
#define MT6983_DISP_RDMA0_POS_MOUT_EN	0xFDC
	#define DISP_RDMA0_POS_MOUT_EN_TO_DISP_RDMA0_SEL        BIT(1)
	#define DISP_RDMA0_POS_MOUT_EN_TO_DISP_CHIST0_SEL_IN    BIT(2)
	#define DISP_RDMA0_POS_MOUT_EN_TO_DISP_CHIST1_SEL_IN    BIT(3)

#define MT6983_DISP_C3D0_SEL_IN	0xF44
	#define DISP_C3D0_SEL_IN_FROM_DISP_CCORR1_SOUT_SEL	0x1

#define MT6983_DISP_COLOR0_SEL_IN	0xF48
	#define DISP_COLOR0_SEL_IN_FROM_DISP_TDSHP0_SOUT_SEL	0x1
...
#define MT6983_DISP_RSZ0_MAIN_OVL_SOUT_SEL 0xF8C
	#define DISP_RSZ0_MAIN_OVL_SOUT_SEL_TO_DISP_OVL0_UFOD_SEL_IN 0x2
	#define DISP_RSZ0_MAIN_OVL_SOUT_SEL_TO_DISP_OVL0_PQ_SEL_IN 0x5
...
#define MT6983_DISP_CCORR1_SOUT_SEL	0xFA4
	#define DISP_CCORR1_SOUT_SEL_TO_DISP_C3D0_SEL_IN	0x1

#define MT6983_DISP_RDMA1_SOUT_SEL	0xFA8
	#define DISP_RDMA1_SOUT_SEL_TO_DISP_RDMA1_OUT_RELAY		0x0
	#define DISP_RDMA1_SOUT_SEL_TO_DISP_RDMA1_POS_SEL_IN	0x1
...
#define MT6983_DISP_SUB0_SOUT_SEL	0xFC0
...
#define MT6983_DISP_POSTMASK0_MOUT_EN	0xFE0
	#define DISP_POSTMASK0_MOUT_EN_TO_DISP_DITHER0			BIT(0)
	#define DISP_POSTMASK0_MOUT_EN_TO_DISP_CHIST0_SEL_IN		BIT(1)
	#define DISP_POSTMASK0_MOUT_EN_TO_DISP_CHIST1_SEL_IN		BIT(2)

#define MT6983_DISP_DITHER0_MOUT_EN	0xFE4
	#define DISP_DITHER0_MOUT_EN_TO_DISP_CM0			BIT(0)
	#define DISP_DITHER0_MOUT_EN_TO_DISP_CHIST0_SEL_IN		BIT(1)
	#define DISP_DITHER0_MOUT_EN_TO_DISP_CHIST1_SEL_IN		BIT(2)

#define MT6983_DISP_SPR0_MOUT_EN	0xFE8
	#define DISP_SPR0_MOUT_EN_TO_DISP_WDMA0_SEL_IN			BIT(0)
	#define DISP_SPR0_MOUT_EN_TO_DISP_UFBC_WDMA0_SEL_IN		BIT(1)
	#define DISP_SPR0_MOUT_EN_TO_DISP_PQ0_SOUT_SEL			BIT(2)

#define MT6983_DISP_OVL0_2L_NWCG_MOUT_EN	0xFEC
	#define DISP_OVL0_2L_NWCG_MOUT_EN_TO_DISP_RDMA1_POS_SEL_IN	BIT(0)
	#define DISP_OVL0_2L_NWCG_MOUT_EN_TO_DISP_RDMA1_SEL_IN		BIT(1)
...
#define MT6983_DISP_MERGE0_MOUT_EN 0xFF0
	#define DISP_MERGE0_MOUT_EN_TO_DISP_MAIN0_SEL_IN BIT(1)
...
#define MT6983_DISP_CHIST0_SEL_IN	0xF50
	...
	#define DISP_CHIST0_SEL_IN_FROM_DISP_POSTMASK0_MOUT_EN	0x1
	#define DISP_CHIST0_SEL_IN_FROM_DISP_DITHER0_MOUT_EN	0x2

#define MT6983_DISP_CHIST1_SEL_IN	0xF54
	#define DISP_CHIST1_SEL_IN_FROM_DISP_RDMA0_POS_MOUT_EN	0x0
...
#define MT6983_DISP_Y2R0_MOUT_EN	0xFC8
	#define DISP_Y2R0_MOUT_TO_DMDP_MAIN_OVL_SOUT BIT(0)
#define MT6983_DMDP_MAIN_OVL_SOUT_SEL	0xF90
	#define DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SOUT 0x2
	#define DMDP_MAIN_OVL_SOUT_TO_DISP_OVL1_2L_PQ_SEL_SOUT 0x4
	#define DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_PQ_SEL_SOUT 0x5
#define MT6983_DISP_MAIN_OVL_DMDP_SEL_IN 0xF28
	#define DISP_RSZ0_MOUT_TO_DISP_MAIN_OVL_DMDP_SEL 0x0
	#define DISP_OVL0_2L_BLEND_MOUT_TO_DISP_MAIN_OVL_DMDP_SEL 0x2
#define MT6983_DISP_OVL0_PQ_SEL_IN 0xF10
	#define DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_PQ_SEL_SIN 0x1
#define MT6983_DISP_OVL0_UFOD_SEL_IN 0xF0C
	#define DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SIN 0x1
#define MT6983_DISP_MAIN_OVL_DISP_WDMA_SEL_IN 0xF2C
	#define DISP_OVL0_BLEND_MOUT_TO_DISP_MAIN_OVL_DISP_WDMA_SEL_IN 0x3

#define MT6983_DISP_OVL1_2L_PQ_SEL_IN 0xF20
	#define DMDP_MAIN_OVL_SOUT_TO_DISP_OVL1_2L_PQ_SEL 0x0
...
#define MT6983_MUTEX_MOD1_INLINEROT0 (BIT(0) | BIT(31))
#define MT6983_MUTEX_MOD1_DLI_ASYNC0 (BIT(1) | BIT(31))
#define MT6983_MUTEX_MOD1_DLI_ASYNC1 (BIT(2) | BIT(31))
#define MT6983_MUTEX_MOD1_DLI_ASYNC2 (BIT(3) | BIT(31))
#define MT6983_MUTEX_MOD1_DLI_ASYNC3 (BIT(4) | BIT(31))
#define MT6983_MUTEX_MOD1_DLO_ASYNC0 (BIT(5) | BIT(31))
#define MT6983_MUTEX_MOD1_DLO_ASYNC1 (BIT(6) | BIT(31))
#define MT6983_MUTEX_MOD1_DLO_ASYNC2 (BIT(7) | BIT(31))
...
#define MT6985_OVLSYS_OVL_CON					0xF08
	...
	#define DISP_OVL0_2L_TO_BG_CROSSBAR0	BIT(1)
	#define DISP_OVL1_2L_TO_BLEND_CROSSBAR1	BIT(2)
	#define DISP_OVL1_2L_TO_BG_CROSSBAR1	BIT(3)
	#define DISP_OVL2_2L_TO_BLEND_CROSSBAR2	BIT(4)
	#define DISP_OVL2_2L_TO_BG_CROSSBAR2	BIT(5)
	#define DISP_OVL3_2L_TO_BLEND_CROSSBAR3	BIT(6)
	#define DISP_OVL3_2L_TO_BG_CROSSBAR3	BIT(7)
#define MT6985_OVLSYS_CROSSBAR_CON	0xF0C
#define MT6985_OVL_BG_CROSSBAR0_MOUT_EN 0xF10
	#define DISP_OVL0_2L_TO_OVL0_2L		BIT(0)
	#define DISP_OVL0_2L_TO_OVL1_2L		BIT(1)
	#define DISP_OVL0_2L_TO_OVL2_2L		BIT(2)
	#define DISP_OVL0_2L_TO_OVL3_2L		BIT(3)
	#define DISP_OVL0_2L_TO_DLO_RELAY1	BIT(4)

#define MT6985_OVL_BG_CROSSBAR1_MOUT_EN 0xF14
	#define DISP_OVL1_2L_TO_OVL0_2L		BIT(0)
	#define DISP_OVL1_2L_TO_OVL1_2L		BIT(1)
	#define DISP_OVL1_2L_TO_OVL2_2L		BIT(2)
	#define DISP_OVL1_2L_TO_OVL3_2L		BIT(3)
	#define DISP_OVL1_2L_TO_DLO_RELAY1	BIT(4)

#define MT6985_OVL_BG_CROSSBAR2_MOUT_EN 0xF18
	#define DISP_OVL2_2L_TO_OVL0_2L		BIT(0)
	#define DISP_OVL2_2L_TO_OVL1_2L		BIT(1)
	#define DISP_OVL2_2L_TO_OVL2_2L		BIT(2)
	#define DISP_OVL2_2L_TO_OVL3_2L		BIT(3)
	#define DISP_OVL2_2L_TO_DLO_RELAY1	BIT(4)

#define MT6985_OVL_BG_CROSSBAR3_MOUT_EN 0xF1C
	#define DISP_OVL3_2L_TO_OVL0_2L		BIT(0)
	#define DISP_OVL3_2L_TO_OVL1_2L		BIT(1)
	#define DISP_OVL3_2L_TO_OVL2_2L		BIT(2)
	#define DISP_OVL3_2L_TO_OVL3_2L		BIT(3)
	#define DISP_OVL3_2L_TO_DLO_RELAY1	BIT(4)

#define MT6985_OVL_BG_CROSSBAR4_MOUT_EN 0xF20
	#define DISP_DLI_RELAY2_TO_OVL0_2L		BIT(0)
	#define DISP_DLI_RELAY2_TO_OVL1_2L		BIT(1)
	#define DISP_DLI_RELAY2_TO_OVL2_2L		BIT(2)
	#define DISP_DLI_RELAY2_TO_OVL3_2L		BIT(3)
	#define DISP_DLI_RELAY2_TO_DLO_RELAY1	BIT(4)

#define MT6985_OVL_BLEND_CROSSBAR0_MOUT_EN 0xF38
	#define DISP_OVL0_2L_TO_DLO_RELAY3	BIT(0)
	#define DISP_OVL0_2L_TO_DLO_RELAY4	BIT(1)
	#define DISP_OVL0_2L_TO_DLO_RELAY5	BIT(2)
	#define DISP_OVL0_2L_TO_WDMA2		BIT(3)
	#define DISP_OVL0_2L_TO_WDMA0		BIT(4)
	#define DISP_OVL0_2L_TO_UFBC_WDMA0	BIT(5)
	#define DISP_OVL0_2L_TO_DLO_RELAY6	BIT(6)

#define MT6985_OVL_BLEND_CROSSBAR1_MOUT_EN 0xF3C
	#define DISP_OVL1_2L_TO_DLO_RELAY3	BIT(0)
	#define DISP_OVL1_2L_TO_DLO_RELAY4	BIT(1)
	#define DISP_OVL1_2L_TO_DLO_RELAY5	BIT(2)
	#define DISP_OVL1_2L_TO_WDMA2		BIT(3)
	#define DISP_OVL1_2L_TO_WDMA0		BIT(4)
	#define DISP_OVL1_2L_TO_UFBC_WDMA0	BIT(5)
	#define DISP_OVL1_2L_TO_DLO_RELAY6	BIT(6)

#define MT6985_OVL_BLEND_CROSSBAR2_MOUT_EN 0xF40
	#define DISP_OVL2_2L_TO_DLO_RELAY3	BIT(0)
	#define DISP_OVL2_2L_TO_DLO_RELAY4	BIT(1)
	#define DISP_OVL2_2L_TO_DLO_RELAY5	BIT(2)
	#define DISP_OVL2_2L_TO_WDMA2		BIT(3)
	#define DISP_OVL2_2L_TO_WDMA0		BIT(4)
	#define DISP_OVL2_2L_TO_UFBC_WDMA0	BIT(5)
	#define DISP_OVL2_2L_TO_DLO_RELAY6	BIT(6)

#define MT6985_OVL_BLEND_CROSSBAR3_MOUT_EN 0xF44
	#define DISP_OVL3_2L_TO_DLO_RELAY3	BIT(0)
	#define DISP_OVL3_2L_TO_DLO_RELAY4	BIT(1)
	#define DISP_OVL3_2L_TO_DLO_RELAY5	BIT(2)
	#define DISP_OVL3_2L_TO_WDMA2		BIT(3)
	#define DISP_OVL3_2L_TO_WDMA0		BIT(4)
	#define DISP_OVL3_2L_TO_UFBC_WDMA0	BIT(5)
	#define DISP_OVL3_2L_TO_DLO_RELAY6	BIT(6)

#define MT6985_OVL_PQ_IN_CROSSBAR0_MOUT_EN 0xF64
	#define DISP_Y2R0_TO_PQ_OVL0_2L		BIT(0)
	#define DISP_Y2R0_TO_PQ_OVL1_2L		BIT(1)
	#define DISP_Y2R0_TO_PQ_OVL2_2L		BIT(2)
	#define DISP_Y2R0_TO_PQ_OVL3_2L		BIT(3)
	#define DISP_Y2R0_TO_UFOD_OVL0_2L	BIT(4)
	#define DISP_Y2R0_TO_UFOD_OVL1_2L	BIT(5)
	#define DISP_Y2R0_TO_UFOD_OVL2_2L	BIT(6)
	#define DISP_Y2R0_TO_UFOD_OVL3_2L	BIT(7)

#define MT6985_OVL_PQ_IN_CROSSBAR1_MOUT_EN 0xF68
	#define DISP_Y2R1_TO_PQ_OVL0_2L		BIT(0)
	#define DISP_Y2R1_TO_PQ_OVL1_2L		BIT(1)
	#define DISP_Y2R1_TO_PQ_OVL2_2L		BIT(2)
	#define DISP_Y2R1_TO_PQ_OVL3_2L		BIT(3)
	#define DISP_Y2R1_TO_UFOD_OVL0_2L	BIT(4)
	#define DISP_Y2R1_TO_UFOD_OVL1_2L	BIT(5)
	#define DISP_Y2R1_TO_UFOD_OVL2_2L	BIT(6)
	#define DISP_Y2R1_TO_UFOD_OVL3_2L	BIT(7)

#define MT6985_OVL_PQ_IN_CROSSBAR2_MOUT_EN 0xF6C
	#define DISP_RSZ1_TO_PQ_OVL0_2L		BIT(0)
	#define DISP_RSZ1_TO_PQ_OVL1_2L		BIT(1)
	#define DISP_RSZ1_TO_PQ_OVL2_2L		BIT(2)
	#define DISP_RSZ1_TO_PQ_OVL3_2L		BIT(3)
	#define DISP_RSZ1_TO_UFOD_OVL0_2L	BIT(4)
	#define DISP_RSZ1_TO_UFOD_OVL1_2L	BIT(5)
	#define DISP_RSZ1_TO_UFOD_OVL2_2L	BIT(6)
	#define DISP_RSZ1_TO_UFOD_OVL3_2L	BIT(7)

#define MT6985_OVL_PQ_OUT_CROSSBAR0_MOUT_EN 0xF90
	#define DISP_OVL0_2L_TO_DLO_RELAY0	BIT(0)
	#define DISP_OVL0_2L_TO_DLO_RELAY2	BIT(1)
	#define DISP_OVL0_2L_TO_RSZ1		BIT(2)

#define MT6985_OVL_PQ_OUT_CROSSBAR1_MOUT_EN 0xF94
	#define DISP_OVL1_2L_TO_DLO_RELAY0	BIT(0)
	#define DISP_OVL1_2L_TO_DLO_RELAY2	BIT(1)
	#define DISP_OVL1_2L_TO_RSZ1		BIT(2)

#define MT6985_OVL_PQ_OUT_CROSSBAR2_MOUT_EN 0xF98
	#define DISP_OVL2_2L_TO_DLO_RELAY0	BIT(0)
	#define DISP_OVL2_2L_TO_DLO_RELAY2	BIT(1)
	#define DISP_OVL2_2L_TO_RSZ1		BIT(2)

#define MT6985_OVL_PQ_OUT_CROSSBAR3_MOUT_EN 0xF9C
	#define DISP_OVL3_2L_TO_DLO_RELAY0	BIT(0)
	#define DISP_OVL3_2L_TO_DLO_RELAY2	BIT(1)
	#define DISP_OVL3_2L_TO_RSZ1		BIT(2)

#define MT6985_PQ_PATH_SEL          0x34
	#define PQ_FAST_PATH_DISABLE        0
	#define PQ_FAST_PATH1               1
	#define PQ_FAST_PATH2               2
	#define PQ_FAST_PATH3               3
	#define PQ_FAST_PATH4               4
	#define PQ_FAST_PATH5               5
	#define PQ_FAST_PATH6               6
...
#define MT6985_COMP_OUT_CROSSBAR0_MOUT_EN 0xea0
	...
	#define DISP_VDCM0_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_VDCM0_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_VDCM0_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_VDCM0_TO_MERGE0_0				BIT(4)
	#define DISP_VDCM0_TO_MERGE0_1				BIT(5)
	#define DISP_VDCM0_TO_MERGE1_0				BIT(6)
	#define DISP_VDCM0_TO_MERGE1_1				BIT(7)

#define MT6985_COMP_OUT_CROSSBAR1_MOUT_EN 0xea4
	#define DISP_DSC_0_TO_MERGE_OUT_CROSSBAR0	BIT(0)
	#define DISP_DSC_0_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_DSC_0_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_DSC_0_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_DSC_0_TO_MERGE0_0				BIT(4)
	#define DISP_DSC_0_TO_MERGE0_1				BIT(5)
	#define DISP_DSC_0_TO_MERGE1_0				BIT(6)
	#define DISP_DSC_0_TO_MERGE1_1				BIT(7)

#define MT6985_COMP_OUT_CROSSBAR2_MOUT_EN 0xea8
	#define DISP_DSC_1_TO_MERGE_OUT_CROSSBAR0	BIT(0)
	#define DISP_DSC_1_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_DSC_1_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_DSC_1_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_DSC_1_TO_MERGE0_0				BIT(4)
	#define DISP_DSC_1_TO_MERGE0_1				BIT(5)
	#define DISP_DSC_1_TO_MERGE1_0				BIT(6)
	#define DISP_DSC_1_TO_MERGE1_1				BIT(7)

#define MT6985_COMP_OUT_CROSSBAR3_MOUT_EN 0xeac
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE_OUT_CROSSBAR0	BIT(0)
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE0_0				BIT(4)
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE0_1				BIT(5)
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE1_0				BIT(6)
	#define DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE1_1				BIT(7)

#define MT6985_COMP_OUT_CROSSBAR4_MOUT_EN 0xeb0
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE_OUT_CROSSBAR0	BIT(0)
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE0_0				BIT(4)
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE0_1				BIT(5)
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE1_0				BIT(6)
	#define DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE1_1				BIT(7)

#define MT6985_COMP_OUT_CROSSBAR5_MOUT_EN 0xeb4
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE_OUT_CROSSBAR0	BIT(0)
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE0_0				BIT(4)
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE0_1				BIT(5)
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE1_0				BIT(6)
	#define DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE1_1				BIT(7)

#define MT6985_COMP_OUT_CROSSBAR6_MOUT_EN 0xeb8
	#define DISP_DLI_RELAY5_TO_MERGE_OUT_CROSSBAR0	BIT(0)
	#define DISP_DLI_RELAY5_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_DLI_RELAY5_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_DLI_RELAY5_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_DLI_RELAY5_TO_MERGE0_0				BIT(4)
	#define DISP_DLI_RELAY5_TO_MERGE0_1				BIT(5)
	#define DISP_DLI_RELAY5_TO_MERGE1_0				BIT(6)
	#define DISP_DLI_RELAY5_TO_MERGE1_1				BIT(7)

#define MT6985_COMP_OUT_CROSSBAR7_MOUT_EN 0xebc
	#define DISP_RELAY0_TO_MERGE_OUT_CROSSBAR0	BIT(0)
	#define DISP_RELAY0_TO_MERGE_OUT_CROSSBAR1	BIT(1)
	#define DISP_RELAY0_TO_MERGE_OUT_CROSSBAR2	BIT(2)
	#define DISP_RELAY0_TO_MERGE_OUT_CROSSBAR3	BIT(3)
	#define DISP_RELAY0_TO_MERGE0_0				BIT(4)
	#define DISP_RELAY0_TO_MERGE0_1				BIT(5)
	#define DISP_RELAY0_TO_MERGE1_0				BIT(6)
	#define DISP_RELAY0_TO_MERGE1_1				BIT(7)

#define MT6985_MERGE_OUT_CROSSBAR0_MOUT_EN 0xf0c
	#define DISP_COMP_OUT_CROSSBAR0_TO_DSI0			BIT(0)
	#define DISP_COMP_OUT_CROSSBAR0_TO_INTF0		BIT(1)
	#define DISP_COMP_OUT_CROSSBAR0_TO_WDMA1		BIT(2)
	#define DISP_COMP_OUT_CROSSBAR0_TO_UFBC_WDMA1	BIT(3)
	#define DISP_COMP_OUT_CROSSBAR0_TO_DLO_RELAY0	BIT(4)
	#define DISP_COMP_OUT_CROSSBAR0_TO_DLO_RELAY1	BIT(5)
	#define DISP_COMP_OUT_CROSSBAR0_TO_RELAY0		BIT(6)

#define MT6985_MERGE_OUT_CROSSBAR1_MOUT_EN 0xf10
	#define DISP_COMP_OUT_CROSSBAR1_TO_DSI0			BIT(0)
	#define DISP_COMP_OUT_CROSSBAR1_TO_DP_INTF0		BIT(1)
	#define DISP_COMP_OUT_CROSSBAR1_TO_WDMA1		BIT(2)
	#define DISP_COMP_OUT_CROSSBAR1_TO_UFBC_WDMA1	BIT(3)
	#define DISP_COMP_OUT_CROSSBAR1_TO_DLO_RELAY0	BIT(4)
	#define DISP_COMP_OUT_CROSSBAR1_TO_DLO_RELAY1	BIT(5)
	#define DISP_COMP_OUT_CROSSBAR1_TO_RELAY0		BIT(6)

#define MT6985_MERGE_OUT_CROSSBAR2_MOUT_EN 0xf14
	#define DISP_COMP_OUT_CROSSBAR2_TO_DSI0			BIT(0)
	#define DISP_COMP_OUT_CROSSBAR2_TO_DP_INTF0		BIT(1)
	#define DISP_COMP_OUT_CROSSBAR2_TO_WDMA1		BIT(2)
	#define DISP_COMP_OUT_CROSSBAR2_TO_UFBC_WDMA1	BIT(3)
	#define DISP_COMP_OUT_CROSSBAR2_TO_DLO_RELAY0	BIT(4)
	#define DISP_COMP_OUT_CROSSBAR2_TO_DLO_RELAY1	BIT(5)
	#define DISP_COMP_OUT_CROSSBAR2_TO_RELAY0		BIT(6)

#define MT6985_MERGE_OUT_CROSSBAR3_MOUT_EN 0xf18
	#define DISP_COMP_OUT_CROSSBAR3_TO_DSI0			BIT(0)
	#define DISP_COMP_OUT_CROSSBAR3_TO_DP_INTF0		BIT(1)
	#define DISP_COMP_OUT_CROSSBAR3_TO_WDMA1		BIT(2)
	#define DISP_COMP_OUT_CROSSBAR3_TO_UFBC_WDMA1	BIT(3)
	#define DISP_COMP_OUT_CROSSBAR3_TO_DLO_RELAY0	BIT(4)
	#define DISP_COMP_OUT_CROSSBAR3_TO_DLO_RELAY1	BIT(5)
	#define DISP_COMP_OUT_CROSSBAR3_TO_RELAY0		BIT(6)

#define MT6985_MERGE_OUT_CROSSBAR4_MOUT_EN 0xf1c
	#define DISP_MERGE0_0_TO_DSI0		BIT(0)
	#define DISP_MERGE0_0_TO_DP_INTF0	BIT(1)
	#define DISP_MERGE0_0_TO_WDMA1		BIT(2)
	#define DISP_MERGE0_0_TO_UFBC_WDMA1	BIT(3)
	#define DISP_MERGE0_0_TO_DLO_RELAY0	BIT(4)
	#define DISP_MERGE0_0_TO_DLO_RELAY1	BIT(5)
	#define DISP_MERGE0_0_TO_RELAY0		BIT(6)

#define MT6985_MERGE_OUT_CROSSBAR5_MOUT_EN 0xf20
	#define DISP_MERGE0_1_TO_DSI0		BIT(0)
	#define DISP_MERGE0_1_TO_DP_INTF0	BIT(1)
	#define DISP_MERGE0_1_TO_WDMA1		BIT(2)
	#define DISP_MERGE0_1_TO_UFBC_WDMA1	BIT(3)
	#define DISP_MERGE0_1_TO_DLO_RELAY0	BIT(4)
	#define DISP_MERGE0_1_TO_DLO_RELAY1	BIT(5)
	#define DISP_MERGE0_1_TO_RELAY0		BIT(6)

#define MT6985_MERGE_OUT_CROSSBAR6_MOUT_EN 0xf24
	#define DISP_MERGE1_0_TO_DSI0		BIT(0)
	#define DISP_MERGE1_0_TO_DP_INTF0	BIT(1)
	#define DISP_MERGE1_0_TO_WDMA1		BIT(2)
	#define DISP_MERGE1_0_TO_UFBC_WDMA1	BIT(3)
	#define DISP_MERGE1_0_TO_DLO_RELAY0	BIT(4)
	#define DISP_MERGE1_0_TO_DLO_RELAY1	BIT(5)
	#define DISP_MERGE1_0_TO_RELAY0		BIT(6)

#define MT6985_MERGE_OUT_CROSSBAR7_MOUT_EN 0xf28
	#define DISP_MERGE1_1_TO_DSI0		BIT(0)
	#define DISP_MERGE1_1_TO_DP_INTF0	BIT(1)
	#define DISP_MERGE1_1_TO_WDMA1		BIT(2)
	#define DISP_MERGE1_1_TO_UFBC_WDMA1	BIT(3)
	#define DISP_MERGE1_1_TO_DLO_RELAY0	BIT(4)
	#define DISP_MERGE1_1_TO_DLO_RELAY1	BIT(5)
	#define DISP_MERGE1_1_TO_RELAY0		BIT(6)

#define MT6985_PANEL_COMP_OUT_CROSSBAR0_MOUT_EN 0xf48
	#define DISP_POSTALIGN0_TO_VDCM0				BIT(0)
	#define DISP_POSTALIGN0_TO_DSC_0				BIT(1)
	#define DISP_POSTALIGN0_TO_DSC_1				BIT(2)
	#define DISP_POSTALIGN0_TO_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_POSTALIGN0_TO_COMP_OUT_CROSSBAR4	BIT(4)
	#define DISP_POSTALIGN0_TO_COMP_OUT_CROSSBAR5	BIT(5)

#define MT6985_PANEL_COMP_OUT_CROSSBAR1_MOUT_EN 0xf4c
	#define DISP_PQ_OUT_CROSSBAR1_TO_VDCM0				BIT(0)
	#define DISP_PQ_OUT_CROSSBAR1_TO_DSC_0				BIT(1)
	#define DISP_PQ_OUT_CROSSBAR1_TO_DSC_1				BIT(2)
	#define DISP_PQ_OUT_CROSSBAR1_TO_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_PQ_OUT_CROSSBAR1_TO_COMP_OUT_CROSSBAR4	BIT(4)
	#define DISP_PQ_OUT_CROSSBAR1_TO_COMP_OUT_CROSSBAR5	BIT(5)

#define MT6985_PANEL_COMP_OUT_CROSSBAR2_MOUT_EN 0xf50
	#define DISP_PQ_OUT_CROSSBAR2_TO_VDCM0				BIT(0)
	#define DISP_PQ_OUT_CROSSBAR2_TO_DSC_0				BIT(1)
	#define DISP_PQ_OUT_CROSSBAR2_TO_DSC_1				BIT(2)
	#define DISP_PQ_OUT_CROSSBAR2_TO_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_PQ_OUT_CROSSBAR2_TO_COMP_OUT_CROSSBAR4	BIT(4)
	#define DISP_PQ_OUT_CROSSBAR2_TO_COMP_OUT_CROSSBAR5	BIT(5)

#define MT6985_PANEL_COMP_OUT_CROSSBAR3_MOUT_EN 0xf54
	#define DISP_PQ_OUT_CROSSBAR3_TO_VDCM0				BIT(0)
	#define DISP_PQ_OUT_CROSSBAR3_TO_DSC_0				BIT(1)
	#define DISP_PQ_OUT_CROSSBAR3_TO_DSC_1				BIT(2)
	#define DISP_PQ_OUT_CROSSBAR3_TO_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_PQ_OUT_CROSSBAR3_TO_COMP_OUT_CROSSBAR4	BIT(4)
	#define DISP_PQ_OUT_CROSSBAR3_TO_COMP_OUT_CROSSBAR5	BIT(5)

#define MT6985_PANEL_COMP_OUT_CROSSBAR4_MOUT_EN 0xf58
	#define DISP_DLI_RELAY4_TO_VDCM0				BIT(0)
	#define DISP_DLI_RELAY4_TO_DSC_0				BIT(1)
	#define DISP_DLI_RELAY4_TO_DSC_1				BIT(2)
	#define DISP_DLI_RELAY4_TO_COMP_OUT_CROSSBAR3	BIT(3)
...
#define MT6985_PQ_IN_CROSSBAR0_MOUT_EN 0xf74
	...
	#define DISP_DLI_RELAY0_TO_PQ_OUT_CROSSBAR3	BIT(2)
	#define DISP_DLI_RELAY0_TO_PQ_OUT_CROSSBAR4	BIT(3)

#define MT6985_PQ_IN_CROSSBAR1_MOUT_EN 0xf78
	#define DISP_DLI_RELAY1_TO_RSZ0				BIT(0)
	#define DISP_DLI_RELAY1_TO_TDSHP1			BIT(1)
	#define DISP_DLI_RELAY1_TO_PQ_OUT_CROSSBAR3	BIT(2)
	#define DISP_DLI_RELAY1_TO_PQ_OUT_CROSSBAR4	BIT(3)

#define MT6985_PQ_IN_CROSSBAR2_MOUT_EN 0xf7c
	#define DISP_DLI_RELAY2_TO_RSZ0				BIT(0)
	#define DISP_DLI_RELAY2_TO_TDSHP1			BIT(1)
	#define DISP_DLI_RELAY2_TO_PQ_OUT_CROSSBAR3	BIT(2)
	#define DISP_DLI_RELAY2_TO_PQ_OUT_CROSSBAR4	BIT(3)

#define MT6985_PQ_IN_CROSSBAR3_MOUT_EN 0xf80
	#define DISP_DLI_RELAY3_TO_RSZ0				BIT(0)
	#define DISP_DLI_RELAY3_TO_TDSHP1			BIT(1)
	#define DISP_DLI_RELAY3_TO_PQ_OUT_CROSSBAR3	BIT(2)
	#define DISP_DLI_RELAY3_TO_PQ_OUT_CROSSBAR4	BIT(3)

#define MT6985_PQ_IN_CROSSBAR4_MOUT_EN 0xf84
	#define DISP_DLI_Y2R0_TO_RSZ0				BIT(0)
	#define DISP_DLI_Y2R0_TO_TDSHP1				BIT(1)
	#define DISP_DLI_Y2R0_TO_PQ_OUT_CROSSBAR3	BIT(2)
	#define DISP_DLI_Y2R0_TO_PQ_OUT_CROSSBAR4	BIT(3)

#define MT6985_PQ_OUT_CROSSBAR0_MOUT_EN 0xf98
	#define DISP_DITHER0_TO_SPR00						BIT(0)
	#define DISP_DITHER0_TO_PANEL_COMP_OUT_CROSSBAR1	BIT(1)
	#define DISP_DITHER0_TO_PANEL_COMP_OUT_CROSSBAR2	BIT(2)
	#define DISP_DITHER0_TO_PANEL_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_DITHER0_TO_PQ_OUT_CHIST0				BIT(4)
	#define DISP_DITHER0_TO_PQ_OUT_CHIST1				BIT(5)

#define MT6985_PQ_OUT_CROSSBAR1_MOUT_EN 0xf9c
	#define DISP_POSTMASK0_TO_SPR00						BIT(0)
	#define DISP_POSTMASK0_TO_PANEL_COMP_OUT_CROSSBAR1	BIT(1)
	#define DISP_POSTMASK0_TO_PANEL_COMP_OUT_CROSSBAR2	BIT(2)
	#define DISP_POSTMASK0_TO_PANEL_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_POSTMASK0_TO_PQ_OUT_CHIST0				BIT(4)
	#define DISP_POSTMASK0_TO_PQ_OUT_CHIST1				BIT(5)

#define MT6985_PQ_OUT_CROSSBAR2_MOUT_EN 0xfa0
	#define DISP_TDSHP1_TO_SPR00					BIT(0)
	#define DISP_TDSHP1_TO_PANEL_COMP_OUT_CROSSBAR1	BIT(1)
	#define DISP_TDSHP1_TO_PANEL_COMP_OUT_CROSSBAR2	BIT(2)
	#define DISP_TDSHP1_TO_PANEL_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_TDSHP1_TO_PQ_OUT_CHIST0			BIT(4)
	#define DISP_TDSHP1_TO_PQ_OUT_CHIST1			BIT(5)

#define MT6985_PQ_OUT_CROSSBAR3_MOUT_EN 0xfa4
	#define DISP_PQ_IN_CROSSBAR2_TO_SPR00						BIT(0)
	#define DISP_PQ_IN_CROSSBAR2_TO_PANEL_COMP_OUT_CROSSBAR1	BIT(1)
	#define DISP_PQ_IN_CROSSBAR2_TO_PANEL_COMP_OUT_CROSSBAR2	BIT(2)
	#define DISP_PQ_IN_CROSSBAR2_TO_PANEL_COMP_OUT_CROSSBAR3	BIT(3)
	#define DISP_PQ_IN_CROSSBAR2_TO_PQ_OUT_CHIST0				BIT(4)
	#define DISP_PQ_IN_CROSSBAR2_TO_PQ_OUT_CHIST1				BIT(5)

#define MT6985_PQ_OUT_CROSSBAR4_MOUT_EN 0xfa8
	#define DISP_PQ_IN_CROSSBAR3_TO_SPR00						BIT(0)
	#define DISP_PQ_IN_CROSSBAR3_TO_PANEL_COMP_OUT_CROSSBAR1	BIT(1)
	#define DISP_PQ_IN_CROSSBAR3_TO_PANEL_COMP_OUT_CROSSBAR2	BIT(2)
	#define DISP_PQ_IN_CROSSBAR3_TO_PANEL_COMP_OUT_CROSSBAR3	BIT(3)
...
#define MT6985_MUTEX_MOD0_DISP_OVL0_2L BIT(0)
#define MT6985_MUTEX_MOD0_DISP_OVL1_2L BIT(1)
#define MT6985_MUTEX_MOD0_DISP_OVL2_2L BIT(2)
#define MT6985_MUTEX_MOD0_DISP_OVL3_2L BIT(3)
#define MT6985_MUTEX_MOD0_DISP_RSZ1 BIT(4)
#define MT6985_MUTEX_MOD0_DISP_MDP_RSZ0 BIT(5)
#define MT6985_MUTEX_MOD0_DISP_WDMA0 BIT(6)
#define MT6985_MUTEX_MOD0_DISP_UFBC_WDMA0 BIT(7)
#define MT6985_MUTEX_MOD0_DISP_WDMA2 BIT(8)
#define MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC0 BIT(9)
#define MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC1 BIT(10)
#define MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC2 BIT(11)
#define MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC0 BIT(12)
#define MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC1 BIT(13)
#define MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC2 BIT(14)
#define MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC3 BIT(15)
#define MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC4 BIT(16)
#define MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC5 BIT(17)
#define MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC6 BIT(18)
#define MT6983_MUTEX_MOD0_INLINEROT0 BIT(19)
#define MT6985_MUTEX_MOD0_OVLSYS_Y2R0 BIT(20)
#define MT6985_MUTEX_MOD0_OVLSYS_Y2R1 BIT(21)

#define MT6985_MUTEX_MOD0_DISP_AAL0 BIT(0)
#define MT6985_MUTEX_MOD0_DISP_C3D0 BIT(1)
#define MT6985_MUTEX_MOD0_DISP_CCORR0 BIT(2)
#define MT6985_MUTEX_MOD0_DISP_CCORR1 BIT(3)
#define MT6985_MUTEX_MOD0_DISP_CHIST0 BIT(4)
#define MT6985_MUTEX_MOD0_DISP_CHIST1 BIT(5)
#define MT6985_MUTEX_MOD0_DISP_COLOR0 BIT(6)
#define MT6985_MUTEX_MOD0_DISP_DITHER0 BIT(7)
#define MT6985_MUTEX_MOD0_DISP_DITHER1 BIT(8)
#define MT6985_MUTEX_MOD0_DLI_ASYNC0 BIT(9)
#define MT6985_MUTEX_MOD0_DLI_ASYNC1 BIT(10)
#define MT6985_MUTEX_MOD0_DLI_ASYNC2 BIT(11)
#define MT6985_MUTEX_MOD0_DLI_ASYNC3 BIT(12)
#define MT6985_MUTEX_MOD0_DLI_ASYNC4 BIT(13)
#define MT6985_MUTEX_MOD0_DLI_ASYNC5 BIT(14)
#define MT6985_MUTEX_MOD0_DLO_ASYNC0 BIT(15)
#define MT6985_MUTEX_MOD0_DLO_ASYNC1 BIT(16)
#define MT6985_MUTEX_MOD0_DISP_DP_INTF0 BIT(17)
#define MT6985_MUTEX_MOD0_DISP_DSC0 BIT(18)
#define MT6985_MUTEX_MOD0_DISP_DSC1 BIT(19)
#define MT6985_MUTEX_MOD0_DISP_DSI0 BIT(20)
#define MT6985_MUTEX_MOD0_DISP_GAMMA0 BIT(21)
#define MT6985_MUTEX_MOD0_DISP_MDP_AAL0 BIT(22)
#define MT6985_MUTEX_MOD0_DISP_MDP_RDMA0 BIT(23)
#define MT6985_MUTEX_MOD0_DISP_MERGE0 BIT(24)
#define MT6985_MUTEX_MOD0_DISP_MERGE1 BIT(25)
#define MT6985_MUTEX_MOD0_DISP_ODDMR0 BIT(26)
#define MT6985_MUTEX_MOD0_DISP_POSTALIGN0 BIT(27)
#define MT6985_MUTEX_MOD0_DISP_POSTMASK0 BIT(28)
#define MT6985_MUTEX_MOD0_DISP_PWM0 BIT(29)
#define MT6985_MUTEX_MOD0_DISP_RELAY0 BIT(30)
#define MT6985_MUTEX_MOD0_DISP_RSZ0 BIT(31)
#define MT6985_MUTEX_MOD1_DISP_SPR0 (BIT(0) | BIT(31))
#define MT6985_MUTEX_MOD1_DISP_TDSHP0 (BIT(1) | BIT(31))
#define MT6985_MUTEX_MOD1_DISP_TDSHP1 (BIT(2) | BIT(31))
#define MT6985_MUTEX_MOD1_DISP_UFBC_WDMA1 (BIT(3) | BIT(31))
#define MT6985_MUTEX_MOD1_DISP_VDCM0 (BIT(4) | BIT(31))
...
#define MT6985_MUTEX_SOF_DSI1 3
#define MT6985_MUTEX_SOF_DPI1 4
#define MT6985_MUTEX_EOF_DSI0 (MT6985_MUTEX_SOF_DSI0 << 6)
#define MT6985_MUTEX_EOF_DPI0 (MT6985_MUTEX_SOF_DPI0 << 6)
#define MT6985_MUTEX_EOF_DSI1 (MT6985_MUTEX_SOF_DSI1 << 6)
#define MT6985_MUTEX_EOF_DPI1 (MT6985_MUTEX_SOF_DPI1 << 6)
#define MT6985_MUTEX_OVLSYS_SOF_DSI0 1
#define MT6985_MUTEX_OVLSYS_SOF_DSI1 2
#define MT6985_MUTEX_OVLSYS_SOF_DPI0 3
#define MT6985_MUTEX_OVLSYS_SOF_DPI1 4
#define MT6985_MUTEX_OVLSYS_EOF_DSI0 (MT6985_MUTEX_OVLSYS_SOF_DSI0 << 6)
#define MT6985_MUTEX_OVLSYS_EOF_DSI1 (MT6985_MUTEX_OVLSYS_SOF_DSI1 << 6)
#define MT6985_MUTEX_OVLSYS_EOF_DPI0 (MT6985_MUTEX_OVLSYS_SOF_DPI0 << 6)
#define MT6985_MUTEX_OVLSYS_EOF_DPI1 (MT6985_MUTEX_OVLSYS_SOF_DPI1 << 6)
...
#define MT6895_DISP_DP_INTF0_SEL_IN				0xF88
	...
	#define MT6895_DISP_DP_INTF0_SEL_IN_FROM_DISP_SUB0_SOUT_SEL			0x1
...
#define	MT6895_DISP_OVL1_2L_BLEND_MOUT_EN		0xFD4
	...
	#define MT6895_DISP_OVL1_2L_BLEND_MOUT_EN_TO_DISP_MAIN_OVL_DMDP_SEL	BIT(1)
...
#define MT6895_DISP_Y2R0_MOUT_EN				0xFC8
	#define MT6895_DISP_Y2R0_MOUT_TO_DMDP_MAIN_OVL_SOUT			BIT(0)

#define MT6895_DISP_MAIN_OVL_DMDP_SEL_IN		0xF28
	#define MT6895_DISP_OVL1_2L_BLEND_MOUT_TO_DISP_MAIN_OVL_DMDP_SEL		0x2
#define MT6895_DISP_OVL0_PQ_SEL_IN				0xF10
	#define MT6895_DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_PQ_SEL_SIN				0x1
#define MT6895_DISP_OVL0_UFOD_SEL_IN			0xF0C
	#define MT6895_DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SIN				0x1
#define MT6895_DISP_RDMA0_POS_SEL_IN			0xF40
	#define MT6895_DISP_RDMA0_POS_SEL_IN_FROM_DISP_RDMA0_SOUT_SEL			0x1
...
#define MT6895_DISP_MERGE0_L_SEL_IN				0xF60
	#define MT6895_DISP_MERGE0_L_SEL_IN_FROM_DISP_TV0_SOUT_SEL				0x1

#define MT6895_DISP_MERGE0_R_SEL_IN				0xF64
	#define MT6895_DISP_MERGE0_R_SEL_IN_FROM_DISP_DLI2_SOUT_SEL				0x1
...
#define MT6895_DISP_DSC_WRAP0_R_SEL_IN			0xF6C
	#define MT6895_DISP_DSC_WRAP0_R_SEL_IN_FROM_DISP_DLI0_SOUT_SEL			0x0
	#define MT6895_DISP_DSC_WRAP0_R_SEL_IN_FROM_DISP_DLI2_SOUT_SEL			0x1
...
#define MT6895_DISP_SUB0_SEL_IN					0xF7C
	#define MT6895_DISP_SUB0_SEL_IN_FROM_DISP_MERGE0_MOUT_EN				0x2
	#define MT6895_DISP_SUB0_SEL_IN_FROM_DISP_DSC_WRAP0_MOUT_EN				0x3
...
#define MT6895_DMDP_MAIN_OVL_SOUT_SEL			0xF90
	#define MT6895_DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SOUT	0x2
	#define MT6895_DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_PQ_SEL_SOUT		0x5
...
#define MT6895_DISP_TV0_SOUT_SEL	0xFB0
	#define MT6895_DISP_TV0_SOUT_SEL_TO_DISP_DLO_RELAY2				0x0
	#define MT6895_DISP_TV0_SOUT_SEL_TO_DISP_MERGE0_L_SEL_IN		0x2
	#define MT6895_DISP_TV0_SOUT_SEL_TO_DISP_DSC_WRAP0_L_SEL_IN		0x3
...
#define MT6895_DISP_DLI2_SOUT_SEL				0xFB8
	#define MT6895_DISP_DLI2_SOUT_SEL_TO_DISP_MERGE0_R_SEL_IN		0x0
	#define MT6895_DISP_DLI2_SOUT_SEL_TO_DISP_DSC_WRAP0_R_SEL_IN	0x1
...
#define MT6895_DISP_SUB0_TX_SOUT_SEL			0xFC4
...
#define MT6895_DISP_MERGE0_MOUT_EN				0xFF0
	#define MT6895_DISP_MERGE0_MOUT_EN_TO_DISP_SUB0_SEL_IN			BIT(2)

#define MT6895_DISP_DSC_WRAP0_MOUT_EN			0xFF4
	#define MT6895_DISP_DSC_WRAP0_MOUT_EN_TO_DISP_MAIN0_SEL_IN		BIT(0)
	#define MT6895_DISP_DSC_WRAP0_MOUT_EN_TO_DISP_SUB0_SEL_IN		BIT(1)
...
#define MT6879_MMSYS_OVL_CON 0xF08
	...
	#define MT6879_DISP_OVL0_2L_GO_BLEND         BIT(2)
	#define MT6879_DISP_OVL0_2L_GO_BG            BIT(3)
	#define MT6879_DISP_OVL1_2L_GO_BLEND         BIT(4)
	#define MT6879_DISP_OVL1_2L_GO_BG            BIT(5)
	#define MT6879_DISP_OVL0_2L_NWCG_GO_BLEND    BIT(6)

#define MT6879_DISP_OVL0_UFOD_SEL                                0xF0C
	#define MT6879_DISP_OVL0_UFOD_FROM_DISP_RSZ0_MAIN_OVL_SOUT   (0)
	#define MT6879_DISP_OVL0_UFOD_FROM_DISP_DMDP_MAIN_OVL_SOUT   (1)

#define MT6879_DISP_OVL0_2L_UFOD_SEL                                0xF14
	#define MT6879_DISP_OVL0_2L_UFOD_FROM_DISP_RSZ0_MAIN_OVL_SOUT   (0)
	#define MT6879_DISP_OVL0_2L_UFOD_FROM_DISP_DMDP_MAIN_OVL_SOUT   (1)

#define MT6879_DISP_RSZ0_SEL                                0xF24
	#define MT6879_DISP_RSZ0_FROM_DISP_OVL0_2L_BLEND_MOUT   (0)
	#define MT6879_DISP_RSZ0_FROM_DISP_OVL1_2L_BLEND_MOUT   (1)
	#define MT6879_DISP_RSZ0_FROM_DISP_OVL0_BLEND_MOUT      (2)
	#define MT6879_DISP_RSZ0_FROM_DISP_OVL0_2L              (3)
	#define MT6879_DISP_RSZ0_FROM_DISP_OVL1_2L              (4)
	#define MT6879_DISP_RSZ0_FROM_DISP_OVL0                 (5)

#define MT6879_DISP_MAIN_OVL_DMDP_SEL                                0xF28
	#define MT6879_DISP_MAIN_OVL_DMDP_FROM_DISP_RSZ0_MOUT            (0)
	#define MT6879_DISP_MAIN_OVL_DMDP_FROM_DISP_OVL0_2L_BLEND_MOUT   (1)
	#define MT6879_DISP_MAIN_OVL_DMDP_FROM_DISP_OVL1_2L_BLEND_MOUT   (2)
	#define MT6879_DISP_MAIN_OVL_DMDP_FROM_DISP_OVL0_BLEND_MOUT      (3)

#define MT6879_DISP_MAIN_OVL_DISP_WDMA_SEL                                0xF2C
	#define MT6879_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_RSZ0_MOUT            (0)
	#define MT6879_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_OVL0_2L_BLEND_MOUT   (1)
	#define MT6879_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_OVL1_2L_BLEND_MOUT   (2)
	#define MT6879_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_OVL0_BLEND_MOUT      (3)

#define MT6879_DISP_MAIN_OVL_DISP_UFBC_WDMA_SEL                                0xF30
	#define MT6879_DISP_MAIN_OVL_DISP_UFBC_WDMA_FROM_DISP_RSZ0_MOUT            (0)
	#define MT6879_DISP_MAIN_OVL_DISP_UFBC_WDMA_FROM_DISP_OVL0_2L_BLEND_MOUT   (1)
	#define MT6879_DISP_MAIN_OVL_DISP_UFBC_WDMA_FROM_DISP_OVL1_2L_BLEND_MOUT   (2)
	#define MT6879_DISP_MAIN_OVL_DISP_UFBC_WDMA_FROM_DISP_OVL0_BLEND_MOUT      (3)

#define MT6879_DISP_MAIN_OVL_DISP_PQ0_SEL                                0xF34
	#define MT6879_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_RSZ0_MOUT            (0)
	#define MT6879_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_OVL0_2L_BLEND_MOUT   (1)
	#define MT6879_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_OVL1_2L_BLEND_MOUT   (2)
	#define MT6879_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_OVL0_BLEND_MOUT      (3)

#define MT6879_DISP_PQ0_SEL                                   0xF38
	#define MT6879_DISP_PQ0_FROM_DISP_Y2R0_MOUT               (0)
	#define MT6879_DISP_PQ0_FROM_DISP_MAIN_OVL_DISP_PQ0_SEL   (1)

#define MT6879_DISP_RDMA0_SEL                            0xF3C
	#define MT6879_DISP_RDMA0_FROM_DISP_RDMA0_POS_MOUT   (0)
	#define MT6879_DISP_RDMA0_FROM_DISP_RDMA0_SOUT       (1)

#define MT6879_DISP_RDMA0_POS_SEL                                   0xF40
	#define MT6879_DISP_RDMA0_POS_FROM_DISP_Y2R0_MOUT               (0)
	#define MT6879_DISP_RDMA0_POS_FROM_DISP_MAIN_OVL_DISP_PQ0_SEL   (1)

#define MT6879_DISP_C3D0_SEL                         0xF44
	#define MT6879_DISP_C3D0_FROM_DISP_TDSHP0_SOUT   (0)
	#define MT6879_DISP_C3D0_FROM_DISP_CCORR1_SOUT   (1)

#define MT6879_DISP_COLOR0_SEL                         0xF48
	#define MT6879_DISP_COLOR0_FROM_DISP_C3D0_SOUT     (0)
	#define MT6879_DISP_COLOR0_FROM_DISP_TDSHP0_SOUT   (1)

#define MT6879_DISP_MDP_AAL0_SEL                         0xF4C
	#define MT6879_DISP_MDP_AAL0_FROM_DISP_CCORR1_SOUT   (0)
	#define MT6879_DISP_MDP_AAL0_FROM_DISP_C3D0_SOUT     (1)

#define MT6879_DISP_CHIST0_SEL                            0xF50
	#define MT6879_DISP_CHIST0_FROM_DISP_RDMA0_POS_MOUT   (0)
	#define MT6879_DISP_CHIST0_FROM_DISP_POSTMASK0_MOUT   (1)
	#define MT6879_DISP_CHIST0_FROM_DISP_DITHER0_MOUT     (2)

#define MT6879_DISP_CHIST1_SEL                            0xF54
	#define MT6879_DISP_CHIST1_FROM_DISP_RDMA0_POS_MOUT   (0)
	#define MT6879_DISP_CHIST1_FROM_DISP_POSTMASK0_MOUT   (1)
	#define MT6879_DISP_CHIST1_FROM_DISP_DITHER0_MOUT     (2)

#define MT6879_DISP_RDMA1_SEL                                     0xF58
	#define MT6879_DISP_RDMA1_FROM_DISP_RDMA1_IN_RELAY            (0)
	#define MT6879_DISP_RDMA1_FROM_DISP_OVL0_2L_NWCG_BLEND_MOUT   (1)

#define MT6879_DISP_RDMA1_POS_SEL                            0xF5C
	#define MT6879_DISP_RDMA1_POS_FROM_DISP_RDMA0_POS_MOUT   (0)
	#define MT6879_DISP_RDMA1_POS_FROM_DISP_RDMA0_SOUT       (1)

#define MT6879_DISP_MERGE0_L_SEL                      0xF60
	#define MT6879_DISP_MERGE0_L_FROM_DISP_PQ0_SOUT   (0)
	#define MT6879_DISP_MERGE0_L_FROM_DISP_TV0_SOUT   (1)

#define MT6879_DISP_MERGE0_R_SEL                       0xF64
	#define MT6879_DISP_MERGE0_R_FROM_DISP_DLI0_SOUT   (0)
	#define MT6879_DISP_MERGE0_R_FROM_DISP_DLI2_SOUT   (1)

#define MT6879_DISP_DSC_WRAP0_L_SEL                      0xF68
	#define MT6879_DISP_DSC_WRAP0_L_FROM_DISP_PQ0_SOUT   (0)
	#define MT6879_DISP_DSC_WRAP0_L_FROM_DISP_TV0_SOUT   (1)

#define MT6879_DISP_DSC_WRAP0_R_SEL                       0xF6C
	#define MT6879_DISP_DSC_WRAP0_R_FROM_DISP_DLI0_SOUT   (0)
	#define MT6879_DISP_DSC_WRAP0_R_FROM_DISP_DLI2_SOUT   (1)

#define MT6879_DISP_WDMA0_SEL                                     0xF70
	#define MT6879_DISP_WDMA0_FROM_DISP_Y2R0_MOUT                 (0)
	#define MT6879_DISP_WDMA0_FROM_DISP_MAIN_OVL_DISP_WDMA_SEL    (1)
	#define MT6879_DISP_WDMA0_FROM_DISP_SPR0_MOUT                 (2)
	#define MT6879_DISP_WDMA0_FROM_DISP_MERGE0_MOUT               (3)
	#define MT6879_DISP_WDMA0_FROM_DISP_OVL0_2L_NWCG_BLEND_MOUT   (4)

#define MT6879_DISP_UFBC_WDMA0_SEL                                         0xF74
	#define MT6879_DISP_UFBC_WDMA0_FROM_DISP_Y2R0_MOUT                     (0)
	#define MT6879_DISP_UFBC_WDMA0_FROM_DISP_MAIN_OVL_DISP_UFBC_WDMA_SEL   (1)
	#define MT6879_DISP_UFBC_WDMA0_FROM_DISP_SPR0_MOUT                     (2)
	#define MT6879_DISP_UFBC_WDMA0_FROM_DISP_MERGE0_MOUT                   (3)
	#define MT6879_DISP_UFBC_WDMA0_FROM_DISP_OVL0_2L_NWCG_BLEND_MOUT       (4)

#define MT6879_DISP_MAIN0_SEL                          0xF78
	#define MT6879_DISP_MAIN0_FROM_DISP_DLI_RELAY1                 (0)
	#define MT6879_DISP_MAIN0_FROM_DISP_PQ0_SOUT                   (1)
	#define MT6879_DISP_MAIN0_FROM_DISP_MERGE0_MOUT                (2)
	#define MT6879_DISP_MAIN0_FROM_DISP_DSC_WRAP0_MOUT             (3)
	#define MT6879_DISP_MAIN0_FROM_DISP_RDMA1_SOUT                 (4)

#define MT6879_DISP_SUB0_SEL                            0xF7C
	#define MT6879_DISP_SUB0_FROM_DISP_PQ0_SOUT         (0)
	#define MT6879_DISP_SUB0_FROM_DISP_TV0_SOUT         (1)
	#define MT6879_DISP_SUB0_FROM_DISP_MERGE0_MOUT      (2)
	#define MT6879_DISP_SUB0_FROM_DISP_DSC_WRAP0_MOUT   (3)

#define MT6879_DISP_WDMA1_SEL                                     0xF80
	#define MT6879_DISP_WDMA1_FROM_DISP_DSC_WRAP0_MOUT            (0)
	#define MT6879_DISP_WDMA1_FROM_DISP_OVL0_2L_NWCG_BLEND_MOUT   (1)
	#define MT6879_DISP_WDMA1_FROM_DISP_OVL1_2L_NWCG              (2)

#define MT6879_DISP_DSI0_SEL                           0xF84
	#define MT6879_DISP_DSI0_FROM_DISP_RDMA0_OUT_RELAY             (0)
	#define MT6879_DISP_DSI0_FROM_DISP_MAIN0_SOUT                  (1)

#define MT6879_DISP_DP_INTF0_SEL                 0xF88
	#define DP_INTF0_FROM_DISP_RDMA1_OUT_RELAY   (0)
	#define DP_INTF0_FROM_DISP_SUB0_SOUT         (1)

#define MT6879_DISP_RSZ0_MAIN_OVL_SOUT_SEL                            0xF8C
	#define MT6879_DISP_RSZ0_MAIN_OVL_SOUT_TO_DISP_OVL0_2L_UFOD_SEL   (0)
	#define MT6879_DISP_RSZ0_MAIN_OVL_SOUT_TO_DISP_OVL1_2L_UFOD_SEL   (1)
	#define MT6879_DISP_RSZ0_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL      (2)

#define MT6879_DISP_OVL0_BG_SOUT_SEL                        0xF94
	#define MT6879_DISP_OVL0_BG_SOUT_TO_DISP_OVL0_2L        (0)
	#define MT6879_DISP_OVL0_BG_SOUT_TO_DISP_OVL1_2L_NWCG   (1)

#define MT6879_DISP_RDMA0_SOUT_SEL                           0xF98
	#define MT6879_DISP_RDMA0_SOUT_TO_DISP_RDMA0_OUT_RELAY   (0)
	#define MT6879_DISP_RDMA0_SOUT_TO_DISP_RDMA0_POS_SEL     (1)

#define MT6879_DISP_TDSHP0_SOUT_SEL                      0xF9C
	#define MT6879_DISP_TDSHP0_SOUT_TO_DISP_C3D0_SEL     (0)
	#define MT6879_DISP_TDSHP0_SOUT_TO_DISP_COLOR0_SEL   (1)

#define MT6879_DISP_C3D0_SOUT_SEL                        0xFA0
	#define MT6879_DISP_C3D0_SOUT_TO_DISP_COLOR0_SEL     (0)
	#define MT6879_DISP_C3D0_SOUT_TO_DISP_MDP_AAL0_SEL   (1)

#define MT6879_DISP_CCORR1_SOUT_SEL                        0xFA4
	#define MT6879_DISP_CCORR1_SOUT_TO_DISP_MDP_AAL0_SEL   (0)
	#define MT6879_DISP_CCORR1_SOUT_TO_DISP_C3D0_SEL       (1)

#define MT6879_DISP_RDMA1_SOUT_SEL                           0xFA8
	#define MT6879_DISP_RDMA1_SOUT_TO_DISP_RDMA1_OUT_RELAY   (0)
	#define MT6879_DISP_RDMA1_SOUT_TO_DISP_RDMA1_POS_SEL     (1)
	#define MT6879_DISP_RDMA1_SOUT_TO_DISP_MAIN0_SEL         (2)

#define MT6879_DISP_PQ0_SOUT_SEL                           0xFAC
	#define MT6879_DISP_PQ0_SOUT_TO_DISP_DLO_RELAY0        (0)
	#define MT6879_DISP_PQ0_SOUT_TO_DISP_MAIN0_SEL         (1)
	#define MT6879_DISP_PQ0_SOUT_TO_DISP_SUB0_SEL          (2)
	#define MT6879_DISP_PQ0_SOUT_TO_DISP_MERGE0_L_SEL      (3)
    #define MT6879_DISP_PQ0_SOUT_TO_DISP_DSC_WRAP0_L_SEL   (4)

#define MT6879_DISP_TV0_SOUT_SEL                           0xFB0
	#define MT6879_DISP_TV0_SOUT_TO_DISP_DLO_RELAY2        (0)
	#define MT6879_DISP_TV0_SOUT_TO_DISP_SUB0_SEL          (1)
	#define MT6879_DISP_TV0_SOUT_TO_DISP_MERGE0_L_SEL      (2)
    #define MT6879_DISP_TV0_SOUT_TO_DISP_DSC_WRAP0_L_SEL   (3)

#define MT6879_DISP_MAIN0_SOUT_SEL                          0xFBC
	#define MT6879_DISP_MAIN0_SOUT_TO_DISP_RDMA0_IN_RELAY   (0)
	#define MT6879_DISP_MAIN0_SOUT_TO_DISP_DSI0_SEL         (1)

#define MT6879_DISP_SUB0_SOUT_SEL                          0xFC0
	#define MT6879_DISP_SUB0_SOUT_TO_DISP_RDMA1_IN_RELAY   (0)
	#define MT6879_DISP_SUB0_SOUT_TO_DISP_DP_INTF0_SEL     (1)

#define MT6879_DISP_SUB0_TX_SOUT_SEL                 0xFC4
	#define MT6879_DISP_SUB0_SOUT_TO_DISP_DP_INTF0   (0)
	#define MT6879_DISP_SUB0_SOUT_TO_DISP_DPI0       (1)

#define MT6879_DISP_Y2R0_MOUT_EN                           0xFC8
	#define MT6879_DISP_OVL0_MOUT_TO_DMDP_MAIN_OVL_SOUT    BIT(0)
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_PQ0_SEL          BIT(1)
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_WDMA0_SEL        BIT(2)
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(3)

#define MT6879_DISP_OVL0_BLEND_MOUT_EN                                  0xFCC
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_RSZ0_SEL                      BIT(0)
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DMDP_SEL             BIT(1)
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_WDMA_SEL        BIT(2)
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_UFBC_WDMA_SEL   BIT(3)
	#define MT6879_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_PQ0_SEL         BIT(4)

#define MT6879_DISP_OVL0_2L_BLEND_MOUT_EN                     0xFD0
	#define MT6879_DISP_OVL0_2L_MOUT_TO_DISP_RSZ0_SEL         BIT(0)
	#define MT6879_DISP_OVL0_2L_MOUT_TO_DISP_DMDP_SEL         BIT(1)
	#define MT6879_DISP_OVL0_2L_MOUT_TO_DISP_WDMA0_SEL        BIT(2)
	#define MT6879_DISP_OVL0_2L_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(3)
	#define MT6879_DISP_OVL0_2L_MOUT_TO_DISP_PQ0_SEL          BIT(4)

#define MT6879_DISP_OVL1_2L_BLEND_MOUT_EN                     0xFD4
	#define MT6879_DISP_OVL1_2L_MOUT_TO_DISP_RSZ0_SEL         BIT(0)
	#define MT6879_DISP_OVL1_2L_MOUT_TO_DISP_DMDP_SEL         BIT(1)
	#define MT6879_DISP_OVL1_2L_MOUT_TO_DISP_WDMA0_SEL        BIT(2)
	#define MT6879_DISP_OVL1_2L_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(3)
	#define MT6879_DISP_OVL1_2L_MOUT_TO_DISP_PQ0_SEL          BIT(4)

#define MT6879_DISP_RSZ0_MOUT_EN                           0xFD8
	#define MT6879_DISP_RSZ0_MOUT_TO_DISP_OVL_SOUT         BIT(0)
	#define MT6879_DISP_RSZ0_MOUT_TO_DISP_DMDP0_SEL        BIT(1)
	#define MT6879_DISP_RSZ0_MOUT_TO_DISP_WDMA0_SEL        BIT(2)
...
#define MT6879_DISP_RDMA0_POS_MOUT_EN                          0xFDC
	...
	#define MT6879_DISP_RDMA0_POS_MOUT_TO_DISP_CHIST1_SEL      BIT(3)

#define MT6879_DISP_POSTMASK0_MOUT_EN                        0xFE0
	#define MT6879_DISP_POSTMASK0_MOUT_TO_DISP_DITHER0_SEL   BIT(0)
	#define MT6879_DISP_POSTMASK0_MOUT_TO_DISP_CHIST0_SEL    BIT(1)
	#define MT6879_DISP_POSTMASK0_MOUT_TO_DISP_CHIST1_SEL    BIT(2)

#define MT6879_DISP_DITHER0_MOUT_EN                       0xFE4
	#define MT6879_DISP_DITHER0_MOUT_TO_DISP_CM0          BIT(0)
	#define MT6879_DISP_DITHER0_MOUT_TO_DISP_CHIST0_SEL   BIT(1)
	#define MT6879_DISP_DITHER0_MOUT_TO_DISP_CHIST1_SEL   BIT(2)

#define MT6879_DISP_SPR0_MOUT_EN                              0xFE8
	#define MT6879_DISP_DITHER0_MOUT_TO_DISP_WDMA0_SEL        BIT(0)
	#define MT6879_DISP_DITHER0_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(1)
	#define MT6879_DISP_DITHER0_MOUT_TO_DISP_PQ0_SOUT         BIT(2)

#define MT6879_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN                     0xFEC
	#define MT6879_DISP_OVL0_2L_NWCG_MOUT_TO_DISP_RDMA1_POS_SEL    BIT(0)
	#define MT6879_DISP_OVL0_2L_NWCG_MOUT_TO_DISP_RDMA1_SEL        BIT(1)
	#define MT6879_DISP_OVL0_2L_NWCG_MOUT_TO_DISP_WDMA0_SEL        BIT(2)
	#define MT6879_DISP_OVL0_2L_NWCG_MOUT_TO_DISP_WDMA1_SEL        BIT(3)
	#define MT6879_DISP_OVL0_2L_NWCG_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(4)

#define MT6879_DISP_MERGE0_MOUT_EN                           0xFF0
	#define MT6879_DISP_MERGE0_MOUT_TO_DISP_WDMA0_SEL        BIT(0)
	#define MT6879_DISP_MERGE0_MOUT_TO_DISP_MAIN0_SEL        BIT(1)
	#define MT6879_DISP_MERGE0_MOUT_TO_DISP_SUB0_SEL         BIT(2)
	#define MT6879_DISP_MERGE0_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(3)

#define MT6879_DISP_DSC_WRAP0_MOUT_EN                      0xFF4
	#define MT6879_DISP_DSC_WRAP0_MOUT_TO_DISP_MAIN0_SEL   BIT(0)
	#define MT6879_DISP_DSC_WRAP0_MOUT_TO_DISP_SUB0_SEL    BIT(1)
	#define MT6879_DISP_DSC_WRAP0_MOUT_TO_DISP_WDMA1_SEL   BIT(2)

#define MT6879_DISP_MUTEX0_MOD0   0x30
#define MT6879_DISP_MUTEX0_SOF    0x2C

#define MT6879_MUTEX_MOD_DISP_OVL0            BIT(0)
#define MT6879_MUTEX_MOD_DISP_OVL0_2L         BIT(1)
#define MT6879_MUTEX_MOD_DISP_OVL1_2L         BIT(2)
#define MT6879_MUTEX_MOD_DISP_RSZ0            BIT(3)
#define MT6879_MUTEX_MOD_DISP_RDMA0           BIT(4)
#define MT6879_MUTEX_MOD_DISP_TDSHP0          BIT(5)
#define MT6879_MUTEX_MOD_DISP_C3D0            BIT(6)
#define MT6879_MUTEX_MOD_DISP_COLOR0          BIT(7)
#define MT6879_MUTEX_MOD_DISP_CCORR0          BIT(8)
#define MT6879_MUTEX_MOD_DISP_CCORR1          BIT(9)
#define MT6879_MUTEX_MOD_DISP_MDP_AAL0        BIT(10)
#define MT6879_MUTEX_MOD_DISP_AAL0            BIT(11)
#define MT6879_MUTEX_MOD_DISP_GAMMA0          BIT(12)
#define MT6879_MUTEX_MOD_DISP_POSTMASK0       BIT(13)
#define MT6879_MUTEX_MOD_DISP_DITHER0         BIT(14)
#define MT6879_MUTEX_MOD_DISP_CHIST0          BIT(15)
#define MT6879_MUTEX_MOD_DISP_CHIST1          BIT(16)
#define MT6879_MUTEX_MOD_DISP_CM0             BIT(17)
#define MT6879_MUTEX_MOD_DISP_SPR0            BIT(18)
#define MT6879_MUTEX_MOD_DISP_DSC_WRAP0_CORE0 BIT(19)
#define MT6879_MUTEX_MOD_DISP_DSC_WRAP0_CORE1 BIT(20)
#define MT6879_MUTEX_MOD_DISP_MERGE0          BIT(21)
#define MT6879_MUTEX_MOD_DISP_DSI0            BIT(22)
#define MT6879_MUTEX_MOD_DISP_WDMA0           BIT(23)
#define MT6879_MUTEX_MOD_DISP_UFBC_WDMA0      BIT(24)
#define MT6879_MUTEX_MOD_DISP_OVL0_2L_NWCG    BIT(25)
#define MT6879_MUTEX_MOD_DISP_OVL1_2L_NWCG    BIT(26)
#define MT6879_MUTEX_MOD_DISP_RDMA1           BIT(27)
#define MT6879_MUTEX_MOD_DISP_DP_INTF0        BIT(28)
#define MT6879_MUTEX_MOD_DISP_DPI0            BIT(29)
#define MT6879_MUTEX_MOD_DISP_WDMA1           BIT(30)
#define MT6879_MUTEX_MOD_DISP_Y2R0            BIT(31)
#define MT6879_MUTEX_MOD_DISP_INLINEROT0     (BIT(0)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLI_ASYNC0     (BIT(1)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLI_ASYNC1     (BIT(2)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLI_ASYNC2     (BIT(3)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLI_ASYNC3     (BIT(4)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLO_ASYNC0     (BIT(5)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLO_ASYNC1     (BIT(6)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLO_ASYNC2     (BIT(7)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_DLO_ASYNC3     (BIT(8)|BIT(31))
#define MT6879_MUTEX_MOD_DISP_PWM0           (BIT(9)|BIT(31))

#define MT6879_MUTEX_SOF_SINGLE_MODE 0
#define MT6879_MUTEX_SOF_DSI0 1
#define MT6879_MUTEX_EOF_DSI0 (MT6879_MUTEX_SOF_DSI0 << 6)

#define MT6855_MMSYS_OVL_CON 0xF08
	#define MT6855_DISP_OVL0_GO_BLEND            BIT(0)
	#define MT6855_DISP_OVL0_GO_BG               BIT(1)
	#define MT6855_DISP_OVL0_2L_GO_BLEND         BIT(2)
	#define MT6855_DISP_OVL0_2L_GO_BG            BIT(3)
	#define MT6855_DISP_OVL1_2L_GO_BLEND         BIT(4)
	#define MT6855_DISP_OVL1_2L_GO_BG            BIT(5)

#define MT6855_DISP_OVL0_UFOD_SEL                                0xF0C
	#define MT6855_DISP_OVL0_UFOD_FROM_DISP_RSZ0_MAIN_OVL_SOUT   (0)
	#define MT6855_DISP_OVL0_UFOD_FROM_DISP_DMDP_MAIN_OVL_SOUT   (1)

#define MT6855_DISP_RSZ0_SEL                                0xF24
	#define MT6855_DISP_RSZ0_FROM_DISP_OVL1_2L_BLEND_MOUT   (1)
	#define MT6855_DISP_RSZ0_FROM_DISP_OVL0_BLEND_MOUT      (2)
	#define MT6855_DISP_RSZ0_FROM_DISP_OVL1_2L              (4)
	#define MT6855_DISP_RSZ0_FROM_DISP_OVL0                 (5)

#define MT6855_DISP_MAIN_OVL_DISP_WDMA_SEL                                0xF2C
	#define MT6855_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_RSZ0_MOUT            (0)
	#define MT6855_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_OVL1_2L_BLEND_MOUT   (2)
	#define MT6855_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_OVL0_BLEND_MOUT      (3)

#define MT6855_DISP_MAIN_OVL_DISP_UFBC_WDMA_SEL                                0xF30
	#define MT6855_DISP_MAIN_OVL_DISP_UFBC_WDMA_FROM_DISP_RSZ0_MOUT            (0)
	#define MT6855_DISP_MAIN_OVL_DISP_UFBC_WDMA_FROM_DISP_OVL1_2L_BLEND_MOUT   (2)
	#define MT6855_DISP_MAIN_OVL_DISP_UFBC_WDMA_FROM_DISP_OVL0_BLEND_MOUT      (3)

#define MT6855_DISP_MAIN_OVL_DISP_PQ0_SEL                                0xF34
	#define MT6855_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_RSZ0_MOUT            (0)
	#define MT6855_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_OVL1_2L_BLEND_MOUT   (2)
	#define MT6855_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_OVL0_BLEND_MOUT      (3)

#define MT6855_DISP_PQ0_SEL                                   0xF38
	#define MT6855_DISP_PQ0_FROM_DISP_MAIN_OVL_DISP_PQ0_SEL   (1)

#define MT6855_DISP_RDMA0_SEL                            0xF3C
	#define MT6855_DISP_RDMA0_FROM_DISP_DSI0_SEL         (0)
	#define MT6855_DISP_RDMA0_FROM_DISP_RDMA0_POS_MOUT   (1)

#define MT6855_DISP_RDMA0_POS_SEL                                   0xF40
	#define MT6855_DISP_RDMA0_POS_FROM_DISP_RDMA0_POS_MOUT   (0)
	#define MT6855_DISP_RDMA0_POS_FROM_DISP_RDMA0_SOUT       (1)

#define MT6855_DISP_COLOR0_SEL                         0xF48
	#define MT6855_DISP_COLOR0_FROM_DISP_TDSHP0_SOUT   (1)

#define MT6855_DISP_MDP_AAL0_SEL                         0xF4C
	#define MT6855_DISP_MDP_AAL0_FROM_DISP_CCORR0_SOUT   (0)

#define MT6855_DISP_DSC_WRAP0_L_SEL                      0xF68
	#define MT6855_DISP_DSC_WRAP0_L_FROM_DISP_PQ0_SOUT   (0)

#define MT6855_DISP_WDMA0_SEL                                     0xF70
	#define MT6855_DISP_WDMA0_FROM_DISP_MAIN_OVL_DISP_WDMA_SEL    (1)
	#define MT6855_DISP_WDMA0_FROM_DISP_SPR0_VIRTUAL              (2)

#define MT6855_DISP_UFBC_WDMA0_SEL                                         0xF74
	#define MT6855_DISP_UFBC_WDMA0_FROM_DISP_MAIN_OVL_DISP_UFBC_WDMA_SEL   (1)
	#define MT6855_DISP_UFBC_WDMA0_FROM_DISP_SPR0_VIRTUAL                  (2)

#define MT6855_DISP_MAIN0_SEL                          0xF78
	#define MT6855_DISP_MAIN0_FROM_DISP_PQ0_SOUT                   (1)
	#define MT6855_DISP_MAIN0_FROM_DISP_DSC_WRAP0_MOUT             (3)

#define MT6855_DISP_DSI0_SEL                           0xF84
	#define MT6855_DISP_DSI0_FROM_DISP_RDMA0_OUT_RELAY             (0)
	#define MT6855_DISP_DSI0_FROM_DISP_MAIN0_SOUT                  (1)

#define MT6855_DISP_RSZ0_MAIN_OVL_SOUT_SEL                            0xF8C
	#define MT6855_DISP_RSZ0_MAIN_OVL_SOUT_TO_DISP_OVL1_2L_UFOD_SEL   (1)
	#define MT6855_DISP_RSZ0_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL      (2)

#define MT6855_DISP_RDMA0_SOUT_SEL                           0xF98
	#define MT6855_DISP_RDMA0_SOUT_TO_DISP_DSI0_SEL          (0)
	#define MT6855_DISP_RDMA0_SOUT_TO_DISP_TDSHP0            (1)

#define MT6855_DISP_TDSHP0_SOUT_SEL                      0xF9C
	#define MT6855_DISP_TDSHP0_SOUT_TO_DISP_COLOR0_SEL   (1)

#define MT6855_DISP_CCORR0_SOUT_SEL                        0xFA4
	#define MT6855_DISP_CCORR0_SOUT_TO_DISP_MDP_AAL0_SEL   (0)

#define MT6855_DISP_PQ0_SOUT_SEL                           0xFAC
	#define MT6855_DISP_PQ0_SOUT_TO_DISP_MAIN0_SEL         (1)
	#define MT6855_DISP_PQ0_SOUT_TO_DISP_DSC_WRAP0_L_SEL   (4)

#define MT6855_DISP_MAIN0_SOUT_SEL                          0xFBC
	#define MT6855_DISP_MAIN0_SOUT_TO_DISP_RDMA0_IN_RELAY   (0)
	#define MT6855_DISP_MAIN0_SOUT_TO_DISP_DSI0_SEL         (1)

#define MT6855_DISP_OVL0_BLEND_MOUT_EN                                  0xFCC
	#define MT6855_DISP_OVL0_MOUT_TO_DISP_RSZ0_SEL                      BIT(0)
	#define MT6855_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_WDMA_SEL        BIT(2)
	#define MT6855_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_UFBC_WDMA_SEL   BIT(3)
	#define MT6855_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_PQ0_SEL         BIT(4)

#define MT6855_DISP_OVL1_2L_BLEND_MOUT_EN                     0xFD4
	#define MT6855_DISP_OVL1_2L_MOUT_TO_DISP_RSZ0_SEL         BIT(0)
	#define MT6855_DISP_OVL1_2L_MOUT_TO_DISP_WDMA0_SEL        BIT(2)
	#define MT6855_DISP_OVL1_2L_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(3)
	#define MT6855_DISP_OVL1_2L_MOUT_TO_DISP_PQ0_SEL          BIT(4)

#define MT6855_DISP_RSZ0_MOUT_EN                           0xFD8
	#define MT6855_DISP_RSZ0_MOUT_TO_DISP_OVL_SOUT         BIT(0)
	#define MT6855_DISP_RSZ0_MOUT_TO_DISP_WDMA0_SEL        BIT(2)
	#define MT6855_DISP_RSZ0_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(3)
	#define MT6855_DISP_RSZ0_MOUT_TO_DISP_PQ0_SEL          BIT(4)

#define MT6855_DISP_RDMA0_POS_MOUT_EN                          0xFDC
	#define MT6855_DISP_RDMA0_POS_MOUT_TO_DISP_RDMA0_POS_SEL   BIT(0)
	#define MT6855_DISP_RDMA0_POS_MOUT_TO_DISP_RDMA0_SEL       BIT(1)

#define MT6855_DISP_POSTMASK0_MOUT_EN                        0xFE0
	#define MT6855_DISP_POSTMASK0_MOUT_TO_DISP_DITHER0_SEL   BIT(0)

#define MT6855_DISP_DITHER0_MOUT_EN                       0xFE4
	#define MT6855_DISP_DITHER0_MOUT_TO_DISP_SPR0_VIRTUAL          BIT(0)

#define MT6855_DISP_SPR0_MOUT_EN                              0xFE8
	#define MT6855_DISP_SPR0_MOUT_TO_DISP_WDMA0_SEL        BIT(0)
	#define MT6855_DISP_SPR0_MOUT_TO_DISP_UFBC_WDMA0_SEL   BIT(1)
	#define MT6855_DISP_SPR0_MOUT_TO_DISP_PQ0_SOUT         BIT(2)

#define MT6855_DISP_DSC_WRAP0_MOUT_EN                      0xFF4
	#define MT6855_DISP_DSC_WRAP0_MOUT_TO_DISP_MAIN0_SEL   BIT(0)

#define MT6855_DISP_MUTEX0_MOD0   0x30
#define MT6855_DISP_MUTEX0_SOF    0x2C

#define MT6855_MUTEX_MOD_DISP_OVL0            BIT(0)
#define MT6855_MUTEX_MOD_DISP_OVL1_2L         BIT(2)
#define MT6855_MUTEX_MOD_DISP_RSZ0            BIT(3)
#define MT6855_MUTEX_MOD_DISP_RDMA0           BIT(4)
#define MT6855_MUTEX_MOD_DISP_TDSHP0          BIT(5)
#define MT6855_MUTEX_MOD_DISP_COLOR0          BIT(7)
#define MT6855_MUTEX_MOD_DISP_CCORR0          BIT(8)
#define MT6855_MUTEX_MOD_DISP_AAL0            BIT(11)
#define MT6855_MUTEX_MOD_DISP_GAMMA0          BIT(12)
#define MT6855_MUTEX_MOD_DISP_POSTMASK0       BIT(13)
#define MT6855_MUTEX_MOD_DISP_DITHER0         BIT(14)
#define MT6855_MUTEX_MOD_DISP_DSC_WRAP0_CORE0 BIT(19)
#define MT6855_MUTEX_MOD_DISP_DSC_WRAP0_CORE1 BIT(20)
#define MT6855_MUTEX_MOD_DISP_DSI0            BIT(22)
#define MT6855_MUTEX_MOD_DISP_WDMA0           BIT(23)
#define MT6855_MUTEX_MOD_DISP_UFBC_WDMA0      BIT(24)
#define MT6855_MUTEX_MOD_DISP_INLINEROT0     (BIT(0)|BIT(31))
#define MT6855_MUTEX_MOD_DISP_PWM0           (BIT(9)|BIT(31))
...
struct dummy_mapping mt6983_dispsys_dummy_register[MT6983_DUMMY_REG_CNT] = {
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x404},//[0:31] //DISP_SLOT_CUR_CONFIG_FENCE(0)
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x408},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x40c},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x500},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x210},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x214},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x230},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x234},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x640},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x644},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x660},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x664},//[0:31]
...
//DISP_SLOT_PRESENT_FENCE(0) = DISP_SLOT_PRESENT_FENCE(MAX_PLANE_NR)
	...
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x210},//[0:31] //DISP_SLOT_PRESENT_FENCE(2)
	{0, NULL, DDP_COMPONENT_OVL0_2L_NWCG, 0x200},

	/* can only use 3 bit */
//DISP_SLOT_SUBTRACTOR_WHEN_FREE(0) = DISP_SLOT_PRESENT_FENCE(MAX_CRTC)
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x20},//[0:2]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x24},//[0:2]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x28},//[0:2]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x2c},//[0:2]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x30},//[0:2]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x34},//[0:14]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x38},//[0:6]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x190},//[0:1]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x600},//[0:5]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x654},//[0:5]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x208},//[0:19]
	{0, NULL, DDP_COMPONENT_ID_MAX, 0x228},//[0:19]
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x28},//[0:2]
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x2c},//[0:2]
...
//DISP_SLOT_SUBTRACTOR_WHEN_FREE(17) MAX_PLANE_NR-1
	...
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x214},//[0:31]//DISP_SLOT_CUR_HRT_IDX
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x20c},//[0:23]//DISP_SLOT_CUR_HRT_LEVEL
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x234},//[0:31]//DISP_SLOT_CUR_OUTPUT_FENCE
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x640},//[0:31]//DISP_SLOT_CUR_INTERFACE_FENCE
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x22c},//[0:23]//DISP_SLOT_OVL_STATUS
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x660},//[0:31]//DISP_SLOT_READ_DDIC_BASE
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x664},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x668},//[0:31]
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x66c},//[0:31]//DISP_SLOT_READ_DDIC_BASE+3*0x4

	/* can only use 3 bit */
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x230},//[0:31]//DISP_SLOT_OVL_DSI_SEQ
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x644},//[0:31]//DISP_SLOT_OVL_WDMA_SEQ
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x30},//[0:2]//DISP_SLOT_VFP_PERIOD
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x208},//[0:19]//DISP_SLOT_DSI_STATE_DBG7
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x228},//[0:19]	//DISP_SLOT_DSI_STATE_DBG7_2
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x190},//[0:1]//DISP_SLOT_TE1_EN
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(31), 0x600},//[0:5]
	...
	/* TODO: BWM just for Dujac SW readyGo, if into SQC need to delete and use new method */
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x214},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x210},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x1F4},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x1F0},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x1D4},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x1D0},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x1B4},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x1B0},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x194},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x190},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x174},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(29), 0x170},//LAYER_AVG_RATIO

	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x214},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x210},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x1F4},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x1F0},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x1D4},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x1D0},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x1B4},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x1B0},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x194},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x190},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x174},//LAYER_AVG_RATIO
	{0, NULL, DDP_COMPONENT_ID_MAX | BIT(30), 0x170},//LAYER_AVG_RATIO
};

struct dummy_mapping mt6879_dispsys_dummy_register[MT6879_DUMMY_REG_CNT] = {
	//DISP_SLOT_CUR_CONFIG_FENCE(0 ~ 17)
	...
	{0, NULL, DDP_COMPONENT_OVL0_2L_NWCG, 0x200},
	{0, NULL, DDP_COMPONENT_RDMA0, 0x090},
	//redudant slot which not used in 6879
	{0, NULL, DDP_COMPONENT_WDMA1, 0x100},
	{0, NULL, DDP_COMPONENT_WDMA1, 0x100},

	//DISP_SLOT_PRESENT_FENCE(0 ~ 3)
	{0, NULL, DDP_COMPONENT_RDMA1, 0x090},
	...
	//DISP_SLOT_SUBTRACTOR_WHEN_FREE(0 ~ 17)
...
static const unsigned int mt6983_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		[DDP_COMPONENT_DMDP_AAL0] = MT6983_MUTEX_MOD0_DISP_MDP_AAL0,
		[DDP_COMPONENT_DMDP_AAL1] = MT6983_MUTEX_MOD0_DISP_MDP_AAL0,
		[DDP_COMPONENT_AAL0] = MT6983_MUTEX_MOD0_DISP_AAL0,
		[DDP_COMPONENT_AAL1] = MT6983_MUTEX_MOD0_DISP_AAL0,
		[DDP_COMPONENT_TDSHP0] = MT6983_MUTEX_MOD0_DISP_TDSHP0,
		[DDP_COMPONENT_TDSHP1] = MT6983_MUTEX_MOD0_DISP_TDSHP0,
		[DDP_COMPONENT_C3D0] = MT6983_MUTEX_MOD0_DISP_C3D0,
		[DDP_COMPONENT_C3D1] = MT6983_MUTEX_MOD0_DISP_C3D0,
		[DDP_COMPONENT_COLOR0] = MT6983_MUTEX_MOD0_DISP_COLOR0,
		[DDP_COMPONENT_COLOR1] = MT6983_MUTEX_MOD0_DISP_COLOR0,
		[DDP_COMPONENT_CCORR0] = MT6983_MUTEX_MOD0_DISP_CCORR0,
		[DDP_COMPONENT_CCORR1] = MT6983_MUTEX_MOD0_DISP_CCORR1,
		[DDP_COMPONENT_CCORR2] = MT6983_MUTEX_MOD0_DISP_CCORR0,
		[DDP_COMPONENT_CCORR3] = MT6983_MUTEX_MOD0_DISP_CCORR1,
		[DDP_COMPONENT_DITHER0] = MT6983_MUTEX_MOD0_DISP_DITHER0,
		[DDP_COMPONENT_DITHER1] = MT6983_MUTEX_MOD0_DISP_DITHER0,
		[DDP_COMPONENT_CHIST0] = MT6983_MUTEX_MOD0_DISP_CHIST0,
		[DDP_COMPONENT_CHIST1] = MT6983_MUTEX_MOD0_DISP_CHIST1,
		[DDP_COMPONENT_CHIST2] = MT6983_MUTEX_MOD0_DISP_CHIST0,
		[DDP_COMPONENT_CHIST3] = MT6983_MUTEX_MOD0_DISP_CHIST1,
		[DDP_COMPONENT_CM0] = MT6983_MUTEX_MOD0_DISP_CM0,
		[DDP_COMPONENT_CM1] = MT6983_MUTEX_MOD0_DISP_CM0,
		[DDP_COMPONENT_SPR0] = MT6983_MUTEX_MOD0_DISP_SPR0,
		[DDP_COMPONENT_SPR1] = MT6983_MUTEX_MOD0_DISP_SPR0,
		[DDP_COMPONENT_DSI0] = MT6983_MUTEX_MOD0_DISP_DSI0,
		[DDP_COMPONENT_DSI1] = MT6983_MUTEX_MOD0_DISP_DSI0,
		[DDP_COMPONENT_GAMMA0] = MT6983_MUTEX_MOD0_DISP_GAMMA0,
		[DDP_COMPONENT_GAMMA1] = MT6983_MUTEX_MOD0_DISP_GAMMA0,
		[DDP_COMPONENT_OVL0] = MT6983_MUTEX_MOD0_DISP_OVL0,
		[DDP_COMPONENT_OVL1] = MT6983_MUTEX_MOD0_DISP_OVL0,
		[DDP_COMPONENT_OVL0_2L] = MT6983_MUTEX_MOD0_DISP_OVL1_2L,
		[DDP_COMPONENT_OVL1_2L] = MT6983_MUTEX_MOD0_DISP_OVL1_2L,
		[DDP_COMPONENT_OVL2_2L] = MT6983_MUTEX_MOD0_DISP_OVL1_2L,
		[DDP_COMPONENT_OVL3_2L] = MT6983_MUTEX_MOD0_DISP_OVL1_2L,
		[DDP_COMPONENT_OVL0_2L_NWCG] = MT6983_MUTEX_MOD0_DISP_OVL0_2L_NWCG,
		[DDP_COMPONENT_OVL1_2L_NWCG] = MT6983_MUTEX_MOD0_DISP_OVL1_2L_NWCG,
		[DDP_COMPONENT_OVL2_2L_NWCG] = MT6983_MUTEX_MOD0_DISP_OVL0_2L_NWCG,
		[DDP_COMPONENT_OVL3_2L_NWCG] = MT6983_MUTEX_MOD0_DISP_OVL1_2L_NWCG,
		[DDP_COMPONENT_RDMA0] = MT6983_MUTEX_MOD0_DISP_RDMA0,
		[DDP_COMPONENT_RDMA2] = MT6983_MUTEX_MOD0_DISP_RDMA0,
		[DDP_COMPONENT_RDMA1] = MT6983_MUTEX_MOD0_DISP_RDMA1,
		[DDP_COMPONENT_RDMA3] = MT6983_MUTEX_MOD0_DISP_RDMA1,
		[DDP_COMPONENT_WDMA0] = MT6983_MUTEX_MOD0_DISP_WDMA0,
		[DDP_COMPONENT_WDMA2] = MT6983_MUTEX_MOD0_DISP_WDMA0,
		[DDP_COMPONENT_WDMA1] = MT6983_MUTEX_MOD0_DISP_WDMA1,
		[DDP_COMPONENT_WDMA3] = MT6983_MUTEX_MOD0_DISP_WDMA1,
		[DDP_COMPONENT_RSZ0] = MT6983_MUTEX_MOD0_DISP_RSZ0,
		[DDP_COMPONENT_RSZ1] = MT6983_MUTEX_MOD0_DISP_RSZ0,
		[DDP_COMPONENT_POSTMASK0] = MT6983_MUTEX_MOD0_DISP_POSTMASK0,
		[DDP_COMPONENT_POSTMASK1] = MT6983_MUTEX_MOD0_DISP_POSTMASK0,
		[DDP_COMPONENT_DSC0] = MT6983_MUTEX_MOD0_DISP_DSC0,
		[DDP_COMPONENT_DSC1] = MT6983_MUTEX_MOD0_DISP_DSC0,
		[DDP_COMPONENT_DP_INTF0] = MT6983_MUTEX_MOD0_DISP_DP_INTF0,
		[DDP_COMPONENT_MERGE0] = MT6983_MUTEX_MOD0_DISP_MERGE0,
		[DDP_COMPONENT_MERGE1] = MT6983_MUTEX_MOD0_DISP_MERGE0,
		[DDP_COMPONENT_DLO_ASYNC0] = MT6983_MUTEX_MOD1_DLO_ASYNC0,
		[DDP_COMPONENT_DLO_ASYNC4] = MT6983_MUTEX_MOD1_DLO_ASYNC0,
		[DDP_COMPONENT_DLO_ASYNC1] = MT6983_MUTEX_MOD1_DLO_ASYNC1,
		[DDP_COMPONENT_DLO_ASYNC5] = MT6983_MUTEX_MOD1_DLO_ASYNC1,
		[DDP_COMPONENT_DLO_ASYNC2] = MT6983_MUTEX_MOD1_DLO_ASYNC2,
		[DDP_COMPONENT_DLO_ASYNC6] = MT6983_MUTEX_MOD1_DLO_ASYNC2,
		[DDP_COMPONENT_DLO_ASYNC3] = MT6983_MUTEX_MOD1_DLO_ASYNC3,
		[DDP_COMPONENT_DLO_ASYNC7] = MT6983_MUTEX_MOD1_DLO_ASYNC3,
		[DDP_COMPONENT_DLI_ASYNC0] = MT6983_MUTEX_MOD1_DLI_ASYNC0,
		[DDP_COMPONENT_DLI_ASYNC4] = MT6983_MUTEX_MOD1_DLI_ASYNC0,
		[DDP_COMPONENT_DLI_ASYNC1] = MT6983_MUTEX_MOD1_DLI_ASYNC1,
		[DDP_COMPONENT_DLI_ASYNC5] = MT6983_MUTEX_MOD1_DLI_ASYNC1,
		[DDP_COMPONENT_DLI_ASYNC2] = MT6983_MUTEX_MOD1_DLI_ASYNC2,
		[DDP_COMPONENT_DLI_ASYNC6] = MT6983_MUTEX_MOD1_DLI_ASYNC2,
		[DDP_COMPONENT_DLI_ASYNC3] = MT6983_MUTEX_MOD1_DLI_ASYNC3,
		[DDP_COMPONENT_DLI_ASYNC7] = MT6983_MUTEX_MOD1_DLI_ASYNC3,

		[DDP_COMPONENT_PWM0] = MT6983_MUTEX_MOD1_DISP_PWM0,
		[DDP_COMPONENT_Y2R0] = MT6983_MUTEX_MOD0_DISP_Y2R0,
		[DDP_COMPONENT_Y2R1] = MT6983_MUTEX_MOD0_DISP_Y2R0,
		[DDP_COMPONENT_DLO_ASYNC] = MT6983_MUTEX_MOD1_DLO_ASYNC3,
		[DDP_COMPONENT_DLI_ASYNC] = MT6983_MUTEX_MOD1_DLI_ASYNC3,
		[DDP_COMPONENT_INLINE_ROTATE0] = MT6983_MUTEX_MOD1_INLINEROT0,
		[DDP_COMPONENT_INLINE_ROTATE1] = MT6983_MUTEX_MOD1_INLINEROT0,
};

static const unsigned int mt6985_ovlsys_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		[DDP_COMPONENT_OVL0_2L] = MT6985_MUTEX_MOD0_DISP_OVL0_2L,
	[DDP_COMPONENT_OVL4_2L] = MT6985_MUTEX_MOD0_DISP_OVL0_2L,
		[DDP_COMPONENT_OVL1_2L] = MT6985_MUTEX_MOD0_DISP_OVL1_2L,
	[DDP_COMPONENT_OVL5_2L] = MT6985_MUTEX_MOD0_DISP_OVL1_2L,
		[DDP_COMPONENT_OVL2_2L] = MT6985_MUTEX_MOD0_DISP_OVL2_2L,
	...
	[DDP_COMPONENT_DMDP_RSZ1] = MT6985_MUTEX_MOD0_DISP_MDP_RSZ0,
		[DDP_COMPONENT_OVLSYS_WDMA0] = MT6985_MUTEX_MOD0_DISP_WDMA0,
	[DDP_COMPONENT_OVLSYS_WDMA2] = MT6985_MUTEX_MOD0_DISP_WDMA0,
		[DDP_COMPONENT_OVLSYS_UFBC_WDMA0] = MT6985_MUTEX_MOD0_DISP_UFBC_WDMA0,
	[DDP_COMPONENT_OVLSYS_UFBC_WDMA1] = MT6985_MUTEX_MOD0_DISP_UFBC_WDMA0,
		[DDP_COMPONENT_OVLSYS_WDMA1] = MT6985_MUTEX_MOD0_DISP_WDMA2,
	[DDP_COMPONENT_OVLSYS_WDMA3] = MT6985_MUTEX_MOD0_DISP_WDMA2,
		[DDP_COMPONENT_OVLSYS_DLI_ASYNC0] = MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC0,
	[DDP_COMPONENT_OVLSYS_DLI_ASYNC3] = MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC0,
		[DDP_COMPONENT_OVLSYS_DLI_ASYNC1] = MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC1,
	[DDP_COMPONENT_OVLSYS_DLI_ASYNC4] = MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC1,
		[DDP_COMPONENT_OVLSYS_DLI_ASYNC2] = MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC2,
	[DDP_COMPONENT_OVLSYS_DLI_ASYNC5] = MT6985_MUTEX_MOD0_OVLSYS_DLI_ASYNC2,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC0] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC0,
	[DDP_COMPONENT_OVLSYS_DLO_ASYNC7] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC0,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC1] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC1,
	[DDP_COMPONENT_OVLSYS_DLO_ASYNC8] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC2] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC2,
	[DDP_COMPONENT_OVLSYS_DLO_ASYNC9] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC2,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC3] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC3,
	[DDP_COMPONENT_OVLSYS_DLO_ASYNC10] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC3,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC4] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC4,
	[DDP_COMPONENT_OVLSYS_DLO_ASYNC11] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC4,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC5] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC5,
	[DDP_COMPONENT_OVLSYS_DLO_ASYNC12] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC5,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC6] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC6,
	[DDP_COMPONENT_OVLSYS_DLO_ASYNC13] = MT6985_MUTEX_MOD0_OVLSYS_DLO_ASYNC6,
		[DDP_COMPONENT_INLINE_ROTATE0] = MT6983_MUTEX_MOD0_INLINEROT0,
	[DDP_COMPONENT_INLINE_ROTATE1] = MT6983_MUTEX_MOD0_INLINEROT0,
		[DDP_COMPONENT_Y2R0] = MT6985_MUTEX_MOD0_OVLSYS_Y2R0,
	[DDP_COMPONENT_Y2R2] = MT6985_MUTEX_MOD0_OVLSYS_Y2R0,
		[DDP_COMPONENT_Y2R1] = MT6985_MUTEX_MOD0_OVLSYS_Y2R1,
	[DDP_COMPONENT_Y2R3] = MT6985_MUTEX_MOD0_OVLSYS_Y2R1,
		[DDP_COMPONENT_MDP_RSZ0] = MT6985_MUTEX_MOD0_DISP_MDP_RSZ0,
	[DDP_COMPONENT_MDP_RSZ1] = MT6985_MUTEX_MOD0_DISP_MDP_RSZ0,
};

static const unsigned int mt6985_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		[DDP_COMPONENT_AAL0] = MT6985_MUTEX_MOD0_DISP_AAL0,
	[DDP_COMPONENT_AAL1] = MT6985_MUTEX_MOD0_DISP_AAL0,
		[DDP_COMPONENT_C3D0] = MT6985_MUTEX_MOD0_DISP_C3D0,
	[DDP_COMPONENT_C3D1] = MT6985_MUTEX_MOD0_DISP_C3D0,
		[DDP_COMPONENT_CCORR0] = MT6985_MUTEX_MOD0_DISP_CCORR0,
	[DDP_COMPONENT_CCORR2] = MT6985_MUTEX_MOD0_DISP_CCORR0,
		[DDP_COMPONENT_CCORR1] = MT6985_MUTEX_MOD0_DISP_CCORR1,
	[DDP_COMPONENT_CCORR3] = MT6985_MUTEX_MOD0_DISP_CCORR1,
		[DDP_COMPONENT_CHIST0] = MT6985_MUTEX_MOD0_DISP_CHIST0,
	[DDP_COMPONENT_CHIST2] = MT6985_MUTEX_MOD0_DISP_CHIST0,
		[DDP_COMPONENT_CHIST1] = MT6985_MUTEX_MOD0_DISP_CHIST1,
	[DDP_COMPONENT_CHIST3] = MT6985_MUTEX_MOD0_DISP_CHIST1,
		[DDP_COMPONENT_COLOR0] = MT6985_MUTEX_MOD0_DISP_COLOR0,
	[DDP_COMPONENT_COLOR1] = MT6985_MUTEX_MOD0_DISP_COLOR0,
		[DDP_COMPONENT_DITHER0] = MT6985_MUTEX_MOD0_DISP_DITHER0,
	[DDP_COMPONENT_DITHER2] = MT6985_MUTEX_MOD0_DISP_DITHER0,
		[DDP_COMPONENT_DITHER1] = MT6985_MUTEX_MOD0_DISP_DITHER1,
	[DDP_COMPONENT_DITHER3] = MT6985_MUTEX_MOD0_DISP_DITHER1,
		[DDP_COMPONENT_DLI_ASYNC0] = MT6985_MUTEX_MOD0_DLI_ASYNC0,
		[DDP_COMPONENT_DLI_ASYNC1] = MT6985_MUTEX_MOD0_DLI_ASYNC1,
		[DDP_COMPONENT_DLI_ASYNC2] = MT6985_MUTEX_MOD0_DLI_ASYNC2,
		[DDP_COMPONENT_DLI_ASYNC3] = MT6985_MUTEX_MOD0_DLI_ASYNC3,
		[DDP_COMPONENT_DLI_ASYNC4] = MT6985_MUTEX_MOD0_DLI_ASYNC4,
		[DDP_COMPONENT_DLI_ASYNC5] = MT6985_MUTEX_MOD0_DLI_ASYNC5,
	[DDP_COMPONENT_DLI_ASYNC6] = MT6985_MUTEX_MOD0_DLI_ASYNC0,
	[DDP_COMPONENT_DLI_ASYNC7] = MT6985_MUTEX_MOD0_DLI_ASYNC1,
	[DDP_COMPONENT_DLI_ASYNC8] = MT6985_MUTEX_MOD0_DLI_ASYNC2,
	[DDP_COMPONENT_DLI_ASYNC9] = MT6985_MUTEX_MOD0_DLI_ASYNC3,
	[DDP_COMPONENT_DLI_ASYNC10] = MT6985_MUTEX_MOD0_DLI_ASYNC4,
	[DDP_COMPONENT_DLI_ASYNC11] = MT6985_MUTEX_MOD0_DLI_ASYNC5,
		[DDP_COMPONENT_DLO_ASYNC0] = MT6985_MUTEX_MOD0_DLO_ASYNC0,
		[DDP_COMPONENT_DLO_ASYNC1] = MT6985_MUTEX_MOD0_DLO_ASYNC1,
	[DDP_COMPONENT_DLO_ASYNC2] = MT6985_MUTEX_MOD0_DLO_ASYNC0,
	[DDP_COMPONENT_DLO_ASYNC3] = MT6985_MUTEX_MOD0_DLO_ASYNC1,
	...
	[DDP_COMPONENT_MERGE3] = MT6985_MUTEX_MOD0_DISP_MERGE1,
		[DDP_COMPONENT_ODDMR0] = MT6985_MUTEX_MOD0_DISP_ODDMR0,
	[DDP_COMPONENT_ODDMR1] = MT6985_MUTEX_MOD0_DISP_ODDMR0,
		[DDP_COMPONENT_POSTALIGN0] = MT6985_MUTEX_MOD0_DISP_POSTALIGN0,
	[DDP_COMPONENT_POSTALIGN1] = MT6985_MUTEX_MOD0_DISP_POSTALIGN0,
		[DDP_COMPONENT_POSTMASK0] = MT6985_MUTEX_MOD0_DISP_POSTMASK0,
	[DDP_COMPONENT_POSTMASK1] = MT6985_MUTEX_MOD0_DISP_POSTMASK0,
		[DDP_COMPONENT_PWM0] = MT6985_MUTEX_MOD0_DISP_PWM0,
	[DDP_COMPONENT_PWM1] = MT6985_MUTEX_MOD0_DISP_PWM0,
		[DDP_COMPONENT_RELAY0] = MT6985_MUTEX_MOD0_DISP_RELAY0,
	[DDP_COMPONENT_RELAY1] = MT6985_MUTEX_MOD0_DISP_RELAY0,
		[DDP_COMPONENT_RSZ0] = MT6985_MUTEX_MOD0_DISP_RSZ0,
	[DDP_COMPONENT_RSZ2] = MT6985_MUTEX_MOD0_DISP_RSZ0,

		[DDP_COMPONENT_SPR0] = MT6985_MUTEX_MOD1_DISP_SPR0,
	[DDP_COMPONENT_SPR1] = MT6985_MUTEX_MOD1_DISP_SPR0,
		[DDP_COMPONENT_TDSHP0] = MT6985_MUTEX_MOD1_DISP_TDSHP0,
		[DDP_COMPONENT_TDSHP1] = MT6985_MUTEX_MOD1_DISP_TDSHP1,
	[DDP_COMPONENT_TDSHP2] = MT6985_MUTEX_MOD1_DISP_TDSHP0,
	[DDP_COMPONENT_TDSHP3] = MT6985_MUTEX_MOD1_DISP_TDSHP1,
		[DDP_COMPONENT_UFBC_WDMA0] = MT6985_MUTEX_MOD1_DISP_UFBC_WDMA1,
	[DDP_COMPONENT_UFBC_WDMA1] = MT6985_MUTEX_MOD1_DISP_UFBC_WDMA1,
		[DDP_COMPONENT_VDCM0] = MT6985_MUTEX_MOD1_DISP_VDCM0,
	[DDP_COMPONENT_VDCM1] = MT6985_MUTEX_MOD1_DISP_VDCM0,
		[DDP_COMPONENT_WDMA0] = MT6985_MUTEX_MOD1_DISP_WDMA1,
	[DDP_COMPONENT_WDMA1] = MT6985_MUTEX_MOD1_DISP_WDMA1,
		[DDP_COMPONENT_Y2R0] = MT6985_MUTEX_MOD1_DISP_Y2R0,
...
static const unsigned int mt6895_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		...
		[DDP_COMPONENT_OVL0_2L] = MT6895_MUTEX_MOD0_DISP_OVL0_2L,
		[DDP_COMPONENT_OVL1_2L] = MT6895_MUTEX_MOD0_DISP_OVL1_2L,
		[DDP_COMPONENT_OVL2_2L] = MT6895_MUTEX_MOD0_DISP_OVL0_2L,
		...
		[DDP_COMPONENT_Y2R1] = MT6895_MUTEX_MOD0_DISP_Y2R0,
		[DDP_COMPONENT_DLO_ASYNC] = MT6895_MUTEX_MOD1_DLO_ASYNC3,
		[DDP_COMPONENT_DLI_ASYNC] = MT6895_MUTEX_MOD1_DLI_ASYNC3,
		[DDP_COMPONENT_INLINE_ROTATE0] = MT6895_MUTEX_MOD1_INLINEROT0,
		[DDP_COMPONENT_INLINE_ROTATE1] = MT6895_MUTEX_MOD1_INLINEROT0,
};
...
static const unsigned int mt6879_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		[DDP_COMPONENT_OVL0] = MT6879_MUTEX_MOD_DISP_OVL0,
		[DDP_COMPONENT_OVL0_2L] = MT6879_MUTEX_MOD_DISP_OVL0_2L,
		[DDP_COMPONENT_RDMA0] = MT6879_MUTEX_MOD_DISP_RDMA0,
		[DDP_COMPONENT_RSZ0] = MT6879_MUTEX_MOD_DISP_RSZ0,
		[DDP_COMPONENT_COLOR0] = MT6879_MUTEX_MOD_DISP_COLOR0,
		[DDP_COMPONENT_CCORR0] = MT6879_MUTEX_MOD_DISP_CCORR0,
		[DDP_COMPONENT_CCORR1] = MT6879_MUTEX_MOD_DISP_CCORR1,
		[DDP_COMPONENT_TDSHP0] = MT6879_MUTEX_MOD_DISP_TDSHP0,
		[DDP_COMPONENT_C3D0] = MT6879_MUTEX_MOD_DISP_C3D0,
		[DDP_COMPONENT_AAL0] = MT6879_MUTEX_MOD_DISP_AAL0,
		[DDP_COMPONENT_GAMMA0] = MT6879_MUTEX_MOD_DISP_GAMMA0,
		[DDP_COMPONENT_POSTMASK0] = MT6879_MUTEX_MOD_DISP_POSTMASK0,
		[DDP_COMPONENT_DITHER0] = MT6879_MUTEX_MOD_DISP_DITHER0,
		[DDP_COMPONENT_CHIST0] = MT6879_MUTEX_MOD_DISP_CHIST0,
		[DDP_COMPONENT_CM0] = MT6879_MUTEX_MOD_DISP_CM0,
		[DDP_COMPONENT_SPR0] = MT6879_MUTEX_MOD_DISP_SPR0,
		[DDP_COMPONENT_DSC0] = MT6879_MUTEX_MOD_DISP_DSC_WRAP0_CORE0,
		[DDP_COMPONENT_DSI0] = MT6879_MUTEX_MOD_DISP_DSI0,
		[DDP_COMPONENT_WDMA0] = MT6879_MUTEX_MOD_DISP_WDMA0,
		[DDP_COMPONENT_UFBC_WDMA0] = MT6879_MUTEX_MOD_DISP_UFBC_WDMA0,
		[DDP_COMPONENT_OVL0_2L_NWCG] = MT6879_MUTEX_MOD_DISP_OVL0_2L_NWCG,
		[DDP_COMPONENT_OVL1_2L_NWCG] = MT6879_MUTEX_MOD_DISP_OVL1_2L_NWCG,
		[DDP_COMPONENT_RDMA1] = MT6879_MUTEX_MOD_DISP_RDMA1,
		[DDP_COMPONENT_DP_INTF0] = MT6879_MUTEX_MOD_DISP_DP_INTF0,
		[DDP_COMPONENT_DPTX] = MT6879_MUTEX_MOD_DISP_DPI0,
		[DDP_COMPONENT_WDMA1] = MT6879_MUTEX_MOD_DISP_WDMA1,
		[DDP_COMPONENT_PWM0] = MT6879_MUTEX_MOD_DISP_PWM0,
};

static const unsigned int mt6855_mutex_mod[DDP_COMPONENT_ID_MAX] = {
		[DDP_COMPONENT_OVL0] = MT6855_MUTEX_MOD_DISP_OVL0,
		[DDP_COMPONENT_OVL1_2L] = MT6855_MUTEX_MOD_DISP_OVL1_2L,
		[DDP_COMPONENT_RDMA0] = MT6855_MUTEX_MOD_DISP_RDMA0,
		[DDP_COMPONENT_RSZ0] = MT6855_MUTEX_MOD_DISP_RSZ0,
		[DDP_COMPONENT_COLOR0] = MT6855_MUTEX_MOD_DISP_COLOR0,
		[DDP_COMPONENT_CCORR0] = MT6855_MUTEX_MOD_DISP_CCORR0,
		[DDP_COMPONENT_TDSHP0] = MT6855_MUTEX_MOD_DISP_TDSHP0,
		[DDP_COMPONENT_AAL0] = MT6855_MUTEX_MOD_DISP_AAL0,
		[DDP_COMPONENT_GAMMA0] = MT6855_MUTEX_MOD_DISP_GAMMA0,
		[DDP_COMPONENT_POSTMASK0] = MT6855_MUTEX_MOD_DISP_POSTMASK0,
		[DDP_COMPONENT_DITHER0] = MT6855_MUTEX_MOD_DISP_DITHER0,
		[DDP_COMPONENT_DSC0] = MT6855_MUTEX_MOD_DISP_DSC_WRAP0_CORE0,
		[DDP_COMPONENT_DSI0] = MT6855_MUTEX_MOD_DISP_DSI0,
		[DDP_COMPONENT_WDMA0] = MT6855_MUTEX_MOD_DISP_WDMA0,
		[DDP_COMPONENT_UFBC_WDMA0] = MT6855_MUTEX_MOD_DISP_UFBC_WDMA0,
		[DDP_COMPONENT_PWM0] = MT6855_MUTEX_MOD_DISP_PWM0,
};
...
/* DISPSYS0 */
		...
		[DDP_COMPONENT_OVL0_2L_NWCG] = 0,
		[DDP_COMPONENT_OVL1_2L_NWCG] = 0,
		[DDP_COMPONENT_OVL0_2L_VIRTUAL0] = 0,
		[DDP_COMPONENT_OVL0_2L_NWCG_VIRTUAL0] = 0,
		...
		[DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL] = 0,

		[DDP_COMPONENT_INLINE_ROTATE0] = 0,
		[DDP_COMPONENT_Y2R0] = 0,
		[DDP_COMPONENT_Y2R0_VIRTUAL0] = 0,
...
/* DISPSYS1 */
		...
		[DDP_COMPONENT_OVL2_2L_NWCG] = 1,
		[DDP_COMPONENT_OVL3_2L_NWCG] = 1,
		[DDP_COMPONENT_OVL2_2L_VIRTUAL0] = 1,
		[DDP_COMPONENT_OVL2_2L_NWCG_VIRTUAL0] = 1,
		...
		[DDP_COMPONENT_MAIN_OVL_DISP1_WDMA_VIRTUAL] = 1,

		[DDP_COMPONENT_INLINE_ROTATE1] = 1,
...
static const unsigned int mt6985_module_rst_offset_map[DDP_COMPONENT_ID_MAX] = {
	...
	/* ovlsys */
		...
		//[DDP_COMPONENT_DMDP_RSZ0] = OVLSYS0,
...
/* dispsys */
		...
		[DDP_COMPONENT_AAL1] = DISPSYS1,
			[DDP_COMPONENT_C3D0] = DISPSYS0,
		[DDP_COMPONENT_C3D1] = DISPSYS1,
			[DDP_COMPONENT_CCORR0] = DISPSYS0,
		[DDP_COMPONENT_CCORR2] = DISPSYS1,
			[DDP_COMPONENT_CCORR1] = DISPSYS0,
		[DDP_COMPONENT_CCORR3] = DISPSYS1,
			[DDP_COMPONENT_CHIST0] = DISPSYS0,
		[DDP_COMPONENT_CHIST2] = DISPSYS1,
			[DDP_COMPONENT_CHIST1] = DISPSYS0,
		[DDP_COMPONENT_CHIST3] = DISPSYS1,
			[DDP_COMPONENT_COLOR0] = DISPSYS0,
		[DDP_COMPONENT_COLOR1] = DISPSYS1,
			[DDP_COMPONENT_DITHER0] = DISPSYS0,
		[DDP_COMPONENT_DITHER2] = DISPSYS1,
			[DDP_COMPONENT_DITHER1] = DISPSYS0,
		[DDP_COMPONENT_DITHER3] = DISPSYS1,
			[DDP_COMPONENT_DLI_ASYNC0] = DISPSYS0,
			[DDP_COMPONENT_DLI_ASYNC1] = DISPSYS0,
			[DDP_COMPONENT_DLI_ASYNC2] = DISPSYS0,
			[DDP_COMPONENT_DLI_ASYNC3] = DISPSYS0,
			[DDP_COMPONENT_DLI_ASYNC4] = DISPSYS0,
			[DDP_COMPONENT_DLI_ASYNC5] = DISPSYS0,
		[DDP_COMPONENT_DLI_ASYNC6] = DISPSYS1,
		[DDP_COMPONENT_DLI_ASYNC7] = DISPSYS1,
		[DDP_COMPONENT_DLI_ASYNC8] = DISPSYS1,
		[DDP_COMPONENT_DLI_ASYNC9] = DISPSYS1,
		[DDP_COMPONENT_DLI_ASYNC10] = DISPSYS1,
		[DDP_COMPONENT_DLI_ASYNC11] = DISPSYS1,
			[DDP_COMPONENT_DLO_ASYNC0] = DISPSYS0,
			[DDP_COMPONENT_DLO_ASYNC1] = DISPSYS0,
		...
		[DDP_COMPONENT_MERGE3] = DISPSYS1,
			[DDP_COMPONENT_ODDMR0] = DISPSYS0,
		[DDP_COMPONENT_ODDMR1] = DISPSYS1,
			[DDP_COMPONENT_POSTALIGN0] = DISPSYS0,
		[DDP_COMPONENT_POSTALIGN1] = DISPSYS1,
			[DDP_COMPONENT_POSTMASK0] = DISPSYS0,
		[DDP_COMPONENT_POSTMASK1] = DISPSYS1,
			[DDP_COMPONENT_PWM0] = DISPSYS0,
		[DDP_COMPONENT_PWM1] = DISPSYS1,
			[DDP_COMPONENT_RELAY0] = DISPSYS0,
		[DDP_COMPONENT_RELAY1] = DISPSYS1,
			[DDP_COMPONENT_RSZ0] = DISPSYS0,
		[DDP_COMPONENT_RSZ1] = DISPSYS1,
		[DDP_COMPONENT_RSZ2] = DISPSYS1,
			[DDP_COMPONENT_SPR0] = DISPSYS0,
		[DDP_COMPONENT_SPR1] = DISPSYS1,
			[DDP_COMPONENT_TDSHP0] = DISPSYS0,
			[DDP_COMPONENT_TDSHP1] = DISPSYS0,
		[DDP_COMPONENT_TDSHP2] = DISPSYS1,
		[DDP_COMPONENT_TDSHP3] = DISPSYS1,
			[DDP_COMPONENT_WDMA0] = DISPSYS0,
		[DDP_COMPONENT_WDMA1] = DISPSYS1,
			[DDP_COMPONENT_UFBC_WDMA0] = DISPSYS0,
		[DDP_COMPONENT_UFBC_WDMA1] = DISPSYS1,
			[DDP_COMPONENT_VDCM0] = DISPSYS0,
		[DDP_COMPONENT_VDCM1] = DISPSYS1,
			[DDP_COMPONENT_Y2R0] = DISPSYS0,
		[DDP_COMPONENT_Y2R1] = DISPSYS1,
/* ovlsys */
			[DDP_COMPONENT_OVL0_2L] = OVLSYS0,
			[DDP_COMPONENT_OVL1_2L] = OVLSYS0,
			[DDP_COMPONENT_OVL2_2L] = OVLSYS0,
			[DDP_COMPONENT_OVL3_2L] = OVLSYS0,
		[DDP_COMPONENT_OVL4_2L] = OVLSYS1,
		[DDP_COMPONENT_OVL5_2L] = OVLSYS1,
		[DDP_COMPONENT_OVL6_2L] = OVLSYS1,
		[DDP_COMPONENT_OVL7_2L] = OVLSYS1,
			[DDP_COMPONENT_OVLSYS_RSZ1] = OVLSYS0,
		[DDP_COMPONENT_OVLSYS_RSZ2] = OVLSYS1,
			[DDP_COMPONENT_DMDP_RSZ0] = OVLSYS0,
		[DDP_COMPONENT_DMDP_RSZ1] = OVLSYS1,
		...
		[DDP_COMPONENT_OVLSYS_UFBC_WDMA1] = OVLSYS1,
			[DDP_COMPONENT_OVLSYS_DLI_ASYNC0] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLI_ASYNC1] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLI_ASYNC2] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLO_ASYNC0] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLO_ASYNC1] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLO_ASYNC2] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLO_ASYNC3] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLO_ASYNC4] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLO_ASYNC5] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_DLO_ASYNC6] = OVLSYS0,
		[DDP_COMPONENT_OVLSYS_DLI_ASYNC3] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLI_ASYNC4] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLI_ASYNC5] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC7] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC8] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC9] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC10] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC11] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC12] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_DLO_ASYNC13] = OVLSYS1,
			[DDP_COMPONENT_INLINE_ROTATE0] = OVLSYS0,
		[DDP_COMPONENT_INLINE_ROTATE1] = OVLSYS1,
			[DDP_COMPONENT_OVLSYS_Y2R0] = OVLSYS0,
			[DDP_COMPONENT_OVLSYS_Y2R1] = OVLSYS0,
		[DDP_COMPONENT_OVLSYS_Y2R2] = OVLSYS1,
		[DDP_COMPONENT_OVLSYS_Y2R3] = OVLSYS1,
		[DDP_COMPONENT_MDP_RSZ0] = OVLSYS0,
		[DDP_COMPONENT_MDP_RSZ1] = OVLSYS1,
/* crossbar */
		[DDP_COMPONENT_OVL0_BLEND_CB0] = OVLSYS0,
		[DDP_COMPONENT_OVL0_BLEND_CB1] = OVLSYS0,
		[DDP_COMPONENT_OVL0_BLEND_CB2] = OVLSYS0,
		[DDP_COMPONENT_OVL0_BLEND_CB3] = OVLSYS0,
		[DDP_COMPONENT_OVL1_BLEND_CB0] = OVLSYS1,
		[DDP_COMPONENT_OVL1_BLEND_CB1] = OVLSYS1,
		[DDP_COMPONENT_OVL1_BLEND_CB2] = OVLSYS1,
		[DDP_COMPONENT_OVL1_BLEND_CB3] = OVLSYS1,
		[DDP_COMPONENT_OVL0_BG_CB0] = OVLSYS0,
		[DDP_COMPONENT_OVL0_BG_CB1] = OVLSYS0,
		[DDP_COMPONENT_OVL0_BG_CB2] = OVLSYS0,
		[DDP_COMPONENT_OVL0_BG_CB3] = OVLSYS0,
		[DDP_COMPONENT_OVL0_BG_CB4] = OVLSYS0,
		[DDP_COMPONENT_OVL1_BG_CB0] = OVLSYS1,
		[DDP_COMPONENT_OVL1_BG_CB1] = OVLSYS1,
		[DDP_COMPONENT_OVL1_BG_CB2] = OVLSYS1,
		[DDP_COMPONENT_OVL1_BG_CB3] = OVLSYS1,
		[DDP_COMPONENT_OVL1_BG_CB4] = OVLSYS1,
		[DDP_COMPONENT_OVL0_PQ_OUT_CB0] = OVLSYS0,
		[DDP_COMPONENT_OVL0_PQ_OUT_CB1] = OVLSYS0,
		[DDP_COMPONENT_OVL0_PQ_OUT_CB2] = OVLSYS0,
		[DDP_COMPONENT_OVL0_PQ_OUT_CB3] = OVLSYS0,
		[DDP_COMPONENT_OVL1_PQ_OUT_CB0] = OVLSYS1,
		[DDP_COMPONENT_OVL1_PQ_OUT_CB1] = OVLSYS1,
		[DDP_COMPONENT_OVL1_PQ_OUT_CB2] = OVLSYS1,
		[DDP_COMPONENT_OVL1_PQ_OUT_CB3] = OVLSYS1,
		[DDP_COMPONENT_OVL0_PQ_IN_CB0] = OVLSYS0,
		[DDP_COMPONENT_OVL0_PQ_IN_CB1] = OVLSYS0,
		[DDP_COMPONENT_OVL0_PQ_IN_CB2] = OVLSYS0,
		[DDP_COMPONENT_OVL1_PQ_IN_CB0] = OVLSYS1,
		[DDP_COMPONENT_OVL1_PQ_IN_CB1] = OVLSYS1,
		[DDP_COMPONENT_OVL1_PQ_IN_CB2] = OVLSYS1,
		[DDP_COMPONENT_PQ0_IN_CB0] = DISPSYS0,
		[DDP_COMPONENT_PQ0_IN_CB1] = DISPSYS0,
		[DDP_COMPONENT_PQ0_IN_CB2] = DISPSYS0,
		[DDP_COMPONENT_PQ0_IN_CB3] = DISPSYS0,
		[DDP_COMPONENT_PQ0_IN_CB4] = DISPSYS0,
		[DDP_COMPONENT_PQ1_IN_CB0] = DISPSYS1,
		[DDP_COMPONENT_PQ1_IN_CB1] = DISPSYS1,
		[DDP_COMPONENT_PQ1_IN_CB2] = DISPSYS1,
		[DDP_COMPONENT_PQ1_IN_CB3] = DISPSYS1,
		[DDP_COMPONENT_PQ1_IN_CB4] = DISPSYS1,
		...
		[DDP_COMPONENT_PQ1_OUT_CB0] = DISPSYS1,
		[DDP_COMPONENT_PQ1_OUT_CB1] = DISPSYS1,
		[DDP_COMPONENT_PQ1_OUT_CB2] = DISPSYS1,
		[DDP_COMPONENT_PQ1_OUT_CB3] = DISPSYS1,
		[DDP_COMPONENT_PQ1_OUT_CB4] = DISPSYS1,
		[DDP_COMPONENT_PANEL0_COMP_OUT_CB0] = DISPSYS0,
		[DDP_COMPONENT_PANEL0_COMP_OUT_CB1] = DISPSYS0,
		[DDP_COMPONENT_PANEL0_COMP_OUT_CB2] = DISPSYS0,
		[DDP_COMPONENT_PANEL0_COMP_OUT_CB3] = DISPSYS0,
		[DDP_COMPONENT_PANEL0_COMP_OUT_CB4] = DISPSYS0,
		[DDP_COMPONENT_PANEL1_COMP_OUT_CB0] = DISPSYS1,
		[DDP_COMPONENT_PANEL1_COMP_OUT_CB1] = DISPSYS1,
		[DDP_COMPONENT_PANEL1_COMP_OUT_CB2] = DISPSYS1,
		[DDP_COMPONENT_PANEL1_COMP_OUT_CB3] = DISPSYS1,
		[DDP_COMPONENT_PANEL1_COMP_OUT_CB4] = DISPSYS1,
		...
		[DDP_COMPONENT_COMP0_OUT_CB5] = DISPSYS0,
		[DDP_COMPONENT_COMP0_OUT_CB6] = DISPSYS0,
		[DDP_COMPONENT_COMP0_OUT_CB7] = DISPSYS0,
		[DDP_COMPONENT_COMP1_OUT_CB0] = DISPSYS1,
		[DDP_COMPONENT_COMP1_OUT_CB1] = DISPSYS1,
		[DDP_COMPONENT_COMP1_OUT_CB2] = DISPSYS1,
		[DDP_COMPONENT_COMP1_OUT_CB3] = DISPSYS1,
		[DDP_COMPONENT_COMP1_OUT_CB4] = DISPSYS1,
		[DDP_COMPONENT_COMP1_OUT_CB5] = DISPSYS1,
		[DDP_COMPONENT_COMP1_OUT_CB6] = DISPSYS1,
		[DDP_COMPONENT_COMP1_OUT_CB7] = DISPSYS1,
		[DDP_COMPONENT_MERGE0_OUT_CB0] = DISPSYS0,
		[DDP_COMPONENT_MERGE0_OUT_CB1] = DISPSYS0,
		[DDP_COMPONENT_MERGE0_OUT_CB2] = DISPSYS0,
		[DDP_COMPONENT_MERGE0_OUT_CB3] = DISPSYS0,
		[DDP_COMPONENT_MERGE0_OUT_CB4] = DISPSYS0,
		[DDP_COMPONENT_MERGE0_OUT_CB5] = DISPSYS0,
		[DDP_COMPONENT_MERGE0_OUT_CB6] = DISPSYS0,
		[DDP_COMPONENT_MERGE0_OUT_CB7] = DISPSYS0,
		[DDP_COMPONENT_MERGE1_OUT_CB0] = DISPSYS1,
		[DDP_COMPONENT_MERGE1_OUT_CB1] = DISPSYS1,
		[DDP_COMPONENT_MERGE1_OUT_CB2] = DISPSYS1,
		[DDP_COMPONENT_MERGE1_OUT_CB3] = DISPSYS1,
		[DDP_COMPONENT_MERGE1_OUT_CB4] = DISPSYS1,
		[DDP_COMPONENT_MERGE1_OUT_CB5] = DISPSYS1,
		[DDP_COMPONENT_MERGE1_OUT_CB6] = DISPSYS1,
...
static const unsigned int mt6885_mutex_sof[DDP_MUTEX_SOF_MAX] = {
		...
		[DDP_MUTEX_SOF_DSI1] =
			MT6885_MUTEX_SOF_DSI1 | MT6885_MUTEX_EOF_DSI1,
		[DDP_MUTEX_SOF_DPI0] =
...
static const unsigned int mt6985_mutex_ovlsys_sof[DDP_MUTEX_SOF_MAX] = {
		[DDP_MUTEX_SOF_SINGLE_MODE] = MT6985_MUTEX_SOF_SINGLE_MODE,
		[DDP_MUTEX_SOF_DSI0] =
			MT6985_MUTEX_OVLSYS_SOF_DSI0 | MT6985_MUTEX_OVLSYS_EOF_DSI0,
		[DDP_MUTEX_SOF_DSI1] =
			MT6985_MUTEX_OVLSYS_SOF_DSI1 | MT6985_MUTEX_OVLSYS_EOF_DSI1,
		[DDP_MUTEX_SOF_DPI0] =
			MT6985_MUTEX_OVLSYS_SOF_DPI0 | MT6985_MUTEX_OVLSYS_EOF_DPI0,
		[DDP_MUTEX_SOF_DPI1] =
			MT6985_MUTEX_OVLSYS_SOF_DPI1 | MT6985_MUTEX_OVLSYS_EOF_DPI1,
};
...
static const unsigned int mt6895_mutex_sof[DDP_MUTEX_SOF_MAX] = {
		...
		[DDP_MUTEX_SOF_DPI1] =
			MT6895_MUTEX_SOF_DPI1 | MT6895_MUTEX_EOF_DPI1,
};
...
static const unsigned int mt6879_mutex_sof[DDP_MUTEX_SOF_MAX] = {
		[DDP_MUTEX_SOF_SINGLE_MODE] = MT6879_MUTEX_SOF_SINGLE_MODE,
		[DDP_MUTEX_SOF_DSI0] =
			MT6879_MUTEX_SOF_DSI0 | MT6879_MUTEX_EOF_DSI0,
};

static const unsigned int mt6855_mutex_sof[DDP_MUTEX_SOF_MAX] = {
		[DDP_MUTEX_SOF_SINGLE_MODE] = MT6855_MUTEX_SOF_SINGLE_MODE,
		[DDP_MUTEX_SOF_DSI0] =
			MT6855_MUTEX_SOF_DSI0 | MT6855_MUTEX_EOF_DSI0,
};
...
static const struct mtk_disp_ddp_data mt6985_ddp_driver_data = {
	.mutex_mod = mt6985_mutex_mod,
	.mutex_ovlsys_mod = mt6985_ovlsys_mutex_mod,
	.mutex_sof = mt6985_mutex_sof,
	.mutex_ovlsys_sof = mt6985_mutex_ovlsys_sof,
	.mutex_mod_reg = MT6983_DISP_MUTEX0_MOD0,
	.mutex_sof_reg = MT6983_DISP_MUTEX0_SOF,
...
static const struct mtk_disp_ddp_data mt6879_ddp_driver_data = {
	.mutex_mod = mt6879_mutex_mod,
	.mutex_sof = mt6879_mutex_sof,
	.mutex_mod_reg = MT6879_DISP_MUTEX0_MOD0,
	.mutex_sof_reg = MT6879_DISP_MUTEX0_SOF,
};

static const struct mtk_disp_ddp_data mt6855_ddp_driver_data = {
	.mutex_mod = mt6855_mutex_mod,
	.mutex_sof = mt6855_mutex_sof,
	.mutex_mod_reg = MT6855_DISP_MUTEX0_MOD0,
...
const struct mtk_mmsys_reg_data mt6985_mmsys_reg_data = {
	// To-Do
	.rdma0_sout_sel_in = MT6983_DISP_RDMA0_SEL_IN,
	.dispsys_map = mt6985_dispsys_map,
...
const struct mtk_mmsys_reg_data mt6879_mmsys_reg_data = {
	.ovl0_mout_en = MT6879_DISP_OVL0_MOUT_EN,
	.rdma0_sout_sel_in = MT6879_DISP_RDMA0_SOUT_SEL,
	.rdma0_sout_color0 = MT6879_DISP_RDMA0_SOUT_COLOR0,
};

const struct mtk_mmsys_reg_data mt6855_mmsys_reg_data = {
	.ovl0_mout_en = MT6855_MMSYS_OVL_CON,
	.rdma0_sout_sel_in = MT6855_DISP_RDMA0_SOUT_SEL,
	.rdma0_sout_color0 = MT6855_DISP_RDMA0_SOUT_TO_DISP_TDSHP0,
};
...
static char *ddp_signal_0_mt6879(int bit)
{
	switch (bit) {
	case 0:
		return
...
static char *ddp_signal_0_mt6855(int bit)
{
	switch (bit) {
	case 0:
		return
...
static char *ddp_signal_1_mt6855(int bit)
{
	switch (bit) {
	case 0:
		return
...
static char *ddp_greq_name_larb0_mt6879(int bit)
{
	switch (bit) {
	case 0:
		return "DISP_POSTMASK0 ";
...
static char *ddp_greq_name_larb1_mt6879(int bit)
{
	switch (bit) {
	case 0:
		return "DISP_OVL0_2L_HDR ";
...
static char *ddp_greq_name_larb0_mt6855(int bit)
{
	switch (bit) {
	case 0:
		return "DISP_POSTMASK0 ";
...
static char *ddp_greq_name_larb1_mt6855(int bit)
{
	switch (bit) {
	case 0:
		return "DISP_OVL0_2L_HDR ";
...
static char *ddp_get_mutex_module0_name_mt6985(unsigned int bit)
{
	switch (bit) {
	case 0:
		return "disp_aal0";
...
static char *ddp_get_mutex_module1_name_mt6985(unsigned int bit)
{
	switch (bit) {
	case 0:
		return "disp_spr0";
...
static char *ddp_get_mutex_module0_name_mt6879(unsigned int bit)
{
	switch (bit) {
	case 0:
		return "disp_ovl0";
...
static char *ddp_get_mutex_module1_name_mt6879(unsigned int bit)
{
	switch (bit) {
	case 0:
		return "inlinerot0";
...
static char *ddp_get_mutex_module0_name_mt6855(unsigned int bit)
{
	switch (bit) {
	case 0:
		return "disp_ovl0";
...
static char *ddp_get_mutex_module1_name_mt6855(unsigned int bit)
{
	switch (bit) {
	case 0:
		return "inlinerot0";
...
char *mtk_ddp_get_mutex_sof_name_mt6985(unsigned int regval)
{
	switch (regval) {
	case MT6983_MUTEX_SOF_SINGLE_MODE:
		return "single";
...
char *mtk_ddp_get_mutex_sof_name_mt6895(unsigned int regval)
{
	...
	case MT6895_MUTEX_SOF_DSI0:
		return "dsi0";
	case MT6895_MUTEX_SOF_DSI1:
		return "dsi1";
	case MT6895_MUTEX_SOF_DPI0:
		return "dpi0";
	case MT6895_MUTEX_SOF_DPI1:
		return "dpi1";
	default:
		DDPDUMP("%s, unknown reg=%d\n", __func__, regval);
		return "unknown";
...
char *mtk_ddp_get_mutex_sof_name_mt6879(unsigned int regval)
{
	switch (regval) {
	case MUTEX_SOF_SINGLE_MODE:
		return "single";
...
char *mtk_ddp_get_mutex_sof_name_mt6855(unsigned int regval)
{
	switch (regval) {
	case MUTEX_SOF_SINGLE_MODE:
		return "single";
...
static char *ddp_clock_0_mt6879(int bit)
{
	switch (bit) {
	case 0:
		return "disp_mutex0, ";
...
static char *ddp_clock_1_mt6879(int bit)
{
	switch (bit) {
	case 0:
		return "reserve, ";
...
static char *ddp_clock_0_mt6855(int bit)
{
	switch (bit) {
	case 0:
		return "disp_mutex0, ";
...
static char *ddp_clock_1_mt6855(int bit)
{
	switch (bit) {
	case 0:
		return "reserve, ";
			   ...
			   unsigned int *addr)
{
	...
	if ((cur == DDP_COMPONENT_OVL0_2L && next == DDP_COMPONENT_OVL1_2L) ||
		...
		*addr = MT6983_MMSYS_OVL_CON;
		...
		next == DDP_COMPONENT_OVL0) || (cur == DDP_COMPONENT_OVL3_2L &&
		next == DDP_COMPONENT_OVL1)){
		*addr = MT6983_MMSYS_OVL_CON;
		value = DISP_OVL1_2L_TO_DISP_OVL0;
	} else if ((cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_OVL0) || (cur == DDP_COMPONENT_OVL2_2L &&
		next == DDP_COMPONENT_OVL1)) {
		*addr = MT6983_MMSYS_OVL_CON;
		value = DISP_OVL0_2L_TO_DISP_OVL0;
	} else if ((cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_OVL0_VIRTUAL0) || (cur == DDP_COMPONENT_OVL1 &&
		next == DDP_COMPONENT_OVL1_VIRTUAL0)) {
		*addr = MT6983_MMSYS_OVL_CON;
		value = DISP_OVL0_TO_DISP_OVL0_BLENDOUT_MOUT;
	} else if ((cur == DDP_COMPONENT_OVL0_2L_NWCG &&
		next == DDP_COMPONENT_OVL0_2L_NWCG_VIRTUAL0) ||
		(cur == DDP_COMPONENT_OVL2_2L_NWCG &&
		next == DDP_COMPONENT_OVL2_2L_NWCG_VIRTUAL0)) {
		*addr = MT6983_MMSYS_OVL_CON;
		value = DISP_OVL0_2L_NWCG_TO_DISP_OVL0_2L_NWCG_BLEND_MOUT;
	} else if ((cur == DDP_COMPONENT_OVL0_VIRTUAL0 &&
		next == DDP_COMPONENT_OVL0_VIRTUAL1) ||
		(cur == DDP_COMPONENT_OVL1_VIRTUAL0 &&
		next == DDP_COMPONENT_OVL1_VIRTUAL1)) {
		*addr = MT6983_DISP_OVL0_BLEND_MOUT_EN;
		...
		next == DDP_COMPONENT_RDMA0) ||
		(cur == DDP_COMPONENT_OVL1_VIRTUAL1 &&
		next == DDP_COMPONENT_RDMA2)) {
		*addr = MT6983_DISP_RDMA0_POS_MOUT_EN;
		...
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_RDMA0_POS))
			value |= DISP_RDMA0_POS_MOUT_EN_TO_DISP_CHIST0_SEL_IN;
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST1_FROM_RDMA0_POS))
			value |= DISP_RDMA0_POS_MOUT_EN_TO_DISP_CHIST1_SEL_IN;
	} else if ((cur == DDP_COMPONENT_POSTMASK0 &&
		next == DDP_COMPONENT_DITHER0) ||
		(cur == DDP_COMPONENT_POSTMASK1 &&
		next == DDP_COMPONENT_DITHER1)) {
		*addr = MT6983_DISP_POSTMASK0_MOUT_EN;
		value = DISP_POSTMASK0_MOUT_EN_TO_DISP_DITHER0;
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_POSTMASK0))
			value |= DISP_POSTMASK0_MOUT_EN_TO_DISP_CHIST0_SEL_IN;
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST1_FROM_POSTMASK0))
			value |= DISP_POSTMASK0_MOUT_EN_TO_DISP_CHIST1_SEL_IN;
	} else if ((cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_CM0) ||
		(cur == DDP_COMPONENT_DITHER1 &&
		next == DDP_COMPONENT_CM1)) {
		*addr = MT6983_DISP_DITHER0_MOUT_EN;
		value = DISP_DITHER0_MOUT_EN_TO_DISP_CM0;
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_DITHER0))
			value |= DISP_DITHER0_MOUT_EN_TO_DISP_CHIST0_SEL_IN;
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST1_FROM_DITHER0))
			value |= DISP_DITHER0_MOUT_EN_TO_DISP_CHIST1_SEL_IN;
	} else if ((cur == DDP_COMPONENT_SPR0 &&
		next == DDP_COMPONENT_PQ0_VIRTUAL) ||
		(cur == DDP_COMPONENT_SPR1 &&
		next == DDP_COMPONENT_PQ1_VIRTUAL)) {
		*addr = MT6983_DISP_SPR0_MOUT_EN;
		value = DISP_SPR0_MOUT_EN_TO_DISP_PQ0_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_OVL1_2L_NWCG &&
		next == DDP_COMPONENT_WDMA1) ||
		(cur == DDP_COMPONENT_OVL3_2L_NWCG &&
		next == DDP_COMPONENT_WDMA3)) {
		*addr = MT6983_MMSYS_OVL_CON;
		value = DISP_OVL1_2L_NWCG_TO_DISP_WDMA1;
	} else if ((cur == DDP_COMPONENT_SPR0 &&
		next == DDP_COMPONENT_WDMA0) ||
		(cur == DDP_COMPONENT_SPR1 &&
		...
		*addr = MT6983_DISP_SPR0_MOUT_EN;
		...
		next == DDP_COMPONENT_OVL2_2L_VIRTUAL0)) {
		*addr = MT6983_MMSYS_OVL_CON;
		value = DISP_OVL0_2L_TO_DISP_OVL1_2L_BLENDOUT_MOUT;
	} else if ((cur == DDP_COMPONENT_OVL0_2L_VIRTUAL0 &&
		next == DDP_COMPONENT_RSZ0) ||
		(cur == DDP_COMPONENT_OVL2_2L_VIRTUAL0 &&
		next == DDP_COMPONENT_RSZ1)) {
		*addr = MT6983_DISP_OVL1_2L_BLEND_MOUT_EN;
		value = DISP_OVL1_2L_BLEND_MOUT_EN_TO_DISP_RSZ0_SEL_IN;
	} else if ((cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) ||
		(cur == DDP_COMPONENT_RSZ1 &&
		next == DDP_COMPONENT_OVL1)) {
		*addr = MT6983_DISP_RSZ0_MOUT_EN;
		value = DISP_RSZ0_MOUT_EN_TO_DISP_RSZ0_MAIN_OVL_SOUT_SEL;
		...
		*addr = MT6983_DISP_OVL0_2L_NWCG_MOUT_EN;
		value = DISP_OVL0_2L_NWCG_MOUT_EN_TO_DISP_RDMA1_POS_SEL_IN;
	} else if ((cur == DDP_COMPONENT_OVL0_2L_NWCG_VIRTUAL0 &&
		next == DDP_COMPONENT_RDMA1) ||
		(cur == DDP_COMPONENT_OVL2_2L_NWCG_VIRTUAL0 &&
		...
		*addr = MT6983_DISP_OVL0_2L_BLEND_MOUT_EN;
		...
		next == DDP_COMPONENT_Y2R0_VIRTUAL0) ||
		(cur == DDP_COMPONENT_Y2R1 &&
		next == DDP_COMPONENT_Y2R1_VIRTUAL0)) {
		*addr = MT6983_DISP_Y2R0_MOUT_EN;
		value = DISP_Y2R0_MOUT_TO_DMDP_MAIN_OVL_SOUT;
	} else if ((cur == DDP_COMPONENT_OVL0_VIRTUAL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL) ||
		(cur == DDP_COMPONENT_OVL1_VIRTUAL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP1_WDMA_VIRTUAL)) {
		*addr = MT6983_DISP_OVL0_BLEND_MOUT_EN;
		value = DISP_OVL0_BLEND_MOUT_EN_TO_DISP_MAIN_OVL_DISP_WDMA_SEL;
	} else if ((cur == DDP_COMPONENT_MERGE0 &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) ||
		(cur == DDP_COMPONENT_MERGE1 &&
		next == DDP_COMPONENT_MAIN1_VIRTUAL)) {
		*addr = MT6983_DISP_MERGE0_MOUT_EN;
		value = DISP_MERGE0_MOUT_EN_TO_DISP_MAIN0_SEL_IN;
	} else {
		value = -1;
	}
			  ...
			  unsigned int *addr)
{
	...
	if ((cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_OVL0_VIRTUAL0) ||
		...
		*addr = MT6983_DISP_RDMA0_SEL_IN;
		...
		next == DDP_COMPONENT_DSI0) ||
		(cur == DDP_COMPONENT_RDMA2_OUT_RELAY &&
		next == DDP_COMPONENT_DSI1)) {
		...
		*addr = MT6983_DISP_DSI0_SEL_IN;
		...
		(cur == DDP_COMPONENT_RDMA2 &&
		next == DDP_COMPONENT_TDSHP1)) {
		*addr = MT6983_DISP_RDMA0_POS_SEL_IN;
		value = DISP_RDMA0_POS_SEL_IN_FROM_DISP_RDMA0_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_TDSHP0 &&
		next == DDP_COMPONENT_COLOR0) ||
		(cur == DDP_COMPONENT_TDSHP1 &&
		next == DDP_COMPONENT_COLOR1)) {
		*addr = MT6983_DISP_COLOR0_SEL_IN;
		value = DISP_COLOR0_SEL_IN_FROM_DISP_TDSHP0_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_CCORR1 &&
		next == DDP_COMPONENT_C3D0) ||
		(cur == DDP_COMPONENT_CCORR3 &&
		next == DDP_COMPONENT_C3D1)) {
		*addr = MT6983_DISP_C3D0_SEL_IN;
		value = DISP_C3D0_SEL_IN_FROM_DISP_CCORR1_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_C3D0 &&
		next == DDP_COMPONENT_DMDP_AAL0) ||
		(cur == DDP_COMPONENT_C3D1 &&
		next == DDP_COMPONENT_DMDP_AAL1)) {
		*addr = MT6983_DISP_MDP_ALL0_SEL_IN;
		value = DISP_MDP_ALL0_SEL_IN_FROM_DISP_C3D0_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_PQ0_VIRTUAL &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) ||
		(cur == DDP_COMPONENT_PQ1_VIRTUAL &&
		next == DDP_COMPONENT_MAIN1_VIRTUAL)) {
		*addr = MT6983_DISP_MAIN0_SEL_IN;
		value = DISP_MAIN0_SEL_IN_FROM_DISP_PQ0_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) ||
		(cur == DDP_COMPONENT_RDMA3 &&
		next == DDP_COMPONENT_MAIN1_VIRTUAL)) {
		*addr = MT6983_DISP_MAIN0_SEL_IN;
		...
		*addr = MT6983_DISP_CHIST0_SEL_IN;
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_RDMA0_POS))
			value = DISP_CHIST0_SEL_IN_FROM_DISP_RDMA0_POS_MOUT_EN;
		else if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_POSTMASK0))
			value = DISP_CHIST0_SEL_IN_FROM_DISP_POSTMASK0_MOUT_EN;
		else if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_DITHER0))
			value = DISP_CHIST0_SEL_IN_FROM_DISP_DITHER0_MOUT_EN;
	} else if ((cur == DDP_COMPONENT_CHIST0 &&
		next == DDP_COMPONENT_CHIST1) || (cur == DDP_COMPONENT_CHIST2 &&
		next == DDP_COMPONENT_CHIST3)) {
		*addr = MT6983_DISP_CHIST1_SEL_IN;
		if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST1_FROM_RDMA0_POS))
			value = DISP_CHIST1_SEL_IN_FROM_DISP_RDMA0_POS_MOUT_EN;
		else if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST1_FROM_POSTMASK0))
			value = DISP_CHIST1_SEL_IN_FROM_DISP_POSTMASK0_MOUT_EN;
		else if (MT6983_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST1_FROM_DITHER0))
			value = DISP_CHIST1_SEL_IN_FROM_DISP_DITHER0_MOUT_EN;
	} else if ((cur == DDP_COMPONENT_OVL1_2L_NWCG &&
		next == DDP_COMPONENT_WDMA1) || (cur == DDP_COMPONENT_OVL3_2L_NWCG &&
		next == DDP_COMPONENT_WDMA3)) {
		*addr = MT6983_DISP_WDMA1_SEL_IN;
		...
		*addr = MT6983_DISP_WDMA0_SEL_IN;
		...
		next == DDP_COMPONENT_RSZ0) || (cur == DDP_COMPONENT_OVL2_2L_VIRTUAL0 &&
		next == DDP_COMPONENT_RSZ1)) {
		*addr = MT6983_DISP_RSZ0_SEL_IN;
		...
		*addr = MT6983_DISP_RDMA1_SEL_IN;
		...
		next == DDP_COMPONENT_TV0_VIRTUAL) || (cur == DDP_COMPONENT_RDMA3 &&
		next == DDP_COMPONENT_TV1_VIRTUAL)) {
		*addr = MT6983_DISP_RDMA1_POS_SEL_IN;
		value = DISP_RDMA1_POS_SEL_IN_FROM_DISP_RDMA1_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_SUB0_VIRTUAL1) || (cur == DDP_COMPONENT_RDMA3 &&
		next == DDP_COMPONENT_SUB1_VIRTUAL1)) {
		*addr = MT6983_DISP_DP_INTF0_SEL_IN;
		value = DISP_DP_INTF0_SEL_IN_FROM_DISP_RDMA1_SOUT_SEL;
	} else if ((cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) || (cur == DDP_COMPONENT_RSZ1 &&
		next == DDP_COMPONENT_OVL1)) {
		...
		*addr = MT6983_DISP_MAIN_OVL_DMDP_SEL_IN;
		...
		next == DDP_COMPONENT_OVL1)) {
		*addr = MT6983_DISP_OVL0_UFOD_SEL_IN;
		value = DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SIN;
	} else if ((cur == DDP_COMPONENT_OVL0_VIRTUAL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL) ||
		(cur == DDP_COMPONENT_OVL1_VIRTUAL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP1_WDMA_VIRTUAL)) {
		*addr = MT6983_DISP_MAIN_OVL_DISP_WDMA_SEL_IN;
		value = DISP_OVL0_BLEND_MOUT_TO_DISP_MAIN_OVL_DISP_WDMA_SEL_IN;
	} else if ((cur == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL &&
		next == DDP_COMPONENT_WDMA0) ||
		(cur == DDP_COMPONENT_MAIN_OVL_DISP1_WDMA_VIRTUAL &&
		next == DDP_COMPONENT_WDMA2)) {
		*addr = MT6983_DISP_WDMA0_SEL_IN;
		value = DISP_WDMA0_SEL_IN_FROM_DISP_MAIN_OVL_DISP_WDMA_SEL_IN;
			    ...
			    unsigned int *addr)
{
	...
	if ((cur == DDP_COMPONENT_RDMA0 &&
		...
		(cur == DDP_COMPONENT_RDMA2 &&
		next == DDP_COMPONENT_RDMA2_OUT_RELAY)) {
		*addr = MT6983_DISP_RDMA0_SOUT_SEL;
		...
		next == DDP_COMPONENT_TDSHP1)) {
		*addr = MT6983_DISP_RDMA0_SOUT_SEL;
		value = DISP_RDMA0_SOUT_SEL_TO_DISP_RDMA0_POS_SEL_IN;
	} else if ((cur == DDP_COMPONENT_TDSHP0 &&
		next == DDP_COMPONENT_COLOR0) ||
		(cur == DDP_COMPONENT_TDSHP1 &&
		next == DDP_COMPONENT_COLOR1)) {
		*addr = MT6983_DISP_TDSHP0_SOUT_SEL;
		value = DISP_TDSHP0_SOUT_SEL_TO_DISP_COLOR0_SEL_IN;
	} else if ((cur == DDP_COMPONENT_CCORR1 &&
		next == DDP_COMPONENT_C3D0) ||
		(cur == DDP_COMPONENT_CCORR3 &&
		next == DDP_COMPONENT_C3D1)) {
		*addr = MT6983_DISP_CCORR1_SOUT_SEL;
		value = DISP_CCORR1_SOUT_SEL_TO_DISP_C3D0_SEL_IN;
	} else if ((cur == DDP_COMPONENT_C3D0 &&
		next == DDP_COMPONENT_DMDP_AAL0) ||
		(cur == DDP_COMPONENT_C3D1 &&
		next == DDP_COMPONENT_DMDP_AAL1)) {
		*addr = MT6983_DISP_C3D0_SOUT_SEL;
		value = DISP_C3D0_SOUT_SEL_TO_DISP_MDP_ALL0_SEL_IN;
	} else if ((cur == DDP_COMPONENT_PQ0_VIRTUAL &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) ||
		(cur == DDP_COMPONENT_PQ1_VIRTUAL &&
		next == DDP_COMPONENT_MAIN1_VIRTUAL)) {
		*addr = MT6983_DISP_PQ0_SOUT_SEL;
		value = DISP_PQ0_SOUT_SEL_TO_DISP_MAIN0_SEL_IN;
	} else if ((cur == DDP_COMPONENT_PQ0_VIRTUAL &&
		...
		*addr = MT6983_DISP_MAIN0_SOUT_SEL;
		...
		next == DDP_COMPONENT_OVL0) || (cur == DDP_COMPONENT_RSZ1 &&
		next == DDP_COMPONENT_OVL1)) {
		*addr = MT6983_DISP_RSZ0_MAIN_OVL_SOUT_SEL;
		value = DISP_RSZ0_MAIN_OVL_SOUT_SEL_TO_DISP_OVL0_UFOD_SEL_IN;
	} else if ((cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_SUB0_VIRTUAL1) ||
		(cur == DDP_COMPONENT_RDMA3 &&
		next == DDP_COMPONENT_SUB1_VIRTUAL1)) {
		*addr = MT6983_DISP_RDMA1_SOUT_SEL;
		value = DISP_RDMA1_SOUT_SEL_TO_DISP_RDMA1_OUT_RELAY;
	} else if ((cur == DDP_COMPONENT_RDMA1 &&
		next == DDP_COMPONENT_TV0_VIRTUAL) ||
		(cur == DDP_COMPONENT_RDMA3 &&
		next == DDP_COMPONENT_TV1_VIRTUAL)) {
		*addr = MT6983_DISP_RDMA1_SOUT_SEL;
		...
		next == DDP_COMPONENT_MAIN1_VIRTUAL)) {
		*addr = MT6983_DISP_RDMA1_SOUT_SEL;
		value = DISP_RDMA1_SOUT_SEL_TO_DISP_MAIN0_SEL_IN;
	} else if (cur == DDP_COMPONENT_SUB1_VIRTUAL1 &&
		next == DDP_COMPONENT_DP_INTF0) {
		...
		*addr = MT6983_DISP_SUB0_TX_SOUT_SEL;
		...
		(cur == DDP_COMPONENT_Y2R1_VIRTUAL0 &&
		next == DDP_COMPONENT_OVL1)) {
		*addr = MT6983_DMDP_MAIN_OVL_SOUT_SEL;
		value = DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SOUT;
	} else if ((cur == DDP_COMPONENT_DLI_ASYNC2 &&
		next == DDP_COMPONENT_MERGE0) ||
		(cur == DDP_COMPONENT_DLI_ASYNC6 &&
		next == DDP_COMPONENT_MERGE1)) {
...
static int mtk_ddp_ovl_con_MT6985(enum mtk_ddp_comp_id cur,
...
static int mtk_ddp_ovl_blend_cb_MT6985(enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
				unsigned int *addr)
{
	...
	case DDP_COMPONENT_OVL4_2L:
		*addr = MT6985_OVL_BLEND_CROSSBAR0_MOUT_EN;
		break;
	...
	default:
		value = -1;
		DDPPR_ERR("%s, cur=%s->next=%s not found in BLEND_cb\n", __func__,
	...
	switch (next) {
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC3:
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC10:
		value = BIT(0);
		break;
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC4:
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC11:
		value = BIT(1);
		break;
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC5:
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC12:
		value = BIT(2);
		break;
	case DDP_COMPONENT_DMDP_RSZ0:
	case DDP_COMPONENT_DMDP_RSZ1:
		value = BIT(3);
		break;
	...
	case DDP_COMPONENT_OVLSYS_WDMA2:
		value = BIT(4);
		break;
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC6:
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC13:
		value = BIT(6);
		break;
	default:
		value = -1;
...
static int mtk_ddp_ovl_bg_cb_MT6985(enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
				unsigned int *addr)
{
	/* Aware this function can't detect cross OVLSYS path description,
	...
	case DDP_COMPONENT_OVL0_2L:
	case DDP_COMPONENT_OVL4_2L:
		*addr = MT6985_OVL_BG_CROSSBAR0_MOUT_EN;
		break;
	case DDP_COMPONENT_OVL1_2L:
	case DDP_COMPONENT_OVL5_2L:
		*addr = MT6985_OVL_BG_CROSSBAR1_MOUT_EN;
		break;
	case DDP_COMPONENT_OVL2_2L:
	case DDP_COMPONENT_OVL6_2L:
		*addr = MT6985_OVL_BG_CROSSBAR2_MOUT_EN;
		break;
	case DDP_COMPONENT_OVL3_2L:
	case DDP_COMPONENT_OVL7_2L:
		*addr = MT6985_OVL_BG_CROSSBAR3_MOUT_EN;
		break;
	case DDP_COMPONENT_OVLSYS_DLI_ASYNC2:
	case DDP_COMPONENT_OVLSYS_DLI_ASYNC5:
		*addr = MT6985_OVL_BG_CROSSBAR4_MOUT_EN;
		break;
	default:
		value = -1;
		DDPPR_ERR("%s, cur=%s->next=%s not found in BG_cb\n", __func__,
			mtk_dump_comp_str_id(cur), mtk_dump_comp_str_id(next));
		return value;
	}
	...
	case DDP_COMPONENT_OVLSYS_DLO_ASYNC8:
		value = BIT(4);
		break;
	default:
		value = -1;
			   ...
			   unsigned int *addr)
{
	...
	if ((cur == DDP_COMPONENT_OVL7_2L &&
		...
		*addr = MT6985_PQ_IN_CROSSBAR2_MOUT_EN;
		...
		/* PQ_IN_CROSSBAR */
		*addr = MT6985_PQ_IN_CROSSBAR1_MOUT_EN;
		value = DISP_DLI_RELAY1_TO_PQ_OUT_CROSSBAR4;
	} else if ((cur == DDP_COMPONENT_PQ0_IN_CB2 &&
		next == DDP_COMPONENT_PQ0_OUT_CB4) ||
		(cur == DDP_COMPONENT_PQ1_IN_CB2 &&
		next == DDP_COMPONENT_PQ1_OUT_CB4)) {
		/* PQ_IN_CROSSBAR */
		*addr = MT6985_PQ_IN_CROSSBAR2_MOUT_EN;
		value = DISP_DLI_RELAY2_TO_PQ_OUT_CROSSBAR4;
		...
		*addr = MT6985_PQ_IN_CROSSBAR3_MOUT_EN;
		...
		/* PQ_IN_CROSSBAR */
		*addr = MT6985_PQ_IN_CROSSBAR3_MOUT_EN;
		value = DISP_DLI_RELAY3_TO_PQ_OUT_CROSSBAR3;
		...
		*addr = MT6985_PQ_OUT_CROSSBAR0_MOUT_EN;
		...
		(cur == DDP_COMPONENT_PQ1_OUT_CB0 &&
		next == DDP_COMPONENT_PANEL1_COMP_OUT_CB1)) {
		/* PQ_OUT_CROSSBAR */
		*addr = MT6985_PQ_OUT_CROSSBAR0_MOUT_EN;
		...
		*addr = MT6985_PQ_OUT_CROSSBAR2_MOUT_EN;
		...
		/* PQ_OUT_CROSSBAR */
		*addr = MT6985_PQ_OUT_CROSSBAR2_MOUT_EN;
		value = DISP_TDSHP1_TO_PANEL_COMP_OUT_CROSSBAR2;
	} else if ((cur == DDP_COMPONENT_PQ0_OUT_CB3 &&
		next == DDP_COMPONENT_PANEL0_COMP_OUT_CB1) ||
		(cur == DDP_COMPONENT_PQ1_OUT_CB3 &&
		next == DDP_COMPONENT_PANEL1_COMP_OUT_CB1)) {
		/* PQ_OUT_CROSSBAR */
		*addr = MT6985_PQ_OUT_CROSSBAR3_MOUT_EN;
		value = DISP_PQ_IN_CROSSBAR2_TO_PANEL_COMP_OUT_CROSSBAR1;
	} else if ((cur == DDP_COMPONENT_PQ0_OUT_CB4 &&
		next == DDP_COMPONENT_PANEL0_COMP_OUT_CB2) ||
		(cur == DDP_COMPONENT_PQ1_OUT_CB4 &&
		next == DDP_COMPONENT_PANEL1_COMP_OUT_CB2)) {
		/* PQ_OUT_CROSSBAR */
		*addr = MT6985_PQ_OUT_CROSSBAR4_MOUT_EN;
		value = DISP_PQ_IN_CROSSBAR3_TO_PANEL_COMP_OUT_CROSSBAR2;
	} else if ((cur == DDP_COMPONENT_PQ0_OUT_CB4 &&
		...
		*addr = MT6985_PQ_OUT_CROSSBAR4_MOUT_EN;
		...
		next == DDP_COMPONENT_VDCM0) ||
		(cur == DDP_COMPONENT_PANEL1_COMP_OUT_CB0 &&
		next == DDP_COMPONENT_VDCM1)) {
		/* PANEL_COMP_OUT_CROSSBAR */
		*addr = MT6985_PANEL_COMP_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_POSTALIGN0_TO_VDCM0;
	} else if ((cur == DDP_COMPONENT_PANEL0_COMP_OUT_CB0 &&
		next == DDP_COMPONENT_DSC0)) {
		/* PANEL_COMP_OUT_CROSSBAR */
		*addr = MT6985_PANEL_COMP_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_POSTALIGN0_TO_DSC_0;
	} else if ((cur == DDP_COMPONENT_PANEL0_COMP_OUT_CB1 &&
		next == DDP_COMPONENT_COMP0_OUT_CB3) ||
		(cur == DDP_COMPONENT_PANEL1_COMP_OUT_CB1 &&
		next == DDP_COMPONENT_COMP1_OUT_CB3)) {
		/* PANEL_COMP_OUT_CROSSBAR */
		*addr = MT6985_PANEL_COMP_OUT_CROSSBAR1_MOUT_EN;
		...
		/* PANEL_COMP_OUT_CROSSBAR */
		*addr = MT6985_PANEL_COMP_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_POSTALIGN0_TO_COMP_OUT_CROSSBAR3;
	} else if ((cur == DDP_COMPONENT_PANEL0_COMP_OUT_CB2 &&
		next == DDP_COMPONENT_COMP0_OUT_CB4)  ||
		(cur == DDP_COMPONENT_PANEL1_COMP_OUT_CB2 &&
		next == DDP_COMPONENT_COMP1_OUT_CB4)) {
		/* PANEL_COMP_OUT_CROSSBAR */
	...
	} else if ((cur == DDP_COMPONENT_COMP0_OUT_CB0 &&
		next == DDP_COMPONENT_MERGE1)) {
		/* COMP_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_VDCM0_TO_MERGE1_0;
	} else if ((cur == DDP_COMPONENT_COMP0_OUT_CB1 &&
		...
		*addr = MT6985_COMP_OUT_CROSSBAR3_MOUT_EN;
		...
		next == DDP_COMPONENT_MERGE0_OUT_CB2) ||
		(cur == DDP_COMPONENT_COMP1_OUT_CB3 &&
		next == DDP_COMPONENT_MERGE1_OUT_CB2)) {
		/* COMP_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR3_MOUT_EN;
		...
		*addr = MT6985_COMP_OUT_CROSSBAR3_MOUT_EN;
		...
		next == DDP_COMPONENT_MERGE0_OUT_CB1) ||
		(cur == DDP_COMPONENT_COMP1_OUT_CB4 &&
		next == DDP_COMPONENT_MERGE1_OUT_CB1)) {
		/* COMP_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR4_MOUT_EN;
		...
		/* COMP_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR4_MOUT_EN;
		value = DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE_OUT_CROSSBAR2;
	} else if ((cur == DDP_COMPONENT_COMP0_OUT_CB5 &&
		...
		*addr = MT6985_COMP_OUT_CROSSBAR6_MOUT_EN;
		...
		/* COMP_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_VDCM0_TO_MERGE_OUT_CROSSBAR0;
	} else if ((cur == DDP_COMPONENT_COMP1_OUT_CB0 &&
		next == DDP_COMPONENT_MERGE3)) {
		/* COMP_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_VDCM0_TO_MERGE1_0;
	} else if ((cur == DDP_COMPONENT_COMP1_OUT_CB1 &&
		...
		*addr = MT6985_COMP_OUT_CROSSBAR5_MOUT_EN;
		...
		next == DDP_COMPONENT_MERGE2)) {
		/* COMP_OUT_CROSSBAR -CON2*/
		*addr = MT6985_COMP_OUT_CROSSBAR5_MOUT_EN;
		value = DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE0_0;
	} else if ((cur == DDP_COMPONENT_COMP1_OUT_CB6 &&
		next == DDP_COMPONENT_MERGE2)) {
		/* COMP_OUT_CROSSBAR -CON2*/
		*addr = MT6985_COMP_OUT_CROSSBAR6_MOUT_EN;
		value = DISP_DLI_RELAY5_TO_MERGE0_1;
		...
		/* COMP_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR6_MOUT_EN;
		value = DISP_DLI_RELAY5_TO_MERGE1_1;
		...
		*addr = MT6985_MERGE_OUT_CROSSBAR0_MOUT_EN;
		...
		/* MERGE_OUT_CROSSBAR */
		*addr = MT6985_MERGE_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_COMP_OUT_CROSSBAR0_TO_DLO_RELAY1;
	} else if ((cur == DDP_COMPONENT_DLI_ASYNC11 &&
		next == DDP_COMPONENT_COMP1_OUT_CB6)) {
		/* MERGE_OUT_CROSSBAR */
		*addr = MT6985_COMP_OUT_CROSSBAR6_MOUT_EN;
		value = DISP_DLI_RELAY5_TO_MERGE_OUT_CROSSBAR3;
		...
		*addr = MT6985_MERGE_OUT_CROSSBAR2_MOUT_EN;
		value = DISP_COMP_OUT_CROSSBAR2_TO_WDMA1;
	} else if ((cur == DDP_COMPONENT_MERGE0_OUT_CB3 &&
		next == DDP_COMPONENT_DLO_ASYNC0)) {
		/* MERGE_OUT_CROSSBAR */
		*addr = MT6985_MERGE_OUT_CROSSBAR3_MOUT_EN;
		value = DISP_COMP_OUT_CROSSBAR3_TO_DLO_RELAY0;
		...
		*addr = MT6985_MERGE_OUT_CROSSBAR4_MOUT_EN;
		value = DISP_MERGE0_0_TO_DP_INTF0;
	} else if ((cur == DDP_COMPONENT_MERGE0_OUT_CB6 &&
		next == DDP_COMPONENT_DLO_ASYNC1)) {
		/* MERGE_OUT_CROSSBAR - CON1*/
	...
	} else if ((cur == DDP_COMPONENT_MERGE1_OUT_CB0 &&
		next == DDP_COMPONENT_DLO_ASYNC2)) {
		/* MERGE_OUT_CROSSBAR */
		*addr = MT6985_MERGE_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_COMP_OUT_CROSSBAR0_TO_DLO_RELAY0;
	} else if ((cur == DDP_COMPONENT_MERGE1_OUT_CB0 &&
		next == DDP_COMPONENT_WDMA4)) {
		/* MERGE_OUT_CROSSBAR -CON2*/
		*addr = MT6985_MERGE_OUT_CROSSBAR0_MOUT_EN;
		value = DISP_COMP_OUT_CROSSBAR0_TO_WDMA1;
	} else if ((cur == DDP_COMPONENT_MERGE1_OUT_CB1 &&
		next == DDP_COMPONENT_DLO_ASYNC3)) {
		/* MERGE_OUT_CROSSBAR */
		*addr = MT6985_MERGE_OUT_CROSSBAR1_MOUT_EN;
		value = DISP_COMP_OUT_CROSSBAR1_TO_DLO_RELAY1;
	} else if ((cur == DDP_COMPONENT_MERGE1_OUT_CB3 &&
		next == DDP_COMPONENT_DSI1)) {
		/* MERGE_OUT_CROSSBAR */
		*addr = MT6985_MERGE_OUT_CROSSBAR3_MOUT_EN;
		value = DISP_COMP_OUT_CROSSBAR3_TO_DSI0;
	} else if ((cur == DDP_COMPONENT_MERGE1_OUT_CB4 &&
		next == DDP_COMPONENT_DSI1)) {
		/* MERGE_OUT_CROSSBAR -CON2 */
		*addr = MT6985_MERGE_OUT_CROSSBAR4_MOUT_EN;
		value = DISP_MERGE0_0_TO_DSI0;
	} else if ((cur == DDP_COMPONENT_MERGE1_OUT_CB6 &&
		next == DDP_COMPONENT_WDMA4)) {
		/* MERGE_OUT_CROSSBAR */
		*addr = MT6985_MERGE_OUT_CROSSBAR6_MOUT_EN;
		value = DISP_MERGE1_0_TO_WDMA1;
		...
		/* OVL_BLEND_CROSSBAR */
		*addr = MT6985_OVL_BLEND_CROSSBAR0_MOUT_EN;
		value = DISP_OVL0_2L_TO_DLO_RELAY3;
...
static int mtk_ddp_sel_in_MT6985(const struct mtk_mmsys_reg_data *data,
			  enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			  unsigned int *addr)
{
	int value = -1;
...
static int mtk_ddp_sout_sel_MT6985(const struct mtk_mmsys_reg_data *data,
			    enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			    unsigned int *addr)
{
	int value = -1;
			   ...
			   unsigned int *addr)
{
	...
	/* for mt6895 rsz path */
		...
		next == DDP_COMPONENT_RDMA3)) {
		*addr = MT6895_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN;
		value = MT6895_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN_TO_DISP_RDMA1_SEL_IN;
	} else if ((cur == DDP_COMPONENT_OVL1_2L_VIRTUAL0 &&
		next == DDP_COMPONENT_DLO_ASYNC3) ||
		(cur == DDP_COMPONENT_OVL3_2L_VIRTUAL0 &&
		next == DDP_COMPONENT_DLO_ASYNC7)) {
		*addr = MT6895_DISP_OVL1_2L_BLEND_MOUT_EN;
		value = MT6895_DISP_OVL1_2L_BLEND_MOUT_EN_TO_DISP_MAIN_OVL_DMDP_SEL;
	} else if ((cur == DDP_COMPONENT_Y2R0 &&
		next == DDP_COMPONENT_Y2R0_VIRTUAL0) ||
		(cur == DDP_COMPONENT_Y2R1 &&
		next == DDP_COMPONENT_Y2R1_VIRTUAL0)) {
		*addr = MT6895_DISP_Y2R0_MOUT_EN;
		value = MT6895_DISP_Y2R0_MOUT_TO_DMDP_MAIN_OVL_SOUT;
	} else {
		value = -1;
	}
			  ...
			  unsigned int *addr)
{
	...
	if ((cur == DDP_COMPONENT_OVL0 && next == DDP_COMPONENT_OVL0_VIRTUAL0) ||
		...
		*addr = MT6895_DISP_DSI0_SEL_IN;
		...
		(cur == DDP_COMPONENT_RDMA0 && next == DDP_COMPONENT_TDSHP0_VIRTUAL) ||
		...
		*addr = MT6895_DISP_RDMA0_POS_SEL_IN;
		...
		(cur == DDP_COMPONENT_TDSHP0_VIRTUAL && next == DDP_COMPONENT_COLOR0) ||
		...
		*addr = MT6895_DISP_C3D0_SEL_IN;
		...
		(cur == DDP_COMPONENT_C3D0 && next == DDP_COMPONENT_AAL0)) {
		...
		*addr = MT6895_DISP_DP_INTF0_SEL_IN;
		...
		next == DDP_COMPONENT_RDMA1) || (cur == DDP_COMPONENT_OVL2_2L_NWCG_VIRTUAL0 &&
		next == DDP_COMPONENT_RDMA3)) {
		*addr = MT6895_DISP_RDMA1_SEL_IN;
		value = MT6895_DISP_RDMA1_SEL_IN_FROM_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN;
	} else if ((cur == DDP_COMPONENT_OVL1_2L_VIRTUAL0 &&
		next == DDP_COMPONENT_DLO_ASYNC3) ||
		(cur == DDP_COMPONENT_OVL3_2L_VIRTUAL0 &&
		next == DDP_COMPONENT_DLO_ASYNC7)) {
		*addr = MT6895_DISP_MAIN_OVL_DMDP_SEL_IN;
		value = MT6895_DISP_OVL1_2L_BLEND_MOUT_TO_DISP_MAIN_OVL_DMDP_SEL;
	} else if ((cur == DDP_COMPONENT_Y2R0_VIRTUAL0 &&
		next == DDP_COMPONENT_OVL0) ||
		(cur == DDP_COMPONENT_Y2R1_VIRTUAL0 &&
		next == DDP_COMPONENT_OVL1)) {
		*addr = MT6895_DISP_OVL0_UFOD_SEL_IN;
		value = MT6895_DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SIN;
	} else {
		value = -1;
	}
			    ...
			    unsigned int *addr)
{
	...
	if ((cur == DDP_COMPONENT_RDMA0 && next == DDP_COMPONENT_RDMA0_OUT_RELAY) ||
		...
		*addr = MT6895_DISP_SUB0_TX_SOUT_SEL;
		...
		(cur == DDP_COMPONENT_Y2R1_VIRTUAL0 &&
		next == DDP_COMPONENT_OVL1)) {
		*addr = MT6895_DMDP_MAIN_OVL_SOUT_SEL;
		value = MT6895_DMDP_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL_SOUT;
	} else {
		value = -1;
	}
			   ...
			   unsigned int *addr)
{
	...
	/*DISP_DITHER0_MOUT*/
		...
		*addr = MT6853_DISP_REG_CONFIG_DISP_DITHER0_MOUT_EN;
		...
		next == DDP_COMPONENT_CM0) {
		*addr = MT6853_DISP_REG_CONFIG_DISP_DITHER0_MOUT_EN;
		value = DITHER0_MOUT_TO_DISP_DISP_CM0;
			  ...
			  unsigned int *addr)
{
	...
	/*DISP_RSZ0_SEL*/
		...
		*addr = MT6853_DISP_REG_CONFIG_DISP_RSZ0_SEL_IN;
		...
		next == DDP_COMPONENT_SPR0_VIRTUAL) {
		*addr = MT6853_DISP_REG_CONFIG_DISP_BYPASS_SPR0_SEL_IN;
		value = SEL_IN_FROM_DISP_SPR0;
	} else if (cur == DDP_COMPONENT_SPR0_VIRTUAL &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6853_DISP_REG_CONFIG_DSI0_SEL_IN;
		value = SEL_IN_FROM_DISP_SPR0_MOUT;
...
static int mtk_ddp_mout_en_MT6879(const struct mtk_mmsys_reg_data *data,
			   enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			   unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL0_2L &&
		...
		*addr = MT6879_DISP_RDMA0_POS_MOUT_EN;
		value = MT6879_DISP_RDMA0_POS_MOUT_TO_DISP_RDMA0_SEL;
		if (MT6879_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_RDMA0_POS))
			value |= MT6879_DISP_RDMA0_POS_MOUT_TO_DISP_CHIST0_SEL;
	} else if (cur == DDP_COMPONENT_POSTMASK0 &&
		next == DDP_COMPONENT_DITHER0) {
		*addr = MT6879_DISP_POSTMASK0_MOUT_EN;
		value = MT6879_DISP_POSTMASK0_MOUT_TO_DISP_DITHER0_SEL;
		if (MT6879_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_POSTMASK0))
			value |= MT6879_DISP_POSTMASK0_MOUT_TO_DISP_CHIST0_SEL;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_CM0) {
		*addr = MT6879_DISP_DITHER0_MOUT_EN;
		value = MT6879_DISP_DITHER0_MOUT_TO_DISP_CM0;
		if (MT6879_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_DITHER0))
			value |= MT6879_DISP_DITHER0_MOUT_TO_DISP_CHIST0_SEL;
	} else if (cur == DDP_COMPONENT_SPR0 &&
		next == DDP_COMPONENT_PQ0_VIRTUAL) {
		*addr = MT6879_DISP_SPR0_MOUT_EN;
		value = MT6879_DISP_DITHER0_MOUT_TO_DISP_PQ0_SOUT;
	} else if (cur == DDP_COMPONENT_OVL0_2L_NWCG &&
		next == DDP_COMPONENT_WDMA1) {
		*addr = MT6879_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN;
		value = MT6879_DISP_OVL0_2L_NWCG_MOUT_TO_DISP_WDMA1_SEL;
	} else {
		value = -1;
	}
	return value;
...
static int mtk_ddp_sel_in_MT6879(const struct mtk_mmsys_reg_data *data,
			  enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			  unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT6879_DISP_RSZ0_SEL;
		value = MT6879_DISP_RSZ0_FROM_DISP_OVL0_2L_BLEND_MOUT;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT6879_DISP_OVL0_UFOD_SEL;
		value = MT6879_DISP_OVL0_UFOD_FROM_DISP_RSZ0_MAIN_OVL_SOUT;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_PQ0_VIRTUAL) {
		...
		*addr = MT6879_DISP_PQ0_SEL;
		value = MT6879_DISP_PQ0_FROM_DISP_MAIN_OVL_DISP_PQ0_SEL;
	} else if (cur == DDP_COMPONENT_PQ0_RDMA0_POS_VIRTUAL &&
		next == DDP_COMPONENT_RDMA0) {
		...
		*addr = MT6879_DISP_COLOR0_SEL;
		value = MT6879_DISP_COLOR0_FROM_DISP_TDSHP0_SOUT;
	} else if (cur == DDP_COMPONENT_CCORR1 &&
		next == DDP_COMPONENT_C3D0) {
		*addr = MT6879_DISP_C3D0_SEL;
		value = MT6879_DISP_C3D0_FROM_DISP_CCORR1_SOUT;
	} else if (cur == DDP_COMPONENT_C3D0 &&
		next == DDP_COMPONENT_AAL0) {
		*addr = MT6879_DISP_MDP_AAL0_SEL;
		value = MT6879_DISP_MDP_AAL0_FROM_DISP_C3D0_SOUT;
	} else if (cur == DDP_COMPONENT_PQ0_VIRTUAL &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) {
		*addr = MT6879_DISP_MAIN0_SEL;
		value = MT6879_DISP_MAIN0_FROM_DISP_PQ0_SOUT;
	} else if (cur == DDP_COMPONENT_MAIN0_VIRTUAL &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6879_DISP_DSI0_SEL;
		value = MT6879_DISP_DSI0_FROM_DISP_MAIN0_SOUT;
	} else if ((cur == DDP_COMPONENT_PWM0 && /* Wired path */
		next == DDP_COMPONENT_CHIST0)) {
		*addr = MT6879_DISP_CHIST0_SEL;
		if (MT6879_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_RDMA0_POS))
			value = MT6879_DISP_CHIST0_FROM_DISP_RDMA0_POS_MOUT;
		else if (MT6879_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_POSTMASK0))
			value = MT6879_DISP_CHIST0_FROM_DISP_POSTMASK0_MOUT;
		else if (MT6879_CHIST_PATH_CONNECT & (0x1 << DISP_CHIST0_FROM_DITHER0))
			value = MT6879_DISP_CHIST0_FROM_DISP_DITHER0_MOUT;
	} else if (cur == DDP_COMPONENT_OVL0_2L_NWCG &&
		next == DDP_COMPONENT_WDMA1) {
		*addr = MT6879_DISP_WDMA1_SEL;
		value = MT6879_DISP_WDMA1_FROM_DISP_OVL0_2L_NWCG_BLEND_MOUT;
	} else {
		value = -1;
	}
...
static int mtk_ddp_sout_sel_MT6879(const struct mtk_mmsys_reg_data *data,
			    enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			    unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT6879_DISP_RSZ0_MAIN_OVL_SOUT_SEL;
		value = MT6879_DISP_RSZ0_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6879_DISP_RDMA0_SOUT_SEL;
		value = MT6879_DISP_RDMA0_SOUT_TO_DISP_RDMA0_OUT_RELAY;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_TDSHP0) {
		*addr = MT6879_DISP_RDMA0_SOUT_SEL;
		value = MT6879_DISP_RDMA0_SOUT_TO_DISP_RDMA0_POS_SEL;
	} else if (cur == DDP_COMPONENT_TDSHP0 &&
		next == DDP_COMPONENT_COLOR0) {
		*addr = MT6879_DISP_TDSHP0_SOUT_SEL;
		value = MT6879_DISP_TDSHP0_SOUT_TO_DISP_COLOR0_SEL;
	} else if (cur == DDP_COMPONENT_CCORR1 &&
		next == DDP_COMPONENT_C3D0) {
		*addr = MT6879_DISP_CCORR1_SOUT_SEL;
		value = MT6879_DISP_CCORR1_SOUT_TO_DISP_C3D0_SEL;
	} else if (cur == DDP_COMPONENT_C3D0 &&
		next == DDP_COMPONENT_AAL0) {
		*addr = MT6879_DISP_C3D0_SOUT_SEL;
		value = MT6879_DISP_C3D0_SOUT_TO_DISP_MDP_AAL0_SEL;
	} else if (cur == DDP_COMPONENT_PQ0_VIRTUAL &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) {
		*addr = MT6879_DISP_PQ0_SOUT_SEL;
		value = MT6879_DISP_PQ0_SOUT_TO_DISP_MAIN0_SEL;
	} else if (cur == DDP_COMPONENT_MAIN0_VIRTUAL &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6879_DISP_MAIN0_SOUT_SEL;
		value = MT6879_DISP_MAIN0_SOUT_TO_DISP_DSI0_SEL;
	} else {
		value = -1;
	}
...
static int mtk_ddp_ovl_bg_blend_en_MT6879(const struct mtk_mmsys_reg_data *data,
			   enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			   unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL0_2L &&
		...
		*addr = MT6879_MMSYS_OVL_CON;
		value = MT6879_DISP_OVL0_2L_GO_BG;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT6879_MMSYS_OVL_CON;
		value = MT6879_DISP_OVL0_2L_GO_BLEND;
	} else if (cur == DDP_COMPONENT_OVL0_2L &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT6879_MMSYS_OVL_CON;
		value = MT6879_DISP_OVL0_2L_GO_BLEND;
	...
	/*OVL0*/
		...
		*addr = MT6879_MMSYS_OVL_CON;
		...
		next == DDP_COMPONENT_WDMA1) {
		*addr = MT6879_MMSYS_OVL_CON;
		value = MT6879_DISP_OVL0_2L_NWCG_GO_BLEND;
	} else {
		value = -1;
	}
...
static int mtk_ddp_mout_en_MT6855(const struct mtk_mmsys_reg_data *data,
			   enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			   unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL1_2L &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT6855_DISP_OVL1_2L_BLEND_MOUT_EN;
		value = MT6855_DISP_OVL1_2L_MOUT_TO_DISP_RSZ0_SEL;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT6855_DISP_RSZ0_MOUT_EN;
		value = MT6855_DISP_RSZ0_MOUT_TO_DISP_OVL_SOUT;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_PQ0_VIRTUAL) {
		*addr = MT6855_DISP_OVL0_BLEND_MOUT_EN;
		value = MT6855_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_PQ0_SEL;
	} else if (cur == DDP_COMPONENT_OVL1_2L &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL) {
		*addr = MT6855_DISP_OVL1_2L_BLEND_MOUT_EN;
		value = MT6855_DISP_OVL1_2L_MOUT_TO_DISP_WDMA0_SEL;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL) {
		*addr = MT6855_DISP_OVL0_BLEND_MOUT_EN;
		value = MT6855_DISP_OVL0_MOUT_TO_DISP_MAIN_OVL_DISP_WDMA_SEL;
	} else if (cur == DDP_COMPONENT_PQ0_RDMA0_POS_VIRTUAL &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT6855_DISP_RDMA0_POS_MOUT_EN;
		value = MT6855_DISP_RDMA0_POS_MOUT_TO_DISP_RDMA0_SEL;
	} else if (cur == DDP_COMPONENT_POSTMASK0 &&
		next == DDP_COMPONENT_DITHER0) {
		*addr = MT6855_DISP_POSTMASK0_MOUT_EN;
		value = MT6855_DISP_POSTMASK0_MOUT_TO_DISP_DITHER0_SEL;
	} else if (cur == DDP_COMPONENT_DITHER0 &&
		next == DDP_COMPONENT_SPR0_VIRTUAL) {
		*addr = MT6855_DISP_DITHER0_MOUT_EN;
		value = MT6855_DISP_DITHER0_MOUT_TO_DISP_SPR0_VIRTUAL;
	} else if (cur == DDP_COMPONENT_SPR0_VIRTUAL &&
		next == DDP_COMPONENT_PQ0_VIRTUAL) {
...
static int mtk_ddp_sel_in_MT6855(const struct mtk_mmsys_reg_data *data,
			  enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			  unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL1_2L &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT6855_DISP_RSZ0_SEL;
		value = MT6855_DISP_RSZ0_FROM_DISP_OVL1_2L_BLEND_MOUT;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT6855_DISP_RSZ0_SEL;
		value = MT6855_DISP_RSZ0_FROM_DISP_OVL0_BLEND_MOUT;
	} else if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT6855_DISP_OVL0_UFOD_SEL;
		value = MT6855_DISP_OVL0_UFOD_FROM_DISP_RSZ0_MAIN_OVL_SOUT;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_PQ0_VIRTUAL) {
		*addr = MT6855_DISP_MAIN_OVL_DISP_PQ0_SEL;
		value = MT6855_DISP_MAIN_OVL_DISP_PQ0_FROM_DISP_OVL0_BLEND_MOUT;
	}  else if (cur == DDP_COMPONENT_OVL1_2L &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL) {
		*addr = MT6855_DISP_MAIN_OVL_DISP_WDMA_SEL;
		value = MT6855_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_OVL1_2L_BLEND_MOUT;
	}  else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL) {
		*addr = MT6855_DISP_MAIN_OVL_DISP_WDMA_SEL;
		value = MT6855_DISP_MAIN_OVL_DISP_WDMA_FROM_DISP_OVL0_BLEND_MOUT;
	} else if (cur == DDP_COMPONENT_MAIN_OVL_DISP_WDMA_VIRTUAL &&
		next == DDP_COMPONENT_WDMA0) {
		*addr = MT6855_DISP_WDMA0_SEL;
		value = MT6855_DISP_WDMA0_FROM_DISP_MAIN_OVL_DISP_WDMA_SEL;
	} else if (cur == DDP_COMPONENT_MAIN_OVL_DISP_PQ0_VIRTUAL &&
		next == DDP_COMPONENT_PQ0_RDMA0_POS_VIRTUAL) {
		*addr = MT6855_DISP_PQ0_SEL;
		value = MT6855_DISP_PQ0_FROM_DISP_MAIN_OVL_DISP_PQ0_SEL;
	} else if (cur == DDP_COMPONENT_PQ0_RDMA0_POS_VIRTUAL &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT6855_DISP_RDMA0_SEL;
		value = MT6855_DISP_RDMA0_FROM_DISP_RDMA0_POS_MOUT;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6855_DISP_DSI0_SEL;
		value = MT6855_DISP_DSI0_FROM_DISP_RDMA0_OUT_RELAY;
	}  else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_TDSHP0) {
		*addr = MT6855_DISP_RDMA0_POS_SEL;
		value = MT6855_DISP_RDMA0_POS_FROM_DISP_RDMA0_SOUT;
	} else if (cur == DDP_COMPONENT_TDSHP0 &&
		next == DDP_COMPONENT_COLOR0) {
		*addr = MT6855_DISP_COLOR0_SEL;
		value = MT6855_DISP_COLOR0_FROM_DISP_TDSHP0_SOUT;
	} else if (cur == DDP_COMPONENT_CCORR0 &&
		next == DDP_COMPONENT_AAL0) {
		*addr = MT6855_DISP_MDP_AAL0_SEL;
		value = MT6855_DISP_MDP_AAL0_FROM_DISP_CCORR0_SOUT;
	} else if (cur == DDP_COMPONENT_PQ0_VIRTUAL &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) {
		*addr = MT6855_DISP_MAIN0_SEL;
		value = MT6855_DISP_MAIN0_FROM_DISP_PQ0_SOUT;
	} else if (cur == DDP_COMPONENT_MAIN0_VIRTUAL &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6855_DISP_DSI0_SEL;
...
static int mtk_ddp_sout_sel_MT6855(const struct mtk_mmsys_reg_data *data,
			    enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			    unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_RSZ0 &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT6855_DISP_RSZ0_MAIN_OVL_SOUT_SEL;
		value = MT6855_DISP_RSZ0_MAIN_OVL_SOUT_TO_DISP_OVL0_UFOD_SEL;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6855_DISP_RDMA0_SOUT_SEL;
		value = MT6855_DISP_RDMA0_SOUT_TO_DISP_DSI0_SEL;
	} else if (cur == DDP_COMPONENT_RDMA0 &&
		next == DDP_COMPONENT_TDSHP0) {
		*addr = MT6855_DISP_RDMA0_SOUT_SEL;
		value = MT6855_DISP_RDMA0_SOUT_TO_DISP_TDSHP0;
	} else if (cur == DDP_COMPONENT_TDSHP0 &&
		next == DDP_COMPONENT_COLOR0) {
		*addr = MT6855_DISP_TDSHP0_SOUT_SEL;
		value = MT6855_DISP_TDSHP0_SOUT_TO_DISP_COLOR0_SEL;
	} else if (cur == DDP_COMPONENT_CCORR0 &&
		next == DDP_COMPONENT_AAL0) {
		*addr = MT6855_DISP_CCORR0_SOUT_SEL;
		value = MT6855_DISP_CCORR0_SOUT_TO_DISP_MDP_AAL0_SEL;
	} else if (cur == DDP_COMPONENT_PQ0_VIRTUAL &&
		next == DDP_COMPONENT_MAIN0_VIRTUAL) {
		*addr = MT6855_DISP_PQ0_SOUT_SEL;
		value = MT6855_DISP_PQ0_SOUT_TO_DISP_MAIN0_SEL;
	} else if (cur == DDP_COMPONENT_MAIN0_VIRTUAL &&
		next == DDP_COMPONENT_DSI0) {
		*addr = MT6855_DISP_MAIN0_SOUT_SEL;
		value = MT6855_DISP_MAIN0_SOUT_TO_DISP_DSI0_SEL;
	} else {
		value = -1;
	}
...
static int mtk_ddp_ovl_bg_blend_en_MT6855(const struct mtk_mmsys_reg_data *data,
			   enum mtk_ddp_comp_id cur, enum mtk_ddp_comp_id next,
			   unsigned int *addr)
{
	int value;
	...
	if (cur == DDP_COMPONENT_OVL1_2L &&
		next == DDP_COMPONENT_OVL0) {
		*addr = MT6855_MMSYS_OVL_CON;
		value = MT6855_DISP_OVL1_2L_GO_BG;
	} else if (cur == DDP_COMPONENT_OVL1_2L &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT6855_MMSYS_OVL_CON;
		value = MT6855_DISP_OVL1_2L_GO_BLEND;
	} else if (cur == DDP_COMPONENT_OVL1_2L &&
		next == DDP_COMPONENT_RDMA0) {
		*addr = MT6855_MMSYS_OVL_CON;
		value = MT6855_DISP_OVL1_2L_GO_BLEND;
	...
	/*OVL0*/
		...
		*addr = MT6855_MMSYS_OVL_CON;
		value = MT6855_DISP_OVL0_GO_BG;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_RSZ0) {
		*addr = MT6855_MMSYS_OVL_CON;
		value = MT6855_DISP_OVL0_GO_BLEND;
	} else if (cur == DDP_COMPONENT_OVL0 &&
		next == DDP_COMPONENT_MAIN_OVL_DISP_PQ0_VIRTUAL) {
		*addr = MT6855_MMSYS_OVL_CON;
		value = MT6855_DISP_OVL0_GO_BLEND;
			      ...
			      enum mtk_ddp_comp_id next)
{
	...
	case MMSYS_MT6983:
		...
		writel_relaxed(0x1, config_regs + MT6983_BYPASS_MUX_SHADOW);
	...
	case MMSYS_MT6985:
		...
		value = mtk_ddp_sout_sel_MT6985(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);

		value = mtk_ddp_sel_in_MT6985(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);
	...
	case MMSYS_MT6879:
		value = mtk_ddp_mout_en_MT6879(reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}

		value = mtk_ddp_sout_sel_MT6879(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);

		value = mtk_ddp_sel_in_MT6879(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);

		value = mtk_ddp_ovl_bg_blend_en_MT6879(
			reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		...
		if (cur == DDP_COMPONENT_OVL0_2L &&
			next == DDP_COMPONENT_OVL0) {
			addr = MT6879_MMSYS_OVL_CON;
			value = MT6879_DISP_OVL1_2L_GO_BG;
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}
		break;
	...
	case MMSYS_MT6855:
		value = mtk_ddp_mout_en_MT6855(reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}

		value = mtk_ddp_sout_sel_MT6855(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);

		value = mtk_ddp_sel_in_MT6855(reg_data, cur, next, &addr);
		if (value >= 0)
			writel_relaxed(value, config_regs + addr);

		value = mtk_ddp_ovl_bg_blend_en_MT6855(
			reg_data, cur, next, &addr);
		if (value >= 0) {
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		...
		if (cur == DDP_COMPONENT_OVL0 &&
			next == DDP_COMPONENT_OVL1_2L) {
			addr = MT6855_MMSYS_OVL_CON;
			value = MT6855_DISP_OVL0_2L_GO_BG;
			reg = readl_relaxed(config_regs + addr) | value;
			writel_relaxed(reg, config_regs + addr);
		}
		break;
			...
			struct cmdq_pkt *handle)
{
	...
	if(offset && value) {
		...
		//DDPINFO("%s: %s, addr=0x%08x value=0x%08x\n",
		//	__func__, mtk_dump_comp_str_id(m), reg_pa+offset, value);
	} /*else {
		DDPINFO("%s: %s not found offset=0x%08x value=0x%08x\n",
			__func__, mtk_dump_comp_str_id(m), offset, value);
	}*/
}
					...
					struct cmdq_pkt *handle)
{
	...
	case MMSYS_MT6885:
		value = mtk_ddp_mout_en_MT6885(reg_data,
			cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_mout_en_1_MT6885(reg_data,
			cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sout_sel_MT6885(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6885(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
	...
	case MMSYS_MT6983:
		...
		cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
			config_regs_pa
			+ MT6983_BYPASS_MUX_SHADOW, 0x1, ~0);
		...
		value = mtk_ddp_sout_sel_MT6983(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6983(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
	...
	case MMSYS_MT6985:
		...
		value = mtk_ddp_sout_sel_MT6985(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6985(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
	...
	case MMSYS_MT6873:
		...
		value = mtk_ddp_sout_sel_MT6873(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6873(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_ovl_bg_blend_en_MT6873(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
	...
	case MMSYS_MT6853:
		value = mtk_ddp_mout_en_MT6853(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sout_sel_MT6853(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6853(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_ovl_bg_blend_en_MT6853(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
	...
	case MMSYS_MT6879:
		value = mtk_ddp_mout_en_MT6879(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sout_sel_MT6879(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6879(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_ovl_bg_blend_en_MT6879(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
	...
	case MMSYS_MT6855:
		value = mtk_ddp_mout_en_MT6855(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sout_sel_MT6855(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6855(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_ovl_bg_blend_en_MT6855(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
	...
	case MMSYS_MT6833:
		...
		value = mtk_ddp_sout_sel_MT6833(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_sel_in_MT6833(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
		...
		value = mtk_ddp_ovl_bg_blend_en_MT6833(reg_data,
				cur, next, &addr);
		if (value >= 0)
			cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
				config_regs_pa
				   ...
				   enum mtk_ddp_comp_id next)
{
	...
	case MMSYS_MT6879:
		...
		value = mtk_ddp_ovl_bg_blend_en_MT6879(reg_data, cur, next, &addr);
	...
	case MMSYS_MT6855:
		...
		value = mtk_ddp_ovl_bg_blend_en_MT6855(reg_data, cur, next, &addr);
...
static void mtk_ddp_ext_dual_pipe_dsc_MT6895(struct mtk_drm_crtc *mtk_crtc,
	struct mtk_disp_mutex *mutex)
{
	...
	DDPFUNC();
	//DISPSYS0
	/*pipe1 from ovl0_2l to dlo_async2*/
	/* DISP_OVL0_2L -> DISP_OVL0_2L_BLEND_MOUT*/
	addr = MT6895_MMSYS_OVL_CON;
	value = MT6895_DISP_OVL0_2L_TO_DISP_OVL0_2L_BLENDOUT_MOUT;
	reg = readl_relaxed(config_regs + addr) | value;
	writel_relaxed(reg, config_regs + addr);

	/* DISP_OVL0_2L_BLEND_MOUT -> DISP_SUB_DISP_PQ0_SEL*/
	addr = MT6895_DISP_OVL0_2L_BLEND_MOUT_EN;
	value = MT6895_DISP_OVL0_2L_BLEND_MOUT_EN_TO_DISP_SUB_DISP_PQ0_SEL_IN;
	writel_relaxed(value, config_regs + addr);
	addr = MT6895_DISP_SUB_DISP_PQ0_SEL_IN;
	...
	/* DISP_OVL0_2L_NWCG_BLEND_MOUT -> DISP_RDMA1 */
	addr = MT6895_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN;
	value = MT6895_DISP_OVL0_2L_NWCG_BLEND_MOUT_EN_TO_DISP_RDMA1_SEL_IN;
	writel_relaxed(value, config_regs + addr);
	addr = MT6895_DISP_RDMA1_SEL_IN;
	...
	addr = MT6895_DISP_TV0_SOUT_SEL;
	value = MT6895_DISP_TV0_SOUT_SEL_TO_DISP_DLO_RELAY2;
	writel_relaxed(value, config_regs + addr);

	//DISPSYS1
	/* continue pipe1 from dlo_async2 to dsc1_r */
	/* DISP_DLI6_SOUT -> DISP_DSC_WRAP1_R_SEL */
	addr = MT6895_DISP_DLI2_SOUT_SEL;
	value = MT6895_DISP_DLI2_SOUT_SEL_TO_DISP_DSC_WRAP0_R_SEL_IN;
	writel_relaxed(value, side_config_regs + addr);
	addr = MT6895_DISP_DSC_WRAP0_R_SEL_IN;
	value = MT6895_DISP_DSC_WRAP0_R_SEL_IN_FROM_DISP_DLI2_SOUT_SEL;
	writel_relaxed(value, side_config_regs + addr);
	...
	addr = MT6895_DISP_TV0_SOUT_SEL;
	value = MT6895_DISP_TV0_SOUT_SEL_TO_DISP_DSC_WRAP0_L_SEL_IN;
	writel_relaxed(value, side_config_regs + addr);
	addr = MT6895_DISP_DSC_WRAP0_L_SEL_IN;
	value = MT6895_DISP_DSC_WRAP0_L_SEL_IN_FROM_DISP_TV0_SOUT_SEL;
	writel_relaxed(value, side_config_regs + addr);

	/* continue pipe0 from dsc1 to dp_intf */
	/* DISP_DSC_WRAP1_MOUT -> DISP_SUB1_SEL */
	addr = MT6895_DISP_DSC_WRAP0_MOUT_EN;
	value = MT6895_DISP_DSC_WRAP0_MOUT_EN_TO_DISP_SUB0_SEL_IN;
	reg = readl_relaxed(side_config_regs + addr) | value;
	writel_relaxed(reg, side_config_regs + addr);
	addr = MT6895_DISP_SUB0_SEL_IN;
	value = MT6895_DISP_SUB0_SEL_IN_FROM_DISP_DSC_WRAP0_MOUT_EN;
	writel_relaxed(value, side_config_regs + addr);

	/* DISP_SUB1_SOUT -> DISP_DP_INTF1_SEL */
	addr = MT6895_DISP_SUB0_SOUT_SEL;
	value = MT6895_DISP_SUB0_SOUT_SEL_TO_DISP_DP_INTF0_SEL_IN;
	writel_relaxed(value, side_config_regs + addr);
	addr = MT6895_DISP_DP_INTF0_SEL_IN;
	value = MT6895_DISP_DP_INTF0_SEL_IN_FROM_DISP_SUB0_SOUT_SEL;
	writel_relaxed(value, side_config_regs + addr);
...
static void mtk_ddp_ext_insert_dual_pipe_MT6895(struct mtk_drm_crtc *mtk_crtc,
	struct mtk_disp_mutex *mutex)
{
	unsigned int addr, value, reg;
	void __iomem *config_regs = mtk_crtc->config_regs;
	...
	/* DISP_OVL2_2L_BLEND_MOUT -> DISP_SUB_DISP_PQ0_SEL*/
	addr = MT6895_DISP_OVL0_2L_BLEND_MOUT_EN;
	value = MT6895_DISP_OVL0_2L_BLEND_MOUT_EN_TO_DISP_SUB_DISP_PQ0_SEL_IN;
	writel_relaxed(value, config_regs + addr);
	addr = MT6895_DISP_SUB_DISP_PQ0_SEL_IN;
	...
	addr = MT6895_DISP_DLI2_SOUT_SEL;
	value = MT6895_DISP_DLI2_SOUT_SEL_TO_DISP_MERGE0_R_SEL_IN;
	writel_relaxed(value, side_config_regs + addr);
	addr = MT6895_DISP_MERGE0_R_SEL_IN;
	value = MT6895_DISP_MERGE0_R_SEL_IN_FROM_DISP_DLI2_SOUT_SEL;
	writel_relaxed(value, side_config_regs + addr);
	...
	addr = MT6895_DISP_TV0_SOUT_SEL;
	value = MT6895_DISP_TV0_SOUT_SEL_TO_DISP_MERGE0_L_SEL_IN;
	writel_relaxed(value, side_config_regs + addr);
	addr = MT6895_DISP_MERGE0_L_SEL_IN;
	value = MT6895_DISP_MERGE0_L_SEL_IN_FROM_DISP_TV0_SOUT_SEL;
	writel_relaxed(value, side_config_regs + addr);

	/* continue pipe0 from merge1 to dp_intf */
	/* DISP_MERGE1_MOUT -> DISP_SUB1_SEL */
	addr = MT6895_DISP_MERGE0_MOUT_EN;
	value = MT6895_DISP_MERGE0_MOUT_EN_TO_DISP_SUB0_SEL_IN;
	reg = readl_relaxed(side_config_regs + addr) | value;
	writel_relaxed(reg, side_config_regs + addr);
	addr = MT6895_DISP_SUB0_SEL_IN;
	value = MT6895_DISP_SUB0_SEL_IN_FROM_DISP_MERGE0_MOUT_EN;
	writel_relaxed(value, side_config_regs + addr);
...
static void mtk_ddp_ext_dual_pipe_dsc_MT6985(struct mtk_drm_crtc *mtk_crtc,
	struct mtk_disp_mutex *mutex)
{
	unsigned int addr, value, reg;
	void __iomem *config_regs = mtk_crtc->config_regs;
...
//need check
	DDPFUNC();
	//DISPSYS0
	/*pipe1 from ovl3_2l to dp_intf0*/
	/* DISP_OVL3_2L -> OVL_BLEND_CROSSBAR3*/
	addr = MT6985_OVLSYS_OVL_CON;
	value = DISP_OVL3_2L_TO_BLEND_CROSSBAR3;
	reg = readl_relaxed(config_regs + addr) | value;
	writel_relaxed(reg, config_regs + addr);

	/* OVL_BLEND_CROSSBAR3 -> OVL_DLO_ASYNC4 */
	addr = MT6985_OVL_BLEND_CROSSBAR3_MOUT_EN;
	value = DISP_OVL3_2L_TO_DLO_RELAY4;
	writel_relaxed(value, config_regs + addr);
	/* OVL_DLO_ASYNC4 -> DISP_DLI_ASYNC1 -> PQ_IN_CROSSBAR1*/

	/* PQ_IN_CROSSBAR1 -> PQ_OUT_CROSSBAR3 */
	addr = MT6985_PQ_IN_CROSSBAR1_MOUT_EN;
	value = DISP_DLI_RELAY1_TO_PQ_OUT_CROSSBAR3;
	writel_relaxed(value, config_regs + addr);

	/* PQ_OUT_CROSSBAR3 -> PANEL_COMP_OUT_CROSSBAR1 */
	addr = MT6985_PQ_OUT_CROSSBAR3_MOUT_EN;
	value = DISP_PQ_IN_CROSSBAR2_TO_PANEL_COMP_OUT_CROSSBAR1;
	writel_relaxed(value, config_regs + addr);

	/* PANEL_COMP_OUT_CROSSBAR1 -> COMP_OUT_CROSSBAR3 */
	addr = MT6985_PANEL_COMP_OUT_CROSSBAR1_MOUT_EN;
	value = DISP_PQ_OUT_CROSSBAR1_TO_COMP_OUT_CROSSBAR3;
	writel_relaxed(value, config_regs + addr);

	/* COMP_OUT_CROSSBAR3 -> DISP_MERGE0 */
	addr = MT6985_COMP_OUT_CROSSBAR3_MOUT_EN;
	value = DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE0_0;
	writel_relaxed(value, config_regs + addr);

	//DISPSYS1
	/* continue pipe1 from disp_dlo_async5 to merge0 */
	/* DISP_OVL3_2L -> OVL_BLEND_CROSSBAR3*/
	addr = MT6985_OVLSYS_OVL_CON;
	value = DISP_OVL3_2L_TO_BLEND_CROSSBAR3;
	reg = readl_relaxed(side_config_regs + addr) | value;
	...
	/* COMP_OUT_CROSSBAR3 -> MERGE_OUT_CROSSBAR1 */
	addr = MT6985_COMP_OUT_CROSSBAR3_MOUT_EN;
	value = DISP_PANEL_COMP_OUT_CROSSBAR3_TO_MERGE_OUT_CROSSBAR1;
	writel_relaxed(value, side_config_regs + addr);

	/* MERGE_OUT_CROSSBAR1 -> DISP_DLO_ASYNC1 */
	addr = MT6985_MERGE_OUT_CROSSBAR1_MOUT_EN;
	value = DISP_COMP_OUT_CROSSBAR1_TO_DLO_RELAY1;
	writel_relaxed(value, side_config_regs + addr);
	/* (pipe1)DISP_DLO_ASYNC1 -> (pipe0)DISP_DLI_ASYNC5 -> COMP_OUT_CROSSBAR7 */

	/* COMP_OUT_CROSSBAR7 -> DISP_MERGE0 */
	addr = MT6985_COMP_OUT_CROSSBAR7_MOUT_EN;
	value = DISP_RELAY0_TO_MERGE0_1;
	writel_relaxed(value, config_regs + addr);

	/* continue pipe0 and pipe1 merge and to dp_intf */
	/* DISP_MERGE0 -> MERGE_OUT_CROSSBAR4 */
	addr = MT6985_MERGE_OUT_CROSSBAR4_MOUT_EN;
	value = DISP_MERGE0_0_TO_DP_INTF0;
	writel_relaxed(value, config_regs + addr);
}
	...
	struct mtk_disp_mutex *mutex)
{
	...
	/* DDP_COMPONENT_COMP0_OUT_CB4 -> DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE1_0 */
	addr = MT6985_COMP_OUT_CROSSBAR4_MOUT_EN;
	value = 0;
	writel_relaxed(value, config_regs + addr);

	/* DDP_COMPONENT_MERGE1 -> DDP_COMPONENT_DP_INTF0 */
	addr = MT6985_MERGE_OUT_CROSSBAR6_MOUT_EN;
	value = 0;
	writel_relaxed(value, config_regs + addr);
...
static void mtk_ddp_ext_insert_dual_pipe_MT6985(struct mtk_drm_crtc *mtk_crtc,
	struct mtk_disp_mutex *mutex)
{
	unsigned int addr, value, reg;
	void __iomem *config_regs = mtk_crtc->config_regs;
	...
	/* DDP_COMPONENT_COMP0_OUT_CB4 -> DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE1_0 */
	addr = MT6985_COMP_OUT_CROSSBAR4_MOUT_EN;
	value = DISP_PANEL_COMP_OUT_CROSSBAR4_TO_MERGE1_0;
	writel_relaxed(value, config_regs + addr);

	/* DDP_COMPONENT_MERGE1 -> DDP_COMPONENT_DP_INTF0 */
	addr = MT6985_MERGE_OUT_CROSSBAR6_MOUT_EN;
	value = DISP_MERGE1_1_TO_DP_INTF0;
	writel_relaxed(value, config_regs + addr);

	/* clear DDP_COMPONENT_MERGE0_OUT_CB1 -> DDP_COMPONENT_DP_INTF0 */
	addr = MT6985_MERGE_OUT_CROSSBAR1_MOUT_EN;
	value = 0;
	writel_relaxed(value, config_regs + addr);
	...
	struct mtk_disp_mutex *mutex)
{
	...
	case MMSYS_MT6983:
		...
		break;
	case MMSYS_MT6985:
		mtk_ddp_ext_dual_pipe_dsc_MT6985(mtk_crtc, mutex);
		break;
	case MMSYS_MT6895:
		mtk_ddp_ext_dual_pipe_dsc_MT6895(mtk_crtc, mutex);
		break;
	default:
		DDPINFO("%s mtk drm not support mmsys id %d\n",
			__func__, priv->data->mmsys_id);
...
static void mtk_ddp_ext_remove_dual_pipe(struct mtk_drm_crtc *mtk_crtc,
	struct mtk_disp_mutex *mutex)
{
	struct mtk_drm_private *priv = mtk_crtc->base.dev->dev_private;
	...
	switch (priv->data->mmsys_id) {
	case MMSYS_MT6985:
		mtk_ddp_ext_remove_dual_pipe_MT6985(mtk_crtc, mutex);
		break;
	default:
	...
	struct mtk_disp_mutex *mutex)
{
	...
	case MMSYS_MT6983:
		...
		break;
	case MMSYS_MT6985:
		mtk_ddp_ext_insert_dual_pipe_MT6985(mtk_crtc, mutex);
		break;
	case MMSYS_MT6895:
		mtk_ddp_ext_insert_dual_pipe_MT6895(mtk_crtc, mutex);
		break;
	default:
		DDPINFO("%s mtk drm not support mmsys id %x\n",
			__func__, priv->data->mmsys_id);
	...
	struct cmdq_pkt *handle)
{
	...
	value = DISP_DLI0_SOUT_SEL_TO_DISP_DSC_WRAP0_R_SEL_IN;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);
...
{
#if defined(CONFIG_PXLW_IRIS)
	/* PW code change begin, support RAW and DSC output mode switch in 2nd DSI display */
	unsigned int addr, value;
	void __iomem *side_config_regs = mtk_crtc->side_config_regs;

	if (is_mi_dev_support_iris()) {
		//DISPSYS1
		/* DDP_COMPONENT_PANEL1_COMP_OUT_CB3 -> DISP_PQ_OUT_CROSSBAR3_TO_COMP_OUT_CROSSBAR5 */
		addr = MT6985_PANEL_COMP_OUT_CROSSBAR3_MOUT_EN;
		value = DISP_PQ_OUT_CROSSBAR3_TO_COMP_OUT_CROSSBAR5;
		writel_relaxed(value, side_config_regs + addr);

		/* DISP_PQ_OUT_CROSSBAR3_TO_COMP_OUT_CROSSBAR5 -> DISP_PANEL_COMP_OUT_CROSSBAR5_TO_MERGE_OUT_CROSSBAR3 */
		addr = MT6985_COMP_OUT_CROSSBAR1_MOUT_EN;
		value = 0;
		writel_relaxed(value, side_config_regs + addr);
	...
	struct cmdq_pkt *handle)
{
	...
	addr = MT6895_DISP_DSC_WRAP0_R_SEL_IN;
	value = MT6895_DISP_DSC_WRAP0_R_SEL_IN_FROM_DISP_DLI0_SOUT_SEL;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);
}
	...
	struct cmdq_pkt *handle)
{
	...
	addr = MT6879_DISP_PQ0_SOUT_SEL;
	value = MT6879_DISP_PQ0_SOUT_TO_DISP_DSC_WRAP0_L_SEL;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);

	addr = MT6879_DISP_DSC_WRAP0_L_SEL;
	value = MT6879_DISP_DSC_WRAP0_L_FROM_DISP_PQ0_SOUT;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);

	addr = MT6879_DISP_DSC_WRAP0_MOUT_EN;
	value = MT6879_DISP_DSC_WRAP0_MOUT_TO_DISP_MAIN0_SEL;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);

	addr = MT6879_DISP_MAIN0_SEL;
	value = MT6879_DISP_MAIN0_FROM_DISP_DSC_WRAP0_MOUT;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);
}
	...
	struct cmdq_pkt *handle)
{
	...
	addr = MT6855_DISP_PQ0_SOUT_SEL;
	value = MT6855_DISP_PQ0_SOUT_TO_DISP_DSC_WRAP0_L_SEL;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);

	addr = MT6855_DISP_DSC_WRAP0_L_SEL;
	value = MT6855_DISP_DSC_WRAP0_L_FROM_DISP_PQ0_SOUT;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);

	addr = MT6855_DISP_DSC_WRAP0_MOUT_EN;
	value = MT6855_DISP_DSC_WRAP0_MOUT_TO_DISP_MAIN0_SEL;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);

	addr = MT6855_DISP_MAIN0_SEL;
	value = MT6855_DISP_MAIN0_FROM_DISP_DSC_WRAP0_MOUT;
	cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
		       mtk_crtc->config_regs_pa + addr, value, ~0);
}
...
int mtk_disp_mutex_prepare(struct mtk_disp_mutex *mutex)
{
	...
	if (ddp->ovlsys1_clk)
		clk_prepare_enable(ddp->ovlsys1_clk);

	if (ddp->ovlsys0_clk)
		clk_prepare_enable(ddp->ovlsys0_clk);
...
void mtk_disp_mutex_unprepare(struct mtk_disp_mutex *mutex)
{
	...
	if (ddp->dispsys_num > 1)
		clk_disable_unprepare(ddp->side_clk);

	if (ddp->ovlsys1_clk)
		clk_disable_unprepare(ddp->ovlsys1_clk);

	if (ddp->ovlsys0_clk)
		clk_disable_unprepare(ddp->ovlsys0_clk);
				       ...
				       unsigned int mutex_id)
{
	...
	if (ovlsys_regs_pa)
		cmdq_pkt_write(handle, mtk_crtc->gce_obj.base,
			       ovlsys_regs_pa + DISP_REG_MUTEX_SOF(ddp->data, mutex->id),
			       ddp->data->mutex_sof[reg], ~0);
}
...
void mtk_disp_mutex_trigger(struct mtk_disp_mutex *mutex, void *handle)
{
	...
	if (ddp->ovlsys0_regs_pa)
		cmdq_pkt_write(handle, ddp->cmdq_base,
			       ddp->ovlsys0_regs_pa + DISP_REG_MUTEX_EN(mutex->id), 1, ~0);
	...
	if (ddp->ovlsys1_regs_pa)
		cmdq_pkt_write(handle, ddp->cmdq_base,
			       ddp->ovlsys1_regs_pa + DISP_REG_MUTEX_EN(mutex->id), 1, ~0);
}
				       ...
				       void *handle)
{
	...
	if (ddp->ovlsys0_regs_pa)
		cmdq_pkt_write(handle, ddp->cmdq_base,
			       ddp->ovlsys0_regs_pa + DISP_REG_MUTEX_INTEN, 0, mask);
	...
	if (ddp->ovlsys1_regs_pa)
		cmdq_pkt_write(handle, ddp->cmdq_base,
				   ddp->ovlsys1_regs_pa + DISP_REG_MUTEX_INTEN, 0, mask);
}
...
void mtk_disp_mutex_enable(struct mtk_disp_mutex *mutex)
{
	...
	if (ddp->ovlsys0_regs)
		writel(1, ddp->ovlsys0_regs + DISP_REG_MUTEX_EN(mutex->id));

	if (ddp->data->dispsys_map && ddp->side_regs) {
		writel(1, ddp->side_regs + DISP_REG_MUTEX_EN(mutex->id));
		if (ddp->ovlsys1_regs)
			writel(1, ddp->ovlsys1_regs + DISP_REG_MUTEX_EN(mutex->id));
	}
				...
				struct cmdq_base *cmdq_base)
{
	...
	if (ddp->ovlsys0_regs_pa) {
		cmdq_pkt_write(cmdq_handle, cmdq_base,
				   ddp->ovlsys0_regs_pa + DISP_REG_MUTEX_CFG, 0, ~0);
		cmdq_pkt_write(cmdq_handle, cmdq_base,
				   ddp->ovlsys0_regs_pa + DISP_REG_MUTEX_EN(mutex->id), 0, ~0);
		cmdq_pkt_write(cmdq_handle, cmdq_base,
				   ddp->ovlsys0_regs_pa + DISP_REG_MUTEX_EN(mutex->id), 1, ~0);
	}
	if (ddp->data->dispsys_map && ddp->side_regs_pa) {
		...
		if (ddp->ovlsys1_regs_pa) {
			cmdq_pkt_write(cmdq_handle, cmdq_base,
				   ddp->ovlsys1_regs_pa + DISP_REG_MUTEX_CFG, 0, ~0);
			cmdq_pkt_write(cmdq_handle, cmdq_base,
				   ddp->ovlsys1_regs_pa + DISP_REG_MUTEX_EN(mutex->id), 0, ~0);
			cmdq_pkt_write(cmdq_handle, cmdq_base,
				   ddp->ovlsys1_regs_pa + DISP_REG_MUTEX_EN(mutex->id), 1, ~0);
		}
	}
...
void mtk_disp_mutex_disable(struct mtk_disp_mutex *mutex)
{
	...
	if (ddp->data->dispsys_map && ddp->side_regs) {
		writel(0, ddp->side_regs + DISP_REG_MUTEX_EN(mutex->id));
		if (ddp->ovlsys1_regs)
			writel(0, ddp->ovlsys1_regs + DISP_REG_MUTEX_EN(mutex->id));
	}
	writel(0, ddp->regs + DISP_REG_MUTEX_EN(mutex->id));
	if (ddp->ovlsys0_regs)
		writel(0, ddp->ovlsys0_regs + DISP_REG_MUTEX_EN(mutex->id));
	if (mutex->id == 2) {
		writel(1, ddp->regs + DISP_REG_MUTEX_RST(mutex->id));
		if (ddp->ovlsys0_regs)
			writel(1, ddp->ovlsys0_regs + DISP_REG_MUTEX_RST(mutex->id));
		if (ddp->data->dispsys_map && ddp->side_regs) {
			writel(1, ddp->side_regs + DISP_REG_MUTEX_RST(mutex->id));
			if (ddp->ovlsys1_regs)
				writel(1, ddp->ovlsys1_regs + DISP_REG_MUTEX_RST(mutex->id));
		}
		udelay(1);
		writel(0, ddp->regs + DISP_REG_MUTEX_RST(mutex->id));
		if (ddp->ovlsys0_regs)
			writel(0, ddp->ovlsys0_regs + DISP_REG_MUTEX_RST(mutex->id));
		if (ddp->data->dispsys_map && ddp->side_regs) {
			writel(0, ddp->side_regs + DISP_REG_MUTEX_RST(mutex->id));
			if (ddp->ovlsys1_regs)
				writel(0, ddp->ovlsys1_regs + DISP_REG_MUTEX_RST(mutex->id));
		}
	}
}
...
void mtk_disp_mutex_acquire(struct mtk_disp_mutex *mutex)
{
	...
	if (ddp->ovlsys0_regs) {
		writel(1, ddp->ovlsys0_regs + DISP_REG_MUTEX_EN(mutex->id));
		writel(1, ddp->ovlsys0_regs + DISP_REG_MUTEX(mutex->id));
	}
	...
	writel(1, ddp->side_regs + DISP_REG_MUTEX_EN(mutex->id));
	writel(1, ddp->side_regs + DISP_REG_MUTEX(mutex->id));

	if (ddp->ovlsys1_regs) {
		writel(1, ddp->ovlsys1_regs + DISP_REG_MUTEX_EN(mutex->id));
		writel(1, ddp->ovlsys1_regs + DISP_REG_MUTEX(mutex->id));
	}
	if (readl_poll_timeout_atomic(ddp->side_regs + DISP_REG_MUTEX(mutex->id),
				      tmp, tmp & INT_MUTEX, 1, 10000))
		DDPPR_ERR("could not acquire disp1 mutex %d\n", mutex->id);
...
void mtk_disp_mutex_release(struct mtk_disp_mutex *mutex)
{
	...
	if (ddp->ovlsys0_regs)
		writel(0, ddp->ovlsys0_regs + DISP_REG_MUTEX(mutex->id));

	if (!(ddp->data->dispsys_map && ddp->side_regs))
		return;

	writel(0, ddp->side_regs + DISP_REG_MUTEX(mutex->id));
	if (ddp->ovlsys1_regs)
		writel(0, ddp->ovlsys1_regs + DISP_REG_MUTEX(mutex->id));
}
...
void mtk_disp_mutex_submit_sof(struct mtk_disp_mutex *mutex)
{
	...
	if (ddp->ovlsys0_regs) {
		reg = readl_relaxed(ddp->ovlsys0_regs
				+ DISP_REG_MUTEX_SOF(ddp->data, mutex->id)) & 0XFFDF;
		writel(reg, ddp->ovlsys0_regs +
				DISP_REG_MUTEX_SOF(ddp->data, mutex->id));
	}
	if (ddp->data->dispsys_map && ddp->side_regs) {
		reg = readl_relaxed(ddp->side_regs
				+ DISP_REG_MUTEX_SOF(ddp->data, mutex->id)) & 0XFFDF;
		writel(reg, ddp->side_regs + DISP_REG_MUTEX_SOF(ddp->data, mutex->id));
		if (ddp->ovlsys1_regs) {
			reg = readl_relaxed(ddp->ovlsys1_regs
					+ DISP_REG_MUTEX_SOF(ddp->data, mutex->id)) & 0XFFDF;
			writel(reg, ddp->ovlsys1_regs +
					DISP_REG_MUTEX_SOF(ddp->data, mutex->id));
		}
	}
}
...
void mmsys_config_dump_analysis_mt6985(void __iomem *config_regs)
{
	...
	unsigned int greq0 =
		readl_relaxed(config_regs +
				MT6985_DISP_REG_CONFIG_SMI_LARB0_GREQ);
	unsigned int greq1 =
		readl_relaxed(config_regs +
				MT6985_DISP_REG_CONFIG_SMI_LARB1_GREQ);
	valid[0] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_VALID_0);
	valid[1] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_VALID_1);
	valid[2] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_VALID_2);
	valid[3] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_VALID_3);
	valid[4] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_VALID_4);
	valid[5] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_VALID_5);

	ready[0] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_READY_0);
	ready[1] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_READY_1);
	ready[2] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_READY_2);
	ready[3] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_READY_3);
	ready[4] =
		readl_relaxed(config_regs + MT6985_DISP_REG_CONFIG_DL_READY_4);
	ready[5] =
...
void mmsys_config_dump_analysis_mt6879(void __iomem *config_regs)
{
	...
	for (i = 0; i < 32; i++) {
		if (greq0 & (1 << i)) {
			name = ddp_greq_name_larb0_mt6879(i);
			if (!name)
				continue;
			strncat(clock_on, name,
				(sizeof(clock_on) -
	...
	for (i = 0; i < 32; i++) {
		if (greq1 & (1 << i)) {
			name = ddp_greq_name_larb1_mt6879(i);
			if (!name)
				continue;
			strncat(clock_on, name,
				(sizeof(clock_on) -
...
void mmsys_config_dump_analysis_mt6855(void __iomem *config_regs)
{
	...
	for (i = 0; i < 32; i++) {
		if (greq0 & (1 << i)) {
			name = ddp_greq_name_larb0_mt6855(i);
			if (!name)
				continue;
			strncat(clock_on, name,
				(sizeof(clock_on) -
	...
	for (i = 0; i < 32; i++) {
		if (greq1 & (1 << i)) {
			name = ddp_greq_name_larb1_mt6855(i);
			if (!name)
				continue;
			strncat(clock_on, name,
				(sizeof(clock_on) -
...
static int mtk_ddp_probe(struct platform_device *pdev)
{
	...
	struct mtk_ddp *ddp = NULL;
	struct resource *regs = NULL, *regs1 = NULL, *regs2 = NULL, *regs3 = NULL;
	...
	if (IS_ERR(ddp->regs)) {
		dev_err(dev, "Failed to map mutex0 registers\n");
	...
	/* dispsys1 mutex irq should have same behavior with
	 * dispsys0 mutex
	 */
	...
	ddp->side_regs_pa = regs1->start;
	ddp->side_regs = devm_ioremap_resource(dev, regs1);
	if (IS_ERR(ddp->side_regs)) {
		dev_err(dev, "Failed to map mutex1 registers\n");
		return PTR_ERR(ddp->side_regs);
	}
...
SKIP_SIDE_DISP:
	...
	if (IS_ERR(ddp->ovlsys0_regs)) {
		dev_err(dev, "Failed to map ovlsys mutex0 registers\n");
		return PTR_ERR(ddp->ovlsys0_regs);
	}
	ddp->ovlsys0_clk = of_clk_get(dev->of_node, 2);
	if (IS_ERR(ddp->ovlsys0_clk))
	...
	if (IS_ERR(ddp->ovlsys1_regs)) {
		dev_err(dev, "Failed to map ovlsys mutex1 registers\n");
		return PTR_ERR(ddp->ovlsys1_regs);
	}
	ddp->ovlsys1_clk = of_clk_get(dev->of_node, 3);
