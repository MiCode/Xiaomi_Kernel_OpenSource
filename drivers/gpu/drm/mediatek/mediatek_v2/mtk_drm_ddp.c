				...
				unsigned int *addr)
{
	...
	default:
		value = -1;
		DDPPR_ERR("%s, cur=%s->next=%s not found in MOUT_EN\n", __func__,
			   ...
			   unsigned int *addr)
{
	...
	if ((cur == DDP_COMPONENT_OVL0_2L &&
		...
		*addr = MT6985_OVL_BLEND_CROSSBAR3_MOUT_EN;
		...
		/* CRTC3 */
		*addr = MT6985_OVL_BLEND_CROSSBAR3_MOUT_EN;
		value = DISP_OVL2_2L_TO_DLO_RELAY5;
