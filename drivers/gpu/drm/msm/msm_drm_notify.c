...
EXPORT_SYMBOL(msm_drm_panel_register_client);
...
EXPORT_SYMBOL(msm_drm_panel_unregister_client);

/**
 * msm_drm_panel_notifier_call_chain - notify clients of drm_events
 *
 */
int msm_drm_panel_notifier_call_chain(unsigned long val, void *v)
{
	return blocking_notifier_call_chain(&msm_drm_panel_notifier_list, val,
					    v);
}
EXPORT_SYMBOL(msm_drm_panel_notifier_call_chain);
