...
static bool g_thermal_hbm_disabled = 0;
			   ...
			   const char *buf, size_t count)
{
	...
	if (thermal_hbm_disabled) {
		param = 0x50000000; /*DISPPARAM_THERMAL_HBM_DISABLE*/
	} else {
		param = 0x40000000; /*DISPPARAM_THERMAL_HBM_ENABLE;*/
	}

	g_thermal_hbm_disabled = thermal_hbm_disabled;
