...
struct gpufreq_opp_info g_default_gpu[] = {
	GPUOP(1100000, 85000, 85000, POSDIV_POWER_2, 1875, 0), /*  0 sign off */
	GPUOP(1086000, 85000, 85000, POSDIV_POWER_2, 1875, 0), /*  1 */
	GPUOP(1072000, 84375, 84375, POSDIV_POWER_2, 1875, 0), /*  2 */
	GPUOP(1058000, 83750, 83750, POSDIV_POWER_2, 1875, 0), /*  3 */
	GPUOP(1045000, 83125, 83125, POSDIV_POWER_2, 1875, 0), /*  4 */
	GPUOP(1031000, 82500, 82500, POSDIV_POWER_2, 1875, 0), /*  5 */
	GPUOP(1017000, 82500, 82500, POSDIV_POWER_2, 1875, 0), /*  6 */
	GPUOP(1003000, 81875, 81875, POSDIV_POWER_2, 1875, 0), /*  7 */
	GPUOP(990000,  81250, 81250, POSDIV_POWER_2, 1875, 0), /*  8 */
	GPUOP(976000,  80625, 80625, POSDIV_POWER_2, 1875, 0), /*  9 */
	GPUOP(962000,  80000, 80000, POSDIV_POWER_2, 1875, 0), /* 10 */
	GPUOP(948000,  79375, 79375, POSDIV_POWER_4, 1875, 0), /* 11 */
	GPUOP(935000,  79375, 79375, POSDIV_POWER_4, 1875, 0), /* 12 */
	GPUOP(921000,  78750, 78750, POSDIV_POWER_4, 1875, 0), /* 13 */
	GPUOP(907000,  78125, 78125, POSDIV_POWER_4, 1875, 0), /* 14 */
	GPUOP(893000,  77500, 77500, POSDIV_POWER_4, 1875, 0), /* 15 */
	GPUOP(880000,  76875, 76875, POSDIV_POWER_4, 1875, 0), /* 16 sign off*/
	GPUOP(868000,  76875, 76875, POSDIV_POWER_4, 1875, 0), /* 17 */
	GPUOP(857000,  76250, 76250, POSDIV_POWER_4, 1875, 0), /* 18 */
	GPUOP(846000,  75625, 75625, POSDIV_POWER_4, 1875, 0), /* 19 */
	GPUOP(835000,  75625, 75625, POSDIV_POWER_4, 1250, 0), /* 20 */
	GPUOP(823000,  75000, 75000, POSDIV_POWER_4, 1250, 0), /* 21 */
	GPUOP(812000,  74375, 75000, POSDIV_POWER_4, 1250, 0), /* 22 */
	GPUOP(801000,  74375, 75000, POSDIV_POWER_4, 1250, 0), /* 23 */
	GPUOP(790000,  73750, 75000, POSDIV_POWER_4, 1250, 0), /* 24 */
	GPUOP(778000,  73125, 75000, POSDIV_POWER_4, 1250, 0), /* 25 */
	GPUOP(767000,  73125, 75000, POSDIV_POWER_4, 1250, 0), /* 26 */
	GPUOP(756000,  72500, 75000, POSDIV_POWER_4, 1250, 0), /* 27 */
	GPUOP(745000,  71875, 75000, POSDIV_POWER_4, 1250, 0), /* 28 */
	GPUOP(733000,  71250, 75000, POSDIV_POWER_4, 1250, 0), /* 29 */
	...
	GPUOP(674000,  69375, 75000, POSDIV_POWER_4, 1250, 0), /* 33 */
	GPUOP(648000,  68750, 75000, POSDIV_POWER_4, 1250, 0), /* 34 */
	GPUOP(622000,  68125, 75000, POSDIV_POWER_4, 1250, 0), /* 35 */
	GPUOP(596000,  67500, 75000, POSDIV_POWER_4,  625, 0), /* 36 */
	GPUOP(570000,  66875, 75000, POSDIV_POWER_4,  625, 0), /* 37 */
	GPUOP(545000,  66250, 75000, POSDIV_POWER_4,  625, 0), /* 38 */
	GPUOP(519000,  65625, 75000, POSDIV_POWER_4,  625, 0), /* 39 */
	GPUOP(493000,  65000, 75000, POSDIV_POWER_4,  625, 0), /* 40 */
	GPUOP(467000,  64375, 75000, POSDIV_POWER_4,  625, 0), /* 41 */
	GPUOP(441000,  63750, 75000, POSDIV_POWER_4,  625, 0), /* 42 */
	GPUOP(415000,  63125, 75000, POSDIV_POWER_4,  625, 0), /* 43 */
	GPUOP(390000,  62500, 75000, POSDIV_POWER_4,  625, 0), /* 44 sign off*/
};
