...
struct gpufreq_opp_info g_default_gpu[] = {
	...
	GPUOP(1086000, 84375, 84375, POSDIV_POWER_2, 1875, 0), /*  1 */
	GPUOP(1072000, 83750, 83750, POSDIV_POWER_2, 1875, 0), /*  2 */
	GPUOP(1058000, 83125, 83125, POSDIV_POWER_2, 1875, 0), /*  3 */
	GPUOP(1045000, 82500, 82500, POSDIV_POWER_2, 1875, 0), /*  4 */
	GPUOP(1031000, 81875, 81875, POSDIV_POWER_2, 1875, 0), /*  5 */
	GPUOP(1017000, 81250, 81250, POSDIV_POWER_2, 1875, 0), /*  6 */
	GPUOP(1003000, 80625, 80625, POSDIV_POWER_2, 1875, 0), /*  7 */
	GPUOP(990000,  80000, 80000, POSDIV_POWER_2, 1875, 0), /*  8 */
	GPUOP(976000,  79375, 79375, POSDIV_POWER_2, 1875, 0), /*  9 */
	GPUOP(962000,  78125, 78125, POSDIV_POWER_2, 1875, 0), /* 10 */
	GPUOP(948000,  77500, 77500, POSDIV_POWER_4, 1875, 0), /* 11 */
	GPUOP(935000,  76875, 76875, POSDIV_POWER_4, 1875, 0), /* 12 */
	GPUOP(921000,  76250, 76250, POSDIV_POWER_4, 1875, 0), /* 13 */
	GPUOP(907000,  75625, 75625, POSDIV_POWER_4, 1875, 0), /* 14 */
	GPUOP(893000,  75000, 75000, POSDIV_POWER_4, 1875, 0), /* 15 */
	GPUOP(880000,  74375, 75000, POSDIV_POWER_4, 1875, 0), /* 16 sign off*/
	GPUOP(868000,  73750, 75000, POSDIV_POWER_4, 1875, 0), /* 17 */
	GPUOP(857000,  73125, 75000, POSDIV_POWER_4, 1875, 0), /* 18 */
	GPUOP(846000,  72500, 75000, POSDIV_POWER_4, 1875, 0), /* 19 */
	GPUOP(835000,  71875, 75000, POSDIV_POWER_4, 1250, 0), /* 20 */
	GPUOP(823000,  71250, 75000, POSDIV_POWER_4, 1250, 0), /* 21 */
	GPUOP(812000,  70625, 75000, POSDIV_POWER_4, 1250, 0), /* 22 */
