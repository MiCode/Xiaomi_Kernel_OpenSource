...
#ifndef __GPUDFD_MT6895_H__
#define __GPUDFD_MT6895_H__
...
#define MFG_DFD_CON_1_ENABLE         (0x0000915C)
#define MFG_DFD_CON_2_ENABLE         (0x0000E820)
#define MFG_DFD_CON_3_ENABLE         (0x00213951)
