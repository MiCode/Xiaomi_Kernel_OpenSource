 ...
 */
#ifndef __GPUFREQ_MT6739_H__
#define __GPUFREQ_MT6739_H__
/**************************************************
...
#define MFGPLL_CON1				        (g_apmixed_base + 0x244)
//TODO:GKI_6739 : Remove
#if 0
...
#endif
/**************************************************
 * Reference Power Setting MT6739
 **************************************************/
// TODO:GKI
 ...
 * PMIC Setting MT6739
 **************************************************/
#define VGPU_MAX_VOLT		(115000)         /* mV x 100 */
...
struct gpufreq_opp_info g_default_gpu_segment1[] = {
	GPUOP(450000, 115000, 100000, 0, 0, 0),
	GPUOP(400000, 111875, 98750, 1, 0, 0),
	GPUOP(350000, 108750, 98750, 2, 0, 0),
	GPUOP(290000, 105000, 98750, 3, 0, 0),
};

struct gpufreq_opp_info g_default_gpu_segment2[] = {
	GPUOP(570000, 115000, 90000, 0, 0, 0),
	GPUOP(482500, 111875, 80000, 1, 0, 0),
	GPUOP(395000, 108750, 80000, 2, 0, 0),
	GPUOP(290000, 105000, 80000, 3, 0, 0),
};

struct gpufreq_opp_info g_default_gpu_segment3[] = {
	GPUOP(350000, 108750, 90000, 0, 0, 0),
