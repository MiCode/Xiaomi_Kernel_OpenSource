...
#ifndef __GPUDFD_MT6855_H__
#define __GPUDFD_MT6855_H__
...
#define MFG_DFD_CON_1_ENABLE         (0x0000F217)
#define MFG_DFD_CON_2_ENABLE         (0x00015651)
#define MFG_DFD_CON_3_ENABLE         (0x00202738)
