...
void __gpufreq_dump_infra_status(void)
{
	...
	if (g_sleep) {
		...
		GPUFREQ_LOGI("pwr status (0x%x-%x): 0x%08x 0x%08x 0x%08x",
			(0x1C001000 + 0xEB8), 0xEC0,
			readl(g_sleep + 0xEB8), readl(g_sleep + 0xEBC),
			readl(g_sleep + 0xEC0));
		/* MFG3_PWR_CON - MFG5_PWR_CON */
		GPUFREQ_LOGI("pwr status (0x%x-%x): 0x%08x 0x%08x 0x%08x",
			(0x1C001000 + 0xEC4), 0xECC,
			readl(g_sleep + 0xEC4), readl(g_sleep + 0xEC8),
			readl(g_sleep + 0xECC));
		/* MFG6_PWR_CON - MFG8_PWR_CON */
		GPUFREQ_LOGI("pwr status (0x%x-%x): 0x%08x 0x%08x 0x%08x",
			(0x1C001000 + 0xED0), 0xED8,
			readl(g_sleep + 0xED0), readl(g_sleep + 0xED4),
			readl(g_sleep + 0xED8));
		/* MFG9_PWR_CON - MFG12_PWR_CON*/
		GPUFREQ_LOGI("pwr status (0x%x-%x): 0x%08x 0x%08x 0x%08x 0x%08x",
			(0x1C001000 + 0xEDC), 0xEE8,
			readl(g_sleep + 0xEDC), readl(g_sleep + 0xEE0),
			readl(g_sleep + 0xEE4), readl(g_sleep + 0xEE8));
		/* XPU_PWR_STATUS */
