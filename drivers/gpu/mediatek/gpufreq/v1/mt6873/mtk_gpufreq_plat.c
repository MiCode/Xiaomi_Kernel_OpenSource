...
static int __mt_gpufreq_init_clk(struct platform_device *pdev)
{
	...
	g_apmixed_base = __mt_gpufreq_of_ioremap("mediatek,mt8192-apmixedsys", 0);
	if (!g_apmixed_base) {
