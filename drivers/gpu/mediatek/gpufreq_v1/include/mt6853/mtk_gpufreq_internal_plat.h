...
enum g_segment_id_enum {
	MT6853_SEGMENT = 1,
	MT6853T_SEGMENT,		//Reserve Segment
};
...
struct opp_table_info g_opp_table_segment_1[] = {
	...
	GPUOP(915000, 77500, 77500, POSDIV_POWER_4, 1875), /* 4 */
	GPUOP(906000, 76875, 76875, POSDIV_POWER_4, 1875), /* 5 */
	GPUOP(897000, 76250, 76250, POSDIV_POWER_4, 1875), /* 6 */
	GPUOP(888000, 75625, 75625, POSDIV_POWER_4, 1875), /* 7 */
	GPUOP(880000, 75000, 75000, POSDIV_POWER_4, 1875), /* 8 sign off */
	GPUOP(865000, 74375, 75000, POSDIV_POWER_4, 1875), /* 9 */
	GPUOP(850000, 73750, 75000, POSDIV_POWER_4, 1875), /*10 */
	GPUOP(835000, 73125, 75000, POSDIV_POWER_4, 1875), /*11 */
	GPUOP(820000, 72500, 75000, POSDIV_POWER_4, 1875), /*12 */
	GPUOP(805000, 71875, 75000, POSDIV_POWER_4, 1875), /*13 */
	GPUOP(790000, 71250, 75000, POSDIV_POWER_4, 1875), /*14 */
	GPUOP(775000, 70625, 75000, POSDIV_POWER_4, 1875), /*15 */
	GPUOP(760000, 70000, 75000, POSDIV_POWER_4, 1250), /*16 */
	GPUOP(745000, 69375, 75000, POSDIV_POWER_4, 1250), /*17 */
	GPUOP(730000, 68750, 75000, POSDIV_POWER_4, 1250), /*18 */
	GPUOP(715000, 68125, 75000, POSDIV_POWER_4, 1250), /*19 */
	GPUOP(700000, 67500, 75000, POSDIV_POWER_4, 1250), /*20 */
	GPUOP(685000, 66875, 75000, POSDIV_POWER_4, 1250), /*21 */
	GPUOP(670000, 66250, 75000, POSDIV_POWER_4, 1250), /*22 */
	GPUOP(655000, 65625, 75000, POSDIV_POWER_4, 1250), /*23 */
	GPUOP(640000, 65000, 75000, POSDIV_POWER_4, 1250), /*24 sign off */
	GPUOP(619000, 64375, 75000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(598000, 63750, 75000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(577000, 63125, 75000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(556000, 62500, 75000, POSDIV_POWER_4, 625),  /*28 */
	GPUOP(535000, 61875, 75000, POSDIV_POWER_4, 625),  /*29 */
	GPUOP(515000, 61250, 75000, POSDIV_POWER_4, 625),  /*30 */
	GPUOP(494000, 60625, 75000, POSDIV_POWER_4, 625),  /*31 */
	GPUOP(473000, 60000, 75000, POSDIV_POWER_4, 625),  /*32 */
	GPUOP(452000, 59375, 75000, POSDIV_POWER_4, 625),  /*33 */
	GPUOP(431000, 58750, 75000, POSDIV_POWER_4, 625),  /*34 */
	GPUOP(410000, 58125, 75000, POSDIV_POWER_4, 625),  /*35 */
	GPUOP(390000, 57500, 75000, POSDIV_POWER_4, 625),  /*36 sign off */
};
...
struct opp_table_info g_opp_table_segment_2[] = {
	...
	GPUOP(655000, 65625, 75000, POSDIV_POWER_4, 1250), /*23 */
	GPUOP(640000, 65000, 75000, POSDIV_POWER_4, 1250), /*24 sign off */
	GPUOP(619000, 65000, 75000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(598000, 64375, 75000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(577000, 63750, 75000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(556000, 63750, 75000, POSDIV_POWER_4, 625),  /*28 */
	GPUOP(535000, 63125, 75000, POSDIV_POWER_4, 625),  /*29 */
	GPUOP(515000, 62500, 75000, POSDIV_POWER_4, 625),  /*30 */
	GPUOP(494000, 62500, 75000, POSDIV_POWER_4, 625),  /*31 */
	GPUOP(473000, 61875, 75000, POSDIV_POWER_4, 625),  /*32 */
	GPUOP(452000, 61250, 75000, POSDIV_POWER_4, 625),  /*33 */
	GPUOP(431000, 61250, 75000, POSDIV_POWER_4, 625),  /*34 */
	GPUOP(410000, 60625, 75000, POSDIV_POWER_4, 625),  /*35 */
	GPUOP(390000, 60000, 75000, POSDIV_POWER_4, 625),  /*36 sign off */
};
...
struct opp_table_info g_opp_table_segment_3[] = {
	...
	GPUOP(640000, 65000, 75000, POSDIV_POWER_4, 1250), /*24 sign off */
	GPUOP(619000, 65000, 75000, POSDIV_POWER_4, 1250), /*25 */
	GPUOP(598000, 65000, 75000, POSDIV_POWER_4, 1250), /*26 */
	GPUOP(577000, 64375, 75000, POSDIV_POWER_4, 1250), /*27 */
	GPUOP(556000, 64375, 75000, POSDIV_POWER_4, 625),  /*28 */
	GPUOP(535000, 64375, 75000, POSDIV_POWER_4, 625),  /*29 */
	GPUOP(515000, 63750, 75000, POSDIV_POWER_4, 625),  /*30 */
	GPUOP(494000, 63750, 75000, POSDIV_POWER_4, 625),  /*31 */
	GPUOP(473000, 63750, 75000, POSDIV_POWER_4, 625),  /*32 */
	GPUOP(452000, 63125, 75000, POSDIV_POWER_4, 625),  /*33 */
	GPUOP(431000, 63125, 75000, POSDIV_POWER_4, 625),  /*34 */
	GPUOP(410000, 63125, 75000, POSDIV_POWER_4, 625),  /*35 */
	GPUOP(390000, 62500, 75000, POSDIV_POWER_4, 625),  /*36 sign off */
};
