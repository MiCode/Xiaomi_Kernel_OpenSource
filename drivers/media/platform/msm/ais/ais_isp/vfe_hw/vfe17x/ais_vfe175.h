...
#ifndef _AIS_VFE175_H_
#define _AIS_VFE175_H_
...
static struct ais_irq_register_set vfe175_top_irq_reg_set[2] = {
	{
...
static struct ais_irq_controller_reg_info vfe175_top_irq_reg_info = {
	.num_registers = 2,
...
static struct ais_vfe_camif_ver2_reg vfe175_camif_reg = {
...
static struct ais_vfe_camif_reg_data vfe_175_camif_reg_data = {
...
static struct ais_vfe_camif_lite_ver2_reg vfe175_camif_lite_reg = {
...
static struct ais_vfe_camif_lite_ver2_reg_data vfe175_camif_lite_reg_data = {
...
static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe175_lens_reg = {
	.reset    = 0x0000001C,
	.cgc_ovd  = 0x0000002C,
	.enable   = 0x00000040,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe175_stats_reg = {
	.reset    = 0x00000020,
	.cgc_ovd  = 0x00000030,
	.enable   = 0x00000044,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe175_color_reg = {
	.reset    = 0x00000024,
	.cgc_ovd  = 0x00000034,
	.enable   = 0x00000048,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe175_zoom_reg = {
	.reset    = 0x00000028,
	.cgc_ovd  = 0x00000038,
	.enable   = 0x0000004C,
};
...
static struct ais_vfe_bus_ver2_stats_cfg_info vfe175_stats_info  = {
	.dmi_offset_info = {
	...
	.stats_cfg_offset = {
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_STATS_HDR_BE,
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_STATS_BF,
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_STATS_AWB_BG,
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_STATS_BHIST,
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_STATS_RS,
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_STATS_CS,
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_STATS_IHIST,
		...
		{
			.res_index      = AIS_VFE_BUS_VER2_VFE_OUT_2PD,
...
static struct ais_vfe_top_ver2_reg_offset_common vfe175_top_common_reg = {
...
static struct ais_vfe_rdi_ver2_reg vfe175_rdi_reg = {
	.reg_update_cmd           = 0x000004AC,
};

static struct ais_vfe_rdi_reg_data  vfe_175_rdi_0_data = {
	.reg_update_cmd_data      = 0x2,
	.sof_irq_mask             = 0x8000000,
	.reg_update_irq_mask      = 0x20,
};

static struct ais_vfe_rdi_reg_data  vfe_175_rdi_1_data = {
	.reg_update_cmd_data      = 0x4,
	.sof_irq_mask             = 0x10000000,
	.reg_update_irq_mask      = 0x40,
};

static struct ais_vfe_rdi_reg_data  vfe_175_rdi_2_data = {
	.reg_update_cmd_data      = 0x8,
	.sof_irq_mask             = 0x20000000,
	.reg_update_irq_mask      = 0x80,
};

static struct ais_vfe_top_ver2_hw_info vfe175_top_hw_info = {
...
static struct ais_irq_register_set vfe175_bus_irq_reg[3] = {
		{
...
static struct ais_vfe_bus_ver2_reg_offset_ubwc_3_client
...
static struct ais_vfe_bus_ver2_hw_info vfe175_bus_hw_info = {
	.common_reg = {
	...
	.stats_data = &vfe175_stats_info,
};

static struct ais_vfe_hw_info ais_vfe175_hw_info = {
	...
	.camif_version                 = AIS_VFE_CAMIF_VER_2_0,
	.camif_reg                     = &vfe175_camif_reg,

	.camif_lite_version            = AIS_VFE_CAMIF_LITE_VER_2_0,
	.camif_lite_reg                = &vfe175_camif_lite_reg,

};

#endif /* _AIS_VFE175_H_ */
