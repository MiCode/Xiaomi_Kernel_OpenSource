...
static struct ais_irq_register_set vfe170_top_irq_reg_set[2] = {
	{
...
static struct ais_irq_controller_reg_info vfe170_top_irq_reg_info = {
	.num_registers = 2,
...
static struct ais_vfe_camif_ver2_reg vfe170_camif_reg = {
...
static struct ais_vfe_camif_reg_data vfe_170_camif_reg_data = {
...
static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe_170_lens_reg = {
	.reset    = 0x0000001C,
	.cgc_ovd  = 0x0000002C,
	.enable   = 0x00000040,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe_170_stats_reg = {
	.reset    = 0x00000020,
	.cgc_ovd  = 0x00000030,
	.enable   = 0x00000044,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe_170_color_reg = {
	.reset    = 0x00000024,
	.cgc_ovd  = 0x00000034,
	.enable   = 0x00000048,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe_170_zoom_reg = {
	.reset    = 0x00000028,
	.cgc_ovd  = 0x00000038,
	.enable   = 0x0000004C,
};

static struct ais_vfe_bus_ver2_stats_cfg_info vfe170_stats_info  = {
	.dmi_offset_info = {
...
static struct ais_vfe_top_ver2_reg_offset_common vfe170_top_common_reg = {
...
static struct ais_vfe_rdi_ver2_reg vfe170_rdi_reg = {
	.reg_update_cmd           = 0x000004AC,
};

static struct ais_vfe_rdi_reg_data  vfe_170_rdi_0_data = {
	.reg_update_cmd_data      = 0x2,
	.sof_irq_mask             = 0x8000000,
	.reg_update_irq_mask      = 0x20,
};

static struct ais_vfe_rdi_reg_data  vfe_170_rdi_1_data = {
	.reg_update_cmd_data      = 0x4,
	.sof_irq_mask             = 0x10000000,
	.reg_update_irq_mask      = 0x40,
};

static struct ais_vfe_rdi_reg_data  vfe_170_rdi_2_data = {
	.reg_update_cmd_data      = 0x8,
	.sof_irq_mask             = 0x20000000,
	.reg_update_irq_mask      = 0x80,
};

static struct ais_vfe_top_ver2_hw_info vfe170_top_hw_info = {
...
static struct ais_irq_register_set vfe170_bus_irq_reg[3] = {
		{
...
static struct ais_vfe_bus_ver2_reg_offset_ubwc_client ubwc_regs_client_3 = {
	.tile_cfg         = 0x0000252C,
	.h_init           = 0x00002530,
	.v_init           = 0x00002534,
...
static struct ais_vfe_bus_ver2_reg_offset_ubwc_client ubwc_regs_client_4 = {
	.tile_cfg         = 0x0000262C,
	.h_init           = 0x00002630,
	.v_init           = 0x00002634,
...
static struct ais_vfe_bus_ver2_hw_info vfe170_bus_hw_info = {
	.common_reg = {
	...
	.stats_data = &vfe170_stats_info,
};

static struct ais_vfe_hw_info ais_vfe170_hw_info = {
