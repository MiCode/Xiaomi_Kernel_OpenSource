...
ADJ_STS	func_SET_SCENE_PARAM_for_NewGYRO_Fil(OIS_UBYTE u16_scene, OIS_UBYTE u16_mode, OIS_UBYTE filter, OIS_UBYTE range, const _FACT_ADJ *param)
{
	...
	OIS_UWORD u16_dat_SCENE_NIGHT_3[4] = { 0x7FF0,   ANGLE_LIMIT,   G_SENSE * 16,   0x0300,  };
	...
	OIS_UWORD u16_dat_SCENE_D_A_Y_3[4] = { 0x7F00,   ANGLE_LIMIT,   G_SENSE * 40,   0x0300,  };

	OIS_UWORD u16_dat_SCENE_SPORT_1[4] = { 0x7FE0,   ANGLE_LIMIT,   G_SENSE * 60,   0x0300,  };



	OIS_UWORD u16_dat_SCENE_SPORT_2[4] = { 0x7F80,   ANGLE_LIMIT,   G_SENSE * 60,   0x0000,  };
	OIS_UWORD u16_dat_SCENE_SPORT_3[4] = { 0x7FFF,   ANGLE_LIMIT,   G_SENSE * 60,   0x0100,  };
