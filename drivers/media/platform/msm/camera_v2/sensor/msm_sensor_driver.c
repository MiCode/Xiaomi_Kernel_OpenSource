...
CSID_TG:
	...
	*  sensor control structure */
	...
	if(!strcmp(slave_info->sensor_name, "s5k4h7_ofilm")) {
		hardwareinfo_set_prop(probed_info->position==BACK_CAMERA_B
			?HARDWARE_BACK_CAM:HARDWARE_FRONT_CAM, "samsung_s5k4h7_i");
	}else if(!strcmp(slave_info->sensor_name, "s5k5e8_ofilm_riva")) {
		hardwareinfo_set_prop(probed_info->position==BACK_CAMERA_B
			?HARDWARE_BACK_CAM:HARDWARE_FRONT_CAM, "samsung_s5k5e8_i");
	}else if (!strcmp(slave_info->sensor_name, "hi556_sunny")) {
		hardwareinfo_set_prop(probed_info->position==BACK_CAMERA_B
			?HARDWARE_BACK_CAM:HARDWARE_FRONT_CAM, "hynix_hi556_ii");
	}else if(!strcmp(slave_info->sensor_name, "gc8034_sunny")) {
		hardwareinfo_set_prop(probed_info->position==BACK_CAMERA_B
			?HARDWARE_BACK_CAM:HARDWARE_FRONT_CAM, "gcore_gc8034_ii");
	}
	if(main_module_id > 0){
