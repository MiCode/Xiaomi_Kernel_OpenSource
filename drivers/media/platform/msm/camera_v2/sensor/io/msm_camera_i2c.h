...
struct msm_camera_i2c_fn_t {
	int (*i2c_read)(struct msm_camera_i2c_client *client,
		uint32_t addr, uint16_t *data,
		enum msm_camera_i2c_data_type data_type);
	int32_t (*i2c_read_seq)(struct msm_camera_i2c_client *client,
		uint32_t addr, uint8_t *data, uint32_t num_byte);
	int (*i2c_write)(struct msm_camera_i2c_client *client,
		uint32_t addr, uint16_t data,
		enum msm_camera_i2c_data_type data_type);
	int (*i2c_write_seq)(struct msm_camera_i2c_client *client,
		uint32_t addr, uint8_t *data, uint32_t num_byte);
	int32_t (*i2c_write_table)(struct msm_camera_i2c_client *client,
		struct msm_camera_i2c_reg_setting *write_setting);
	int32_t (*i2c_write_seq_table)(struct msm_camera_i2c_client *client,
		struct msm_camera_i2c_seq_reg_setting *write_setting);
	int32_t (*i2c_write_table_w_microdelay)
		(struct msm_camera_i2c_client *client,
		struct msm_camera_i2c_reg_setting *write_setting);
	int32_t (*i2c_util)(struct msm_camera_i2c_client *client,
			uint16_t cci_cmd);
	...
	int32_t (*i2c_write_burst)(struct msm_camera_i2c_client *client,
		...
		enum msm_camera_i2c_data_type data_type);
	int32_t (*i2c_write_table_async)(struct msm_camera_i2c_client *client,
		struct msm_camera_i2c_reg_setting *write_setting);
	int32_t (*i2c_write_table_sync)(struct msm_camera_i2c_client *client,
		struct msm_camera_i2c_reg_setting *write_setting);
	int32_t (*i2c_write_table_sync_block)(
		struct msm_camera_i2c_client *client,
		struct msm_camera_i2c_reg_setting *write_setting);
};
