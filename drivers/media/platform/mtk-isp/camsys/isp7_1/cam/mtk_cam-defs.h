...
enum mtkcam_ipi_raw_video_id {
	...
	MTKCAM_IPI_RAW_YUVBO_1,		/* YUVBO_R1 */
	MTKCAM_IPI_RAW_YUVCO_1,		/* YUVCO_R1 */
	MTKCAM_IPI_RAW_YUVO_2,		/* YUVO_R2 */
	MTKCAM_IPI_RAW_YUVBO_2,		/* YUVBO_R2 */
	MTKCAM_IPI_RAW_YUVCO_2,		/* YUVCO_R2 */
	MTKCAM_IPI_RAW_YUVO_3,		/* YUVO_R3 */
	MTKCAM_IPI_RAW_YUVBO_3,		/* YUVBO_R3 */
	MTKCAM_IPI_RAW_YUVCO_3,		/* YUVCO_R3 */
	MTKCAM_IPI_RAW_YUVO_4,		/* YUVO_R4 */
	MTKCAM_IPI_RAW_YUVBO_4,		/* YUVBO_R4 */
	MTKCAM_IPI_RAW_YUVCO_4,		/* YUVCO_R4 */
	MTKCAM_IPI_RAW_YUVO_5,		/* YUVO_R5 */
	MTKCAM_IPI_RAW_YUVBO_5,		/* YUVBO_R5 */
	MTKCAM_IPI_RAW_YUVCO_5,		/* YUVCO_R5 */
	...
	MTKCAM_IPI_RAW_RZH1N2TBO_3,	/* RZH1N2TBO_R3 */
	MTKCAM_IPI_RAW_RZH1N2TO_1,	/* RZH1N2TO_R1 */
	MTKCAM_IPI_RAW_RZH1N2TBO_1,	/* RZH1N2TBO_R1 */
...
enum mtkcam_ipi_meta_valid_num_control {
	...
	MTKCAM_IPI_FBCX_RZH1N2TBO_R1,
	MTKCAM_IPI_FBCX_RZH1N2TO_R2,
	MTKCAM_IPI_FBCX_RZH1N2TO_R3,
	MTKCAM_IPI_FBCX_RZH1N2TBO_R3,
