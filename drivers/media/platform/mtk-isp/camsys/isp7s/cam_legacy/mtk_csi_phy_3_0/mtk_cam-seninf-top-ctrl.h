...
#define RG_SENINF_TOP_VS_OCC_ECO_DISABLE_SHIFT 0
#define RG_SENINF_TOP_VS_OCC_ECO_DISABLE_MASK (0x1 << 0)
#define RG_SENINF_TOP_DB_LOAD_ECO_DISABLE_SHIFT 1
#define RG_SENINF_TOP_DB_LOAD_ECO_DISABLE_MASK (0x1 << 1)
#define RG_SENINF_TOP_GLB_DROP_ECO_DISABLE_SHIFT 2
#define RG_SENINF_TOP_GLB_DROP_ECO_DISABLE_MASK (0x1 << 2)
#define RG_SENINF_TOP_SPARE_0_B7_3_SHIFT 3
#define RG_SENINF_TOP_SPARE_0_B7_3_MASK (0x1f << 3)
