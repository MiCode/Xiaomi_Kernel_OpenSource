...
static const struct mtk_imgsys_video_device_desc me_setting[] = {
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEFST_OUT,
		.name = "FSTI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MEMMGFST_OUT,
		.name = "MMGFSTI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &in_frmsizeenum,
		.description = "ME MMG FST Input ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MMGYROMV_OUT,
		.name = "GYROMVI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &in_frmsizeenum,
		.description = "MM GYRO MV Input ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MMFMB_OUT,
		.name = "MMFMBI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &in_frmsizeenum,
		.description = "MM FMB Input ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MMFST_OUT,
		.name = "MMFSTI Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_ME1WMV_CAPTURE,
		.name = "ME1WMVO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &out_frmsizeenum,
		.description = "ME WMV FOR DEBUG Output ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_ME1FMB_CAPTURE,
		.name = "ME1FMBO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &out_frmsizeenum,
		.description = "ME FMB FOR DEBUG Output ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MMMIL_CAPTURE,
		.name = "MMMILO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 0,
		.frmsizeenum = &out_frmsizeenum,
		.description = "MM MIL Output ",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_MMMMGFST_CAPTURE,
		.name = "MMFSTO Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
