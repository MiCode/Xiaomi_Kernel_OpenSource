...
static void *hcp_vb2_vmalloc_alloc(struct device *dev,
			       unsigned long attrs,
...
static void *hcp_vb2_vmalloc_get_userptr(struct device *dev,
				     unsigned long vaddr,
				     unsigned long size,
				     enum dma_data_direction dma_dir)
{
...
static void *hcp_vb2_vmalloc_vaddr(void *buf_priv)
{
	struct vb2_vmalloc_buf *buf = buf_priv;
...
static struct dma_buf *hcp_vb2_vmalloc_get_dmabuf(void *buf_priv,
	unsigned long flags)
{
	struct vb2_vmalloc_buf *buf = buf_priv;
	struct dma_buf *dbuf;
...
static void *hcp_vb2_vmalloc_attach_dmabuf(struct device *dev,
	struct dma_buf *dbuf,
	unsigned long size, enum dma_data_direction dma_dir)
{
	struct vb2_vmalloc_buf *buf;
