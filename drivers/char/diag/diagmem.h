...
#define POOL_TYPE_USB_APPS		3
#define POOL_TYPE_USB_PERIPHERALS	4
#define POOL_TYPE_DCI			5
#define POOL_TYPE_LOCAL_LAST		6
...
#define POOL_TYPE_MDM_USB		(POOL_TYPE_REMOTE_BASE + 4)
#define POOL_TYPE_MDM2_USB		(POOL_TYPE_REMOTE_BASE + 5)
#define POOL_TYPE_MDM_DCI_WRITE		(POOL_TYPE_REMOTE_BASE + 6)
#define POOL_TYPE_MDM2_DCI_WRITE	(POOL_TYPE_REMOTE_BASE + 7)
#define POOL_TYPE_QSC_USB		(POOL_TYPE_REMOTE_BASE + 8)
