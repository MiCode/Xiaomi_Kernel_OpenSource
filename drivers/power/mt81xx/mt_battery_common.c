...
static struct mt_battery_charging_custom_data default_charging_data = {
	...
	.non_std_ac_charger_current = CHARGE_CURRENT_1500_00_MA,
	.charging_host_charger_current = CHARGE_CURRENT_1000_00_MA,
	...
	.jeita_temp_pos_15_to_pos_45_cv_voltage = BATTERY_VOLT_04_360000_V,
	.jeita_temp_pos_0_to_pos_15_cv_voltage = BATTERY_VOLT_04_360000_V,
	.jeita_temp_below_0_cv_voltage = BATTERY_VOLT_04_100000_V,
	.temp_pos_60_threshold = 50,
	.temp_pos_60_thres_minus_x_degree = 47,
	.temp_pos_45_threshold = 45,
	.temp_pos_45_thres_minus_x_degree = 42,
	.temp_pos_15_threshold = 15,
	.temp_pos_15_thres_plus_x_degree = 18,
	.temp_pos_0_threshold = 0,
	.temp_pos_0_thres_plus_x_degree = 3,
...
static void mt_battery_update_EM(struct battery_data *bat_data)
{
	...
	if ((BMT_status.UI_SOC == 100) && BMT_status.charger_exist && bat_charger_get_charging_status())
...
#if defined(CONFIG_MTK_JEITA_STANDARD_SUPPORT)
	if (g_temp_status != TEMP_POS_15_TO_POS_45 && g_temp_status != TEMP_POS_0_TO_POS_15) {
...
static void battery_update(struct battery_data *bat_data)
{
	...
	bat_data->BAT_TEMP = BMT_status.temperature;
...
/*  not recover charging  when plug out/in usb for echo 0 > sys/devices/mediatek,battery_common/Charging_Enable */
/*
...
{
	pr_err("[Power/Battery][chrdet_bat_int_handler]....\n");
...
static void init_charging_data_from_dt(struct device_node *np)
{
	...
	bat_parse_node(np, "temp_pos_10_threshold", &p_bat_charging_data->temp_pos_15_threshold);
	bat_parse_node(np, "temp_pos_10_thres_plus_x_degree", &p_bat_charging_data->temp_pos_15_thres_plus_x_degree);
	...
	bat_parse_node(np, "jeita_temp_pos_10_to_pos_45_cv_voltage",
		&p_bat_charging_data->jeita_temp_pos_15_to_pos_45_cv_voltage);
	bat_parse_node(np, "jeita_temp_pos_0_to_pos_10_cv_voltage",
		&p_bat_charging_data->jeita_temp_pos_0_to_pos_15_cv_voltage);
	bat_parse_node(np, "jeita_temp_below_0_cv_voltage",
		&p_bat_charging_data->jeita_temp_below_0_cv_voltage);
