...
struct mt_battery_charging_custom_data {
	...
	int jeita_temp_pos_15_to_pos_45_cv_voltage;
	int jeita_temp_pos_0_to_pos_15_cv_voltage;
	int jeita_temp_below_0_cv_voltage;
	...
	int temp_pos_15_threshold;
	int temp_pos_15_thres_plus_x_degree;
