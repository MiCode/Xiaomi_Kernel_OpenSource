...
#ifndef __SMB_CHARGER_REG_H
#define __SMB_CHARGER_REG_H
...
#define BAT_MISS_THERM_SRC_EN_BIT	BIT(1)
#define BAT_MISS_BATID_SRC_EN_BIT	BIT(0)
...
#define TYPE_C_STATUS_2_7_BIT			BIT(7)
