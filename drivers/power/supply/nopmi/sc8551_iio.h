...
static const struct sc8551_iio_channels sc8551_iio_psy_channels[] = {
	...
	SC8551_CHAN_ENERGY("sc_chip_vendor", PSY_IIO_SC_CHIP_VENDOR)
	SC8551_CHAN_ENERGY("sc_chip_id", PSY_IIO_DEV_CHIP_ID)
...
static const struct sc8551_iio_channels sc8551_slave_iio_psy_channels[] = {
	...
	SC8551_CHAN_ENERGY("sc_chip_vendor_slave", PSY_IIO_SC_CHIP_VENDOR)
	SC8551_CHAN_ENERGY("sc_chip_id", PSY_IIO_DEV_CHIP_ID)
