...
struct charger_custom_data {
	...
	int xm_pps_single_charger_input_current;
	...
	int xm_pps_max_vbus;
	int xm_pps_max_ibus;
	int xm_pps_single_charger_current_non_verified_pps;
#endif
	...
	int step_b_aging;
	int step_c_aging;
	int current_step_aging;
	int current_max_aging;
