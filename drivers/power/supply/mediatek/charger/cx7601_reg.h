...
#ifndef __CX7601_HEADER__
#define __CX7601_HEADER__

/* Register 00h */
#define CX7601_REG_00      		0x00
#define REG00_ENHIZ_MASK		0x80
#define REG00_ENHIZ_SHIFT		7
#define	REG00_HIZ_ENABLE		1
#define	REG00_HIZ_DISABLE		0

#define	REG00_STAT_CTRL_MASK		0x40
#define REG00_STAT_CTRL_SHIFT		6
...
#define	REG00_VINDPM_MASK		0x78//00011111
#define	REG00_VINDPM_SHIFT		3
#define	REG00_VINDPM_BASE		3780
...
#define	REG01_BOOST_LIM_MASK		0x01
#define	REG01_BOOST_LIM_SHIFT		0
#define	REG01_BOOST_LIM_0P5A		0
#define	REG01_BOOST_LIM_1P2A		1


/* Register 0x02*/
#define CX7601_REG_02                   0x02
#if 0
...
#define REG05_CHG_TIMER_SHIFT     	0
...
/* Register 0x06*/
#define CX7601_REG_06                   0x06
#if 0
#define	REG06_OVP_MASK			0x18
...
#define	REG06_BOOSTV_4P85V		5
#define	REG06_BOOSTV_5V			7
#define	REG06_BOOSTV_5P15V		9
#define	REG06_BOOSTV_5P3V		12
...
#define	REG07_AVOV_TH_MASK		0x18
#define	REG07_AVOV_TH_SHIFT		3
#define	REG07_AVOV_TH_5P5V		0
#define	REG07_AVOV_TH_6P2V		1
#define	REG07_AVOV_TH_10P5V		2
#define	REG07_AVOV_TH_14P3V		3


/* Register 0x08*/
#define CX7601_REG_08             	0x08
...
/* Register 0x0A */
#define CX7601_REG_0A              	0x0A
#define	REG0A_VBUS_GD_MASK		0x10
#define	REG0A_VBUS_GD_SHIFT		7
#define	REG0A_VBUS_GD			1

#define	REG0A_VINDPM_STAT_MASK		0x40
#define	REG0A_VINDPM_STAT_SHIFT		4
...
#define CX7601_REG_0C			0X0C

#define	REG0C_BATFET_DLY_MASK		0x10
#define	REG0C_BATFET_DLY_SHIFT		4
#define	REG0C_BATFET_DLY_0S		0
#define	REG0C_BATFET_DLY_10S		1

#define CX7601_REG_0D			0X0D

#ifdef MTK_CX7601_SUPPORT
extern int cx7601_probe(void);
#else
static inline int cx7601_probe(void)
{
	        return 0;
}
#endif
