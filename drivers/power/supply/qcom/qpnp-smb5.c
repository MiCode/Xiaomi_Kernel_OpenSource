...
struct smb_charger *wt_smbchip = NULL;//bug 498013 zhaolinquan.wt, modify 20191104 F9S android P to Q bringup
...
static int smb5_chg_config_init(struct smb5 *chip)
{
	...
	case PMI632_SUBTYPE:
		...
		chg->wa_flags |= WEAK_ADAPTER_WA | USBIN_OV_WA
				| CHG_TERMINATION_WA | USBIN_ADC_WA;//bug 498013 zhaolinquan.wt, modify 20191104 F9S android P to Q bringup
		...
		union power_supply_propval *val)
{
	...
	int rc = 0;
	union power_supply_propval pval = {0, };//bug 498013 zhaolinquan.wt, modify 20191104 F9S android P to Q bringup
	...
	case POWER_SUPPLY_PROP_TECHNOLOGY:
		//bug 439226 zhaolinquan.wt, MODIFY, 20190415, change battery technology from Li-on to Li-poly
...
static int smb5_probe(struct platform_device *pdev)
{
	...
	mutex_init(&chg->adc_lock);//bug 444105 zhaolinquan.wt, MODIFY, 20190508, using usbin vadc patch
