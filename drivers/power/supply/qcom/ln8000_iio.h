...
static const struct ln8000_iio_channels ln8000_slave_iio_psy_channels[] = {
	LN8000_CHAN_ENERGY("ln_present_slave", PSY_IIO_PRESENT)
	LN8000_CHAN_ENERGY("ln_charging_enabled_slave", PSY_IIO_CHARGING_ENABLED)
	LN8000_CHAN_ENERGY("ln_status_slave", PSY_IIO_STATUS)
