...
//#endif
		...
		vote(chg->awake_votable, CHG_INSERT_VOTER, true, 0);//bug 431225 zhaolinquan.wt, MODIFY, 20190304, add period_update_work
...
static void typec_src_removal(struct smb_charger *chg)
{
	...
	vote(chg->awake_votable, CHG_INSERT_VOTER, false, 0);//bug 431225 zhaolinquan.wt, MODIFY, 20190304, add period_update_work
	/* reset USBOV votes and cancel work */
	cancel_delayed_work_sync(&chg->usbov_dbc_work);
	vote(chg->awake_votable, USBOV_DBC_VOTER, false, 0);
	chg->dbc_usbov = false;
...
extern const char *BATTERY_DEFAULT;//bug 498013 zhaolinquan.wt, modify 20191104 F9S android P to Q bringup
...
int smblib_init(struct smb_charger *chg)
{
	...
	chg->last_bat_current = 1;//bug 441468 zhaolinquan.wt, MODIFY, 20190505, set last_bat_current default value
