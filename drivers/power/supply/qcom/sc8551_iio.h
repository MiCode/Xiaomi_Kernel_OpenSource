...
#ifndef __SC8551_IIO_H
#define __SC8551_IIO_H
...
static const struct sc8551_iio_channels sc8551_iio_psy_channels[] = {
	SC8551_CHAN_ENERGY("present", PSY_IIO_PRESENT)
	SC8551_CHAN_ENERGY("charging_enabled", PSY_IIO_CHARGING_ENABLED)
	SC8551_CHAN_ENERGY("status", PSY_IIO_STATUS)
...
static const struct sc8551_iio_channels sc8551_slave_iio_psy_channels[] = {
	SC8551_CHAN_ENERGY("present_slave", PSY_IIO_PRESENT)
	SC8551_CHAN_ENERGY("charging_enabled_slave", PSY_IIO_CHARGING_ENABLED)
	SC8551_CHAN_ENERGY("status_slave", PSY_IIO_STATUS)
