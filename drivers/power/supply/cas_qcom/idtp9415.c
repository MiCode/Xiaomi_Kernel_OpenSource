...
#define DC_PAN_CURRENT_UA 1300000
...
static void idtp9220_wpc_det_work(struct work_struct *work)
{
	...
	cancel_delayed_work(&di->bpp_connect_load_work);
	...
	cancel_delayed_work_sync(&di->keep_awake_work);
...
MODULE_DESCRIPTION("IDTP Wireless Power Charger Monitor driver");
