...
#define ONE_WIRE_CONFIG_OUT		writel_relaxed(GPIO_ENABLE | DRV_STRENGTH_16MA | GPIO_OUTPUT | GPIO_PULL_UP, g_onewire_data->gpio_cfg66_reg)// OUT
...
void Software_Reset(void)                                  
{
	...
	for (i = 0; i < 40; i++)  //Pullup for 4ms
		Delay_us(100);
	step++;
	ow_dbg("DS28E16_software_reset success!\n");
}
