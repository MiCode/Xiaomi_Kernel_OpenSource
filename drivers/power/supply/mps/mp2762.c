...
static int mp2762_enable_otg(struct mp2762 *chip, bool enable)
{
	...
	if (enable) {
		...
		regmap_write(chip->regmap, 0x31, 0x02);
		regmap_write(chip->regmap, 0x3F, 0x04);
		regmap_write(chip->regmap, 0x3A, 0x40);
	...
	if (!enable) {
		mp2762_enable_test_mode(chip, true);
		regmap_write(chip->regmap, 0x3E, 0x80);
		regmap_write(chip->regmap, 0x31, 0x03);
		regmap_write(chip->regmap, 0x3A, 0x00);
...
static int mp2762_init_device(struct mp2762 *chip)
{
	...
	ret = regmap_write(chip->regmap, 0x11, 0xFF);
	ret = regmap_write(chip->regmap, 0x12, 0x77);
	ret = regmap_write(chip->regmap, 0x2D, 0x0F);
	ret = regmap_write(chip->regmap, 0x36, 0xF5);
