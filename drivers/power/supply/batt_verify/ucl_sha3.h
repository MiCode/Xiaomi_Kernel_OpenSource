 ...
 * @ingroup UCL_SHA3
 */
 int ucl_sha3_core(ucl_sha3_ctx_t *ctx, const unsigned char *msg, unsigned int size);
/*============================================================================*/
/** <b>SHA3 Finish</b>.
 ...
 */
  ...
  int ucl_sha3_finish(unsigned char *hash, ucl_sha3_ctx_t *ctx);
 ...
 */
  ...
  int ucl_sha3_224(unsigned char *digest, unsigned char *msg, unsigned int msg_Len);
 ...
 * @ingroup UCL_SHA3
 */
  int ucl_sha3_256(unsigned char *digest, unsigned char *msg, unsigned int msg_Len);
 ...
 * @ingroup UCL_SHA3
 */
  int ucl_sha3_384(unsigned char *digest, unsigned char *msg, unsigned int msg_Len);
 ...
 * @ingroup UCL_SHA3
 */
  int ucl_sha3_512(unsigned char *digest, unsigned char *msg, unsigned int msg_Len);
