	...
	union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_CAPACITY_LEVEL:
		...
		/*pr_err("POWER_SUPPLY_PROP_CAPACITY_LEVEL=%d",val->intval);*/
		break;
	case POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN:
		val->intval = 4000000;
		break;
	...
	case POWER_SUPPLY_PROP_CHARGE_FULL:
		val->intval =
			fg_table_cust_data.fg_profile[gm.battery_id].q_max * 1000;
		break;
	case POWER_SUPPLY_PROP_CHARGE_COUNTER:
		val->intval = gm.ui_soc * 4000 * 1000 / 100;
		break;
...
void battery_update(struct battery_data *bat_data)
{
	...
	else if( gm.tbat_precise >= 450 && gm.tbat_precise < 600)
	{
