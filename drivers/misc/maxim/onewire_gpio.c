...
#define ONE_WIRE_GPIO_ADDR		0x200000
#define ONE_WIRE_GPIO_OFFSET		21
#define ONE_WIRE_CONFIG_OUT		writel_relaxed(ONE_WIRE_GPIO_ADDR, g_onewire_data->gpio_dir_set_addr)// OUT
#define ONE_WIRE_CONFIG_IN		writel_relaxed(ONE_WIRE_GPIO_ADDR, g_onewire_data->gpio_dir_clr_addr)// IN
#define ONE_WIRE_OUT_HIGH		writel_relaxed(ONE_WIRE_GPIO_ADDR, g_onewire_data->gpio_dout_set_addr)// OUT: 1
#define ONE_WIRE_OUT_LOW		writel_relaxed(ONE_WIRE_GPIO_ADDR, g_onewire_data->gpio_dout_clr_addr)// OUT: 0
