...
{
	return blocking_notifier_chain_register(&xiaomi_panel_notifier_list,
						nb);
}
...
{
	return blocking_notifier_chain_unregister(&xiaomi_panel_notifier_list,
						  nb);
}
...
{
	return blocking_notifier_call_chain(&xiaomi_panel_notifier_list, val,
					    v);
}
