...
char Lcm_name[HARDWARE_MAX_ITEM_LONGTH]={0};//req  wuzhenzhen.wt 20140901 add for hardware info
char Sar_name[HARDWARE_MAX_ITEM_LONGTH]={0};//bug 417945 , add sar info, chenrongli.wt, 20181218
char board_id[HARDWARE_MAX_ITEM_LONGTH]={0};//req  wuzhenzhen.wt 20140901 add for hardware info
