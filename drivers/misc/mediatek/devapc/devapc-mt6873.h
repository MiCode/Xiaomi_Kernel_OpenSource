...
enum MFG_PA {
	MFG_PA_START = 0x13000000,
	MFG_PA_END = 0x13FFFFFF,
};

/* TODO */
enum GCE_PA {
	GCE_PA_START = 0x10228000,
	GCE_PA_END = 0x1022BFFF,
	GCE_M2_PA_START = 0x10318000,
	GCE_M2_PA_END = 0x1031BFFF,
};
