...
#define MCUPM_MBOX_SIZE_SUSPEND		10 /* slot size: 4 bytes */
#define MCUPM_MBOX_OFFSET_PDN		(MCUPM_MBOX_OFFSET_SUSPEND + \
					MCUPM_MBOX_SIZE_SUSPEND)

#define MCUPM_MBOX_SIZE_PDN		2 /* slot size: 4 bytes */
#define MCUPM_MBOX_OFFSET_TIMESTAMP	(MCUPM_MBOX_OFFSET_PDN + \
					MCUPM_MBOX_SIZE_PDN)
