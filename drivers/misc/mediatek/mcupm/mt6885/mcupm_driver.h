...
#define MCUPM_MBOX_NO_MCDI		3
#define MCUPM_MBOX_NO_SUSPEND		4

#define MCUPM_BOX_OFFSET_MCDI		0
#define MCUPM_BOX_SIZE_MCDI		10 /* uint 4 bytes */
#define MCUPM_BOX_OFFSET_TIMESTAMP	(MCUPM_BOX_OFFSET_MCDI + \
					MCUPM_BOX_SIZE_MCDI)

#define MCUPM_MBOX_OFFSET_SUSPEND	0
#define MCUPM_MBOX_SIZE_SUSPEND		10 /* uint 4 bytes */
#define MCUPM_MBOX_OFFSET_PDN		(MCUPM_MBOX_OFFSET_SUSPEND + \
					MCUPM_MBOX_SIZE_SUSPEND)
