...
/*/ VBL min is 6 (VBL=VBP+VFP)*/
	params->dsi.vertical_sync_active = 2; /* min: 2*/
	params->dsi.vertical_backporch = 8; /* min: 2*/
	params->dsi.vertical_frontporch = 10; /* min: 2*/
	params->dsi.vertical_active_line = FRAME_HEIGHT;

/** Suggested and minimum values
HSA: 10
HBP: 60
HFP: 100
*/
	params->dsi.horizontal_sync_active				= 10;
	params->dsi.horizontal_backporch				= 60; /* min in spec is 45*/
	params->dsi.horizontal_frontporch				= 100 ; /* min in spec is 70*/
...
LCM_DRIVER r63417_fhd_dsi_vdo_truly_nt50358_lcm_drv = {
	.name = "r63417_fhd_dsi_vdo_truly_nt50358_drv",
