...
#ifndef CONFIG_FPGA_EARLY_PORTING
#if (LCM_DSI_CMD_MODE)
	params->dsi.PLL_CLOCK = 100; //this value must be in MTK suggested table
#else
...
LCM_DRIVER nt35595_fhd_dsi_cmd_truly_nt50358_wvga_lcm_drv=
{
    .name           	= "nt35595_fhd_dsi_cmd_truly_nt50358_wvga_drv",
