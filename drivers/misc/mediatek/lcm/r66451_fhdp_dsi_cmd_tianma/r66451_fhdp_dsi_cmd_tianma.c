...
static struct LCM_setting_table init_setting[] = {
	...
	/* set PLL to 285M */
	{0xB0, 1, {0x00} },
	{0xB6, 12, {0x59, 0x00, 0x06, 0x23, 0x8A, 0x13, 0x1A, 0x05,
		      0x04, 0xFA, 0x05, 0x20} },
		       ...
		       unsigned char force_update)
{
	...
	pr_info("[lcm]r66451 %s start, line:%d", __func__, __LINE__);
