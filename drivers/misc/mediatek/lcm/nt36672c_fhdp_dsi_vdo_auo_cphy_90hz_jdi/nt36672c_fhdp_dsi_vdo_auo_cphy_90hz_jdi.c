...
#if (LCM_DSI_CMD_MODE)
struct LCM_DRIVER nt36672c_fhdp_dsi_cmd_auo_cphy_90hz_jdi_lcm_drv = {
	.name = "nt36672c_fhdp_dsi_cmd_auo_cphy_90hz_jdi_lcm_drv",
#else
struct LCM_DRIVER nt36672c_fhdp_dsi_vdo_auo_cphy_90hz_jdi_lcm_drv = {
