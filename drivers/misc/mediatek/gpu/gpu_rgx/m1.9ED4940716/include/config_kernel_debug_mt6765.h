...
#define MTK_CHCEKPATCH_1 RGXFWIF_INICFG_VDM_CTX_STORE_MODE_INDEX
#define PVRSRV_APPHINT_VDMCONTEXTSWITCHMODE MTK_CHCEKPATCH_1
...
#define MTK_CHCEKPATCH_2 RGXFWIF_CTXSWITCH_PROFILE_MEDIUM_EN
#define PVRSRV_APPHINT_FWCONTEXTSWITCHPROFILE MTK_CHCEKPATCH_2
