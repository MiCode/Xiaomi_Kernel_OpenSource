...
#endif
static void __iomem *g_gpu_base;
static void __iomem *g_mfgcfg_base;
...
#endif
	/** WA for buffer decompressor HW bug **/
	/* disable security */
	ui64CC_val = 0x0;
	OSWriteHWReg64(g_gpu_base, 0xA100, ui64CC_val);
	/* set constant color into transparent */
	ui64CC_val = 0x0;
	OSWriteHWReg64(g_gpu_base, 0xA520, ui64CC_val);
	/* enable security */
	ui64CC_val = 0x1;
	OSWriteHWReg64(g_gpu_base, 0xA100, ui64CC_val);

	/** axi 2to2 **/
	OSWriteHWReg32(g_mfgcfg_base, 0x8e0, 0x11);
	OSWriteHWReg32(g_mfgcfg_base, 0x8e4, 0x100);
	OSWriteHWReg32(g_mfgcfg_base, 0x8e8, 0x11);
	OSWriteHWReg32(g_mfgcfg_base, 0x8ec, 0x100);
...
static int MTKInitHWAPM(void)
{
	...
	OSWriteHWReg32(g_mfgcfg_base, 0xC10, 0x01a80000);
	OSWriteHWReg32(g_mfgcfg_base, 0xC14, 0x80010);
	OSWriteHWReg32(g_mfgcfg_base, 0xC18, 0x100008);
	OSWriteHWReg32(g_mfgcfg_base, 0xC1C, 0x00b800c8);
	OSWriteHWReg32(g_mfgcfg_base, 0xC20, 0x00b000c0);
	OSWriteHWReg32(g_mfgcfg_base, 0xC24, 0x00c000c8);
	OSWriteHWReg32(g_mfgcfg_base, 0xC28, 0x00b000b8);
	OSWriteHWReg32(g_mfgcfg_base, 0xC2C, 0x00d000d0);
	OSWriteHWReg32(g_mfgcfg_base, 0xC30, 0x00d000d0);
	OSWriteHWReg32(g_mfgcfg_base, 0xC34, 0x00d00000);


	OSWriteHWReg32(g_mfgcfg_base, 0xC38, 0x03a80200);
	OSWriteHWReg32(g_mfgcfg_base, 0xC3C, 0x02080210);
	OSWriteHWReg32(g_mfgcfg_base, 0xC40, 0x02100208);
	OSWriteHWReg32(g_mfgcfg_base, 0xC44, 0x02b802c8);
	OSWriteHWReg32(g_mfgcfg_base, 0xC48, 0x02b002c0);
	OSWriteHWReg32(g_mfgcfg_base, 0xC4C, 0x02c002c8);
	OSWriteHWReg32(g_mfgcfg_base, 0xC50, 0x02b002b8);
	OSWriteHWReg32(g_mfgcfg_base, 0xC54, 0x02d002d0);
	OSWriteHWReg32(g_mfgcfg_base, 0xC58, 0x02d002d0);
	OSWriteHWReg32(g_mfgcfg_base, 0xC5C, 0x02d00200);
	OSWriteHWReg32(g_mfgcfg_base, 0xC00, 0x9004001b);
	OSWriteHWReg32(g_mfgcfg_base, 0xC00, 0x8004001b);

	if (gpu_debug_enable) {
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC10, OSReadHWReg32(g_mfgcfg_base, 0xC10)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC14, OSReadHWReg32(g_mfgcfg_base, 0xC14)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC18, OSReadHWReg32(g_mfgcfg_base, 0xC18)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC1C, OSReadHWReg32(g_mfgcfg_base, 0xC1C)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC20, OSReadHWReg32(g_mfgcfg_base, 0xC20)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC24, OSReadHWReg32(g_mfgcfg_base, 0xC24)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC28, OSReadHWReg32(g_mfgcfg_base, 0xC28)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC2C, OSReadHWReg32(g_mfgcfg_base, 0xC2C)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC30, OSReadHWReg32(g_mfgcfg_base, 0xC30)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC34, OSReadHWReg32(g_mfgcfg_base, 0xC34)));

		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC38, OSReadHWReg32(g_mfgcfg_base, 0xC38)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC3C, OSReadHWReg32(g_mfgcfg_base, 0xC3C)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC40, OSReadHWReg32(g_mfgcfg_base, 0xC40)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC44, OSReadHWReg32(g_mfgcfg_base, 0xC44)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC48, OSReadHWReg32(g_mfgcfg_base, 0xC48)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC4C, OSReadHWReg32(g_mfgcfg_base, 0xC4C)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC50, OSReadHWReg32(g_mfgcfg_base, 0xC50)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC54, OSReadHWReg32(g_mfgcfg_base, 0xC54)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC58, OSReadHWReg32(g_mfgcfg_base, 0xC58)));
		PVR_DPF((PVR_DBG_ERROR, "HWAPM: g_mfgcfg_base + 0x%x = 0x%x",
			0xC5C, OSReadHWReg32(g_mfgcfg_base, 0xC5C)));
	}
	...
	if (psDevNode) {
		...
		if ((eResult == PVRSRV_OK) || (eResult == PVRSRV_ERROR_RETRY)) {
			...
			if (ePowerState == PVRSRV_DEV_POWER_STATE_ON) {
				mt_gpufreq_target(ui32NewFreqID);
				g_bUnsync = IMG_FALSE;
				ged_log_buf_print2(_mtk_ged_log
					, GED_LOG_ATTR_TIME
					, "vgpu: %u, vsram: %u, freq: %u"
					, mt_gpufreq_get_cur_volt()
					, mt_gpufreq_get_cur_vsram()
