...
extern INT8 stp_dbg_nl_send(PINT8 aucMsg, UINT8 cmd, INT32 len);
...
extern INT32 stp_dbg_set_version_info(UINT32 chipid,PUINT8 pRomVer,PUINT8 wifiVer,PUINT8 pPatchVer,PUINT8 pPatchBrh);
