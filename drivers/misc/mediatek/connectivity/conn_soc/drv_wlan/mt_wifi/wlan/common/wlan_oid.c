    ...
    )
{
	...
	if(*(PUINT_8)pvSetBuffer == 1){
		ucCmd = TRUE;
	}else {
		ucCmd = FALSE;
	}

	DBGLOG(INIT, INFO, ("%s ucCmd:%d \n", __FUNCTION__, ucCmd));

    /* Update domain info to chip */
    wlanSendSetQueryCmd (
                prAdapter,					/* prAdapter */
                CMD_ID_SET_TX_ERR_REPORT,	/* ucCID */
                TRUE,						/* fgSetQuery */
                FALSE,						/* fgNeedResp */
                FALSE,						/* fgIsOid */
                NULL,						/* pfCmdDoneHandler*/
                NULL,						/* pfCmdTimeoutHandler */
                sizeof(UINT_8),				/* u4SetQueryInfoLen */
                (PUINT_8) &ucCmd,			/* pucInfoBuffer */
                NULL,                       /* pvSetQueryBuffer */
                0                           /* u4SetQueryBufferLen */
                );
	return WLAN_STATUS_SUCCESS;
    ...
    )
{
    ...
    *pu4SetInfoLen = sizeof(CMD_RLM_INFO_T);
	...
	DBGLOG(INIT, INFO, ("<tar_cmd> command = %u %u %u %u %d %u %u\n",
...
#endif /* CFG_SUPPORT_BCN_TUNE */

WLAN_STATUS
wlanoidSetTxParam (  //TxParam
    IN  P_ADAPTER_T       prAdapter,
    IN  PVOID             pvSetBuffer,
    IN  UINT_32           u4SetBufferLen,
    OUT PUINT_32          pu4SetInfoLen
...
{
	printk("//TxParam wlanoidSetTxParam CMD_ID_SET_TX_PARAM E\n");
    /* Update domain info to chip */
    wlanSendSetQueryCmd (
                prAdapter,					/* prAdapter */
                CMD_ID_SET_TX_PARAM,	/* ucCID */
                TRUE,						/* fgSetQuery */
                FALSE,						/* fgNeedResp */
                FALSE,						/* fgIsOid */
                NULL,						/* pfCmdDoneHandler*/
                NULL,						/* pfCmdTimeoutHandler */
                sizeof(CMD_TX_PARAM_T),				/* u4SetQueryInfoLen */
                (PUINT_8) pvSetBuffer,			/* pucInfoBuffer */
                NULL,                       /* pvSetQueryBuffer */
                0                           /* u4SetQueryBufferLen */
                );
	printk("//TxParam wlanoidSetTxParam CMD_ID_SET_TX_PARAM X\n");
	return WLAN_STATUS_SUCCESS;
}

WLAN_STATUS
wlanoidSetPsIntervalParam (  //PsIntervalParam
    IN  P_ADAPTER_T       prAdapter,
    IN  PVOID             pvSetBuffer,
    IN  UINT_32           u4SetBufferLen,
    OUT PUINT_32          pu4SetInfoLen
...
{
	printk("//PsIntervalParam wlanoidSetTxParam CMD_ID_SET_PS_INTERVAL_PARAM E\n");
    /* Update domain info to chip */
    wlanSendSetQueryCmd (
                prAdapter,					/* prAdapter */
                CMD_ID_SET_PS_INTERVAL_PARAM,	/* ucCID */
                TRUE,						/* fgSetQuery */
                FALSE,						/* fgNeedResp */
                FALSE,						/* fgIsOid */
                NULL,						/* pfCmdDoneHandler*/
                NULL,						/* pfCmdTimeoutHandler */
                sizeof(CMD_PS_INTERVAL_PARAM_T),				/* u4SetQueryInfoLen */
                (PUINT_8) pvSetBuffer,			/* pucInfoBuffer */
                NULL,                       /* pvSetQueryBuffer */
                0                           /* u4SetQueryBufferLen */
                );
	printk("//PsIntervalParam wlanoidSetTxParam CMD_ID_SET_PS_INTERVAL_PARAM X\n");
	return WLAN_STATUS_SUCCESS;
}
