...
typedef enum _ENUM_CMD_ID_T {
    ...
    CMD_ID_SET_PSCAN_ENABLE,            /* 0x43 (Set) */
    CMD_ID_SET_PSCAN_PARAM,             /* 0x44 (Set) */
    CMD_ID_SET_GSCAN_ADD_HOTLIST_BSSID, /* 0x45 (Set) */
    CMD_ID_SET_GSCAN_ADD_SWC_BSSID,     /* 0x46 (Set) */ //SWC: Significant Wifi Change
    CMD_ID_SET_PSCAN_MAC_ADDR,          /* 0x47 (Set) */
    CMD_ID_GET_GSCAN_RESULT,            /* 0x48 (Query) */
    CMD_ID_BEACON_CONFIG = 0x49,		/* 0x49 (Set) */

	CMD_ID_GET_SET_CUSTOMER_CFG =0x70,  /* 0x70 (Set/Query) */ //CFG_SUPPORT_EASY_DEBUG
    CMD_ID_SET_TX_PARAM       ,         /* 0x71 (Set) */ //TxParam
    CMD_ID_SET_PS_INTERVAL_PARAM,       /* 0x72 (Set) */ //PsIntervalParam
