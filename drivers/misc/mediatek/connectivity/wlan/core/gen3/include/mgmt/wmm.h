...
struct SOFT_ACM_CTRL {
	UINT_32 u4RemainTime;
	UINT_32 u4AdmittedTime;
	UINT_32 u4IntervalEndSec;
	UINT_16 u2DeqNum;
};
#endif
...
VOID wmmAcmTxStatistic(P_ADAPTER_T prAdapter, UINT_8 ucAc, UINT_32 u4Remain, UINT_16 u2DeqNum);

UINT_32
wmmCalculatePktUsedTime(P_BSS_INFO_T prBssInfo, P_STA_RECORD_T prStaRec, UINT_16 u2PktLen);
VOID wmmPrepareFastUsedTimeCal(P_ADAPTER_T prAdapter);
UINT_32 wmmFastCalPktUsedTime(struct WMM_INFO *prWmmInfo, UINT_8 ucAc, UINT_16 u2PktLen);
