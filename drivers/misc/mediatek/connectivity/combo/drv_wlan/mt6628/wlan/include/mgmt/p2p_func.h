...
p2pFuncStartGO(IN P_ADAPTER_T prAdapter,
	       ...
	       IN ENUM_BAND_T eBand, IN ENUM_CHNL_EXT_T eSco, IN BOOLEAN fgIsPureAP);
...
BOOLEAN
p2pFuncValidateAssocReq(IN P_ADAPTER_T prAdapter,
...
BOOLEAN
p2pFuncParseCheckForP2PInfoElem(IN P_ADAPTER_T prAdapter,
...
p2pFuncGetAttriList(IN P_ADAPTER_T prAdapter,
		    ...
		    OUT PPUINT_8 ppucAttriList, OUT PUINT_16 pu2AttriListLen);
...
p2pFuncGetSpecAttri(IN P_ADAPTER_T prAdapter,
		    IN UINT_8 ucOuiType,
		    IN PUINT_8 pucIEBuf, IN UINT_16 u2BufferLen, IN UINT_16 u2AttriID);


BOOLEAN p2pFuncIsChannelGrant(IN P_ADAPTER_T prAdapter);
