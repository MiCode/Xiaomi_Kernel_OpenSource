...
#define ELLIPTIC_ULTRASOUND_SYSTEM_CONFIG 4
#define ELLIPTIC_ULTRASOUND_RAMP_DOWN 5
#define ELLIPTIC_ULTRASOUND_OPERATION_MODE 6
#define ELLIPTIC_INIT_DEBUG_SEGMENT 7
...
#define ELLIPTIC_IPI_MSG_HDR_SIZE 8
...
int elliptic_data_initialize(struct elliptic_data *elliptic_data,
			     size_t max_queue_size, unsigned int wakeup_timeout,
			     int id);
