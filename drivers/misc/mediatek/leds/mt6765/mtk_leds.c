...
int pmic_period_array[] = { 2, 4, 6, 8, 10, 12, 20, 60, 2500 };
int pmic_freqsel_array[] = { 0, 1, 2, 3, 4, 5, 9, 28, 1249 };
...
int mt_brightness_set_pmic(enum mt65xx_led_pmic pmic_type, u32 level, u32 div)
{
	...
	if (pmic_type == MT65XX_LED_PMIC_NLED_ISINK1) {
		...
		pmic_set_register_value(PMIC_ISINK_DIM1_DUTY, 100);
