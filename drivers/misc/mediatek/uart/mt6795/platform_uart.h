...
/*------ IRQ Section -----------------------*/
#ifndef CONFIG_OF
#define UART0_IRQ_ID	UART0_IRQ_BIT_ID
#define UART1_IRQ_ID	UART1_IRQ_BIT_ID
#define UART2_IRQ_ID	UART2_IRQ_BIT_ID
#define UART3_IRQ_ID	UART3_IRQ_BIT_ID

/*Note: Different from other UART numbers (counting from 0~3), VFF count from 1~4 due to some historical reasons*/
...
#endif
/*------ PDN Section -----------------------*/
#define PDN_FOR_UART0	MT_CG_PERI_UART0
#define PDN_FOR_UART1	MT_CG_PERI_UART1
#define PDN_FOR_UART2	MT_CG_PERI_UART2
#define PDN_FOR_UART3	MT_CG_PERI_UART3
...
do {    \
	...
	if (DBG_EVT_##evt & DBG_EVT_ERR) \
	    ...
	    pr_notice("  [%d]:%c: " fmt , uart->nport, s[0], ##args); \
    } \
} while (0)
/*---------------------------------------------------------------------------*/
...
#define MSGERR(fmt, args...)    pr_err("  [%d]:E:%4d: " fmt, uart->nport, __LINE__, ##args)
...
#endif /**/
#define MSG_ERR(fmt, args...)   pr_err(":E:%4d: " fmt, __LINE__, ##args)
#define MSG_TRC(fmt, args...)   pr_notice(":T: " fmt, ##args)
#define DEV_TRC(fmt, args...)   pr_notice("[%d]:T: " fmt, uart->nport, ##args)
#define DEV_ERR(fmt, args...)   pr_err("[%d]:E: " fmt, uart->nport, ##args)
/*---------------------------------------------------------------------------*/
