...
#ifndef __MT6873_DBG_FS_COMMON_H__
#define __MT6873_DBG_FS_COMMON_H__
...
int mt6873_dbg_spm_fs_init(void);
...
int mt6873_lpm_trace_init(void);

void mt6873_lpm_trace_deinit(void);
