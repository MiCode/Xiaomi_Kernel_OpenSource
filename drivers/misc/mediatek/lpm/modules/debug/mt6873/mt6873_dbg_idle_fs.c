...
static ssize_t mt6873_idle_dram_read(char *ToUserBuf,
					size_t sz, void *priv)
{
	char *p = ToUserBuf;
	uint32_t block, b;
...
static ssize_t mt6873_idle_dram_write(char *FromUserBuf,
				   size_t sz, void *priv)
{
	char cmd[128];
	int parm;
...
static const struct mtk_idle_sysfs_op mt6873_idle_dram_fops = {
	.fs_read = mt6873_idle_dram_read,
	.fs_write = mt6873_idle_dram_write,
};

static ssize_t mt6873_idle_syspll_read(char *ToUserBuf,
					size_t sz, void *priv)
{
	char *p = ToUserBuf;
	uint32_t block, b;
...
static ssize_t mt6873_idle_syspll_write(char *FromUserBuf,
				   size_t sz, void *priv)
{
	char cmd[128];
	int parm;
...
static const struct mtk_idle_sysfs_op mt6873_idle_syspll_fops = {
	.fs_read = mt6873_idle_syspll_read,
	.fs_write = mt6873_idle_syspll_write,
};

static ssize_t mt6873_idle_bus26m_read(char *ToUserBuf,
					size_t sz, void *priv)
{
	char *p = ToUserBuf;
	uint32_t block, b;
...
static ssize_t mt6873_idle_bus26m_write(char *FromUserBuf,
				   size_t sz, void *priv)
{
	char cmd[128];
	int parm;
...
static const struct mtk_idle_sysfs_op mt6873_idle_bus26m_fops = {
	.fs_read = mt6873_idle_bus26m_read,
	.fs_write = mt6873_idle_bus26m_write,
};

int mt6873_dbg_idle_fs_init(void)
{
	...
	mtk_idle_sysfs_entry_node_add("IdleDram_state"
		      , 0644, &mt6873_idle_dram_fops, NULL);
	mtk_idle_sysfs_entry_node_add("IdleSyspll_state"
		      , 0644, &mt6873_idle_syspll_fops, NULL);
	mtk_idle_sysfs_entry_node_add("IdleBus26m_state"
		      , 0644, &mt6873_idle_bus26m_fops, NULL);
	return 0;
}

int mt6873_dbg_idle_fs_deinit(void)
{
