...
static char *mt6853_pwr_ctrl_str[PW_MAX_COUNT] = {
...
static ssize_t mt6853_show_pwr_ctrl(int id, char *buf, size_t buf_sz)
{
	char *p = buf;
	size_t mSize = 0;
	...
	/* SPM_SRC6_MASK */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_ccif_event_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CCIF_EVENT_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_ccif_event_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CCIF_EVENT_APSRC_REQ_MASK_B, 0));
	/* SPM_SRC_REQ */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_spm_ddren_req = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SPM_DDREN_REQ, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	/* SPM_SRC_MASK */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_0_srcclkena_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_0_SRCCLKENA_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_0_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_0_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_0_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_0_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_0_vrf18_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_0_VRF18_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_0_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_0_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_1_srcclkena_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_1_SRCCLKENA_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_1_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_1_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_1_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_1_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_1_vrf18_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_1_VRF18_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_md_1_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MD_1_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_conn_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CONN_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_conn_vfe28_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CONN_VFE28_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_srcclkeni_srcclkena_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SRCCLKENI_SRCCLKENA_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_srcclkeni_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SRCCLKENI_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_infrasys_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_INFRASYS_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_infrasys_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_INFRASYS_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_sspm_srcclkena_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SSPM_SRCCLKENA_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_sspm_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SSPM_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_sspm_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SSPM_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_sspm_vrf18_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SSPM_VRF18_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_sspm_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SSPM_DDREN_REQ_MASK_B, 0));
	/* SPM_SRC2_MASK */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_scp_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SCP_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_audio_dsp_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_AUDIO_DSP_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_ufs_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_UFS_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_disp0_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DISP0_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_disp0_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DISP0_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_disp1_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DISP1_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_disp1_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DISP1_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_gce_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_GCE_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_apu_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_APU_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_cg_check_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CG_CHECK_DDREN_REQ_MASK_B, 0));
	/* SPM_SRC3_MASK */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_sw2spm_wakeup_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SW2SPM_WAKEUP_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_adsp2spm_wakeup_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_ADSP2SPM_WAKEUP_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_sspm2spm_wakeup_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SSPM2SPM_WAKEUP_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_scp2spm_wakeup_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SCP2SPM_WAKEUP_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_csyspwrup_ack_mask = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CSYSPWRUP_ACK_MASK, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_spm_reserved_srcclkena_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SPM_RESERVED_SRCCLKENA_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_spm_reserved_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SPM_RESERVED_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_spm_reserved_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SPM_RESERVED_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_spm_reserved_vrf18_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SPM_RESERVED_VRF18_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_spm_reserved_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_SPM_RESERVED_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_mcupm_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MCUPM_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_msdc0_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MSDC0_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_msdc1_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MSDC1_DDREN_REQ_MASK_B, 0));
	/* SPM_SRC4_MASK */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_ccif_event_srcclkena_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CCIF_EVENT_SRCCLKENA_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_bak_psri_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_BAK_PSRI_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_dramc_md32_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DRAMC_MD32_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_dramc_md32_vrf18_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DRAMC_MD32_VRF18_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_conn_srcclkenb2pwrap_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_CONN_SRCCLKENB2PWRAP_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_dramc_md32_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DRAMC_MD32_APSRC_REQ_MASK_B, 0));
	/* SPM_SRC5_MASK */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_mcusys_merge_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MCUSYS_MERGE_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_afe_srcclkena_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_AFE_SRCCLKENA_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_afe_infra_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_AFE_INFRA_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_afe_apsrc_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_AFE_APSRC_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_afe_vrf18_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_AFE_VRF18_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_afe_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_AFE_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_msdc2_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_MSDC2_DDREN_REQ_MASK_B, 0));
	/* SPM_SRC7_MASK */
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_pcie_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_PCIE_DDREN_REQ_MASK_B, 0));
	mSize += scnprintf(p + mSize, buf_sz - mSize,
	...
	mSize += scnprintf(p + mSize, buf_sz - mSize,
			"reg_dpmaif_ddren_req_mask_b = 0x%zx\n",
			mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_GET,
				PW_REG_DPMAIF_DDREN_REQ_MASK_B, 0));
 ...
 **************************************/
/* code gen by spm_pwr_ctrl_atf.pl, need struct pwr_ctrl */
static ssize_t mt6853_store_pwr_ctrl(int id,	const char *buf, size_t count)
{
	u32 val;
	char cmd[64];
	...
	if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS_CUST])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS_CUST, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS_CUST_SET])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS_CUST_SET, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS_CUST_CLR])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS_CUST_CLR, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS1])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS1, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS1_CUST])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS1_CUST, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS1_CUST_SET])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS1_CUST_SET, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_PCM_FLAGS1_CUST_CLR])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_PCM_FLAGS1_CUST_CLR, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_TIMER_VAL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_TIMER_VAL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_TIMER_VAL_CUST])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_TIMER_VAL_CUST, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_TIMER_VAL_RAMP_EN])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_TIMER_VAL_RAMP_EN, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_TIMER_VAL_RAMP_EN_SEC])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_TIMER_VAL_RAMP_EN_SEC, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_WAKE_SRC])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_WAKE_SRC, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_WAKE_SRC_CUST])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_WAKE_SRC_CUST, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_WAKELOCK_TIMER_VAL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_WAKELOCK_TIMER_VAL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_WDT_DISABLE])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_WDT_DISABLE, val);
	/* SPM_CLK_CON */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKEN0_CTL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKEN0_CTL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKEN1_CTL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKEN1_CTL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_LOCK_INFRA_DCM])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_LOCK_INFRA_DCM, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKEN_MASK])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKEN_MASK, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD1_C32RM_EN])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD1_C32RM_EN, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD2_C32RM_EN])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD2_C32RM_EN, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CLKSQ0_SEL_CTRL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CLKSQ0_SEL_CTRL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CLKSQ1_SEL_CTRL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CLKSQ1_SEL_CTRL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKEN0_EN])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKEN0_EN, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKEN1_EN])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKEN1_EN, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SYSCLK0_SRC_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SYSCLK0_SRC_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SYSCLK1_SRC_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SYSCLK1_SRC_MASK_B, val);
	/* SPM_AP_STANDBY_CON */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_WFI_OP])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_WFI_OP, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_WFI_TYPE])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_WFI_TYPE, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MP0_CPUTOP_IDLE_MASK])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MP0_CPUTOP_IDLE_MASK, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MP1_CPUTOP_IDLE_MASK])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MP1_CPUTOP_IDLE_MASK, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUSYS_IDLE_MASK])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUSYS_IDLE_MASK, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_APSRC_1_SEL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_APSRC_1_SEL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_APSRC_0_SEL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_APSRC_0_SEL, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_APSRC_SEL])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_APSRC_SEL, val);
	/* SPM_SRC6_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CCIF_EVENT_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CCIF_EVENT_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CCIF_EVENT_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CCIF_EVENT_APSRC_REQ_MASK_B, val);
	/* SPM_SRC_REQ */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_APSRC_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_APSRC_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_F26M_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_F26M_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_INFRA_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_INFRA_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_VRF18_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_VRF18_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_DDREN_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_DDREN_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_DVFS_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_DVFS_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_SW_MAILBOX_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_SW_MAILBOX_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_SSPM_MAILBOX_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_SSPM_MAILBOX_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_ADSP_MAILBOX_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_ADSP_MAILBOX_REQ, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_SCP_MAILBOX_REQ])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_SCP_MAILBOX_REQ, val);
	/* SPM_SRC_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_0_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_0_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_0_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_0_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_0_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_0_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_0_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_0_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_0_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_0_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_1_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_1_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_1_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_1_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_1_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_1_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_1_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_1_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_1_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_1_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_SRCCLKENB_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_SRCCLKENB_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_VFE28_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_VFE28_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKENI_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKENI_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_INFRASYS_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_INFRASYS_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_INFRASYS_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_INFRASYS_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SSPM_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SSPM_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SSPM_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SSPM_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SSPM_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SSPM_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SSPM_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SSPM_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SSPM_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SSPM_DDREN_REQ_MASK_B, val);
	/* SPM_SRC2_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SCP_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SCP_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SCP_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SCP_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SCP_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SCP_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SCP_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SCP_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SCP_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SCP_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AUDIO_DSP_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AUDIO_DSP_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AUDIO_DSP_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AUDIO_DSP_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AUDIO_DSP_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AUDIO_DSP_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AUDIO_DSP_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AUDIO_DSP_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AUDIO_DSP_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AUDIO_DSP_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_UFS_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_UFS_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_UFS_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_UFS_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_UFS_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_UFS_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_UFS_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_UFS_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_UFS_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_UFS_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DISP0_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DISP0_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DISP0_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DISP0_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DISP1_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DISP1_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DISP1_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DISP1_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_GCE_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_GCE_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_GCE_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_GCE_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_GCE_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_GCE_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_GCE_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_GCE_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_APU_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_APU_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_APU_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_APU_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_APU_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_APU_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_APU_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_APU_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_APU_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_APU_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CG_CHECK_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CG_CHECK_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CG_CHECK_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CG_CHECK_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CG_CHECK_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CG_CHECK_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CG_CHECK_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CG_CHECK_DDREN_REQ_MASK_B, val);
	/* SPM_SRC3_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DVFSRC_EVENT_TRIGGER_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DVFSRC_EVENT_TRIGGER_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SW2SPM_WAKEUP_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SW2SPM_WAKEUP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_ADSP2SPM_WAKEUP_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_ADSP2SPM_WAKEUP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SSPM2SPM_WAKEUP_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SSPM2SPM_WAKEUP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SCP2SPM_WAKEUP_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SCP2SPM_WAKEUP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CSYSPWRUP_ACK_MASK])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CSYSPWRUP_ACK_MASK, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_RESERVED_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_RESERVED_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_RESERVED_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_RESERVED_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_RESERVED_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_RESERVED_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_RESERVED_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_RESERVED_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_RESERVED_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_RESERVED_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUPM_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUPM_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUPM_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUPM_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUPM_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUPM_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUPM_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUPM_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUPM_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUPM_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC0_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC0_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC0_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC0_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC0_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC0_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC0_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC0_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC0_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC0_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC1_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC1_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC1_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC1_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC1_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC1_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC1_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC1_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC1_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC1_DDREN_REQ_MASK_B, val);
	/* SPM_SRC4_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CCIF_EVENT_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CCIF_EVENT_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_BAK_PSRI_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_BAK_PSRI_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_BAK_PSRI_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_BAK_PSRI_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_BAK_PSRI_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_BAK_PSRI_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_BAK_PSRI_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_BAK_PSRI_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_BAK_PSRI_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_BAK_PSRI_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC_MD32_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DRAMC_MD32_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC_MD32_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DRAMC_MD32_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CONN_SRCCLKENB2PWRAP_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CONN_SRCCLKENB2PWRAP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC_MD32_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DRAMC_MD32_APSRC_REQ_MASK_B, val);
	/* SPM_SRC5_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUSYS_MERGE_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUSYS_MERGE_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MCUSYS_MERGE_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MCUSYS_MERGE_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AFE_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AFE_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AFE_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AFE_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AFE_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AFE_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AFE_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AFE_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_AFE_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_AFE_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC2_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC2_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC2_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC2_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC2_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC2_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC2_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC2_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MSDC2_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC2_DDREN_REQ_MASK_B, val);
	/* SPM_SRC7_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_PCIE_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_PCIE_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_PCIE_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_PCIE_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_PCIE_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_PCIE_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_PCIE_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_PCIE_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_PCIE_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_PCIE_DDREN_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DPMAIF_SRCCLKENA_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DPMAIF_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DPMAIF_INFRA_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DPMAIF_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DPMAIF_APSRC_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DPMAIF_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DPMAIF_VRF18_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DPMAIF_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DPMAIF_DDREN_REQ_MASK_B])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DPMAIF_DDREN_REQ_MASK_B, val);

	/* SPM_WAKEUP_EVENT_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_WAKEUP_EVENT_MASK])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_WAKEUP_EVENT_MASK, val);
	/* SPM_WAKEUP_EVENT_EXT_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_EXT_WAKEUP_EVENT_MASK])) {
		mtk_lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
...
{
	return mt6853_show_pwr_ctrl(MT_SPM_DBG_SMC_UID_SUSPEND_PWR_CTRL,
			     buf, get_mtk_lp_kernfs_bufsz_max());
}
static ssize_t idle_ctrl_show(struct kobject *kobj,
	struct kobj_attribute *attr, char *buf)
{
	return mt6853_show_pwr_ctrl(MT_SPM_DBG_SMC_UID_IDLE_PWR_CTRL,
			     buf, get_mtk_lp_kernfs_bufsz_max());
}
...
{
	return mt6853_store_pwr_ctrl(MT_SPM_DBG_SMC_UID_SUSPEND_PWR_CTRL,
				     buf, count);
}
static ssize_t idle_ctrl_store(struct kobject *kobj,
	struct kobj_attribute *attr,
				const char *buf, size_t count)
{
	return mt6853_store_pwr_ctrl(MT_SPM_DBG_SMC_UID_IDLE_PWR_CTRL,
				     buf, count);
}
...
static char *mt6853_spm_resource_str[MT_SPM_RES_MAX] = {
...
static ssize_t mt6853_spm_res_rq_read(char *ToUserBuf, size_t sz, void *priv)
{
	char *p = ToUserBuf;
	int i, s, u;
...
static ssize_t mt6853_spm_res_rq_write(char *FromUserBuf, size_t sz, void *priv)
{
	char cmd[128];
	int parm;
...
static const struct mtk_lp_sysfs_op mt6853_spm_res_rq_fops = {
	.fs_read = mt6853_spm_res_rq_read,
	.fs_write = mt6853_spm_res_rq_write,
};
