...
static ssize_t mt6853_store_pwr_ctrl(int id,	const char *buf, size_t count)
{
	...
	/* SPM_SRC_REQ */
		...
		mt6853_pwr_ctrl_str[PW_REG_SPM_DDR_EN_REQ])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
	...
	/* SPM_SRC_MASK */
		...
		mt6853_pwr_ctrl_str[PW_REG_MD_SRCCLKENA_0_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_SRCCLKENA_0_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_SRCCLKENA2INFRA_REQ_0_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_SRCCLKENA2INFRA_REQ_0_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_APSRC2INFRA_REQ_0_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_APSRC2INFRA_REQ_0_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_APSRC_REQ_0_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_APSRC_REQ_0_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_VRF18_REQ_0_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_VRF18_REQ_0_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_DDR_EN_0_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_DDR_EN_0_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_SRCCLKENA_1_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_SRCCLKENA_1_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_SRCCLKENA2INFRA_REQ_1_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_SRCCLKENA2INFRA_REQ_1_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_APSRC2INFRA_REQ_1_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_APSRC2INFRA_REQ_1_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_APSRC_REQ_1_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_APSRC_REQ_1_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_VRF18_REQ_1_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD_VRF18_REQ_1_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD_DDR_EN_1_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_CONN_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI0_SRCCLKENA_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKENI0_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI0_INFRA_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKENI0_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI1_SRCCLKENA_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKENI1_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI1_INFRA_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKENI1_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI2_SRCCLKENA_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SRCCLKENI2_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SRCCLKENI2_INFRA_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_INFRASYS_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_INFRASYS_DDR_EN_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD32_SRCCLKENA_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD32_SRCCLKENA_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD32_INFRA_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD32_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD32_APSRC_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD32_APSRC_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD32_VRF18_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MD32_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_MD32_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
	...
	/* SPM_SRC2_MASK */
		...
		mt6853_pwr_ctrl_str[PW_REG_SCP_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_AUDIO_DSP_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_UFS_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_DISP0_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_DISP1_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_GCE_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_APU_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_CG_CHECK_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
	...
	/* SPM_SRC3_MASK */
		...
		mt6853_pwr_ctrl_str[PW_REG_SW2SPM_INT0_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SW2SPM_INT0_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SW2SPM_INT1_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SW2SPM_INT1_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SW2SPM_INT2_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SW2SPM_INT2_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SW2SPM_INT3_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SW2SPM_INT3_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SC_ADSP2SPM_WAKEUP_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SC_ADSP2SPM_WAKEUP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SC_SSPM2SPM_WAKEUP_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SC_SSPM2SPM_WAKEUP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SC_SCP2SPM_WAKEUP_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SC_SCP2SPM_WAKEUP_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_CSYSPWRREQ_MASK])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_CSYSPWRREQ_MASK, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_SRCCLKENA_RESERVED_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_SRCCLKENA_RESERVED_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_INFRA_REQ_RESERVED_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_INFRA_REQ_RESERVED_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_APSRC_REQ_RESERVED_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_APSRC_REQ_RESERVED_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_VRF18_REQ_RESERVED_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_SPM_VRF18_REQ_RESERVED_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_SPM_DDR_EN_RESERVED_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_MCUPM_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_MSDC0_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_MSDC1_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_MSDC1_DDR_EN_MASK_B, val);
	/* SPM_SRC4_MASK */
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_CCIF_EVENT_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_BAK_PSRI_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_BAK_PSRI_DDR_EN_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC0_MD32_INFRA_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DRAMC0_MD32_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC0_MD32_VRF18_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DRAMC0_MD32_VRF18_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC1_MD32_INFRA_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DRAMC1_MD32_INFRA_REQ_MASK_B, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC1_MD32_VRF18_REQ_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_DRAMC0_MD32_WAKEUP_MASK])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
				PW_REG_DRAMC0_MD32_WAKEUP_MASK, val);
	} else if (!strcmp(cmd,
		mt6853_pwr_ctrl_str[PW_REG_DRAMC1_MD32_WAKEUP_MASK])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
	...
	/* SPM_SRC5_MASK */
		...
		mt6853_pwr_ctrl_str[PW_REG_MCUSYS_MERGE_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_MSDC2_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
		...
		mt6853_pwr_ctrl_str[PW_REG_PCIE_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
	...
	/* SPM_SRC6_MASK */
		...
		mt6853_pwr_ctrl_str[PW_REG_DPMAIF_DDR_EN_MASK_B])) {
		lpm_smc_spm_dbg(id, MT_LPM_SMC_ACT_SET,
...
static ssize_t
mt6853_generic_spm_read(char *ToUserBuf, size_t sz, void *priv);

static ssize_t
mt6853_generic_spm_write(char *FromUserBuf, size_t sz, void *priv);

struct mt6853_SPM_ENTERY {
	const char *name;
	int mode;
	struct mtk_lp_sysfs_handle handle;
};

struct mt6853_SPM_NODE {
	const char *name;
	int mode;
	struct mtk_lp_sysfs_handle handle;
...
struct mt6853_SPM_ENTERY mt6853_spm_root = {
	.name = "power",
	.mode = 0644,
};

struct mt6853_SPM_NODE mt6853_spm_idle = {
	.name = "idle_ctrl",
	.mode = 0644,
	.op = {
		.fs_read = mt6853_generic_spm_read,
		.fs_write = mt6853_generic_spm_write,
		.priv = (void *)&mt6853_spm_idle,
	},
};

struct mt6853_SPM_NODE mt6853_spm_suspend = {
	.name = "suspend_ctrl",
	.mode = 0644,
	.op = {
		.fs_read = mt6853_generic_spm_read,
		.fs_write = mt6853_generic_spm_write,
		.priv = (void *)&mt6853_spm_suspend,
	},
};
...
mt6853_generic_spm_read(char *ToUserBuf, size_t sz, void *priv)
{
	...
	if (priv == &mt6853_spm_idle)
		id = MT_SPM_DBG_SMC_UID_IDLE_PWR_CTRL;
	return mt6853_show_pwr_ctrl(id, ToUserBuf, sz);
}
...
mt6853_generic_spm_write(char *FromUserBuf, size_t sz, void *priv)
{
	...
	return mt6853_store_pwr_ctrl(id, FromUserBuf, sz);
}
...
int lpm_spm_fs_init(void)
{
	...
	r = mtk_lp_sysfs_entry_func_create(mt6853_spm_root.name,
					   mt6853_spm_root.mode, NULL,
					   &mt6853_spm_root.handle);
	if (!r) {
		mtk_lp_sysfs_entry_func_node_add(mt6853_spm_suspend.name,
						mt6853_spm_suspend.mode,
						&mt6853_spm_suspend.op,
						&mt6853_spm_root.handle,
						&mt6853_spm_suspend.handle);

		mtk_lp_sysfs_entry_func_node_add(mt6853_spm_idle.name,
						 mt6853_spm_idle.mode,
						 &mt6853_spm_idle.op,
						 &mt6853_spm_root.handle,
						 &mt6853_spm_idle.handle);
	}
