...
static struct lpm_spm_wake_status mt6853_wakesrc;

static struct lpm_log_helper mt6853_log_help = {
	.wakesrc = &mt6853_wakesrc,
	.cur = 0,
	.prev = 0,
};
...
{
	struct lpm_log_helper *help = &mt6853_log_help;
...
{
	struct lpm_spm_wake_status *wakesrc = mt6853_log_help.wakesrc ;
...
static struct lpm_dbg_plat_ops mt6853_dbg_ops = {
...
int mt6853_dbg_ops_register(void)
{
	int ret;

	ret = lpm_dbg_plat_ops_register(&mt6853_dbg_ops);
