...
/* PMIC */
struct lpm_gs_pmic pmic6377 = {
	.type = GS_PMIC,
	.regulator = "mediatek,mt6377-regulator",
	.pwr_domain = "6377",
};
struct lpm_gs_pmic pmic6319 = {
	.type = GS_PMIC,
	.regulator = "mediatek,mt6319-regulator",
	.pwr_domain = "6319",
};
...
int power_gs_pmic_user_attach(struct lpm_gs_pmic *p)
{
	...
	/*FIXME mediatek,mt6319-regulator*/
	if (!strcmp(p->regulator, "mediatek,mt6377-regulator")) {
		p->user[LPM_PWR_GS_TYPE_SUSPEND].name = "suspend";
		p->user[LPM_PWR_GS_TYPE_SUSPEND].array =
			AP_PMIC_REG_6377_gs_suspend_32kless;
		p->user[LPM_PWR_GS_TYPE_SUSPEND].array_sz =
			AP_PMIC_REG_6377_gs_suspend_32kless_len;
		p->user[LPM_PWR_GS_TYPE_VCORELP_26M].name = "sodi3";
		p->user[LPM_PWR_GS_TYPE_VCORELP_26M].array =
			AP_PMIC_REG_6377_gs_sodi3p0_32kless;
		p->user[LPM_PWR_GS_TYPE_VCORELP_26M].array_sz =
			AP_PMIC_REG_6377_gs_sodi3p0_32kless_len;
		p->user[LPM_PWR_GS_TYPE_VCORELP].name = "dpidle";
		p->user[LPM_PWR_GS_TYPE_VCORELP].array =
			AP_PMIC_REG_6377_gs_deepidle___lp_mp3_32kless;
		p->user[LPM_PWR_GS_TYPE_VCORELP].array_sz =
			AP_PMIC_REG_6377_gs_deepidle___lp_mp3_32kless_len;
	} else if (!strcmp(p->regulator, "mediatek,mt6319-regulator")) {
		p->user[LPM_PWR_GS_TYPE_SUSPEND].name = "suspend";
		p->user[LPM_PWR_GS_TYPE_SUSPEND].array =
			AP_PMIC_REG_6319_gs_suspend_32kless;
		p->user[LPM_PWR_GS_TYPE_SUSPEND].array_sz =
			AP_PMIC_REG_6319_gs_suspend_32kless_len;
		p->user[LPM_PWR_GS_TYPE_VCORELP_26M].name = "sodi3";
		p->user[LPM_PWR_GS_TYPE_VCORELP_26M].array =
			AP_PMIC_REG_6319_gs_sodi3p0_32kless;
		p->user[LPM_PWR_GS_TYPE_VCORELP_26M].array_sz =
			AP_PMIC_REG_6319_gs_sodi3p0_32kless_len;
		p->user[LPM_PWR_GS_TYPE_VCORELP].name = "dpidle";
		p->user[LPM_PWR_GS_TYPE_VCORELP].array =
			AP_PMIC_REG_6319_gs_deepidle___lp_mp3_32kless;
		p->user[LPM_PWR_GS_TYPE_VCORELP].array_sz =
			AP_PMIC_REG_6319_gs_deepidle___lp_mp3_32kless_len;
	} else
		return -EINVAL;
	return 0;
}
