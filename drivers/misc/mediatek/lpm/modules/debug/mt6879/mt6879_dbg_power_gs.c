...
int mt6879_pwr_gs_set(unsigned int type, const struct lpm_data *val)
{
	int ret = 0;
...
struct lpm_callee mt6879_pwr_gs_callee = {
	.uid = LPM_CALLEE_PWR_GS,
	.i.simple = {
		.set = mt6879_pwr_gs_set,
	},
};

struct lpm_gs_clk mt6879_clk_cg = {
	.type = GS_CG,
	.name = "CG",
};
struct lpm_gs_clk mt6879_clk_dcm = {
	.type = GS_DCM,
	.name = "DCM",
};
struct lpm_gs_clk *mt6879_clks[] = {
	&mt6879_clk_dcm,
	&mt6879_clk_cg,
	NULL,
};
int mt6879_power_gs_clk_user_attach(struct lpm_gs_clk *p)
{
...
struct lpm_gs_clk_info mt6879_clk_infos = {
	.attach = mt6879_power_gs_clk_user_attach,
	.dcm = mt6879_clks,
};

/* PMIC */
struct lpm_gs_pmic mt6879_pmic6363 = {
	.type = GS_PMIC,
	.regulator = "mediatek,mt6363-regulator",
	.pwr_domain = "6363",
};
struct lpm_gs_pmic mt6879_pmic6368 = {
	.type = GS_PMIC,
...
struct lpm_gs_pmic *mt6879_pmic[] = {
	&mt6879_pmic6363,
	&mt6879_pmic6368,
	NULL,
};
int mt6879_power_gs_pmic_user_attach(struct lpm_gs_pmic *p)
{
	if (!p || !p->regulator)
		return -EINVAL;
	/* Set compare golden setting for scenario */
...
struct lpm_gs_pmic_info mt6879_pmic_infos = {
	.pmic = mt6879_pmic,
	.attach = mt6879_power_gs_pmic_user_attach,
};

int mt6879_power_gs_init(void)
{
	lpm_callee_registry(&mt6879_pwr_gs_callee);
	/* initial gs compare method */
	lpm_pwr_gs_common_init();
	/* initial gs pmic information */
	lpm_pwr_gs_compare_init(LPM_GS_CMP_PMIC, &mt6879_pmic_infos);
#ifdef MTK_LPM_GS_PLAT_CLK_DUMP_SUPPORT
	/* initial gs dcm information */
	lpm_pwr_gs_compare_init(LPM_GS_CMP_CLK, &mt6879_clk_infos);
#endif
	return 0;
}

void mt6879_power_gs_deinit(void)
{
