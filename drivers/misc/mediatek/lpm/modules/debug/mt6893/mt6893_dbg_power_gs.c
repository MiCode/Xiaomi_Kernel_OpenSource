...
int mt6893_pwr_gs_set(unsigned int type, const struct lpm_data *val)
{
	int ret = 0;
...
struct lpm_callee mt6893_pwr_gs_callee = {
	.uid = LPM_CALLEE_PWR_GS,
	.i.simple = {
		.set = mt6893_pwr_gs_set,
	},
};
#ifdef MTK_LPM_GS_PLAT_CLK_DUMP_SUPPORT
struct lpm_gs_clk mt6893_clk_cg = {
	.type = GS_CG,
	.name = "CG",
};
struct lpm_gs_clk mt6893_clk_dcm = {
	.type = GS_DCM,
	.name = "DCM",
};
struct lpm_gs_clk *mt6893_clks[] = {
	&mt6893_clk_dcm,
	&mt6893_clk_cg,
	NULL,
};
int mt6893_power_gs_clk_user_attach(struct lpm_gs_clk *p)
{
...
struct lpm_gs_clk_info mt6893_clk_infos = {
	.attach = mt6893_power_gs_clk_user_attach,
	.dcm = mt6893_clks,
};
#endif
/* PMIC */
/* FIXME */
struct lpm_gs_pmic mt6893_pmic6359p = {
	.type = GS_PMIC,
	.regulator = "mediatek,mt6359p-regulator",
	.pwr_domain = "6359P",
};
struct lpm_gs_pmic mt6893_pmic6315_1 = {
	.type = GS_PMIC,
	.regulator = "mediatek,mt6315_6-regulator",
	.pwr_domain = "6315-1",
};
struct lpm_gs_pmic mt6893_pmic6315_2 = {
	.type = GS_PMIC,
	.regulator = "mediatek,mt6315_7-regulator",
	.pwr_domain = "6315-2",
};
struct lpm_gs_pmic mt6893_pmic6315_3 = {
	.type = GS_PMIC,
	.regulator = "mediatek,mt6315_3-regulator",
	.pwr_domain = "6315-3",
};
struct lpm_gs_pmic *mt6893_pmic[] = {
	&mt6893_pmic6359p,
	&mt6893_pmic6315_1,
	&mt6893_pmic6315_2,
	&mt6893_pmic6315_3,
...
int mt6893_power_gs_pmic_user_attach(struct lpm_gs_pmic *p)
{
	if (!p || !p->regulator)
		return -EINVAL;
	/* Set compare golden setting for scenario */
...
struct lpm_gs_pmic_info mt6893_pmic_infos = {
	.pmic = mt6893_pmic,
	.attach = mt6893_power_gs_pmic_user_attach,
};

int mt6893_power_gs_init(void)
{
	lpm_callee_registry(&mt6893_pwr_gs_callee);
	/* initial gs compare method */
	lpm_pwr_gs_common_init();
	/* initial gs pmic information */
	lpm_pwr_gs_compare_init(LPM_GS_CMP_PMIC, &mt6893_pmic_infos);
#ifdef MTK_LPM_GS_PLAT_CLK_DUMP_SUPPORT
	/* initial gs dcm information */
	lpm_pwr_gs_compare_init(LPM_GS_CMP_CLK, &mt6893_clk_infos);
#endif
	return 0;
}
