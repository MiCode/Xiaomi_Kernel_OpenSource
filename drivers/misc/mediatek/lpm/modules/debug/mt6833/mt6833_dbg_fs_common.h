...
#ifndef __MT6833_DBG_FS_COMMON_H__
#define __MT6833_DBG_FS_COMMON_H__
...
int mt6833_dbg_lpm_init(void);

int mt6833_dbg_lpm_deinit(void);

int mt6833_dbg_lpm_fs_init(void);

int mt6833_dbg_lpm_fs_deinit(void);
