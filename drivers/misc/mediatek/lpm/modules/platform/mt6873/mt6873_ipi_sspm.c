...
static int _mt6873_ipi_sspm_send(int flags, unsigned int cmd)
{
...
static int _mt6873_ipi_sspm_response(int flags, unsigned int cmd)
{
...
{
	return _mt6873_ipi_sspm_send(SSPM_NOTIFY_ENTER, cmd);
}

int mt6873_sspm_notify_leave(unsigned int cmd)
{
	return _mt6873_ipi_sspm_send(SSPM_NOTIFY_LEAVE, cmd);
}

int mt6873_sspm_notify_ansyc_enter(unsigned int cmd)
{
	return _mt6873_ipi_sspm_send(SSPM_NOTIFY_ENTER_ASYNC, cmd);
}

int mt6873_sspm_notify_ansyc_enter_respone(void)
{
	return _mt6873_ipi_sspm_response(SSPM_NOTIFY_ENTER_ASYNC, 0);
}

int mt6873_sspm_notify_ansyc_leave(unsigned int cmd)
{
	return _mt6873_ipi_sspm_send(SSPM_NOTIFY_LEAVE_ASYNC, cmd);
}

int mt6873_sspm_notify_ansyc_leave_respone(void)
{
	return _mt6873_ipi_sspm_response(SSPM_NOTIFY_LEAVE_ASYNC, 0);
}
