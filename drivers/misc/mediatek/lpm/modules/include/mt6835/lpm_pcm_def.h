...
#define CTRL0_SC_VLP_BUS_CK_OFF            (0x1U << 1)
...
#define CTRL1_TIMER_SET                    (0x1U << 8)
#define CTRL1_TIMER_CLR                    (0x1U << 9)
#define CTRL1_SPM_LEAVE_DEEPIDLE_REQ       (0x1U << 10)
#define CTRL1_SPM_LEAVE_SUSPEND_REQ        (0x1U << 11)
#define CTRL1_CSYSPWRUPACK                 (0x1U << 12)
#define CTRL1_SRCCLKENO0                   (0x1U << 13)
#define CTRL1_SRCCLKENO1                   (0x1U << 14)
#define CTRL1_SRCCLKENO2                   (0x1U << 15)
#define CTRL1_SPM_APSRC_INTERNAL_ACK       (0x1U << 16)
#define CTRL1_SPM_DDREN_INTERNAL_ACK       (0x1U << 17)
#define CTRL1_SPM_INFRA_INTERNAL_ACK       (0x1U << 18)
#define CTRL1_SPM_VRF18_INTERNAL_ACK       (0x1U << 19)
#define CTRL1_SPM_VCORE_INTERNAL_ACK       (0x1U << 20)
#define CTRL1_SPM_VCORE_RESTORE_ACK        (0x1U << 21)
#define CTRL1_PMIC_IRQ_REQ_EN              (0x1U << 22)
#define CTRL1_WDT_KICK_P                   (0x1U << 23)
#define CTRL1_SPM_PMIF_VLD                 (0x1U << 24)
#define CTRL1_FORCE_DDREN_WAKE             (0x1U << 26)
#define CTRL1_FORCE_F26M_WAKE              (0x1U << 27)
#define CTRL1_FORCE_APSRC_WAKE             (0x1U << 28)
#define CTRL1_FORCE_INFRA_WAKE             (0x1U << 29)
#define CTRL1_FORCE_VRF18_WAKE             (0x1U << 30)
#define CTRL1_FORCE_VCORE_WAKE             (0x1U << 31)
/* --- R12 Define --- */
...
#define R12EXT_VCORE_WAKE                     (1U << 11)
#define R12EXT_VCORE_SLEEP                    (1U << 12)
#define R12EXT_MCU_PM_WFI                     (1U << 13)
#define R12EXT_SSPM_STATE                     (1U << 14)
#define R12EXT_DPM_STATE                      (1U << 15)
#define R12EXT_CONN_SRCCLKENB                 (1U << 16)
#define R12EXT_SW_MAILBOX_WAKE                (1U << 17)
#define R12EXT_SSPM_MAILBOX_WAKE              (1U << 18)
#define R12EXT_ADSP_MAILBOX_WAKE              (1U << 19)
#define R12EXT_SCP_MAILBOX_WAKE               (1U << 20)
#define R12EXT_SPM_LEAVE_SUSPEND_ACK          (1U << 21)
#define R12EXT_SPM_LEAVE_DEEPIDLE_ACK         (1U << 22)
#define R12EXT_CROSS_REQ_APU                  (1U << 23)
#define R12EXT_CROSS_REQ_L3                   (1U << 24)
#define R12EXT_DFD_SOC_MTCMOS_REQ             (1U << 25)
#define R12EXT_IPIC_IRQ_SPM                   (1U << 26)
...
#define R13_CONN_SRCCLKENA                    (1U << 15)
#define R13_CONN_SRCCLKENB                    (1U << 16)
