...
#define WAKE_MISC_PMSR_IRQ_B_SET0		 (1U << 22) //This bit is not exist in 6835
#define WAKE_MISC_PMSR_IRQ_B_SET1		 (1U << 23) //This bit is not exist in 6835
#define WAKE_MISC_PMSR_IRQ_B_SET2		 (1U << 24) //This bit is not exist in 6835
...
enum pwr_ctrl_enum {
	...
	PW_REG_CXO32K_REMOVE_EN_LSB,
	PW_REG_SPM_LEAVE_SUSPEND_MERGE_MASK_LSB,
	PW_REG_SRCLKENO0_SRC_MASK_LSB,
	PW_REG_SRCLKENO1_SRC_MASK_LSB,
	PW_REG_SRCLKENO2_SRC_MASK_LSB,
