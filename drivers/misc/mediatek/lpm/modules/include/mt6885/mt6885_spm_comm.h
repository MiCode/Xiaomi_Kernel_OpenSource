...
#ifndef __MT6885_SPM_COMM_H__
#define __MT6885_SPM_COMM_H__

struct mt6885_spm_wake_status {
...
#define SPM_FLAG_RESERVED_BIT9                (1U << 9)
...
#define SPM_FLAG_RESERVED_BIT15               (1U << 15)
...
#define SPM_FLAG_RESERVED_BIT23               (1U << 23)
...
#define SPM_DBG_DEBUG_IDX_DRAM_SREF_ABORT_IN_APSRC    (1U << 13)
#define SPM_DBG_DEBUG_IDX_DRAMC_MCU_SRAM_STATE   (1U << 14)
#define SPM_DBG_DEBUG_IDX_DRAM_SREF_ABORT_IN_DDREN    (1U << 15)
#define SPM_DBG_DEBUG_IDX_SYSRAM_SLP          (1U << 16)
#define SPM_DBG_DEBUG_IDX_SYSRAM_ON           (1U << 17)
#define SPM_DBG_DEBUG_IDX_MCUPM_SRAM_SLP      (1U << 18)
#define SPM_DBG_DEBUG_IDX_MCUPM_SRAM_ON       (1U << 19)
#define SPM_DBG_DEBUG_IDX_SSPM_SRAM_SLP       (1U << 20)
#define SPM_DBG_DEBUG_IDX_SSPM_SRAM_ON        (1U << 21)
#define SPM_DBG_DEBUG_IDX_DRAMC_MCU_SRAM_SLP    (1U << 22)
#define SPM_DBG_DEBUG_IDX_DRAMC_MCU_SRAM_ON    (1U << 23)
#define SPM_DBG_DEBUG_IDX_SCP_VCORE_0P575V    (1U << 24)
#define SPM_DBG_DEBUG_IDX_SCP_VCORE_0P600V    (1U << 25)
#define SPM_DBG_DEBUG_IDX_SCP_VCORE_0P650V    (1U << 26)
#define SPM_DBG_DEBUG_IDX_SCP_VCORE_0P725V    (1U << 27)
#define SPM_DBG_DEBUG_IDX_SPM_GO_WAKEUP_NOW   (1U << 28)
