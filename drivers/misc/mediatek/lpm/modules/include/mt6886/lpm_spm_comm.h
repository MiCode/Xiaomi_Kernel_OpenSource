...
#define SPM_FLAG_DISABLE_EMI_DFS                 (0x1U << 2)
#define SPM_FLAG_DISABLE_BUS_DFS                 (0x1U << 3)
#define SPM_FLAG_DISABLE_SSPM_SRAM_SLEEP         (0x1U << 4)
...
#define SPM_FLAG_DISABLE_DPM_PDN                 (0x1U << 11)
#define SPM_FLAG_ENABLE_SPM_DBG_WDT_DUMP         (0x1U << 12)
#define SPM_FLAG_ENABLE_LVTS_WORKAROUND          (0x1U << 13)
#define SPM_FLAG_ENABLE_POLL_BUS_PROTECT         (0x1U << 14)
#define SPM_FLAG_DISABLE_AVS_VCORE_RETRY         (0x1U << 15)
#define SPM_FLAG_DISABLE_MCUPM_PDN               (0x1U << 16)
#define SPM_FLAG_ENABLE_MD_MUMTAS                (0x1U << 17)
//Deepidle/SODI
#define SPM_FLAG_USE_SRCLKENO2                   (0x1U << 18)
#define SPM_FLAG_DIS_O2_LOW_AT_IFR               (0x1U << 19)
//DVFS use
#define SPM_FLAG_DISABLE_VCORE_DVS               (0x1U << 20)
#define SPM_FLAG_DISABLE_DDR_DFS                 (0x1U << 21)
#define SPM_FLAG_DISABLE_VDDQ_DVS                (0x1U << 22)
#define SPM_FLAG_DISABLE_VMDDR_DVS               (0x1U << 23)
#define SPM_FLAG_DISABLE_DVFS_SHU_BOUND          (0x1U << 24)
#define SPM_FLAG_DVFS_V_SYNC_IN_SEQ              (0x1U << 25)
...
#define SPM_FLAG1_DISABLE_PERI_PDN               (0x1U << 5)
...
#define SPM_FLAG1_DISABLE_DPM_CMD                (0x1U << 12)
...
#define	SPM_DBG_DEBUG_IDX_VCORE_WAKE               (0x1U << 8)
#define	SPM_DBG_DEBUG_IDX_VCORE_SLEEP              (0x1U << 9)
#define	SPM_DBG_DEBUG_IDX_DDREN_WAKE               (0x1U << 10)
#define	SPM_DBG_DEBUG_IDX_DDREN_SLEEP              (0x1U << 11)
#define SPM_DBG_DEBUG_IDX_26M_STATE                (0x1U << 12)
#define SPM_DBG_DEBUG_IDX_INFRA_STATE              (0x1U << 13)
#define SPM_DBG_DEBUG_IDX_APSRC_STATE              (0x1U << 14)
#define SPM_DBG_DEBUG_IDX_VRF18_STATE              (0x1U << 15)
#define SPM_DBG_DEBUG_IDX_VCORE_STATE              (0x1U << 16)
#define SPM_DBG_DEBUG_IDX_SSPM_SRAM_SLP            (0x1U << 18)
#define SPM_DBG_DEBUG_IDX_SSPM_SRAM_WAKE           (0x1U << 19)
#define SPM_DBG_DEBUG_IDX_PST_REQUEST_ING          (0x1U << 20)
#define SPM_DBG_DEBUG_IDX_SSPM_REQUEST_ING         (0x1U << 21)
#define SPM_DBG_DEBUG_IDX_PMIF_REQUEST_ING         (0x1U << 22)
#define SPM_DBG_DEBUG_IDX_APU_REQUEST_ING          (0x1U << 23)
...
#define SPM_DBG_DEBUG_IDX_DVFS_REQ_WHEN_S0         (0x1U << 25)
#define SPM_DBG_DEBUG_IDX_PST_REQUEST_TWICE        (0x1U << 26)
#define SPM_DBG_DEBUG_IDX_SPM_DVFS_NO_REQ          (0x1U << 27)
#define SPM_DBG_DEBUG_IDX_SPM_GO_WAKEUP_NOW        (0x1U << 28)
#define SPM_DBG_DEBUG_IDX_SPM_NORMAL_WAKEUP        (0x1U << 29)
#define SPM_DBG_DEBUG_IDX_SPM_WAKEUP_BY_NONE       (0x1U << 30)
//#define SPM_DBG_DEBUG_IDX_APSRC_SLEEP_ABORT        (0x1U << 29)
//#define SPM_DBG_DEBUG_IDX_AXI_MEM_CLK_OFF          (0x1U << 30)
//#define SPM_DBG_DEBUG_IDX_AXI_MEM_CLK_ON           (0x1U << 31)
...
#define SPM_DBG1_DEBUG_IDX_VCORE_SLEEP_ABORT            (0x1U << 9)

//#define SPM_DBG1_DEBUG_IDX_INFRA_SUB_MTCMOS_ON          (0x1U << 10)
...
//#define SPM_DBG1_DEBUG_IDX_DORMANT_WAKEUP               (0x1U << 19)
...
#define SPM_DBG1_DEBUG_IDX_SPM_PMIF_CMD_RDY_ABORT       (0x1U << 28)
//#define SPM_DBG1_DEBUG_IDX_MCUSYS_PWR_ACK_LOW_ABORT     (0x1U << 29)
//#define SPM_DBG1_DEBUG_IDX_CORE_PWR_ACK_HIGH_ABORT      (0x1U << 30)
#define SPM_DBG1_DEBUG_IDX_MCUPM_OFF                    (0x1U << 29)
#define SPM_DBG1_DEBUG_IDX_MCUPM_ON                     (0x1U << 30)
