...
#define SYS_TIMER_LATCH_CLEAN          (SPM_BASE + 0x5B0)
#define SYS_TIMER_ID_FILTER            (SPM_BASE + 0x5B4)
...
#define SPM_EVENT_COUNTER_CLEAR        (SPM_BASE + 0x89C)
#define SPM_SRCCLKENA_EVENT_COUNT_STA  (SPM_BASE + 0x8A0)
#define SPM_PMIC_EVENT_COUNT_STA       (SPM_BASE + 0x8A4)
#define SPM_INFRA_EVENT_COUNT_STA      (SPM_BASE + 0x8A8)
#define SPM_EMI_EVENT_COUNT_STA        (SPM_BASE + 0x8AC)
#define SPM_APSRC_EVENT_COUNT_STA      (SPM_BASE + 0x8B0)
#define SPM_VRF18_EVENT_COUNT_STA      (SPM_BASE + 0x8B4)
#define SPM_DDREN_EVENT_COUNT_STA      (SPM_BASE + 0x8B8)
#define SPM_VCORE_EVENT_COUNT_STA      (SPM_BASE + 0x8BC)
#define SPM_RESOURCE_ACK_MASK_4        (SPM_BASE + 0x8C0)
#define SPM_RESOURCE_ACK_MASK_5        (SPM_BASE + 0x8C4)
#define SPM_RESOURCE_ACK_MASK_6        (SPM_BASE + 0x8C8)
#define SPM_RESOURCE_ACK_MASK_7        (SPM_BASE + 0x8CC)
...
#define MCUPM_PWR_CON                  (SPM_BASE + 0xEE4)
#define MFG0_PWR_CON                   (SPM_BASE + 0xEE8)
...
#define MM_HRE_SRAM_CON                (SPM_BASE + 0xF5C)
#define SPM_SRAM_CON                   (SPM_BASE + 0xF60)
#define SSPM_SRAM_CON                  (SPM_BASE + 0xF64)
#define UFS_PDN_SRAM_CON               (SPM_BASE + 0xF68)
#define CPU_BUCK_ISO_CON               (SPM_BASE + 0xF6C)
#define MD_BUCK_ISO_CON                (SPM_BASE + 0xF70)
#define SOC_BUCK_ISO_CON               (SPM_BASE + 0xF74)
#define PWR_STATUS                     (SPM_BASE + 0xF78)
#define PWR_STATUS_2ND                 (SPM_BASE + 0xF7C)
#define PWR_STATUS_MSB                 (SPM_BASE + 0xF80)
#define PWR_STATUS_MSB_2ND             (SPM_BASE + 0xF84)
#define XPU_PWR_STATUS                 (SPM_BASE + 0xF88)
#define XPU_PWR_STATUS_2ND             (SPM_BASE + 0xF8C)
#define DFD_SOC_PWR_LATCH              (SPM_BASE + 0xF90)
#define RSV_SRAM_CON                   (SPM_BASE + 0xF94)
#define SUBSYS_PM_BYPASS               (SPM_BASE + 0xF98)
#define SPM_TWAM_CON                   (SPM_BASE + 0xFA0)
#define SPM_TWAM_WINDOW_LEN            (SPM_BASE + 0xFA4)
#define SPM_TWAM_IDLE_SEL              (SPM_BASE + 0xFA8)
#define SPM_TWAM_LAST_STA_0            (SPM_BASE + 0xFAC)
#define SPM_TWAM_LAST_STA_1            (SPM_BASE + 0xFB0)
#define SPM_TWAM_LAST_STA_2            (SPM_BASE + 0xFB4)
#define SPM_TWAM_LAST_STA_3            (SPM_BASE + 0xFB8)
#define SPM_TWAM_CURR_STA_0            (SPM_BASE + 0xFBC)
#define SPM_TWAM_CURR_STA_1            (SPM_BASE + 0xFC0)
#define SPM_TWAM_CURR_STA_2            (SPM_BASE + 0xFC4)
#define SPM_TWAM_CURR_STA_3            (SPM_BASE + 0xFC8)
#define SPM_TWAM_TIMER_OUT             (SPM_BASE + 0xFCC)
...
#define REG_HW_S1_ACK_MASK_LSB              (1U << 4)       /* 2b */
#define SC_HW_S1_ACK_LSB                    (1U << 8)       /* 2b */
...
/* SYS_TIMER_LATCH_CLEAN (0x1C001000+0x5B0) */
#define SYS_TIMER_LATCH_CLEAN_LSB           (1U << 0)       /* 1b */
/* SYS_TIMER_ID_FILTER (0x1C001000+0x5B4) */
#define SYS_TIMER_ID_FILTER_LSB             (1U << 0)       /* 8b */
...
#define REG_PERI_DDREN_REQ_MASK_B_LSB       (1U << 0)       /* 1b */
#define REG_APU_DDREN_REQ_MASK_B_LSB        (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_DDREN_REQ_MASK_B_LSB  (1U << 2)       /* 1b */
#define REG_CAM_DDREN_REQ_MASK_B_LSB        (1U << 3)       /* 1b */
#define REG_IFR_DDREN_REQ_MASK_B_LSB        (1U << 4)       /* 1b */
#define REG_CONN_DDREN_REQ_MASK_B_LSB       (1U << 5)       /* 1b */
#define REG_MCUPM_DDREN_REQ_MASK_B_LSB      (1U << 7)       /* 1b */
#define REG_DISP0_DDREN_REQ_MASK_B_LSB      (1U << 8)       /* 1b */
#define REG_GCE_DDREN_REQ_MASK_B_LSB        (1U << 13)      /* 1b */
#define REG_GPUEB_DDREN_REQ_MASK_B_LSB      (1U << 14)      /* 1b */
#define REG_IMG_DDREN_REQ_MASK_B_LSB        (1U << 15)      /* 1b */
#define REG_INFRASYS_DDREN_REQ_MASK_B_LSB   (1U << 16)      /* 1b */
#define REG_MD_DDREN_REQ_MASK_B_LSB         (1U << 17)      /* 1b */
#define REG_MDP0_DDREN_REQ_MASK_B_LSB       (1U << 19)      /* 1b */
#define REG_MM_PROC_DDREN_REQ_MASK_B_LSB    (1U << 20)      /* 1b */
#define REG_MSDC1_DDREN_REQ_MASK_B_LSB      (1U << 21)      /* 1b */
#define REG_SCP_DDREN_REQ_MASK_B_LSB        (1U << 22)      /* 1b */
#define REG_SSPM_DDREN_REQ_MASK_B_LSB       (1U << 25)      /* 1b */
#define REG_SSUSB0_DDREN_REQ_MASK_B_LSB     (1U << 26)      /* 1b */
#define REG_UFS_DDREN_REQ_MASK_B_LSB        (1U << 27)      /* 1b */
#define REG_VDEC_DDREN_REQ_MASK_B_LSB       (1U << 28)      /* 1b */
#define REG_VENC_DDREN_REQ_MASK_B_LSB       (1U << 29)      /* 1b */
#define REG_MMSYS_DDREN_REQ_MASK_B_LSB      (1U << 30)      /* 1b */
#define REG_CG_CHECK_DDREN_REQ_MASK_B_LSB   (1U << 31)      /* 1b */
/* SPM_SRC_MASK_1 (0x1C001000+0x820) */
#define REG_PERI_APSRC_REQ_MASK_B_LSB       (1U << 0)       /* 1b */
#define REG_APU_APSRC_REQ_MASK_B_LSB        (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_APSRC_REQ_MASK_B_LSB  (1U << 2)       /* 1b */
#define REG_CAM_APSRC_REQ_MASK_B_LSB        (1U << 3)       /* 1b */
#define REG_IFR_APSRC_REQ_MASK_B_LSB        (1U << 4)       /* 1b */
...
#define REG_GCE_APSRC_REQ_MASK_B_LSB        (1U << 13)      /* 1b */
#define REG_GPUEB_APSRC_REQ_MASK_B_LSB      (1U << 14)      /* 1b */
#define REG_IMG_APSRC_REQ_MASK_B_LSB        (1U << 15)      /* 1b */
#define REG_INFRASYS_APSRC_REQ_MASK_B_LSB   (1U << 16)      /* 1b */
#define REG_MD_APSRC_REQ_MASK_B_LSB         (1U << 17)      /* 1b */
#define REG_MDP0_APSRC_REQ_MASK_B_LSB       (1U << 19)      /* 1b */
#define REG_MM_PROC_APSRC_REQ_MASK_B_LSB    (1U << 20)      /* 1b */
#define REG_MSDC1_APSRC_REQ_MASK_B_LSB      (1U << 21)      /* 1b */
#define REG_SCP_APSRC_REQ_MASK_B_LSB        (1U << 22)      /* 1b */
#define REG_SSPM_APSRC_REQ_MASK_B_LSB       (1U << 25)      /* 1b */
#define REG_SSUSB0_APSRC_REQ_MASK_B_LSB     (1U << 26)      /* 1b */
#define REG_UFS_APSRC_REQ_MASK_B_LSB        (1U << 27)      /* 1b */
#define REG_VDEC_APSRC_REQ_MASK_B_LSB       (1U << 28)      /* 1b */
#define REG_VENC_APSRC_REQ_MASK_B_LSB       (1U << 29)      /* 1b */
#define REG_MMSYS_APSRC_REQ_MASK_B_LSB      (1U << 30)      /* 1b */
#define REG_CG_CHECK_APSRC_REQ_MASK_B_LSB   (1U << 31)      /* 1b */
/* SPM_SRC_MASK_2 (0x1C001000+0x824) */
#define REG_PERI_VRF18_REQ_MASK_B_LSB       (1U << 0)       /* 1b */
#define REG_APU_VRF18_REQ_MASK_B_LSB        (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_VRF18_REQ_MASK_B_LSB  (1U << 2)       /* 1b */
#define REG_IFR_VRF18_REQ_MASK_B_LSB        (1U << 4)       /* 1b */
#define REG_CONN_VRF18_REQ_MASK_B_LSB       (1U << 5)       /* 1b */
#define REG_MCUPM_VRF18_REQ_MASK_B_LSB      (1U << 7)       /* 1b */
#define REG_DPM_VRF18_REQ_MASK_B_LSB        (1U << 9)       /* 4b */
#define REG_GCE_VRF18_REQ_MASK_B_LSB        (1U << 13)      /* 1b */
#define REG_GPUEB_VRF18_REQ_MASK_B_LSB      (1U << 14)      /* 1b */
#define REG_MD_VRF18_REQ_MASK_B_LSB         (1U << 17)      /* 1b */
#define REG_MM_PROC_VRF18_REQ_MASK_B_LSB    (1U << 20)      /* 1b */
#define REG_MSDC1_VRF18_REQ_MASK_B_LSB      (1U << 21)      /* 1b */
#define REG_SCP_VRF18_REQ_MASK_B_LSB        (1U << 22)      /* 1b */
#define REG_SSPM_VRF18_REQ_MASK_B_LSB       (1U << 25)      /* 1b */
#define REG_SSUSB0_VRF18_REQ_MASK_B_LSB     (1U << 26)      /* 1b */
#define REG_UFS_VRF18_REQ_MASK_B_LSB        (1U << 27)      /* 1b */
#define REG_MMSYS_VRF18_REQ_MASK_B_LSB      (1U << 30)      /* 1b */
#define REG_CG_CHECK_VRF18_REQ_MASK_B_LSB   (1U << 31)      /* 1b */
/* SPM_SRC_MASK_3 (0x1C001000+0x828) */
#define REG_PERI_INFRA_REQ_MASK_B_LSB       (1U << 0)       /* 1b */
#define REG_APU_INFRA_REQ_MASK_B_LSB        (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_INFRA_REQ_MASK_B_LSB  (1U << 2)       /* 1b */
#define REG_CAM_INFRA_REQ_MASK_B_LSB        (1U << 3)       /* 1b */
#define REG_IFR_INFRA_REQ_MASK_B_LSB        (1U << 4)       /* 1b */
#define REG_CONN_INFRA_REQ_MASK_B_LSB       (1U << 5)       /* 1b */
#define REG_MCUPM_INFRA_REQ_MASK_B_LSB      (1U << 7)       /* 1b */
#define REG_DPM_INFRA_REQ_MASK_B_LSB        (1U << 9)       /* 4b */
#define REG_GCE_INFRA_REQ_MASK_B_LSB        (1U << 13)      /* 1b */
#define REG_GPUEB_INFRA_REQ_MASK_B_LSB      (1U << 14)      /* 1b */
#define REG_MD_INFRA_REQ_MASK_B_LSB         (1U << 17)      /* 1b */
#define REG_MM_PROC_INFRA_REQ_MASK_B_LSB    (1U << 20)      /* 1b */
#define REG_MSDC1_INFRA_REQ_MASK_B_LSB      (1U << 21)      /* 1b */
#define REG_SCP_INFRA_REQ_MASK_B_LSB        (1U << 22)      /* 1b */
#define REG_SRCCLKENI_INFRA_REQ_MASK_B_LSB  (1U << 23)      /* 2b */
#define REG_SSPM_INFRA_REQ_MASK_B_LSB       (1U << 25)      /* 1b */
#define REG_SSUSB0_INFRA_REQ_MASK_B_LSB     (1U << 26)      /* 1b */
#define REG_UFS_INFRA_REQ_MASK_B_LSB        (1U << 27)      /* 1b */
/* SPM_SRC_MASK_4 (0x1C001000+0x82C) */
#define REG_PERI_SRCCLKENA_MASK_B_LSB       (1U << 0)       /* 1b */
#define REG_APU_SRCCLKENA_MASK_B_LSB        (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_SRCCLKENA_MASK_B_LSB  (1U << 2)       /* 1b */
#define REG_IFR_SRCCLKENA_MASK_B_LSB        (1U << 4)       /* 1b */
#define REG_CONN_SRCCLKENA_MASK_B_LSB       (1U << 5)       /* 1b */
#define REG_CONN_SRCCLKENB_MASK_B_LSB       (1U << 6)       /* 1b */
#define REG_MCUPM_SRCCLKENA_MASK_B_LSB      (1U << 7)       /* 1b */
#define REG_GPUEB_SRCCLKENA_MASK_B_LSB      (1U << 14)      /* 1b */
#define REG_MD_SRCCLKENA_MASK_B_LSB         (1U << 17)      /* 1b */
#define REG_MD_SRCCLKENA1_MASK_B_LSB        (1U << 18)      /* 1b */
#define REG_MM_PROC_SRCCLKENA_MASK_B_LSB    (1U << 20)      /* 1b */
#define REG_MSDC1_SRCCLKENA_MASK_B_LSB      (1U << 21)      /* 1b */
#define REG_SCP_SRCCLKENA_MASK_B_LSB        (1U << 22)      /* 1b */
#define REG_SRCCLKENI_SRCCLKENA_MASK_B_LSB  (1U << 23)      /* 2b */
#define REG_SSPM_SRCCLKENA_MASK_B_LSB       (1U << 25)      /* 1b */
#define REG_SSUSB0_SRCCLKENA_MASK_B_LSB     (1U << 26)      /* 1b */
#define REG_UFS_SRCCLKENA_MASK_B_LSB        (1U << 27)      /* 1b */
#define REG_CG_CHECK_SRCCLKENA_MASK_B_LSB   (1U << 31)      /* 1b */
/* SPM_SRC_MASK_5 (0x1C001000+0x830) */
#define REG_IFR_VCORE_REQ_MASK_B_LSB        (1U << 4)       /* 1b */
#define REG_CONN_VCORE_REQ_MASK_B_LSB       (1U << 5)       /* 1b */
#define REG_MD_VCORE_REQ_MASK_B_LSB         (1U << 17)      /* 1b */
#define REG_CG_CHECK_VCORE_REQ_MASK_B_LSB   (1U << 31)      /* 1b */
/* SPM_SRC_MASK_6 (0x1C001000+0x834) */
#define REG_PERI_EMI_REQ_MASK_B_LSB         (1U << 0)       /* 1b */
#define REG_APU_EMI_REQ_MASK_B_LSB          (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_EMI_REQ_MASK_B_LSB    (1U << 2)       /* 1b */
#define REG_CAM_EMI_REQ_MASK_B_LSB          (1U << 3)       /* 1b */
#define REG_IFR_EMI_REQ_MASK_B_LSB          (1U << 4)       /* 1b */
#define REG_CONN_EMI_REQ_MASK_B_LSB         (1U << 5)       /* 1b */
#define REG_MCUPM_EMI_REQ_MASK_B_LSB        (1U << 7)       /* 1b */
#define REG_DISP0_EMI_REQ_MASK_B_LSB        (1U << 8)       /* 1b */
#define REG_DPM_EMI_REQ_MASK_B_LSB          (1U << 9)       /* 4b */
#define REG_GCE_EMI_REQ_MASK_B_LSB          (1U << 13)      /* 1b */
#define REG_GPUEB_EMI_REQ_MASK_B_LSB        (1U << 14)      /* 1b */
#define REG_IMG_EMI_REQ_MASK_B_LSB          (1U << 15)      /* 1b */
#define REG_INFRASYS_EMI_REQ_MASK_B_LSB     (1U << 16)      /* 1b */
#define REG_MD_EMI_REQ_MASK_B_LSB           (1U << 17)      /* 1b */
#define REG_MDP0_EMI_REQ_MASK_B_LSB         (1U << 19)      /* 1b */
#define REG_MM_PROC_EMI_REQ_MASK_B_LSB      (1U << 20)      /* 1b */
#define REG_MSDC1_EMI_REQ_MASK_B_LSB        (1U << 21)      /* 1b */
#define REG_SCP_EMI_REQ_MASK_B_LSB          (1U << 22)      /* 1b */
#define REG_SSPM_EMI_REQ_MASK_B_LSB         (1U << 25)      /* 1b */
#define REG_SSUSB0_EMI_REQ_MASK_B_LSB       (1U << 26)      /* 1b */
#define REG_UFS_EMI_REQ_MASK_B_LSB          (1U << 27)      /* 1b */
#define REG_VDEC_EMI_REQ_MASK_B_LSB         (1U << 28)      /* 1b */
#define REG_VENC_EMI_REQ_MASK_B_LSB         (1U << 29)      /* 1b */
#define REG_MMSYS_EMI_REQ_MASK_B_LSB        (1U << 30)      /* 1b */
#define REG_CG_CHECK_EMI_REQ_MASK_B_LSB     (1U << 31)      /* 1b */
/* SPM_SRC_MASK_7 (0x1C001000+0x838) */
#define REG_PERI_PMIC_REQ_MASK_B_LSB        (1U << 0)       /* 1b */
#define REG_APU_PMIC_REQ_MASK_B_LSB         (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_PMIC_REQ_MASK_B_LSB   (1U << 2)       /* 1b */
#define REG_CONN_PMIC_REQ_MASK_B_LSB        (1U << 5)       /* 1b */
#define REG_MCUPM_PMIC_REQ_MASK_B_LSB       (1U << 7)       /* 1b */
#define REG_GPUEB_PMIC_REQ_MASK_B_LSB       (1U << 14)      /* 1b */
#define REG_MD_PMIC_REQ_MASK_B_LSB          (1U << 17)      /* 1b */
#define REG_MM_PROC_PMIC_REQ_MASK_B_LSB     (1U << 20)      /* 1b */
#define REG_MSDC1_PMIC_REQ_MASK_B_LSB       (1U << 21)      /* 1b */
#define REG_SCP_PMIC_REQ_MASK_B_LSB         (1U << 22)      /* 1b */
#define REG_SRCCLKENI_PMIC_REQ_MASK_B_LSB   (1U << 23)      /* 2b */
#define REG_SSPM_PMIC_REQ_MASK_B_LSB        (1U << 25)      /* 1b */
#define REG_SSUSB0_PMIC_REQ_MASK_B_LSB      (1U << 26)      /* 1b */
#define REG_UFS_PMIC_REQ_MASK_B_LSB         (1U << 27)      /* 1b */
#define REG_CG_CHECK_PMIC_REQ_MASK_B_LSB    (1U << 31)      /* 1b */
...
#define REG_DVFSRC_LEVEL_REQ_MASK_B_LSB     (1U << 31)      /* 1b */
/* SPM_REQ_STA_0 (0x1C001000+0x848) */
#define PERI_DDREN_REQ_LSB                  (1U << 0)       /* 1b */
#define APU_DDREN_REQ_LSB                   (1U << 1)       /* 1b */
#define AUDIO_DSP_DDREN_REQ_LSB             (1U << 2)       /* 1b */
#define CAM_DDREN_REQ_LSB                   (1U << 3)       /* 1b */
#define IFR_DDREN_REQ_LSB                   (1U << 4)       /* 1b */
#define CONN_DDREN_REQ_LSB                  (1U << 5)       /* 1b */
#define MCUPM_DDREN_REQ_LSB                 (1U << 7)       /* 1b */
#define DISP0_DDREN_REQ_LSB                 (1U << 8)       /* 1b */
#define GCE_DDREN_REQ_LSB                   (1U << 13)      /* 1b */
#define GPUEB_DDREN_REQ_LSB                 (1U << 14)      /* 1b */
#define IMG_DDREN_REQ_LSB                   (1U << 15)      /* 1b */
#define INFRASYS_DDREN_REQ_LSB              (1U << 16)      /* 1b */
#define MD_DDREN_REQ_LSB                    (1U << 17)      /* 1b */
#define MDP0_DDREN_REQ_LSB                  (1U << 19)      /* 1b */
#define MM_PROC_DDREN_REQ_LSB               (1U << 20)      /* 1b */
#define MSDC1_DDREN_REQ_LSB                 (1U << 21)      /* 1b */
#define SCP_DDREN_REQ_LSB                   (1U << 22)      /* 1b */
#define SSPM_DDREN_REQ_LSB                  (1U << 25)      /* 1b */
#define SSUSB0_DDREN_REQ_LSB                (1U << 26)      /* 1b */
#define UFS_DDREN_REQ_LSB                   (1U << 27)      /* 1b */
#define VDEC_DDREN_REQ_LSB                  (1U << 28)      /* 1b */
#define VENC_DDREN_REQ_LSB                  (1U << 29)      /* 1b */
#define MMSYS_DDREN_REQ_LSB                 (1U << 30)      /* 1b */
/* SPM_REQ_STA_1 (0x1C001000+0x84C) */
#define PERI_APSRC_REQ_LSB                  (1U << 0)       /* 1b */
#define APU_APSRC_REQ_LSB                   (1U << 1)       /* 1b */
#define AUDIO_DSP_APSRC_REQ_LSB             (1U << 2)       /* 1b */
#define CAM_APSRC_REQ_LSB                   (1U << 3)       /* 1b */
#define IFR_APSRC_REQ_LSB                   (1U << 4)       /* 1b */
...
#define GCE_APSRC_REQ_LSB                   (1U << 13)      /* 1b */
#define GPUEB_APSRC_REQ_LSB                 (1U << 14)      /* 1b */
#define IMG_APSRC_REQ_LSB                   (1U << 15)      /* 1b */
#define INFRASYS_APSRC_REQ_LSB              (1U << 16)      /* 1b */
#define MD_APSRC_REQ_LSB                    (1U << 17)      /* 1b */
#define MDP0_APSRC_REQ_LSB                  (1U << 19)      /* 1b */
#define MM_PROC_APSRC_REQ_LSB               (1U << 20)      /* 1b */
#define MSDC1_APSRC_REQ_LSB                 (1U << 21)      /* 1b */
#define SCP_APSRC_REQ_LSB                   (1U << 22)      /* 1b */
#define SSPM_APSRC_REQ_LSB                  (1U << 25)      /* 1b */
#define SSUSB0_APSRC_REQ_LSB                (1U << 26)      /* 1b */
#define UFS_APSRC_REQ_LSB                   (1U << 27)      /* 1b */
#define VDEC_APSRC_REQ_LSB                  (1U << 28)      /* 1b */
#define VENC_APSRC_REQ_LSB                  (1U << 29)      /* 1b */
#define MMSYS_APSRC_REQ_LSB                 (1U << 30)      /* 1b */
/* SPM_REQ_STA_2 (0x1C001000+0x850) */
#define PERI_VRF18_REQ_LSB                  (1U << 0)       /* 1b */
#define APU_VRF18_REQ_LSB                   (1U << 1)       /* 1b */
#define AUDIO_DSP_VRF18_REQ_LSB             (1U << 2)       /* 1b */
#define IFR_VRF18_REQ_LSB                   (1U << 4)       /* 1b */
#define CONN_VRF18_REQ_LSB                  (1U << 5)       /* 1b */
#define MCUPM_VRF18_REQ_LSB                 (1U << 7)       /* 1b */
#define DPM_VRF18_REQ_LSB                   (1U << 9)       /* 4b */
#define GCE_VRF18_REQ_LSB                   (1U << 13)      /* 1b */
#define GPUEB_VRF18_REQ_LSB                 (1U << 14)      /* 1b */
#define MD_VRF18_REQ_LSB                    (1U << 17)      /* 1b */
#define MM_PROC_VRF18_REQ_LSB               (1U << 20)      /* 1b */
#define MSDC1_VRF18_REQ_LSB                 (1U << 21)      /* 1b */
#define SCP_VRF18_REQ_LSB                   (1U << 22)      /* 1b */
#define SSPM_VRF18_REQ_LSB                  (1U << 25)      /* 1b */
#define SSUSB0_VRF18_REQ_LSB                (1U << 26)      /* 1b */
#define UFS_VRF18_REQ_LSB                   (1U << 27)      /* 1b */
#define MMSYS_VRF18_REQ_LSB                 (1U << 30)      /* 1b */
/* SPM_REQ_STA_3 (0x1C001000+0x854) */
#define PERI_INFRA_REQ_LSB                  (1U << 0)       /* 1b */
#define APU_INFRA_REQ_LSB                   (1U << 1)       /* 1b */
#define AUDIO_DSP_INFRA_REQ_LSB             (1U << 2)       /* 1b */
#define CAM_INFRA_REQ_LSB                   (1U << 3)       /* 1b */
#define IFR_INFRA_REQ_LSB                   (1U << 4)       /* 1b */
#define CONN_INFRA_REQ_LSB                  (1U << 5)       /* 1b */
#define MCUPM_INFRA_REQ_LSB                 (1U << 7)       /* 1b */
#define DPM_INFRA_REQ_LSB                   (1U << 9)       /* 4b */
#define GCE_INFRA_REQ_LSB                   (1U << 13)      /* 1b */
#define GPUEB_INFRA_REQ_LSB                 (1U << 14)      /* 1b */
#define MD_INFRA_REQ_LSB                    (1U << 17)      /* 1b */
#define MM_PROC_INFRA_REQ_LSB               (1U << 20)      /* 1b */
#define MSDC1_INFRA_REQ_LSB                 (1U << 21)      /* 1b */
#define SCP_INFRA_REQ_LSB                   (1U << 22)      /* 1b */
#define SRCCLKENI_INFRA_REQ_LSB             (1U << 23)      /* 2b */
#define SSPM_INFRA_REQ_LSB                  (1U << 25)      /* 1b */
#define SSUSB0_INFRA_REQ_LSB                (1U << 26)      /* 1b */
#define UFS_INFRA_REQ_LSB                   (1U << 27)      /* 1b */
/* SPM_REQ_STA_4 (0x1C001000+0x858) */
#define PERI_SRCCLKENA_LSB                  (1U << 0)       /* 1b */
#define APU_SRCCLKENA_LSB                   (1U << 1)       /* 1b */
#define AUDIO_DSP_SRCCLKENA_LSB             (1U << 2)       /* 1b */
#define IFR_SRCCLKENA_LSB                   (1U << 4)       /* 1b */
#define CONN_SRCCLKENA_LSB                  (1U << 5)       /* 1b */
#define CONN_SRCCLKENB_LSB                  (1U << 6)       /* 1b */
#define MCUPM_SRCCLKENA_LSB                 (1U << 7)       /* 1b */
#define GPUEB_SRCCLKENA_LSB                 (1U << 14)      /* 1b */
#define MD_SRCCLKENA_LSB                    (1U << 17)      /* 1b */
#define MD_SRCCLKENA1_LSB                   (1U << 18)      /* 1b */
#define MM_PROC_SRCCLKENA_LSB               (1U << 20)      /* 1b */
#define MSDC1_SRCCLKENA_LSB                 (1U << 21)      /* 1b */
#define SCP_SRCCLKENA_LSB                   (1U << 22)      /* 1b */
#define SRCCLKENI_SRCCLKENA_LSB             (1U << 23)      /* 2b */
#define SSPM_SRCCLKENA_LSB                  (1U << 25)      /* 1b */
#define SSUSB0_SRCCLKENA_LSB                (1U << 26)      /* 1b */
#define UFS_SRCCLKENA_LSB                   (1U << 27)      /* 1b */
/* SPM_REQ_STA_5 (0x1C001000+0x85C) */
#define IFR_VCORE_REQ_LSB                   (1U << 4)       /* 1b */
#define CONN_VCORE_REQ_LSB                  (1U << 5)       /* 1b */
#define MD_VCORE_REQ_LSB                    (1U << 17)      /* 1b */
/* SPM_REQ_STA_6 (0x1C001000+0x860) */
#define PERI_EMI_REQ_LSB                    (1U << 0)       /* 1b */
#define APU_EMI_REQ_LSB                     (1U << 1)       /* 1b */
#define AUDIO_DSP_EMI_REQ_LSB               (1U << 2)       /* 1b */
#define CAM_EMI_REQ_LSB                     (1U << 3)       /* 1b */
#define IFR_EMI_REQ_LSB                     (1U << 4)       /* 1b */
#define CONN_EMI_REQ_LSB                    (1U << 5)       /* 1b */
#define MCUPM_EMI_REQ_LSB                   (1U << 7)       /* 1b */
#define DISP0_EMI_REQ_LSB                   (1U << 8)       /* 1b */
#define DPM_EMI_REQ_LSB                     (1U << 9)       /* 4b */
#define GCE_EMI_REQ_LSB                     (1U << 13)      /* 1b */
#define GPUEB_EMI_REQ_LSB                   (1U << 14)      /* 1b */
#define IMG_EMI_REQ_LSB                     (1U << 15)      /* 1b */
#define INFRASYS_EMI_REQ_LSB                (1U << 16)      /* 1b */
#define MD_EMI_REQ_LSB                      (1U << 17)      /* 1b */
#define MDP0_EMI_REQ_LSB                    (1U << 19)      /* 1b */
#define MM_PROC_EMI_REQ_LSB                 (1U << 20)      /* 1b */
#define MSDC1_EMI_REQ_LSB                   (1U << 21)      /* 1b */
#define SCP_EMI_REQ_LSB                     (1U << 22)      /* 1b */
#define SSPM_EMI_REQ_LSB                    (1U << 25)      /* 1b */
#define SSUSB0_EMI_REQ_LSB                  (1U << 26)      /* 1b */
#define UFS_EMI_REQ_LSB                     (1U << 27)      /* 1b */
#define VDEC_EMI_REQ_LSB                    (1U << 28)      /* 1b */
#define VENC_EMI_REQ_LSB                    (1U << 29)      /* 1b */
#define MMSYS_EMI_REQ_LSB                   (1U << 30)      /* 1b */
/* SPM_REQ_STA_7 (0x1C001000+0x864) */
#define PERI_PMIC_REQ_LSB                   (1U << 0)       /* 1b */
#define APU_PMIC_REQ_LSB                    (1U << 1)       /* 1b */
#define AUDIO_DSP_PMIC_REQ_LSB              (1U << 2)       /* 1b */
#define CONN_PMIC_REQ_LSB                   (1U << 5)       /* 1b */
#define MCUPM_PMIC_REQ_LSB                  (1U << 7)       /* 1b */
#define GPUEB_PMIC_REQ_LSB                  (1U << 14)      /* 1b */
#define MD_PMIC_REQ_LSB                     (1U << 17)      /* 1b */
#define MM_PROC_PMIC_REQ_LSB                (1U << 20)      /* 1b */
#define MSDC1_PMIC_REQ_LSB                  (1U << 21)      /* 1b */
#define SCP_PMIC_REQ_LSB                    (1U << 22)      /* 1b */
#define SRCCLKENI_PMIC_REQ_LSB              (1U << 23)      /* 2b */
#define SSPM_PMIC_REQ_LSB                   (1U << 25)      /* 1b */
#define SSUSB0_PMIC_REQ_LSB                 (1U << 26)      /* 1b */
#define UFS_PMIC_REQ_LSB                    (1U << 27)      /* 1b */
/* SPM_REQ_STA_8 (0x1C001000+0x868) */
#define CG_CHECK_APSRC_REQ_LSB              (1U << 0)       /* 1b */
#define CG_CHECK_DDREN_REQ_LSB              (1U << 1)       /* 1b */
#define CG_CHECK_EMI_REQ_LSB                (1U << 2)       /* 1b */
...
#define MCUSYS_APSRC_REQ_LSB                (1U << 7)       /* 8b */
#define MCUSYS_DDREN_REQ_LSB                (1U << 15)      /* 8b */
#define MCUSYS_EMI_REQ_LSB                  (1U << 23)      /* 8b */
#define DVFSRC_LEVEL_REQ_LSB                (1U << 31)      /* 1b */
...
#define REG_PERI_DDREN_ACK_MASK_LSB         (1U << 0)       /* 1b */
#define REG_APU_DDREN_ACK_MASK_LSB          (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_DDREN_ACK_MASK_LSB    (1U << 2)       /* 1b */
#define REG_CAM_DDREN_ACK_MASK_LSB          (1U << 3)       /* 1b */
#define REG_CONN_DDREN_ACK_MASK_LSB         (1U << 5)       /* 1b */
#define REG_MCUPM_DDREN_ACK_MASK_LSB        (1U << 7)       /* 1b */
#define REG_GCE_DDREN_ACK_MASK_LSB          (1U << 13)      /* 1b */
#define REG_GPUEB_DDREN_ACK_MASK_LSB        (1U << 14)      /* 1b */
#define REG_MD_DDREN_ACK_MASK_LSB           (1U << 17)      /* 1b */
#define REG_MDP0_DDREN_ACK_MASK_LSB         (1U << 19)      /* 1b */
#define REG_MM_PROC_DDREN_ACK_MASK_LSB      (1U << 20)      /* 1b */
#define REG_SCP_DDREN_ACK_MASK_LSB          (1U << 22)      /* 1b */
#define REG_SSPM_DDREN_ACK_MASK_LSB         (1U << 25)      /* 1b */
#define REG_SSUSB0_DDREN_ACK_MASK_LSB       (1U << 26)      /* 1b */
#define REG_UFS_DDREN_ACK_MASK_LSB          (1U << 27)      /* 1b */
/* SPM_RESOURCE_ACK_MASK_1 (0x1C001000+0x890) */
#define REG_PERI_APSRC_ACK_MASK_LSB         (1U << 0)       /* 1b */
#define REG_APU_APSRC_ACK_MASK_LSB          (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_APSRC_ACK_MASK_LSB    (1U << 2)       /* 1b */
#define REG_CAM_APSRC_ACK_MASK_LSB          (1U << 3)       /* 1b */
#define REG_CONN_APSRC_ACK_MASK_LSB         (1U << 5)       /* 1b */
#define REG_MCUPM_APSRC_ACK_MASK_LSB        (1U << 7)       /* 1b */
#define REG_GCE_APSRC_ACK_MASK_LSB          (1U << 13)      /* 1b */
#define REG_GPUEB_APSRC_ACK_MASK_LSB        (1U << 14)      /* 1b */
#define REG_MD_APSRC_ACK_MASK_LSB           (1U << 17)      /* 1b */
#define REG_MDP0_APSRC_ACK_MASK_LSB         (1U << 19)      /* 1b */
#define REG_MM_PROC_APSRC_ACK_MASK_LSB      (1U << 20)      /* 1b */
#define REG_SCP_APSRC_ACK_MASK_LSB          (1U << 22)      /* 1b */
#define REG_SSPM_APSRC_ACK_MASK_LSB         (1U << 25)      /* 1b */
#define REG_SSUSB0_APSRC_ACK_MASK_LSB       (1U << 26)      /* 1b */
#define REG_UFS_APSRC_ACK_MASK_LSB          (1U << 27)      /* 1b */
/* SPM_RESOURCE_ACK_MASK_2 (0x1C001000+0x894) */
#define REG_PERI_VRF18_ACK_MASK_LSB         (1U << 0)       /* 1b */
#define REG_APU_VRF18_ACK_MASK_LSB          (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_VRF18_ACK_MASK_LSB    (1U << 2)       /* 1b */
#define REG_CONN_VRF18_ACK_MASK_LSB         (1U << 5)       /* 1b */
#define REG_MCUPM_VRF18_ACK_MASK_LSB        (1U << 7)       /* 1b */
#define REG_GCE_VRF18_ACK_MASK_LSB          (1U << 13)      /* 1b */
#define REG_GPUEB_VRF18_ACK_MASK_LSB        (1U << 14)      /* 1b */
#define REG_MD_VRF18_ACK_MASK_LSB           (1U << 17)      /* 1b */
#define REG_MM_PROC_VRF18_ACK_MASK_LSB      (1U << 20)      /* 1b */
#define REG_SCP_VRF18_ACK_MASK_LSB          (1U << 22)      /* 1b */
#define REG_SSPM_VRF18_ACK_MASK_LSB         (1U << 25)      /* 1b */
#define REG_SSUSB0_VRF18_ACK_MASK_LSB       (1U << 26)      /* 1b */
#define REG_UFS_VRF18_ACK_MASK_LSB          (1U << 27)      /* 1b */
/* SPM_RESOURCE_ACK_MASK_3 (0x1C001000+0x898) */
#define REG_PERI_INFRA_ACK_MASK_LSB         (1U << 0)       /* 1b */
#define REG_APU_INFRA_ACK_MASK_LSB          (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_INFRA_ACK_MASK_LSB    (1U << 2)       /* 1b */
#define REG_CAM_INFRA_ACK_MASK_LSB          (1U << 3)       /* 1b */
#define REG_CONN_INFRA_ACK_MASK_LSB         (1U << 5)       /* 1b */
#define REG_MCUPM_INFRA_ACK_MASK_LSB        (1U << 7)       /* 1b */
#define REG_GCE_INFRA_ACK_MASK_LSB          (1U << 13)      /* 1b */
#define REG_GPUEB_INFRA_ACK_MASK_LSB        (1U << 14)      /* 1b */
#define REG_MD_INFRA_ACK_MASK_LSB           (1U << 17)      /* 1b */
#define REG_MM_PROC_INFRA_ACK_MASK_LSB      (1U << 20)      /* 1b */
#define REG_SCP_INFRA_ACK_MASK_LSB          (1U << 22)      /* 1b */
#define REG_SSPM_INFRA_ACK_MASK_LSB         (1U << 25)      /* 1b */
#define REG_SSUSB0_INFRA_ACK_MASK_LSB       (1U << 26)      /* 1b */
#define REG_UFS_INFRA_ACK_MASK_LSB          (1U << 27)      /* 1b */
/* SPM_EVENT_COUNTER_CLEAR (0x1C001000+0x89C) */
#define REG_SPM_EVENT_COUNTER_CLR_LSB       (1U << 0)       /* 1b */
/* SPM_SRCCLKENA_EVENT_COUNT_STA (0x1C001000+0x8A0) */
#define SPM_SRCCLKENA_SLEEP_COUNT_LSB       (1U << 0)       /* 16b */
#define SPM_SRCCLKENA_WAKE_COUNT_LSB        (1U << 16)      /* 16b */
/* SPM_PMIC_EVENT_COUNT_STA (0x1C001000+0x8A4) */
#define SPM_PMIC_SLEEP_COUNT_LSB            (1U << 0)       /* 16b */
#define SPM_PMIC_WAKE_COUNT_LSB             (1U << 16)      /* 16b */
/* SPM_INFRA_EVENT_COUNT_STA (0x1C001000+0x8A8) */
#define SPM_INFRA_SLEEP_COUNT_LSB           (1U << 0)       /* 16b */
#define SPM_INFRA_WAKE_COUNT_LSB            (1U << 16)      /* 16b */
/* SPM_EMI_EVENT_COUNT_STA (0x1C001000+0x8AC) */
#define SPM_EMI_SLEEP_COUNT_LSB             (1U << 0)       /* 16b */
#define SPM_EMI_WAKE_COUNT_LSB              (1U << 16)      /* 16b */
/* SPM_APSRC_EVENT_COUNT_STA (0x1C001000+0x8B0) */
#define SPM_APSRC_SLEEP_COUNT_LSB           (1U << 0)       /* 16b */
#define SPM_APSRC_WAKE_COUNT_LSB            (1U << 16)      /* 16b */
/* SPM_VRF18_EVENT_COUNT_STA (0x1C001000+0x8B4) */
#define SPM_VRF18_SLEEP_COUNT_LSB           (1U << 0)       /* 16b */
#define SPM_VRF18_WAKE_COUNT_LSB            (1U << 16)      /* 16b */
/* SPM_DDREN_EVENT_COUNT_STA (0x1C001000+0x8B8) */
...
/* SPM_RESOURCE_ACK_MASK_4 (0x1C001000+0x8C0) */
#define REG_PERI_SRCCLKENA_ACK_MASK_LSB     (1U << 0)       /* 1b */
#define REG_APU_SRCCLKENA_ACK_MASK_LSB      (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_SRCCLKENA_ACK_MASK_LSB (1U << 2)       /* 1b */
#define REG_CONN_SRCCLKENA_ACK_MASK_LSB     (1U << 5)       /* 1b */
#define REG_MCUPM_SRCCLKENA_ACK_MASK_LSB    (1U << 7)       /* 1b */
#define REG_GPUEB_SRCCLKENA_ACK_MASK_LSB    (1U << 14)      /* 1b */
#define REG_MD_SRCCLKENA_ACK_MASK_LSB       (1U << 17)      /* 1b */
#define REG_MM_PROC_SRCCLKENA_ACK_MASK_LSB  (1U << 20)      /* 1b */
#define REG_SCP_SRCCLKENA_ACK_MASK_LSB      (1U << 22)      /* 1b */
#define REG_SSPM_SRCCLKENA_ACK_MASK_LSB     (1U << 25)      /* 1b */
#define REG_SSUSB0_SRCCLKENA_ACK_MASK_LSB   (1U << 26)      /* 1b */
#define REG_UFS_SRCCLKENA_ACK_MASK_LSB      (1U << 27)      /* 1b */
/* SPM_RESOURCE_ACK_MASK_5 (0x1C001000+0x8C4) */
#define REG_CONN_VCORE_ACK_MASK_LSB         (1U << 5)       /* 1b */
#define REG_MD_VCORE_ACK_MASK_LSB           (1U << 17)      /* 1b */
/* SPM_RESOURCE_ACK_MASK_6 (0x1C001000+0x8C8) */
#define REG_PERI_EMI_ACK_MASK_LSB           (1U << 0)       /* 1b */
#define REG_APU_EMI_ACK_MASK_LSB            (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_EMI_ACK_MASK_LSB      (1U << 2)       /* 1b */
#define REG_CAM_EMI_ACK_MASK_LSB            (1U << 3)       /* 1b */
#define REG_CONN_EMI_ACK_MASK_LSB           (1U << 5)       /* 1b */
#define REG_MCUPM_EMI_ACK_MASK_LSB          (1U << 7)       /* 1b */
#define REG_GCE_EMI_ACK_MASK_LSB            (1U << 13)      /* 1b */
#define REG_GPUEB_EMI_ACK_MASK_LSB          (1U << 14)      /* 1b */
#define REG_MD_EMI_ACK_MASK_LSB             (1U << 17)      /* 1b */
#define REG_MDP0_EMI_ACK_MASK_LSB           (1U << 19)      /* 1b */
#define REG_MM_PROC_EMI_ACK_MASK_LSB        (1U << 20)      /* 1b */
#define REG_SCP_EMI_ACK_MASK_LSB            (1U << 22)      /* 1b */
#define REG_SSPM_EMI_ACK_MASK_LSB           (1U << 25)      /* 1b */
#define REG_SSUSB0_EMI_ACK_MASK_LSB         (1U << 26)      /* 1b */
#define REG_UFS_EMI_ACK_MASK_LSB            (1U << 27)      /* 1b */
/* SPM_RESOURCE_ACK_MASK_7 (0x1C001000+0x8CC) */
#define REG_PERI_PMIC_ACK_MASK_LSB          (1U << 0)       /* 1b */
#define REG_APU_PMIC_ACK_MASK_LSB           (1U << 1)       /* 1b */
#define REG_AUDIO_DSP_PMIC_ACK_MASK_LSB     (1U << 2)       /* 1b */
#define REG_CONN_PMIC_ACK_MASK_LSB          (1U << 5)       /* 1b */
#define REG_MCUPM_PMIC_ACK_MASK_LSB         (1U << 7)       /* 1b */
#define REG_GPUEB_PMIC_ACK_MASK_LSB         (1U << 14)      /* 1b */
#define REG_MD_PMIC_ACK_MASK_LSB            (1U << 17)      /* 1b */
#define REG_MM_PROC_PMIC_ACK_MASK_LSB       (1U << 20)      /* 1b */
#define REG_SCP_PMIC_ACK_MASK_LSB           (1U << 22)      /* 1b */
#define REG_SSPM_PMIC_ACK_MASK_LSB          (1U << 25)      /* 1b */
#define REG_SSUSB0_PMIC_ACK_MASK_LSB        (1U << 26)      /* 1b */
#define REG_UFS_PMIC_ACK_MASK_LSB           (1U << 27)      /* 1b */
...
#define SC_DXCC_PDN_SRAM_PDN_ACK_LSB        (1U << 12)      /* 1b */
...
#define EMI_HRE_SRAM_SLEEP_B_LSB            (1U << 4)       /* 1b */
#define EMI_HRE_SRAM_PDN_LSB                (1U << 16)      /* 1b */
/* EMI_SLB_SRAM_CON (0x1C001000+0xF4C) */
#define EMI_SLB_SRAM_PDN_LSB                (1U << 0)       /* 6b */
/* EMI_SLB_SRAM_ACK (0x1C001000+0xF50) */
#define SC_EMI_SLB_SRAM_PDN_ACK_LSB         (1U << 0)       /* 6b */
...
/* SSPM_SRAM_CON (0x1C001000+0xF64) */
...
/* MD_BUCK_ISO_CON (0x1C001000+0xF70) */
...
/* SOC_BUCK_ISO_CON (0x1C001000+0xF74) */
...
/* PWR_STATUS (0x1C001000+0xF78) */
#define PWR_STATUS_LSB                      (1U << 0)       /* 32b */
/* PWR_STATUS_2ND (0x1C001000+0xF7C) */
#define PWR_STATUS_2ND_LSB                  (1U << 0)       /* 32b */
/* PWR_STATUS_MSB (0x1C001000+0xF80) */
#define PWR_STATUS_MSB_LSB                  (1U << 0)       /* 32b */
/* PWR_STATUS_MSB_2ND (0x1C001000+0xF84) */
#define PWR_STATUS_MSB_2ND_LSB              (1U << 0)       /* 32b */
/* XPU_PWR_STATUS (0x1C001000+0xF88) */
#define XPU_PWR_STATUS_LSB                  (1U << 0)       /* 32b */
/* XPU_PWR_STATUS_2ND (0x1C001000+0xF8C) */
#define XPU_PWR_STATUS_2ND_LSB              (1U << 0)       /* 32b */
/* DFD_SOC_PWR_LATCH (0x1C001000+0xF90) */
#define DFD_SOC_PWR_LATCH_LSB               (1U << 0)       /* 32b */
/* RSV_SRAM_CON (0x1C001000+0xF94) */
#define RSV_SRAM_CKISO_LSB                  (1U << 0)       /* 1b */
#define RSV_SRAM_ISOINT_B_LSB               (1U << 1)       /* 1b */
#define RSV_SRAM_SLEEP_B_LSB                (1U << 4)       /* 1b */
#define RSV_SRAM_PDN_LSB                    (1U << 16)      /* 1b */
/* SUBSYS_PM_BYPASS (0x1C001000+0xF98) */
#define PM_BYPASS_MODE_LSB                  (1U << 0)       /* 16b */
/* SPM_TWAM_CON (0x1C001000+0xFA0) */
...
/* SPM_TWAM_WINDOW_LEN (0x1C001000+0xFA4) */
#define REG_TWAM_WINDOW_LEN_LSB             (1U << 0)       /* 32b */
/* SPM_TWAM_IDLE_SEL (0x1C001000+0xFA8) */
...
/* SPM_TWAM_LAST_STA_0 (0x1C001000+0xFAC) */
#define TWAM_LAST_IDLE_CNT_0_LSB            (1U << 0)       /* 32b */
/* SPM_TWAM_LAST_STA_1 (0x1C001000+0xFB0) */
#define TWAM_LAST_IDLE_CNT_1_LSB            (1U << 0)       /* 32b */
/* SPM_TWAM_LAST_STA_2 (0x1C001000+0xFB4) */
#define TWAM_LAST_IDLE_CNT_2_LSB            (1U << 0)       /* 32b */
/* SPM_TWAM_LAST_STA_3 (0x1C001000+0xFB8) */
#define TWAM_LAST_IDLE_CNT_3_LSB            (1U << 0)       /* 32b */
/* SPM_TWAM_CURR_STA_0 (0x1C001000+0xFBC) */
#define TWAM_CURRENT_IDLE_CNT_0_LSB         (1U << 0)       /* 32b */
/* SPM_TWAM_CURR_STA_1 (0x1C001000+0xFC0) */
#define TWAM_CURRENT_IDLE_CNT_1_LSB         (1U << 0)       /* 32b */
/* SPM_TWAM_CURR_STA_2 (0x1C001000+0xFC4) */
#define TWAM_CURRENT_IDLE_CNT_2_LSB         (1U << 0)       /* 32b */
/* SPM_TWAM_CURR_STA_3 (0x1C001000+0xFC8) */
#define TWAM_CURRENT_IDLE_CNT_3_LSB         (1U << 0)       /* 32b */
/* SPM_TWAM_TIMER_OUT (0x1C001000+0xFCC) */
#define TWAM_TIMER_LSB                      (1U << 0)
