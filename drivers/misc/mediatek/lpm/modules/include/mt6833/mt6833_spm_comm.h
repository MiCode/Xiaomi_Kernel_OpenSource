...
#ifndef __MT6833_SPM_COMM_H__
#define __MT6833_SPM_COMM_H__

struct mt6833_spm_wake_status {
...
#define SPM_DBG_DEBUG_IDX__6360_VDDQ_LP_MODE		(1 << 25u)
...
#define SPM_DBG1_DEBUG_IDX_6360_SRCLKEN2_LOW		(1 << 9u)
#define SPM_DBG1_DEBUG_IDX_6360_SRCLKEN2_HIGH		(1 << 10u)
...
#define SPM_DBG1_MCUPM_RESTORE				(1 << 31u)
