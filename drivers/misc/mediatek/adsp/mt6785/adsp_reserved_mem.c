...
#if defined(FPGA_EARLY_DEVELOPMENT)
...
#elif defined(CONFIG_MTK_ENG_BUILD)
...
#else
	[ADSP_A_SYSTEM_MEM_ID]      = ADSP_RESERVE_MEMORY_BLOCK(0x700000),
	[ADSP_A_IPI_MEM_ID]         = ADSP_RESERVE_MEMORY_BLOCK(0x248000),
	[ADSP_A_LOGGER_MEM_ID]      = ADSP_RESERVE_MEMORY_BLOCK(0x80000),
	[ADSP_VOIP_MEM_ID]          = ADSP_RESERVE_MEMORY_BLOCK(0x10000),
	[ADSP_A2DP_PLAYBACK_MEM_ID] = ADSP_RESERVE_MEMORY_BLOCK(0),
	[ADSP_OFFLOAD_MEM_ID]       = ADSP_RESERVE_MEMORY_BLOCK(0),
	[ADSP_AFE_MEM_ID]           = ADSP_RESERVE_MEMORY_BLOCK(0x30000),
	[ADSP_PLAYBACK_MEM_ID]      = ADSP_RESERVE_MEMORY_BLOCK(0x18000),
	[ADSP_DEEPBUF_MEM_ID]       = ADSP_RESERVE_MEMORY_BLOCK(0),
	[ADSP_PRIMARY_MEM_ID]       = ADSP_RESERVE_MEMORY_BLOCK(0),
	[ADSP_CAPTURE_UL1_MEM_ID]   = ADSP_RESERVE_MEMORY_BLOCK(0xC000),
	[ADSP_DATAPROVIDER_MEM_ID]  = ADSP_RESERVE_MEMORY_BLOCK(0),
	[ADSP_CALL_FINAL_MEM_ID]    = ADSP_RESERVE_MEMORY_BLOCK(0x30000),
	[ADSP_A_DEBUG_DUMP_MEM_ID]  = ADSP_RESERVE_MEMORY_BLOCK(0x20000),
	[ADSP_A_CORE_DUMP_MEM_ID]   = ADSP_RESERVE_MEMORY_BLOCK(0x400),
#endif
};
