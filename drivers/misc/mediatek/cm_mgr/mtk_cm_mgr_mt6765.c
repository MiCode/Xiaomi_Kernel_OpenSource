...
u32 cm_mgr_get_perfs_mt6765(int num)
{
	if (num < 0 || num >= cm_mgr_get_num_perf())
		return 0;
	return cm_mgr_perfs[num];
}
EXPORT_SYMBOL_GPL(cm_mgr_get_perfs_mt6765);
...
void cm_mgr_perf_platform_set_status_mt6765(int enable)
{
...
EXPORT_SYMBOL_GPL(cm_mgr_perf_platform_set_status_mt6765);
...
void cm_mgr_perf_set_status_mt6765(int enable)
{
	...
	cm_mgr_perf_platform_set_status_mt6765(enable);
}
EXPORT_SYMBOL_GPL(cm_mgr_perf_set_status_mt6765);

void cm_mgr_perf_set_force_status_mt6765(int enable)
{
...
EXPORT_SYMBOL_GPL(cm_mgr_perf_set_force_status_mt6765);
...
static int platform_cm_mgr_probe(struct platform_device *pdev)
{
	...
	local_hk.cm_mgr_get_perfs =
		cm_mgr_get_perfs_mt6765;
	local_hk.cm_mgr_perf_set_force_status =
		cm_mgr_perf_set_force_status_mt6765;
	local_hk.check_cm_mgr_status =
		check_cm_mgr_status_mt6765;
	local_hk.cm_mgr_perf_platform_set_status =
		cm_mgr_perf_platform_set_status_mt6765;
	local_hk.cm_mgr_perf_set_status =
		cm_mgr_perf_set_status_mt6765;
