...
EXPORT_SYMBOL_GPL(cm_mgr_get_perfs_mt6985);
...
void cm_mgr_perf_platform_set_status_mt6985(int enable)
{
...
EXPORT_SYMBOL_GPL(cm_mgr_perf_platform_set_status_mt6985);
...
void cm_mgr_perf_set_status_mt6985(int enable)
{
	...
	cm_mgr_perf_platform_set_status_mt6985(enable);
}
EXPORT_SYMBOL_GPL(cm_mgr_perf_set_status_mt6985);

void cm_mgr_perf_set_force_status_mt6985(int enable)
{
...
EXPORT_SYMBOL_GPL(cm_mgr_perf_set_force_status_mt6985);

void check_cm_mgr_status_mt6985(unsigned int cluster, unsigned int freq,
		unsigned int idx)
{
...
EXPORT_SYMBOL_GPL(check_cm_mgr_status_mt6985);
...
static int platform_cm_mgr_probe(struct platform_device *pdev)
{
	...
	local_hk.cm_mgr_get_perfs =
		cm_mgr_get_perfs_mt6985;
	local_hk.cm_mgr_perf_set_force_status =
		cm_mgr_perf_set_force_status_mt6985;
	local_hk.check_cm_mgr_status =
		check_cm_mgr_status_mt6985;
...
static const struct of_device_id platform_cm_mgr_of_match[] = {
	{ .compatible = "mediatek,mt6985-cm_mgr", },
	{},
};
