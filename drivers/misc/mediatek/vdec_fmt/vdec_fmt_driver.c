...
static void fmt_dump_addr_reg(void)
{
	...
	for (idx = 0; idx < fmt->dtsInfo.pipeNum; idx++) {
		fmt_debug(0, "RDMA%d(0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx",
		...
		fmt_debug(0, "RDMA%d(0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx",
		...
		fmt_debug(0, "RDMA%d(0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx",
		...
		fmt_debug(0, "RDMA%d(0x%lx) 0x%lx",
		idx, ADDR0(0xF54), REG0(0xF54));

		fmt_debug(0, "WROT%d(0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx",
		...
		fmt_debug(0, "WROT%d(0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx",
		...
		fmt_debug(0, "WROT%d(0x%lx) 0x%lx (0x%lx)",
		...
		fmt_debug(0, "WROT%d(0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx (0x%lx) 0x%lx",
