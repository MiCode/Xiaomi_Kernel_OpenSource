...
#define ITG1010_REG_CFG             0x1A      //set external sync, full-scale range and sample rate, low pass filter bandwidth
...
// for ITG1010_REG_CFG
#define ITG1010_EXT_SYNC            0x03    //0x05    //captue the state of external frame sync input pin to insert into LSB of registers
