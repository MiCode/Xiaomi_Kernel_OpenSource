...
#define SMI_LARB0_PORT_NUM	(6)	/* SYS_DIS */
#define SMI_LARB1_PORT_NUM	(8)	/* SYS_DIS */
#define SMI_LARB2_PORT_NUM	(5)	/* SYS_MDP */
#define SMI_LARB3_PORT_NUM	(0)	/* SYS_MDP */
...
#define SMI_LARB8_PORT_NUM	(0)	/* SYS_VEN */
...
#define SMI_LARB15_PORT_NUM	(0)	/* SYS_CAM1 */
...
SMI_LARB_PORT_NUM[SMI_LARB_NUM] = {
	6, 8, 5, 0, 11, 8, 0, 15, 0, 29, 0, 29, 0, 12, 6, 0, 17, 17, 17, 4, 6};
