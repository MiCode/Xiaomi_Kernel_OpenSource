...
#define SMI_LARB4_PORT_NUM	(14)	/* SYS_VDE */
...
#define SMI_LARB18_PORT_NUM	(0)	/* SYS_CAM4 */
...
SMI_LARB_L1ARB[SMI_LARB_NUM] = {
	0, 1, 4, SMI_COMM_MASTER_NUM, 2, SMI_COMM_MASTER_NUM, SMI_COMM_MASTER_NUM,
	3, SMI_COMM_MASTER_NUM, 5, SMI_COMM_MASTER_NUM, 5, SMI_COMM_MASTER_NUM,
	7, 6, SMI_COMM_MASTER_NUM, 6, 7, SMI_COMM_MASTER_NUM, 5, 5};

static const u8
SMI_LARB_PORT_NUM[SMI_LARB_NUM] = {
	4, 5, 5, 0, 14, 0, 0, 13, 0, 29, 0, 29, 0, 12, 6, 0, 17, 17, 0, 4, 6};
