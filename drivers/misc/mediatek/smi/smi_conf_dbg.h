...
#define SMI_MMSYS_DEBUG_NUM	((SMI_LARB_NUM_MAX) * 3 + 6)
u32 smi_mmsys_debug_offset[SMI_MMSYS_DEBUG_NUM] = {
	...
	DISP_GALS_DBG(4), DISP_GALS_DBG(5), DISP_GALS_DBG(6),
	DISP_GALS_DBG(7), DISP_GALS_DBG(8), DISP_GALS_DBG(9),
	DISP_GALS_DBG(10), DISP_GALS_DBG(11), DISP_GALS_DBG(12),
	DISP_GALS_DBG(13), DISP_GALS_DBG(14), DISP_GALS_DBG(15),
...
#define SMI_COMM_DEBUG_NUM	((SMI_LARB_NUM_MAX) * 4 + 27)
u32 smi_comm_debug_offset[SMI_COMM_DEBUG_NUM] = {
	...
	SMI_PREULTRA_MASK0, SMI_PREULTRA_MASK1, SMI_DCM, SMI_ELA,
	...
	SMI_AST_EN, SMI_AST_COND, SMI_TIMEOUT, SMI_TIMEOUT_CNT, SMI_AST_STA,
};

#define SMI_LARB_DEBUG_NUM	((SMI_PORT_NUM_MAX) * 4 + 31)
u32 smi_larb_debug_offset[SMI_LARB_DEBUG_NUM] = {
	SMI_LARB_STAT, SMI_LARB_IRQ_STATUS, SMI_LARB_SLP_CON,
	SMI_LARB_CON, SMI_LARB_CON_SET,
	SMI_LARB_VC_PRI_MODE, SMI_LARB_CMD_THRT_CON,
	SMI_LARB_SW_FLAG, SMI_LARB_BWL_EN, SMI_LARB_OSTDL_EN,
	SMI_LARB_ULTRA_DIS, SMI_LARB_FORCE_ULTRA,
