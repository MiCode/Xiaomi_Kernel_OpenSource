...
static request_dvfs_opp request_vcore_opp;

void mmdvfs_register_vcore_callback(request_dvfs_opp request_opp_cb)
{
	request_vcore_opp = request_opp_cb;
}
EXPORT_SYMBOL(mmdvfs_register_vcore_callback);

void mmdvfs_unregister_vcore_callback(void)
{
	request_vcore_opp = NULL;
}
EXPORT_SYMBOL(mmdvfs_unregister_vcore_callback);
#else
#define OPP_0 0
#define OPP_1 1
#define OPP_2 2
