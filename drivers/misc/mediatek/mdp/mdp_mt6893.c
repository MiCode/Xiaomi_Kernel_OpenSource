...
static void mdp_qos_clear_all(u32 thread_id)
{
	...
	icc_set_bw(path_mdp_rdma2[thread_id], 0, 0);
	icc_set_bw(path_mdp_rdma3[thread_id], 0, 0);
	icc_set_bw(path_mdp_wrot0[thread_id], 0, 0);
	icc_set_bw(path_mdp_wrot1[thread_id], 0, 0);
	icc_set_bw(path_mdp_wrot2[thread_id], 0, 0);
	icc_set_bw(path_mdp_wrot3[thread_id], 0, 0);
}
