...
extern int generic_debugfs_register(struct dbg_info *di);
extern void generic_debugfs_unregister(struct dbg_info *di);
#else
static inline int generic_debugfs_register(struct dbg_info *di)
{
	return 0;
}

static inline void generic_debugfs_unregister(struct dbg_info *di) {}
