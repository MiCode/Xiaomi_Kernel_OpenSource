...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0147000C, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT imx766dual_cust_op_tri_v2_eeprom = {
	.name = "imx766dual_cust_op_tri_v2_eeprom",
