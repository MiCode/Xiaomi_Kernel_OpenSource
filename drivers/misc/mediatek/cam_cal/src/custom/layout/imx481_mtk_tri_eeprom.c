...
struct STRUCT_CAM_CAL_CONFIG_STRUCT imx481_mtk_tri_eeprom = {
	.name = "imx481_mtk_tri_eeprom",
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	pCamCalData->Single2A.S2aAf[0] = 363; //AFInf
	pCamCalData->Single2A.S2aAf[1] = 662; //AFMacro
