...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF117771, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT daumiers5k5e9_mtk_eeprom = {
	.name = "daumiers5k5e9_mtk_eeprom",
	.check_layout_function = layout_check,
	.read_function = Common_read_region,
	.layout = &cal_layout_table,
	.sensor_id = DAUMIERS5K5E9_SENSOR_ID,
	.i2c_write_id = 0xA8,
	.max_size = 0x4000,
	.enable_preload = 1,
	.preload_size = 0x2000,
