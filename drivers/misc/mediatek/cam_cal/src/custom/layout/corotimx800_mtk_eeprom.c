...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0x0243A0ED, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000001, 0x0000000F, xiaomi_do_module_version},
		{0x00000001, 0x00000010, 0x00000010, xiaomi_do_part_number},
		{0x00000001, 0x000038CF, 0x0000074C, xiaomi_do_single_lsc},
		{0x00000001, 0x000038B6, 0x00000010, xiaomi_do_2a_gain},
		{0x00000001, 0x00004778, 0x00000A28, xiaomi_do_pdaf},
		{0x00000001, 0x00000000, 0x00000001, NULL},
		{0x00000001, 0x00000000, 0x00007FFF, xiaomi_do_dump_all},
		{0x00000000, 0x00000F80, 0x0000000A, NULL}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT corotimx800_mtk_eeprom = {
	.name = "corotimx800_mtk_eeprom",
	.check_layout_function = layout_check,
	.read_function = Common_read_region,
	.layout = &cal_layout_table,
	.sensor_id = COROTIMX800_SENSOR_ID,
	.i2c_write_id = 0xA2,
	.max_size = 0x8000,
	.enable_preload = 1,
	.preload_size = 0x2000,
