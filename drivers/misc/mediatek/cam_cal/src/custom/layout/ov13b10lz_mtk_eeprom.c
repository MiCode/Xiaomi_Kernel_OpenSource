...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
    0x00000001, 0x010b00ff, CAM_CAL_SINGLE_EEPROM_DATA,
    {
        ...
        {0x00000001, 0x00000051, 0x0000074F, custom_do_single_lsc},
        {0x00000001, 0x00000027, 0x0000002A, custom_do_2a_gain},
        {0x00000001, 0x000007A0, 0x000005E1, custom_do_pdaf},
        {0x00000000, 0x00000000, 0x00000D81, do_dump_all},
        {0x00000000, 0x00000F80, 0x0000000A, do_lens_id},
    }
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT ov13b10lz_mtk_eeprom = {
    .name = "ov13b10lz_mtk_eeprom",
