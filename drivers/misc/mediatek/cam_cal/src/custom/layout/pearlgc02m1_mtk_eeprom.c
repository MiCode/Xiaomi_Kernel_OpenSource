...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFFE7, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000001, 0x0000000F, xiaomi_do_module_version},
		{0x00000001, 0x00000010, 0x0000000B, xiaomi_do_part_number},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT pearlgc02m1_mtk_eeprom = {
	.name = "pearlgc02m1_mtk_eeprom",
	.check_layout_function = layout_check,
	.read_function = Common_read_region,
	.layout = &cal_layout_table,
	.sensor_id = PEARLGC02M1_SENSOR_ID,
	.i2c_write_id = 0xA4,
	.max_size = 0x4000,
	.enable_preload = 1,
	.preload_size = 0x2000,
