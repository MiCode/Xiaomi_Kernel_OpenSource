...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF68, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT xagaaacs5k4h7_mtk_eeprom = {
	.name = "xagaaacs5k4h7_mtk_eeprom",
	.check_layout_function = layout_check,
	.read_function = Common_read_region,
	.layout = &cal_layout_table,
	.sensor_id = XAGAS5K4H7_SENSOR_ID,
	.i2c_write_id = 0xA0,
	.max_size = 0x4000,
	.enable_preload = 1,
	.preload_size = 0x2000,
