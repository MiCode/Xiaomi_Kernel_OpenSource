...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFFC7, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000000, 0x00001AED, 0x000005DD, xiaomi_do_pdaf},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT daumierov32b40_mtk_eeprom = {
	.name                  = "daumierov32b40_mtk_eeprom",
