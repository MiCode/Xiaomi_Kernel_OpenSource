...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFF3D8FE9, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000000, 0x00003FF4, xiaomi_do_dump_all},
		{0x00000000, 0x00000F80, 0x0000000A, NULL}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT platosemcos5khm6_mtk_eeprom = {
	.name = "platosemcos5khm6_mtk_eeprom",
