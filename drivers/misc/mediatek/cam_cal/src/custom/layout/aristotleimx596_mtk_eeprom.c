...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000008, 0xFFFFFF73, CAM_CAL_SINGLE_EEPROM_DATA,
	{
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT aristotleimx596_mtk_eeprom = {
	.name = "aristotleimx596_mtk_eeprom",
	.check_layout_function = layout_check,
	.read_function = Common_read_region,
	.layout = &cal_layout_table,
	.sensor_id = ARISTOTLEIMX596_SENSOR_ID,
	.i2c_write_id = 0xA2,
	.max_size = 0x4000,
	.enable_preload = 1,
	.preload_size = 0x2000,
