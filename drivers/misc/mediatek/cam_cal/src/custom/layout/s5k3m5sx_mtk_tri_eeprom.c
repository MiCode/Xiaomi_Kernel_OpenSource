...
struct STRUCT_CAM_CAL_CONFIG_STRUCT s5k3m5sx_mtk_tri_eeprom = {
	.name = "s5k3m5sx_mtk_tri_eeprom",
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	pCamCalData->Single2A.S2aAf[0] = 424; //AFInf
	pCamCalData->Single2A.S2aAf[1] = 604; //AFMacro
	pCamCalData->Single2A.S2aAF_t.AF_infinite_pattern_distance = 5000;
	pCamCalData->Single2A.S2aAF_t.AF_Macro_pattern_distance = 300;
	pCamCalData->Single2A.S2aAF_t.AF_Middle_calibration = 0;
