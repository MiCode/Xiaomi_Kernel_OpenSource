...
{
	return mtk_gether_setup_name(g, dev_addr, host_addr, ethaddr, qmult, "usb");
}
...
/*
 * mtk_gether_register_netdev - register the net device
...
/**
 * mtk_gether_set_gadget - initialize one ethernet-over-usb link with a gadget
...
/**
 * mtk_gether_set_dev_addr - initialize an ethernet-over-usb link with eth address
 * @net: device representing this link
...
/**
 * mtk_gether_get_dev_addr - get an ethernet-over-usb link eth address
 * @net: device representing this link
...
/**
 * mtk_gether_set_host_addr - initialize an ethernet-over-usb link with host address
 * @net: device representing this link
...
/**
 * mtk_gether_get_host_addr - get an ethernet-over-usb link host address
 * @net: device representing this link
...
/**
 * mtk_gether_get_host_addr_cdc - get an ethernet-over-usb link host address
 * @net: device representing this link
 * @host_addr: place to store eth address of the host
 * @len: length of the @host_addr buffer
 *
...
/**
 * mtk_gether_get_host_addr_u8 - get an ethernet-over-usb link host address
 * @net: device representing this link
...
/**
 * mtk_gether_set_qmult - initialize an ethernet-over-usb link with a multiplier
 * @net: device representing this link
...
/**
 * mtk_gether_get_qmult - get an ethernet-over-usb link multiplier
 * @net: device representing this link
 *
...
/**
 * mtk_gether_get_ifname - get an ethernet-over-usb link interface name
 * @net: device representing this link
...
struct net_device *mtk_gether_connect(struct gether *);
void mtk_gether_disconnect(struct gether *);
