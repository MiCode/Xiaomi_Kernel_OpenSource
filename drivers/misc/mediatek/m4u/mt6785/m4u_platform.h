...
struct m4u_port_t gM4uPort[] = {
	...
	M4U0_PORT_INIT("AFO_1", 0, 6, smi_select_larb6_id, 9),
	M4U0_PORT_INIT("PSO", 0, 6, smi_select_larb6_id, 10),
	M4U0_PORT_INIT("LSCI_2", 0, 6, smi_select_larb6_id, 11),
	M4U0_PORT_INIT("SOCO", 0, 6, smi_select_larb6_id, 12),
	M4U0_PORT_INIT("SOC1", 0, 6, smi_select_larb6_id, 13),
	M4U0_PORT_INIT("SOC2", 0, 6, smi_select_larb6_id, 14),
	M4U0_PORT_INIT("CCUI", 0, 6, smi_select_larb6_id, 15),
	M4U0_PORT_INIT("CCUO", 0, 6, smi_select_larb6_id, 16),

	M4U0_PORT_INIT("UFEO", 0, 6, smi_select_larb6_id, 17),
	M4U0_PORT_INIT("RAWI_A", 0, 6, smi_select_larb6_id, 18),
	M4U0_PORT_INIT("RSSO_A", 0, 6, smi_select_larb6_id, 19),
	M4U0_PORT_INIT("CCUG", 0, 6, smi_select_larb6_id, 20),
