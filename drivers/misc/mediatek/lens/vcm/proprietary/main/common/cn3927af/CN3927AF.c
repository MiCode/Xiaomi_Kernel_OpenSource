...
{
	int ret = 0;
	LOG_INF("lxl guoameng-the value of holitech af position=%ld\n",a_u4Position);
    ...
    if(a_u4Position > 230){
                ...
                s4AF_WriteReg(200);
                msleep(20);
                s4AF_WriteReg((unsigned short)a_u4Position);
               }else{
                s4AF_WriteReg((unsigned short)a_u4Position);
                }
...
/* ////////////////////////////////////////////////////////////// */
long CN3927AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
	switch (a_u4Command) {
