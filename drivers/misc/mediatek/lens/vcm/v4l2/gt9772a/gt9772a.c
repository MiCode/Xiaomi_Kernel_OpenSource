 ...
 */
#define GT9772A_MOVE_STEPS			16
#define GT9772A_MOVE_DELAY_US			8400
#define GT9772A_STABLE_TIME_US			20000
...
static int gt9772a_release(struct gt9772a_device *gt9772a)
{
	...
	for (val = round_down(gt9772a->focus->val, GT9772A_MOVE_STEPS);
	     val >= 0; val -= GT9772A_MOVE_STEPS) {
	 ...
	 */
	usleep_range(GT9772A_STABLE_TIME_US - GT9772A_MOVE_DELAY_US,
		     GT9772A_STABLE_TIME_US - GT9772A_MOVE_DELAY_US + 1000);
...
static int gt9772a_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	if (ctrl->id == V4L2_CID_FOCUS_ABSOLUTE) {
		LOG_INF("pos(%d)\n", ctrl->val);
		return gt9772a_set_position(gt9772a, ctrl->val);
	}
	return 0;
}
