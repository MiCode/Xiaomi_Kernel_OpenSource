...
static long gt9772a_ops_core_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	int ret = 0;
...
static struct v4l2_subdev_core_ops gt9772a_ops_core = {
	.ioctl = gt9772a_ops_core_ioctl,
};

static const struct v4l2_subdev_ops gt9772a_ops = {
	.core = &gt9772a_ops_core,
};
