...
{
#if (defined(XAGA_CAM) || defined(PEARL_CAM))
	int timeout;
#endif
	int ret, val;
	struct i2c_client *client = v4l2_get_subdevdata(&dw9800v->sd);
...
#elif (defined(XAGA_CAM) || defined(PEARL_CAM))
	char puSendCmdArray[8][2] = {
	{0x02, 0x01}, {0x02, 0x00}, {0xFE, 0xFE},
	{0x02, 0x02}, {0x06, 0x40}, {0x07, 0x07}, {0x10, 0x00}, {0xFE, 0xFE},
	};
	cmd_number = 8;
#elif defined(PLATO_CAM)
	char puSendCmdArray[7][2] = {
	{0x02, 0x01}, {0x02, 0x00}, {0xFE, 0xFE},
	{0x02, 0x02}, {0x06, 0x40}, {0x07, 0x06}, {0xFE, 0xFE},
	};
	cmd_number = 7;
#elif defined(DAUMIER_CAM)
	char puSendCmdArray[7][2] = {
	{0x02, 0x01}, {0x02, 0x00}, {0xFE, 0xFE},
	{0x02, 0x02}, {0x06, 0x40}, {0x07, 0x02}, {0xFE, 0xFE},
	};
#elif defined(YUECHU_CAM)
	char puSendCmdArray[7][2] = {
	{0x02, 0x01}, {0x02, 0x00}, {0xFE, 0xFE},
	{0x02, 0x02}, {0x06, 0x80}, {0x07, 0x60}, {0xFE, 0xFE},
	};
#elif defined(ARISTOTLE_CAM)
	char puSendCmdArray[7][2] = {
	{0x02, 0x01}, {0x02, 0x00}, {0xFE, 0xFE},
