...
static long lc898229_ops_core_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
	int ret = 0;
...
static struct v4l2_subdev_core_ops lc898229_ops_core = {
	.ioctl = lc898229_ops_core_ioctl,
};

static const struct v4l2_subdev_ops lc898229_ops = {
	.core = &lc898229_ops_core,
};
