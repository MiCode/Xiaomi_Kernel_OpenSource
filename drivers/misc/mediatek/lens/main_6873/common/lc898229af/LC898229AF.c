...
/*
 * LC898229AF voice coil motor driver
 *
 *
 */
...
/* ////////////////////////////////////////////////////////////// */
long LC898229AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int LC898229AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int LC898229AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int LC898229AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int LC898229AF_GetFileName(unsigned char *pFileName)
{
