...
#define DW9761BAFIOC_T_MOVETO _IOW(DW9761BAF_MAGIC, 1, u32)

#define DW9761BAFIOC_T_SETINFPOS _IOW(DW9761BAF_MAGIC, 2, u32)

#define DW9761BAFIOC_T_SETMACROPOS _IOW(DW9761BAF_MAGIC, 3, u32)
#ifdef LensdrvCM3
