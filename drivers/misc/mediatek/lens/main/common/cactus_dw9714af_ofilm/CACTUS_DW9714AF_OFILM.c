...
/*
 * CACTUS_DW9714AF_OFILM voice coil motor driver vendor V2
 *
 *
 */
...
#define AF_DRVNAME "CACTUS_DW9714AF_OFILM_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long CACTUS_DW9714AF_OFILM_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int CACTUS_DW9714AF_OFILM_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int CACTUS_DW9714AF_OFILM_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int CACTUS_DW9714AF_OFILM_GetFileName(unsigned char *pFileName)
{
