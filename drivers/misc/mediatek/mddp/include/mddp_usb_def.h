...
typedef int32_t (*drv_cbf_usb_event_t)(
	uint32_t msg_id, void *data, uint16_t data_len);

struct mddpu_drv_handle_t {
	/* MDDPU invokes these APIs provided by driver. */
	drv_cbf_usb_event_t             usb_event;

	/* Driver invokes these APIs provided by MDDPU. */
};
