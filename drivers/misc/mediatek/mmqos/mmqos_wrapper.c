...
static struct wrapper_data wrapper_data_mt6855 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
static struct wrapper_data wrapper_data_mt6789 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
...
static struct wrapper_data wrapper_data_mt6761 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
...
static const struct of_device_id of_mmqos_wrapper_match_tbl[] = {
	...
	},
	{
		...
		.data = &wrapper_data_mt6855,
	},
	{
		.compatible = "mediatek,mt6789-mmqos-wrapper",
		.data = &wrapper_data_mt6789,
	},
	{
