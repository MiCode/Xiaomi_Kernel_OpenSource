...
static int pmic_lp_golden_set(
	unsigned int en_adr, unsigned char op_en, unsigned char op_cfg)
{
...
static int pmic_lp_type_set(
	unsigned short en_cfg_adr, enum PMU_LP_TABLE_ENUM name,
...
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VPROC11_OP_EN, VPROC11, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VPROC12_OP_EN, VPROC12, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VCORE_OP_EN, VCORE, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VGPU_OP_EN, VGPU, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VDRAM1_OP_EN, VDRAM1, user, op_en, op_cfg);
}

int pmic_buck_vdram2_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VDRAM2_OP_EN, VDRAM2, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VMODEM_OP_EN, VMODEM, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VS1_OP_EN, VS1, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_BUCK_VS2_OP_EN, VS2, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VSRAM_PROC_OP_EN, VSRAM_PROC, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VSRAM_GPU_OP_EN, VSRAM_GPU, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VSRAM_MD_OP_EN, VSRAM_MD, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VSRAM_CORE_OP_EN, VSRAM_CORE, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VFE28_OP_EN, VFE28, user, op_en, op_cfg);
}

int pmic_ldo_vtcxo24_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VTCXO24_OP_EN, VTCXO24, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VXO22_OP_EN, VXO22, user, op_en, op_cfg);
}

int pmic_ldo_vxo18_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VXO18_OP_EN, VXO18, user, op_en, op_cfg);
}

int pmic_ldo_vrf18_1_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VRF18_1_OP_EN, VRF18_1, user, op_en, op_cfg);
}

int pmic_ldo_vrf18_2_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VRF18_2_OP_EN, VRF18_2, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VRF12_OP_EN, VRF12, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	...
	PMICLOG("%s\n", __func__);
	ret = pmic_lp_type_set(
		MT6355_LDO_VCN33_OP_EN, VCN33_0, user, op_en, op_cfg);
	if (ret)
		return ret;
	ret = pmic_lp_type_set(
		MT6355_LDO_VCN33_OP_EN, VCN33_1, user, op_en, op_cfg);
	return ret;
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VCN28_OP_EN, VCN28, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VCN18_OP_EN, VCN18, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VCAMA1_OP_EN, VCAMA1, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VCAMA2_OP_EN, VCAMA2, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VCAMIO_OP_EN, VCAMIO, user, op_en, op_cfg);
}

int pmic_ldo_vcamd1_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VCAMD1_OP_EN, VCAMD1, user, op_en, op_cfg);
}

int pmic_ldo_vcamd2_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VCAMD2_OP_EN, VCAMD2, user, op_en, op_cfg);
}

int pmic_ldo_va10_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VA10_OP_EN, VA10, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VA12_OP_EN, VA12, user, op_en, op_cfg);
}

int pmic_ldo_va18_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VA18_OP_EN, VA18, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VSIM1_OP_EN, VSIM1, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VSIM2_OP_EN, VSIM2, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	...
	PMICLOG("%s\n", __func__);
	ret = pmic_lp_type_set(
		MT6355_LDO_VLDO28_OP_EN, VLDO28_0, user, op_en, op_cfg);
	if (ret)
		return ret;
	ret = pmic_lp_type_set(
		MT6355_LDO_VLDO28_OP_EN, VLDO28_1, user, op_en, op_cfg);
	return ret;
}

int pmic_ldo_vmipi_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VMIPI_OP_EN, VMIPI, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VIO28_OP_EN, VIO28, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VMCH_OP_EN, VMCH, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VEMC_OP_EN, VEMC, user, op_en, op_cfg);
}

int pmic_ldo_vufs18_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VUFS18_OP_EN, VUFS18, user, op_en, op_cfg);
}

int pmic_ldo_vusb33_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	int ret = 0;
	...
	PMICLOG("%s\n", __func__);
	ret = pmic_lp_type_set(
		MT6355_LDO_VUSB33_OP_EN, VUSB33_0, user, op_en, op_cfg);
	if (ret)
		return ret;
	ret = pmic_lp_type_set(
		MT6355_LDO_VUSB33_OP_EN, VUSB33_1, user, op_en, op_cfg);
	return ret;
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VBIF28_OP_EN, VBIF28, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VIO18_OP_EN, VIO18, user, op_en, op_cfg);
}
	...
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VGP_OP_EN, VGP, user, op_en, op_cfg);
}

int pmic_ldo_vgp2_lp(
	enum BUCK_LDO_EN_USER user, unsigned char op_en, unsigned char op_cfg)
{
	PMICLOG("%s\n", __func__);
	return pmic_lp_type_set(
		MT6355_LDO_VGP2_OP_EN, VGP2, user, op_en, op_cfg);
}
