...
int hw_charging_get_charger_type(void)
{
	...
	CHR_Type_num = get_hw_charging_type();

	if (CHR_Type_num == NONSTANDARD_CHARGER){
		msleep(300);
		pr_info("charger type is nonstandard,will detect again\n");
		CHR_Type_num = get_hw_charging_type();
