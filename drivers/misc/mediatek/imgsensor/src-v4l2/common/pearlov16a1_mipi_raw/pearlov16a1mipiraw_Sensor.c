 ...
 *============================================================================
 ****************************************************************************/
#define PFX "PEARLOV16A1_camera_sensor"
...
#include "pearlov16a1_ana_gain_table.h"
#include "pearlov16a1mipiraw_Sensor.h"
//#include "pearlov16a1_seamless_switch.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PEARLOV16A1_SENSOR_ID,
...
static kal_uint32 pearlov16a1_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	return ERROR_NONE;
}

static void pearlov16a1_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	OV16A1_LOG_INF("+\n");
	pearlov16a1_table_write_cmos_sensor(ctx, pearlov16a1_init_setting,
		sizeof(pearlov16a1_init_setting)/sizeof(kal_uint16));
...
{
	OV16A1_LOG_INF("+\n");
	pearlov16a1_table_write_cmos_sensor(ctx, pearlov16a1_preview_setting,
		sizeof(pearlov16a1_preview_setting) / sizeof(kal_uint16));
	OV16A1_LOG_INF("-\n");
} /* preview_setting */
...
{
	OV16A1_LOG_INF("+\n");
	pearlov16a1_table_write_cmos_sensor(ctx, pearlov16a1_hs_video_setting,
		sizeof(pearlov16a1_hs_video_setting)/sizeof(kal_uint16));
	OV16A1_LOG_INF("-\n");
}
...
{
	OV16A1_LOG_INF("+\n");
	pearlov16a1_table_write_cmos_sensor(ctx, pearlov16a1_custom1_setting,
		sizeof(pearlov16a1_custom1_setting)/sizeof(kal_uint16));
	OV16A1_LOG_INF("-\n");
}
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(pearlov16a1_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)pearlov16a1_ana_gain_table,
			sizeof(pearlov16a1_ana_gain_table));
		}
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		pearlov16a1_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry pearlov16a1_mipi_raw_entry = {
	.name = "pearlov16a1_mipi_raw",
	.id = PEARLOV16A1_SENSOR_ID,
	.pw_seq = pw_seq,
