 ...
 *============================================================================
 ****************************************************************************/
#define PFX "PLATOIMX596_camera_sensor"
...
#include "platoimx596_ana_gain_table.h"
#include "platoimx596mipiraw_Sensor.h"
//#include "platoimx596_seamless_switch.h"
#include "platoimx596_eeprom.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PLATOIMX596_SENSOR_ID,
...
static kal_uint32 platoimx596_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	return ERROR_NONE;
}

static void platoimx596_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	IMX596_LOG_DBG("+\n");
	platoimx596_table_write_cmos_sensor(ctx, platoimx596_init_setting,
		sizeof(platoimx596_init_setting)/sizeof(kal_uint16));
...
{
	IMX596_LOG_DBG("+\n");
	platoimx596_table_write_cmos_sensor(ctx, platoimx596_preview_setting,
		sizeof(platoimx596_preview_setting) / sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
} /* preview_setting */
...
{
	IMX596_LOG_DBG("+\n");
	platoimx596_table_write_cmos_sensor(ctx, platoimx596_normal_video_setting,
		sizeof(platoimx596_normal_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
...
{
	IMX596_LOG_DBG("+\n");
	platoimx596_table_write_cmos_sensor(ctx, platoimx596_hs_video_setting,
		sizeof(platoimx596_hs_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
...
{
	IMX596_LOG_DBG("+\n");
	platoimx596_table_write_cmos_sensor(ctx, platoimx596_custom1_setting,
		sizeof(platoimx596_custom1_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(platoimx596_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)platoimx596_ana_gain_table,
			sizeof(platoimx596_ana_gain_table));
		}
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		platoimx596_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry platoimx596_mipi_raw_entry = {
	.name = "platoimx596_mipi_raw",
	.id = PLATOIMX596_SENSOR_ID,
	.pw_seq = pw_seq,
