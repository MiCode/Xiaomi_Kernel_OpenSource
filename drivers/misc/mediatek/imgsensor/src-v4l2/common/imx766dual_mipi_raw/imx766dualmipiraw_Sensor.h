...
enum IMGSENSOR_MODE {
	...
	IMGSENSOR_MODE_CUSTOM16,
	IMGSENSOR_MODE_MAX = IMGSENSOR_MODE_CUSTOM16,
};
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom16;
	...
	kal_uint8 custom16_delay_frame; /* enter custom16 delay frame num */
