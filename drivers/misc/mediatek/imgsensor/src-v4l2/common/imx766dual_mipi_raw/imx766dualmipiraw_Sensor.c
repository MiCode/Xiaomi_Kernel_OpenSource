...
{
	LOG_INF("E\n");
	imx766dual_table_write_cmos_sensor_8(ctx, imx766dual_custom14_setting,
		sizeof(imx766dual_custom14_setting)/sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	if (otp_flag == OTP_QSC_NONE) {
		LOG_INF("OTP no QSC Data, close qsc register");
		write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
	LOG_INF("E\n");
	imx766dual_table_write_cmos_sensor_8(ctx, imx766dual_custom15_setting,
		sizeof(imx766dual_custom15_setting)/sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	if (otp_flag == OTP_QSC_NONE) {
		LOG_INF("OTP no QSC Data, close qsc register");
		write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
{
	LOG_INF("E\n");
	imx766dual_table_write_cmos_sensor_8(ctx, imx766dual_custom16_setting,
		sizeof(imx766dual_custom16_setting)/sizeof(kal_uint16));
	set_mirror_flip(ctx, ctx->mirror);
	if (otp_flag == OTP_QSC_NONE) {
		LOG_INF("OTP no QSC Data, close qsc register");
		write_cmos_sensor_8(ctx, 0x32D2, 0x00);
		...
		enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
	...
	case SENSOR_SCENARIO_ID_CUSTOM13:
	{
		...
		FMC_GPH_START;
		imx766dual_table_write_cmos_sensor_8(ctx, imx766dual_seamless_custom13,
				sizeof(imx766dual_seamless_custom13) / sizeof(kal_uint16));
	...
	case SENSOR_SCENARIO_ID_CUSTOM14:
	{
		...
		FMC_GPH_START;
		imx766dual_table_write_cmos_sensor_8(ctx, imx766dual_seamless_custom14,
				sizeof(imx766dual_seamless_custom14) / sizeof(kal_uint16));
	...
	case SENSOR_SCENARIO_ID_CUSTOM15:
	{
		...
		FMC_GPH_START;
		imx766dual_table_write_cmos_sensor_8(ctx, imx766dual_seamless_custom15,
				sizeof(imx766dual_seamless_custom15) / sizeof(kal_uint16));
	...
	case SENSOR_SCENARIO_ID_CUSTOM16:
	{
		...
		FMC_GPH_START;
		imx766dual_table_write_cmos_sensor_8(ctx, imx766dual_seamless_custom16,
