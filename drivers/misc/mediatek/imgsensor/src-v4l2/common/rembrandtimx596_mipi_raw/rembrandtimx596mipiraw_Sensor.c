 ...
 *============================================================================
 ****************************************************************************/
#define PFX "REMBRANDTIMX596_camera_sensor"
...
#include "rembrandtimx596_ana_gain_table.h"
#include "rembrandtimx596mipiraw_Sensor.h"
//#include "rembrandtimx596_seamless_switch.h"
#include "rembrandtimx596_eeprom.h"
...
//#define rembrandtimx596_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#define rembrandtimx596_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[rembrandtimx596]"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = REMBRANDTIMX596_SENSOR_ID,
...
static kal_uint32 rembrandtimx596_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	return ERROR_NONE;
}

static void rembrandtimx596_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	IMX596_LOG_INF("+\n");
	rembrandtimx596_table_write_cmos_sensor(ctx, rembrandtimx596_init_setting,
		sizeof(rembrandtimx596_init_setting)/sizeof(kal_uint16));
...
{
	IMX596_LOG_INF("+\n");
	rembrandtimx596_table_write_cmos_sensor(ctx, rembrandtimx596_preview_setting,
		sizeof(rembrandtimx596_preview_setting) / sizeof(kal_uint16));
	IMX596_LOG_INF("-\n");
} /* preview_setting */
...
{
	IMX596_LOG_INF("+\n");
	rembrandtimx596_table_write_cmos_sensor(ctx, rembrandtimx596_normal_video_setting,
		sizeof(rembrandtimx596_normal_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_INF("-\n");
}
...
{
	IMX596_LOG_INF("+\n");
	rembrandtimx596_table_write_cmos_sensor(ctx, rembrandtimx596_hs_video_setting,
		sizeof(rembrandtimx596_hs_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_INF("-\n");
}
...
{
	IMX596_LOG_INF("+\n");
	rembrandtimx596_table_write_cmos_sensor(ctx, rembrandtimx596_custom1_setting,
		sizeof(rembrandtimx596_custom1_setting)/sizeof(kal_uint16));
	IMX596_LOG_INF("-\n");
}
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(rembrandtimx596_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)rembrandtimx596_ana_gain_table,
			sizeof(rembrandtimx596_ana_gain_table));
		}
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		rembrandtimx596_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry rembrandtimx596_mipi_raw_entry = {
	.name = "rembrandtimx596_mipi_raw",
	.id = REMBRANDTIMX596_SENSOR_ID,
	.pw_seq = pw_seq,
