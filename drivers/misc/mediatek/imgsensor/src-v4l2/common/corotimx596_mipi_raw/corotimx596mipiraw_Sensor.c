 ...
 *============================================================================
 ****************************************************************************/
#define PFX "COROTIMX596_camera_sensor"
...
#include "corotimx596_ana_gain_table.h"
#include "corotimx596mipiraw_Sensor.h"
//#include "corotimx596_seamless_switch.h"
...
//#define corotimx596_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#define corotimx596_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[corotimx596]"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = COROTIMX596_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
	{ 5184, 3904,    0,     8,  5184, 3888,  2592, 1944,    0,    0,    2592, 1944,    0,    0,  2592, 1944}, // Preview
	{ 5184, 3904,    0,     8,  5184, 3888,  2592, 1944,    0,    0,    2592, 1944,    0,    0,  2592, 1944}, // capture
	{ 5184, 3904,    0,   488,  5184, 2928,  2592, 1464,    0,    0,    2592, 1464,    0,    0,  2592, 1464}, // video
	{ 5184, 3904,  672,   872,  3840, 2160,  1920, 1080,    0,    0,    1920, 1080,    0,    0,  1920, 1080}, // high speed video 120ps
	{ 5184, 3904,    0,     8,  5184, 3888,  2592, 1944,    0,    0,    2592, 1944,    0,    0,  2592, 1944}, // slim video same as preview
	{ 5184, 3904,    0,   488,  5184, 2928,  2592, 1464,    0,    0,    2592, 1464,    0,    0,  2592, 1464}, // custom1 stere0 as Preview 
};
...
static kal_uint32 corotimx596_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	return ERROR_NONE;
}

static void corotimx596_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	IMX596_LOG_DBG("+\n");
	corotimx596_table_write_cmos_sensor(ctx, corotimx596_init_setting,
		sizeof(corotimx596_init_setting)/sizeof(kal_uint16));
...
{
	IMX596_LOG_DBG("+\n");
	corotimx596_table_write_cmos_sensor(ctx, corotimx596_preview_setting,
		sizeof(corotimx596_preview_setting) / sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
} /* preview_setting */
...
{
	IMX596_LOG_DBG("+\n");
	corotimx596_table_write_cmos_sensor(ctx, corotimx596_normal_video_setting,
		sizeof(corotimx596_normal_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
...
{
	IMX596_LOG_DBG("+\n");
	corotimx596_table_write_cmos_sensor(ctx, corotimx596_hs_video_setting,
		sizeof(corotimx596_hs_video_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
...
{
	IMX596_LOG_DBG("+\n");
	corotimx596_table_write_cmos_sensor(ctx, corotimx596_custom1_setting,
		sizeof(corotimx596_custom1_setting)/sizeof(kal_uint16));
	IMX596_LOG_DBG("-\n");
}
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(corotimx596_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)corotimx596_ana_gain_table,
			sizeof(corotimx596_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		 *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 714000;
		 break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		corotimx596_set_lsc_reg_setting(ctx, index, feature_data_16,
	...
	struct mtk_csi_param *csi_param)
{
	...
	case SENSOR_SCENARIO_ID_HIGHSPEED_VIDEO:
	case SENSOR_SCENARIO_ID_CUSTOM1:
		csi_param->dphy_clk_settle = 0x0C;
		csi_param->dphy_data_settle = 0x0C;
		csi_param->dphy_trail = 29;
		break;
	default:
		csi_param->dphy_clk_settle = 0x04;
		csi_param->dphy_data_settle = 0x04;
		csi_param->dphy_trail = 29;
		break;
	}
	return 0;
...
const struct subdrv_entry corotimx596_mipi_raw_entry = {
	.name = "corotimx596_mipi_raw",
	.id = COROTIMX596_SENSOR_ID,
	.pw_seq = pw_seq,
