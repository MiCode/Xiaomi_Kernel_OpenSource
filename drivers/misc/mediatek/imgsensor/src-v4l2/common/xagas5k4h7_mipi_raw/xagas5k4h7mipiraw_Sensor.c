 ...
 *============================================================================
 ****************************************************************************/
#define PFX "XAGAS5K4H7_camera_sensor"
...
#include "xagas5k4h7_ana_gain_table.h"
#include "xagas5k4h7mipiraw_Sensor.h"
...
#define xagas5k4h7_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[xagas5k4h7]"
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{ 3264, 2448, 402, 302, 2460, 1844, 2460, 1844, 0000, 0000, 2460, 1844, 0, 0, 2460, 1844}, // custom1
...
static void set_frame_length(struct subdrv_ctx *ctx, kal_uint16 frame_length)
{
	...
	S5K4H7_LOG_DBG("Framelength: set=%d/input=%d/min=%d, auto_extend=%d\n",
...
static kal_uint16 set_gain(struct subdrv_ctx *ctx, kal_uint16 gain)
{
	...
	ctx->gain = reg_gain;
	S5K4H7_LOG_DBG("gain = %d, reg_gain = 0x%x, max_gain:0x%x\n ",
...
static kal_uint32 xagas5k4h7_awb_gain(struct subdrv_ctx *ctx,
...
static void xagas5k4h7_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	xagas5k4h7_table_write_cmos_sensor(ctx, xagas5k4h7_init_setting,
		sizeof(xagas5k4h7_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	xagas5k4h7_table_write_cmos_sensor(ctx, xagas5k4h7_preview_setting,
			sizeof(xagas5k4h7_preview_setting) / sizeof(kal_uint16));
...
{
	S5K4H7_LOG_INF("+\n");
	xagas5k4h7_table_write_cmos_sensor(ctx, xagas5k4h7_normal_video_setting,
		sizeof(xagas5k4h7_normal_video_setting)/sizeof(kal_uint16));
	S5K4H7_LOG_INF("-\n");
}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	...
	xagas5k4h7_table_write_cmos_sensor(ctx, xagas5k4h7_custom1_setting,
			sizeof(xagas5k4h7_custom1_setting) / sizeof(kal_uint16));
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	xagas5k4h7_table_write_cmos_sensor(ctx, xagas5k4h7_custom2_setting,
			sizeof(xagas5k4h7_custom2_setting) / sizeof(kal_uint16));
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	case SENSOR_SCENARIO_ID_CUSTOM2:
		...
		break;
	default:
		S5K4H7_LOG_DBG("Error ScenarioId setting");
		preview(ctx, image_window, sensor_config_data);
		...
		enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
	...
	default:  /*coding with  preview scenario by default*/
		...
		if (ctx->frame_length > ctx->shutter)
			set_dummy(ctx);
		S5K4H7_LOG_DBG("error scenario_id = %d, we use preview scenario\n",
			scenario_id);
		break;
	}
	return ERROR_NONE;
...
static kal_uint32 get_sensor_temperature(struct subdrv_ctx *ctx)
{
	...
	S5K4H7_LOG_DBG("temp_c(%d), read_reg(%d)\n", temperature_convert, temperature);
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OUTPUT_FORMAT_BY_SCENARIO:
		...
		S5K4H7_LOG_DBG("SENSOR_FEATURE_GET_OUTPUT_FORMAT_BY_SCENARIO get:%d\n", *(feature_data + 1));
	break;
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(xagas5k4h7_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)xagas5k4h7_ana_gain_table,
			sizeof(xagas5k4h7_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		S5K4H7_LOG_DBG("SENSOR_FEATURE_GET_PDAF_DATA\n");
		break;
	...
	case SENSOR_FEATURE_SET_FRAMERATE:
		S5K4H7_LOG_DBG("current fps :%d\n", (UINT32)*feature_data_32);
		ctx->current_fps = *feature_data_32;
		break;
	case SENSOR_FEATURE_SET_HDR:
		S5K4H7_LOG_DBG("ihdr enable :%d\n", (BOOL)*feature_data_32);
	...
	case SENSOR_FEATURE_SET_IHDR_SHUTTER_GAIN:
		S5K4H7_LOG_DBG("SENSOR_SET_SENSOR_IHDR LE=%d, SE=%d, Gain=%d\n",
			(UINT16)*feature_data,
	...
	case SENSOR_FEATURE_SET_HDR_SHUTTER:
		S5K4H7_LOG_DBG("SENSOR_FEATURE_SET_HDR_SHUTTER LE=%d, SE=%d\n",
			(UINT16)*feature_data, (UINT16)*(feature_data+1));
		break;
	case SENSOR_FEATURE_SET_STREAMING_SUSPEND:
		S5K4H7_LOG_DBG("SENSOR_FEATURE_SET_STREAMING_SUSPEND\n");
		streaming_control(ctx, KAL_FALSE);
		break;
	case SENSOR_FEATURE_SET_STREAMING_RESUME:
		S5K4H7_LOG_DBG("SENSOR_FEATURE_SET_STREAMING_RESUME, shutter:%llu\n",
			*feature_data);
		if (*feature_data != 0)
			set_shutter(ctx, *feature_data);
	...
	case SENSOR_FEATURE_GET_BINNING_TYPE:
		...
		S5K4H7_LOG_DBG("SENSOR_FEATURE_GET_BINNING_TYPE AE_binning_type:%d,\n",
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		xagas5k4h7_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry xagas5k4h7_mipi_raw_entry = {
	.name = "xagas5k4h7_mipi_raw",
	.id = XAGAS5K4H7_SENSOR_ID,
	.pw_seq = pw_seq,
