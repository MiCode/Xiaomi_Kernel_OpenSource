#define PFX "COROTIMX707_camera_sensor"
...
#include "corotimx707_ana_gain_table.h"
#include "corotimx707mipiraw_Sensor.h"
...
#define corotimx707_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define corotimx707_burst_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8_burst(__VA_ARGS__)
#define LOG_TAG "[corotimx707]"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = { /* preview reb_B Tline = 4710ns */
		.pclk = 2870400000,
		.linelength = 13536,
		.framelength = 7068,
		.startx = 0,
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[] = {
	{/* preview */
		...
		0x00, 0x30, 4096, 768,  0x00, 0x00, 0x0000, 0x0000
	},
	{/* normal video */
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 4096, 2304, 0x00, 0x00, 0x0000, 0x0000,
		0x00, 0x30, 4096, 576,  0x00, 0x00, 0x0000, 0x0000
	},
	{/* cust2 */
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 2048, 1152, 0x00, 0x00, 0x0000, 0x0000,
		0x00, 0x30, 2048, 288,  0x00, 0x00, 0x0000, 0x0000
	},
	{/* cust3 */
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 4096, 2304, 0x00, 0x00, 0x0000, 0x0000,
	...
	{/* cust8 cust12*/
		...
		0x00, 0x30, 2880, 540,  0x00, 0x00, 0x0000, 0x0000
	},
	{/* cust10 */
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 7680, 4320, 0x00, 0x00, 0x0000, 0x0000,
		0x00, 0x30, 7680, 1080, 0x00, 0x00, 0x0000, 0x0000
	},
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info[] = {
	{
		...
		.i4Crop = {
			...
			{0, 0}, {0,  384}, {608, 456}, {0,0}, {256,912}, {0,0}, {608, 456}
		},
...
static kal_uint16 corotimx707_QSC_setting[2304 * 2];
//static kal_uint16 corotimx707_LRC_setting[384 * 2];


static void corotimx707_get_pdaf_reg_setting(struct subdrv_ctx *ctx, MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void corotimx707_set_pdaf_reg_setting(struct subdrv_ctx *ctx,
...
static void write_sensor_QSC(struct subdrv_ctx *ctx)
{
	...
	corotimx707_burst_write_cmos_sensor(ctx, corotimx707_QSC_setting,
		sizeof(corotimx707_QSC_setting) / sizeof(kal_uint16));
...
static void write_sensor_LRC(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_LRC_setting,
		sizeof(corotimx707_LRC_setting) / sizeof(kal_uint16));
...
//	kal_uint16 eeprom_lrc_1 = 0x7B10, sensor_lrc_1 = 0x7C00;
	...
	if(read_cmos_eeprom_8(ctx,0x000C ) == 0x63){//eeprom sensor id
		for (idx = 0; idx < 2304; idx++) {
			corotimx707_QSC_setting[2 * idx]	 = sensor_qsc + idx;
			corotimx707_QSC_setting[2 * idx + 1] = read_cmos_eeprom_8(ctx, eeprom_qsc + idx);
		}
	...
	for (idx = 0; idx < 192; idx++) {
		corotimx707_LRC_setting[2 * idx]               = sensor_lrc_0 + idx;
		corotimx707_LRC_setting[2 * idx + 1]           = read_cmos_eeprom_8(ctx, eeprom_lrc_0 + idx);
		corotimx707_LRC_setting[2 * idx + 192 * 2]     = sensor_lrc_1 + idx;
		corotimx707_LRC_setting[2 * idx + 1 + 192 * 2] = read_cmos_eeprom_8(ctx, eeprom_lrc_1 + idx);
	}
#endif
	ctx->is_read_preload_eeprom = 1;
...
static u16 dgain2reg(struct subdrv_ctx *ctx, u32 dgain)
{
	...
	IMX707_LOG_INF("dgain(%d) dgain_reg = 0x%x\n", dgain, ret);
...
static kal_uint32 set_gain(struct subdrv_ctx *ctx, kal_uint32 gain, bool hold_en)
{
	...
	IMX707_LOG_INF("cur_ana_gain = %d, ana_reg_gain = 0x%x, max_ana_gain:%d\n ",
		cur_ana_gain, ana_reg_gain, max_ana_gain);

	dig_reg_gain = dgain2reg(ctx, cur_dig_gain);
	IMX707_LOG_INF("cur_dig_gain = %d, dig_reg_gain = 0x%x, max_dig_gain:%d\n ",
...
static void set_multi_dig_gain(struct subdrv_ctx *ctx, u32 *gains, u16 exp_cnt)
{
	...
	IMX707_LOG_INF("ae_ctrl_gph_en(%d) dgain reg[lg/mg/sg]: 0x%x 0x%x 0x%x\n",
		ctx->ae_ctrl_gph_en, reg_dig_lg, reg_dig_mg, reg_dig_sg);
}


static kal_uint16 corotimx707_feedback_awbgain[] = {
	0x0b8e, 0x00,
	0x0b8f, 0x00,
	0x0b90, 0x00,
	0x0b91, 0x00,
...
static kal_uint32 corotimx707_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	...
	corotimx707_feedback_awbgain[1] = (gr_gain_int & 0xFF00) >> 8;
	corotimx707_feedback_awbgain[3] = gr_gain_int & 0xFF;
	corotimx707_feedback_awbgain[5] = (r_gain_int & 0xFF00) >> 8;
	corotimx707_feedback_awbgain[7] = r_gain_int & 0xFF;
	corotimx707_feedback_awbgain[9] = (b_gain_int & 0xFF00) >> 8;
	corotimx707_feedback_awbgain[11] = b_gain_int & 0xFF;
	corotimx707_feedback_awbgain[13] = (gb_gain_int & 0xFF00) >> 8;
	corotimx707_feedback_awbgain[15] = gb_gain_int & 0xFF;

	corotimx707_table_write_cmos_sensor(ctx, corotimx707_feedback_awbgain,
		sizeof(corotimx707_feedback_awbgain)/sizeof(kal_uint16));

	return ERROR_NONE;
}

static void corotimx707_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_init_setting,
		sizeof(corotimx707_init_setting)/sizeof(kal_uint16));

	corotimx707_table_write_cmos_sensor(ctx, corotimx707_Image_quality_setting,
                sizeof(corotimx707_Image_quality_setting)/sizeof(kal_uint16));
...
{
	IMX707_LOG_INF("%s +\n", __func__);
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_preview_setting,
		sizeof(corotimx707_preview_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_normal_video_setting,
		sizeof(corotimx707_normal_video_setting)/sizeof(kal_uint16));
...
static void hs_video_setting(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_hs_video_setting,
		sizeof(corotimx707_hs_video_setting)/sizeof(kal_uint16));
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_custom1_setting,
		sizeof(corotimx707_custom1_setting)/sizeof(kal_uint16));
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_custom2_setting,
		sizeof(corotimx707_custom2_setting)/sizeof(kal_uint16));
...
static void custom3_setting(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_custom3_setting,
		sizeof(corotimx707_custom3_setting)/sizeof(kal_uint16));
...
static void custom4_setting(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_custom4_setting,
		sizeof(corotimx707_custom4_setting)/sizeof(kal_uint16));
...
static void custom5_setting(struct subdrv_ctx *ctx)
{
	...
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_custom5_setting,
		sizeof(corotimx707_custom5_setting)/sizeof(kal_uint16));
...
{
	IMX707_LOG_INF("+\n");
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_custom8_setting,
		sizeof(corotimx707_custom8_setting)/sizeof(kal_uint16));
	IMX707_LOG_INF("-\n");
}
...
{
	IMX707_LOG_INF("+\n");
	corotimx707_table_write_cmos_sensor(ctx, corotimx707_custom10_setting,
		sizeof(corotimx707_custom10_setting)/sizeof(kal_uint16));
	IMX707_LOG_INF("-\n");
}
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (last_sensor_awb.ABS_GAIN_GR != 0 &&
		...
		corotimx707_awb_gain(ctx, &last_sensor_awb);
	}
	return ERROR_NONE;
}	/* custom4 */
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(corotimx707_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)corotimx707_ana_gain_table,
			sizeof(corotimx707_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		IMX707_LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		corotimx707_get_pdaf_reg_setting(ctx,
				(*feature_para_len) / sizeof(UINT32),
				feature_data_16);
		break;
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		 *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 482666;
		 break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		IMX707_LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		corotimx707_set_pdaf_reg_setting(ctx,
				(*feature_para_len) / sizeof(UINT32),
				feature_data_16);
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		corotimx707_set_lsc_reg_setting(ctx, index, feature_data_16,
	...
	case SENSOR_FEATURE_SEAMLESS_SWITCH:
		...
		if (pSetSensorAWB != NULL) {
			corotimx707_awb_gain(ctx, pSetSensorAWB);
...
const struct subdrv_entry corotimx707_mipi_raw_entry = {
	.name       = "corotimx707_mipi_raw",
	.id         = COROTIMX707_SENSOR_ID,
	.pw_seq     = pw_seq,
