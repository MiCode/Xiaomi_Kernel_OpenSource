#define PFX "DAUMIERIMX707_camera_sensor"
...
#include "daumierimx707_ana_gain_table.h"
#include "daumierimx707mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = DAUMIERIMX707_SENSOR_ID,
	...
	.gain_step        = 1,
	.gain_type        = 0,
	.max_frame_length = 0x74E1E0,    //7660000
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	...
	{8192, 6144, 0,    0,    8192, 6144, 2048, 1536, 64, 228, 1920, 1080,  0,  0, 1920, 1080}, /* hs_video */
	...
	{8192, 6144, 0,    0,    8192, 6144, 2048, 1536, 64, 228, 1920, 1080,  0,  0, 1920, 1080}, /* custom2 */
	...
	{8192, 6144, 0,    0,    8192, 6144, 4096, 3072, 512,0,   3072, 3072,  0,  0, 3072, 3072}, /* custom8 */
	{8192, 6144, 256,  912,  7680, 4320, 7680, 4320, 0,  0,   7680, 4320,  0,  0, 7680, 4320}, /* custom9 */
	{8192, 6144, 0,    0,    8192, 6144, 4096, 3072, 128,456, 3840, 2160,  0,  0, 3840, 2160}, /* custom10 */
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[] = {
	...
	{/* cust2 */
		...
		0x01, 0x2b, 1920, 270,  0x00, 0x00, 0x0000, 0x0000
	},
	{/* cust3 */
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 4096, 2304, 0x00, 0x00, 0x0000, 0x0000,
	...
	{/* cust8 */
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 3072, 3072, 0x00, 0x00, 0x0000, 0x0000,
		0x01, 0x2b, 3072, 768,  0x00, 0x00, 0x0000, 0x0000
	},
	{/* cust9 */
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	...
	{/* cust10 */
		...
		0x01, 0x2b, 3840, 540,  0x00, 0x00, 0x0000, 0x0000
	},
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4Crop = {
		...
		{0, 0}, {0,  384}, {512, 0}, {256,912}
	},
	.iMirrorFlip = IMAGE_HV_MIRROR,
};

static kal_uint16 daumierimx707_QSC_setting[2304 * 2];
//static kal_uint16 daumierimx707_LRC_setting[384 * 2];


static void daumierimx707_get_pdaf_reg_setting(struct subdrv_ctx *ctx, MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void daumierimx707_set_pdaf_reg_setting(struct subdrv_ctx *ctx,
...
static void write_sensor_QSC(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_burst_write_cmos_sensor(ctx, daumierimx707_QSC_setting,
		sizeof(daumierimx707_QSC_setting) / sizeof(kal_uint16));
...
static void write_sensor_LRC(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_LRC_setting,
		sizeof(daumierimx707_LRC_setting) / sizeof(kal_uint16));
...
//	kal_uint16 eeprom_lrc_1 = 0x7B10, sensor_lrc_1 = 0x7C00;
	...
	for (idx = 0; idx < 2304; idx++) {
		daumierimx707_QSC_setting[2 * idx]     = sensor_qsc + idx;
		daumierimx707_QSC_setting[2 * idx + 1] = read_cmos_eeprom_8(ctx, eeprom_qsc + idx);
	}
#if 0
	for (idx = 0; idx < 192; idx++) {
		daumierimx707_LRC_setting[2 * idx]               = sensor_lrc_0 + idx;
		daumierimx707_LRC_setting[2 * idx + 1]           = read_cmos_eeprom_8(ctx, eeprom_lrc_0 + idx);
		daumierimx707_LRC_setting[2 * idx + 192 * 2]     = sensor_lrc_1 + idx;
		daumierimx707_LRC_setting[2 * idx + 1 + 192 * 2] = read_cmos_eeprom_8(ctx, eeprom_lrc_1 + idx);
	}
#endif
...
{
	IMX707_LOG_DBG("dummyline = %d, dummypixels = %d\n",
...
static void write_shutter(struct subdrv_ctx *ctx, kal_uint32 shutter)
{
	...
	IMX707_LOG_DBG("shutter =%d, framelength =%d\n",
...
static kal_uint32 set_gain(struct subdrv_ctx *ctx, kal_uint32 gain)
{
	...
	ctx->gain = reg_gain;
	IMX707_LOG_DBG("gain = %d, reg_gain = 0x%x, max_gain:%d\n ",
...
static kal_uint16 daumierimx707_feedback_awbgain[] = {
	0x0b8e, 0x00,
	0x0b8f, 0x00,
	0x0b90, 0x00,
	0x0b91, 0x00,
...
static kal_uint32 daumierimx707_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	...
	daumierimx707_feedback_awbgain[1] = (gr_gain_int & 0xFF00) >> 8;
	daumierimx707_feedback_awbgain[3] = gr_gain_int & 0xFF;
	daumierimx707_feedback_awbgain[5] = (r_gain_int & 0xFF00) >> 8;
	daumierimx707_feedback_awbgain[7] = r_gain_int & 0xFF;
	daumierimx707_feedback_awbgain[9] = (b_gain_int & 0xFF00) >> 8;
	daumierimx707_feedback_awbgain[11] = b_gain_int & 0xFF;
	daumierimx707_feedback_awbgain[13] = (gb_gain_int & 0xFF00) >> 8;
	daumierimx707_feedback_awbgain[15] = gb_gain_int & 0xFF;

	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_feedback_awbgain,
		sizeof(daumierimx707_feedback_awbgain)/sizeof(kal_uint16));

	return ERROR_NONE;
}

static void daumierimx707_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static kal_uint32 streaming_control(struct subdrv_ctx *ctx, kal_bool enable)
{
	...
	if (enable) {
		if (read_cmos_sensor_8(ctx, 0x0350) != 0x01) {
			IMX707_LOG_INF("single cam scenario enable auto-extend");
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_init_setting,
		sizeof(daumierimx707_init_setting)/sizeof(kal_uint16));

	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_Image_quality_setting,
                sizeof(daumierimx707_Image_quality_setting)/sizeof(kal_uint16));
...
{
	IMX707_LOG_INF("%s +\n", __func__);
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_preview_setting,
		sizeof(daumierimx707_preview_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_normal_video_setting,
		sizeof(daumierimx707_normal_video_setting)/sizeof(kal_uint16));
...
static void hs_video_setting(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_hs_video_setting,
		sizeof(daumierimx707_hs_video_setting)/sizeof(kal_uint16));
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_custom2_setting,
		sizeof(daumierimx707_custom2_setting)/sizeof(kal_uint16));
...
static void custom3_setting(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_custom3_setting,
		sizeof(daumierimx707_custom3_setting)/sizeof(kal_uint16));
...
static void custom4_setting(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_custom4_setting,
		sizeof(daumierimx707_custom4_setting)/sizeof(kal_uint16));
...
static void custom5_setting(struct subdrv_ctx *ctx)
{
	...
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_custom5_setting,
		sizeof(daumierimx707_custom5_setting)/sizeof(kal_uint16));
...
{
	IMX707_LOG_INF("+\n");
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_custom8_setting,
		sizeof(daumierimx707_custom8_setting)/sizeof(kal_uint16));
	IMX707_LOG_INF("-\n");
}
...
{
	IMX707_LOG_INF("+\n");
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_custom9_setting,
		sizeof(daumierimx707_custom9_setting)/sizeof(kal_uint16));
	IMX707_LOG_INF("-\n");
}
...
{
	IMX707_LOG_INF("+\n");
	daumierimx707_table_write_cmos_sensor(ctx, daumierimx707_custom10_setting,
		sizeof(daumierimx707_custom10_setting)/sizeof(kal_uint16));
	IMX707_LOG_INF("-\n");
}
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (last_sensor_awb.ABS_GAIN_GR != 0 &&
		...
		daumierimx707_awb_gain(ctx, &last_sensor_awb);
	}
	return ERROR_NONE;
}	/* custom4 */
		...
		kal_bool enable, UINT16 framerate)
{
	if (enable) /*enable auto flicker*/ {
		...
		IMX707_LOG_DBG("enable! fps = %d", framerate);
	} else {
		 /*Cancel Auto flick*/
		ctx->autoflicker_en = KAL_FALSE;
	}
		...
		enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
	...
	IMX707_LOG_DBG("scenario_id = %d, framerate = %d\n", scenario_id, framerate);
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(daumierimx707_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)daumierimx707_ana_gain_table,
			sizeof(daumierimx707_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		IMX707_LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		daumierimx707_get_pdaf_reg_setting(ctx,
	...
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		IMX707_LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		daumierimx707_set_pdaf_reg_setting(ctx,
				(*feature_para_len) / sizeof(UINT32),
				feature_data_16);
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		daumierimx707_set_lsc_reg_setting(ctx, index, feature_data_16,
	...
	case SENSOR_FEATURE_SEAMLESS_SWITCH:
		...
		if (pSetSensorAWB != NULL) {
			daumierimx707_awb_gain(ctx, pSetSensorAWB);
...
static struct subdrv_pw_seq_entry pw_seq[] = {
	...
	{HW_ID_AVDD2, 3100000, 1}, // OIS
	{HW_ID_AVDD1, 1200000, 1}, // VCAM_LDO
	{HW_ID_AVDD,  1,       1}, // AVDD 2.9&1.8 gpio en
	{HW_ID_DVDD,  1,       1},
...
const struct subdrv_entry daumierimx707_mipi_raw_entry = {
	.name       = "daumierimx707_mipi_raw",
	.id         = DAUMIERIMX707_SENSOR_ID,
	.pw_seq     = pw_seq,
