 ...
 *============================================================================
 ****************************************************************************/
#define PFX "REMBRANDTGC02M1_camera_sensor"
...
#include "rembrandtgc02m1_ana_gain_table.h"
#include "rembrandtgc02m1mipiraw_Sensor.h"
...
#define rembrandtgc02m1_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8_u8(__VA_ARGS__)
#define LOG_TAG "[rembrandtgc02m1]"
...
static kal_uint32 rembrandtgc02m1_awb_gain(struct subdrv_ctx *ctx,
...
static void rembrandtgc02m1_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    // Global
	rembrandtgc02m1_table_write_cmos_sensor(ctx, rembrandtgc02m1_init_setting,
		sizeof(rembrandtgc02m1_init_setting) / sizeof(kal_uint16));
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(rembrandtgc02m1_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)rembrandtgc02m1_ana_gain_table,
			sizeof(rembrandtgc02m1_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		rembrandtgc02m1_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry rembrandtgc02m1_mipi_raw_entry = {
	.name = "rembrandtgc02m1_mipi_raw",
	.id = REMBRANDTGC02M1_SENSOR_ID,
	.pw_seq = pw_seq,
