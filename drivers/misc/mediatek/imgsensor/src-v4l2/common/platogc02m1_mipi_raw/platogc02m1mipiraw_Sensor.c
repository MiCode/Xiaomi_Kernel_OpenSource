 ...
 *============================================================================
 ****************************************************************************/
#define PFX "PLATOGC02M1_camera_sensor"
...
#include "platogc02m1_ana_gain_table.h"
#include "platogc02m1mipiraw_Sensor.h"
...
#define platogc02m1_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8_u8(__VA_ARGS__)
#define LOG_TAG "[platogc02m1]"
...
static kal_uint32 platogc02m1_awb_gain(struct subdrv_ctx *ctx,
...
static void platogc02m1_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	GC02M1_LOG_INF("+\n");
	// Global
	platogc02m1_table_write_cmos_sensor(ctx, platogc02m1_init_setting,
		sizeof(platogc02m1_init_setting) / sizeof(kal_uint16));
	GC02M1_LOG_INF("-\n");
}	/*	  sensor_init  */
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(platogc02m1_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)platogc02m1_ana_gain_table,
			sizeof(platogc02m1_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		platogc02m1_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry platogc02m1_mipi_raw_entry = {
	.name = "platogc02m1_mipi_raw",
	.id = PLATOGC02M1_SENSOR_ID,
	.pw_seq = pw_seq,
