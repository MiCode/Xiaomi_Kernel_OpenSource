 ...
 *============================================================================
 ****************************************************************************/
#define PFX "HI1339SUBTXD_camera_sensor"
...
#include "hi1339subtxdmipiraw_Sensor.h"
...
#define EEPROM_VAL 0x000b
#define SENSOR_ID 0x1339

#define I2C_BUFFER_LEN 255 /* trans# max is 255, each 3 bytes */

#if USE_BURST_MODE
//static kal_uint16 hi1339subtxd_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len);
#define hi1339subtxd_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u16(__VA_ARGS__)
#endif
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 4240, 3152,   8,  14, 4224, 3124,	 4224, 3124,  8,  2, 4208, 3120, 0, 0, 4208, 3120},
		// preview (4208 x 3120)
	{ 4240, 3152,   8,  14, 4224, 3124,	 4224, 3124,  8,  2, 4208, 3120, 0, 0, 4208, 3120},
		// capture (4208 x 3120)
	{ 4240, 3152,   8,  14, 4224, 3124,	 4224, 3124,  8,  2, 4208, 3120, 0, 0, 4208, 3120},
		// normal video (4208 x 3120)
	{ 4240, 3152,   8, 490, 4224, 2172,	 1408,  724, 64,  2, 1280,  720, 0, 0, 1280,  720},
		// hs video (1280 x 720)
	{ 4240, 3152,   8, 492, 4224, 2168,	 2112, 1084, 96,  2, 1920, 1080, 0, 0, 1920, 1080},
		// slim video (1920 x 1080)
};
#if ENABLE_PDAF
...
#define I2C_BUFFER_LEN 255 /* trans# max is 255, each 3 bytes */
#if 0
static kal_uint16 hi1339subtxd_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 hi1339subtxd_init_setting[] = {
	0x0790, 0x0100,
	0x2000, 0x0000,
	0x2002, 0x0058,
	0x2006, 0x40B2,
...
static kal_uint16 hi1339subtxd_preview_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339subtxd_capture_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339subtxd_normal_video_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339subtxd_slim_video_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static kal_uint16 hi1339subtxd_hs_video_setting[] = {
0x2E38, 0x0040,
0x2E3A, 0x003E,
0x2E3C, 0x0042,
0x2E3E, 0x0046,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    hi1339subtxd_table_write_cmos_sensor(ctx,hi1339subtxd_init_setting,
		sizeof(hi1339subtxd_init_setting)/sizeof(kal_uint16));
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	hi1339subtxd_table_write_cmos_sensor(ctx,hi1339subtxd_preview_setting,
		sizeof(hi1339subtxd_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(struct subdrv_ctx *ctx,kal_uint16 currefps)
{
	...
	hi1339subtxd_table_write_cmos_sensor(ctx,hi1339subtxd_capture_setting,
		sizeof(hi1339subtxd_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(struct subdrv_ctx *ctx,kal_uint16 currefps)
{
	...
	hi1339subtxd_table_write_cmos_sensor(ctx,hi1339subtxd_normal_video_setting,
		sizeof(hi1339subtxd_normal_video_setting)/sizeof(kal_uint16));
...
static void hs_video_setting(struct subdrv_ctx *ctx)
{
	...
	hi1339subtxd_table_write_cmos_sensor(ctx,hi1339subtxd_hs_video_setting,
		sizeof(hi1339subtxd_hs_video_setting)/sizeof(kal_uint16));
...
static void slim_video_setting(struct subdrv_ctx *ctx)
{
	...
	hi1339subtxd_table_write_cmos_sensor(ctx,hi1339subtxd_slim_video_setting,
		sizeof(hi1339subtxd_slim_video_setting)/sizeof(kal_uint16));
...
break;
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_eeprom_hi1339subtxd((kal_uint16)(*feature_data),
...
const struct subdrv_entry hi1339subtxd_mipi_raw_entry = {
	.name = "hi1339subtxd_mipi_raw",
	.id = HI1339SUBTXD_SENSOR_ID,
	.pw_seq = pw_seq,
