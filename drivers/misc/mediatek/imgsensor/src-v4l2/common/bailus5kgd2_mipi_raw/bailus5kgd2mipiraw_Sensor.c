 ...
 *============================================================================
 ****************************************************************************/
#include "bailus5kgd2mipiraw_Sensor.h"

static void set_group_hold(void *arg, u8 en);
static u16 get_gain2reg(u32 gain);
static void bailus5kgd2_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static void bailus5kgd2_set_test_pattern_data(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static void bailus5kgd2_sensor_init(struct subdrv_ctx *ctx);
static int open(struct subdrv_ctx *ctx);

/* STRUCT */

static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, bailus5kgd2_set_test_pattern},
	{SENSOR_FEATURE_SET_TEST_PATTERN_DATA, bailus5kgd2_set_test_pattern_data},
};
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = BAILUS5KGD2_SENSOR_ID,
	...
	.ana_gain_type = 2,
	.ana_gain_step = 32,
	.ana_gain_table = bailus5kgd2_ana_gain_table,
	.ana_gain_table_size = sizeof(bailus5kgd2_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 3,
...
const struct subdrv_entry bailus5kgd2_mipi_raw_entry = {
	.name = "bailus5kgd2_mipi_raw",
	.id = BAILUS5KGD2_SENSOR_ID,
	.pw_seq = pw_seq,
