#define PFX "YUECHUIMX582_camera_sensor"
...
#include "yuechuimx582_ana_gain_table.h"
#include "yuechuimx582_seamless_switch.h"
#include "yuechuimx582mipiraw_Sensor.h"
...
#define yuechuimx582_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[yuechuimx582]"
...
static unsigned int Fullsize_qsc_flag = 0;
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YUECHUIMX582_SENSOR_ID,
...
static kal_uint16 yuechuimx582_QSC_setting[2304 * 2];
static kal_uint16 yuechuimx582_LRC_setting[384 * 2];


static void yuechuimx582_get_pdaf_reg_setting(struct subdrv_ctx *ctx, MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void yuechuimx582_set_pdaf_reg_setting(struct subdrv_ctx *ctx,
...
static void write_sensor_QSC(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_QSC_setting,
		sizeof(yuechuimx582_QSC_setting) / sizeof(kal_uint16));
...
static void write_sensor_LRC(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_LRC_setting,
		sizeof(yuechuimx582_LRC_setting) / sizeof(kal_uint16));
...
static void read_sensor_Cali(struct subdrv_ctx *ctx)
{
	...
	for (idx = 0; idx < 2304; idx++) {
		...
		yuechuimx582_QSC_setting[2 * idx] = sensor_qsc;
		yuechuimx582_QSC_setting[2 * idx + 1] = read_cmos_eeprom_8(ctx, addr_qsc);
	}
	for (idx = 0; idx < 192; idx++) {
		yuechuimx582_LRC_setting[2 * idx] = sensor_lrc_0 + idx;
		yuechuimx582_LRC_setting[2 * idx + 1] = read_cmos_eeprom_8(ctx, eeprom_lrc_0 + idx);
		yuechuimx582_LRC_setting[2 * idx + 192 * 2] = sensor_lrc_1 + idx;
		yuechuimx582_LRC_setting[2 * idx + 1 + 192 * 2] = read_cmos_eeprom_8(ctx, eeprom_lrc_1 + idx);
	}
...
static kal_uint16 yuechuimx582_feedback_awbgain[] = {
	0x0b8e, 0x00,
	0x0b8f, 0x00,
	0x0b90, 0x00,
	0x0b91, 0x00,
...
static kal_uint32 yuechuimx582_awb_gain(struct subdrv_ctx *ctx,
		struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	...
	yuechuimx582_feedback_awbgain[1] = (gr_gain_int & 0xFF00) >> 8;
	yuechuimx582_feedback_awbgain[3] = gr_gain_int & 0xFF;
	yuechuimx582_feedback_awbgain[5] = (r_gain_int & 0xFF00) >> 8;
	yuechuimx582_feedback_awbgain[7] = r_gain_int & 0xFF;
	yuechuimx582_feedback_awbgain[9] = (b_gain_int & 0xFF00) >> 8;
	yuechuimx582_feedback_awbgain[11] = b_gain_int & 0xFF;
	yuechuimx582_feedback_awbgain[13] = (gb_gain_int & 0xFF00) >> 8;
	yuechuimx582_feedback_awbgain[15] = gb_gain_int & 0xFF;

	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_feedback_awbgain,
		sizeof(yuechuimx582_feedback_awbgain)/sizeof(kal_uint16));

	return ERROR_NONE;
}

static void yuechuimx582_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_init_setting,
		sizeof(yuechuimx582_init_setting)/sizeof(kal_uint16));

	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_Image_quality_setting,
                sizeof(yuechuimx582_Image_quality_setting)/sizeof(kal_uint16));
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_preview_setting,
		sizeof(yuechuimx582_preview_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_normal_video_setting,
		sizeof(yuechuimx582_normal_video_setting)/sizeof(kal_uint16));
	seamless_state = 0;
...
static void hs_video_setting(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_hs_video_setting,
		sizeof(yuechuimx582_hs_video_setting)/sizeof(kal_uint16));
	seamless_state = 0;
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_custom2_setting,
		sizeof(yuechuimx582_custom2_setting)/sizeof(kal_uint16));
	seamless_state = 0;
...
static void custom3_setting(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_custom3_setting,
		sizeof(yuechuimx582_custom3_setting)/sizeof(kal_uint16));
	seamless_state = 0;
...
static void custom4_setting(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_custom4_setting,
		sizeof(yuechuimx582_custom4_setting)/sizeof(kal_uint16));
	seamless_state = 0;
...
static void custom5_setting(struct subdrv_ctx *ctx)
{
	...
	yuechuimx582_table_write_cmos_sensor(ctx, yuechuimx582_custom5_setting,
		sizeof(yuechuimx582_custom5_setting)/sizeof(kal_uint16));
		...
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (last_sensor_awb.ABS_GAIN_GR != 0 &&
		...
		yuechuimx582_awb_gain(ctx, &last_sensor_awb);
	}
	return ERROR_NONE;
}	/* custom4 */
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(yuechuimx582_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)yuechuimx582_ana_gain_table,
			sizeof(yuechuimx582_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		IMX582_LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		yuechuimx582_get_pdaf_reg_setting(ctx,
	...
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		IMX582_LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		yuechuimx582_set_pdaf_reg_setting(ctx,
				(*feature_para_len) / sizeof(UINT32),
				feature_data_16);
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		yuechuimx582_set_lsc_reg_setting(ctx, index, feature_data_16,
	...
	case SENSOR_FEATURE_SEAMLESS_SWITCH:
		...
		if (pSetSensorAWB != NULL) {
			yuechuimx582_awb_gain(ctx, pSetSensorAWB);
...
const struct subdrv_entry yuechuimx582_mipi_raw_entry = {
	.name = "yuechuimx582_mipi_raw",
	.id = YUECHUIMX582_SENSOR_ID,
	.pw_seq = pw_seq,
