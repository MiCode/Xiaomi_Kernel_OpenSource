 ...
 * Filename:
 * ---------
 *	 ZIRCONOV02B10SUNNYmipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#define PFX "ZIRCONOV02B10SUNNY_camera_sensor"
...
#include "zirconov02b10sunny_ana_gain_table.h"
#include "zirconov02b10sunnymipiraw_Sensor.h"
...
#define zirconov02b10sunny_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8_u8(__VA_ARGS__)
#define LOG_TAG "[zirconov02b10sunny]"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = ZIRCONOV02B10SUNNY_SENSOR_ID,
...
static kal_uint32 zirconov02b10sunny_awb_gain(struct subdrv_ctx *ctx,
...
static void zirconov02b10sunny_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    // Global
        ...
        mdelay(5);
	zirconov02b10sunny_table_write_cmos_sensor(ctx, zirconov02b10sunny_init_setting,
		sizeof(zirconov02b10sunny_init_setting) / sizeof(kal_uint16));
...
{
	OV02B10_LOG_INF("+\n");
	zirconov02b10sunny_table_write_cmos_sensor(ctx, zirconov02b10sunny_preview_setting,
		sizeof(zirconov02b10sunny_preview_setting) / sizeof(kal_uint16));
	OV02B10_LOG_INF("-\n");
} /* preview_setting */
...
#if 0
	if (enable) {
		write_cmos_sensor(ctx, 0xfd, 0x00);
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(zirconov02b10sunny_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)zirconov02b10sunny_ana_gain_table,
			sizeof(zirconov02b10sunny_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		...
		zirconov02b10sunny_awb_gain(ctx,
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		zirconov02b10sunny_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry zirconov02b10sunny_mipi_raw_entry = {
	.name = "zirconov02b10sunny_mipi_raw",
	.id = ZIRCONOV02B10SUNNY_SENSOR_ID,
	.pw_seq = pw_seq,
