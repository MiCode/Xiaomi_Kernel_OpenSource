 ...
 *============================================================================
 ****************************************************************************/
#define PFX "RUBENSS5K4H7_camera_sensor"
...
#include "rubenss5k4h7_ana_gain_table.h"
#include "rubenss5k4h7mipiraw_Sensor.h"
...
static kal_uint32 rubenss5k4h7_awb_gain(struct subdrv_ctx *ctx,
...
static void rubenss5k4h7_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	S5K4H7_LOG_INF("+\n");
	rubenss5k4h7_table_write_cmos_sensor(ctx, rubenss5k4h7_normal_video_setting,
		sizeof(rubenss5k4h7_normal_video_setting)/sizeof(kal_uint16));
	S5K4H7_LOG_INF("-\n");
}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	...
	rubenss5k4h7_table_write_cmos_sensor(ctx, rubenss5k4h7_custom1_setting,
			sizeof(rubenss5k4h7_custom1_setting) / sizeof(kal_uint16));
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	rubenss5k4h7_table_write_cmos_sensor(ctx, rubenss5k4h7_custom2_setting,
			sizeof(rubenss5k4h7_custom2_setting) / sizeof(kal_uint16));
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(rubenss5k4h7_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)rubenss5k4h7_ana_gain_table,
			sizeof(rubenss5k4h7_ana_gain_table));
		}
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		rubenss5k4h7_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry rubenss5k4h7_mipi_raw_entry = {
	.name = "rubenss5k4h7_mipi_raw",
	.id = RUBENSS5K4H7_SENSOR_ID,
	.pw_seq = pw_seq,
