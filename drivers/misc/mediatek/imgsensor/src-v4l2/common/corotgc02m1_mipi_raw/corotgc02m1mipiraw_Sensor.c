 ...
 *============================================================================
 ****************************************************************************/
#define PFX "COCOTGC02M1_camera_sensor"
...
#include "corotgc02m1_ana_gain_table.h"
#include "corotgc02m1mipiraw_Sensor.h"
...
#define corotgc02m1_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[corotgc02m1]"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = COROTGC02M1_SENSOR_ID,
...
static kal_uint32 corotgc02m1_awb_gain(struct subdrv_ctx *ctx,
...
static void corotgc02m1_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
{
	kal_uint32 len, i, cnt;

	kal_uint16 *plist = corotgc02m1_init_setting;

	len = sizeof(corotgc02m1_init_setting) / sizeof(kal_uint16);

	cnt = len >> 1;

    // Global
	// corotgc02m1_table_write_cmos_sensor(ctx, corotgc02m1_init_setting,
	// 	sizeof(corotgc02m1_init_setting) / sizeof(kal_uint16));

	GC02M1_LOG_INF("+\n");
	for ( i = 0; i < cnt; i++) {
		//GC02M1_LOG_INF("addr = 0x%x data = 0x%x \n",plist[0],plist[1] & 0xff);
        write_cmos_sensor_8(ctx, plist[0] & 0xff, plist[1] & 0xff);
		plist += 2;
	}
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(corotgc02m1_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)corotgc02m1_ana_gain_table,
			sizeof(corotgc02m1_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		corotgc02m1_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry corotgc02m1_mipi_raw_entry = {
	.name = "corotgc02m1_mipi_raw",
	.id = COROTGC02M1_SENSOR_ID,
	.pw_seq = pw_seq,
