 ...
 *============================================================================
 ****************************************************************************/
#define PFX "REMBRANDTS5K4H7_camera_sensor"
...
#include "rembrandts5k4h7_ana_gain_table.h"
#include "rembrandts5k4h7mipiraw_Sensor.h"
...
#define rembrandts5k4h7_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[rembrandts5k4h7]"
...
static kal_uint32 rembrandts5k4h7_awb_gain(struct subdrv_ctx *ctx,
...
static void rembrandts5k4h7_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	rembrandts5k4h7_table_write_cmos_sensor(ctx, rembrandts5k4h7_init_setting,
		sizeof(rembrandts5k4h7_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	rembrandts5k4h7_table_write_cmos_sensor(ctx, rembrandts5k4h7_preview_setting,
			sizeof(rembrandts5k4h7_preview_setting) / sizeof(kal_uint16));
...
{
	S5K4H7_LOG_INF("+\n");
	rembrandts5k4h7_table_write_cmos_sensor(ctx, rembrandts5k4h7_normal_video_setting,
		sizeof(rembrandts5k4h7_normal_video_setting)/sizeof(kal_uint16));
	S5K4H7_LOG_INF("-\n");
}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	...
	rembrandts5k4h7_table_write_cmos_sensor(ctx, rembrandts5k4h7_custom1_setting,
			sizeof(rembrandts5k4h7_custom1_setting) / sizeof(kal_uint16));
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	rembrandts5k4h7_table_write_cmos_sensor(ctx, rembrandts5k4h7_custom2_setting,
			sizeof(rembrandts5k4h7_custom2_setting) / sizeof(kal_uint16));
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(rembrandts5k4h7_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)rembrandts5k4h7_ana_gain_table,
			sizeof(rembrandts5k4h7_ana_gain_table));
		}
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		rembrandts5k4h7_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry rembrandts5k4h7_mipi_raw_entry = {
	.name = "rembrandts5k4h7_mipi_raw",
	.id = REMBRANDTS5K4H7_SENSOR_ID,
	.pw_seq = pw_seq,
