...
static struct imgsensor_pw_seq_entry pw_seq[] = {
	{HW_ID_MCLK, 24, 0},
	{HW_ID_RST, 0, 0},
...
static struct v4l2_mbus_frame_desc_entry frame_desc_prev[] = {
	...
	},
	{
		.bus.csi2 = {
			...
			.hsize = 0x04d8,
			.vsize = 0x05d0,
			.user_data_desc = V4L2_MBUS_CSI2_USER_DEFINED_DATA_DESC_PDAF_PIXEL,
		},
	},
};
...
static int get_frame_desc(int scenario_id, struct v4l2_mbus_frame_desc *fd)
{
	switch (scenario_id) {
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
	case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
...
struct imgsensor_subdrv_entry imx586_mipi_raw_entry = {
	...
	.max_frame_length = 0xffff,
	.ana_gain_min = 73, /* 1x gain */
	.ana_gain_max = 4096, /* 16x gain */
	.ana_gain_step = 1,
	.ana_gain_def = 0x100,
	.exposure_min = 6,
	.exposure_max = 0xffff - 48, /* max_frame_length - margin */
	.exposure_step = 2,
	.exposure_def = 0x3D0,
	.is_hflip = 0,
	.is_vflip = 0,
