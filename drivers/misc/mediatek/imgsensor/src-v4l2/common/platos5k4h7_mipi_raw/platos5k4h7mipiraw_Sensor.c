 ...
 *============================================================================
 ****************************************************************************/
#define PFX "PLATOS5K4H7_camera_sensor"
...
#include "platos5k4h7_ana_gain_table.h"
#include "platos5k4h7mipiraw_Sensor.h"
...
#define platos5k4h7_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[platos5k4h7]"
#define S5K4H7_LOG_INF(format, args...) pr_info(LOG_TAG "[%s] " format, __func__, ##args)
#define S5K4H7_LOG_DBG(format, args...) pr_info(LOG_TAG "[%s] " format, __func__, ##args)
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{ 3264, 2448,352, 264, 2560, 1920, 2560, 1920, 0000, 0000, 2560, 1920, 0, 0, 2560, 1920}, // custom1
	{ 3264, 2448, 352, 504, 2560, 1440, 2560, 1440, 0000, 0000, 2560, 1440, 0, 0, 2560, 1440}, // custom2
};
...
static kal_uint32 platos5k4h7_awb_gain(struct subdrv_ctx *ctx,
...
static void platos5k4h7_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	platos5k4h7_table_write_cmos_sensor(ctx, platos5k4h7_init_setting,
		sizeof(platos5k4h7_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	platos5k4h7_table_write_cmos_sensor(ctx, platos5k4h7_preview_setting,
			sizeof(platos5k4h7_preview_setting) / sizeof(kal_uint16));
...
{
	S5K4H7_LOG_INF("+\n");
	platos5k4h7_table_write_cmos_sensor(ctx, platos5k4h7_normal_video_setting,
		sizeof(platos5k4h7_normal_video_setting)/sizeof(kal_uint16));
	S5K4H7_LOG_INF("-\n");
}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	...
	platos5k4h7_table_write_cmos_sensor(ctx, platos5k4h7_custom1_setting,
			sizeof(platos5k4h7_custom1_setting) / sizeof(kal_uint16));
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	platos5k4h7_table_write_cmos_sensor(ctx, platos5k4h7_custom2_setting,
			sizeof(platos5k4h7_custom2_setting) / sizeof(kal_uint16));
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(platos5k4h7_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)platos5k4h7_ana_gain_table,
			sizeof(platos5k4h7_ana_gain_table));
		}
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		platos5k4h7_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry platos5k4h7_mipi_raw_entry = {
	.name = "platos5k4h7_mipi_raw",
	.id = PLATOS5K4H7_SENSOR_ID,
	.pw_seq = pw_seq,
