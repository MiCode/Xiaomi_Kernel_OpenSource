 ...
 *============================================================================
 ****************************************************************************/
#define PFX "MATISSEGC02M1_camera_sensor"
...
#include "matissegc02m1_ana_gain_table.h"
#include "matissegc02m1mipiraw_Sensor.h"
...
#define matissegc02m1_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8_u8(__VA_ARGS__)
#define LOG_TAG "[matissegc02m1]"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MATISSEGC02M1_SENSOR_ID,
...
static kal_uint32 matissegc02m1_awb_gain(struct subdrv_ctx *ctx,
...
static void matissegc02m1_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	GC02M1_LOG_INF("+\n");
	// Global
	matissegc02m1_table_write_cmos_sensor(ctx, matissegc02m1_init_setting,
		sizeof(matissegc02m1_init_setting) / sizeof(kal_uint16));
	GC02M1_LOG_INF("-\n");
}	/*	  sensor_init  */
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(matissegc02m1_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)matissegc02m1_ana_gain_table,
			sizeof(matissegc02m1_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		matissegc02m1_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry matissegc02m1_mipi_raw_entry = {
	.name = "matissegc02m1_mipi_raw",
	.id = MATISSEGC02M1_SENSOR_ID,
	.pw_seq = pw_seq,
