...
static struct v4l2_mbus_frame_desc_entry frame_desc_prev[] = {
	...
	},
	{
		.bus.csi2 = {
			...
			.hsize = 0x0e10,
			.vsize = 0x0001,
			.user_data_desc = V4L2_MBUS_CSI2_USER_DEFINED_DATA_DESC_Y_HIST,
		},
	},
	{
		.bus.csi2 = {
			...
			.hsize = 0x0e10,
			.vsize = 0x0001,
			.user_data_desc = V4L2_MBUS_CSI2_USER_DEFINED_DATA_DESC_AE_HIST,
		},
	},
	{
		.bus.csi2 = {
			...
			.hsize = 0x0e10,
			.vsize = 0x0001,
			.user_data_desc = V4L2_MBUS_CSI2_USER_DEFINED_DATA_DESC_FLICKER,
		},
	},
};
...
struct imgsensor_subdrv_entry imx576_mipi_raw_entry = {
	...
	.max_frame_length = 0xffff,
	.ana_gain_min = 64, /* 1x gain */
	.ana_gain_max = 1024, /* 16x gain */
	.ana_gain_step = 1,
	.ana_gain_def = 0x100,
	.exposure_min = 6,
	.exposure_max = 0xffff - 61, /* max_frame_length - margin */
	.exposure_step = 1,
	.exposure_def = 0x3D0,
	.is_hflip = 0,
	.is_vflip = 0,
