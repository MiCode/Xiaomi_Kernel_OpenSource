...
#include "ov13b10sunny_mipiraw_Sensor.h"
#include "cam_cal_define.h"
#define PFX "OV13B10SUNNY_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10SUNNY_SENSOR_ID,
...
static void preview_setting(void)
{
	...
	ov13b10sunny_table_write_cmos_sensor(
		...
		sizeof(addr_data_pair_preview_ov13b10sunny) /
				sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
			...
			if (vendor_id == 0x01) {
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info("ov13b10sunny i2c write id: 0x%x, sensor id: 0x%x vendor_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					vendor_id);
					return ERROR_NONE;
				} else {
					pr_err("ov13b10sunny check id i2c write id: 0x%x, sensor id: 0x%x vendor_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					vendor_id);
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
        case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
            *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 7000000;
        break;
