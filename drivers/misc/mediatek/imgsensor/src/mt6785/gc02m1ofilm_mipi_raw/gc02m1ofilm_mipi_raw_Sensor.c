...
#define PFX "GC02M1OFILM_MIPI_RAW_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1OFILM_SENSOR_ID,
...
static kal_uint16
gc02m1ofilm_mipi_raw_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < GC02M1OFILM_MIPI_RAW_SENSOR_GAIN_BASE)
		reg_gain = GC02M1OFILM_MIPI_RAW_SENSOR_GAIN_BASE;
	else if (reg_gain > GC02M1OFILM_MIPI_RAW_SENSOR_GAIN_MAX)
		reg_gain = GC02M1OFILM_MIPI_RAW_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 GC02M1OFILM_MIPI_RAW_AGC_Param[GC02M1OFILM_MIPI_RAW_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{1024, 0},
		{1536, 1},
		{2035, 2},
		{2519, 3},
	...
	for (gain_index = GC02M1OFILM_MIPI_RAW_SENSOR_GAIN_MAX_VALID_INDEX - 1;
			gain_index >= 0; gain_index--)
		if (reg_gain >= GC02M1OFILM_MIPI_RAW_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC02M1OFILM_MIPI_RAW_AGC_Param[gain_index][1]);
	temp_gain =
		reg_gain * GC02M1OFILM_MIPI_RAW_SENSOR_DGAIN_BASE /
		GC02M1OFILM_MIPI_RAW_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x1f);
	write_cmos_sensor(0xb2, temp_gain & 0xff);
	LOG_INF
	("GC02M1OFILM_MIPI_RAW[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
	 GC02M1OFILM_MIPI_RAW_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
kal_uint16 addr_data_pair_init_gc02m1ofilm_mipi_raw[] = {
	...
	0x0d, 0x04,
	0x0e, 0xbc,
	0x17, GC02M1OFILM_MIPI_RAW_MIRROR,
	0x19, 0x04,
	0x24, 0x00,
	0x56, 0x20,
	0x5b, 0x00,
...
kal_uint16 addr_data_pair_preview_gc02m1ofilm_mipi_raw[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1ofilm_mipi_raw[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1ofilm_mipi_raw[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1ofilm_mipi_raw[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1ofilm_mipi_raw[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1ofilm_mipi_raw_table_write_cmos_sensor(addr_data_pair_init_gc02m1ofilm_mipi_raw,
		   sizeof(addr_data_pair_init_gc02m1ofilm_mipi_raw) /
		   sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	gc02m1ofilm_mipi_raw_table_write_cmos_sensor(addr_data_pair_preview_gc02m1ofilm_mipi_raw,
		   sizeof(addr_data_pair_preview_gc02m1ofilm_mipi_raw) /
		   sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	gc02m1ofilm_mipi_raw_table_write_cmos_sensor(addr_data_pair_capture_gc02m1ofilm_mipi_raw,
		  sizeof(addr_data_pair_capture_gc02m1ofilm_mipi_raw) /
		   sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	gc02m1ofilm_mipi_raw_table_write_cmos_sensor(addr_data_pair_normal_video_gc02m1ofilm_mipi_raw,
		   sizeof
		   (addr_data_pair_normal_video_gc02m1ofilm_mipi_raw) /
		   sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	gc02m1ofilm_mipi_raw_table_write_cmos_sensor(addr_data_pair_hs_video_gc02m1ofilm_mipi_raw,
			   sizeof(addr_data_pair_hs_video_gc02m1ofilm_mipi_raw) /
			   sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	gc02m1ofilm_mipi_raw_table_write_cmos_sensor(addr_data_pair_slim_video_gc02m1ofilm_mipi_raw,
			   sizeof(addr_data_pair_slim_video_gc02m1ofilm_mipi_raw)
			   / sizeof(kal_uint16));
}
...
unsigned int
gc02m1ofilm_mipi_raw_read_otp_info(struct i2c_client *client,
...
#if USER_OTP
static void gc02m1ofilm_mipi_raw_read_otp(void)
{
	int i = 0;
...
#if USER_OTP
static int get_gc02m1ofilm_mipi_raw_vendor_id(void)
{
	int module_id;
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfc, 0x01);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			pr_err("wangmin get_imgsensor_id read is %x!",
				   *sensor_id);
			...
			LOG_INF
			("Read sensor id true, write id: 0x%x, id: 0x%x\n",
