...
#define PFX "OV64B40Semco_camera_sensor"
...
#include "ov64b40semco_mipi_raw.h"
#include "ov64b40semco_Sensor_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40SEMCO_SENSOR_ID,
...
{
        if(read_eeprom_sensor(0x12BE) == 1) //OVPD-1 Flag valid
        {
                ov64b40_table_write_cmos_sensor(ov64b_QSC_OVPD_setting,
                        sizeof(ov64b_QSC_OVPD_setting) / sizeof(kal_uint16));
        }
        else if( read_eeprom_sensor(0x12BE) == 0xFF)
        {
                ov64b40_table_write_cmos_sensor(addr_data_pair_init_ovpd_ov64b40,
                        sizeof(addr_data_pair_init_ovpd_ov64b40) / sizeof(kal_uint16));
        }
}
