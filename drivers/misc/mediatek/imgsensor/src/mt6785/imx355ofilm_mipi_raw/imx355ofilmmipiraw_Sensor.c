...
#include "imx355ofilmmipiraw_Sensor.h"

/************************Modify Following Strings for Debug********************/
#define PFX "IMX355OFILM_camera_sensor"
#define LOG_1 LOG_INF("IMX355OFILM,MIPI 4LANE\n")
/************************   Modify end    *************************************/
...
/*support ZHDR*/
/* #define imx355ofilm_ZHDR */

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355OFILM_SENSOR_ID,
...
static BYTE imx355ofilm_SPC_data[352] = { 0 };
...
#define IMX355OFILMMIPI_MaxGainIndex (389)
kal_uint16 imx355ofilmMIPI_sensorGainMapping[IMX355OFILMMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 16},
	{66, 32},
	{67, 46},
...
static void imx355ofilm_set_pd_focus_area(MUINT32 startpos, MUINT32 size)
{
...
static void imx355ofilm_get_pdaf_reg_setting(
...
static void imx355ofilm_set_pdaf_reg_setting(
	MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx355ofilm_apply_SPC(void)
{
	...
	imx355ofilm_read_SPC(imx355ofilm_SPC_data);

	tosend = 0;
	puSendCmd[tosend++] = (char)(start_reg >> 8);
	puSendCmd[tosend++] = (char)(start_reg & 0xFF);
	memcpy((void *)&puSendCmd[tosend], imx355ofilm_SPC_data, 352);
	tosend += 352;
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (iI = 0; iI < IMX355OFILMMIPI_MaxGainIndex; iI++) {
		if (gain <= imx355ofilmMIPI_sensorGainMapping[iI][0])
			return imx355ofilmMIPI_sensorGainMapping[iI][1];
	}

	return imx355ofilmMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx355ofilm_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_imx355ofilm_zvhdr_on[] = {
	0x30b1, 0x00,
	0x30c6, 0x00,
	0x30b2, 0x00,
	0x30b3, 0x00,
...
kal_uint16 addr_data_pair_imx355ofilm_zvhdr_off[] = {
	0x30b4, 0x00,
	0x30b5, 0x00,
	0x30b6, 0x00,
	0x30b7, 0x00,
...
static kal_uint16 zvhdr_setting(void)
{
	...
	if (imgsensor.hdr_mode == 9) {
		imx355ofilm_table_write_cmos_sensor(addr_data_pair_imx355ofilm_zvhdr_on,
		sizeof(addr_data_pair_imx355ofilm_zvhdr_on) / sizeof(kal_uint16));
	} else {
		imx355ofilm_table_write_cmos_sensor(addr_data_pair_imx355ofilm_zvhdr_off,
		sizeof(addr_data_pair_imx355ofilm_zvhdr_off) / sizeof(kal_uint16));
	}
	return 0;
...
kal_uint16 addr_data_pair_init_imx355ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
...
{
	LOG_INF("E\n");
	imx355ofilm_table_write_cmos_sensor(addr_data_pair_init_imx355ofilm,
		sizeof(addr_data_pair_init_imx355ofilm)/sizeof(kal_uint16));

	/*enable temperature sensor, TEMP_SEN_CTL:*/
	write_cmos_sensor(0x0138, 0x01);
}    /*    sensor_init  */

kal_uint16 addr_data_pair_preview_imx355ofilm[] = {
	0x0100, 0x00,
...
{
	imx355ofilm_table_write_cmos_sensor(addr_data_pair_preview_imx355ofilm,
	sizeof(addr_data_pair_preview_imx355ofilm) / sizeof(kal_uint16));
	/* zvhdr_setting(); */
}				/*    preview_setting  */

kal_uint16 addr_data_pair_capture_imx355ofilm[] = {
	0x0100, 0x00,
...
kal_uint16 addr_data_pair_capture_imx355ofilm_pdaf_on[] = {
	/*PDAF*/
	/*PD_OUT_EN=1 */
	0x3E37, 0x01,
	/*AREA MODE */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx355ofilm_table_write_cmos_sensor(addr_data_pair_capture_imx355ofilm,
	sizeof(addr_data_pair_capture_imx355ofilm) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif
#ifdef IMX355_PDAF_SUPPORT
	if (imgsensor.pdaf_mode == 1) {
		imx355ofilm_table_write_cmos_sensor(
			addr_data_pair_capture_imx355ofilm_pdaf_on,

		sizeof(
		addr_data_pair_capture_imx355ofilm_pdaf_on) / sizeof(kal_uint16));

		imx355ofilm_apply_SPC();
	}
#endif

}

kal_uint16 addr_data_pair_video_imx355ofilm[] = {
	0x0100, 0x00,
...
#if SUPPORT_HPS
kal_uint16 addr_data_pair_hs_video_imx355ofilm[] = {
	0x0100, 0x00,
...
{
	imx355ofilm_table_write_cmos_sensor(addr_data_pair_hs_video_imx355ofilm,
	sizeof(addr_data_pair_hs_video_imx355ofilm) / sizeof(kal_uint16));
	zvhdr_setting();
}
#endif
...
static kal_uint32 open(void)
{
	...
	KD_SENSOR_PROFILE("imx355ofilm_open_1");
	...
	KD_SENSOR_PROFILE("imx355ofilm_open_2");
	return ERROR_NONE;
} /* open */
...
static kal_uint32 imx355ofilm_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		imx355ofilm_read_DCC((kal_uint16) (*feature_data),
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx355ofilm_awb_gain(pSetSensorAWB);
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355ofilm_get_pdaf_reg_setting(
			(*feature_para_len) / sizeof(UINT32), feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355ofilm_set_pdaf_reg_setting(
			(*feature_para_len) / sizeof(UINT32), feature_data_16);
		break;

	case SENSOR_FEATURE_SET_PDFOCUS_AREA:
		LOG_INF(
			"SENSOR_FEATURE_SET_imx355ofilm_PDFOCUS_AREA Start Pos=%d, Size=%d\n",
			(UINT32) *feature_data, (UINT32) *(feature_data + 1));
		imx355ofilm_set_pd_focus_area(*feature_data, *(feature_data + 1));
		break;
		/*End of PDAF */	
#endif
