...
#include "gc02m1bsunnymipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1bsunny_camera_sensor"
#define LOG_1 LOG_INF("GC02M1BSUNNY, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1BSUNNY_SENSOR_ID,
...
static kal_uint16 gc02m1bsunny_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint32 return_sensor_id(void)
{
	...
	sensorid = ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1));
	if (sensorid == 0x2E0)
            sensorid = imgsensor_info.sensor_id;
	return sensorid;
}
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < GC02M1BSUNNY_SENSOR_GAIN_BASE)
		reg_gain = GC02M1BSUNNY_SENSOR_GAIN_BASE;
	else if (reg_gain > GC02M1BSUNNY_SENSOR_GAIN_MAX)
		reg_gain = GC02M1BSUNNY_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 GC02M1BSUNNY_AGC_Param[GC02M1BSUNNY_SENSOR_GAIN_MAX_VALID_INDEX][2] = {
		{  1024,  0 },
		{  1536,  1 },
		{  2035,  2 },
		{  2519,  3 },
	...
	for (gain_index = GC02M1BSUNNY_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= GC02M1BSUNNY_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC02M1BSUNNY_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * GC02M1BSUNNY_SENSOR_DGAIN_BASE / GC02M1BSUNNY_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x1f);
	write_cmos_sensor(0xb2, temp_gain & 0xff);
	LOG_INF("GC02M1BSUNNY_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
		GC02M1BSUNNY_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
kal_uint16 addr_data_pair_init_gc02m1bsunny[] = {
...
kal_uint16 addr_data_pair_preview_gc02m1bsunny[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1bsunny[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1bsunny[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1bsunny[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1bsunny[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
kal_uint16 addr_data_pair_custom1_gc02m1bsunny[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xfc,
	0x3e, 0x90,
...
static void sensor_init(void)
{
	...
	gc02m1bsunny_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1bsunny,
		sizeof(addr_data_pair_init_gc02m1bsunny) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsunny_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1bsunny,
		sizeof(addr_data_pair_preview_gc02m1bsunny) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsunny_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1bsunny,
		sizeof(addr_data_pair_capture_gc02m1bsunny) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsunny_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1bsunny,
		sizeof(addr_data_pair_normal_video_gc02m1bsunny) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsunny_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1bsunny,
		sizeof(addr_data_pair_hs_video_gc02m1bsunny) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsunny_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1bsunny,
		sizeof(addr_data_pair_slim_video_gc02m1bsunny) /
		sizeof(kal_uint16));
}
static void custom1_setting(void)
{
	LOG_INF("E\n");
	gc02m1bsunny_table_write_cmos_sensor(
		addr_data_pair_custom1_gc02m1bsunny,
		sizeof(addr_data_pair_custom1_gc02m1bsunny) /
		sizeof(kal_uint16));
}
...
unsigned int
gc02m1bofilm_mipi_raw_read_otp_info(struct i2c_client *client,
...
static void gc02m1bofilm_mipi_raw_read_otp(void)
{
	int i = 0;
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				#if USE_OTP
				gc02m1bofilm_mipi_raw_read_otp();
				#endif
