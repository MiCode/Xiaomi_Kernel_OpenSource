...
#include "imx355_ultra_ofilm_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355_ULTRA_OFILM_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{3280, 2464, 0,   0,   3280, 2464, 1640, 1232, 0, 0, 1640, 1232,  0,  0, 1640, 1232}, /* custom1 1640x1232@30fps*/
...
#if ENABLE_PDAF
static void imx355ofilm_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx355ofilm_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
/*
static kal_uint16 imx355ofilm_feedback_awbgain[] = {
	0x0b90, 0x00,
	0x0b91, 0x01,
	0x0b92, 0x00,
	0x0b93, 0x01,
...
static void feedback_awbgain(kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	imx355ofilm_feedback_awbgain[1] = r_gain_int;
	imx355ofilm_feedback_awbgain[3] = (
		((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
	imx355ofilm_feedback_awbgain[5] = b_gain_int;
	imx355ofilm_feedback_awbgain[7] = (
		((b_gain * 100) / 512) - (b_gain_int * 100)) * 2;
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_feedback_awbgain,
		sizeof(imx355ofilm_feedback_awbgain)/sizeof(kal_uint16));
}
*/
static void imx355ofilm_set_lsc_reg_setting(
...
static kal_uint16 imx355ofilm_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
#endif
static kal_uint16 imx355ofilm_init_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x4348, 0x16,
	0x4350, 0x19,
...
static kal_uint16 imx355ofilm_capture_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 imx355ofilm_preview_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 imx355ofilm_normal_video_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 imx355ofilm_slim_video_setting[] = {

};

static kal_uint16 imx355ofilm_hs_video_setting[] = {

};

static kal_uint16 imx355ofilm_custom1_setting[] = {
	0x0100, 0x00,
...
static kal_uint16 imx355ofilm_custom2_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
static void sensor_init(void)
{
	...
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_init_setting,
		sizeof(imx355ofilm_init_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("%s +\n", __func__);
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_preview_setting,
		sizeof(imx355ofilm_preview_setting)/sizeof(kal_uint16));
	LOG_INF("%s -\n", __func__);
} /* preview_setting */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	/*************MIPI output setting************/
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_capture_setting,
		sizeof(imx355ofilm_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_normal_video_setting,
		sizeof(imx355ofilm_normal_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
	...
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_hs_video_setting,
		sizeof(imx355ofilm_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
	...
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_slim_video_setting,
		sizeof(imx355ofilm_slim_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_custom1_setting,
		sizeof(imx355ofilm_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
...
static void custom2_setting(void)
{
	...
	imx355ofilm_table_write_cmos_sensor(imx355ofilm_custom2_setting,
		sizeof(imx355ofilm_custom2_setting)/sizeof(kal_uint16));
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355ofilm_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355ofilm_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		imx355ofilm_set_lsc_reg_setting(index, feature_data_16,
