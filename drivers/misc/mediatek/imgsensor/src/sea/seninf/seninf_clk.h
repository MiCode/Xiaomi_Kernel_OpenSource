...
enum SENINF_CLK_IDX_SYS {
	...
	SENINF_CLK_IDX_SYS_SCP_SYS_CAM = SENINF_CLK_IDX_SYS_MIN_NUM,
	SENINF_CLK_IDX_SYS_SCP_SYS_CSI,
...
enum SENINF_CLK_IDX_TG {
	...
	SENINF_CLK_IDX_TG_TOP_MUX_CAMTG1,
...
enum SENINF_CLK_IDX_FREQ {
	...
	SENINF_CLK_IDX_FREQ_TOP_UNIVPLL_D3_D32,
