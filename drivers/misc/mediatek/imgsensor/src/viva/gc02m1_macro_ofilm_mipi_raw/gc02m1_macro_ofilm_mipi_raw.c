...
#include "gc02m1_macro_ofilm_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_MACRO_OFILM_SENSOR_ID,
...
static kal_uint16 read_cmos_sensor(kal_uint32 addr)
{
	...
	iReadRegI2CTiming(pu_send_cmd, 1, (u8 *) &get_byte, 1,
...
static void write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
	...
	iWriteRegI2CTiming(pu_send_cmd, 2, imgsensor.i2c_write_id, imgsensor_info.i2c_speed);
}
...
static kal_uint16 get_vendor_id(void)
{
	...
	iReadRegI2CTiming(pusendcmd, 2, (u8 *)&get_byte, 1, 0xA4, imgsensor_info.i2c_speed);
	return get_byte;
...
UINT32 GC02M1_MACRO_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
