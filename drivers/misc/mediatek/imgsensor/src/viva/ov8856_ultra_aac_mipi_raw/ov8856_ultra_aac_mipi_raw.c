 ...
 *============================================================================
 ****************************************************************************/
#define PFX "ov8856_aac_mipi_raw"
...
#include "ov8856_ultra_aac_mipi_raw.h"
#include "ov8856_ultra_aac_mipiraw_Setting.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV8856_ULTRA_AAC_SENSOR_ID,
...
static void set_dummy(void)
{
	...
	pr_debug("OV8856 AAC imgsensor.frame_length = %d\n", imgsensor.frame_length);
...
static void set_max_framerate(UINT16 framerate, kal_bool min_framelength_en)
{
    ...
    pr_err("OV8856 AAC framerate = %d, min framelength should enable %d\n", framerate, min_framelength_en);
...
static void write_shutter(kal_uint32 shutter)
{
	...
	pr_debug("OV8856 AAC Add for N3D! shutterlzl =%d, framelength =%d\n",
...
#define SHUTTER_1		 37266//0.5s
#define SHUTTER_2		 44719//0.6s
#define SHUTTER_3		 59625//0.8s
#define SHUTTER_4		 74532//1s
#define SHUTTER_5		 96892//1.3s
#define SHUTTER_6		 119251//1.6s
#define SHUTTER_7		 149064//2s
#define SHUTTER_8		 186330//2.5s
#define SHUTTER_9		 238503//3.2s
#define SHUTTER_10		 298129//4s
#define SHUTTER_11		 372661//5s
#define SHUTTER_12		 447193//6s
#define SHUTTER_13		 596258//8s
#define SHUTTER_14		 745323//10s
#define SHUTTER_15		 968920//13s
#define SHUTTER_16		 1117984//15s
/*************************************************************************
 * FUNCTION
 *	set_shutter
 *
...
static void set_shutter(kal_uint32 shutter)
{
	...
	write_cmos_sensor(0x3501, (shutter >> 4) & 0xFF);
	write_cmos_sensor(0x3500, (shutter >> 12) & 0x0F);
	pr_debug("Exit! shutter =%d, framelength =%d, realtime_fps =%d \n", shutter, imgsensor.frame_length, realtime_fps);
	} else{
		pr_debug("Enter Long Exposure shutter:%d ", shutter);
		...
		imgsensor.current_ae_effective_frame = 2;
			...
			case SHUTTER_16:
				...
				break;
			default:
				pr_err("ERROR! Shutter = %d, does not match any values!", shutter);
	}
	write_cmos_sensor(0x3208, 0x00);
	...
	write_cmos_sensor(0x3208, 0x10);
	write_cmos_sensor(0x3208, 0xa0);
	pr_debug("Exit Long Exposure shutter:%d", shutter);
	}
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (*sensor_id == imgsensor_info.sensor_id) {
		pr_err("ov8856 aac i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
		return ERROR_NONE;
	}

	    pr_err("ov8856 aac Read sensor id fail, id: 0x%x\n",    imgsensor.i2c_write_id);
	    retry--;
	} while (retry > 0);
	i++;
	retry = 2;
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_err(
	    "ov8856 aac Warning: current_fps %d fps is not support, so use cap's setting: %d fps!\n",
...
static kal_uint32 slim_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    pr_err("ov8856 aac %s. 720P@240FPS\n", __func__);
    spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 control(enum MSDK_SCENARIO_ID_ENUM scenario_id,
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    pr_err("ov8856 aac scenario_id = %d\n", scenario_id);
    spin_lock(&imgsensor_drv_lock);
	...
	break;
    default:
	pr_err("ov8856 aac Error ScenarioId setting");
	preview(image_window, sensor_config_data);
...
static kal_uint32 set_auto_flicker_mode(kal_bool enable, UINT16 framerate)
{
	...
	pr_err("ov8856 aac enable! fps = %d", framerate);
    } else {
	imgsensor.autoflicker_en = KAL_FALSE;
    }
    spin_unlock(&imgsensor_drv_lock);
	...
	enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
    ...
    pr_err("ov8856 aac scenario_id = %d, framerate = %d\n", scenario_id, framerate);
	...
	if (imgsensor.frame_length > imgsensor.shutter)
	    set_dummy();
	pr_err("ov8856 aac error scenario_id = %d, we use preview scenario\n",
	    scenario_id);
	break;
    }
    return ERROR_NONE;
    ...
    UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	*(feature_data + 2) = imgsensor_info.exp_step;
	...
	pr_err("SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO %d",*feature_data);
	switch (*feature_data) {
	case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
	...
	*feature_para_len = 4;
	...
	pr_err("SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ");
...
UINT32 OV8856_ULTRA_AAC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    if (pfFunc != NULL)
	*pfFunc = &sensor_func;
    return ERROR_NONE;
