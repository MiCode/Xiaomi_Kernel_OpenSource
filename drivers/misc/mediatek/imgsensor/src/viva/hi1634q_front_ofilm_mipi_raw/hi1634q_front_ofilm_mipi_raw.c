 ...
 *============================================================================
 ****************************************************************************/
#define PFX "HI1634Q_ofilm_camera_sensor"
...
#include "hi1634q_front_ofilm_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1634Q_FRONT_OFILM_SENSOR_ID,
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 2520000;
		break;
...
UINT32 HI1634Q_FRONT_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
