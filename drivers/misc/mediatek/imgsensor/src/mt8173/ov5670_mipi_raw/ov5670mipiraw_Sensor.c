...
{2592, 1944, 0, 0, 2592, 1944, 2592, 1944, 0000, 0000, 2592, 1944, 1, 0, 2560, 1920},
{2592, 1944, 0, 0, 2592, 1944, 1296, 972, 0000, 0000, 1296, 972, 1, 0, 1280, 960},
{2592, 1944, 0, 0, 2592, 1944, 640, 480, 0000, 0000, 640, 480, 1, 0, 640, 480},
{2592, 1944, 0, 0, 2592, 1944, 1296, 972, 0000, 0000, 1296, 972, 1, 0, 1280, 960}
};
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 240) {	/*24fps for PIP */
		...
		write_cmos_sensor(0x380c,
			((imgsensor_info.cap1.linelength >> 8) & 0xFF));
		write_cmos_sensor(0x380d,
			(imgsensor_info.cap1.linelength & 0xFF));
		write_cmos_sensor(0x380e,
			((imgsensor_info.cap1.framelength >> 8) & 0xFF));
		write_cmos_sensor(0x380f,
			(imgsensor_info.cap1.framelength & 0xFF));
...
#define OV5670_OTP_SIZE 32
static u8 read_value[OV5670_OTP_SIZE];
