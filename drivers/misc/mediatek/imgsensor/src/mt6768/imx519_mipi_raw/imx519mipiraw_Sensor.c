...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.grabwindow_height = 1748, /* 0x6c0 */
		.mipi_data_lp2hs_settle_dc = 85,
		/* following for GetDefaultFramerateByScenario() */
		.mipi_pixel_rate = 200800000,
	...
	.hs_video = {
		...
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1288,
		.grabwindow_height = 726,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 246380000,
		.max_framerate = 1200,
	},
	.slim_video = {
		.pclk = 500000000,
	...
	.custom2 = {/*vga 240fps*/
		...
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 640, /*0x500*/
		.grabwindow_height = 480, /*0x2D0*/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	{4656, 3496, 000, 000, 4656, 3496, 2328, 1748,
	0000, 0000, 2328, 1748, 0, 0, 2328, 1748}, /* Preview */
	{4656, 3496, 000, 000, 4656, 3496, 4656, 3496,
	0000, 0000, 4656, 3496, 0, 0, 4656, 3496}, /* capture */
	{4656, 3496, 000, 440, 4656, 2618, 4656, 2616,
	0000, 0000, 4656, 2618, 0, 0, 4656, 2616}, /* video */
	{4656, 3496, 1040, 1022, 2576, 1452, 1288, 726,
	0000, 0000, 1288, 726, 0, 0, 1288, 726}, /* high speed video */
	{4656, 3496, 1040, 1022, 2576, 1452, 1288, 726,
	0000, 0000, 1288, 726, 0, 0, 1288, 726}, /* slim video */
	{4656, 3496, 1048, 1028, 2560, 1440, 1280,  720,
	 0000, 0000, 1280,  720,    0,	  0, 1280,  720}, /*custom1*/
	{4656, 3496, 1688, 1268, 1280, 960, 640,  480,
	 0000, 0000, 640,  480,    0,	  0, 640,  480}, /*custom2*/
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {
	...
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 ...
	 0x00, 0x00, 0x000, 0x0000, 0x00, 0x00, 0x0000, 0x0000},
...
static kal_uint16 imx519_capture_setting[] = {
	0x0111, 0x02,
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
static kal_uint16 imx519_video_setting[] = {
	0x0111, 0x02,
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
static kal_uint16 imx519_hs_video_setting[] = {
	0x0111, 0x02,
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
static kal_uint16 imx519_slim_video_setting[] = {
	0x0111, 0x02,
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx519_table_write_cmos_sensor(imx519_capture_setting,
		sizeof(imx519_capture_setting) / sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx519_table_write_cmos_sensor(imx519_video_setting,
		sizeof(imx519_video_setting) / sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	imx519_table_write_cmos_sensor(imx519_hs_video_setting,
		sizeof(imx519_hs_video_setting) / sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	imx519_table_write_cmos_sensor(imx519_slim_video_setting,
		sizeof(imx519_slim_video_setting) / sizeof(kal_uint16));

	LOG_INF("X\n");
}

/*full size vga@240fps*/
static void custom1_setting(void)
{
	LOG_INF("%s vga 240 fps E! currefps\n", __func__);
	/*************MIPI output setting************/
...
{
	LOG_INF("%s hd 240 fps E! currefps\n", __func__);
	/*************MIPI output setting************/
