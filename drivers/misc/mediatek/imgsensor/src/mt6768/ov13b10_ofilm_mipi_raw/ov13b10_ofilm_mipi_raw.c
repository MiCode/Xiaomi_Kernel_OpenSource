...
#include "ov13b10_ofilm_mipi_raw.h"
#include "cam_cal_define.h"
#define PFX "ov13b10_ofilm_mipi_raw"
...
static kal_uint16 ov13b10_ofilm_table_write_cmos_sensor(
...
static void set_shutter_frame_length(kal_uint16 shutter,
    kal_uint16 frame_length, kal_uint16 auto_extend_en)
{
    unsigned long flags;
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_ofilm[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_ofilm_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_ofilm,
		sizeof(addr_data_pair_init_ov13b10_ofilm) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_ofilm[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_ofilm_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_ofilm,
		sizeof(addr_data_pair_preview_ov13b10_ofilm) /
				sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_ofilm[] = {
//	0x0100, 0x00,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_ofilm[] = {
//	0x0100, 0x00,
	0x0305, 0x42, //0x44, //0x45, //0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10_ofilm_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10_ofilm,
			sizeof(addr_data_pair_capture_15fps_ov13b10_ofilm) /
			sizeof(kal_uint16));
	} else {
		ov13b10_ofilm_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10_ofilm,
			sizeof(addr_data_pair_capture_30fps_ov13b10_ofilm) /
			sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_ofilm[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_ofilm_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_ofilm,
		sizeof(addr_data_pair_video_ov13b10_ofilm) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_ofilm[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x02,
	0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_ofilm_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_ofilm,
		sizeof(addr_data_pair_hs_video_ov13b10_ofilm) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_ofilm[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_ofilm_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_ofilm,
		sizeof(addr_data_pair_slim_video_ov13b10_ofilm) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
			...
			if (1)
			{
				*sensor_id = return_sensor_id() + 2;
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info("ov13b10_ofilm i2c write id: 0x%x, sensor id: 0x%x vendor_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					vendor_id);
					return ERROR_NONE;
				} else {
					pr_err("ov13b10_ofilm check id i2c write id: 0x%x, sensor id: 0x%x vendor_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					vendor_id);
