...
//C3J1 start
#if defined(S5KGM1SP_OFILM_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGM1SP_OFILM_MIPI_RAW,
		{
			{RST,        Vol_Low,  1},
			{AVDD,       Vol_2800, 0},
			{DVDD,       Vol_High, 0},
...
#endif
#if defined(OV13855_OFILM_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV13855_OFILM_MIPI_RAW,
		{
			{RST,        Vol_Low,  1},
			{AVDD,       Vol_High, 0},
			{DVDD,       Vol_1200, 0},
...
#endif
#if defined(OV02A10_SUNNY_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV02A10_SUNNY_MIPI_RAW,
		{
			{RST,        Vol_High,  1,  Vol_High, 0},
			{DOVDD,      Vol_1800, 1},
			{AVDD,       Vol_2800, 1},
			{SensorMCLK, Vol_High, 5},
			{RST,        Vol_Low, 9},
...
#endif
#if defined(GC2375H_OFILM_MIPI_RAW)
	{
		SENSOR_DRVNAME_GC2375H_OFILM_MIPI_RAW,
		{
			{RST,        Vol_High, 10,  Vol_High, 0},
			{DOVDD,      Vol_1800, 1},
			{AVDD,       Vol_2800, 1},
			{SensorMCLK, Vol_High, 1},
			{RST,        Vol_Low, 1},
