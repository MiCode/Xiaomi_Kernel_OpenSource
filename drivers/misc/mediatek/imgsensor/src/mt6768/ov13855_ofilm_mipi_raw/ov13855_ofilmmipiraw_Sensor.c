...
#include "ov13855_ofilmmipiraw_Sensor.h"

/***********Modify Following Strings for Debug********/
#define PFX "OV13855_OFILM_camera_sensor"
#define LOG_1 LOG_INF("OV13855_OFILM,MIPI 4LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	/*0xf86cfdf4, checksum value for Camera Auto Test */
...
static struct imgsensor_struct imgsensor = {
	...
	/* test pattern mode or not. KAL_FALSE for
	 * in test pattern mode, KAL_TRUE for normal output
	 */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	/* Preview */
{4256, 3152, 0, 8, 4232, 3144, 4232, 3144,
...
{4256, 3152, 0, 8, 4232, 3144, 4232, 3144,
	16, 8, 4224, 3136, 0, 0, 4224, 3136},
	/* hs video */
{4256, 3152, 64, 64, 4192, 3088, 1048, 772,
	4, 4, 1024, 768, 0, 0, 1024, 768},
	/* slim video */
{4256, 3152, 0, 8, 4256, 3144, 2128, 1572,
	8, 2, 2112, 1568, 0, 0, 2112, 1568}
};

/* add from OV13855_OFILM_v1_mirror_on_flip_off_mtk2.0.1.ini */
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	return iReg;		/* ov13855_ofilm. sensorGlobalGain */
}
	...
	if (capture_first_flag == 0) {
		...
		if (currefps == 300) {	/* 30fps for Normal capture & ZSD */
			...
			if (imgsensor.ihdr_en)
				...
				LOG_INF("imgsensor ihdr disable\n");
				/* no implementation */
		}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
		 ...
		 * read_ov13855_ofilm_eeprom((kal_uint16 )(*feature_data),
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		 ...
		 * ov13855_ofilm only full size support PDAF
		 */
		switch (*feature_data) {
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
...
UINT32 OV13855_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*    OV13855_OFILM_MIPI_RAW_SensorInit    */
