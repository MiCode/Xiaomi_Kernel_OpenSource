...
#include "s5k4h7yx_qtech_ultra_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX_QTECH_ULTRA_SENSOR_ID,
...
kal_uint16 otp_4h7_ultra_qtech_read_cmos_sensor(kal_uint32 addr)
{
...
void otp_4h7_qtech_ultra_write_cmos_sensor_8(kal_uint16 addr, kal_uint8 para)
{
	write_cmos_sensor_8(addr, para);
}

unsigned char S5K4H7_qtech_ultra_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void S5K4H7_qtech_ultra_write_cmos_sensor(u16 addr, u32 para)
{
	char pusendcmd[3] = {
		(char)(addr >> 8), (char)(addr & 0xFF), (char)(para & 0xFF) };
...
static kal_uint32 return_sensor_id(void)
{
	...
	get_byte = get_byte + 6;
	LOG_INF("s5k_ultra_qtech get_byte = %d\n", get_byte);
	return get_byte;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	*sensor_id = 0xFFFFFFFF;
	...
	LOG_INF("cxc_qtech_ultra vendor_id 0x%x\n", vendor_id);
		...
		do {
			//if (0x06 == vendor_id) {
				*sensor_id = return_sensor_id();
				LOG_INF
				    ("cxc_qtech_ultra sensor id: 0x%x, imgsensor_info.sensor_id 0x%x imgsensor.i2c_write_id: 0x%x\n",
...
UINT32 S5K4H7YX_QTECH_ULTRA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT
						**pfFunc)
{
