...
struct imgsensor_struct {
	...
	kal_uint64 current_fps;			//current max fps
...
void otp_4h7_ultra_write_cmos_sensor_8(kal_uint16 addr, kal_uint8 para);
kal_uint16 otp_4h7_ultra__read_cmos_sensor(kal_uint32 addr);
#endif
