...
#include "ov8856_qtech_ultra_mipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856_QTECH_ULTRA_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
UINT32 OV8856_QTECH_ULTRA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
