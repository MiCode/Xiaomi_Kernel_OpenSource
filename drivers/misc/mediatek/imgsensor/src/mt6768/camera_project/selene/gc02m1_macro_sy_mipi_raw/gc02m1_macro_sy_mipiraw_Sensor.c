 ...
 * Filename:
 * ---------
 *     gc02m1_sy_macro_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_MACRO_SY_SENSOR_ID,
...
kal_uint16 addr_data_pair_init_gc02m1_macro_sy[] = {
...
kal_uint16 addr_data_pair_preview_gc02m1_macro_sy[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1_macro_sy[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1_macro_sy[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1_macro_sy[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1_macro_sy[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1_macro_sy,
		sizeof(addr_data_pair_init_gc02m1_macro_sy) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1_macro_sy,
		sizeof(addr_data_pair_preview_gc02m1_macro_sy) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1_macro_sy,
		sizeof(addr_data_pair_capture_gc02m1_macro_sy) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1_macro_sy,
		sizeof(addr_data_pair_normal_video_gc02m1_macro_sy) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1_macro_sy,
		sizeof(addr_data_pair_hs_video_gc02m1_macro_sy) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1_macro_sy,
		sizeof(addr_data_pair_slim_video_gc02m1_macro_sy) /
		sizeof(kal_uint16));
}
...
UINT32 GC02M1_MACRO_SY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
