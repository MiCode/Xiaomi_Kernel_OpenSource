...
static kal_uint16
gc02m1_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(addr_data_pair_init_gc02m1,
...
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(addr_data_pair_preview_gc02m1,
...
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(addr_data_pair_capture_gc02m1,
...
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(addr_data_pair_normal_video_gc02m1,
		   sizeof
...
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(addr_data_pair_hs_video_gc02m1,
...
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(addr_data_pair_slim_video_gc02m1,
