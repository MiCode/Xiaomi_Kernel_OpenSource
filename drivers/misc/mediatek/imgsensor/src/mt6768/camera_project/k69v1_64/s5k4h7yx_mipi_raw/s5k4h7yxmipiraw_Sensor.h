 ...
 *
 ****************************************************************************/
#ifndef _S5K4H7YXMIPIRAW_SENSOR_SUNWIN_H
#define _S5K4H7YXMIPIRAW_SENSOR_SUNWIN_H
enum IMGSENSOR_MODE {
	IMGSENSOR_MODE_INIT,
...
struct imgsensor_struct {
	...
	kal_uint64 shutter;				//current shutter
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct cap1;		//capture for PIP 15fps relative information, capture1 mode must use same framelength, linelength with Capture mode for shutter calculate
	struct imgsensor_mode_struct cap2;	//capture for PIP 24fps relative information, capture1 mode must use same framelength, linelength with Capture mode for shutter calculate
