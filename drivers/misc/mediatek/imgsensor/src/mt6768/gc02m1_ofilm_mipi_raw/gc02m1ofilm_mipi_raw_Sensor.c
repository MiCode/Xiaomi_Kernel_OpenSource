...
#define PFX "GC02M1OFILM_MIPI_RAW"
#define LOG_1 LOG_INF("GC02M1OFILM,MIPI 1LANE\n")
...
static kal_uint32 return_sensor_id(void)
{
	...
	/*
	if (tmp_id == 0x2e0) {
		LOG_INF("ERROR, Set sensor id 02E0\n");
...
static void
set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length, kal_uint16 auto_extend_en)
{
	unsigned long flags;
...
{
	int i = 0;
	int otp_addr[] = { 16, 17, 18, 3, 4, 5, 6, 7, 8, 9, 10, 11 };
	kal_uint8 otp_info[12];
	write_cmos_sensor(0xfe, 0x00);
