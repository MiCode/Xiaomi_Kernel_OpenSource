...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
			...
			{
				SENSOR_DRVNAME_IMX686SUNNY_MIPI_RAW,
				{
					{RST, Vol_Low, 0},
					{AVDD, Vol_1800, 0},
					{AFVDD, Vol_2800, 0},
					{DOVDD, Vol_1800, 0},
					{DVDD, Vol_2900, 1}, //enable wide avdd
					{PDN, Vol_1100, 1},  //enable wide dvdd
			...
			{
				SENSOR_DRVNAME_IMX682SUNNY_MIPI_RAW,
				{
					{RST, Vol_Low, 1},
					{AVDD, Vol_1800, 0},
					{AFVDD, Vol_2800, 0},
		...
		{
			SENSOR_DRVNAME_S5K3T2SUNNY_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{DVDD, Vol_1100, 0},
				{AVDD, Vol_2800, 0},
		...
		{
			SENSOR_DRVNAME_S5K3T2OFILM_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{DVDD, Vol_1100, 0},
				{AVDD, Vol_2800, 0},
		...
		{
			SENSOR_DRVNAME_OV02B1BOFILM_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{DOVDD, Vol_1800, 0},
		...
		{
			SENSOR_DRVNAME_S5K5E9SUNNY_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{AVDD, Vol_2800, 0},
				{DVDD, Vol_1200, 0},
