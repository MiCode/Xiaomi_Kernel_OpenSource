...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV48B_QTECH_MAIN_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h

	.checksum_value = 0xeb587126,		//checksum value for Camera Auto Test

	.pre = {
		.pclk = 117000000,				//record different mode's pclk
		.linelength  = 1224,				//record different mode's linelength
		.framelength = 3186,			//record different mode's framelength
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
	...
	{ 8000, 6000,    160,    840, 7680, 4320, 1920, 1080,   0,     0, 1920, 1080,     0, 0, 1920, 1080}, /* hs vedio */
	{ 8000, 6000,    160,    840, 7680, 4320, 1920, 1080,   0,     0, 1920, 1080,     0, 0, 1920, 1080}, /* slim vedio */
	{8000, 6000,    0,    0, 8000, 6000, 4000, 3000,  0,  0, 4000, 3000, 0, 0, 4000, 3000},     /* Custom1 */
	{ 8000, 6000,    0,    0, 8000, 6000, 4000, 3000,   0,     0, 4000, 3000,     0, 0, 4000, 3000}, /* custom2 */
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[4] = {
    ...
    /* custom5mode setting 496(pxiel)*1296*/
    {
	0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	0x00, 0x2b, 0x0FA0, 0x08D0, 0x00, 0x00, 0x0280, 0x0001,
...
/*
struct SET_PD_BLOCK_INFO_T imgsensor_pd_info1 = {
...
{
     LOG_INF("E\n");
	table_write_cmos_sensor(ov48bofilm_normal_video_setting,
		sizeof(ov48bofilm_normal_video_setting) / sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov48bofilm_slim_video_setting,
			sizeof(ov48bofilm_slim_video_setting) / sizeof(kal_uint16));
}
...
static kal_uint8 get_vendor_id(void)
{
     ...
     char pusendcmd[2] = {(char)(0x00), (char)(0x01 & 0xFF) };
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("%s: vendor_id: 0x%x,\n", __func__, vendor_id);
	if (vendor_id != 0x06) {
		LOG_INF("%s: vendor_id(0x%x) is not same with 0x06\n", __func__, vendor_id);
...
UINT32 OV48B_QTECH_MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("OV48B_MIPI_RAW_SensorInit in\n");
