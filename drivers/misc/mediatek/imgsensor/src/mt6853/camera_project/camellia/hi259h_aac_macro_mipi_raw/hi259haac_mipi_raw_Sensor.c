...
#include "hi259haac_mipi_raw_Sensor.h"

#define PFX "hi259aac_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI259H_AAC_MACRO_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	return (1 + read_cmos_sensor(0x04));     //FIXME: optimize code
}
...
UINT32 HI259H_AAC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
