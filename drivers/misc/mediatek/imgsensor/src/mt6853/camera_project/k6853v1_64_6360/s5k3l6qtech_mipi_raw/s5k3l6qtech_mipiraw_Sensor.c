...
#define PFX "S5K3l6qtech_camera_sensor"
...
#include "s5k3l6qtech_mipiraw_Sensor.h"
...
#define S5K3L6_QTECH_EEPROM_CALI
#if MULTI_WRITE
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = S5K3L6QTECH_SENSOR_ID,
...
#ifdef S5K3L6_QTECH_EEPROM_CALI
                ...
                do {
                    if (vendorId == 0x06) {
                        *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) + 1;
                        pr_err("s5k3l6_qtech_sensor_id:0x%x==0x%x",*sensor_id,imgsensor_info.sensor_id);
                        if (*sensor_id == imgsensor_info.sensor_id) {
//                                hw_info_main_otp.sensor_name = SENSOR_DRVNAME_S5K3L6_QTECH_MIPI_RAW;
/*
#ifdef S5K3L6_QTECH_EEPROM_CALI
...
*/
                        ...
                        pr_err("s5k3l6 qtech vendor id not match :0x%x", vendorId);
                    }
...
UINT32 S5K3L6QTECH_MIPI_RAW_SensorInit(
