...
#include "ov8856ofilm_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = OV8856OFILM_SENSOR_ID,                //record sensor id defined in Kd_imgsensor.h
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
 ...
 //{ 3296, 2480,          0,        12, 3296, 2456, 1648, 1228,   8,        2, 1632, 1224,         0, 0, 1632, 1224}, // custom1 
// { 3296, 2480,    0,        12, 3296, 2456, 3296, 2456,   16,        4, 3264, 2448,         0, 0, 3264, 2448}, // capture
 { 3296, 2480,          0,        12, 3296, 2456, 1648, 1228,   8,        2, 1632, 1224,         0, 0, 1632, 1224}, // Preview
};
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
        ...
        dummy_line = frame_length - imgsensor.frame_length;
                imgsensor.min_frame_length = imgsensor.frame_length + dummy_line;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
        kal_uint8 i = 0;
        kal_uint8 retry = 2;
        LOG_INF("OV8856OFILM get_imgsensor_id in\n");
...
UINT32 OV8856OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("OV8856OFILM_MIPI_RAW_SensorInit in\n");
        /* To Do : Check Sensor status here */
        if (pfFunc != NULL)
                *pfFunc = &sensor_func;
        return ERROR_NONE;
}        /*        OV8856OFILM_MIPI_RAW_SensorInit        */
