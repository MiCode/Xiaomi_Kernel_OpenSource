...
#include "ov02b10aacofilm_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV02B10AACOFILM_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
    ...
    if(1 == s5kgm1st_ofilm_or_qtech)
       sensor_id += 2;
    LOG_INF("s5kgm1st_ofilm_or_qtech = %d\n",s5kgm1st_ofilm_or_qtech);
    return sensor_id;
}
...
unsigned int
ov02b10aacofilm_read_otp_info(struct i2c_client *client,
...
UINT32 OV02B10AACOFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
