...
#define PFX "MAIN[F8D2]_camera_sensor"
...
#include "s5kgm1stqtech_mipiraw_Sensor.h"

//#include "s5kgm1st_qtech_mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM1STQTECH_SENSOR_ID,
		...
		do {
                    if (vendor_id == 0x06) {
                        ...
                        *sensor_id = read_cmos_sensor_16_16(0x0000) + 1;
                        ...
                        PK_DBG("s5kgm1st qtech vendor id not match 0x%x \n", vendor_id);
                    }
...
UINT32 S5KGM1STQTECH_MIPI_RAW_SensorInit(
