...
#include "hi259aac_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI259AAC_SENSOR_ID, //HI259_SENSOR_ID,  /*sensor_id = 0x00E1*/ //record sensor id defined in Kd_imgsensor.h
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi259aac[] = {
0x03, 0x00,
0x01, 0x01,
0x01, 0x03,
0x01, 0x01,
...
static void sensor_init(void)
{
	...
	hi259_table_write_cmos_sensor(
		addr_data_pair_init_hi259aac,
		sizeof(addr_data_pair_init_hi259aac) /
		sizeof(kal_uint16));
#else
    write_cmos_sensor(0x03, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi259aac[] = {
...
#if MULTI_WRITE
	hi259_table_write_cmos_sensor(
		addr_data_pair_preview_hi259aac,
		sizeof(addr_data_pair_preview_hi259aac) /
		sizeof(kal_uint16));
#else
    write_cmos_sensor(0x03, 0x00);
    write_cmos_sensor(0x07, 0x05);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_hi259aac[] = {
...
kal_uint16 addr_data_pair_capture_15fps_hi259aac[] = {
0x03, 0x00,
0x01, 0x01,
};
#endif
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi259_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi259aac,
		sizeof(addr_data_pair_capture_30fps_hi259aac) /
		sizeof(kal_uint16));

	} else {
	hi259_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_hi259aac,
		sizeof(addr_data_pair_capture_15fps_hi259aac) /
		sizeof(kal_uint16));
	}
#else
  if( currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi259aac[] = {
0x03, 0x00,
0x07, 0x05,
0x08, 0x62,
0x09, 0x13,
...
#if MULTI_WRITE
	hi259_table_write_cmos_sensor(
		addr_data_pair_video_hi259aac,
		sizeof(addr_data_pair_video_hi259aac) /
		sizeof(kal_uint16));
#else
    write_cmos_sensor(0x03, 0x00);
    write_cmos_sensor(0x07, 0x05);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi259aac[] = {
0x03, 0x00,
0x01, 0x01,
};
#endif
...
#if MULTI_WRITE
	hi259_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi259aac,
		sizeof(addr_data_pair_hs_video_hi259aac) /
		sizeof(kal_uint16));
#else
    write_cmos_sensor(0x03, 0x00);
    write_cmos_sensor(0x01, 0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi259aac[] = {
0x03, 0x00,
0x01, 0x01,
};
#endif
...
#if MULTI_WRITE
	hi259_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi259aac,
		sizeof(addr_data_pair_slim_video_hi259aac) /
		sizeof(kal_uint16));
#else
    write_cmos_sensor(0x03, 0x00);
    write_cmos_sensor(0x01, 0x01);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			return ERROR_NONE;
                        ...
                        LOG_INF("hi259 aac vendor id not match : 0x%x\n", vendor_id);
                    }
