...
static kal_uint32 return_sensor_id(void)
{
	...
	if (VENDOR_ID == imgsensor.vendor_id)
		sensor_id = S5K4H7OFILM_SENSOR_ID;
	else
		sensor_id = 0xFFFF;
	printk("[%s] s5k4h7ofilm sensor_id: 0x%x vendor_id: 0x%x", __func__, sensor_id, imgsensor.vendor_id);
...
{
	LOG_INF("start \n");
	table_write_cmos_sensor(s5k4h7ofilm_custom1_setting,
		sizeof(s5k4h7ofilm_custom1_setting) / sizeof(kal_uint16));
}
