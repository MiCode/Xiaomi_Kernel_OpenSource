...
#include "imx766ofilmmipiraw_Sensor.h"
//#include "imx766ofilm_eeprom.h"
...
#define PFX "IMX766OFILM_camera_sensor"
/****************************   Modify end	**************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX766OFILM_SENSOR_ID,
...
static kal_uint16 imx766ofilm_QSC_setting[3072 * 2];
...
static kal_uint16 imx766ofilm_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 imx766ofilm_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
	char puSendCmd[I2C_BUFFER_LEN];
	kal_uint32 tosend, IDX;
...
static void imx766ofilm_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx766ofilm_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	imx766ofilm_table_write_cmos_sensor(regDa, regNum*2);
}
...
static void read_sensor_Cali(void)
{
	...
	for (idx = 0; idx < 3072; idx++) {
		...
		imx766ofilm_QSC_setting[2 * idx] = sensor_qsc;
		imx766ofilm_QSC_setting[2 * idx + 1] =
...
static void write_sensor_QSC(void)
{
	...
	if ((otp_flag == OTP_QSC_CUSTOM) || (otp_flag == OTP_QSC_INTERNAL)) {
		imx766ofilm_table_write_cmos_sensor(imx766ofilm_QSC_setting,
		sizeof(imx766ofilm_QSC_setting) / sizeof(kal_uint16));
	}
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (imgsensor.vendor_id == VENDOR_ID)
		...
		sensor_id = 0xFFFF;
	printk("[%s]imx766ofilm sensor_id: 0x%x vendor_id: 0x%x", __func__, sensor_id, imgsensor.vendor_id);
	return sensor_id;
}
...
#define IMX766OFILM_GAIN_TABL_SIZE 432
kal_uint16 imx766ofilm_gain_ratio[IMX766OFILM_GAIN_TABL_SIZE] = {
	64,
	65,
	66,
	67,
...
kal_uint16 imx766ofilm_gain_reg[IMX766OFILM_GAIN_TABL_SIZE] = {
	0,
	240,
	496,
	720,
...
#ifdef USE_GAIN_TABLE
	reg_gain = imx766ofilm_gain_reg[IMX766OFILM_GAIN_TABL_SIZE - 1];
	for (i = 0; i < IMX766OFILM_GAIN_TABL_SIZE; i++) {
		if (gain_value <= imx766ofilm_gain_ratio[i]) {
			reg_gain = imx766ofilm_gain_reg[i];
			break;
		}
	}
#else
...
{
	LOG_INF("E\n");
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_init_setting,
		sizeof(imx766ofilm_init_setting)/sizeof(kal_uint16));
...
static void preview_setting(void)
{
	LOG_INF("E\n");
		...
		imx766ofilm_table_write_cmos_sensor(imx766ofilm_preview_setting,
		sizeof(imx766ofilm_preview_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_normal_video_setting,
	sizeof(imx766ofilm_normal_video_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("E\n");
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_hs_video_setting,
	sizeof(imx766ofilm_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
{
	//LOG_INF("%s E! currefps:%d\n", __func__, currefps);
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_custom5_setting,
	sizeof(imx766ofilm_custom5_setting)/sizeof(kal_uint16));
...
static void custom1_setting(void)
{
	...
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_custom1_setting,
		sizeof(imx766ofilm_custom1_setting)/sizeof(kal_uint16));
...
static void custom2_setting(void)
{
	...
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_custom2_setting,
		sizeof(imx766ofilm_custom2_setting)/sizeof(kal_uint16));
...
static void custom3_setting(void)
{
	...
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_custom3_setting,
		sizeof(imx766ofilm_custom3_setting)/sizeof(kal_uint16));
...
static void custom4_setting(void)
{
	...
	imx766ofilm_table_write_cmos_sensor(imx766ofilm_custom4_setting,
		sizeof(imx766ofilm_custom4_setting)/sizeof(kal_uint16));
...
static kal_uint32 imx766ofilm_ana_gain_table[] = {
	100000,
	100098,
	100196,
	100294,
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(imx766ofilm_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)imx766ofilm_ana_gain_table,
			sizeof(imx766ofilm_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_GET_STAGGER_MAX_EXP_TIME:
		if (*feature_data == MSDK_SCENARIO_ID_CUSTOM2
			...
			// see IMX766OFILM SRM, table 5-22 constraints of COARSE_INTEG_TIME
			switch (*(feature_data + 1)) {
			case VC_STAGGER_NE:
			case VC_STAGGER_ME:
			case VC_STAGGER_SE:
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx766ofilm_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		 ...
		 *	(*feature_para_len));
		 */
		imx766ofilm_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
...
UINT32 IMX766OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* IMX766OFILM_MIPI_RAW_SensorInit */
