...
#include "ov16a1qsunnymipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16A1QSUNNY_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (VENDOR_ID == imgsensor.vendor_id)
		sensor_id = OV16A1QSUNNY_SENSOR_ID;
		...
		UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 2900000;
		break;
...
UINT32 OV16A1QSUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("OV16A1QSUNNY_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV16A1QSUNNY_MIPI_RAW_SensorInit	*/
