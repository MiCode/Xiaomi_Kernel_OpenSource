...
#include "hi1337ofilmmipiraw_Sensor.h"

#define PFX "hi1337ofilm_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1337OFILM_SENSOR_ID,
...
static kal_uint16 hi1337ofilm_table_write_cmos_sensor(
...
{
#if MULTI_WRITE
	hi1337ofilm_table_write_cmos_sensor(
		addr_data_pair_init_hi1337ofilm,
		sizeof(addr_data_pair_init_hi1337ofilm) /
		sizeof(kal_uint16));
#endif
}
...
{
	LOG_INF("hi1337ofilm enter loading capture_setting\n");
#if MULTI_WRITE
	hi1337ofilm_table_write_cmos_sensor(
		addr_data_pair_cap_hi1337ofilm,
		sizeof(addr_data_pair_cap_hi1337ofilm) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi1337ofilm[] = {
...
#if MULTI_WRITE
	hi1337ofilm_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1337ofilm,
		sizeof(addr_data_pair_hs_video_hi1337ofilm) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi1337ofilm[] = {
...
{
	printk("hi1337ofilm enter loading video_setting\n");
#if MULTI_WRITE
	hi1337ofilm_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1337ofilm,
		sizeof(addr_data_pair_slim_video_hi1337ofilm) /
		sizeof(kal_uint16));
#endif
}
...
UINT32 HI1337OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	HI1337OFILM_MIPI_RAW_SensorInit	*/
