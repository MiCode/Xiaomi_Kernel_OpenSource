 ...
 * Filename:
 * ---------
 *	 ov50d40_truly_main_i_mipi_raw.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _OV50D40_TRULY_MAIN_I_MIPI_RAW_H
#define _OV50D40_TRULY_MAIN_I_MIPI_RAW_H
...
typedef struct imgsensor_struct {
	...
	kal_uint32 lastshutter; 			//wt.fanbingyang add for blue screen 2023/4/4
