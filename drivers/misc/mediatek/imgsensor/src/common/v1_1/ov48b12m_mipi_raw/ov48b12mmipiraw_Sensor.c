 ...
 * Setting version:
 * ------------
 *   update full pd setting for OV48B12M2QEB_03B
 *------------------------------------------------------------------------------
 * Upper this line, this part is controlled by CC/CQ. DO NOT MODIFY!!
 *============================================================================
 ****************************************************************************/

#define PFX "OV48B12M2Q_camera_sensor"
...
#include "ov48b12mmipiraw_Sensor.h"
#include "ov48b12m_Sensor_setting.h"

#define _I2C_BUF_SIZE 4096
kal_uint16 _i2c_data_ov48b12m[_I2C_BUF_SIZE];
unsigned int _size_to_write_ov48b12m;
bool _is_seamless_ov48b12m;
#define SEAMLESS_ 1
...
static kal_uint16 ov48b12m2q_table_write_cmos_sensor(
...
static kal_uint16 ov48b12m2q_burst_write_cmos_sensor(
					kal_uint16 *para, kal_uint32 len)
{
	char puSendCmd[I2C_BUFFER_LEN];
	kal_uint32 tosend, IDX;
...
static void set_dummy(void)
{
	...
	if (!_is_seamless_ov48b12m) {
		...
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x3840;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = imgsensor.frame_length >> 16;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x380e;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = imgsensor.frame_length >> 8;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x380f;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = imgsensor.frame_length & 0xFF;
	}
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if (imgsensor.autoflicker_en == KAL_TRUE) {
		...
		if (realtime_fps >= 297 && realtime_fps <= 305) {
			...
			if (!_is_seamless_ov48b12m) {
				...
				//_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x3840;
				//_i2c_data_ov48b12m[_size_to_write_ov48b12m++] =
								//imgsensor.frame_length >> 16;
				_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x380e;
				_i2c_data_ov48b12m[_size_to_write_ov48b12m++] =
	...
	if (!_is_seamless_ov48b12m) {
		...
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x380f;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = imgsensor.frame_length & 0xFF;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x3500;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = (shutter >> 16) & 0xFF;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x3501;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = (shutter >> 8) & 0xFF;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x3502;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = (shutter)  & 0xFF;
	}
	pr_debug("shutter =%d, framelength =%d, realtime_fps =%d _is_seamless_ov48b12m %d\n",
		shutter, imgsensor.frame_length, realtime_fps, _is_seamless_ov48b12m);
#endif
}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (!_is_seamless_ov48b12m) {
		...
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x03508;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] =  reg_gain >> 8;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] = 0x03509;
		_i2c_data_ov48b12m[_size_to_write_ov48b12m++] =  reg_gain & 0xff;
	}
#endif
	return gain;
}
...
static void sensor_init(void)
{
	...
	mdelay(5);
	LOG_INF("[%s] ov48b12m sensor init start\n", __func__);
	ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_init_ov48b12m2q,
		sizeof(addr_data_pair_init_ov48b12m2q) / sizeof(kal_uint16));
	LOG_INF("[%s] ov48b12m sensor init end\n", __func__);
}
...
static void preview_setting(void)
{
	...
	_length = sizeof(addr_data_pair_preview_ov48b12m2q) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
			addr_data_pair_preview_ov48b12m2q,
			_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);

		if (_size_to_write_ov48b12m + _length > _I2C_BUF_SIZE) {
			pr_debug("_too much i2c data for fast siwtch %d\n",
				_size_to_write_ov48b12m + _length);
			return;
		}
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_preview_ov48b12m2q,
			sizeof(addr_data_pair_preview_ov48b12m2q));
		_size_to_write_ov48b12m += _length;
	}
	pr_debug("[%s] RES_4000x3000_60fps end\n", __func__);
}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	_length = sizeof(addr_data_pair_capture_ov48b12m2q) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
			addr_data_pair_capture_ov48b12m2q,
			_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_capture_ov48b12m2q,
			sizeof(addr_data_pair_capture_ov48b12m2q));
		_size_to_write_ov48b12m += _length;
	}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	_length = sizeof(addr_data_pair_video_ov48b12m2q) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
			addr_data_pair_video_ov48b12m2q,
			_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_video_ov48b12m2q,
			sizeof(addr_data_pair_video_ov48b12m2q));
		_size_to_write_ov48b12m += _length;
	}
...
static void hs_video_setting(void)
{
	...
	_length = sizeof(addr_data_pair_hs_video_ov48b12m2q) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov48b12m2q,
		_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_hs_video_ov48b12m2q,
			sizeof(addr_data_pair_hs_video_ov48b12m2q));
		_size_to_write_ov48b12m += _length;
	}
...
static void slim_video_setting(void)
{
	...
	_length = sizeof(addr_data_pair_slim_video_ov48b12m2q) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov48b12m2q,
		_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_slim_video_ov48b12m2q,
			sizeof(addr_data_pair_slim_video_ov48b12m2q));
		_size_to_write_ov48b12m += _length;
	}
...
static void custom1_setting(void)
{
	...
	_length = sizeof(addr_data_pair_custom1_ov48b12m) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_custom1_ov48b12m,
		_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_custom1_ov48b12m,
			sizeof(addr_data_pair_custom1_ov48b12m));
		_size_to_write_ov48b12m += _length;
	}
...
static void custom2_setting(void)
{
	...
	_length = sizeof(addr_data_pair_custom2_ov48b12m) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_custom2_ov48b12m,
		_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_custom2_ov48b12m,
			sizeof(addr_data_pair_custom2_ov48b12m));
		_size_to_write_ov48b12m += _length;
	}
	pr_debug("custom1_setting_end\n");
}	/*	custom2_setting  */

#ifndef CUSTOM3_TO_PREV
static void custom3_setting(void)
{
	int _length = 0;

	pr_debug("custom3_setting_start\n");
	pr_debug("E\n");
	ov48b12m2q_burst_write_cmos_sensor(addr_data_pair_xtalk_ov48b12m2q,
		sizeof(addr_data_pair_xtalk_ov48b12m2q)/sizeof(kal_uint16));

	_length = sizeof(addr_data_pair_custom3_ov48b12m) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_custom3_ov48b12m,
		_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_custom3_ov48b12m,
			sizeof(addr_data_pair_custom3_ov48b12m));
		_size_to_write_ov48b12m += _length;
	}
	pr_debug("custom1_setting_end\n");
}	/*	custom3_setting  */
...
static void custom4_setting(void)
{
	...
	_length = sizeof(addr_data_pair_custom4_ov48b12m) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_custom4_ov48b12m,
		_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_custom4_ov48b12m,
			sizeof(addr_data_pair_custom4_ov48b12m));
		_size_to_write_ov48b12m += _length;
	}
...
static void custom5_setting(void)
{
	...
	pr_debug("custom5_setting_start\n");
	pr_debug("E\n");
	_length = sizeof(addr_data_pair_custom5_ov48b12m) / sizeof(kal_uint16);
	if (!_is_seamless_ov48b12m) {
		ov48b12m2q_table_write_cmos_sensor(
		addr_data_pair_custom5_ov48b12m,
		_length);
	} else {
		pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
		...
		memcpy((void *) (_i2c_data_ov48b12m + _size_to_write_ov48b12m),
			addr_data_pair_custom5_ov48b12m,
			sizeof(addr_data_pair_custom5_ov48b12m));
		_size_to_write_ov48b12m += _length;
	}
	pr_debug("custom5_setting_end\n");
}	/*	custom5_setting  */
...
static kal_uint16 ov48b12m_PDC_setting[8*2];
static kal_uint16 ov48b12m_PDC_setting_burst[720*2];
...
static void read_sensor_Cali(void)
{
	...
	for (idx = 0; idx < 8; idx++) {
		...
		ov48b12m_PDC_setting[2 * idx] = sensor_PDC_addr1;
		ov48b12m_PDC_setting[2 * idx + 1] =
			read_cmos_eeprom_8(eeprom_PDC_addr);
	}
	for (idx = 8; idx < 728; idx++) {
		eeprom_PDC_addr = 0x1638 + idx;
		sensor_PDC_addr2 = 0x5900 + idx - 8;
		ov48b12m_PDC_setting_burst[2 * (idx-8)] = sensor_PDC_addr2;
		ov48b12m_PDC_setting_burst[2 * (idx-8) + 1] =
			read_cmos_eeprom_8(eeprom_PDC_addr);
	}
}
...
{
	ov48b12m2q_table_write_cmos_sensor(ov48b12m_PDC_setting,
		sizeof(ov48b12m_PDC_setting)/sizeof(kal_uint16));
	ov48b12m2q_burst_write_cmos_sensor(ov48b12m_PDC_setting_burst,
		sizeof(ov48b12m_PDC_setting_burst)/sizeof(kal_uint16));
}
	...
	kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
	...
	int k = 0;
#endif
	_is_seamless_ov48b12m = true;
	memset(_i2c_data_ov48b12m, 0x0, sizeof(_i2c_data_ov48b12m));
	_size_to_write_ov48b12m = 0;

	pr_debug("%s %d, %d, %d, %d, %d sizeof(_i2c_data_ov48b12m) %d\n", __func__,
		scenario_id, shutter, gain, shutter_2ndframe,
			gain_2ndframe, sizeof(_i2c_data_ov48b12m));

	_length = sizeof(addr_data_pair_seamless_switch_step1_ov48b12m2q) / sizeof(kal_uint16);
	...
	memcpy((void *)(_i2c_data_ov48b12m + _size_to_write_ov48b12m),
		addr_data_pair_seamless_switch_step1_ov48b12m2q,
		sizeof(addr_data_pair_seamless_switch_step1_ov48b12m2q));
	_size_to_write_ov48b12m += _length;
	...
	_length = sizeof(addr_data_pair_seamless_switch_step2_ov48b12m2q) / sizeof(kal_uint16);
	...
	memcpy((void *)(_i2c_data_ov48b12m + _size_to_write_ov48b12m),
		addr_data_pair_seamless_switch_step2_ov48b12m2q,
		sizeof(addr_data_pair_seamless_switch_step2_ov48b12m2q));
	_size_to_write_ov48b12m += _length;
	...
	_length = sizeof(addr_data_pair_seamless_switch_step3_ov48b12m2q) / sizeof(kal_uint16);
	if (_size_to_write_ov48b12m + _length > _I2C_BUF_SIZE) {
		pr_debug("_too much i2c data for fast siwtch\n");
		return ERROR_NONE;
	}
	memcpy((void *)(_i2c_data_ov48b12m + _size_to_write_ov48b12m),
		addr_data_pair_seamless_switch_step3_ov48b12m2q,
		sizeof(addr_data_pair_seamless_switch_step3_ov48b12m2q));
	_size_to_write_ov48b12m += _length;

	pr_debug("%s _is_seamless_ov48b12m %d, _size_to_write_ov48b12m %d\n",
			__func__, _is_seamless_ov48b12m, _size_to_write_ov48b12m);
#if SEAMLESS_NO_USE
	for (k = 0; k < _size_to_write_ov48b12m; k += 2)
		pr_debug("k = %d, 0x%04x , 0x%02x\n",
			k,  _i2c_data_ov48b12m[k], _i2c_data_ov48b12m[k+1]);

#endif
	ov48b12m2q_table_write_cmos_sensor(
		_i2c_data_ov48b12m,
		_size_to_write_ov48b12m);
	...
	for (k = 0; k < _size_to_write_ov48b12m; k += 2)
		pr_debug("k = %d, 0x%04x , 0x%02x\n",
			k,  _i2c_data_ov48b12m[k], read_cmos_sensor(_i2c_data_ov48b12m[k]));

#endif
	_is_seamless_ov48b12m = false;
	pr_debug("exit\n");
	return ERROR_NONE;
}
