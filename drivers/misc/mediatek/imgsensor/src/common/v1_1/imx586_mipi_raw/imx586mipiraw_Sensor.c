...
#define CUS1_12M_60_FPS 0/* 0:CUS1_12M_100_FPS, 1:CUS1_12M_60_FPS */
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if (shutter >
		...
		if (longexposure_times > MAX_CIT_LSHIFT) {
			LOG_INF(
			    "Unable to set such a long exposure %d, set to max\n",
			    shutter);
			longexposure_times = MAX_CIT_LSHIFT;
		}
		...
		write_cmos_sensor_8(0x3100,
			read_cmos_sensor(0x3100) | (longexposure_times & 0x7));
		write_cmos_sensor_8(0x0104, 0x00);
	} else {
		write_cmos_sensor_8(0x0104, 0x01);
