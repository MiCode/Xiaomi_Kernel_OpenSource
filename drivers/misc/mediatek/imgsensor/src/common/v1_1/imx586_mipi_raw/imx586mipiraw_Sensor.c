...
static kal_uint16 imx586_shutter_initialize;
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.normal_video = { /*reg_D Full 16:9 @30fps*/
		.pclk = 1728000000,
		.linelength = 9440,
		.framelength = 6101,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 8000,
		.grabwindow_height = 4512,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 1594290000,
		.max_framerate = 300,
	},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{8000, 6000, 0000,  744, 8000, 4512, 8000, 4512,
	 0000, 0000, 8000, 4512,    0,    0, 8000, 4512}, /* video */
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[3] = {
	...
	{0x02, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 ...
	 0x00, 0x34, 0x026C, 0x08C0, 0x00, 0x00, 0x0000, 0x0000}
};
