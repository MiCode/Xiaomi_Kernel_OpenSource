...
#include "ov16a1q_sunny_front_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16A1Q_SUNNY_FRONT_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
/* N17 code for HQ-291083 by yangchangyun at 2023/05/30 start */
	.normal_video = {
		.pclk = 100000000,
		.linelength  = 850,
		.framelength = 3920,
...
/* N17 code for HQ-291083 by yangchangyun at 2023/05/30 end */
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 290400000,
	},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
 ...
 /* N17 code for HQ-291083 by yangchangyun at 2023/05/30 start */
 { 4656, 3496, 0, 0,   4656, 3496, 2328, 1748,   12, 226,  2304, 1296, 0, 0, 2304, 1296 },//normal-video
 /* N17 code for HQ-291083 by yangchangyun at 2023/05/30 end */
...
static kal_uint32 return_sensor_id(void)
{
        ...
        printk("[%s] sensor_id: 0x%x vendor_id: 0x%x sensorinfo_id: 0x%x", __func__, sensor_id, imgsensor.vendor_id,imgsensor_info.sensor_id);
	if ((VENDOR_ID == imgsensor.vendor_id) && ((sensor_id)== imgsensor_info.sensor_id))
{
            sensor_id = OV16A1Q_SUNNY_FRONT_SENSOR_ID;	
        printk("[%s] sensor_id: 0x%x", __func__, sensor_id);
}
	else
			sensor_id = 0;
        return sensor_id;
...
#if MULTI_WRITE
static const int I2C_BUFFER_LEN = 255; /*trans# max is 255, each 4 bytes*/
#else
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(ov16a1qsunny_init_setting,
			sizeof(ov16a1qsunny_init_setting) / sizeof(kal_uint16));
}	/*	sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qsunny_preview_setting,
		sizeof(ov16a1qsunny_preview_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void capture_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qsunny_capture_setting,
		sizeof(ov16a1qsunny_capture_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
/* N17 code for HQ-291083 by yangchangyun at 2023/05/30 start */
	table_write_cmos_sensor(ov16a1qsunny_normal_video_setting,
		sizeof(ov16a1qsunny_normal_video_setting) / sizeof(kal_uint16));
/* N17 code for HQ-291083 by yangchangyun at 2023/05/30 end */
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qsunny_hs_video_setting,
		sizeof(ov16a1qsunny_hs_video_setting) / sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov16a1qsunny_custom1_setting,
		sizeof(ov16a1qsunny_custom1_setting) / sizeof(kal_uint16));
}

static void custom2_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov16a1qsunny_custom2_setting,
		sizeof(ov16a1qsunny_custom2_setting) / sizeof(kal_uint16));
}
/*************************************************************************
* FUNCTION
*	get_imgsensor_id
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	LOG_INF("OV16A1QSUNNY get_imgsensor_id in\n");
...
{
    LOG_INF("OV16A1Q_SUNNY_FRONT_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV16A1Q_SUNNY_FRONT_MIPI_RAW_SensorInit	*/
