...
wl2866_ldo_pin_map_t wl2866_ldo_pin_map[] = {
	{ IMGSENSOR_SENSOR_IDX_MAIN, IMGSENSOR_HW_PIN_AVDD, WL2866_LDO_AVDD1},//2.2V 2.8
	{ IMGSENSOR_SENSOR_IDX_MAIN, IMGSENSOR_HW_PIN_DVDD, WL2866_LDO_DVDD1},//1.0 1.1 V
	{ IMGSENSOR_SENSOR_IDX_MAIN, IMGSENSOR_HW_PIN_DVDD1, WL2866_LDO_DVDD1},//1.2V
	...
	{ IMGSENSOR_SENSOR_IDX_MAIN2, IMGSENSOR_HW_PIN_AVDD, WL2866_LDO_AVDD2},//2.8V  ULTRA Depth
	{ IMGSENSOR_SENSOR_IDX_MAIN2, IMGSENSOR_HW_PIN_DVDD, WL2866_LDO_DVDD2},//1.2V ULTRA

	{ IMGSENSOR_SENSOR_IDX_SUB2, IMGSENSOR_HW_PIN_AVDD, WL2866_LDO_AVDD2},//2.8V Depth
	{ IMGSENSOR_SENSOR_IDX_SUB2, IMGSENSOR_HW_PIN_DVDD, WL2866_LDO_DVDD2},//2.8V Marco
};
...
wl2866_ldo_votage_map_t wl2866_ldo_avdd_votage_map[] = {
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_0, 0x00},//1.2V
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_2500, 0x50},//2.2V  2.2007
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_2800, 0x80},//2.8V  2.7980

};

wl2866_ldo_votage_map_t wl2866_ldo_dvdd_votage_map[] = {
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_0, 0x00},//0.6V
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_1000, 0x42},// 0.996V  0.995
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_1100, 0x53},//1.098V   1.0962
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_1200, 0x64},//1.2V        1.1985
