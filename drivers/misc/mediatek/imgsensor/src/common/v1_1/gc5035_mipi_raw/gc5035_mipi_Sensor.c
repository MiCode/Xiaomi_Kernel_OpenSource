...
#include "gc5035_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc5035_camera_sensor"
#define LOG_1 LOG_INF("GC5035MIPI, 1LANE\n")
/****************************   Modify end    *******************************************/
#define USE_2M_SETTINGS                   0

#define GC5035_DEBUG 0
#if GC5035_DEBUG
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.cap = {
		.pclk = 86400000,
		.linelength = 1460,//2920
		.framelength = 2008,//1252
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1296,//1600
		.grabwindow_height = 972,//1200
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 86400000,
		.max_framerate = 300,
	},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 1296, 972,   0,   0, 1296, 972, 1296,  972, 0, 0, 1296,  972, 0, 0, 1296,  972 },
	{ 1296, 972,   0,   0, 1296, 972, 1296,  972, 0, 0, 1296,  972, 0, 0, 1296,  972 },
	{ 1296, 972,   0,   0, 1296, 972, 1296,  972, 0, 0, 1296,  972, 0, 0, 1296,  972 },
	{ 1296, 972,   0,   0, 1296, 972, 1296,  972, 0, 0, 1296,  972, 0, 0, 1296,  972 },
	{ 1296, 972,   0,   0, 1296, 972, 1296,  972, 0, 0, 1296,  972, 0, 0, 1296,  972 }
			...
			kal_uint16 frame_length)
{
	...
	kal_uint32 cal_frame_length =imgsensor.frame_length;
	...
	if (imgsensor.autoflicker_en) {
		...
		if (realtime_fps >= 297 && realtime_fps <= 305)
			...
			// Extend frame length
			cal_frame_length = imgsensor.frame_length >> 2;

			cal_frame_length = cal_frame_length << 2;
			write_cmos_sensor(0xfe, 0x00);
			write_cmos_sensor(0x41, (cal_frame_length >> 8) & 0x3f);
			write_cmos_sensor(0x42, cal_frame_length & 0xff);
		}
	} else {
		// Extend frame length
		cal_frame_length = imgsensor.frame_length >> 2;
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x04, 0x58);
	write_cmos_sensor(0x41, 0x07);
	write_cmos_sensor(0x42, 0xcc);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x42, 0xe4);
	write_cmos_sensor(0x05, 0x02);
	write_cmos_sensor(0x06, 0xda);
	write_cmos_sensor(0x9d, 0x0c);
	write_cmos_sensor(0x09, 0x01);
	write_cmos_sensor(0x0a, 0x78);
	write_cmos_sensor(0x0b, 0x00);
	write_cmos_sensor(0x0c, 0x03);
	...
	write_cmos_sensor(0x97, 0x0a);
	write_cmos_sensor(0x98, 0x32);
	write_cmos_sensor(0x99, 0x04);
	write_cmos_sensor(0x9a, 0xc1);
