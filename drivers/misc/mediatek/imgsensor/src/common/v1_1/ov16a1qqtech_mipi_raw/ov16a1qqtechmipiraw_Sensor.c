...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16A1QQTECH_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
   ...
   .custom2 = {//2304x1728@24fps
	...
	.gain_step = 1,
	.gain_type = 1,
	.max_frame_length = 0x7ff6,//max framelength by sensor register's limitation
	...
	.custom2_delay_frame = 3,//enter slim video delay frame num
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
 ...
 { 4656, 3496, 0, 0,   4656, 3496, 2328, 1748,  204, 334, 1920, 1080, 0, 0, 1920, 1080 },//hs-video
 { 4656, 3496, 0, 0,   4656, 3496, 2328, 1748,   12, 10,  2304, 1728, 0, 0, 2304, 1728 },// slim video
 { 4656, 3496, 0, 0,   4656, 3496, 2328, 1748,   12, 10,  2304, 1728, 0, 0, 2304, 1728 },// custom1
 { 4656, 3496, 0, 0,   4656, 3496, 2328, 1748,   12, 10,  2304, 1728, 0, 0, 2304, 1728 },// custom2
};
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	LOG_INF("set_gain gain = %d, reg_gain = 0x%x, 0x3508=%x, 0x3509=%x\n ", gain, reg_gain,read_cmos_sensor(0x3508),read_cmos_sensor(0x3509));
...
static void ihdr_write_shutter_gain(kal_uint16 le, kal_uint16 se, kal_uint16 gain)
{
	...
	if (imgsensor.ihdr_en) {
		...
		write_cmos_sensor(0x3500, (le >> 16) & 0x0F);
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(ov16a1qqtech_init_setting,
			sizeof(ov16a1qqtech_init_setting) / sizeof(kal_uint16));
}	/*	sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qqtech_preview_setting,
		sizeof(ov16a1qqtech_preview_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(ov16a1qqtech_capture_setting,
		sizeof(ov16a1qqtech_capture_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qqtech_hs_video_setting,
		sizeof(ov16a1qqtech_hs_video_setting) / sizeof(kal_uint16));
}
...
static void custom2_setting(void)
{
    ...
    preview_setting();
    //table_write_cmos_sensor(ov16a1qofilm_custom2_setting,
    //sizeof(ov16a1qofilm_custom2_setting) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("OV16A1QQTECH get_imgsensor_id in\n");
		...
		UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 6160000;
		break;
#endif
...
UINT32 OV16A1QQTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("OV16A1QQTECH_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV16A1QQTECH_MIPI_RAW_SensorInit	*/
