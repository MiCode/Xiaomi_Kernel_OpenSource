...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.i2c_addr_table = { 0x7a, 0x5a, 0xff},

	.reg_frame_length = 0x0340,
	.reg_line_length = 0x0342,
	.reg_shutter = 0x0202,
	.reg_gain = 0x0204,
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
	...
	0, 0, 9280, 6944},   /* full size capture*/
#endif
	{9280, 6944, 0, 0, 9280, 6944, 4640, 3472, 0, 0, 4640, 3472,
	0, 0, 4640, 3472},/* Video */
...
static kal_uint32 return_sensor_id(void)
{
	...
	module_id = read_eeprom_module_id(0xA2, 0x0001);
...
static void set_dummy(void)
{
	...
	/* return; //for test */
	write_cmos_sensor(imgsensor_info.reg_frame_length, imgsensor.frame_length);
	write_cmos_sensor(imgsensor_info.reg_line_length, imgsensor.line_length);
}				/*      set_dummy  */
...
*/
		...
		//write_cmos_sensor(imgsensor_info.reg_frame_length, 0x45e2);
		//write_cmos_sensor(imgsensor_info.reg_shutter, 0x45de);
		write_cmos_sensor(imgsensor_info.reg_frame_length, (shutter>>6)+3);
		write_cmos_sensor(imgsensor_info.reg_shutter, (shutter>>6));
		...
		if (bIsLongExposure) {
			...
			write_cmos_sensor(imgsensor_info.reg_frame_length, imgsensor.frame_length);
			write_cmos_sensor(imgsensor_info.reg_shutter, shutter);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	write_cmos_sensor(imgsensor_info.reg_gain, reg_gain);
	/* write_cmos_sensor_8(imgsensor_info.reg_gain,(reg_gain>>8)); */
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable) {
		...
		if (bIsLongExposure) {
			...
			write_cmos_sensor(imgsensor_info.reg_frame_length, imgsensor.frame_length);
			write_cmos_sensor(imgsensor_info.reg_shutter, 4680);
			write_cmos_sensor(0x0702, 0x0000);
			write_cmos_sensor(0x0704, 0x0000);
			//bIsLongExposure = KAL_FALSE;
		} else {
...
void capture_setting(kal_uint16 currefps)
{
