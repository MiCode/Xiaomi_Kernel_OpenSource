 ...
 *
 ****************************************************************************/
#ifndef _S5KGW1OFILMMIPI_SENSOR_H
#define _S5KGW1OFILMMIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	/* XIAOMI: libin16 add register address --start */
	kal_uint16 reg_frame_length; /*　register of frame length address　*/
	kal_uint16 reg_line_length; /*　register of line length address　*/
	kal_uint16 reg_shutter; /* register of shutter address */
	kal_uint16 reg_gain; /* register of gain address */
	/* XIAOMI: libin16 add register address --end */
};
...
extern kal_uint16 read_eeprom_module_id(kal_uint8 saddr, kal_uint32 addr);
