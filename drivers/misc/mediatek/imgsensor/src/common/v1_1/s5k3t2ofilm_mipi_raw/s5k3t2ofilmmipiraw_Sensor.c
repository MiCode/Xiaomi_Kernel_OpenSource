...
#define PFX "S5K3T2OFILM_camera_sensor"
...
#include "s5k3t2ofilmmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3T2OFILM_SENSOR_ID,
...
UINT32 S5K3T2OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
