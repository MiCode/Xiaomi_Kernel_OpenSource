 ...
 *============================================================================
 ****************************************************************************/
#define PFX "IMX686spec25m_camera_sensor"
...
#include "imx686spec25m_eeprom.h"
...
#if USE_BURST_MODE
static kal_uint16 imx686spec25m_table_write_cmos_sensor(
		kal_uint16 *para, kal_uint32 len);
#endif
static DEFINE_SPINLOCK(imgsensor_drv_lock);

#define imx686spec25m_flag 0

#define use_capture_setting 1

#define new_init_setting 1
#define imx686spec25m_seamless_test 1

#ifdef imx686spec25m_seamless_test
#define _I2C_BUF_SIZE 4096
kal_uint16 imx686spec25m_i2c_data[_I2C_BUF_SIZE];
unsigned int imx686spec25m_size_to_write;
bool imx686spec25m_is_seamless;
#endif

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX686SPEC25M_SENSOR_ID,
...
static void imx686spec25m_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx686spec25m_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static kal_uint16 imx686spec25m_QSC_setting[3024 * 2];
static kal_uint16 imx686spec25m_LRC_setting[504 * 2];
static void read_sensor_Cali(void)
{
	...
	for (idx = 0; idx < 3024; idx++) {
		...
		imx686spec25m_QSC_setting[2*idx] = sensor_addr;
		imx686spec25m_QSC_setting[2*idx + 1] = read_cmos_eeprom_8(addr_qsc);
	}

	for (idx = 0; idx < 252; idx++) {
		addr_lrc = 0x2460 + idx;
		sensor_addr = 0x7B00 + idx;
		imx686spec25m_LRC_setting[2*idx] = sensor_addr;
		imx686spec25m_LRC_setting[2*idx + 1] = read_cmos_eeprom_8(addr_lrc);
	}
...
{
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_QSC_setting,
		sizeof(imx686spec25m_QSC_setting)/sizeof(kal_uint16));
	#else
	kal_uint16 idx = 0, addr_qsc = 0xCA00;

	for (idx = 0; idx < 3024; idx++) {
		addr_qsc = 0xCA00 + idx;
		write_cmos_sensor_8(addr_qsc, imx686spec25m_QSC_setting[2 * idx + 1]);
	}
	#endif
}
...
{
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_LRC_setting,
		sizeof(imx686spec25m_LRC_setting)/sizeof(kal_uint16));
	#else
	kal_uint16 idx = 0, addr_lrc = 0x7510;

	for (idx = 0; idx < 252; idx++) {
		addr_lrc = 0x7B00 + idx;
		write_cmos_sensor_8(addr_lrc, imx686spec25m_LRC_setting[2*idx + 1]);
	}
	for (idx = 252; idx < 504; idx++) {
...
static void set_dummy(void)
{
	...
	if (!imx686spec25m_is_seamless) {
		...
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0340;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] =
			imgsensor.frame_length >> 8;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0341;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] =
			imgsensor.frame_length & 0xFF;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0342;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] =
			imgsensor.frame_length >> 8;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0343;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] =
			imgsensor.frame_length & 0xFF;
	}
#else
...
static void write_shutter(kal_uint32 shutter)
{
...
#ifdef imx686spec25m_seamless_test
	if (!imx686spec25m_is_seamless) //need check
	...
	if (longexposure_times > 0) {
		...
		if (!imx686spec25m_is_seamless)
			...
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x3100;
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] =
				longexposure_times & 0x07;
		}
#else
		write_cmos_sensor_8(0x3100, longexposure_times & 0x07);
#endif
		...
		if (!imx686spec25m_is_seamless) {
			...
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0104;
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 1;
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x3100;
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0;
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0340;
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] =
				imgsensor.frame_length >> 8;
			imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0341;
	...
	if (!imx686spec25m_is_seamless) {
		...
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0104;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 1;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0350;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 1;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0202;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = (shutter >> 8) & 0xFF;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0203;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = shutter  & 0xFF;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0104;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0;
	}
#else
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (!imx686spec25m_is_seamless) {
		...
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0204;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] =  (reg_gain>>8) & 0xFF;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0205;
		imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = reg_gain & 0xFF;
	}
...
static kal_uint32 imx686spec25m_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
#if imx686spec25m_flag
	...
	imx686spec25m_awb_gain_table[1]  = (grgain_32 >> 8) & 0xFF;
	imx686spec25m_awb_gain_table[3]  = grgain_32 & 0xFF;
	imx686spec25m_awb_gain_table[5]  = (rgain_32 >> 8) & 0xFF;
	imx686spec25m_awb_gain_table[7]  = rgain_32 & 0xFF;
	imx686spec25m_awb_gain_table[9]  = (bgain_32 >> 8) & 0xFF;
	imx686spec25m_awb_gain_table[11] = bgain_32 & 0xFF;
	imx686spec25m_awb_gain_table[13] = (gbgain_32 >> 8) & 0xFF;
	imx686spec25m_awb_gain_table[15] = gbgain_32 & 0xFF;
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_awb_gain_table,
		sizeof(imx686spec25m_awb_gain_table)/sizeof(kal_uint16));
#endif

	return ERROR_NONE;
}

static kal_uint16 imx686spec25m_feedback_awbgain[] = {
	0x0b90, 0x00,
	0x0b91, 0x01,
	0x0b92, 0x00,
	0x0b93, 0x01,
...
#else
	imx686spec25m_feedback_awbgain[1] = r_gain_int;
	imx686spec25m_feedback_awbgain[3] = (
		((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
	imx686spec25m_feedback_awbgain[5] = b_gain_int;
	imx686spec25m_feedback_awbgain[7] = (
		((b_gain * 100) / 512) - (b_gain_int * 100)) * 2;
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_feedback_awbgain,
		sizeof(imx686spec25m_feedback_awbgain)/sizeof(kal_uint16));
#endif
}

static void imx686spec25m_set_lsc_reg_setting(
...
#if USE_BURST_MODE
#define I2C_BUFFER_LEN 255 /* trans# max is 255, each 3 bytes */
static kal_uint16 imx686spec25m_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 imx686spec25m_init_setting[] = {
#ifdef new_init_setting
...
static kal_uint16 imx686spec25m_preview_setting[] = {
#ifdef use_capture_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_capture_setting[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_normal_video_setting_60FPS[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
#if imx686spec25m_flag
static kal_uint16 imx686spec25m_slim_video_setting[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_hs_video_setting[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_normal_video_setting[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_custom3_setting[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_custom4_setting[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_custom1_setting[] = {
#ifdef new_init_setting
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
...
static kal_uint16 imx686spec25m_custom8_setting[] = {
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
	0x0114,  0x02,
...
static kal_uint16 imx686spec25m_custom9_setting[] = {
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
	0x0114,  0x02,
...
static kal_uint16 imx686spec25m_custom10_setting[] = {
	/*MIPI output setting*/
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
...
static kal_uint16 imx686spec25m_custom11_setting[] = {
	/*MIPI output setting*/
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
...
{
	pr_debug("[%s] imx686spec25m_sensor_init_start\n", __func__);
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_init_setting,
		sizeof(imx686spec25m_init_setting)/sizeof(kal_uint16));
	#else
	/*External Clock Setting*/
	...
	pr_debug("[%s] imx686spec25m_sensor_init_End\n", __func__);
}	/*	  sensor_init  */
...
static void preview_setting(void)
{
	...
	#if USE_BURST_MODE
	//Feiping.Li, 60fps
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_preview_setting,
		sizeof(imx686spec25m_preview_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
...
static void capture_setting(kal_uint16 currefps)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_capture_setting,
		sizeof(imx686spec25m_capture_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_normal_video_setting,
		sizeof(imx686spec25m_normal_video_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void hs_video_setting(void)
{
	...
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_hs_video_setting,
		sizeof(imx686spec25m_hs_video_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom3_setting(void)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_custom3_setting,
		sizeof(imx686spec25m_custom3_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom4_setting(void)
{
	...
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_custom4_setting,
		sizeof(imx686spec25m_custom4_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom8_setting(void)
{
	...
	_length = sizeof(imx686spec25m_custom8_setting)/sizeof(kal_uint16);

	pr_debug("%s 24M setting\n", __func__);
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_custom8_setting, _length);
	pr_debug("X\n");
}
...
static void custom9_setting(void)
{
	...
	_length = sizeof(imx686spec25m_custom9_setting)/sizeof(kal_uint16);

	pr_debug("%s 25M setting\n", __func__);
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_custom9_setting, _length);
	pr_debug("X\n");
}
...
static void custom10_setting(void)
{
	...
	_length = sizeof(imx686spec25m_custom10_setting)/sizeof(kal_uint16);

	pr_debug("%s 4608*3456@17 FPS Bin\n", __func__);

	if (!imx686spec25m_is_seamless)
		imx686spec25m_table_write_cmos_sensor(imx686spec25m_custom10_setting, _length);
	else {
		pr_debug("%s imx686spec25m_is_seamless %d, imx686spec25m_size_to_write %d\n",
			__func__, imx686spec25m_is_seamless, imx686spec25m_size_to_write);
		if (imx686spec25m_size_to_write + _length > _I2C_BUF_SIZE) {
			pr_debug("_too much i2c data for fast siwtch %d\n",
				imx686spec25m_size_to_write + _length);
			return;
		}
		memcpy((void *) (imx686spec25m_i2c_data + imx686spec25m_size_to_write),
			imx686spec25m_custom10_setting,
			sizeof(imx686spec25m_custom10_setting));
		imx686spec25m_size_to_write += _length;
	}
	pr_debug("X\n");
}
...
static void custom11_setting(void)
{
	...
	_length = sizeof(imx686spec25m_custom11_setting)/sizeof(kal_uint16);

	pr_debug("%s 4608*3456@17 FPS center crop\n", __func__);

	if (!imx686spec25m_is_seamless)
		imx686spec25m_table_write_cmos_sensor(imx686spec25m_custom11_setting, _length);
	else {
		pr_debug("%s imx686spec25m_is_seamless %d, imx686spec25m_size_to_write %d\n",
			__func__, imx686spec25m_is_seamless, imx686spec25m_size_to_write);
		if (imx686spec25m_size_to_write + _length > _I2C_BUF_SIZE) {
		...
		memcpy((void *) (imx686spec25m_i2c_data + imx686spec25m_size_to_write),
			imx686spec25m_custom11_setting,
			sizeof(imx686spec25m_custom11_setting));
		imx686spec25m_size_to_write += _length;
	}
	pr_debug("X\n");
}
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_custom1_setting,
		sizeof(imx686spec25m_custom1_setting)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static void custom2_setting(void)
{
	...
	/*************MIPI output setting************/
	#if USE_BURST_MODE
	imx686spec25m_table_write_cmos_sensor(imx686spec25m_normal_video_setting_60FPS,
		sizeof(imx686spec25m_normal_video_setting_60FPS)/sizeof(kal_uint16));
	#else
	/*MIPI output setting*/
	write_cmos_sensor_8(0x0112, 0x0A);
	write_cmos_sensor_8(0x0113, 0x0A);
...
static kal_uint32 custom5(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_debug("%s. 4608*3456@30FPS preview\n", __func__);
...
{
	//int k = 0;
	imx686spec25m_is_seamless = true;
	memset(imx686spec25m_i2c_data, 0x0, sizeof(imx686spec25m_i2c_data));
	imx686spec25m_size_to_write = 0;

	pr_debug("seamless switch %d, %d, %d, %d, %d sizeof(imx686spec25m_i2c_data) %d\n",
		scenario_id, shutter, gain,
		shutter_2ndframe, gain_2ndframe,
		sizeof(imx686spec25m_i2c_data));

	if (scenario_id != MSDK_SCENARIO_ID_CUSTOM10 &&
		scenario_id != MSDK_SCENARIO_ID_CUSTOM11)
		return ERROR_INVALID_SCENARIO_ID;


	imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x0104;
	imx686spec25m_i2c_data[imx686spec25m_size_to_write++] = 0x01;
	...
	imx686spec25m_table_write_cmos_sensor(
		imx686spec25m_i2c_data,
		imx686spec25m_size_to_write);

	imx686spec25m_is_seamless = false;
	pr_debug("exit\n");
	return ERROR_NONE;
}
#endif
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	(struct SENSOR_WINSIZE_INFO_STRUCT *)(uintptr_t)(*(feature_data+1));
		...
		case MSDK_SCENARIO_ID_CUSTOM5:
			memcpy((void *)wininfo,
			(void *)&imgsensor_winsize_info[0],//original 9 modify pre 0
			sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_CUSTOM6:
			memcpy((void *)wininfo,
			(void *)&imgsensor_winsize_info[0],//original 10 modify pre 0
			sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_CUSTOM7:
			memcpy((void *)wininfo,
			(void *)&imgsensor_winsize_info[0],//original 11 modify pre 0
			sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_CUSTOM8:
			memcpy((void *)wininfo,
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		pr_debug("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx686spec25m_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		pr_debug("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx686spec25m_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	...
	case SENSOR_FEATURE_GET_VC_INFO:
		...
		case MSDK_SCENARIO_ID_CUSTOM3:
			...
			break;
		case MSDK_SCENARIO_ID_CUSTOM5:
			memcpy((void *)pvcinfo, (void *)&SENSOR_VC_INFO[0],//original 5 modify pre 0
				sizeof(struct SENSOR_VC_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_CUSTOM6:
			memcpy((void *)pvcinfo, (void *)&SENSOR_VC_INFO[0],//original 6 modify pre 0
				sizeof(struct SENSOR_VC_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_CUSTOM7:
			memcpy((void *)pvcinfo, (void *)&SENSOR_VC_INFO[0],//original 7 modify pre 0
				sizeof(struct SENSOR_VC_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_CUSTOM8:
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		imx686spec25m_set_lsc_reg_setting(index, feature_data_16,
...
UINT32 IMX686SPEC25M_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	return ERROR_NONE;
} /* IMX686SPEC25M_MIPI_RAW_SensorInit */
