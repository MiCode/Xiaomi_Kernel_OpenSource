 ...
 * Filename:
 * ---------
 *     sc202cs_sunny_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "sc202cs_sunny_mipi_raw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC202CS_SUNNY_DEPTH_SENSOR_ID,
...
//N17 code for HQ-293329 by wuzhenyue at 2023/04/28 end
  		 ...
  		 unsigned int addr, unsigned char *data, unsigned int size)
  {
   ...
   /* N17 code for HQ-293329 by wuzhenyue at 2023/04/27 start */
    EXPORT_SYMBOL(sc202cs_sunny_read_otp_info);
...
/* N17 code for HQ-293329 by wuzhenyue at 2023/05/22 start */
	...
	LOG_INF("depth-sunny getimgsensorid!!!\n");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            LOG_INF("depth-sunny return_sensor_id:0x%x , lens_id = 0x%x\n",*sensor_id,lens_id);
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if(lens_id == Lens_ID){
                    ...
                    LOG_INF("depth-sunny read lens_id fail");
