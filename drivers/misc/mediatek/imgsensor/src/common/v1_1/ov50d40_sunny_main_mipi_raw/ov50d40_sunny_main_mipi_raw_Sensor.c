...
#include "ov50d40_sunny_main_mipi_raw_Sensor.h"
#define PFX "OV50D40_camera_sensor"
#define LOG_INF(format, args...)    \
	pr_debug(PFX "[%s] " format, __func__, ##args)

#define MULTI_WRITE 1
//N17 code for HQ-293325 by yangchangyun at 2023/05/11 start
#define PDAF_SUPPORT 1
//N17 code for HQ-293325 by yangchangyun at 2023/05/11 end
/* N17 code for HQ-293330 by miaozhognshu at 2023/05/12 start */
static bool _is_binning_size = true; //bining to 4096x3072 set true,other set false
/* N17 code for HQ-293330 by miaozhognshu at 2023/05/12 end */

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV50D40_SUNNY_MAIN_SENSOR_ID,
...
/* N17 code for HQ-293330 by miaozhognshu at 2023/05/12 start */
	.max_gain = 62 * BASEGAIN, // real again is 62
/* N17 code for HQ-293330 by miaozhognshu at 2023/05/12 end */
	.min_gain_iso = 50,
	.gain_step = 1,
	.gain_type = 1,
...
/* N17 code for HQ-296316 by yangchangyun at 2023/05/22 start */
#if 0
/* N17 code for HQ-296316 by yangchangyun at 2023/05/22 end */
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
  { 8256,  6208,  0,  0,  8256,  6208,  4128,  3104,  16,   16,  4096,  3072,  0,  0,  4096,  3072},	/*Preview*/
  { 8256,  6208,  0,  0,  8256,  6208,  4128,  3104,  16,   16,  4096,  3072,  0,  0,  4096,  3072},	/*capture*/
  { 8256,  6208,  0,  768,  8256,  5440,  4128,  2720,  16,   16,  4096,  2304,  0,  0,  4096,  2304},	/*normal video*/
  { 8256,  6208,  224,  880,  8032,  5328,  2008, 1332,  16,   16,  1920, 1080,  0,  0,  1920,  1080},	/*hs video*/
  { 8256,  6208,  224,  880,  8032,  5328,  2008, 1332,  16,   16,  1920, 1080,  0,  0,  1920,  1080},	/*slim video*/
  { 8256,  6208,  0,  0,  8256,  6208,  4128,  3104,  16,   16,  4096,  3072,  0,  0,  4096,  3072},/*custom1 DualCam */
};
#else
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
...
{   
/* N17 code for HQ-293330 by miaozhongshu at 2023/05/12 start */
	if (_is_binning_size){
		write_cmos_sensor(0x3840, (imgsensor.frame_length*2 >> 16) & 0xFF);
		write_cmos_sensor(0x380e, (imgsensor.frame_length*2 >> 8) & 0xFF);
...
/* N17 code for HQ-293330 by miaozhongshu at 2023/05/12 end */
}
...
/* N17 code for HQ-293325 by miaozhongshu at 2023/05/08 end */
/* N17 code for HQ-293330 by miaozhongshu at 2023/05/12 start */
	if(_is_binning_size) {
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	spin_unlock(&imgsensor_drv_lock);
/* N17 code for HQ-293325 by miaozhognshu at 2023/05/17 start */
  #if 1
	switch (image_mirror) {
	case IMAGE_NORMAL:
        //N17 code for HQ-293325 by yangchangyun at 2023/05/11 start
  ...
  #endif
/* N17 code for HQ-293325 by miaozhognshu at 2023/05/17 end */
}
/* N17 code for HQ-293325 by miaozhongshu at 2023/05/12 start */
static void set_flip(void)
{
	kal_uint16 reg_val = read_cmos_sensor(0x3820) | (1 << 2);
	write_cmos_sensor(0x3820, reg_val);
}
/* N17 code for HQ-293325 by miaozhongshu at 2023/05/12 end */
...
kal_uint16 addr_data_pair_init_ov50d40[] = {
    ...
    0x3683, 0x00,
    //N17 code for HQ-293325 by yangchangyun at 2023/05/11 start
    0x3684, 0x01, //01, //pd on 01, pd off 00
    //N17 code for HQ-293325 by yangchangyun at 2023/05/11 end
    0x3685, 0x00,
    0x3686, 0x40,
    0x3687, 0x80,
