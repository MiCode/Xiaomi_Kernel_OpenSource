...
#include "ov02a10betamipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV02A10BETA_SENSOR_ID,
...
UINT32 OV02A10BETA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV02A10BETA_MIPI_RAW_SensorInit	*/
