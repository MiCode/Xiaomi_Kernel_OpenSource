...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {		/*data rate 1099.20 Mbps/lane */
		.pclk = 201592800,	/* record different mode's pclk */
		.linelength = 1836,	/* record different mode's linelength */
		.framelength = 3660, /* record different mode's framelength */
	...
	.isp_driving_current = ISP_DRIVING_4MA,	/* ISP_DRIVING_8MA mclk driving current */
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	0000, 0000, 1640, 1232, 0, 0, 1640, 1232},	/* Preview */
...
static BYTE imx355sunny_SPC_data[352] = { 0 };
...
#define IMX355SUNNYMIPI_MaxGainIndex (389)
kal_uint16 imx355sunnyMIPI_sensorGainMapping[IMX355SUNNYMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 16},
	{66, 32},
	{67, 46},
...
static void imx355sunny_set_pd_focus_area(MUINT32 startpos, MUINT32 size)
{
...
static void imx355sunny_get_pdaf_reg_setting(
...
static void imx355sunny_set_pdaf_reg_setting(
	MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx355sunny_apply_SPC(void)
{
	...
	memcpy((void *)&puSendCmd[tosend], imx355sunny_SPC_data, 352);
	tosend += 352;
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (iI = 0; iI < IMX355SUNNYMIPI_MaxGainIndex; iI++) {
		if (gain <= imx355sunnyMIPI_sensorGainMapping[iI][0])
			return imx355sunnyMIPI_sensorGainMapping[iI][1];
	}

	return imx355sunnyMIPI_sensorGainMapping[iI - 1][1];
}
...
kal_uint16 addr_data_pair_imx355sunny_zvhdr_on[] = {
	0x30b1, 0x00,
	0x30c6, 0x00,
	0x30b2, 0x00,
	0x30b3, 0x00,
...
kal_uint16 addr_data_pair_imx355sunny_zvhdr_off[] = {
	0x30b4, 0x00,
	0x30b5, 0x00,
	0x30b6, 0x00,
	0x30b7, 0x00,
...
static kal_uint16 zvhdr_setting(void)
{
	...
	if (imgsensor.hdr_mode == 9) {
		imx355sunny_table_write_cmos_sensor(addr_data_pair_imx355sunny_zvhdr_on,
		sizeof(addr_data_pair_imx355sunny_zvhdr_on) / sizeof(kal_uint16));
	} else {
		imx355sunny_table_write_cmos_sensor(addr_data_pair_imx355sunny_zvhdr_off,
		sizeof(addr_data_pair_imx355sunny_zvhdr_off) / sizeof(kal_uint16));
	}
	return 0;
...
kal_uint16 addr_data_pair_init_imx355sunny[] = {
	0x0136, 0x18,
	0x0137, 0x00,
...
{
	LOG_INF("E\n");
	imx355sunny_table_write_cmos_sensor(addr_data_pair_init_imx355sunny,
		sizeof(addr_data_pair_init_imx355sunny)/sizeof(kal_uint16));

	/*enable temperature sensor, TEMP_SEN_CTL:*/
	write_cmos_sensor(0x0138, 0x01);
}    /*    sensor_init  */

kal_uint16 addr_data_pair_preview_imx355sunny[] = {
	0x0100, 0x00,
...
{
	imx355sunny_table_write_cmos_sensor(addr_data_pair_preview_imx355sunny,
	sizeof(addr_data_pair_preview_imx355sunny) / sizeof(kal_uint16));
	/* zvhdr_setting(); */
}				/*    preview_setting  */
...
kal_uint16 addr_data_pair_capture_imx355sunny_pdaf_on[] = {
	/*PDAF*/
	/*PD_OUT_EN=1 */
	0x3E37, 0x01,
	/*AREA MODE */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx355sunny_table_write_cmos_sensor(addr_data_pair_capture_imx355sunny,
	sizeof(addr_data_pair_capture_imx355sunny) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif
#ifdef IMX355_PDAF_SUPPORT
	if (imgsensor.pdaf_mode == 1) {
		imx355sunny_table_write_cmos_sensor(
			addr_data_pair_capture_imx355sunny_pdaf_on,

		sizeof(
		addr_data_pair_capture_imx355sunny_pdaf_on) / sizeof(kal_uint16));

		imx355sunny_apply_SPC();
	}
#endif

}

kal_uint16 addr_data_pair_video_imx355sunny[] = {
	0x0100, 0x00,
...
static kal_uint32 open(void)
{
	...
	KD_SENSOR_PROFILE("imx355sunny_open_1");
	...
	KD_SENSOR_PROFILE("imx355sunny_open_2");
	return ERROR_NONE;
} /* open */
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		imx355sunny_read_DCC((kal_uint16) (*feature_data),
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx355sunny_awb_gain(pSetSensorAWB);
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355sunny_get_pdaf_reg_setting(
			(*feature_para_len) / sizeof(UINT32), feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx355sunny_set_pdaf_reg_setting(
			(*feature_para_len) / sizeof(UINT32), feature_data_16);
		break;

	case SENSOR_FEATURE_SET_PDFOCUS_AREA:
		LOG_INF(
			"SENSOR_FEATURE_SET_imx355sunny_PDFOCUS_AREA Start Pos=%d, Size=%d\n",
			(UINT32) *feature_data, (UINT32) *(feature_data + 1));
		imx355sunny_set_pd_focus_area(*feature_data, *(feature_data + 1));
		break;
		/*End of PDAF */	
#endif
