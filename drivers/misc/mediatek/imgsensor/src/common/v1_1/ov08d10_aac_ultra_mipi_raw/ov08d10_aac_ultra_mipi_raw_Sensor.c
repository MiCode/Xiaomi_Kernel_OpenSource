...
#include "ov08d10_aac_ultra_mipi_raw_Sensor.h"

#define PFX "OV08D10AACULTRA_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV08D10_AAC_ULTRA_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	return ((read_cmos_sensor(0x00) << 24) |(read_cmos_sensor(0x01) << 16) |(read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03));
}
...
/* N17 code for HQ-293327 by changqi end*/
 ...
 /* N17 code for HQ-293327 by changqi at 2023/05/16 start */
			pr_info("ov08d10aac sensor id : 0x%x, vendor id: 0x%x\n",*sensor_id, vendor_id);
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_info("ov08d10aac i2c write id : 0x%x, sensor id: 0x%x\n",
