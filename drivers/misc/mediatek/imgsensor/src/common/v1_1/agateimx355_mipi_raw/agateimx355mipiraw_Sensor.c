 ...
 *============================================================================
 ****************************************************************************/
#define PFX "AGATEIMX355_camera_sensor"
...
#include "agateimx355mipiraw_Sensor.h"
...
#if USE_BURST_MODE
static kal_uint16 agateimx355_table_write_cmos_sensor(
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = AGATEIMX355_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{3280, 2464, 440, 332, 2560, 1920, 2560, 1920, 0, 0, 2560, 1920,  0,  0, 2560, 1920}, /* custom3 preview@24fps*/
...
#if ENABLE_PDAF
static void agateimx355_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void agateimx355_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static kal_uint32 agateimx355_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	return ERROR_NONE;
}
/*
static kal_uint16 agateimx355_feedback_awbgain[] = {
	0x0b90, 0x00,
	0x0b91, 0x01,
	0x0b92, 0x00,
	0x0b93, 0x01,
...
static void feedback_awbgain(kal_uint32 r_gain, kal_uint32 b_gain)
{
	...
	agateimx355_feedback_awbgain[1] = r_gain_int;
	agateimx355_feedback_awbgain[3] = (
		((r_gain*100) / 512) - (r_gain_int * 100)) * 2;
	agateimx355_feedback_awbgain[5] = b_gain_int;
	agateimx355_feedback_awbgain[7] = (
		((b_gain * 100) / 512) - (b_gain_int * 100)) * 2;
	agateimx355_table_write_cmos_sensor(agateimx355_feedback_awbgain,
		sizeof(agateimx355_feedback_awbgain)/sizeof(kal_uint16));
}
*/
static void agateimx355_set_lsc_reg_setting(
...
static kal_uint16 agateimx355_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
#endif
static kal_uint16 agateimx355_init_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x4348, 0x16,
	0x4350, 0x19,
...
static kal_uint16 agateimx355_capture_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 agateimx355_preview_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 agateimx355_normal_video_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 agateimx355_slim_video_setting[] = {

};

static kal_uint16 agateimx355_hs_video_setting[] = {

};

static kal_uint16 agateimx355_custom1_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static kal_uint16 agateimx355_custom2_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
static kal_uint16 agateimx355_custom3_setting[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
static void sensor_init(void)
{
	...
	agateimx355_table_write_cmos_sensor(agateimx355_init_setting,
		sizeof(agateimx355_init_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("%s +\n", __func__);
	agateimx355_table_write_cmos_sensor(agateimx355_preview_setting,
		sizeof(agateimx355_preview_setting)/sizeof(kal_uint16));
	LOG_INF("%s -\n", __func__);
} /* preview_setting */
...
static void capture_setting(kal_uint16 currefps)
{
	...
	/*************MIPI output setting************/
	agateimx355_table_write_cmos_sensor(agateimx355_capture_setting,
		sizeof(agateimx355_capture_setting)/sizeof(kal_uint16));
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	agateimx355_table_write_cmos_sensor(agateimx355_normal_video_setting,
		sizeof(agateimx355_normal_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
	...
	agateimx355_table_write_cmos_sensor(agateimx355_hs_video_setting,
		sizeof(agateimx355_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
	...
	agateimx355_table_write_cmos_sensor(agateimx355_slim_video_setting,
		sizeof(agateimx355_slim_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	agateimx355_table_write_cmos_sensor(agateimx355_custom1_setting,
		sizeof(agateimx355_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
...
static void custom2_setting(void)
{
	...
	agateimx355_table_write_cmos_sensor(agateimx355_custom2_setting,
		sizeof(agateimx355_custom2_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("%s 2560x1920@24fps E!\n", __func__);
	/*************MIPI output setting************/
	agateimx355_table_write_cmos_sensor(agateimx355_custom3_setting,
		sizeof(agateimx355_custom3_setting)/sizeof(kal_uint16));
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		agateimx355_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		agateimx355_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		agateimx355_set_lsc_reg_setting(index, feature_data_16,
...
UINT32 AGATEIMX355_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* AGATEIMX355_MIPI_RAW_SensorInit */
