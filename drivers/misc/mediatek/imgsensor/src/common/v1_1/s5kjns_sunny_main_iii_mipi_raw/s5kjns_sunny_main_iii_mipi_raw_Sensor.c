...
#include "s5kjns_sunny_main_iii_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJNS_SUNNY_MAIN_III_SENSOR_ID ,
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjnssunny_ii[] = {
	0x6028,0x2400,
	/*
	0x602A,0x7700,
	0x6F12,0x1753,
...
static void sensor_init(void)
{
	...
	mdelay(10);
		...
		addr_data_pair_init_s5kjnssunny_ii,
		sizeof(addr_data_pair_init_s5kjnssunny_ii) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjnssunny_ii[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void preview_setting(void)
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjnssunny_ii,
		sizeof(addr_data_pair_preview_s5kjnssunny_ii) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjnssunny_ii[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjnssunny_ii,
		sizeof(addr_data_pair_hs_video_s5kjnssunny_ii) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjnssunny_ii[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
        s5kjns_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjnssunny_ii,
		sizeof(addr_data_pair_capture_s5kjnssunny_ii) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjnssunny_ii[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void normal_video_setting(kal_uint16 currefps)  // 30fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjnssunny_ii,
		sizeof(addr_data_pair_normal_video_s5kjnssunny_ii) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjnssunny_ii[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void slim_video_setting(void) //60fps
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjnssunny_ii,
		sizeof(addr_data_pair_slim_video_s5kjnssunny_ii) / sizeof(kal_uint16));
}
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjnssunny_ii[] = {
	0x6028,0x2400,    
	0x602A,0x1A28,    
	0x6F12,0x4C00,    
	0x602A,0x065A,    
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjnssunny_ii,
		sizeof(addr_data_pair_custom1_s5kjnssunny_ii) / sizeof(kal_uint16));
}
		...
		do {
			if (vendor_id == 0x10) {
				*sensor_id = return_sensor_id();
					LOG_INF("wpc get_imgsensor_id iii sensor_id: 0x%x\n",*sensor_id);
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info("wpc s5kjnsacc_ofilm i2c 0x%x, sid 0x%x\n",
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_set_test_pattern_s5kjnssunny_ii[] = {
	0x0600,0x0001,
	0x0602,0x0000,
	0x0604,0x0000,
	0x0606,0x0000,
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		s5kjns_multi_write_cmos_sensor(
			addr_data_pair_set_test_pattern_s5kjnssunny_ii,
			sizeof(addr_data_pair_set_test_pattern_s5kjnssunny_ii) / sizeof(kal_uint16));
	} else {
...
{
	LOG_INF("S5KJNS_SUNNY_MAIN_III_MIPI_RAW_SensorInit in\n");
