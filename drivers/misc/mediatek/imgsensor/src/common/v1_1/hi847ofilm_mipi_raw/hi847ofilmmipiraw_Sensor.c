...
#include "hi847ofilmmipiraw_Sensor.h"

#define PFX "hi847ofilm_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI847OFILM_SENSOR_ID,
...
static kal_uint16 hi847ofilm_table_write_cmos_sensor(
			...
			kal_uint16 frame_length)
{
	...
	write_cmos_sensor_8(0x020D, (shutter & 0xFF0000) >> 16 );
	write_cmos_sensor(0x020A, shutter & 0xFFFF);
	printk("[HI847I]Add for N3D! shutter =%d, framelength =%d\n",
		shutter, imgsensor.frame_length);
}
...
{
#if MULTI_WRITE
	hi847ofilm_table_write_cmos_sensor(
		addr_data_pair_init_hi847ofilm,
		sizeof(addr_data_pair_init_hi847ofilm) /
		sizeof(kal_uint16));
#endif
}
...
{
	printk("hi847ofilm enter loading capture_setting\n");
#if MULTI_WRITE
	hi847ofilm_table_write_cmos_sensor(
		addr_data_pair_cap_hi847ofilm,
		sizeof(addr_data_pair_cap_hi847ofilm) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi847ofilm[] = {
...
#if MULTI_WRITE
	hi847ofilm_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi847ofilm,
		sizeof(addr_data_pair_hs_video_hi847ofilm) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi847ofilm[] = {
...
{
	printk("hi847ofilm enter loading video_setting\n");
#if MULTI_WRITE
	hi847ofilm_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi847ofilm,
		sizeof(addr_data_pair_slim_video_hi847ofilm) /
		sizeof(kal_uint16));
#endif
}
...
UINT32 HI847OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	HI847OFILM_MIPI_RAW_SensorInit	*/
