...
#define PFX "s5k5e9sunny_camera_sensor"
#define LOG_INF(format, args...) pr_debug(PFX "[%s] " format, __func__, ##args)
static DEFINE_SPINLOCK(imgsensor_drv_lock);

#include "s5k5e9sunnymipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K5E9SUNNY_SENSOR_ID,	/*S5K5E9SUNNY_SENSOR_ID = 0x487B */
...
{
	table_write_cmos_sensor(s5k5e9sunny_init_setting,
		sizeof(s5k5e9sunny_init_setting) / sizeof(kal_uint16));
}				/*  s5k5e9sunnyMIPI_Sensor_Init  */

static void preview_setting(void)
{
	LOG_INF("start \n");
	if (bIsLongExposure == KAL_FALSE) {
		table_write_cmos_sensor(s5k5e9sunny_preview_setting,
			sizeof(s5k5e9sunny_preview_setting) / sizeof(kal_uint16));
	} else {
		sensor_init();
		table_write_cmos_sensor(s5k5e9sunny_preview_setting,
			sizeof(s5k5e9sunny_preview_setting) / sizeof(kal_uint16));
...
}				/*  s5k5e9sunnyMIPI_Capture_Setting  */

static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start \n");
	table_write_cmos_sensor(s5k5e9sunny_cap_setting,
			sizeof(s5k5e9sunny_cap_setting) / sizeof(kal_uint16));
}

static void normal_video_setting(kal_uint16 currefps)
{
	LOG_INF("E! currefps:%d\n", currefps);
	table_write_cmos_sensor(s5k5e9sunny_normal_video_setting,
		sizeof(s5k5e9sunny_normal_video_setting) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
	LOG_INF("EVGA 120fps");
	table_write_cmos_sensor(s5k5e9sunny_hs_video_setting,
		sizeof(s5k5e9sunny_hs_video_setting) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
	LOG_INF("E");
	table_write_cmos_sensor(s5k5e9sunny_slim_video_setting,
		sizeof(s5k5e9sunny_slim_video_setting) / sizeof(kal_uint16));
}
...
UINT32 S5K5E9SUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      s5k5e9sunny_MIPI_RAW_SensorInit      */
