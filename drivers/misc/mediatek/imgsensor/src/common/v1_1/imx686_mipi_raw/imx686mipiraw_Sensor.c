...
static struct imgsensor_info_struct imgsensor_info = {
...
#endif
	.custom7 = { /* reg_11 4608x2992 @30fps */
		.pclk = 2192000000,
		.linelength = 10336,
		.framelength = 7069,
		.startx = 0,
	...
	.custom8 = { /* reg_12 5656x4242 @30fps 24M*/
		.pclk = 1992000000,
		.linelength = 15168,
		.framelength = 4377,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 5656,
		.grabwindow_height = 4242,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 929830000,
		.max_framerate = 300,
	},
	.custom9 = { /* reg_13 5776x4332 @30fps 25M*/
		.pclk = 2032000000,
		.linelength = 15168,
		.framelength = 4465,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 5776,
		.grabwindow_height = 4332,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 995660000,
		.max_framerate = 300,
	},
	.custom10 = { /* reg_14 5776x4332 @30fps 25M*/
		.pclk = 1224000000,
		.linelength = 20416,
		.framelength = 3526,
		.startx = 0,
		...
		.grabwindow_height = 3456,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 562290000,
		.max_framerate = 170,
	},
	.custom11 = { /* reg_15 5776x4332 @30fps 25M*/
		.pclk = 1224000000,
		.linelength = 15168,
		.framelength = 4746,
		.startx = 0,
	...
	.custom10_delay_frame = 2,	/* enter custom9 delay frame num */
	.custom11_delay_frame = 2,	/* enter custom9 delay frame num */
...
#endif
	{9248, 6944, 0,  1744, 9248, 3456, 9248, 3456,
	2320, 0, 4608, 3456,  0,  0, 4608, 3456}, /* custom7 */
	{9248, 6944, 0,  1344, 9248, 4256, 9248, 4256,
	1796, 6, 5656, 4242,  0,  0, 5656, 4242}, /* custom8 */
	{9248, 6944, 0,  1296, 9248, 4352, 9248, 4352,
	1739, 10, 5776, 4332,  0,  0, 5776, 4332}, /* custom9 */
	{9248, 6944, 0,   16, 9248, 6912, 4624, 3456,
	8,  0, 4608, 3456,  0,  0, 4608, 3456}, /* custom10 */
	{9248, 6944, 0,   1744, 9248, 3456, 9248, 3456,
	2320,  0, 4608, 3456,  0,  0, 4608, 3456}, /* custom11 */
};
 /*VC1 for HDR(DT=0X35), VC2 for PDAF(DT=0X36), unit : 10bit */
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[13] = {
#ifdef new_init_setting
	...
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x1200, 0x0D80, 0x00, 0x00, 0x0000, 0x0000,
	 0x01, 0x2b, 0x023C, 0x0358, 0x00, 0x00, 0x0000, 0x0000},//pd size
	/*custom8*//*index:8*/
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x1618, 0x1092, 0x00, 0x00, 0x0000, 0x0000,
	 0x01, 0x2b, 0x02BC, 0x0418, 0x00, 0x00, 0x0000, 0x0000}, //pd size
	/*custom9*//*index:9*/
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x1690, 0x10EC, 0x00, 0x00, 0x0000, 0x0000,
	 0x01, 0x2b, 0x02CC, 0x0438, 0x00, 0x00, 0x0000, 0x0000}, //pd size
	/*custom10*//*index:10*/
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x1200, 0x0D80, 0x00, 0x00, 0x00, 0x00,
	 0x01, 0x2b, 0x047C, 0x06B8, 0x00, 0x00, 0x0000, 0x0000}, //pd size
	...
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x1200, 0x0D80, 0x00, 0x00, 0x00, 0x00,
	 0x01, 0x2b, 0x023C, 0x0358, 0x00, 0x00, 0x0000, 0x0000}, //pd size
	/*hs video mode setting*//*index:12*/
	{0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 0x00, 0x2b, 0x0900, 0x0510, 0x00, 0x00, 0x00, 0x00,
	 0x00, 0x00, 0x0000, 0x0000, 0x00, 0x00, 0x0000, 0x0000} //pd size
};
...
static struct SEAMLESS_SYS_DELAY seamless_sys_delays[] = {
	...
	{ MSDK_SCENARIO_ID_CUSTOM5, MSDK_SCENARIO_ID_CUSTOM7, 1 },
	{ MSDK_SCENARIO_ID_CUSTOM6, MSDK_SCENARIO_ID_CUSTOM5, 1 },
	{ MSDK_SCENARIO_ID_CUSTOM6, MSDK_SCENARIO_ID_CUSTOM7, 1 },
	{ MSDK_SCENARIO_ID_CUSTOM7, MSDK_SCENARIO_ID_CUSTOM5, 1 },
	{ MSDK_SCENARIO_ID_CUSTOM7, MSDK_SCENARIO_ID_CUSTOM6, 1 },
	{ MSDK_SCENARIO_ID_CUSTOM10, MSDK_SCENARIO_ID_CUSTOM11, 1 },
	{ MSDK_SCENARIO_ID_CUSTOM11, MSDK_SCENARIO_ID_CUSTOM10, 1 },
};
#endif
...
static kal_uint16 imx686_init_setting[] = {
	...
	0x3076, 0x01,//dp data channel 0
	0x3077, 0x2b,//dp data DT 2b
	/*Global Setting*/
	0x4008, 0x10,
	0x4009, 0x10,
	0x400A, 0x10,
...
static kal_uint16 imx686_custom7_setting[] = {
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
	0x0114,  0x02,
...
static kal_uint16 imx686_custom8_setting[] = {
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
	0x0114,  0x02,
...
static kal_uint16 imx686_custom9_setting[] = {
	/*MIPI output setting*/
	0x0112,  0x0A,
	0x0113,  0x0A,
	0x0114,  0x02,
	...
	0x040C,  0x16,
	0x040D,  0x90,
	0x040E,  0x10,//img height 4330 to 4332
	0x040F,  0xEC,//img height 4330 to 4332
	/*Output Size Setting*/
	0x034C,  0x16,
	0x034D,  0x90,
	0x034E,  0x10,//img height 4330 to 4332
	0x034F,  0xEC,//img height 4330 to 4332
	/*Clock Setting*/
	0x0301,  0x08,
	0x0303,  0x02,
	0x0305,  0x03,
...
static kal_uint16 imx686_custom10_setting[] = {
	/*MIPI output setting*/
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
...
static kal_uint16 imx686_custom11_setting[] = {
	/*MIPI output setting*/
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
...
static void custom7_setting(void)
{
	...
	_length = sizeof(imx686_custom7_setting)/sizeof(kal_uint16);

	pr_debug("%s 720p@240 fps E! currefps\n", __func__);

	if (!imx686_is_seamless)
		imx686_table_write_cmos_sensor(imx686_custom7_setting, _length);
	else {
		pr_debug("%s imx686_is_seamless %d, imx686_size_to_write %d\n",
			__func__, imx686_is_seamless, imx686_size_to_write);
		if (imx686_size_to_write + _length > _I2C_BUF_SIZE) {
		...
		memcpy((void *) (imx686_i2c_data + imx686_size_to_write),
			imx686_custom7_setting,
			sizeof(imx686_custom7_setting));
		imx686_size_to_write += _length;
	}
	pr_debug("X\n");
}
...
static void custom8_setting(void)
{
	...
	_length = sizeof(imx686_custom8_setting)/sizeof(kal_uint16);

	pr_debug("%s 24M setting\n", __func__);
	imx686_table_write_cmos_sensor(imx686_custom8_setting, _length);
	pr_debug("X\n");
}
...
static void custom9_setting(void)
{
	...
	_length = sizeof(imx686_custom9_setting)/sizeof(kal_uint16);

	pr_debug("%s 25M setting\n", __func__);
	imx686_table_write_cmos_sensor(imx686_custom9_setting, _length);
	pr_debug("X\n");
}
...
static void custom10_setting(void)
{
	...
	_length = sizeof(imx686_custom10_setting)/sizeof(kal_uint16);

	pr_debug("%s 4608*3456@17 FPS Bin\n", __func__);

	if (!imx686_is_seamless)
		imx686_table_write_cmos_sensor(imx686_custom10_setting, _length);
	else {
		pr_debug("%s imx686_is_seamless %d, imx686_size_to_write %d\n",
			__func__, imx686_is_seamless, imx686_size_to_write);
		if (imx686_size_to_write + _length > _I2C_BUF_SIZE) {
		...
		memcpy((void *) (imx686_i2c_data + imx686_size_to_write),
			imx686_custom10_setting,
			sizeof(imx686_custom10_setting));
		imx686_size_to_write += _length;
	}
	pr_debug("X\n");
}
...
static void custom11_setting(void)
{
	...
	_length = sizeof(imx686_custom11_setting)/sizeof(kal_uint16);

	pr_debug("%s 4608*3456@17 FPS center crop\n", __func__);

	if (!imx686_is_seamless)
		imx686_table_write_cmos_sensor(imx686_custom11_setting, _length);
	else {
		pr_debug("%s imx686_is_seamless %d, imx686_size_to_write %d\n",
			__func__, imx686_is_seamless, imx686_size_to_write);
		if (imx686_size_to_write + _length > _I2C_BUF_SIZE) {
		...
		memcpy((void *) (imx686_i2c_data + imx686_size_to_write),
			imx686_custom11_setting,
			sizeof(imx686_custom11_setting));
		imx686_size_to_write += _length;
	}
	pr_debug("X\n");
}
...
static kal_uint32 custom5(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_debug("%s. 4608*3456@30FPS full size h1v1 bin\n", __func__);
...
static kal_uint32 custom6(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_debug("%s. 9216*6912@30FPS full size\n", __func__);
...
static kal_uint32 custom7(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_debug("%s. 4608*3456@30FPS full size center crop\n", __func__);
...
static kal_uint32 custom10(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_debug("%s. 4608*3456@30FPS full size bin\n", __func__);
	...
	kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
	...
	if (scenario_id != MSDK_SCENARIO_ID_CUSTOM5 &&
		...
		scenario_id != MSDK_SCENARIO_ID_CUSTOM7 &&
		scenario_id != MSDK_SCENARIO_ID_CUSTOM10 &&
		scenario_id != MSDK_SCENARIO_ID_CUSTOM11)
		return ERROR_INVALID_SCENARIO_ID;
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_VC_INFO:
		...
		case MSDK_SCENARIO_ID_CUSTOM10:
			...
			break;
		case MSDK_SCENARIO_ID_CUSTOM11:
			memcpy((void *)pvcinfo, (void *)&SENSOR_VC_INFO[11],
				sizeof(struct SENSOR_VC_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
			memcpy((void *)pvcinfo, (void *)&SENSOR_VC_INFO[12],
				sizeof(struct SENSOR_VC_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
	...
	case SENSOR_FEATURE_GET_SEAMLESS_SCENARIOS:
		...
		case MSDK_SCENARIO_ID_CUSTOM5:
			...
			*(pScenarios + 1) = MSDK_SCENARIO_ID_CUSTOM7;
			break;
		case MSDK_SCENARIO_ID_CUSTOM6:
		...
		case MSDK_SCENARIO_ID_CUSTOM7:
			*pScenarios = MSDK_SCENARIO_ID_CUSTOM5;
			*(pScenarios + 1) = MSDK_SCENARIO_ID_CUSTOM6;
			break;
		case MSDK_SCENARIO_ID_CUSTOM10:
			*pScenarios = MSDK_SCENARIO_ID_CUSTOM11;
			break;
		case MSDK_SCENARIO_ID_CUSTOM11:
			*pScenarios = MSDK_SCENARIO_ID_CUSTOM10;
			break;
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
