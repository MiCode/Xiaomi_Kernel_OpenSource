 ...
 *============================================================================
 ****************************************************************************/
#define PFX "S5KGW1SUNNY_camera_sensor"
...
UINT32 isS5kgw1_ofilm_or_sunny;

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static bool bIsLongExposure = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGW1SUNNY_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		 ...
		 *	pr_debug(
		 *	"sp8Flag(0x%x),0x5003 used by s5kgw1sunny\n", sp8spFlag);
		 *
		 *	if (sp8spFlag == 0x5003) {
		 *		pr_debug("it is s5kgw1sunny\n");
		 *		return ERROR_NONE;
		 *	}
		 *
		 *		pr_debug(
