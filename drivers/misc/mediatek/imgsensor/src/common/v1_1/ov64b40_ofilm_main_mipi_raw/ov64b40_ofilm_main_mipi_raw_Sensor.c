...
#include "ov64b40_ofilm_main_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40_OFILM_MAIN_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h

	.checksum_value = 0x47a75476,		//checksum value for Camera Auto Test

	.pre = {
		/* N17 code for HQ-293330 by chenxiaoyong at 2023/05/10 start */
		.pclk = 345600000,
		.linelength  = 2808,
		/* N17 code for HQ-293330 by chenxiaoyong at 2023/05/10 end */
		.framelength = 4102,
		.startx = 0,
		.starty = 0,
	...
	/* N17 code for HQ-293325 by chenxiaoyong at 2023/05/11 start */
	.custom2 = {//full size capture
		/* N17 code for HQ-293330 by chenxiaoyong at 2023/05/10 start */
		.pclk = 345600000,
		.linelength  = 3240,
		/* N17 code for HQ-293330 by chenxiaoyong at 2023/05/10 end */
	...
	/* N17 code for HQ-293325 by chenxiaoyong at 2023/05/11 end */
	.min_shutter = 8,		//min shutter
	.exp_step    = 2,
	.min_gain = BASEGAIN, // 1x gain
	/* N17 code for HQ-299842 by chenxiaoyong at 2023/06/16 start */
	.max_gain = 15.9375 * BASEGAIN, // real again is 15.5x
	/* N17 code for HQ-299842 by chenxiaoyong at 2023/06/16 end */
	.min_gain_iso = 50,
	.gain_step = 1,
	.gain_type = 1,
...
/* N17 code for HQ-293325 by chenxiaoyong at 2023/05/11 start */
 { 9248, 6944,    0,    0,    9248, 6944, 9248, 6944,   0,     0, 9248, 6944,     0, 0, 9248, 6944}, // custom2 full size capture
/* N17 code for HQ-293325 by chenxiaoyong at 2023/05/11 end */
};
...
/* N17 code for HQ-293330 by chenxiaoyong at 2023/05/01 end */
...
/* N17 code for HQ-293325 by chenxiaoyong at 2023/05/11 start */
#define PDC_EEPROM_OFFSET_OFILM   0x12E2  // [12-731]
#define PDC_SENSOR_OFFSET   0x5F80

#define XTALK_EEPROM_OFFSET 0x296A//ofilm
...
static void read_cali_data_from_eeprom(void)
{
	...
	if (Is_Read_Otp_Data != 1) {
		...
		for (i = 0; i < PDC_SIZE; i++) {
			...
			pdc_cali_setting[2 * i + 1] = read_eeprom_sensor(PDC_EEPROM_OFFSET_OFILM+i);
		}
		...
		UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 0)) == 0) {
			*(feature_data + 0) =
				sizeof(ana_gain_table_16x)/sizeof(kal_uint32);
		} else {
...
/* N17 code for HQ-293330 by chenxiaoyong at 2023/05/1 end */
	...
	/* N17 code for HQ-297075 by chenxiaoyong at 2023/05/30 start */
	...
	/* N17 code for HQ-297075 by chenxiaoyong at 2023/05/30 end */
