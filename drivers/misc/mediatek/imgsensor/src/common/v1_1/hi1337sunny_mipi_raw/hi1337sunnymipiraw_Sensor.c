...
#include "hi1337sunnymipiraw_Sensor.h"

#define PFX "hi1337sunny_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1337SUNNY_SENSOR_ID,
	...
	.gain_step = 4,
	.gain_type = 2,
	.max_frame_length = 0x2DC6C0, //30.003s
#if per_frame
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 4224, 3136,   0,   6, 4224, 3124,	 4224, 3124,  8,  2, 4208, 3120, 0, 0, 4208, 3120},		// preview (2104 x 1560)
...
static kal_uint16 hi1337sunny_table_write_cmos_sensor(
...
static void set_dummy(void)
{
	LOG_INF("dummyline = %d, dummypixels = %d\n",
		...
		write_cmos_sensor(0x0206, imgsensor.line_length >> 3);
			...
			kal_uint16 frame_length)
{
	...
	write_cmos_sensor_8(0x020D, (shutter & 0xFF0000) >> 16 );
	write_cmos_sensor(0x020A, shutter & 0xFFFF);
	printk("[HI1337I]Add for N3D! shutter =%d, framelength =%d\n",
		shutter, imgsensor.frame_length);
}
...
{
#if MULTI_WRITE
	hi1337sunny_table_write_cmos_sensor(
		addr_data_pair_init_hi1337sunny,
		sizeof(addr_data_pair_init_hi1337sunny) /
		sizeof(kal_uint16));
#endif
}
...
{
	LOG_INF("hi1337sunny enter loading capture_setting\n");
#if MULTI_WRITE
	hi1337sunny_table_write_cmos_sensor(
		addr_data_pair_cap_hi1337sunny,
		sizeof(addr_data_pair_cap_hi1337sunny) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi1337sunny[] = {
...
#if MULTI_WRITE
	hi1337sunny_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1337sunny,
		sizeof(addr_data_pair_hs_video_hi1337sunny) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi1337sunny[] = {
...
{
	printk("hi1337sunny enter loading video_setting\n");
#if MULTI_WRITE
	hi1337sunny_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1337sunny,
		sizeof(addr_data_pair_slim_video_hi1337sunny) /
		sizeof(kal_uint16));
#endif
}
...
UINT32 HI1337SUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	HI1337SUNNY_MIPI_RAW_SensorInit	*/
