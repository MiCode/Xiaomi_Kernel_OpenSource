...
#include "gc2375beta_mipi_Sensor.h"

/*********************Modify Following Strings for Debug*********************/
#define PFX "GC2375BETA_camera_sensor"
#define LOG_1 cam_pr_debug("GC2375BETA_,MIPI 1LANE\n")
/***************************   Modify end    ********************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375BETA_SENSOR_ID,
...
#define ANALOG_GAIN_9 1038	/* 16.23x */
	...
	if ((iReg >= ANALOG_GAIN_1) && (iReg < ANALOG_GAIN_2)) {
		...
		cam_pr_debug("GC2375BETA_MIPI analogic gain 1x, GC2375BETA_MIPI add pregain = %d\n",
			temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 1.43x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 2x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 2.84x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 3.97x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 5.68x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 8.14x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 11.34x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
	} else {
		write_cmos_sensor(0x20, 0x0c);
		write_cmos_sensor(0x22, 0x0e);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		cam_pr_debug("GC2375BETA_MIPI analogic gain 16.23x , GC2375BETA_MIPI add pregain = %d\n",
			temp);
	}
	return gain;
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375BETA_MIRROR);
	...
	write_cmos_sensor(0x4e, GC2375BETA_BLK_Select1_H);
	write_cmos_sensor(0x4f, GC2375BETA_BLK_Select1_L);
	write_cmos_sensor(0x66, GC2375BETA_BLK_Select2_H);
	write_cmos_sensor(0x67, GC2375BETA_BLK_Select2_L);
...
UINT32 GC2375BETA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}			/*    GC2375BETA_MIPI_RAW_SensorInit    */
