...
typedef struct imgsensor_info_struct {
	...
	imgsensor_mode_struct
	custom1;  //custom1 for stereo relative information    //modify dualcam IDLHLYE-99 by wei.miao@reallytek.com 180629
	kal_uint8
	...
	kal_uint8
	frame_time_delay_frame;  //modify dualcam IDLHLYE-99 by wei.miao@reallytek.com 180629
	...
	kal_uint8 custom1_delay_frame; //enter custom1 delay frame num    //modify dualcam IDLHLYE-99 by wei.miao@reallytek.com 180629
	...
	kal_uint8
	mipi_sensor_type; //0,MIPI_OPHY_NCSI2; 1,MIPI_OPHY_CSI2, default is NCSI2, don't modify this para
	kal_uint8
	mipi_settle_delay_mode; //0, high speed signal auto detect; 1, use settle delay,unit is ns, default is auto detect, don't modify this para
	kal_uint8
