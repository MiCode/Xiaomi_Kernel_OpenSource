...
static struct imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.framelength = 3333, //1666, 			//record different mode's framelength
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 4224, 3136,   0,   4, 4224, 3128,	 2112, 1564,  4,  2, 2104, 1560, 0, 0, 2104, 1560},		// preview (2104 x 1560)
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi1337[] = {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi1337[] = {
...
0x020A, 0x067E,
//0x020E, 0x0682, 60fps
0x020E, 0x0D05, // Frame length 3333
0x0214, 0x0200,
0x0216, 0x0200,
0x0218, 0x0200,
0x021A, 0x0200,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_hi1337[] = {
...
kal_uint16 addr_data_pair_capture_15fps_hi1337[] = {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi1337[] = {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi1337[] = {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi1337[] = {
