...
#include "gc02m1_sunny_macro_mipi_raw.h"

#define VENDOR_ID_ENABLE        1
#define VENDOR_ID               0x01
#define PFX                     "GC02M1_SUNNY_MACRO"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SUNNY_MACRO_SENSOR_ID,
...
static kal_uint16
gc02m1_sunny_macro_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint32 get_sensor_id(void)
{

	int tmp_id = 0x0;
	tmp_id = ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1));
	LOG_INF("sensor_id read is %x!", tmp_id);
	if (tmp_id == 0x2e0) {
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < GC02M1_SUNNY_MACRO_SENSOR_GAIN_BASE)
		reg_gain = GC02M1_SUNNY_MACRO_SENSOR_GAIN_BASE;
	else if (reg_gain > GC02M1_SUNNY_MACRO_SENSOR_GAIN_MAX)
		reg_gain = GC02M1_SUNNY_MACRO_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16
	GC02M1_SUNNY_MACRO_AGC_Param[GC02M1_SUNNY_MACRO_SENSOR_GAIN_MAX_VALID_INDEX][2]
	= {
		{1024, 0},
		{1536, 1},
		{2035, 2},
	...
	for (gain_index = GC02M1_SUNNY_MACRO_SENSOR_GAIN_MAX_VALID_INDEX - 1;
			gain_index >= 0; gain_index--)
		if (reg_gain >= GC02M1_SUNNY_MACRO_AGC_Param[gain_index][0])
			break;

	/* N19A code for HQ-364042 by p-xuyechen at 2024/1/5 start */
	if (gain_index < 0) {
		LOG_ERROR("get gain failed. please check!");
		return reg_gain;
	}
	/* N19A code for HQ-364042 by p-xuyechen at 2024/1/5 end */

	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC02M1_SUNNY_MACRO_AGC_Param[gain_index][1]);
	temp_gain =
		reg_gain * GC02M1_SUNNY_MACRO_SENSOR_DGAIN_BASE /
		GC02M1_SUNNY_MACRO_AGC_Param[gain_index][0];
	write_cmos_sensor(0xb1, (temp_gain >> 8) & 0x1f);
	write_cmos_sensor(0xb2, temp_gain & 0xff);
	LOG_INF
	("GC02M1 aac_macro = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
	 GC02M1_SUNNY_MACRO_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
kal_uint16 addr_data_pair_init_gc02m1_sunny_macro[] = {
	...
	0x0d, 0x04,
	0x0e, 0xbc,
	0x17, GC02M1_SUNNY_MACRO_MIRROR,
	0x19, 0x04,
	0x24, 0x00,
	0x56, 0x20,
	0x5b, 0x00,
...
kal_uint16 addr_data_pair_preview_gc02m1_sunny_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1_sunny_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1_sunny_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1_sunny_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1_sunny_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_sunny_macro_table_write_cmos_sensor(addr_data_pair_init_gc02m1_sunny_macro,
		   sizeof(addr_data_pair_init_gc02m1_sunny_macro) /
		   sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	gc02m1_sunny_macro_table_write_cmos_sensor
	(addr_data_pair_preview_gc02m1_sunny_macro,
	 sizeof(addr_data_pair_preview_gc02m1_sunny_macro) / sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_sunny_macro_table_write_cmos_sensor
	(addr_data_pair_capture_gc02m1_sunny_macro,
	 sizeof(addr_data_pair_capture_gc02m1_sunny_macro) / sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_sunny_macro_table_write_cmos_sensor
	(addr_data_pair_normal_video_gc02m1_sunny_macro,
	 sizeof(addr_data_pair_normal_video_gc02m1_sunny_macro) /
	 sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_sunny_macro_table_write_cmos_sensor
	(addr_data_pair_hs_video_gc02m1_sunny_macro,
	 sizeof(addr_data_pair_hs_video_gc02m1_sunny_macro) / sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_sunny_macro_table_write_cmos_sensor
	(addr_data_pair_slim_video_gc02m1_sunny_macro,
	 sizeof(addr_data_pair_slim_video_gc02m1_sunny_macro) /
	 sizeof(kal_uint16));
}
...
unsigned int
gc02m1_sunny_macro_read_otp_info(struct i2c_client *client,
...
EXPORT_SYMBOL(gc02m1_sunny_macro_read_otp_info);
static void gc02m1_sunny_macro_read_otp(void)
{
	int i = 0;
...
static int get_gc02m1_sunny_macro_vendor_id(void)
{
	int module_id;
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfc, 0x01);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = get_sensor_id();
			LOG_INF("get_imgsensor_id read is %x!", *sensor_id);

			if (*sensor_id == imgsensor_info.sensor_id) {
				vendor_id = get_vendor_id();
				if (vendor_id == VENDOR_ID)
				{
					LOG_INF("i2c write id:0x%x, sensor id:0x%x, vendor_id = %d\n",
					 imgsensor.i2c_write_id,
					 *sensor_id, vendor_id);
					return ERROR_NONE;
				}
...
static kal_uint32 open(void)
{
	...
	LOG_INF("GC02M1_SUNNY_MACRO,MIPI 1LANE\n");
...
UINT32 GC02M1_SUNNY_MACRO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
