...
struct imgsensor_struct {
	...
	kal_uint8
	    hdr_mode; /* HDR mODE : 0: disable HDR, 1:IHDR, 2:HDR, 9:ZHDR */
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct
	    cap1; /* capture for PIP 15fps relative information*/
	struct imgsensor_mode_struct
	    cap2; /* capture for PIP 24fps relative information*/
	struct imgsensor_mode_struct
	...
	kal_uint8 i2c_addr_table
	    [5]; /* record sensor support all write id addr, only supprt 4must
		    end with 0xff */
};
...
extern int iReadRegI2CTiming(u8 *a_pSendData, u16 a_sizeSendData,
			     ...
			     u16 timing);
extern int iWriteRegI2CTiming(u8 *a_pSendData, u16 a_sizeSendData, u16 i2cId,
			      u16 timing);
