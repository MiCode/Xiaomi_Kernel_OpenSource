...
#define _SET_MODE3_V2_SENSOR_INFO_AND_WINSIZE_                                 \
	do {                                                                   \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE3_INIT_MODULE_V2_                                          \
	do {                                                                   \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE3_PREVIEW_MODULE_V2_                                       \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE3_CAPTURE_MODULE_V2_                                       \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE3_HS_VIDEO_MODULE_V2_                                      \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE3_SLIM_VIDEO_MODULE_V2_                                    \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE3_CAPTURE_WDR_MODULE_V2_                                   \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
