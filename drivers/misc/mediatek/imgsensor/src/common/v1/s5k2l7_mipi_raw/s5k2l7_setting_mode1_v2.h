...
#define _S5K2L7_MODE1_V2_SENSOR_INFO_                                          \
	static struct imgsensor_info_struct _imgsensor_info_m1_v2 =            \
	    {                                                                  \
	      .sensor_id = S5K2L7_SENSOR_ID, /* record sensor id defined in    \
						Kd_imgsensor.h */              \
	      .checksum_value =                                                \
		  0xb4cb9203, /* checksum value for Camera Auto Test  */       \
	      .pre =                                                           \
		  {.pclk = 960000000, /* record different mode's pclk */       \
		   .linelength =                                               \
		       10160, /* record different mode's linelength */         \
		   .framelength =                                              \
		       3149, /* record different mode's framelength */         \
		   .startx =                                                   \
		       0, /* record different mode's startx of grabwindow */   \
		   .starty =                                                   \
		       0, /* record different mode's starty of grabwindow */   \
		   .grabwindow_width =                                         \
		       2016, /* Dual PD: need to tg grab width / 2, p1 drv     \
				will * 2 itself */                             \
		   .grabwindow_height = 1512,       /* record different mode's \
		  ...
		  {.pclk = 960000000, /* record different mode's pclk */       \
		   .linelength =                                               \
		       10256, /* record different mode's linelength */         \
		   .framelength =                                              \
		       3120, /* record different mode's framelength */         \
		   .startx =                                                   \
		       0, /* record different mode's startx of grabwindow */   \
		   .starty =                                                   \
		       0, /* record different mode's starty of grabwindow */   \
		   .grabwindow_width =                                         \
		       4032, /* Dual PD: need to tg grab width / 2, p1 drv     \
				will * 2 itself */                             \
		   .grabwindow_height = 3024,       /* record different mode's \
						       height of grabwindow */ \
		   .mipi_data_lp2hs_settle_dc = 85, /* unit , ns */            \
		   .max_framerate = 300 },                                     \
	      .cap1 =                                                          \
		  ...
		  {                                                            \
		      ...
		      .startx = 0,                                             \
		      .starty = 0,                                             \
		      .grabwindow_width = 1344, /* record different mode's     \
						   width of grabwindow */      \
		      .grabwindow_height = 756, /* record different mode's     \
						   height of grabwindow */     \
		      .mipi_data_lp2hs_settle_dc = 85, /* unit , ns */         \
		      .max_framerate = 900,                                    \
		  },                                                           \
...
#define _S5K2L7_MODE1_V2_WINSIZE_INFO_                                         \
	static struct_SENSOR_WINSIZE_INFO _imgsensor_winsize_info_m1_v2[5] = { \
		{ 4032, 3024, 0, 0, 4032, 3024, 2016, 1512, 0, 0, 2016, 1512,  \
		  0, 0, 2016, 1512 }, /* Preview */                            \
		{ 4032, 3024, 0, 0, 4032, 3024, 4032, 3024, 0, 0, 4032, 3024,  \
		  0, 0, 4032, 3024 }, /* capture */                            \
		{ 4032, 3024, 0, 0, 4032, 3024, 4032, 3024, 0, 0, 4032, 3024,  \
		  0, 0, 4032, 3024 }, /* normal_video */                       \
		{ 4032, 3024, 0, 378, 4032, 2268, 1344, 756, 0, 0, 1344, 756,  \
		  0, 0, 1344, 756 }, /* hs_video */                            \
		{ 4032, 3024, 0, 378, 4032, 2268, 1344, 756, 0, 0, 1336, 756,  \
		  0, 0, 1344, 756 }, /* slim_video */                          \
	}

#define _SET_MODE1_V2_SENSOR_INFO_AND_WINSIZE_                                 \
	do {                                                                   \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE1_INIT_MODULE_V2_                                          \
	do {                                                                   \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE1_PREVIEW_MODULE_V2_                                       \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE1_CAPTURE_MODULE_V2_                                       \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE1_HS_VIDEO_MODULE_V2_                                      \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE1_SLIM_VIDEO_MODULE_V2_                                    \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
 ...
 *
 ****************************************************************************/
#define _S5K2L7_MODE1_CAPTURE_WDR_MODULE_V2_                                   \
	do {                                                                   \
		write_cmos_sensor_twobyte(0X6028, 0X4000);                     \
		write_cmos_sensor_twobyte(0X6214, 0X7970);                     \
		write_cmos_sensor_twobyte(0X6218, 0X7150);                     \
