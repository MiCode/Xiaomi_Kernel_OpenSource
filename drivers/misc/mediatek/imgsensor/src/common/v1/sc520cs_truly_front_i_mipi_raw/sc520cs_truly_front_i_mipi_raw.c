...
#include "sc520cs_truly_front_i_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC520CS_TRULY_FRONT_I_SENSOR_ID,
...
UINT32 SC520CS_TRULY_FRONT_I_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
