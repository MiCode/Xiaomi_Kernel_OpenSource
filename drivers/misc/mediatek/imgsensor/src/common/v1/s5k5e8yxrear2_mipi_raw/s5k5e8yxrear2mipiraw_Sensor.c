...
#define PFX "s5k5e8yxrear2_camera_sensor"
#define LOG_1 LOG_INF("s5k5e8yxrear2,MIPI 2LANE\n")
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	LOG_INF("S5K5E8YXREAR2_I2CBUS = %d\n", I2C_bus);
	if (I2C_bus != S5K5E8YXREAR2_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		LOG_INF("S5K5E8YXREAR2_I2CBUS: %d Check Error!\n", I2C_bus);
