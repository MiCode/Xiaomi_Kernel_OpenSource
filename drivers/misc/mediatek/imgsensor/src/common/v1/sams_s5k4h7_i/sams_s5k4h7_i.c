...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SAMS_S5K4H7_I_SENSOR_ID,  //0x487B
...
static void preview_setting(void)
{
	...
	write_cmos_sensor_8(0x030F, 0xA2);
	...
	write_cmos_sensor_8(0x0821, 0xBE);
	...
	write_cmos_sensor_8(0x0341, 0xDE);
...
static void hs_video_setting(void)
{
	...
	write_cmos_sensor_8(0x0306, 0x00);
	write_cmos_sensor_8(0x0307, 0x53);
	write_cmos_sensor_8(0x030D, 0x06);
	write_cmos_sensor_8(0x030E, 0x00);
	write_cmos_sensor_8(0x030F, 0xA2);
	write_cmos_sensor_8(0x3C1F, 0x00);
	...
	write_cmos_sensor_8(0x0343, 0xE4);
	write_cmos_sensor_8(0x0200, 0x0D);
	write_cmos_sensor_8(0x0201, 0x54);
	write_cmos_sensor_8(0x0202, 0x02);
	write_cmos_sensor_8(0x0203, 0x08);
	write_cmos_sensor_8(0x3400, 0x01);
...
static UINT8 get_sensor_module_id(void)
{
    ...
    for (i=0; i<15; i++) {
        calmoduleversion[i] = read_cmos_sensor_s5k4h7(0x01+i);
        //pr_err("%s %d s5k4h7_i module_id[%d]=0x%2x\n",__func__, __LINE__, i, calmoduleversion[i]);
	}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if (module_id != 0x10) {
					pr_err("Read ACC module id failed, module id = 0x%x\n", module_id);
...
UINT32 SAMS_S5K4H7_I_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
