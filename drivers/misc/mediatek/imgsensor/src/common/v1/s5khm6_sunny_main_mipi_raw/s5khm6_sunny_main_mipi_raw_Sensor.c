...
#include "s5khm6_sunny_main_mipi_raw_Sensor.h"
#include "s5khm6_sunny_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = S5KHM6_SUNNY_MAIN_SENSOR_ID, // 0x1AD6
...
static kal_uint16 set_gain_fullsize(kal_uint16 gain)
{
	...
	//gain = 64 = 1x real gain.
  LOG_INF("isz debug log: set_gain_fullsize gain =%d",gain);
...
UINT32
S5KHM6_SUNNY_MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc) {
