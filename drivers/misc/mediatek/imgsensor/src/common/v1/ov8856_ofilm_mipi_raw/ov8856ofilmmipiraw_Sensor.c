...
#define PFX "OV8856"
#define OV8856_OFILM_OTP
#ifdef OV8856_OFILM_OTP
...
static kal_uint16 ov8856_ofilm_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_ov8856_ofilm[] = {
    // base on AM12c
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
...
static void sensor_init(void)
{
	pr_err("v3 E\n");
#if 1	/* MULTI_WRITE */
	ov8856_ofilm_table_write_cmos_sensor(addr_data_pair_init_ov8856_ofilm,
			   sizeof(addr_data_pair_init_ov8856_ofilm) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856_ofilm[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366e, 0x08,
	0x3714, 0x27,
...
#endif
	ov8856_ofilm_table_write_cmos_sensor(addr_data_pair_preview_ov8856_ofilm,
				   sizeof(addr_data_pair_preview_ov8856_ofilm) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856_ofilm[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
kal_uint16 addr_data_pair_capture_15fps_ov8856_ofilm[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
#endif
	if (currefps == 150) {
		ov8856_ofilm_table_write_cmos_sensor(addr_data_pair_capture_15fps_ov8856_ofilm,
					       sizeof(addr_data_pair_capture_15fps_ov8856_ofilm) /
					       sizeof(kal_uint16));
	} else {
		ov8856_ofilm_table_write_cmos_sensor(addr_data_pair_capture_30fps_ov8856_ofilm,
					       sizeof(addr_data_pair_capture_30fps_ov8856_ofilm) /
					       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_normal_video_setting_ov8856_ofilm[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
static void normal_video_setting(void)
{
	...
	ov8856_ofilm_table_write_cmos_sensor(addr_data_pair_normal_video_setting_ov8856_ofilm,
				   sizeof(addr_data_pair_normal_video_setting_ov8856_ofilm) /
				   sizeof(kal_uint16));
