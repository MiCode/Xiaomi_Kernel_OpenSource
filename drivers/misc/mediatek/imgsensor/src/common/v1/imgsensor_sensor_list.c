...
{S5KGM1SP_OFILM_SENSOR_ID, SENSOR_DRVNAME_S5KGM1SP_OFILM_MIPI_RAW, S5KGM1SP_OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV13B10_OFILM_MIPI_RAW)
{OV13B10_OFILM_SENSOR_ID, SENSOR_DRVNAME_OV13B10_OFILM_MIPI_RAW, OV13B10_OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV13855_OFILM_MIPI_RAW)
{OV13855_OFILM_SENSOR_ID, SENSOR_DRVNAME_OV13855_OFILM_MIPI_RAW, OV13855_OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV8856_OFILM_MIPI_RAW)
{OV8856_OFILM_SENSOR_ID, SENSOR_DRVNAME_OV8856_OFILM_MIPI_RAW, OV8856_OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1_OFILM_MIPI_RAW)
{GC02M1_OFILM_SENSOR_ID, SENSOR_DRVNAME_GC02M1_OFILM_MIPI_RAW, GC02M1_OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV02A10_SUNNY_MIPI_RAW)
    {OV02A10_SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV02A10_SUNNY_MIPI_RAW, OV02A10_SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(GC2375H_OFILM_MIPI_RAW)
{GC2375H_OFILM_SENSOR_ID, SENSOR_DRVNAME_GC2375H_OFILM_MIPI_RAW, GC2375H_OFILM_MIPI_RAW_SensorInit},
#endif
//C3J1 end
	/*IMX*/
