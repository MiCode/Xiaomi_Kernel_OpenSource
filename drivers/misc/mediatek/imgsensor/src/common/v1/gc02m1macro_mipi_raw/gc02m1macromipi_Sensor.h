 ...
 *
 ****************************************************************************/
#ifndef __GC02M1MACROMIPI_SENSOR_H__
#define __GC02M1MACROMIPI_SENSOR_H__


/* SENSOR MIRROR FLIP INFO */
#define GC02M1MACRO_MIRROR_NORMAL    0
#define GC02M1MACRO_MIRROR_H         0
#define GC02M1MACRO_MIRROR_V         0
#define GC02M1MACRO_MIRROR_HV        1

#if GC02M1MACRO_MIRROR_NORMAL
#define GC02M1MACRO_MIRROR	        0x80
#elif GC02M1MACRO_MIRROR_H
#define GC02M1MACRO_MIRROR	        0x81
#elif GC02M1MACRO_MIRROR_V
#define GC02M1MACRO_MIRROR	        0x82
#elif GC02M1MACRO_MIRROR_HV
#define GC02M1MACRO_MIRROR	        0x83
#else
#define GC02M1MACRO_MIRROR 0x80
#endif
/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define GC02M1MACRO_SENSOR_GAIN_BASE             0x400
#define GC02M1MACRO_SENSOR_GAIN_MAX              (12 * GC02M1MACRO_SENSOR_GAIN_BASE)
#define GC02M1MACRO_SENSOR_GAIN_MAX_VALID_INDEX  16
#define GC02M1MACRO_SENSOR_GAIN_MAP_SIZE         16
#define GC02M1MACRO_SENSOR_DGAIN_BASE            0x400
