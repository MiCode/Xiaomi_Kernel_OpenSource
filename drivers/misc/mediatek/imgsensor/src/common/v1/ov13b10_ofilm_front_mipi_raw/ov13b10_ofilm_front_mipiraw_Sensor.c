 ...
 * Filename:
 * ---------
 *     ov13b10_ofilm_front_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "ov13b10_ofilm_front_mipiraw_Sensor.h"
...
#define OV13B10_OFILM_EEPROM_I2C_ADDR (0xA2)
#define OV13B10_OFILM_EEPROM_VENDOR_ID (0x07)

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_OFILM_FRONT_SENSOR_ID,
	...
	.slim_video = {
		...
		.mipi_data_lp2hs_settle_dc = 90,	//unit(ns), 16/23/65/85 recommanded
		.mipi_pixel_rate = 448000000,
        .max_framerate = 240,	
				...
				kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	LOG_DBG("Exit! shutter =%d, framelength =%d/%d, dummy_line=%d\n",
...
static void preview_setting(void)
{
	...
	ov13b10ofilm_table_write_cmos_sensor(
		...
		sizeof(addr_data_pair_preview_ov13b10ofilm) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
static kal_uint16 get_vendor_id(void)
{
        ...
        iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, OV13B10_OFILM_EEPROM_I2C_ADDR);
        return get_byte;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		i++;
#if 0
		size = imgSensorReadEepromData(&sensor_eeprom_data,ov13b10ofilmChecksum);
	    ...
	    do {
	              *sensor_id = return_sensor_id();
	              if (*sensor_id == imgsensor_info.sensor_id) {
                          LOG_INF("ov13b10_ofilm i2c write id: 0x%x, sensor id: 0x%x \n",
                                                  imgsensor.i2c_write_id,*sensor_id);
                          return ERROR_NONE;
                      }else{
                          LOG_ERR("ov13b10_ofilm check id fail i2c write id: 0x%x, sensor id: 0x%x\n",
                                                imgsensor.i2c_write_id,*sensor_id);
                          *sensor_id = 0xFFFFFFFF;
                    }
		    LOG_ERR("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
/*#if OTP_OV13B10
				ov13b10ofilm_read_data_from_eeprom(OV13B10_EEPROM_SLAVE_ADD,0x000B,1);
#if INCLUDE_NO_OTP_OV13B10
				if ((ov13b10ofilm_otp_data.module_id > 0) && (ov13b10ofilm_otp_data.module_id < 0xFFFF)) {
#endif
					if (ov13b10ofilm_otp_data.module_id != OV13B10_OFILM_MODULE_ID) {
						*sensor_id = 0xFFFFFFFF;
						return ERROR_SENSOR_CONNECT_FAIL;
					} else
						LOG_INF("This is ofilm --->ov13b10ofilm otp data vaild ...");
#if INCLUDE_NO_OTP_OV13B10
				} else {
					LOG_INF("This is ov13b10ofilm, but no otp data ...");
				}
#endif
#endif*/
...
//PIP capture: 24fps for less than 13M, 20fps for 16M,15fps for 20M
	...
	if (imgsensor.current_fps != imgsensor_info.cap.max_framerate)
		LOG_DBG("current_fps %d fps is not support,use cap: %d fps!\n",
...
UINT32 OV13B10_OFILM_FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
