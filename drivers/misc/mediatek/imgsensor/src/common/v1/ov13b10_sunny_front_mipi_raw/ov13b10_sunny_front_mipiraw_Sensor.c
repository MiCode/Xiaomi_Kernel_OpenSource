 ...
 * Filename:
 * ---------
 *     ov13b10_sunny_front_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 * Setting version:
 * ------------
 *   update full pd setting for OV13B10_SUNNY_AM04
 *------------------------------------------------------------------------------
...
#include "ov13b10_sunny_front_mipiraw_Sensor.h"
...
#define OV13B10_SUNNY_EEPROM_I2C_ADDR (0xA2)
#define OV13B10_SUNNY_EEPROM_VENDOR_ID (0x01)

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_SUNNY_FRONT_SENSOR_ID,
...
static kal_uint16 ov13b10sunny_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10sunny[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10sunny_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10sunny,
		sizeof(addr_data_pair_init_ov13b10sunny) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10sunny[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x0327, 0x04,
	0x3f02, 0x0f,
...
#if MULTI_WRITE
	ov13b10sunny_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10sunny,
		sizeof(addr_data_pair_preview_ov13b10sunny) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10sunny[] = {
//	0x0100, 0x00,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10sunny[] = {
//	0x0100, 0x00,
	0x0305, 0x46, 
	0x0327, 0x05,
	0x3f02, 0x2a,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	ov13b10sunny_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov13b10sunny,
		sizeof(addr_data_pair_capture_15fps_ov13b10sunny) /
		sizeof(kal_uint16));
	} else {
	ov13b10sunny_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov13b10sunny,
		sizeof(addr_data_pair_capture_30fps_ov13b10sunny) /
		sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10sunny[] = {
//	0x0100, 0x00,
	0x0305, 0x46, 
	0x0327, 0x05,
	0x3f02, 0x2a,
...
#if MULTI_WRITE
	ov13b10sunny_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10sunny,
		sizeof(addr_data_pair_video_ov13b10sunny) /
		sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10sunny[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x0327, 0x04,
	0x3f02, 0x0f,
...
#if MULTI_WRITE
	ov13b10sunny_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10sunny,
		sizeof(addr_data_pair_hs_video_ov13b10sunny) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10sunny[] = {
	//0x0100, 0x00,
	0x0305, 0x46,
	0x0327, 0x05,
	0x3f02, 0x2a,
...
#if MULTI_WRITE
	ov13b10sunny_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10sunny,
		sizeof(addr_data_pair_slim_video_ov13b10sunny) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
...
static kal_uint16 get_vendor_id(void)
{
        ...
        iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, OV13B10_SUNNY_EEPROM_I2C_ADDR);
        return get_byte;
...
static kal_uint32 return_sensor_id(void)
{
	...
	if(OV13B10_SUNNY_EEPROM_VENDOR_ID == vendor_id){
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		i++;
#if 0
		size = imgSensorReadEepromData(&sensor_eeprom_data,ov13b10sunnyChecksum);
	    ...
	    do {
	              *sensor_id = return_sensor_id();
	              if (*sensor_id == imgsensor_info.sensor_id) {
                          LOG_INF("ov13b10_sunny i2c write id: 0x%x, sensor id: 0x%x \n",
                                                  imgsensor.i2c_write_id,*sensor_id);
                          return ERROR_NONE;
                      }else{
                          LOG_ERR("ov13b10_sunny check id fail i2c write id: 0x%x, sensor id: 0x%x\n",
                                                imgsensor.i2c_write_id,*sensor_id);
                          *sensor_id = 0xFFFFFFFF;
                    }
		    LOG_ERR("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
/*#if OTP_OV13B10
				ov13b10sunny_read_data_from_eeprom(OV13B10_EEPROM_SLAVE_ADD,0x000B,1);
#if INCLUDE_NO_OTP_OV13B10
				if ((ov13b10sunny_otp_data.module_id > 0) && (ov13b10sunny_otp_data.module_id < 0xFFFF)) {
#endif
					if (ov13b10sunny_otp_data.module_id != OV13B10_OFILM_MODULE_ID) {
						*sensor_id = 0xFFFFFFFF;
						return ERROR_SENSOR_CONNECT_FAIL;
					} else
						LOG_INF("This is ofilm --->ov13b10sunny otp data vaild ...");
#if INCLUDE_NO_OTP_OV13B10
				} else {
					LOG_INF("This is ov13b10sunny, but no otp data ...");
				}
#endif
#endif*/
