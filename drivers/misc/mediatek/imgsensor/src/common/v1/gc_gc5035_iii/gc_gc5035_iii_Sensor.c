...
#define gc5035_vendor_id  0x41 //0x41 for aac
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC_GC5035_III_SENSOR_ID,
...
static kal_uint16 read_cmos_sensor_gc5035(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
...
static void gc5035_fusion_id_read(void)
{
	int i;
	for (i=0; i<9; i++) {
		fusion_id_front[i] = read_cmos_sensor_gc5035(0x24+i);
