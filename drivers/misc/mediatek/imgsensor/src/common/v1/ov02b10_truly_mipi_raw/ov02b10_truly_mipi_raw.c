...
#include "ov02b10_truly_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV02B10_TRULY_SENSOR_ID,
	
	.checksum_value = 0x3cde62ee,       //0x6d01485c // Auto Test Mode
...
static void set_dummy(void)
{
	...
	write_cmos_sensor(0x14, ((imgsensor.frame_length - 0x4c4) >> 8) & 0xFF);
...
//  //    pr_err("OV02B1B_EEPROM_I2C_ADDR = 0x%x \n",OV02B1B_EEPROM_I2C_ADDR);
