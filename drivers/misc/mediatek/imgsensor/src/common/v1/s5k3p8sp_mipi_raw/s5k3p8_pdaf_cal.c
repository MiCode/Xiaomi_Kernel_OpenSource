...
/* #define LOG_2 \
 * LOG_INF("preview 2096*1552@30fps,640Mbps/lane; video
 * 4192*3104@30fps,1.2Gbps/lane; capture 13M@30fps,1.2Gbps/lane\n")
 */
/****************************   Modify end
 * *******************************************/
...
static bool s5k3p8_selective_read_eeprom(kal_uint16 addr, BYTE *data)
{
	...
	if (iReadRegI2C(pu_send_cmd0, 2, (u8 *)(data + 1), 1, EEPROM_READ_ID) <
	    0)
		return false;
