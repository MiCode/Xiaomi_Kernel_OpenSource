...
//#define HI259_SENSOR_ID 0xe1

extern bool read_hi259_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi259[] = {
0x03, 0x00,
0x01, 0x01,
};
#endif
...
#if MULTI_WRITE
	hi259_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi259,
		sizeof(addr_data_pair_hs_video_hi259) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x03, 0x00);
	write_cmos_sensor(0x01, 0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi259[] = {
0x03, 0x00,
0x01, 0x01,
};
#endif
...
#if MULTI_WRITE
	hi259_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi259,
		sizeof(addr_data_pair_slim_video_hi259) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x03, 0x00);
	write_cmos_sensor(0x01, 0x01);
