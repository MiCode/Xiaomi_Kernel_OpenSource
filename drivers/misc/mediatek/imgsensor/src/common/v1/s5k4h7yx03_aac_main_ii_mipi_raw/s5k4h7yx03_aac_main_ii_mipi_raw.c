 ...
 * Filename:
 * ---------
 *	 s5k4h7yx03_aac_main_ii_mipi_raw.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5k4h7yx03_aac_main_ii_mipi_raw.h"
...
//#define DEVICE_VERSION_S5K4H7YX03    "s5k4h7yx03"
...
#define PFX "s5k4h7yx03_camera_sensor"
#define LOG_1 LOG_INF("s5k4h7yx03,MIPI 2LANE\n")
#define LOG_2 \
...
//kal_uint8 s5k4h7yx03_2a_data[33];

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static MUINT32 g_sync_mode = SENSOR_NO_SYNC_MODE;
//static int first_flag = 1;
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX03_AAC_MAIN_II_SENSOR_ID,  //0x487B
...
static kal_uint16 read_cmos_sensor_s5k4h7yx03(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pu_send_cmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
...
static void s5k4h7yx03_fusion_id_read(void)
{
	int i;
	for (i=0; i<8; i++) {
		fusion_id_main[i] = read_cmos_sensor_s5k4h7yx03(0x10+i);
		//pr_info("%s %d fusion_id_front[%d]=0x%2x\n",__func__, __LINE__, i, fusion_id_main[i]);
	}
}
static void s5k4h7yx03_sn_read(void)
{
	int i;
	for (i=0; i<14; i++) {
		sn_main[i] = read_cmos_sensor_s5k4h7yx03(0x1F92+i);
...
UINT32 S5K4H7YX03_AAC_MAIN_II_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
