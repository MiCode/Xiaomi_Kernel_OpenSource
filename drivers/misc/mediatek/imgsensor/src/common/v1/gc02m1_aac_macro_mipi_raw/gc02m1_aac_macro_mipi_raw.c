...
#include "gc02m1_aac_macro_mipi_raw.h"

#define VENDOR_ID_ENABLE        1
#define VENDOR_ID               0x10
#define PFX                     "GC02M1_AAC_MACRO"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_AAC_MACRO_SENSOR_ID,
...
static kal_uint16
gc02m1_aac_macro_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < GC02M1_AAC_MACRO_SENSOR_GAIN_BASE)
		reg_gain = GC02M1_AAC_MACRO_SENSOR_GAIN_BASE;
	else if (reg_gain > GC02M1_AAC_MACRO_SENSOR_GAIN_MAX)
		reg_gain = GC02M1_AAC_MACRO_SENSOR_GAIN_MAX;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16
	GC02M1_AAC_MACRO_AGC_Param[GC02M1_AAC_MACRO_SENSOR_GAIN_MAX_VALID_INDEX][2]
	= {
		{1024, 0},
		{1536, 1},
		{2035, 2},
	...
	for (gain_index = GC02M1_AAC_MACRO_SENSOR_GAIN_MAX_VALID_INDEX - 1;
			gain_index >= 0; gain_index--)
		if (reg_gain >= GC02M1_AAC_MACRO_AGC_Param[gain_index][0])
			break;
	...
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xb6, GC02M1_AAC_MACRO_AGC_Param[gain_index][1]);
	temp_gain =
		reg_gain * GC02M1_AAC_MACRO_SENSOR_DGAIN_BASE /
		GC02M1_AAC_MACRO_AGC_Param[gain_index][0];
	...
	("GC02M1 aac_macro = 0x%x, temp_gain = 0x%x, reg_gain = %d\n",
	 GC02M1_AAC_MACRO_AGC_Param[gain_index][1], temp_gain, reg_gain);
...
kal_uint16 addr_data_pair_init_gc02m1_aac_macro[] = {
...
kal_uint16 addr_data_pair_preview_gc02m1_aac_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1_aac_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1_aac_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1_aac_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1_aac_macro[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_aac_macro_table_write_cmos_sensor(addr_data_pair_init_gc02m1_aac_macro,
		   sizeof(addr_data_pair_init_gc02m1_aac_macro) /
		   sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	gc02m1_aac_macro_table_write_cmos_sensor
	(addr_data_pair_preview_gc02m1_aac_macro,
	 sizeof(addr_data_pair_preview_gc02m1_aac_macro) / sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_aac_macro_table_write_cmos_sensor
	(addr_data_pair_capture_gc02m1_aac_macro,
	 sizeof(addr_data_pair_capture_gc02m1_aac_macro) / sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_aac_macro_table_write_cmos_sensor
	(addr_data_pair_normal_video_gc02m1_aac_macro,
	 sizeof(addr_data_pair_normal_video_gc02m1_aac_macro) /
	 sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_aac_macro_table_write_cmos_sensor
	(addr_data_pair_hs_video_gc02m1_aac_macro,
	 sizeof(addr_data_pair_hs_video_gc02m1_aac_macro) / sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_aac_macro_table_write_cmos_sensor
	(addr_data_pair_slim_video_gc02m1_aac_macro,
	 sizeof(addr_data_pair_slim_video_gc02m1_aac_macro) /
	 sizeof(kal_uint16));
}
...
unsigned int
gc02m1_aac_macro_read_otp_info(struct i2c_client *client,
...
EXPORT_SYMBOL(gc02m1_aac_macro_read_otp_info);
static void gc02m1_aac_macro_read_otp(void)
{
	int i = 0;
...
static int get_gc02m1_aac_macro_vendor_id(void)
{
	int module_id;
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfc, 0x01);
...
static kal_uint32 open(void)
{
	...
	LOG_INF("GC02M1_AAC_MACRO,MIPI 1LANE\n");
...
UINT32 GC02M1_AAC_MACRO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
