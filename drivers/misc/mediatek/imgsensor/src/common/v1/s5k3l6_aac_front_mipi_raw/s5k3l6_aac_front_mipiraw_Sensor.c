...
#define PFX "S5K3L6_AAC_FRONT_camera_sensor"
...
#include "s5k3l6_aac_front_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
        .sensor_id = S5K3L6_AAC_FRONT_SENSOR_ID,
...
unsigned int
s5k3l6_aac_front_get_otpdata(unsigned char *data, u16 i2cId)
{
        int ii = 0;
                ...
                do {
                    if (1) {
                        *sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) ;
                        pr_err("s5k3l6_aac_sensor_id:0x%x==0x%x",*sensor_id,imgsensor_info.sensor_id);
                        if (*sensor_id == imgsensor_info.sensor_id) {
//                                hw_info_main_otp.sensor_name = SENSOR_DRVNAME_S5K3L6_AAC_MIPI_RAW;
/*
#ifdef S5K3L6_AAC_EEPROM_CALI
...
*/
                        ...
                        pr_err("s5k3l6 aac vendor id not match :0x%x", vendorId);
                    }
...
UINT32 S5K3L6_AAC_FRONT_MIPI_RAW_SensorInit(
