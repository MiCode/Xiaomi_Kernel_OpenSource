...
#include "imx355_sunny_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355_SUNNY_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{3264, 2448, 0,   0,   3264, 2448, 3264, 2448, 0, 0, 3264, 2448,  0,  0, 3264, 2448}, /* hs_video 240fps*/
	{3264, 2448, 0,   0,   3264, 2448, 3264, 2448, 0, 0, 3264, 2448,  0,  0, 3264, 2448}, /* slim video same as pre*/
    {3264, 2448, 0,   0,   3264, 2448, 1632, 1224, 0, 0, 1632, 1224,  0,  0, 1632, 1224}, /* custom1 */
	{3264, 2448, 0,   0,   3264, 2448, 3264, 2448, 0, 0, 3264, 2448,  0,  0, 3264, 2448}, /* custom2 1600x900@120fps*/
	{3264, 2448, 0,   0,   3264, 2448, 3264, 2448, 0, 0, 3264, 2448,  0,  0, 3264, 2448}, /* custom3 preview@24fps*/
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_HDR_SHUTTER:
		LOG_INF("SENSOR_FEATURE_SET_HDR_SHUTTER LE=%llu, SE=%llu\n",
