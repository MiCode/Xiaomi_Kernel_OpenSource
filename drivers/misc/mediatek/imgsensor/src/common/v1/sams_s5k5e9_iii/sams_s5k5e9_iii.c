...
#include "sams_s5k5e9_iii.h"

/****************************Modify following Strings for debug****************************/
#define PFX "sams_s5k5e9_iii_camera_sensor"
...
static  imgsensor_info_struct imgsensor_info = {
    .sensor_id = SAMS_S5K5E9_III_SENSOR_ID,
//  .checksum_value = 0x2ae69154,
    .checksum_value = 0x42d95d37,
    .pre = {
    .pclk = 190700000,              //record different mode's pclk
        .linelength = 3112,    /* record different mode's linelength */
        .framelength = 2036,         //record different mode's framelength
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
    ...
    {2592, 1944, 0, 242, 2592, 1460, 2592, 1460, 0000, 0000, 2592, 1460, 0, 0, 2592, 1460},    /* high speed video */
    {2592, 1944, 0, 242, 2592, 1460, 2592, 1460, 0000, 0000, 2592, 1460, 0, 0, 2592, 1460},    /*  slim video */
    {2592, 1944, 0, 242, 2592, 1460, 2592, 1460, 0000, 0000, 2592, 1460, 0, 0, 2592, 1460},    // custom1 (for shortvideo; copy normal video)
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor_8(0x3931,    0x02);  //zhurunlong edit, dont touch
    write_cmos_sensor_8(0x392F,    0x01);  //zhurunlong edit, dont touch
    write_cmos_sensor_8(0x3930,    0x80);  //zhurunlong edit, dont touch
    write_cmos_sensor_8(0x3932,    0x88);  //zhurunlong edit, dont touch
...
static void preview_setting(void)
{
    ...
    write_cmos_sensor_8(0x030D,    0x05);
    write_cmos_sensor_8(0x030E,    0x00);
    write_cmos_sensor_8(0x030F,    0xAD);
    ...
    write_cmos_sensor_8(0x3941,    0x0F);
    write_cmos_sensor_8(0x3942,    0x3D);
...
{
    pr_err("capture_settingzaki 900M");
    write_cmos_sensor_8(0x0100,    0x00);
...
UINT32 SAMS_S5K5E9_III_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
