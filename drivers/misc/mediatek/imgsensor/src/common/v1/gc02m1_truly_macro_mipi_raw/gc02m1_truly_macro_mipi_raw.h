 ...
 * Filename:
 * ---------
 *     GC02_Truly_M1mipi_raw_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef __GC02M1_TRULY_MACRO_MIPI_SENSOR_H__
#define __GC02M1_TRULY_MACRO_MIPI_SENSOR_H__

/* N19A code for HQ-357416 by p-xuyechen at 2023/12/17 */
#define GC02M1_TRULY_MACRO_MIRROR_FLIP_ENABLE         0
#if GC02M1_TRULY_MACRO_MIRROR_FLIP_ENABLE
#define GC02M1_TRULY_MACRO_MIRROR 0x83
#else
#define GC02M1_TRULY_MACRO_MIRROR 0x80
#endif
/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define GC02M1_TRULY_MACRO_SENSOR_GAIN_BASE             0x400
#define GC02M1_TRULY_MACRO_SENSOR_GAIN_MAX              (12 * GC02M1_TRULY_MACRO_SENSOR_GAIN_BASE)
#define GC02M1_TRULY_MACRO_SENSOR_GAIN_MAX_VALID_INDEX  16
#define GC02M1_TRULY_MACRO_SENSOR_GAIN_MAP_SIZE         16
#define GC02M1_TRULY_MACRO_SENSOR_DGAIN_BASE            0x400
