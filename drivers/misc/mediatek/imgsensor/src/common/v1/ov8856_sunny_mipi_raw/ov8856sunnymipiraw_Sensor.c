...
#define PFX "OV8856"
#define OV8856_SUNNY_OTP
#ifdef OV8856_SUNNY_OTP

#endif
#define LOG_INF(fmt, args...)   pr_debug(PFX "[%s] " fmt, __func__, ##args)

//[ITD]modify for XLBBCHLYYB-238 to improve Camera performance by wei.miao 20201102 start

extern void kdSetI2CSpeed(u32 i2cSpeed);
//[ITD]modify for XLBBCHLYYB-238 to improve Camera performance by wei.miao 20201102 end
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856_SUNNY_SENSOR_ID,		/*record sensor id defined in Kd_imgsensor.h*/
	.checksum_value = 0xca71b5d,//0xb1893b4f,		/*checksum value for Camera Auto Test*/
	.pre = {
...
//[ITD]modify for XLBBCHLYYB-238 to improve Camera performance by wei.miao 20201102 end
	...
	.i2c_speed = 400,//[ITD]modify for XLBBCHLYYB-238 to improve Camera performance by wei.miao 20201102
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
 ...
 { 3264, 2448,  0,  0,  3264,  2448,  3264,  2448,672,684,  1920,  1080,  0,  0,  1920,  1080}, // hs_video 
 { 3264, 2448,  0,  0,  3264,  2448,  3264,  2448,672,684,  1920,  1080,  0,  0,  1920,  1080}// slim video
};
...
static kal_uint16 ov8856_sunny_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static void set_max_framerate(UINT16 framerate, kal_bool min_framelength_en)
{
	...
	pr_err("framerate = %d, min framelength should enable?\n", framerate);
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	pr_err("Add for N3D! shutterlzl =%d, framelength =%d\n", shutter, imgsensor.frame_length);
...
static void set_shutter(kal_uint16 shutter)
{
	...
	write_cmos_sensor(0x3501, (shutter >> 4) & 0xFF);
	write_cmos_sensor(0x3500, (shutter >> 12) & 0x0F);
	pr_err("Exit! shutter =%d, framelength =%d\n", shutter, imgsensor.frame_length);
...
{
	pr_err("le:0x%x, se:0x%x, gain:0x%x\n", le, se, gain);
...
kal_uint16 addr_data_pair_init_ov8856_sunny[] = {
    // base on AM12c
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
...
static void sensor_init(void)
{
	pr_err("v3 E\n");
#if 1	/* MULTI_WRITE */
	ov8856_sunny_table_write_cmos_sensor(addr_data_pair_init_ov8856_sunny,
			   sizeof(addr_data_pair_init_ov8856_sunny) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856_sunny[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366e, 0x08,
	0x3714, 0x27,
...
#endif
	ov8856_sunny_table_write_cmos_sensor(addr_data_pair_preview_ov8856_sunny,
				   sizeof(addr_data_pair_preview_ov8856_sunny) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856_sunny[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
kal_uint16 addr_data_pair_capture_15fps_ov8856_sunny[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
#endif
	if (currefps == 150) {
		ov8856_sunny_table_write_cmos_sensor(addr_data_pair_capture_15fps_ov8856_sunny,
					       sizeof(addr_data_pair_capture_15fps_ov8856_sunny) /
					       sizeof(kal_uint16));
	} else {
		ov8856_sunny_table_write_cmos_sensor(addr_data_pair_capture_30fps_ov8856_sunny,
					       sizeof(addr_data_pair_capture_30fps_ov8856_sunny) /
					       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_normal_video_setting_ov8856_sunny[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
static void normal_video_setting(void)
{
	...
	ov8856_sunny_table_write_cmos_sensor(addr_data_pair_normal_video_setting_ov8856_sunny,
				   sizeof(addr_data_pair_normal_video_setting_ov8856_sunny) /
				   sizeof(kal_uint16));
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	printk("8856sunny------0x%x\n",vendor_id);
    if (vendor_id != 0x01) {
      pr_err("Vendor_id: 0x%x, this should be 0x01!\n", vendor_id);
		...
		do {
			*sensor_id = (((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C)));
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_err("i2c write id: 0x%x, sensor id: 0x%x, ver = 0x%x<0xB1=r2a,0xB0=r1a>\n",
					imgsensor.i2c_write_id, *sensor_id, read_cmos_sensor(0x302A));
				return ERROR_NONE;
			}
			pr_err("Read sensor id fail,write_id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
...
static kal_uint32 open(void)
{
	...
	pr_err("PLATFORM:Vison,MIPI 4LANE\n");
	pr_err("read_cmos_sensor(0x302A): 0x%x\n", read_cmos_sensor(0x302A));
	/*sensor have two i2c address 0x6c 0x6d & 0x21 0x20, we should detect the module used i2c address*/
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		spin_lock(&imgsensor_drv_lock);
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
		...
		do {
			...
			pr_err("Read sensor id fail, write: 0x%x, sensor: 0x%x\n", imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		if (sensor_id == imgsensor_info.sensor_id)
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	preview_setting();
	set_mirror_flip(imgsensor.mirror);
	//mdelay(10);//[ITD]modify for XLBBCHLYYB-238 to improve Camera performance by wei.miao 20201102
	return ERROR_NONE;
}	/*	preview   */
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (imgsensor.current_fps == imgsensor_info.cap1.max_framerate) {/*15fps*/
		...
		if (imgsensor.current_fps != imgsensor_info.cap.max_framerate)
			pr_err("Warning: current_fps %d fps is not support, so use cap1's setting: %d fps!\n",
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_TEMPERATURE_VALUE:
		pr_err("This sensor can't support temperature get\n");
		break;
...
UINT32 OV8856_SUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV8856_SUNNY_MIPI_RAW_SensorInit	*/