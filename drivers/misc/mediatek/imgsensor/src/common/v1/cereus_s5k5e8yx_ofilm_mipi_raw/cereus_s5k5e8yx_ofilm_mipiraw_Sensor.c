...
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = CEREUS_S5K5E8YX_OFILM_SENSOR_ID,
...
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= CEREUS_S5K5E8YX_OFILM_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 386,
	.sensorVendorid = 0x072DFFFF,
	.vendorByte = {1,8,9,10},
	.dataBuffer = NULL,
};
...
static kal_uint16 cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
 ...
 *************************************************************************/
#if MULTI_WRITE
static kal_uint16 addr_data_pair_init_cereus_s5k5e8yx_ofilm[] = {
	0x0100, 0x00,
	0x3906, 0x7E,
	0x3C01, 0x0F,
	0x3C14, 0x00,
...
static void sensor_init(void)
{
	...
	cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_init_cereus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_init_cereus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_preview_cereus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_preview_cereus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_preview_cereus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_capture_15fps_cereus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static kal_uint16 addr_data_pair_capture_24fps_cereus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static kal_uint16 addr_data_pair_capture_30fps_cereus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_cereus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_capture_15fps_cereus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_cereus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_capture_24fps_cereus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
	} else {
	cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_cereus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_capture_30fps_cereus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 150){
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_hs_video_cereus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
		addr_data_pair_hs_video_cereus_s5k5e8yx_ofilm,
		sizeof(addr_data_pair_hs_video_cereus_s5k5e8yx_ofilm) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136,0x18);
	write_cmos_sensor(0x0137,0x00);
...
#if MULTI_WRITE
static kal_uint16 addr_data_pair_slim_video_cereus_s5k5e8yx_ofilm[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
cereus_s5k5e8yx_ofilm_table_write_cmos_sensor(
	addr_data_pair_slim_video_cereus_s5k5e8yx_ofilm,
	sizeof(addr_data_pair_slim_video_cereus_s5k5e8yx_ofilm) /
	sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136,0x18);
	write_cmos_sensor(0x0137,0x00);
...
#define CEREUS_S5K5E8YX_OFILM_I2CBUS    (4)
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	LOG_DBG("CEREUS_S5K5E8YX_OFILM_I2CBUS = %d, I2C_bus = %d\n", CEREUS_S5K5E8YX_OFILM_I2CBUS, I2C_bus);
	if (I2C_bus != CEREUS_S5K5E8YX_OFILM_I2CBUS) {
		*sensor_id = 0xFFFFFFFF;
		LOG_ERR("CEREUS_S5K5E8YX_OFILM_I2CBUS: %d, I2C_bus = %d, Check Error!\n", CEREUS_S5K5E8YX_OFILM_I2CBUS, I2C_bus);
