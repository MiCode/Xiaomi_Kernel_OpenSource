...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_PDN,   IMGSENSOR_HW_ID_GPIO},//use as dphy avdd 1.8v
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
		...
		{
			SENSOR_DRVNAME_OV48BSUNNY_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
		...
		{
			SENSOR_DRVNAME_OV48BOFILM_MIPI_RAW,
			{
				{RST, Vol_Low, 0},
				{SensorMCLK, Vol_High, 0},
				{DOVDD, Vol_1800, 0},
...
#if defined(IMX582_MIPI_RAW)
		{
			SENSOR_DRVNAME_IMX582_MIPI_RAW,
			{
				...
				{AVDD, Vol_2800, 0},
				{AFVDD, Vol_2800, 0},
				{PDN, Vol_High, 0},//use as supply avdd 1.8v
				{DVDD, Vol_1200, 2},
				{RST, Vol_High, 5}
			},
		},
	...
	{
		SENSOR_DRVNAME_HI847SUNNY_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
	...
	{
		SENSOR_DRVNAME_HI847OFILM_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
	...
	{
		SENSOR_DRVNAME_GC5035SUNNY_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
	...
	{
		SENSOR_DRVNAME_GC5035OFILM_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
