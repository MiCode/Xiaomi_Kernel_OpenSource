...
#endif
#if defined(LOTUS_IMX486_OFILM_MIPI_RAW)
	{
		SENSOR_DRVNAME_LOTUS_IMX486_OFILM_MIPI_RAW,
		{
	        {DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
			{DVDD, Vol_1200, 1},
...
#endif
#if defined(LOTUS_OV12A10_SUNNY_MIPI_RAW)
	{
		SENSOR_DRVNAME_LOTUS_OV12A10_SUNNY_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{PDN, Vol_Low, 1},
			{AVDD, Vol_2800, 1},
...
#endif
#if defined(LOTUS_S5K4H7YX_OFILM_MIPI_RAW)
	{
		SENSOR_DRVNAME_LOTUS_S5K4H7YX_OFILM_MIPI_RAW,
		{
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low, 1},
            {PDN, Vol_Low, 1},
...
#endif
#if defined(LOTUS_S5K4H7YX_QTECH_MIPI_RAW)
	{
		SENSOR_DRVNAME_LOTUS_S5K4H7YX_QTECH_MIPI_RAW,
		{
            {SensorMCLK, Vol_High, 0},
            {RST, Vol_Low, 1},
            {PDN, Vol_Low, 1},
...
#endif
#if defined(LOTUS_OV02A10_OFILM_MIPI_RAW)
	{
		SENSOR_DRVNAME_LOTUS_OV02A10_OFILM_MIPI_RAW,
		{
            {RST, Vol_Low, 1},
            {RST, Vol_High, 1},
            {DOVDD, Vol_1800, 5},
...
#endif
#if defined(LOTUS_OV02A10_SUNNY_MIPI_RAW)
	{
		SENSOR_DRVNAME_LOTUS_OV02A10_SUNNY_MIPI_RAW,
		{
            {RST, Vol_Low, 1},
            {RST, Vol_High, 1},
            {DOVDD, Vol_1800, 5},
