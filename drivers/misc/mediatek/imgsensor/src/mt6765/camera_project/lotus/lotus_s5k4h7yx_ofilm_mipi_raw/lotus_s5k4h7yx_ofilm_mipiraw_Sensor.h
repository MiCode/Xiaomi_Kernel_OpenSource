 ...
 *
 ****************************************************************************/
#ifndef _LOTUS_S5K4H7YX_OFILM_MIPIRAW_SENSOR_SUNWIN_H
#define _LOTUS_S5K4H7YX_OFILM_MIPIRAW_SENSOR_SUNWIN_H
typedef enum{
	IMGSENSOR_MODE_INIT,
...
void otp_4h7_ofilm_write_cmos_sensor_8(kal_uint16 addr, kal_uint8 para);
kal_uint16 otp_4h7_ofilm_read_cmos_sensor(kal_uint32 addr);
#endif
