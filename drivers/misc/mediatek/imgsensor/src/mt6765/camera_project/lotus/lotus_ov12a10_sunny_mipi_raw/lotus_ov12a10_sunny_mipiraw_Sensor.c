...
#define PFX "lotus_ov12a10_sunny_camera_sensor"
...
#include "lotus_ov12a10_sunny_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = LOTUS_OV12A10_SUNNY_SENSOR_ID,

	.checksum_value = 0x2442829d, //0x8b86a64
...
static kal_uint16 lotus_ov12a10_sunny_table_write_cmos_sensor(
...
static void write_shutter(kal_uint64 shutter)
{
    ...
    if(shutter < 50000 ){
        if(cur_state > 0){
             pr_info("write_shutter cur_state =%d \n",cur_state);
            if(1 == cur_state ){
                cur_state = 0;
                pr_info("write_shutter longexposue exit shutter =%llu\n",shutter);
    	...
    	LOG_INF("shutter =%llu, framelength =%d, realtime_fps =%d\n",
    		shutter, imgsensor.frame_length, realtime_fps);
    }else{
          cur_state = 3;
          reg_line_long_exp = (shutter - (imgsensor.frame_length - 8))*imgsensor.line_length/256;
          pr_info("write_shutter longexposue enter shutter =%llu,fll=%d llp %d reg 0x%x\n",
                                     shutter,imgsensor.frame_length,imgsensor.line_length,reg_line_long_exp);
          write_cmos_sensor(0x3208, 0x03);
          write_cmos_sensor(0x3C80, 0x0C);
          write_cmos_sensor(0x3C90, 0x01);
          write_cmos_sensor(0x3C95, reg_line_long_exp & 0xFF);
          ...
          write_cmos_sensor(0x380E, ((imgsensor.frame_length + 8) & 0x0000FF00) >> 8);
          write_cmos_sensor(0x380F, ((imgsensor.frame_length + 8) & 0x000000FF));

          write_cmos_sensor(0x3500, (imgsensor.frame_length & 0x0000F000) >> 12);
          write_cmos_sensor(0x3501, (imgsensor.frame_length & 0x00000FF0) >> 4);
          write_cmos_sensor(0x3502, (imgsensor.frame_length & 0x0000000F) << 4);
...
static void set_shutter(kal_uint64 shutter)//check out
{
	unsigned long flags;
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_lotus_ov12a10_sunny_[] = {
	0x0103, 0x01,
	0x0302, 0x49,
	0x0303, 0x00,
	0x0304, 0x00,
...
static void sensor_init(void) //check out
{
	...
	lotus_ov12a10_sunny_table_write_cmos_sensor(
		addr_data_pair_init_lotus_ov12a10_sunny_,
		sizeof(addr_data_pair_init_lotus_ov12a10_sunny_) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_lotus_ov12a10_sunny_[] = {
	0x3642, 0x10,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
#if MULTI_WRITE
	lotus_ov12a10_sunny_table_write_cmos_sensor(
		addr_data_pair_preview_lotus_ov12a10_sunny_,
		sizeof(addr_data_pair_preview_lotus_ov12a10_sunny_) /
		sizeof(kal_uint16));
#else
...
#endif
#if 0
	#ifdef LOTUS_OV12A10_SUNNY_SYNC_OPEN
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_lotus_ov12a10_sunny_[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
kal_uint16 addr_data_pair_capture_24fps_lotus_ov12a10_sunny_[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
kal_uint16 addr_data_pair_capture_30fps_lotus_ov12a10_sunny_[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
static void capture_setting(kal_uint16 currefps)//jack yan check
{
	...
	if (currefps == 150) {
	lotus_ov12a10_sunny_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_lotus_ov12a10_sunny_,
		sizeof(addr_data_pair_capture_15fps_lotus_ov12a10_sunny_) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	lotus_ov12a10_sunny_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_lotus_ov12a10_sunny_,
		sizeof(addr_data_pair_capture_24fps_lotus_ov12a10_sunny_) /
		sizeof(kal_uint16));
	} else {
	lotus_ov12a10_sunny_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_lotus_ov12a10_sunny_,
		sizeof(addr_data_pair_capture_30fps_lotus_ov12a10_sunny_) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_lotus_ov12a10_sunny_[] = {
	0x3642, 0x08,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
#if MULTI_WRITE
	lotus_ov12a10_sunny_table_write_cmos_sensor(
		addr_data_pair_hs_video_lotus_ov12a10_sunny_,
		sizeof(addr_data_pair_hs_video_lotus_ov12a10_sunny_) /
		sizeof(kal_uint16));
#else
			...
			MUINT32 framerate)
{
	...
	break;
	case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
                  if( imgsensor_info.cap1.max_framerate == imgsensor.current_fps ) {
...
UINT32 LOTUS_OV12A10_SUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
	{
