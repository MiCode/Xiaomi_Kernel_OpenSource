...
#define PFX "s5k5e8yx_rear2_camera_sensor"
...
#include "s5k5e8yxrear2mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K5E8YXREAR2_SENSOR_ID,
...
static kal_uint16 s5k5e8yxrear2_table_write_cmos_sensor(
 ...
 *************************************************************************/
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5k5e8yxrear2[] = {
	0x0100, 0x00,
	0x3906, 0x7E,
	0x3C01, 0x0F,
	0x3C14, 0x00,
...
static void sensor_init(void)
{
	...
	s5k5e8yxrear2_table_write_cmos_sensor(
		addr_data_pair_init_s5k5e8yxrear2,
		sizeof(addr_data_pair_init_s5k5e8yxrear2) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5k5e8yxrear2[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	s5k5e8yxrear2_table_write_cmos_sensor(
		addr_data_pair_preview_s5k5e8yxrear2,
		sizeof(addr_data_pair_preview_s5k5e8yxrear2) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_s5k5e8yxrear2[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
kal_uint16 addr_data_pair_capture_24fps_s5k5e8yxrear2[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
kal_uint16 addr_data_pair_capture_30fps_s5k5e8yxrear2[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	s5k5e8yxrear2_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_s5k5e8yxrear2,
		sizeof(addr_data_pair_capture_15fps_s5k5e8yxrear2) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	s5k5e8yxrear2_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_s5k5e8yxrear2,
		sizeof(addr_data_pair_capture_24fps_s5k5e8yxrear2) /
		sizeof(kal_uint16));
	} else {
	s5k5e8yxrear2_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_s5k5e8yxrear2,
		sizeof(addr_data_pair_capture_30fps_s5k5e8yxrear2) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5k5e8yxrear2[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
	s5k5e8yxrear2_table_write_cmos_sensor(
		addr_data_pair_hs_video_s5k5e8yxrear2,
		sizeof(addr_data_pair_hs_video_s5k5e8yxrear2) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136, 0x18);
	write_cmos_sensor(0x0137, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5k5e8yxrear2[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x18,
...
#if MULTI_WRITE
s5k5e8yxrear2_table_write_cmos_sensor(
	addr_data_pair_slim_video_s5k5e8yxrear2,
	sizeof(addr_data_pair_slim_video_s5k5e8yxrear2) /
	sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0136, 0x18);
	write_cmos_sensor(0x0137, 0x00);
...
UINT32 S5K5E8YXREAR2_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
