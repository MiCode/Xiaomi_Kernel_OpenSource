	...
	s32 thread)
{
	...
	if (gce_pa == GCE_M_PA) // GCE-M
		switch (event) {
		case CMDQ_EVENT_VENC0_VENC_EVENT_0
			... CMDQ_EVENT_VENC0_VENC_EVENT_12:
			return "VENC";
		case CMDQ_EVENT_VDEC0_VDEC_EVENT_0
			... CMDQ_EVENT_VDEC0_VDEC_EVENT_15:
			return "VENC";
		...
		case CMDQ_EVENT_IMG_TRAW1_CQ_THR_DONE_TRAW0_0
			...
			return "LTRAW";
		case CMDQ_EVENT_IMG_ADL_RESERVED:
			return "ADL";
		...
		case CMDQ_EVENT_IMG_FDVT1_RESERVED:
			return "FDVT";
		case CMDQ_EVENT_IMG_IMG_ENG_EVENT:
			return "IMGSYS";
