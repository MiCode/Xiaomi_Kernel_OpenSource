...
#include <dt-bindings/gce/mt6835-gce.h>
	...
	s32 thread)
{
	...
	if (gce_pa == GCE_D_PA) // GCE-D
		switch (event) {
		case CMDQ_EVENT_DISPSYS_DISP_OVL0_SOF
			... CMDQ_EVENT_DISPSYS_BUF_UNDERRUN_ENG_EVENT_70:
			return "DISP";
		default:
			return "CMDQ";
		}
	...
	if (gce_pa == GCE_M_PA) // GCE-M
		switch (event) {
		case CMDQ_EVENT_VENC1_VENC_EVENT_0
			... CMDQ_EVENT_VENC1_VENC_EVENT_31:
			return "VENC";
		case CMDQ_EVENT_IMG1_DIP_FRAME_DONE_P2_0
			... CMDQ_EVENT_IMG1_DIP_DMA_ERR_EVENT:
			return "IMG";
		case CMDQ_EVENT_CAM1_ISP_FRAME_DONE_A
			... CMDQ_EVENT_CAM1_CQ_VR_SNAP_B_INT:
			return "CAM";
		case CMDQ_EVENT_MDP_MDP_RDMA0_SOF
			... CMDQ_EVENT_MDP_BUF_UNDERFUN_ENG_EVENT_3:
			return "MDP";
		case CMDQ_EVENT_VDEC1_VDEC_EVENT_0
			... CMDQ_EVENT_VDEC1_VDEC_EVENT_31:
			return "VDEC";
		case CMDQ_EVENT_IPE_IPE_FDVT_DONE:
			return "IPE";
