...
enum CMDQ_ENG_ENUM {
	...
	/* Dummy Engine */
	CMDQ_ENG_DISP_AAL,	/* 49 */
	CMDQ_ENG_DISP_COLOR0,   /* 50 */
	CMDQ_ENG_DISP_RDMA0,	/* 51 */
	CMDQ_ENG_DISP_RDMA1,	/* 52 */
	CMDQ_ENG_DISP_WDMA0,	/* 53 */
	CMDQ_ENG_DISP_WDMA1,	/* 54 */
	CMDQ_ENG_DISP_OVL0,	/* 55 */
	CMDQ_ENG_DISP_OVL1,	/* 56 */
	CMDQ_ENG_DISP_GAMMA,	/* 57 */
	CMDQ_ENG_DISP_DSI0,	/* 58 */
	CMDQ_ENG_DISP_COLOR1,   /* 59   */
	CMDQ_ENG_DISP_2L_OVL1,  /* 60   */

	CMDQ_ENG_MDP_WDMA,	/* 61 */
	CMDQ_ENG_MDP_MOUT0,	/* 62 */
	CMDQ_ENG_MDP_MOUT1,	/* 63 */
	CMDQ_ENG_DISP_MERGE,	/* 64 */
	CMDQ_ENG_DISP_RDMA2,	/* 65 */
	CMDQ_ENG_DISP_SPLIT0,   /* 66 */
	CMDQ_ENG_DISP_SPLIT1,   /* 67 */
	CMDQ_ENG_DISP_DSI1_VDO, /* 68 */
	CMDQ_ENG_DISP_DSI1_CMD, /* 69 */
	CMDQ_ENG_DISP_DSI1,/* 70 */
	CMDQ_ENG_DISP_UFOE,/* 71 */
	CMDQ_ENG_DISP_OVL2,/* 72 */
	CMDQ_ENG_DISP_DSI0_VDO, /* 73 */
	CMDQ_ENG_DISP_DSI0_CMD, /* 74 */
	CMDQ_ENG_DISP_DPI,/* 75 */
	CMDQ_ENG_DISP_2L_OVL0,  /* 76 */
	CMDQ_ENG_DISP_2L_OVL2,  /* 77 */
