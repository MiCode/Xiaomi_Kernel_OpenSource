...
extern struct remap *pwm_infracfg_base;
...
#define PWM_3DLCM_V2	(PWM_BASE+0x70)
#define PWM_3DLCM_ENABLE_OFFSET  0

#define PWM_INT_ENABLE (PWM_BASE+0x0200)
#define PWM_INT_ENABLE_V2 (PWM_BASE+0x4)
#define PWM_INT_STATUS (PWM_BASE+0x0204)
#define PWM_INT_STATUS_V2 (PWM_BASE+0xc)
#define PWM_INT_ACK (PWM_BASE+0x0208)
#define PWM_INT_ACK_V2 (PWM_BASE+0x14)
#define PWM_EN_STATUS (PWM_BASE+0x020c)
#define PWM_EN_STATUS_V2 (PWM_BASE+0x1c)

#define PWM_CK_26M_SEL (PWM_BASE+0x0210)
#define PWM_CK_26M_SEL_V2 (PWM_BASE+0x74)
