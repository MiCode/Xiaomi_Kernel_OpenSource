...
int __weak
mtk_swpm_sysfs_entry_create_plat(const char *name,
...
int __weak
mtk_swpm_sysfs_entry_node_add_plat(const char *name,
...
int __weak
mtk_swpm_sysfs_entry_node_remove_plat(struct mtk_swpm_sysfs_handle *node)
{
	return 0;
}

int __weak
mtk_swpm_sysfs_entry_group_create_plat(const char *name,
