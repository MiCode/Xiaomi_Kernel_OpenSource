...
/* TODO: use weak function wait for cpufreq_lite */
...
static struct aphy_core_pwr_data aphy_def_core_pwr_tbl[] = {
	...
	560, 705, 834, 889, 889, 889},
		...
		[DDR_933] = {
			.read_coef = {110, 280, 786, 1269, 1768, 1920,
	2018, 2026, 2026, 2026, 2026, 2026},
			.write_coef = {116, 297, 913, 1605, 2531, 2761,
	2957, 2960, 2965, 2965, 2965, 2970},
		},
		[DDR_1066] = {
			.read_coef = {149, 353, 976, 1588, 2154, 2316,
	...
	4422, 4422, 4422, 4422, 4433, 4433},
		...
		[DDR_1600] = {
			.read_coef = {444, 1036, 2685, 4125, 5352, 5753,
...
static struct aphy_others_pwr_data aphy_def_others_pwr_tbl[] = {
	...
	604, 664, 1053, 1459, 1587, 1706,
	1963, 2130, 2645, 3118, 3563, 4008},
			.write_coef = {124, 259, 376, 493,
	610, 649, 875, 1101, 1211, 1318,
	1503, 1670, 1959, 2257, 2309, 2462},
		},
		[DDR_1066] = {
			.read_coef = {210, 392, 559, 723,
	898, 1431, 2012, 2511, 2883, 3289,
	3952, 4589, 5363, 6305, 7192, 8867},
			.write_coef = {196, 370, 535, 701,
	829, 1299, 1705, 2083, 2388, 2646,
	3108, 3717, 4200, 4406, 4893, 5645},
		},
		[DDR_1333] = {
			.read_coef = {152, 303, 442, 577,
	744, 1168, 1636, 2133, 2541, 2946,
	3656, 4315, 4865, 5473, 6243, 7697},
			.write_coef = {140, 255, 376, 499,
	623, 1007, 1340, 1682, 1979, 2258,
	2778, 3343, 3945, 4419, 4526, 4894},
		},
		[DDR_1600] = {
			.read_coef = {224, 421, 620, 818,
	964, 1622, 2362, 2984, 3474, 4016,
	5009, 5790, 6701, 8130, 9291, 10453},
			.write_coef = {215, 395, 584, 774,
	906, 1432, 1911, 2370, 2770, 3149,
	4080, 4988, 5398, 5809, 6536, 7260},
		},
		[DDR_2133] = {
			.read_coef = {1807, 3402, 3869, 4335,
	4801, 5437, 6018, 6599, 7168, 7825,
	8832, 9515, 10062, 11722, 13396, 15071},
			.write_coef = {1775, 3391, 3823, 4255,
	...
	10878, 11847, 12501, 14569, 16651, 18732},
	...
	12403, 13413, 14131, 16949, 19370, 21791},
	...
	48, 48, 48, 48, 48, 48},
		...
		[DDR_1066] = {
			.read_coef = {57, 115, 173, 230,
	278, 547, 796, 988, 1267, 1372,
...
int __attribute__((weak)) get_devinfo(int i)
{
	return CORE_STATIC_MA;
}
