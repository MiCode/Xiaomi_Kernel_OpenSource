...
static struct aphy_core_pwr_data aphy_def_core_pwr_tbl[] = {
	...
	.coef_idle = {1090, 1282, 1474, 1778, 1984, 2817, 3993, 4460, 4460},
	},
};
...
static struct aphy_others_pwr_data aphy_def_others_pwr_tbl[] = {
	...
	.coef_idle = {102, 104, 104, 104, 104, 1416, 1428, 1440, 1440},
	},
	[APHY_VM_0P75V] = {
	.pwr = {
		[DDR_400] = {
	...
	.coef_idle = {75, 75, 75, 80, 80, 87, 94, 101, 101},
	},
	[APHY_VIO_1P2V] = {
	.pwr = {
		[DDR_400] = {
	...
	.coef_idle = {444, 449, 482, 516, 972, 1056, 1272, 1489, 1489},
	},
};
