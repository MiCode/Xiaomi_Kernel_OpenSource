...
static struct aphy_core_bw_data aphy_ref_core_bw_tbl[] = {
	...
	[DDR_3750] = {
	.bw = {	545, 1340, 5069, 12676, 24042, 27784,
	31015, 37819, 40553, 44264, 47793, 54351},
	},
};
static struct aphy_core_pwr_data aphy_def_core_pwr_tbl[] = {
	...
	19252, 19360, 19360, 19460, 19460, 19460},
		...
		[DDR_3750] = {
			.read_coef = {566, 1322, 3427, 5265, 6832, 7344,
	7572, 7633, 7636, 7666, 7666, 7666},
			.write_coef = {581, 1296, 3775, 6525, 9415, 10245,
	10955, 10995, 10995, 11006, 11044, 11082},
		},
	},
	.coef_idle = {1090, 1626, 1587, 1984, 3129, 4460, 5750, 7161, 3993},
	.coef_srst = {153, 153, 150, 187, 249, 326, 346, 369, 389},
	.coef_ssr = {32, 32, 29, 37, 45, 53, 53, 57, 57},
	.volt = {550, 550, 600, 600, 650, 725, 725, 750, 750},
	},
};
static struct aphy_others_bw_data aphy_ref_others_bw_tbl[] = {
	...
	[DDR_3750] = {
	.bw = {	600, 1200, 1800, 2400,
	3000, 6000, 9000, 12000, 14700, 17820,
	23520, 29400, 34620, 42000, 47700, 52980},
	},
};
static struct aphy_others_pwr_data aphy_def_others_pwr_tbl[] = {
	...
	4001, 4688, 5213, 6176, 6814, 6839},
		...
		[DDR_3750] = {
			.read_coef = {203, 204, 213, 228,
	242, 254, 271, 288, 328, 536,
	1170, 2018, 2690, 3928, 4793, 5569},
			.write_coef = {374, 659, 842, 1216,
	1377, 1971, 2505, 2989, 3414, 3912,
	4688, 5494, 6109, 7237, 7985, 8014},
		},
	},
	.coef_idle = {26, 26, 21, 26, 1043, 1000, 1000, 1000, 1000},
	.coef_srst = {5, 5, 4, 5, 14, 13, 13, 13, 13},
	.coef_ssr = {4, 4, 3, 4, 12, 12, 12, 12, 12},
	.volt = {300, 300, 300, 300, 500, 500, 500, 500, 500},
	},
	[APHY_VM] = {
	.pwr = {
		[DDR_400] = {
	...
	10866, 11563, 12166, 13113, 13739, 15260},
		...
		[DDR_3750] = {
			.read_coef = {839, 1234, 1608, 1869,
	2130, 3018, 3689, 4198, 4664, 5226,
	6288, 7399, 8667, 10515, 12017, 13519},
			.write_coef = {797, 1332, 1712, 1867,
	2023, 2467, 2891, 3155, 3384, 3692,
	4362, 4735, 5454, 6617, 7515, 8347},
		},
	},
	.coef_idle = {1009, 2225, 2427, 2470, 2868, 5081, 6194, 7096, 152},
	.coef_srst = {296, 336, 428, 428, 446, 657, 657, 657, 98},
	.coef_ssr = {0, 0, 0, 0, 0, 0, 0, 0, 58},
	.volt = {575, 600, 650, 650, 650, 750, 750, 750, 750},
	},
	[APHY_VIO12] = {
	.pwr = {
		[DDR_400] = {
	...
	.coef_idle = {444, 516, 523, 654, 1327, 1489, 1919, 2234, 2617},
	.coef_srst = {186, 323, 327, 409, 444, 490, 632, 736, 862},
	.coef_ssr = {1, 1, 1, 1, 2, 1, 1, 1, 1},
	.volt = {1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200, 1200},
	},
};
...
#endif
		if (cpu_ptr) {
			cpu_ptr->cpu_temp[i] = (unsigned int)temp;
		}
	}
}
