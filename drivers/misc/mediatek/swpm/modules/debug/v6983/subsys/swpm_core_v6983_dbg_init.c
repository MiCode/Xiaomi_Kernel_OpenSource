...
void __exit swpm_core_v6983_dbg_exit(void)
{
	swpm_core_v6983_exit();
}

module_init(swpm_core_v6983_dbg_init);
module_exit(swpm_core_v6983_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6983 SWPM core debug module");
