...
int __init smap_v6983_dbg_init(void)
{
	int i;
...
void __exit smap_v6983_dbg_exit(void)
{
}

module_init(smap_v6983_dbg_init);
module_exit(smap_v6983_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6983 SMAP debug module");
