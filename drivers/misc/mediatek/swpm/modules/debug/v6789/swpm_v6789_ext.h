...
//extern void swpm_v6789_ext_init(phys_addr_t ref_addr,
			 //phys_addr_t ctrl_addr);
extern void swpm_v6789_ext_init(void);
extern void swpm_v6789_ext_exit(void);
