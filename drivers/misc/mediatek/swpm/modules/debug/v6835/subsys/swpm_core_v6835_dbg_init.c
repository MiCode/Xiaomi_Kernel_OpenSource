...
void __exit swpm_core_v6835_dbg_exit(void)
{
	swpm_core_v6835_exit();
}

module_init(swpm_core_v6835_dbg_init);
module_exit(swpm_core_v6835_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6835 SWPM core debug module");
