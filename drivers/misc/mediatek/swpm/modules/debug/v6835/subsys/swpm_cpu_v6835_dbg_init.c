...
int __init swpm_cpu_v6835_dbg_init(void)
{
...
void __exit swpm_cpu_v6835_dbg_exit(void)
{
	swpm_cpu_v6835_exit();
}

module_init(swpm_cpu_v6835_dbg_init);
module_exit(swpm_cpu_v6835_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6835 SWPM cpu debug module");
