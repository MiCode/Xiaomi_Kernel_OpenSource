...
int __init swpm_cpu_v6886_dbg_init(void)
{
...
void __exit swpm_cpu_v6886_dbg_exit(void)
{
	swpm_cpu_v6886_exit();
}

module_init(swpm_cpu_v6886_dbg_init);
module_exit(swpm_cpu_v6886_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6886 SWPM cpu debug module");
