...
void __exit swpm_core_v6985_dbg_exit(void)
{
	swpm_core_v6985_exit();
}

module_init(swpm_core_v6985_dbg_init);
module_exit(swpm_core_v6985_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6985 SWPM core debug module");
