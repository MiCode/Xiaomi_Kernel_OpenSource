...
int __init swpm_cpu_v6985_dbg_init(void)
{
...
void __exit swpm_cpu_v6985_dbg_exit(void)
{
	swpm_cpu_v6985_exit();
}

module_init(swpm_cpu_v6985_dbg_init);
module_exit(swpm_cpu_v6985_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6985 SWPM cpu debug module");
