...
///===============================================================================
    ...
    #define RG_WGULTRA_L2_THR             REG_FLD(9,0)//[8:0]
    #define RG_WGULTRA_EN                 REG_FLD(1,12)//[12:12]
    #define RG_WGPREULTRA_L2_THR          REG_FLD(9,16)//[24:16]
    ...
    #define RG_RGULTRA_L2_THR             REG_FLD(9,0)//[8:0]
    #define RG_RGULTRA_EN                 REG_FLD(1,12)//[12:12]
    #define RG_RGPREULTRA_L2_THR          REG_FLD(9,16)//[24:16]
