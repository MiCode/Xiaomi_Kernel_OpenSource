...
#include <mt6835_dcm_internal.h>
#include <mt6835_dcm_autogen.h>
#include <mtk_dcm.h>
/*====================auto gen code 20220509=====================*/
...
#define INFRA_AO_BCRM_INFRA_BUS_DCM_REG0_MASK ((0x1 << 0) | \
			...
			(0x1f << 16) | \
			(0x1 << 22))
#define INFRA_AO_BCRM_INFRA_BUS_DCM_REG1_MASK ((0xf << 0) | \
			(0x1 << 4) | \
			(0x1 << 6) | \
			(0x1 << 15) | \
			(0xf << 16) | \
...
#define INFRA_AO_BCRM_INFRA_BUS_DCM_REG0_ON ((0x1 << 0) | \
			...
			(0x0 << 16) | \
			(0x1 << 22))
#define INFRA_AO_BCRM_INFRA_BUS_DCM_REG1_ON ((0x0 << 0) | \
			(0x0 << 4) | \
			(0x1 << 6) | \
			(0x0 << 15) | \
			(0x0 << 16) | \
...
#define INFRA_AO_BCRM_INFRA_BUS_DCM_REG0_OFF ((0x1 << 0) | \
			...
			(0x0 << 16) | \
			(0x0 << 22))
#define INFRA_AO_BCRM_INFRA_BUS_DCM_REG1_OFF ((0x0 << 0))
...
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG0_MASK ((0x1 << 4) | \
			(0x1 << 5))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG1_MASK ((0x1 << 20))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG2_MASK ((0x1f << 0))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG0_ON ((0x1 << 4) | \
			(0x1 << 5))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG1_ON ((0x1 << 20))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG2_ON ((0x0 << 0))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG0_OFF ((0x1 << 4) | \
			(0x1 << 5))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG1_OFF ((0x0 << 20))
#define INFRA_AO_BCRM_INFRA_BUS_FMEM_SUB_DCM_REG2_OFF ((0x0 << 0))
...
#define UFS0_AO_BCRM_UFS_BUS_DCM_REG0_MASK ((0x1 << 1) | \
			(0x1 << 4) | \
			(0x1 << 7) | \
			(0x1 << 22))
#define UFS0_AO_BCRM_UFS_BUS_DCM_REG0_ON ((0x1 << 1) | \
			(0x1 << 4) | \
			(0x1 << 7) | \
			(0x1 << 22))
#define UFS0_AO_BCRM_UFS_BUS_DCM_REG0_OFF ((0x0 << 1) | \
			(0x0 << 4) | \
			(0x0 << 7) | \
			(0x0 << 22))
...
bool dcm_vlp_ao_bcrm_vlp_bus_dcm_is_on(void)
{
	bool ret = true;
			...
			ret &= ((reg_read(
			VLP_AO_BCRM_VDNR_DCM_TOP_VLP_PAR_BUS_u_VLP_PAR_BUS_CTRL_0) &
