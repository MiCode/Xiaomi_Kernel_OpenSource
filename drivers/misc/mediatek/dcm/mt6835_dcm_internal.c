...
unsigned int all_dcm_type =
		...
		PERI_DCM_TYPE | VLP_DCM_TYPE  | UFS0_DCM_TYPE |
		MCUSYS_ACP_DCM_TYPE | MCUSYS_ADB_DCM_TYPE | MCUSYS_BUS_DCM_TYPE |
...
unsigned int init_dcm_type =
		...
		INFRA_DCM_TYPE | PERI_DCM_TYPE | VLP_DCM_TYPE | UFS0_DCM_TYPE |
...
#define DCM_NODE "mediatek,mt6835-dcm"
...
void dcm_dump_regs(void)
{
	...
	REG_DUMP(VLP_AO_BCRM_VDNR_DCM_TOP_VLP_PAR_BUS_u_VLP_PAR_BUS_CTRL_0);
}
...
static int __init mt6835_dcm_init(void)
{
	int ret = 0;
...
static void __exit mt6835_dcm_exit(void)
{
}
MODULE_SOFTDEP("pre:mtk_dcm.ko");
module_init(mt6835_dcm_init);
module_exit(mt6835_dcm_exit);
