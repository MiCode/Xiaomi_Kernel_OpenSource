...
#define REG_FH_PLL3_CON0    REG_APMIX_ADDR(0x024C) /*MFGPLL */
#define REG_FH_PLL4_CON0    REG_PLL_NOT_SUPPORT    /*MEMPLL */
#define REG_FH_PLL5_CON0    REG_APMIX_ADDR(0x02A0) /*MPLL */
#define REG_FH_PLL6_CON0    REG_APMIX_ADDR(0x025C) /*MMPLL */
#define REG_FH_PLL7_CON0    REG_APMIX_ADDR(0x021C) /*ARMPLL_L */
#define REG_FH_PLL8_CON0    REG_APMIX_ADDR(0x022C) /*CCIPLL */

#define REG_FH_PLL0_CON1    REG_APMIX_ADDR(0x0210) /*ARMPLL */
#define REG_FH_PLL1_CON1    REG_APMIX_ADDR(0x0240) /*MAINPLL */
#define REG_FH_PLL2_CON1    REG_APMIX_ADDR(0x0280) /*MSDCPLL */
#define REG_FH_PLL3_CON1    REG_APMIX_ADDR(0x0250) /*MFGPLL */
#define REG_FH_PLL4_CON1    REG_PLL_NOT_SUPPORT    /*MEMPLL */
#define REG_FH_PLL5_CON1    REG_APMIX_ADDR(0x02A4) /*MPLL */
