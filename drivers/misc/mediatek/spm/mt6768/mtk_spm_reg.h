...
#define MP0_CPU4_PWR_CON               (SPM_BASE + 0x218)
#define MP0_CPU5_PWR_CON               (SPM_BASE + 0x21C)
#define MP0_CPU6_PWR_CON               (SPM_BASE + 0x220)
#define MP0_CPU7_PWR_CON               (SPM_BASE + 0x224)
...
#define AMRPLL_CLK_SEL                 (SPM_BASE + 0x244)
...
#define MFG_SOCIF_SYC_STEP_CTRL        (SPM_BASE + 0x3B0)
#define MSDC_SRAM_CON                  (SPM_BASE + 0x3C0)
#define MBIST_EFUSE_REPAIR_ACK_STA     (SPM_BASE + 0x3D0)
#define MCUPM_SRAM_CON                 (SPM_BASE + 0x3D4)
#define SC_FHC_PAUSE                   (SPM_BASE + 0x3E0)
...
#define MP0_CPU4_IRQ_MASK              (SPM_BASE + 0x510)
#define MP0_CPU5_IRQ_MASK              (SPM_BASE + 0x514)
#define MP0_CPU6_IRQ_MASK              (SPM_BASE + 0x518)
#define MP0_CPU7_IRQ_MASK              (SPM_BASE + 0x51C)
...
#define MP0_CPU4_WFI_EN                (SPM_BASE + 0x540)
#define MP0_CPU5_WFI_EN                (SPM_BASE + 0x544)
#define MP0_CPU6_WFI_EN                (SPM_BASE + 0x548)
#define MP0_CPU7_WFI_EN                (SPM_BASE + 0x54C)
...
#define WFI_TYPE_LSB                        (1U << 1)       /* 1b */
#define MP0_CPUTOP_IDLE_MASK_LSB            (1U << 2)       /* 1b */
#define MP1_CPUTOP_IDLE_MASK_LSB            (1U << 3)       /* 1b */
...
#define MP0_CPU4_STANDBYWFI_AFTER_SEL_LSB   (1U << 4)       /* 1b */
#define MP0_CPU5_STANDBYWFI_AFTER_SEL_LSB   (1U << 5)       /* 1b */
#define MP0_CPU6_STANDBYWFI_AFTER_SEL_LSB   (1U << 6)       /* 1b */
#define MP0_CPU7_STANDBYWFI_AFTER_SEL_LSB   (1U << 7)       /* 1b */
...
#define MP0_CPU4_STANDBYWFI_LSB             (1U << 14)      /* 1b */
#define MP0_CPU5_STANDBYWFI_LSB             (1U << 15)      /* 1b */
#define MP0_CPU6_STANDBYWFI_LSB             (1U << 16)      /* 1b */
#define MP0_CPU7_STANDBYWFI_LSB             (1U << 17)      /* 1b */
...
#define GIC_WAKEUP_LSB                      (1U << 10)      /* 10b */
...
#define VEN_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
...
#define ISP_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
...
#define DIS_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
...
#define MFG_CORE1_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
...
#define AUD_SRAM_PDN_LSB                    (1U << 8)       /* 1b */
#define AUD_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
...
#define IFR_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
...
#define VPU_TOP_SRAM_PDN_LSB                (1U << 8)       /* 1b */
#define VPU_TOP_SRAM_PDN_ACK_LSB            (1U << 12)      /* 1b */
#define VPU_TOP_SRAM_SLPB_LSB               (1U << 16)      /* 1b */
#define VPU_TOP_SRAM_SLPB_ACK_LSB           (1U << 28)      /* 1b */
...
#define VPU_CORE2_SRAM_PDN_LSB              (1U << 8)       /* 1b */
#define VPU_CORE2_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
#define VPU_CORE2_SRAM_SLPB_LSB             (1U << 16)      /* 1b */
#define VPU_CORE2_SRAM_SLPB_ACK_LSB         (1U << 28)      /* 1b */
...
#define MFG_ASYNC_SRAM_PDN_LSB              (1U << 8)       /* 1b */
#define MFG_ASYNC_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
...
#define MFG_SRAM_PDN_LSB                    (1U << 8)       /* 1b */
#define MFG_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
...
#define VPU_CORE0_SRAM_PDN_LSB              (1U << 8)       /* 1b */
#define VPU_CORE0_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
#define VPU_CORE0_SRAM_SLPB_LSB             (1U << 16)      /* 1b */
#define VPU_CORE0_SRAM_SLPB_ACK_LSB         (1U << 28)      /* 1b */
...
#define VPU_CORE1_SRAM_PDN_LSB              (1U << 8)       /* 1b */
#define VPU_CORE1_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
#define VPU_CORE1_SRAM_SLPB_LSB             (1U << 16)      /* 1b */
#define VPU_CORE1_SRAM_SLPB_ACK_LSB         (1U << 28)      /* 1b */
...
#define CAM_SRAM_PDN_LSB                    (1U << 8)       /* 2b */
#define CAM_SRAM_PDN_ACK_LSB                (1U << 12)      /* 2b */
...
#define MFG_2D_SRAM_PDN_LSB                 (1U << 8)       /* 1b */
#define MFG_2D_SRAM_PDN_ACK_LSB             (1U << 12)      /* 1b */
...
#define MFG_CORE0_SRAM_PDN_ACK_LSB          (1U << 12)      /* 1b */
...
#define VDE_SRAM_PDN_ACK_LSB                (1U << 12)      /* 1b */
...
/* MFG_SOCIF_SYC_STEP_CTRL (0x10006000+0x3B0) */
#define MFG_SOCIF_SYC_STEP_CHG_LSB          (1U << 0)       /* 1b */
...
/* SC_FHC_PAUSE (0x10006000+0x3E0) */
#define SC_FHC_PAUSE_LSB                    (1U << 0)       /* 4b */
...
/* MP0_CPU4_IRQ_MASK (0x10006000+0x510) */
#define MP0_CPU4_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP0_CPU4_AUX_LSB                    (1U << 8)       /* 11b */
/* MP0_CPU5_IRQ_MASK (0x10006000+0x514) */
#define MP0_CPU5_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP0_CPU5_AUX_LSB                    (1U << 8)       /* 11b */
/* MP0_CPU6_IRQ_MASK (0x10006000+0x518) */
#define MP0_CPU6_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP0_CPU6_AUX_LSB                    (1U << 8)       /* 11b */
/* MP0_CPU7_IRQ_MASK (0x10006000+0x51C) */
#define MP0_CPU7_IRQ_MASK_LSB               (1U << 0)       /* 1b */
#define MP0_CPU7_AUX_LSB                    (1U << 8)       /* 11b */
