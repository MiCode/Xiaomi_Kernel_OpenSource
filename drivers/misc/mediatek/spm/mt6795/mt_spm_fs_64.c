...
#ifdef CONFIG_OF
#define SPM_CKSYS_BASE		spm_cksys_base
#define SPM_DDRPHY0_BASE	spm_ddrphy0_base
#define SPM_DDRPHY1_BASE	spm_ddrphy1_base
#define SPM_PERICFG_BASE	spm_pericfg_base
#else
#define SPM_CKSYS_BASE		(0xF0000200)
#define SPM_DDRPHY0_BASE	(0xF000f000)
#define SPM_DDRPHY1_BASE	(0xF0012000)
#define SPM_PERICFG_BASE	(0xF0003000)
#endif
