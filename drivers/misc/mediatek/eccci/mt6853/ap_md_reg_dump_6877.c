 ...
 * Date 2021-02-08 17:15:43.054854
 */
...
static void __iomem *TOPSM;
static void __iomem *MD_RGU;
static void __iomem *OST_status;
static void __iomem *CSC;
static void __iomem *ELM;
static void __iomem *USIP;

struct dump_reg_ioremap dump_reg_tab[] = {
	{&DBGSYS_Time, 0x0D10111C, 0x4},
	{&PC_Monitor, 0x0D11C000, 0x21B0},
	{&PLL_reg, 0x0D103800, 0x248A0},
	{&BUS_reg, 0x0D102000, 0x37140},
	{&BUSMON, 0x0D108000, 0x30F24},
	{&ECT, 0x0D101100, 0xCF48},
	{&TOPSM, 0x0D110000, 0x8E8},
	{&MD_RGU, 0x0D112100, 0x25C},
	{&OST_status, 0x0D111000, 0x20C},
	{&CSC, 0x0D113000, 0x224},
	{&ELM, 0x20350000, 0xF01},
...
void internal_md_dump_debug_register(unsigned int md_index)
{
	...
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(TOPSM + 0x00000000), 0x8E8);

	/* MD_RGU */
	CCCI_MEM_LOG_TAG(md_index, TAG,
		"Dump MD RGU: [0]0x0D112100, [1]0x0D112300\n");
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(MD_RGU + 0x00000000), 0xDD);
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
	...
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(USIP + 0x00050030), 0x10);
	CCCI_MEM_LOG_TAG(md_index, TAG,
		"Dump hram hrambusck abus: [0]0x0D156830\n");
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(USIP + 0x00052430), 0x48);
	CCCI_MEM_LOG_TAG(md_index, TAG,
	...
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(USIP + 0x00043300), 0x8);
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(USIP + 0x00043420), 0x4C);
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(USIP + 0x00043500), 0x1C);
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(USIP + 0x00043600), 0x8);
	ccci_util_mem_dump(md_index, CCCI_DUMP_MEM_DUMP,
		(USIP + 0x00043700), 0x424);
	/* [Pre-Action] Disable bus his rec & select entry 0 */
