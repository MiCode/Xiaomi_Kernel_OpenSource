...
#define PDA_PDAI_P1_BASE_ADDR_MSB_REG (PDA_BASE_HW + 0x3c4)
#define PDA_PDATI_P1_BASE_ADDR_MSB_REG (PDA_BASE_HW + 0x3c8)
#define PDA_PDAI_P2_BASE_ADDR_MSB_REG (PDA_BASE_HW + 0x3cc)
#define PDA_PDATI_P2_BASE_ADDR_MSB_REG (PDA_BASE_HW + 0x3d0)
#define PDA_PDAO_P1_BASE_ADDR_MSB_REG (PDA_BASE_HW + 0x3d4)
#define PDA_PDAO_DMA_EXISTED_ECO_REG (PDA_BASE_HW + 0x3d8)
#define PDA_PDA_DEBUG_DATA_REG (PDA_BASE_HW + 0x3dc)
