...
struct DPI_REGS {
	struct DPI_REG_EN DPI_EN;		/* 0x0000 */
	struct DPI_REG_RST DPI_RST;		/* 0x0004 */
	struct DPI_REG_INTERRUPT INT_ENABLE;	/* 0x0008 */
	struct DPI_REG_INTERRUPT INT_STATUS;	/* 0x000C */
	struct DPI_REG_CNTL CNTL;		/* 0x0010 */
	struct DPI_REG_OUTPUT_SETTING OUTPUT_SETTING;	/* 0x0014 */
	struct DPI_REG_SIZE SIZE;		/* 0x0018 */
	struct DPI_REG_DDR_SETTING DDR_SETTING;	/* 0x001c */

	unsigned int TGEN_HWIDTH;		/* 0x0020 */
	struct DPI_REG_TGEN_HPORCH TGEN_HPORCH;	/* 0x0024 */
	struct DPI_REG_TGEN_VWIDTH_LODD TGEN_VWIDTH_LODD;	/* 0x0028 */
	struct DPI_REG_TGEN_VPORCH_LODD TGEN_VPORCH_LODD;	/* 0x002C */

	struct DPI_REG_BG_HCNTL BG_HCNTL;	/* 0x0030 */
	struct DPI_REG_BG_VCNTL BG_VCNTL;	/* 0x0034 */
	struct DPI_REG_BG_COLOR BG_COLOR;	/* 0x0038 */
	struct DPI_REG_FIFO_CTL FIFO_CTL;	/* 0x003C */

	struct DPI_REG_STATUS STATUS;		/* 0x0040 */
	struct DPI_REG_TMODE TMODE;		/* 0x0044 */
	struct DPI_REG_CHKSUM CHKSUM;		/* 0x0048 */
	unsigned int rsv_4C;
	unsigned int DUMMY;			/* 0x0050 */
	unsigned int rsv_54[5];

	struct DPI_REG_TGEN_VWIDTH_LEVEN TGEN_VWIDTH_LEVEN;	/* 0x0068 */
	struct DPI_REG_TGEN_VPORCH_LEVEN TGEN_VPORCH_LEVEN;	/* 0x006C */

	struct DPI_REG_TGEN_VWIDTH_RODD TGEN_VWIDTH_RODD;	/* 0x0070 */
	struct DPI_REG_TGEN_VPORCH_RODD TGEN_VPORCH_RODD;	/* 0x0074 */
	struct DPI_REG_TGEN_VWIDTH_REVEN TGEN_VWIDTH_REVEN;	/* 0x0078 */
	struct DPI_REG_TGEN_VPORCH_REVEN TGEN_VPORCH_REVEN;	/* 0x007C */
	struct DPI_REG_ESAV_VTIM_LOAD ESAV_VTIM_LOAD;		/* 0x0080 */
	struct DPI_REG_ESAV_VTIM_LEVEN ESAV_VTIM_LEVEN;		/* 0x0084 */
	struct DPI_REG_ESAV_VTIM_ROAD ESAV_VTIM_ROAD;		/* 0x0088 */
	struct DPI_REG_ESAV_VTIM_REVEN ESAV_VTIM_REVEN;		/* 0x008C */

	struct DPI_REG_ESAV_FTIM ESAV_FTIM;			/* 0x0090 */
	struct DPI_REG_CLPF_SETTING CLPF_SETTING;		/* 0x0094 */
	struct DPI_REG_Y_LIMIT Y_LIMIT;				/* 0x0098 */
	struct DPI_REG_C_LIMIT C_LIMIT;				/* 0x009C */
	struct DPI_REG_YUV422_SETTING YUV422_SETTING;		/* 0x00A0 */
	struct DPI_REG_EMBSYNC_SETTING EMBSYNC_SETTING;		/* 0x00A4 */
	struct DPI_REG_ESAV_CODE_SET0 ESAV_CODE_SET0;		/* 0x00A8 */
	struct DPI_REG_ESAV_CODE_SET1 ESAV_CODE_SET1;		/* 0x00AC */
};
