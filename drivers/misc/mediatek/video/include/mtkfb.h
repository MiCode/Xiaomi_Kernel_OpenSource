...
#define EBBG_ILI_WPOINTR          654333
#define EBBG_ILI_WPOINTG          290663
#define EBBG_ILI_WPOINTB          153052
#define COST_FOCAL_WPOINTR          653342
#define COST_FOCAL_WPOINTG          291660
#define COST_FOCAL_WPOINTB          157048

struct fb_lcd_lotus_para{
	int cabc_mode;
	int ce_mode;
	int white_point_x;
	int white_point_y;
