...
#define COLOR_TUNING_INDEX C_TUN_IDX
#define THSHP_TUN_IDX 12
#define THSHP_PARAM_MAX 121
...
struct DISP_PQ_PARAM {
	...
	unsigned int u4Ccorr; /* 0 : min , 3 : max. */
	unsigned int u4ColorLUT; /* 0 : min , 3 : max. */
};
...
struct DISPLAY_PQ_T {
	...
	unsigned int PURP_TONE_S[C_TUN_IDX][PQ_PART_CON][PURP_TONE_SIZE];
	unsigned int SKIN_TONE_S[C_TUN_IDX][PQ_PART_CON][SKIN_TONE_SIZE];
	unsigned int GRASS_TONE_S[C_TUN_IDX][PQ_PART_CON][GRASS_TONE_SIZE];
	unsigned int SKY_TONE_S[C_TUN_IDX][PQ_PART_CON][SKY_TONE_SIZE];
	unsigned int PURP_TONE_H[C_TUN_IDX][PURP_TONE_SIZE];
	unsigned int SKIN_TONE_H[C_TUN_IDX][SKIN_TONE_SIZE];
	unsigned int GRASS_TONE_H[C_TUN_IDX][GRASS_TONE_SIZE];
	unsigned int SKY_TONE_H[C_TUN_IDX][SKY_TONE_SIZE];
	...
	unsigned int COLOR_3D[C_3D_CNT][C_3D_WINDOW_CNT][C_3D_WINDOW_SIZE];
};
...
struct DISPLAY_COLOR_REG {
	...
	unsigned int PURP_TONE_S[PQ_PART_CON][PURP_TONE_SIZE];
	unsigned int SKIN_TONE_S[PQ_PART_CON][SKIN_TONE_SIZE];
	unsigned int GRASS_TONE_S[PQ_PART_CON][GRASS_TONE_SIZE];
	unsigned int SKY_TONE_S[PQ_PART_CON][SKY_TONE_SIZE];
	...
	unsigned int COLOR_3D[C_3D_WINDOW_CNT][C_3D_WINDOW_SIZE];
};

struct DISPLAY_TDSHP_T {
	unsigned int entry[THSHP_TUN_IDX][THSHP_PARAM_MAX];
};
