...
static atomic_t g_pwm_max_backlight[PWM_TOTAL_MODULE_NUM] = {
	ATOMIC_INIT(2047), ATOMIC_INIT(2047) };//2022.4.22 zhangguoqing modify for 2047bl
...
static atomic_t g_pwm_max_backlight[PWM_TOTAL_MODULE_NUM] = {
	ATOMIC_INIT(2047) };//2022.4.22 zhangguoqing modify for 2047bl
	...
	struct disp_ddp_path_config *pConfig, void *cmdq)
{
	...
	/* 1024 levels */
	DISP_REG_MASK(cmdq, reg_base + DISP_PWM_CON_1_OFF, 2047, 0x7ff); //2022.4.24 zhangguoqing modify for 2047bl
