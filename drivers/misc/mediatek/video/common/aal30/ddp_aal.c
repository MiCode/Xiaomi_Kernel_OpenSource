...
#endif
#ifdef CONFIG_MTK_DRE30_SUPPORT
	DISP_REG_SET(NULL, DISP_AAL_EN, 0x01);
	DISP_REG_SET(NULL, DISP_AAL_CFG_MAIN, 0x1a);

	DISP_REG_SET(NULL, DISP_AAL_DRE_BLOCK_INFO_00, 0x86e000);
	DISP_REG_SET(NULL, DISP_AAL_DRE_BLOCK_INFO_01, 0x208);
	DISP_REG_SET(NULL, DISP_AAL_DRE_BLOCK_INFO_02, 0x10e087);
	DISP_REG_SET(NULL, DISP_AAL_DRE_BLOCK_INFO_04, 0x216000);
	DISP_REG_SET(NULL, DISP_AAL_DRE_CHROMA_HIST_00, 0x2018b030);
	DISP_REG_SET(NULL, DISP_AAL_DRE_CHROMA_HIST_01, 0x4445858);

	DISP_REG_SET(NULL, DISP_AAL_DRE_ALPHA_BLEND_00, 0xfe50fe5);
	DISP_REG_SET(NULL, DISP_AAL_DRE_BLOCK_INFO_05, 0x4731);
	DISP_REG_SET(NULL, DISP_AAL_DRE_BLOCK_INFO_06, 0x8e62);
	DISP_REG_SET(NULL, DISP_AAL_SRAM_CFG, 0x3f0030);
	DISP_REG_SET(NULL, DISP_AAL_DUAL_PIPE_INFO_00, 0x0);
	DISP_REG_SET(NULL, DISP_AAL_DUAL_PIPE_INFO_01, 0xe086);
#endif
#if defined(CONFIG_MACH_MT6799)
