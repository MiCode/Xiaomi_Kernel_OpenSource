...
static struct mout_s mout_map[] = {
	...
	{DISP_MODULE_RSZ0,
		{{DISP_MODULE_RDMA0, 1 << 0},
		 ...
		 {DISP_MODULE_RDMA0_VIRTUAL0, 1 << 2}, {-1, 0} },
		0, 0},
...
static struct sel_s sel_out_map[] = {
	/* DISP_OVL0_2L_BLENDOUT_SOUT_SEL */
	{DISP_MODULE_OVL0_2L, {DISP_MODULE_OVL0_2L_VIRTUAL0,
		DISP_MODULE_OVL0_VIRTUAL0, -1}, 0, 0},

	/* DISP_OVL0_BLENDOUT_SOUT_SEL */
	{DISP_MODULE_OVL0, {DISP_MODULE_OVL0_2L_VIRTUAL0,
		DISP_MODULE_OVL0_VIRTUAL0, -1}, 0, 0},
	...
	{DISP_MODULE_RDMA0_VIRTUAL0, {DISP_MODULE_DSI0,
...
static struct sel_s sel_in_map[] = {
	/* DISP_OVL0_OVL1_OVL1_2L_BGOUT_SEL_IN */
	{DISP_MODULE_OVL0_2L, {DISP_MODULE_UNKNOWN, DISP_MODULE_OVL0,
	 -1},
	 0, 0},

	/* DISP_OVL0_2L_OVL1_OVL1_2L_BGOUT_SEL_IN */
	{DISP_MODULE_OVL0, {DISP_MODULE_UNKNOWN, DISP_MODULE_OVL0_2L,
	 -1}, 0, 0},

	/* DISP_TOVL0_OUT0_SEL_IN */
	{DISP_MODULE_OVL0_2L_VIRTUAL0, {DISP_MODULE_OVL0_2L,
	 DISP_MODULE_OVL0, -1}, 0, 0},

	/* DISP_TOVL0_OUT1_SEL_IN */
	{DISP_MODULE_OVL0_VIRTUAL0, {DISP_MODULE_OVL0_2L,
	 DISP_MODULE_OVL0, -1}, 0, 0},

	/* DISP_RDMA0_SEL_IN */
	{DISP_MODULE_RDMA0, {DISP_MODULE_OVL0_VIRTUAL0,
	 DISP_MODULE_RSZ0, -1},
	 0, 0},

	/* DISP_RSZ0_SEL_IN */
	{DISP_MODULE_RSZ0, {DISP_MODULE_OVL0_2L_VIRTUAL0,
	 DISP_MODULE_OVL0_VIRTUAL0, DISP_MODULE_RDMA0, -1}, 0, 0},

	/* DISP_RDMA0_RSZ0_SEL_IN */
	{DISP_MODULE_RDMA0_VIRTUAL0, {DISP_MODULE_RDMA0,
	 DISP_MODULE_RSZ0, -1}, 0, 0},

	/* DISP_COLOR0_OUT_SEL_IN */
	{DISP_MODULE_CCORR0, {DISP_MODULE_COLOR0,
	 DISP_MODULE_RDMA0_VIRTUAL0, -1}, 0, 0},
	...
	/* DSI0_SEL_IN */
	{DISP_MODULE_DSI0, {DISP_MODULE_RDMA0_VIRTUAL0,
...
int ddp_path_init(void)
{
	...
	/* sel_out */
	sel_out_map[0].reg =
		(unsigned long *)DISP_REG_CONFIG_DISP_OVL0_2L_BLENDOUT_SOUT_SEL;
	sel_out_map[1].reg =
		(unsigned long *)DISP_REG_CONFIG_DISP_OVL0_BLENDOUT_SOUT_SEL;
	sel_out_map[2].reg =
	...
	/* sel_in */
	sel_in_map[0].reg =
		(unsigned long *)DISP_REG_CONFIG_DISP_O0_O1_OVL1_2L_BG_SEL;
	sel_in_map[1].reg =
		(unsigned long *)DISP_REG_CONFIG_DISP_O0_2L_O1_OVL1_2L_BG_SEL;
	sel_in_map[2].reg =
		(unsigned long *)DISP_REG_CONFIG_DISP_TOVL0_OUT0_SEL_IN;
	sel_in_map[3].reg =
		(unsigned long *)DISP_REG_CONFIG_DISP_TOVL0_OUT1_SEL_IN;
	sel_in_map[4].reg =
