...
static bool ddp_valid_engine[DISP_MODULE_NUM] = {
	...
	1, /* DISP_MODULE_DSC_WRAP0_CORE0*/
	1, /* DISP_MODULE_DSC_WRAP0_CORE1*/
	1, /* DISP_MODULE_DSI0*/
	1, /* DISP_MODULE_WDMA0*/
	1, /* DISP_MODULE_UFBC_WDMA0*/

	1, /* DISP_MODULE_OVL2_2L*/
	1, /* DISP_MODULE_RDMA4*/
	0, /* DISP_MODULE_DPI*/
	0, /* DISP_MODULE_MDP_RDMA4*/
	0, /* DISP_MODULE_MDP_HDR4*/

	0, /* DISP_MODULE_MDP_RSZ4*/
	0, /* DISP_MODULE_MDP_AAL4*/
	0, /* DISP_MODULE_MDP_TDSHP4*/
	0, /* DISP_MODULE_MDP_COLOR4*/
	0, /* DISP_MODULE_Y2R0*/
	...
	0, /* DISP_MODULE_OVL0_OVL0_2L_VIRTUAL*/
	0, /* DISP_MODULE_RDMA2_VIRTUAL*/
	0, /* DISP_MODULE_DMDP_TDSHP4_SOUT*/
