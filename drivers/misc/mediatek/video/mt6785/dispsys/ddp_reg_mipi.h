...
#define MIPIX_XXX_SW_HSTX_DATA0			(0x05A0UL)
#  define DSI_XXX_SW_HSTX_DATA0			REG_FLD(1, 0)
#  define DBG_OUT_DSI_XXX_SW_HSTX_DATA0		REG_FLD(1, 8)
#define MIPIX_XXX_SW_HSTX_DATA1			(0x05A4UL)
#  define DSI_XXX_SW_HSTX_DATA1			REG_FLD(1, 0)
#  define DBG_OUT_DSI_XXX_SW_HSTX_DATA1		REG_FLD(1, 8)
#define MIPIX_XXX_SW_HSTX_DATA2			(0x05A8UL)
#  define DSI_XXX_SW_HSTX_DATA2			REG_FLD(1, 0)
#  define DBG_OUT_DSI_XXX_SW_HSTX_DATA2		REG_FLD(1, 8)
#define MIPIX_XXX_SW_HSTX_DATA3			(0x05ACUL)
#  define DSI_XXX_SW_HSTX_DATA3			REG_FLD(1, 0)
#  define DBG_OUT_DSI_XXX_SW_HSTX_DATA3		REG_FLD(1, 8)
#define MIPIX_XXX_SW_HSTX_DATA4			(0x05B0UL)
#  define DSI_XXX_SW_HSTX_DATA4			REG_FLD(1, 0)
#  define DBG_OUT_DSI_XXX_SW_HSTX_DATA4		REG_FLD(1, 8)
#define MIPIX_XXX_SW_HSTX_DATA5			(0x05B4UL)
#  define DSI_XXX_SW_HSTX_DATA5			REG_FLD(1, 0)
#  define DBG_OUT_DSI_XXX_SW_HSTX_DATA5		REG_FLD(1, 8)
#define MIPIX_XXX_SW_HSTX_DATA6			(0x05B8UL)
#  define DSI_XXX_SW_HSTX_DATA6			REG_FLD(1, 0)
#  define DBG_OUT_DSI_XXX_SW_HSTX_DATA6		REG_FLD(1, 8)
