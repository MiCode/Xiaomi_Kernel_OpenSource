...
static bool ddp_valid_engine[DISP_MODULE_NUM] = {
	...
	0, /* DISP_MODULE_OVL0_2L_VIRTUAL0 */
	0, /* DISP_MODULE_OVL0_VIRTUAL0 */
	1, /* DISP_MODULE_RSZ0 */

	0, /* DISP_MODULE_OVL1 */
	0, /* DISP_MODULE_OVL1_2L */
	0, /* DISP_MODULE_OVL1_2L_VIRTUAL0 */
	0, /* DISP_MODULE_OVL1_VIRTUAL0 */
	0, /* DISP_MODULE_RSZ1 */

	1, /* DISP_MODULE_RDMA0 */
	0, /* DISP_MODULE_RDMA0_VIRTUAL0 */
	1, /* DISP_MODULE_WDMA0 */
	1, /* DISP_MODULE_COLOR0 */
	1, /* DISP_MODULE_CCORR0 */

	0, /* DISP_MODULE_RDMA1 */
	0, /* DISP_MODULE_RDMA1_VIRTUAL0 */
	0, /* DISP_MODULE_WDMA1 */
	...
	0, /* DISP_MODULE_AAL1 */
	0, /* DISP_MODULE_MDP_AAL5 */
	0, /* DISP_MODULE_GAMMA1 */
	0, /* DISP_MODULE_POSTMASK1 */
	...
	0, /* DISP_MODULE_MIPI1 */
	0, /* DISP_MODULE_DPI */
	0, /* DISP_MODULE_OVL2_2L */
	0, /* DISP_MODULE_OVL3_2L */

	0, /* DISP_MODULE_RDMA4 */
	0, /* DISP_MODULE_RDMA5 */
	0, /* DISP_MODULE_MDP_RDMA4 */
	0, /* DISP_MODULE_MDP_RDMA5 */
	0, /* DISP_MODULE_MDP_RSZ4 */

	0, /* DISP_MODULE_MDP_RSZ5 */
	0, /* DISP_MODULE_MERGE0 */
	0, /* DISP_MODULE_MERGE1 */
	0, /* DISP_MODULE_DP_INTF */
	0, /* DISP_MODULE_DSC */
...
static struct DDP_IRQ_EVENT_MAPPING
	...
	{			/* rdma path */
	 ...
	 {DDP_IRQ_RDMA0_TARGET_LINE},	/*FRAME_STOP */
	 {DDP_IRQ_RDMA0_REG_UPDATE},	/*IF_CMD_DONE */
	 {DDP_IRQ_RDMA0_TARGET_LINE},	/*IF_VSYNC */
	 {DDP_IRQ_UNKNOWN}, /*TRIGER*/
