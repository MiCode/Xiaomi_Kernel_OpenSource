...
char lcd_whitepoint_info[32] = {0};           /* 2020.12.22 add for read tianma whitepoint baiyihan */
...
static int __init whitepoint_info(char *str)						 /* 2020.12.22 add for tianma read whitepoint baiyihan start */
{
	strcpy(lcd_whitepoint_info, str);
	pr_info("lcd_whitepoint_info : %s\n", lcd_whitepoint_info);
	return 1;
}
__setup("androidboot.whitepoint=", whitepoint_info);				 /* 2020.12.22 add for tianma read whitepoint baiyihan end	*/
