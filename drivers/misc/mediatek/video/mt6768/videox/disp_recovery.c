...
int primary_display_esd_recovery(void)
{
	...
	/*2021.3.1 longcheer TaoCheng add for NVT IC Frozen screen issue begin*/
	if (strnstr(mtkfb_lcm_name,"dsi_panel_c3j1_36_02_0a",strlen(mtkfb_lcm_name))) {
		esd_resume(0);
		DISPCHECK("It is NVT IC ESD RECOVERY, do tp suspend/resume\n");
	} else{
		DISPCHECK("It is not NVT IC, Skip\n");
	}
	/*2021.3.1 longcheer TaoCheng add for NVT IC Frozen screen issue end*/
