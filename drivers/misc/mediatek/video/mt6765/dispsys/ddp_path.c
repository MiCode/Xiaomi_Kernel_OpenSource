...
unsigned int module_list_scenario[DDP_SCENARIO_MAX][DDP_ENING_NUM] = {
	/* DDP_SCENARIO_PRIMARY_DISP */
	{
		...
		DISP_MODULE_RDMA0,
		DISP_MODULE_RSZ0_VIRT0, DISP_MODULE_RSZ0_VIRT1,
#ifdef DISP_COLOR_ON
		DISP_MODULE_COLOR0,
#endif
	...
	{
		DISP_MODULE_OVL0_2L, DISP_MODULE_RDMA1, DISP_MODULE_DPI,
		-1,
	},
...
static struct sel_s sel_in_map[] = {
	...
	{DISP_MODULE_RSZ0_VIRT1, {DISP_MODULE_RSZ0_VIRT0,
	 DISP_MODULE_RSZ0, -1}, 0, 0},

	/* MDP_COLOR0_OUT_SEL_IN */
	{DISP_MODULE_CCORR0, {DISP_MODULE_COLOR0,
	 DISP_MODULE_RSZ0_VIRT1, -1}, 0, 0},

	/* DSI0_SEL_IN */
	{DISP_MODULE_DSI0, {DISP_MODULE_RSZ0_VIRT1,
...
int ddp_path_init(void)
{
	...
	sel_in_map[3].reg =
		(unsigned long *)DISP_REG_CONFIG_MDP_COLOR0_OUT_SEL_IN;
	sel_in_map[4].reg =
