...
#define SENSOR_TYPE_SAR_UNIFY                          73
/* end sensor type */
#define SENSOR_TYPE_MAX_NUM                            SENSOR_TYPE_SAR_UNIFY
...
#define ID_SAR_UNIFY            (ID_BASE + SENSOR_TYPE_SAR_UNIFY - 1)
/* end sensor ID */
#define ID_SENSOR_MAX_HANDLE    (ID_SAR_UNIFY)
