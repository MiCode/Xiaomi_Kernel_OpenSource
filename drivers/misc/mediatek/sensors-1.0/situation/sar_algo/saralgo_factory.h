...
extern int saralgo_factory_device_register(struct saralgo_factory_public *dev);
extern int saralgo_factory_device_deregister(struct saralgo_factory_public *dev);
#endif