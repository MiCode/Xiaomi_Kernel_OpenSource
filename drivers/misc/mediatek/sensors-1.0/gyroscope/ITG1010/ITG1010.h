...
/* set external sync, full-scale range and sample rate, low pass filter
 * bandwidth
 */
...
#define ITG1010_AUX_VDDIO_DIS 0x00

/* for ITG1010_REG_CFG */
/* 0x05    //captue the state of external frame sync input pin to insert into
 * LSB of registers
 */
...
#if IS_ENABLED(CONFIG_CUSTOM_KERNEL_GYROSCOPE_MODULE)
