...
#ifndef BMI160_ACCGYRO_H
#define BMI160_ACCGYRO_H

#include <linux/ioctl.h>

#define BMI160_ACCELGYRO_DEV_NAME "bmi160_accelgyro"
...
extern int BMP160_spi_read_bytes(struct spi_device *spi, u16 addr, u8 *rx_buf,
				 u32 data_len);
extern int BMP160_spi_write_bytes(struct spi_device *spi, u16 addr, u8 *tx_buf,
				  u32 data_len);
