...
const static struct proc_ops dbg_fops = {
	.proc_read = dbg_read,
...
const static struct proc_ops var_fops = {
	.proc_read = var_read,
	.proc_write = var_write,
};
...
MODULE_DEVICE_TABLE(of, spmtwam_of_ids);
...
MODULE_DESCRIPTION("Mediatek MT6XXX spmtwam driver");
