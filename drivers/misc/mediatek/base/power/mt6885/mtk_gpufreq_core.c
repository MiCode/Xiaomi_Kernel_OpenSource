...
static void __mt_gpufreq_clock_switch(unsigned int freq_new)
{
	...
	/* [MT6885] GPUPLL_CON1[24:26] is POST_DIVIDER
	 *    000 : /1
	 *    001 : /2
	 *    010 : /4
	 *    011 : /8
		...
		enum g_post_divider_power_enum post_divider_power)
{
	...
	/* [MT6885] dds is GPUPLL_CON1[21:0] */
...
static int __mt_gpufreq_pdrv_probe(struct platform_device *pdev)
{
	...
	if (g_segment_id == MT6885_SEGMENT_1) {
	...
	} else if (g_segment_id == MT6885_SEGMENT_2) {
	...
	} else if (g_segment_id == MT6885_SEGMENT_3) {
	...
	} else if (g_segment_id == MT6885_SEGMENT_4) {
