...
int clk_buf_dts_map(void)
{
	...
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6833-pwrap");
	if (node)
	...
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6833-pmif-m");
	if (node)
...
#if 0
	node = of_find_compatible_node(NULL, NULL, "mediatek,mt6833-pmif-p");
	if (node)
