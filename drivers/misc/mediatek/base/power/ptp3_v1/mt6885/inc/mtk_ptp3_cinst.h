...
#define CINST_CPU4_DIDT_REG	(CINST_MCUSYS_REG_BASE_ADDR + 0xB930)
#define CINST_CPU5_DIDT_REG	(CINST_MCUSYS_REG_BASE_ADDR + 0xBA30)
...
#define CINST_CPU4_CONFIG_REG	(0x0C532000)
#define CINST_CPU5_CONFIG_REG	(0x0C532800)
...
static const unsigned int CINST_CPU_BASE[NR_CINST_CPU] = {
	CINST_CPU4_CONFIG_REG,
	CINST_CPU5_CONFIG_REG,
