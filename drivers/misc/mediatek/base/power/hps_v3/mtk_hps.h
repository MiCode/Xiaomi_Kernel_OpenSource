...
extern int hps_get_cpu_num_base(hps_base_type_e type,
...
extern int hps_get_cpu_num_limit(hps_limit_type_e type,
	unsigned int *little_cpu_ptr, unsigned int *big_cpu_ptr);
extern int hps_set_cpu_num_limit(hps_limit_type_e type,
