...
#define DEF_NR_LEAKAGE       39
#define DEF_VPU_LEAKAGE       39
#define DEF_MDLA_LEAKAGE       39
#define DEF_VSRAM_PROC12_LEAKAGE         3
#define DEF_VSRAM_PROC11_LEAKAGE         6
#define DEF_VSRAM_OTHERS_LEAKAGE         3
#define DEF_ADSP_LEAKAGE         3
#define DEF_VSRAM_GPU_LEAKAGE            1
#define DEF_VSRAM_VPU_MDLA_LEAKAGE         3
#define DEF_VSRAM_MODEM_LEAKAGE         3
#define DEF_VCORE_OFF_LEAKAGE         3
