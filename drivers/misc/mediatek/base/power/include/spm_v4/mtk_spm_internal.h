...
enum pwr_ctrl_enum {
	...
	PW_CCIFMD_MD1_EVENT_MASK_B,
	PW_CCIFMD_MD2_EVENT_MASK_B,
	PW_DSI0_VSYNC_MASK_B,
	PW_DSI1_VSYNC_MASK_B,
	PW_DPI_VSYNC_MASK_B,
	PW_ISP0_VSYNC_MASK_B,
	PW_ISP1_VSYNC_MASK_B,
	PW_MD_SRCCLKENA_0_INFRA_MASK_B,
	PW_MD_SRCCLKENA_1_INFRA_MASK_B,
	PW_CONN_SRCCLKENA_INFRA_MASK_B,
	PW_SSPM_SRCCLKENA_INFRA_MASK_B,
	PW_SRCCLKENI_INFRA_MASK_B,
	PW_MD_APSRC_REQ_0_INFRA_MASK_B,
	PW_MD_APSRC_REQ_1_INFRA_MASK_B,
	PW_CONN_APSRCREQ_INFRA_MASK_B,
	PW_SSPM_APSRCREQ_INFRA_MASK_B,
	PW_MD_DDR_EN_0_MASK_B,
	PW_MD_DDR_EN_1_MASK_B,
	PW_MD_VRF18_REQ_0_MASK_B,
	PW_MD_VRF18_REQ_1_MASK_B,
	PW_MD1_DVFS_REQ_MASK,
	PW_CPU_DVFS_REQ_MASK,
	PW_EMI_BW_DVFS_REQ_MASK,
	PW_MD_SRCCLKENA_0_DVFS_REQ_MASK_B,
	PW_MD_SRCCLKENA_1_DVFS_REQ_MASK_B,
	PW_CONN_SRCCLKENA_DVFS_REQ_MASK_B,
	PW_DVFS_HALT_MASK_B,
	PW_VDEC_REQ_MASK_B,
	PW_GCE_REQ_MASK_B,
	PW_CPU_MD_DVFS_REQ_MERGE_MASK_B,
	PW_MD_DDR_EN_DVFS_HALT_MASK_B,
	PW_DSI0_VSYNC_DVFS_HALT_MASK_B,
	PW_DSI1_VSYNC_DVFS_HALT_MASK_B,
	PW_DPI_VSYNC_DVFS_HALT_MASK_B,
	PW_ISP0_VSYNC_DVFS_HALT_MASK_B,
	PW_ISP1_VSYNC_DVFS_HALT_MASK_B,
	...
	PW_PS_C2K_RCCIF_WAKE_MASK_B,
	PW_L1_C2K_RCCIF_WAKE_MASK_B,
	PW_SDIO_ON_DVFS_REQ_MASK_B,
	PW_EMI_BOOST_DVFS_REQ_MASK_B,
	PW_CPU_MD_EMI_DVFS_REQ_PROT_DIS,
	PW_DRAMC_SPCMD_APSRC_REQ_MASK_B,
	PW_EMI_BOOST_DVFS_REQ_2_MASK_B,
	PW_EMI_BW_DVFS_REQ_2_MASK,
...
#define spm_emerg(fmt, args...)		\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
#define spm_alert(fmt, args...)		\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
#define spm_crit(fmt, args...)		\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
#define spm_err(fmt, args...)		\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
#define spm_warn(fmt, args...)		\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
#define spm_notice(fmt, args...)	\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
#define spm_info(fmt, args...)		\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
/* pr_debug show nothing */
#define spm_debug(fmt, args...)		\
	printk_deferred("[name:spm&][SPM] " fmt, ##args)
