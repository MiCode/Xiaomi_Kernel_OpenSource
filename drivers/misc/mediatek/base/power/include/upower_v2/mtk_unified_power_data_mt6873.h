...
struct upower_tbl upower_tbl_l_6873T = {
	.row = {
		{.cap = 126, .volt = 60000, .dyn_pwr = 13161,
			.lkg_pwr = {19715, 19715, 19715, 19715, 19715, 19715} },
		{.cap = 153, .volt = 60000, .dyn_pwr = 17109,
			.lkg_pwr = {19715, 19715, 19715, 19715, 19715, 19715} },
		{.cap = 161, .volt = 61250, .dyn_pwr = 19283,
			.lkg_pwr = {20392, 20392, 20392, 20392, 20392, 20392} },
		{.cap = 169, .volt = 63125, .dyn_pwr = 22026,
			.lkg_pwr = {21408, 21408, 21408, 21408, 21408, 21408} },
		{.cap = 183, .volt = 65625, .dyn_pwr = 27143,
			.lkg_pwr = {22811, 22811, 22811, 22811, 22811, 22811} },
		{.cap = 195, .volt = 68750, .dyn_pwr = 33453,
			.lkg_pwr = {24743, 24743, 24743, 24743, 24743, 24743} },
		{.cap = 204, .volt = 71250, .dyn_pwr = 38899,
			.lkg_pwr = {26288, 26288, 26288, 26288, 26288, 26288} },
		{.cap = 219, .volt = 75000, .dyn_pwr = 47760,
			.lkg_pwr = {28604, 28604, 28604, 28604, 28604, 28604} },
		{.cap = 230, .volt = 77500, .dyn_pwr = 54821,
			.lkg_pwr = {30356, 30356, 30356, 30356, 30356, 30356} },
		{.cap = 239, .volt = 80625, .dyn_pwr = 63336,
			.lkg_pwr = {32605, 32605, 32605, 32605, 32605, 32605} },
		{.cap = 246, .volt = 83750, .dyn_pwr = 72555,
			.lkg_pwr = {35089, 35089, 35089, 35089, 35089, 35089} },
		{.cap = 257, .volt = 88125, .dyn_pwr = 84931,
			.lkg_pwr = {38818, 38818, 38818, 38818, 38818, 38818} },
		{.cap = 263, .volt = 90625, .dyn_pwr = 92858,
			.lkg_pwr = {41065, 41065, 41065, 41065, 41065, 41065} },
		{.cap = 269, .volt = 93125, .dyn_pwr = 101103,
			.lkg_pwr = {43483, 43483, 43483, 43483, 43483, 43483} },
		{.cap = 275, .volt = 96875, .dyn_pwr = 113304,
			.lkg_pwr = {47374, 47374, 47374, 47374, 47374, 47374} },
		{.cap = 280, .volt = 100000, .dyn_pwr = 124630,
			.lkg_pwr = {50836, 50836, 50836, 50836, 50836, 50836} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_cluster_l_6873T = {
	.row = {
		{.cap = 126, .volt = 60000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 153, .volt = 60000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 161, .volt = 61250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 169, .volt = 63125, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 183, .volt = 65625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 195, .volt = 68750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 204, .volt = 71250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 219, .volt = 75000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 230, .volt = 77500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 239, .volt = 80625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 246, .volt = 83750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 257, .volt = 88125, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 263, .volt = 90625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 269, .volt = 93125, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 275, .volt = 96875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 280, .volt = 100000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_b_6873T = {
	.row = {
		{.cap = 574, .volt = 60000, .dyn_pwr = 79872,
			.lkg_pwr = {81046, 81046, 81046, 81046, 81046, 81046} },
		{.cap = 620, .volt = 62500, .dyn_pwr = 97945,
			.lkg_pwr = {87427, 87427, 87427, 87427, 87427, 87427} },
		{.cap = 661, .volt = 64375, .dyn_pwr = 116001,
			.lkg_pwr = {92213, 92213, 92213, 92213, 92213, 92213} },
		{.cap = 710, .volt = 67500, .dyn_pwr = 145123,
			.lkg_pwr = {100176, 100176, 100176, 100176, 100176,
						100176} },
		{.cap = 760, .volt = 70625, .dyn_pwr = 177071,
			.lkg_pwr = {108133, 108133, 108133, 108133, 108133,
						108133} },
		{.cap = 792, .volt = 72500, .dyn_pwr = 200653,
			.lkg_pwr = {112905, 112905, 112905, 112905, 112905,
						112905} },
		{.cap = 820, .volt = 75000, .dyn_pwr = 229764,
			.lkg_pwr = {119268, 119268, 119268, 119268, 119268,
						119268} },
		{.cap = 860, .volt = 78750, .dyn_pwr = 280365,
			.lkg_pwr = {130024, 130024, 130024, 130024, 130024,
						130024} },
		{.cap = 888, .volt = 80625, .dyn_pwr = 310738,
			.lkg_pwr = {135442, 135442, 135442, 135442, 135442,
						135442} },
		{.cap = 921, .volt = 83750, .dyn_pwr = 356771,
			.lkg_pwr = {144608, 144608, 144608, 144608, 144608,
						144608} },
		{.cap = 933, .volt = 85625, .dyn_pwr = 381998,
			.lkg_pwr = {150469, 150469, 150469, 150469, 150469,
						150469} },
		{.cap = 953, .volt = 89375, .dyn_pwr = 433914,
			.lkg_pwr = {163636, 163636, 163636, 163636, 163636,
						163636} },
		{.cap = 973, .volt = 93125, .dyn_pwr = 492664,
			.lkg_pwr = {177134, 177134, 177134, 177134, 177134,
						177134} },
		{.cap = 994, .volt = 96250, .dyn_pwr = 545057,
			.lkg_pwr = {189284, 189284, 189284, 189284, 189284,
						189284} },
		{.cap = 1012, .volt = 100000, .dyn_pwr = 608474,
			.lkg_pwr = {205387, 205387, 205387, 205387, 205387,
						205387} },
		{.cap = 1024, .volt = 100000, .dyn_pwr = 627193,
			.lkg_pwr = {205387, 205387, 205387, 205387, 205387,
						205387} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
...
struct upower_tbl upower_tbl_cluster_b_6873T = {
	.row = {
		{.cap = 574, .volt = 60000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 620, .volt = 62500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 661, .volt = 64375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 710, .volt = 67500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 760, .volt = 70625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 792, .volt = 72500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 820, .volt = 75000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 860, .volt = 78750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 888, .volt = 80625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 921, .volt = 83750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 933, .volt = 85625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 953, .volt = 89375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 973, .volt = 93125, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 994, .volt = 96250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 1012, .volt = 100000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 1024, .volt = 100000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
	},
