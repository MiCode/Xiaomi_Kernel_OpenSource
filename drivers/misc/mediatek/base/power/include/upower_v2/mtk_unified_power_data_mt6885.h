...
struct upower_tbl upower_tbl_l_6885T = {
	.row = {
		{.cap = 132, .volt = 60000, .dyn_pwr = 11815,
			.lkg_pwr = {19715, 19715, 19715, 19715, 19715, 19715} },
		{.cap = 161, .volt = 60000, .dyn_pwr = 15359,
			.lkg_pwr = {19715, 19715, 19715, 19715, 19715, 19715} },
		{.cap = 170, .volt = 61250, .dyn_pwr = 17311,
			.lkg_pwr = {20392, 20392, 20392, 20392, 20392, 20392} },
		{.cap = 179, .volt = 63125, .dyn_pwr = 19773,
			.lkg_pwr = {21408, 21408, 21408, 21408, 21408, 21408} },
		{.cap = 193, .volt = 65625, .dyn_pwr = 24367,
			.lkg_pwr = {22811, 22811, 22811, 22811, 22811, 22811} },
		{.cap = 205, .volt = 68750, .dyn_pwr = 30032,
			.lkg_pwr = {24742, 24742, 24742, 24742, 24742, 24742} },
		{.cap = 215, .volt = 71250, .dyn_pwr = 34921,
			.lkg_pwr = {26287, 26287, 26287, 26287, 26287, 26287} },
		{.cap = 231, .volt = 75000, .dyn_pwr = 43604,
			.lkg_pwr = {28604, 28604, 28604, 28604, 28604, 28604} },
		{.cap = 242, .volt = 77500, .dyn_pwr = 50739,
			.lkg_pwr = {30356, 30356, 30356, 30356, 30356, 30356} },
		{.cap = 252, .volt = 80625, .dyn_pwr = 59436,
			.lkg_pwr = {32605, 32605, 32605, 32605, 32605, 32605} },
		{.cap = 260, .volt = 83750, .dyn_pwr = 69059,
			.lkg_pwr = {35089, 35089, 35089, 35089, 35089, 35089} },
		{.cap = 271, .volt = 88125, .dyn_pwr = 82834,
			.lkg_pwr = {38818, 38818, 38818, 38818, 38818, 38818} },
		{.cap = 278, .volt = 90625, .dyn_pwr = 92075,
			.lkg_pwr = {41065, 41065, 41065, 41065, 41065, 41065} },
		{.cap = 284, .volt = 93125, .dyn_pwr = 101950,
			.lkg_pwr = {43483, 43483, 43483, 43483, 43483, 43483} },
		{.cap = 290, .volt = 96875, .dyn_pwr = 116732,
			.lkg_pwr = {47375, 47375, 47375, 47375, 47375, 47375} },
		{.cap = 296, .volt = 100000, .dyn_pwr = 131277,
			.lkg_pwr = {50838, 50838, 50838, 50838, 50838, 50838} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
...
struct upower_tbl upower_tbl_b_6885T = {
	.row = {
		{.cap = 605, .volt = 60000, .dyn_pwr = 62929,
			.lkg_pwr = {81045, 81045, 81045, 81045, 81045, 81045} },
		{.cap = 655, .volt = 62500, .dyn_pwr = 77169,
			.lkg_pwr = {87429, 87429, 87429, 87429, 87429, 87429} },
		{.cap = 697, .volt = 64375, .dyn_pwr = 91395,
			.lkg_pwr = {92217, 92217, 92217, 92217, 92217, 92217} },
		{.cap = 749, .volt = 67500, .dyn_pwr = 114339,
			.lkg_pwr = {100179, 100179, 100179, 100179, 100179,
				100179} },
		{.cap = 802, .volt = 70625, .dyn_pwr = 140460,
			.lkg_pwr = {108136, 108136, 108136, 108136, 108136,
				108136} },
		{.cap = 836, .volt = 72500, .dyn_pwr = 159974,
			.lkg_pwr = {112907, 112907, 112907, 112907, 112907,
				112907} },
		{.cap = 865, .volt = 75000, .dyn_pwr = 184127,
			.lkg_pwr = {119268, 119268, 119268, 119268, 119268,
				119268} },
		{.cap = 890, .volt = 76875, .dyn_pwr = 207034,
			.lkg_pwr = {124645, 124645, 124645, 124645, 124645,
				124645} },
		{.cap = 907, .volt = 78750, .dyn_pwr = 226612,
			.lkg_pwr = {130022, 130022, 130022, 130022, 130022,
				130022} },
		{.cap = 937, .volt = 80625, .dyn_pwr = 252474,
			.lkg_pwr = {135441, 135441, 135441, 135441, 135441,
				135441} },
		{.cap = 972, .volt = 83750, .dyn_pwr = 293924,
			.lkg_pwr = {144611, 144611, 144611, 144611, 144611,
				144611} },
		{.cap = 985, .volt = 85625, .dyn_pwr = 316537,
			.lkg_pwr = {150473, 150473, 150473, 150473, 150473,
				150473} },
		{.cap = 994, .volt = 87500, .dyn_pwr = 337885,
			.lkg_pwr = {157054, 157054, 157054, 157054, 157054,
				157054} },
		{.cap = 1006, .volt = 89375, .dyn_pwr = 363423,
			.lkg_pwr = {163636, 163636, 163636, 163636, 163636,
				163636} },
		{.cap = 1020, .volt = 92500, .dyn_pwr = 404648,
			.lkg_pwr = {174875, 174875, 174875, 174875, 174875,
				174875} },
		{.cap = 1024, .volt = 93125, .dyn_pwr = 415327,
			.lkg_pwr = {177136, 177136, 177136, 177136, 177136,
				177136} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
	.row_num = UPOWER_OPP_NUM,
