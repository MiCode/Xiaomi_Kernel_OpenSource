...
struct upower_tbl upower_tbl_l_B24G = {
	.row = {
		{.cap = 148, .volt = 65000, .dyn_pwr = 15882,
			.lkg_pwr = {24121, 24121, 24121, 24121, 24121, 24121} },
		{.cap = 182, .volt = 65000, .dyn_pwr = 20646,
			.lkg_pwr = {24121, 24121, 24121, 24121, 24121, 24121} },
		{.cap = 193, .volt = 66250, .dyn_pwr = 23197,
			.lkg_pwr = {24952, 24952, 24952, 24952, 24952, 24952} },
		{.cap = 203, .volt = 67500, .dyn_pwr = 25896,
			.lkg_pwr = {25784, 25784, 25784, 25784, 25784, 25784} },
		{.cap = 222, .volt = 70000, .dyn_pwr = 31755,
			.lkg_pwr = {27447, 27447, 27447, 27447, 27447, 27447} },
		...
		{.cap = 324, .volt = 89375, .dyn_pwr = 90570,
			.lkg_pwr = {42932, 42932, 42932, 42932, 42932, 42932} },
		{.cap = 336, .volt = 92500, .dyn_pwr = 101058,
			.lkg_pwr = {46122, 46122, 46122, 46122, 46122, 46122} },
		{.cap = 341, .volt = 94375, .dyn_pwr = 107555,
			.lkg_pwr = {48073, 48073, 48073, 48073, 48073, 48073} },
		{.cap = 351, .volt = 97500, .dyn_pwr = 118796,
			.lkg_pwr = {51703, 51703, 51703, 51703, 51703, 51703} },
...
struct upower_tbl upower_tbl_cluster_l_B24G = {
	.row = {
		{.cap = 148, .volt = 65000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 182, .volt = 65000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 193, .volt = 66250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 203, .volt = 67500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 222, .volt = 70000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		...
		{.cap = 324, .volt = 89375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 336, .volt = 92500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 341, .volt = 94375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 351, .volt = 97500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
...
struct upower_tbl upower_tbl_b_B24G = {
	.row = {
		{.cap = 612, .volt = 65000, .dyn_pwr = 88354,
			.lkg_pwr = {95432, 95432, 95432, 95432, 95432, 95432} },
		{.cap = 668, .volt = 67500, .dyn_pwr = 110395,
			.lkg_pwr = {101909, 101909, 101909, 101909, 101909,
			101909} },
		{.cap = 698, .volt = 68750, .dyn_pwr = 122429,
			.lkg_pwr = {105148, 105148, 105148, 105148, 105148,
			105148} },
		{.cap = 732, .volt = 70625, .dyn_pwr = 141715,
			.lkg_pwr = {110005, 110005, 110005, 110005, 110005,
			110005} },
		{.cap = 755, .volt = 71875, .dyn_pwr = 155269,
			.lkg_pwr = {113241, 113241, 113241, 113241, 113241,
			113241} },
		{.cap = 754, .volt = 73750, .dyn_pwr = 176368,
			.lkg_pwr = {118096, 118096, 118096, 118096, 118096,
			118096} },
		{.cap = 798, .volt = 76875, .dyn_pwr = 214580,
			.lkg_pwr = {126803, 126803, 126803, 126803, 126803,
			126803} },
		{.cap = 837, .volt = 80000, .dyn_pwr = 256656,
			.lkg_pwr = {135922, 135922, 135922, 135922, 135922,
			135922} },
		{.cap = 865, .volt = 82500, .dyn_pwr = 293432,
			.lkg_pwr = {143381, 143381, 143381, 143381, 143381,
			143381} },
		{.cap = 894, .volt = 85000, .dyn_pwr = 332437,
			.lkg_pwr = {150841, 150841, 150841, 150841, 150841,
			150841} },
		{.cap = 932, .volt = 88750, .dyn_pwr = 395006,
			.lkg_pwr = {164235, 164235, 164235, 164235, 164235,
			164235} },
		{.cap = 953, .volt = 91875, .dyn_pwr = 451060,
			.lkg_pwr = {175600, 175600, 175600, 175600, 175600,
			175600} },
		{.cap = 978, .volt = 94375, .dyn_pwr = 498412,
			.lkg_pwr = {184799, 184799, 184799, 184799, 184799,
			184799} },
		{.cap = 996, .volt = 96250, .dyn_pwr = 536863,
			.lkg_pwr = {192560, 192560, 192560, 192560, 192560,
			192560} },
		{.cap = 1011, .volt = 98125, .dyn_pwr = 579949,
			.lkg_pwr = {200751, 200751, 200751, 200751, 200751,
			200751} },
		{.cap = 1024, .volt = 100000, .dyn_pwr = 626711,
			.lkg_pwr = {208942, 208942, 208942, 208942, 208942,
			208942} },
	},
	.lkg_idx = DEFAULT_LKG_IDX,
...
struct upower_tbl upower_tbl_cluster_b_B24G = {
	.row = {
		{.cap = 612, .volt = 65000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 668, .volt = 67500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 698, .volt = 68750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 732, .volt = 70625, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 755, .volt = 71875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 754, .volt = 73750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 798, .volt = 76875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 837, .volt = 80000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 865, .volt = 82500, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 894, .volt = 85000, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 932, .volt = 88750, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 953, .volt = 91875, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 978, .volt = 94375, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
		{.cap = 996, .volt = 96250, .dyn_pwr = 0,
			.lkg_pwr = {0, 0, 0, 0, 0, 0} },
