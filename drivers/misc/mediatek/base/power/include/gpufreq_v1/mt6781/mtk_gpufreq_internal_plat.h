...
struct opp_table_info g_opp_table_segment_1[] = {
	GPUOP(950000, 90000, 100000, POSDIV_POWER_4, 1875), /* 0 sign off */
	GPUOP(940000, 89375, 99375,  POSDIV_POWER_4, 1875), /* 1 */
	GPUOP(930000, 88750, 98750,  POSDIV_POWER_4, 1875), /* 2 */
	GPUOP(920000, 88125, 98125,  POSDIV_POWER_4, 1875), /* 3 */
	GPUOP(910000, 87500, 97500,  POSDIV_POWER_4, 1875), /* 4 */
	GPUOP(900000, 86875, 96875,  POSDIV_POWER_4, 1875), /* 5 */
	GPUOP(890000, 86250, 96250,  POSDIV_POWER_4, 1875), /* 6 */
	GPUOP(880000, 85625, 95625,  POSDIV_POWER_4, 1875), /* 7 */
	GPUOP(870000, 85000, 95000,  POSDIV_POWER_4, 1875), /* 8 */
	GPUOP(860000, 84375, 94375,  POSDIV_POWER_4, 1875), /* 9 */
	...
	GPUOP(732000, 77500, 87500,  POSDIV_POWER_4, 1250), /*20 */
	GPUOP(718000, 76875, 86875,  POSDIV_POWER_4, 1250), /*21 */
	GPUOP(703000, 76250, 86250,  POSDIV_POWER_4, 1250), /*22 */
	GPUOP(689000, 75625, 85625,  POSDIV_POWER_4, 1250), /*23 */
	GPUOP(675000, 75000, 85000,  POSDIV_POWER_4, 1250), /*24 */
