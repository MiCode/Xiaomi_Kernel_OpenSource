 ...
 **************************************************/
// MT6781_PORTING_TODO: check aging settings
struct opp_table_info g_opp_table_segment_1[] = {
	GPUOP(950000, 90000, 100000, POSDIV_POWER_4, 2500), /* 0 sign off */
	GPUOP(940000, 89375, 99375,  POSDIV_POWER_4, 2500), /* 1 */
	GPUOP(930000, 88750, 98750,  POSDIV_POWER_4, 2500), /* 2 */
	GPUOP(920000, 88125, 98125,  POSDIV_POWER_4, 2500), /* 3 */
	GPUOP(910000, 87500, 97500,  POSDIV_POWER_4, 2500), /* 4 */
	GPUOP(900000, 86875, 96875,  POSDIV_POWER_4, 2500), /* 5 */
	GPUOP(890000, 86250, 96250,  POSDIV_POWER_4, 2500), /* 6 */
	GPUOP(880000, 85625, 95625,  POSDIV_POWER_4, 2500), /* 7 */
	GPUOP(870000, 85000, 95000,  POSDIV_POWER_4, 2500), /* 8 */
	GPUOP(860000, 84375, 94375,  POSDIV_POWER_4, 2500), /* 9 */
	GPUOP(850000, 83750, 93750,  POSDIV_POWER_4, 1875), /*10 */
	GPUOP(840000, 83125, 93125,  POSDIV_POWER_4, 1875), /*11 */
	GPUOP(830000, 82500, 92500,  POSDIV_POWER_4, 1875), /*12 */
	GPUOP(820000, 81875, 91875,  POSDIV_POWER_4, 1875), /*13 */
	GPUOP(810000, 81250, 91250,  POSDIV_POWER_4, 1875), /*14 */
	GPUOP(800000, 80625, 90625,  POSDIV_POWER_4, 1875), /*15 */
	GPUOP(790000, 80000, 90000,  POSDIV_POWER_4, 1875), /*16 sign off */
	GPUOP(775000, 79375, 89375,  POSDIV_POWER_4, 1875), /*17 */
	GPUOP(761000, 78750, 88750,  POSDIV_POWER_4, 1875), /*18 */
	GPUOP(746000, 78125, 88125,  POSDIV_POWER_4, 1875), /*19 */
	GPUOP(732000, 77500, 87500,  POSDIV_POWER_4, 1875), /*20 */
	GPUOP(718000, 76875, 86875,  POSDIV_POWER_4, 1875), /*21 */
	GPUOP(703000, 76250, 86250,  POSDIV_POWER_4, 1875), /*22 */
	GPUOP(689000, 75625, 85625,  POSDIV_POWER_4, 1875), /*23 */
	GPUOP(675000, 75000, 85000,  POSDIV_POWER_4, 1875), /*24 */
	GPUOP(660000, 74375, 85000,  POSDIV_POWER_4, 1250), /*25 */
	GPUOP(646000, 73750, 85000,  POSDIV_POWER_4, 1250), /*26 */
	GPUOP(631000, 73125, 85000,  POSDIV_POWER_4, 1250), /*27 */
	GPUOP(617000, 72500, 85000,  POSDIV_POWER_4, 1250), /*28 */
	GPUOP(603000, 71875, 85000,  POSDIV_POWER_4, 1250), /*29 */
	GPUOP(588000, 71250, 85000,  POSDIV_POWER_4, 1250), /*30 */
	GPUOP(574000, 70625, 85000,  POSDIV_POWER_4, 1250), /*31 */
	GPUOP(560000, 70000, 85000,  POSDIV_POWER_4, 1250), /*32 sign off */
	GPUOP(543000, 69375, 85000,  POSDIV_POWER_4, 1250), /*33 */
	GPUOP(527000, 68750, 85000,  POSDIV_POWER_4, 1250), /*34 */
	GPUOP(511000, 68125, 85000,  POSDIV_POWER_4, 1250), /*35 */
	GPUOP(495000, 67500, 85000,  POSDIV_POWER_4, 1250), /*36 */
...
// MT6781_PORTING_TODO: check the segments settings
#if 0
