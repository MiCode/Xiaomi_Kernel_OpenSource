...
struct opp_table_info g_opp_table_segment_1[] = {
	GPUOP(1068000, 85000, 85000, POSDIV_POWER_2, 625), /* 0 sign off */
	GPUOP(1059000, 84375, 84375, POSDIV_POWER_2, 625), /* 1 */
	GPUOP(1051000, 83750, 83750, POSDIV_POWER_2, 625), /* 2 */
	GPUOP(1042000, 83125, 83125, POSDIV_POWER_2, 625), /* 3 */
	GPUOP(1034000, 82500, 82500, POSDIV_POWER_2, 625), /* 4 */
	GPUOP(1025000, 81875, 81875, POSDIV_POWER_2, 625), /* 5 */
	GPUOP(1017000, 81250, 81250, POSDIV_POWER_2, 625), /* 6 */
	GPUOP(1008000, 80625, 80625, POSDIV_POWER_2, 625), /* 7 */
	GPUOP(1000000, 80000, 80000, POSDIV_POWER_2, 625), /* 8 sign off */
	GPUOP(985000,  79375, 79375, POSDIV_POWER_2, 625), /* 9 */
	GPUOP(970000,  78750, 78750, POSDIV_POWER_2, 625), /*10 */
	GPUOP(955000,  78125, 78125, POSDIV_POWER_2, 625), /*11 */
	GPUOP(940000,  77500, 77500, POSDIV_POWER_4, 625), /*12 */
	GPUOP(925000,  76875, 76875, POSDIV_POWER_4, 625), /*13 */
	GPUOP(910000,  76250, 76250, POSDIV_POWER_4, 625), /*14 */
	GPUOP(895000,  75625, 75625, POSDIV_POWER_4, 625), /*15 */
	GPUOP(880000,  75000, 75000, POSDIV_POWER_4, 625), /*16 sign off */
	GPUOP(868000,  74375, 75000, POSDIV_POWER_4, 625), /*17 */
	GPUOP(857000,  73750, 75000, POSDIV_POWER_4, 625), /*18 */
	GPUOP(846000,  73125, 75000, POSDIV_POWER_4, 625), /*19 */
	GPUOP(835000,  72500, 75000, POSDIV_POWER_4, 625), /*20 */
	GPUOP(823000,  71875, 75000, POSDIV_POWER_4, 625), /*21 */
	GPUOP(812000,  71250, 75000, POSDIV_POWER_4, 625), /*22 */
	GPUOP(801000,  70625, 75000, POSDIV_POWER_4, 625), /*23 */
	GPUOP(790000,  70000, 75000, POSDIV_POWER_4, 625), /*24 */
	GPUOP(778000,  69375, 75000, POSDIV_POWER_4, 625), /*25 */
	GPUOP(767000,  68750, 75000, POSDIV_POWER_4, 625), /*26 */
	GPUOP(756000,  68125, 75000, POSDIV_POWER_4, 625), /*27 */
	GPUOP(745000,  67500, 75000, POSDIV_POWER_4, 625), /*28 */
	GPUOP(733000,  66875, 75000, POSDIV_POWER_4, 625), /*29 */
	GPUOP(722000,  66250, 75000, POSDIV_POWER_4, 625), /*30 */
	GPUOP(711000,  65625, 75000, POSDIV_POWER_4, 625), /*31 */
	GPUOP(700000,  65000, 75000, POSDIV_POWER_4, 625), /*32 sign off */
	GPUOP(674000,  64375, 75000, POSDIV_POWER_4, 625), /*33 */
	GPUOP(648000,  63750, 75000, POSDIV_POWER_4, 625), /*34 */
	GPUOP(622000,  63125, 75000, POSDIV_POWER_4, 625), /*35 */
...
struct opp_table_info g_opp_table_segment_2[] = {
	...
	GPUOP(711000,  65625, 75000, POSDIV_POWER_4, 625), /*31 */
	GPUOP(700000,  65000, 75000, POSDIV_POWER_4, 625), /*32 sign off */
	GPUOP(674000,  65000, 75000, POSDIV_POWER_4, 625), /*33 */
	GPUOP(648000,  64375, 75000, POSDIV_POWER_4, 625), /*34 */
	GPUOP(622000,  63750, 75000, POSDIV_POWER_4, 625), /*35 */
