...
struct opp_table_info g_opp_table_segment_1[] = {
	...
	GPUOP(926000, 78750, 78750, POSDIV_POWER_4, 1870), /* 2 */
	GPUOP(914000, 78125, 78125, POSDIV_POWER_4, 1870), /* 3 */
	GPUOP(902000, 77500, 77500, POSDIV_POWER_4, 1870), /* 4 */
	GPUOP(890000, 76875, 76875, POSDIV_POWER_4, 1870), /* 5 */
	GPUOP(878000, 76250, 76250, POSDIV_POWER_4, 1870), /* 6 */
	GPUOP(866000, 75625, 75625, POSDIV_POWER_4, 1870), /* 7 */
	GPUOP(855000, 75000, 75000, POSDIV_POWER_4, 1870), /* 8 */
	GPUOP(843000, 74375, 75000, POSDIV_POWER_4, 1870), /* 9 */
	GPUOP(831000, 73750, 75000, POSDIV_POWER_4, 1870), /*10 */
	GPUOP(819000, 73125, 75000, POSDIV_POWER_4, 1870), /*11 */
	GPUOP(807000, 72500, 75000, POSDIV_POWER_4, 1870), /*12 */
	GPUOP(795000, 71875, 75000, POSDIV_POWER_4, 1870), /*13 */
	GPUOP(783000, 71250, 75000, POSDIV_POWER_4, 1870), /*14 */
	GPUOP(772000, 70625, 75000, POSDIV_POWER_4, 1870), /*15 */
	...
	GPUOP(523000, 61250, 75000, POSDIV_POWER_4,  620), /*30 */
	GPUOP(502000, 60625, 75000, POSDIV_POWER_4,  620), /*31 */
	GPUOP(482000, 60000, 75000, POSDIV_POWER_4,  620), /*32 */
	GPUOP(461000, 59375, 75000, POSDIV_POWER_4,  620), /*33 */
	GPUOP(440000, 58750, 75000, POSDIV_POWER_4,  620), /*34 */
	GPUOP(420000, 58125, 75000, POSDIV_POWER_4,  620), /*35 */
	GPUOP(399000, 57500, 75000, POSDIV_POWER_4,  620), /*36 */
	GPUOP(378000, 56875, 75000, POSDIV_POWER_4,  620), /*37 */
	GPUOP(358000, 56250, 75000, POSDIV_POWER_8,  620), /*38 sign off */
};
