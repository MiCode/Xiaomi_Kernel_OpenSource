...
//MT6781_TODO check this part with PTPOD
/*
...
static int __mt_gpufreq_init_clk(struct platform_device *pdev)
{
    ...
    //MT6781_TODO check DFD addr & sleep g_dbgtop g_toprgu g_infracfg_ao
	// 0x1020E000
	#if 0
