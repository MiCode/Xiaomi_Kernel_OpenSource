...
struct spower_leakage_info spower_lkg_info[MTK_SPOWER_MAX] = {
	...
	[MTK_VSRAM_CORE_LEAKAGE] = {
		.name = __stringify(MTK_VSRAM_CORE_LEAKAGE),
		.devinfo_idx = DEVINFO_IDX_VSRAM_CORE,
		.devinfo_offset = DEVINFO_OFF_VSRAM_CORE,
		.value = DEF_VSRAM_CORE_LEAKAGE,
		.v_of_fuse = V_OF_FUSE_VSRAM_CORE,
		.t_of_fuse = T_OF_FUSE,
	},
	...
	[MTK_MODEM_OFF_LEAKAGE] = {
		.name = __stringify(MTK_MODEM_OFF_LEAKAGE),
		.devinfo_idx = DEVINFO_IDX_MODEM_OFF,
		.devinfo_offset = DEVINFO_OFF_MODEM_OFF,
		.value = DEF_MODEM_OFF_LEAKAGE,
		.v_of_fuse = V_OF_FUSE_MODEM_OFF,
		.t_of_fuse = T_OF_FUSE,
	},
};
/****************************************************************
