...
int cpu_power_ratio_up[CM_MGR_EMI_OPP] = {40, 40};
int cpu_power_ratio_down[CM_MGR_EMI_OPP] = {100, 60};
int vcore_power_ratio_up[CM_MGR_EMI_OPP] = {100, 100};
int vcore_power_ratio_down[CM_MGR_EMI_OPP] = {100, 100};
int debounce_times_up_adb[CM_MGR_EMI_OPP] = {0, 0};
int debounce_times_down_adb[CM_MGR_EMI_OPP] = {0, 0};
