...
#define CPU4_DIDT_REG			(MCUSYS_REG_BASE_ADDR + 0xB830)
#define CPU5_DIDT_REG			(MCUSYS_REG_BASE_ADDR + 0xBA30)
#define CPU6_DIDT_REG			(MCUSYS_REG_BASE_ADDR + 0xBC30)
#define CPU7_DIDT_REG			(MCUSYS_REG_BASE_ADDR + 0xBE30)
#define MCUSYS_RESERVED_REG0	(MCUSYS_REG_BASE_ADDR + 0xFFE0)
#define MCUSYS_RESERVED_REG1	(MCUSYS_REG_BASE_ADDR + 0xFFE4)
...
#define CREDIT_DIDT_RG_HACK_EN			(1:1)
#define CREDIT_DIDT_LS_CTRL_EN			(15:15)
#define CREDIT_DIDT_VX_CTRL_EN_CORE4	(0:0)
#define CREDIT_DIDT_VX_CTRL_EN_CORE5	(1:1)
#define CREDIT_DIDT_VX_CTRL_EN_CORE6	(2:2)
#define CREDIT_DIDT_VX_CTRL_EN_CORE7	(3:3)
 ...
 ************************************************/
#ifdef CONFIG_ARM64
#define MTK_SIP_KERNEL_CREDIT_DIDT_CONTROL			0xC2000330
#else
#define MTK_SIP_KERNEL_CREDIT_DIDT_CONTROL			0x82000330
#endif
