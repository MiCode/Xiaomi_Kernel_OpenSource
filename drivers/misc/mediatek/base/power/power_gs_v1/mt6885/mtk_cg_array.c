...
unsigned int AP_CG_Golden_Setting_tcl_gs_dpidle_len = 396;
...
unsigned int AP_CG_Golden_Setting_tcl_gs_suspend_len = 408;
...
unsigned int AP_CG_Golden_Setting_tcl_gs_sodi_len = 147;
