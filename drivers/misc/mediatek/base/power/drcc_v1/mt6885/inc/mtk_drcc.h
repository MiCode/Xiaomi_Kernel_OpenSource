...
#define DRCC_B_CONF0 (DRCC_BASEADDR + 0x2290)
#define DRCC_B_CONF2 (DRCC_BASEADDR + 0x2298)
#define DRCC_B_CONF3 (DRCC_BASEADDR + 0x229C)
#define MCUSYS_RESERVED_REG1 (DRCC_BASEADDR + 0xFFE4)
