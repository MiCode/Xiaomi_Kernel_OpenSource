 ...
 * struct vpu_img_hdr, whose size is 3. All VPU driver needs to know is
 * algo's offset for algo loading.
 *
 */

struct vpu_img_hdr_legacy {
	uint32_t version;
	uint32_t build_date;
...
extern struct vpu_sys_ops vpu_sops_mt68xx;
extern struct vpu_sys_ops vpu_sops_mt67xx;
extern struct vpu_bin_ops vpu_bops_legacy;
extern struct vpu_bin_ops vpu_bops_preload;
