...
static bool support_preemption;
...
static bool mdla_sched_preemption_support(void)
{
	return support_preemption;
}
...
int mdla_mt6873_sched_init(void)
{
...
void mdla_mt6873_sched_deinit(void)
{
	int i;
