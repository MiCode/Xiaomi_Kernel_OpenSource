...
static void mdla_v2_0_reset(int core, const char *str)
{
	unsigned long flags;
...
int mdla_v2_0_init(struct platform_device *pdev)
{
	...
	if (mdla_pwr_register(pdev, mdla_pwr_on_v2_0, mdla_pwr_off_v2_0))
		goto err_pwr;
	...
	mdla_util_setup_decode_ops(mdla_decode_v2_0);
