...
int mt6983_rproc_init(struct mtk_apu *apu)
{
	return 0;
}

int mt6983_rproc_exit(struct mtk_apu *apu)
{
	return 0;
}
...
int mt6983_rproc_start(struct mtk_apu *apu)
{
	int ns = 1; /* Non Secure */
	int domain = 0;
...
int mt6983_rproc_stop(struct mtk_apu *apu)
{
	/* Hold runstall */
...
int mt6983_apu_memmap_init(struct mtk_apu *apu)
{
...
void mt6983_apu_memmap_remove(struct mtk_apu *apu)
{
}

void mt6983_rv_cg_gating(struct mtk_apu *apu)
{
	iowrite32(0x0, apu->md32_sysctrl + MD32_CLK_EN);
}

void mt6983_rv_cg_ungating(struct mtk_apu *apu)
{
	iowrite32(0x1, apu->md32_sysctrl + MD32_CLK_EN);
}

void mt6983_rv_cachedump(struct mtk_apu *apu)
{
	int offset;
	unsigned long flags;
