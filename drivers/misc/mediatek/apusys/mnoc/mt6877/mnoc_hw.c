...
static const char * const mni_map_string[][NR_MNI_PER_GROUP] = {
	{"MNI_MDLA0_0", "MNI_MDLA0_1", "MNI_VPU0", "MNI_VPU1", "MNI_XPU", "MNI_EDMA0"},
};

static const char * const sni_map_string[][NR_SNI_PER_GROUP] = {
	{"SNI_VPU0", "SNI_VPU1", "SNI_EMI0", "SNI_EMI1"},
};
...
/**
 * MDLA0_0  -> MNI0 -> group 0 -> mni_offset 0
 * MDLA0_1  -> MNI1 -> group 0 -> mni_offset 1
 * VPU0     -> MNI2 -> group 0 -> mni_offset 2
 * VPU1     -> MNI3 -> group 0 -> mni_offset 3
 * XPU      -> MNI4 -> group 0 -> mni_offset 4
 * EDMA0    -> MNI5 -> group 0 -> mni_offset 5
 */
static const unsigned int grp_base_addr[NR_GROUP] = {
	APU_NOC_GROUP0,
};

static unsigned int grp_nr_mni[NR_GROUP] = {6};
static unsigned int grp_nr_sni[NR_GROUP] = {4};

#ifdef MNOC_MET_PMU_FTRACE
static unsigned int grp_req_rt_pmu_id[NR_GROUP] = {9};
#endif

static unsigned int grp_map[NR_APU_QOS_MNI] = {0, 0, 0, 0, 0, 0};
static unsigned int mni_map[NR_APU_QOS_MNI] = {0, 1, 2, 3, 4, 5};
...
{
#if 0 // no need infra2apu bus protect
