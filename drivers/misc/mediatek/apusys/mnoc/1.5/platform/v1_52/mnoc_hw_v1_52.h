...
#define NR_APU_ENGINE_MDLA (0)
#define NR_APU_ENGINE_EDMA (0)

#define NR_MNOC_RT (1)
#define NR_GROUP (1)
#define NR_MNI_PER_GROUP (4)
#define NR_SNI_PER_GROUP (5)

#define SNI_EMI0_GRP (0)
#define SNI_EMI1_GRP (0)
#define EMI0_FINE_TUNE (0x7 << 12)
#define EMI1_FINE_TUNE (0x7 << 16)

#ifdef MNOC_MET_PMU_FTRACE
/* only output REQ_RT timeout event */
#define NR_PMU_CNTR_PER_GRP (1)
#else
...
#define QOS_MON_SLV_SEL_DRAM (0x18)
#define QOS_MON_SLV_SEL_DRAM_TCM (0x1F)
...
/* bit 0~1 */
#define MNOC_INT_MAP (GRP_INT_MAP_0)
...
#define PMU_CTRL (0x200)
#define REQ_RT_PMU (0x500)
#define RSP_RT_PMU (0x600)

#define CFG_PMU_EN (1 << 31)
#define	CFG_PMU_CNTR_SAT (1 << 30)
#define	CFG_COLLECTOR_EN (1 << 31)
#define TIMEOUT_EVENT (0x6)
