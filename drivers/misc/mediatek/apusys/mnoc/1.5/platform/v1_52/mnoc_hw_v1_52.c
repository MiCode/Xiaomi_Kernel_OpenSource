...
struct int_sta_info apusys_int_sta_dump_v1_52;
...
int mnoc_check_int_status_v1_52(void)
{
	...
	if (int_sta != 0) {
		apusys_int_sta_dump_v1_52.reg_val = int_sta;
		apusys_int_sta_dump_v1_52.timestamp = cur_timestamp;
	}
...
void mnoc_hw_v1_52_init(void)
{
	...
	apusys_int_sta_dump_v1_52.reg_val = 0;
	apusys_int_sta_dump_v1_52.timestamp = 0;
