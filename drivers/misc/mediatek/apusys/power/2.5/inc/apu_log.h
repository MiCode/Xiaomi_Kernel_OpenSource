...
#define aclk_debug(dev, fmt, ...) \
	pr_debug("[%s:"APUCLK_PRE"]" fmt, dev_name(dev), ##__VA_ARGS__)
...
#define argul_debug(dev, fmt, ...) \
	pr_debug("[%s:"APURGU_PRE"]" fmt, dev_name(dev), ##__VA_ARGS__)
...
#define aprobe_debug(dev, fmt, ...) \
	pr_debug("[%s:"APUPROBE_PRE"]" fmt, dev_name(dev), ##__VA_ARGS__)
...
#define apower_debug(dev, fmt, ...) \
	pr_debug("[%s:"APUPW_PRE"]" fmt, dev_name(dev), ##__VA_ARGS__)
...
#define arpc_debug(dev, fmt, ...) \
	pr_debug("[%s:"APURPC_PRE"]" fmt, dev_name(dev), ##__VA_ARGS__)
...
#define aspm_debug(dev, fmt, ...) \
	pr_debug("[%s:"APUSPM_PRE"]" fmt, dev_name(dev), ##__VA_ARGS__)
...
#define advfs_debug(dev, fmt, ...) \
	pr_debug("[%s:"APUDVFS_PRE"]" fmt, dev_name(dev), ##__VA_ARGS__)
