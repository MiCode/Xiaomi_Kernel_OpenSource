...
{
	//MNOC/uP PLL
	//uint32_t pll_base_arr[] = {PLL4H_PLL3_CON0};
	uint32_t pll_offset_arr[] = {
				PLL4HPLL_FHCTL_HP_EN, PLL4HPLL_FHCTL_RST_CON,
				PLL4HPLL_FHCTL_CLK_CON, PLL4HPLL_FHCTL2_CFG,
				PLL4H_PLL3_CON1, PLL4HPLL_FHCTL2_DDS};
	int base_arr_size = 1;
...
static void __apu_pll_init(void)
{
	...
	pr_info("%s dbg writel 0x%08x to 0x%08x\n", __func__,
		0xF,
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL_HP_EN);
#endif
	...
	pr_info("%s dbg writel 0x%08x to 0x%08x\n", __func__,
		0xF,
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL_RST_CON);
#endif
	...
	pr_info("%s dbg writel 0x%08x to 0x%08x\n", __func__,
		0xF,
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL_CLK_CON);
#endif
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		(0x1 << 0) | (0x1 << 2),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL0_CFG);
#endif
	apu_setl((0x1 << 0) | (0x1 << 2),
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		(0x1 << 0) | (0x1 << 2),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL1_CFG);
#endif
	apu_setl((0x1 << 0) | (0x1 << 2),
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		(0x1 << 0) | (0x1 << 2),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL2_CFG);
#endif
	apu_setl((0x1 << 0) | (0x1 << 2),
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		(0x1 << 0) | (0x1 << 2),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL3_CFG);
#endif
	...
	apu_clearl(((0x1 << 26) | (0x1 << 25) | (0x1 << 24)),
		apupw.regs[apu_pll]  + PLL4H_PLL1_CON1);
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		...
		apupw.phy_addr[apu_pll] + PLL4H_PLL1_CON1);
#endif
	...
	pr_info("%s dbg writel 0x%08x to 0x%08x\n", __func__,
		((0x1 << 31) | pcw_val),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL0_DDS);
#endif

	get_pll_pcw(pll_freq_out[PLL2], &posdiv_val, &pcw_val);

	apu_clearl(((0x1 << 26) | (0x1 << 25) | (0x1 << 24)),
		apupw.regs[apu_pll]  + PLL4H_PLL2_CON1);
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		((0x1 << 31) | (posdiv_val << 24) | pcw_val),
		apupw.phy_addr[apu_pll] + PLL4H_PLL2_CON1);
#endif
	apu_writel(((0x1 << 31) | pcw_val),
	...
	pr_info("%s dbg writel 0x%08x to 0x%08x\n", __func__,
		((0x1 << 31) | pcw_val),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL1_DDS);
#endif

	get_pll_pcw(pll_freq_out[PLL3], &posdiv_val, &pcw_val);

	apu_clearl(((0x1 << 26) | (0x1 << 25) | (0x1 << 24)),
		apupw.regs[apu_pll]  + PLL4H_PLL3_CON1);
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		((0x1 << 31) | (posdiv_val << 24) | pcw_val),
		apupw.phy_addr[apu_pll] + PLL4H_PLL3_CON1);
#endif
	apu_writel(((0x1 << 31) | pcw_val),
	...
	pr_info("%s dbg writel 0x%08x to 0x%08x\n", __func__,
		((0x1 << 31) | pcw_val),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL2_DDS);
#endif

	get_pll_pcw(pll_freq_out[PLL4], &posdiv_val, &pcw_val);

	apu_clearl(((0x1 << 26) | (0x1 << 25) | (0x1 << 24)),
		apupw.regs[apu_pll]  + PLL4H_PLL4_CON1);
	...
	pr_info("%s dbg setl 0x%08x to 0x%08x\n", __func__,
		((0x1 << 31) | (posdiv_val << 24) | pcw_val),
		apupw.phy_addr[apu_pll] + PLL4H_PLL4_CON1);
#endif
	apu_writel(((0x1 << 31) | pcw_val),
	...
	pr_info("%s dbg writel 0x%08x to 0x%08x\n", __func__,
		((0x1 << 31) | pcw_val),
		apupw.phy_addr[apu_pll] + PLL4HPLL_FHCTL3_DDS);
#endif
...
static void __apu_acc_init(void)
{
	...
	/* Parking clk setting */
	pr_info("Parking clk setting %s %d\n", __func__, __LINE__);
	// CGEN_SOC
...
static int mt6879_apu_top_on(struct device *dev)
{
	int ret = 0;
...
static int mt6879_apu_top_off(struct device *dev)
{
	int ret = 0, val = 0;
...
#else
	mt6879_pwr_flow_remote_sync(1); // tell remote side I am ready to off
#endif
	...
	//mt6879_apu_dump_rpc_status(RCX, NULL);
...
static int init_plat_chip_data(struct platform_device *pdev)
{
	...
	return mt6879_chip_data_remote_sync(&plat_cfg);
}
...
static int mt6879_apu_top_pb(struct platform_device *pdev)
{
#if APU_POWER_INIT
	int ret_clk = 0;
	int ret = 0;
	...
	mt6879_init_remote_data_sync(apupw.regs[apu_md32_mbox]);
	...
	case 1: // power on : RCX_TOP/ACX0_TOP/ACX0_MVPU0
		...
		break;
	case 2: // power on : RCX_TOP/ACX0_TOP/ACX0_MVPU0
		pm_runtime_get_sync(&pdev->dev);
		__apu_wake_rpc_acx(&pdev->dev, ACX0);
		__apu_pwr_ctl_acx_engines(&pdev->dev, ACX0, VPU0, 1);
		break;
	case 3: // power on : RCX_TOP/ACX0_TOP/ACX0_MDLA0/
		pm_runtime_get_sync(&pdev->dev);
		__apu_wake_rpc_acx(&pdev->dev, ACX0);
...
static int mt6879_apu_top_rm(struct platform_device *pdev)
{
	int idx;
...
static void aputop_dump_pwr_res(void)
{
	...
	//mt6879_apu_dump_rpc_status(RCX, NULL);
#if APU_POWER_BRING_UP
	mt6879_apu_dump_rpc_status(ACX0, NULL);
#endif
}
...
static int mt6879_apu_top_func(struct platform_device *pdev,
		enum aputop_func_id func_id, struct aputop_func_param *aputop)
{
	...
	case APUTOP_FUNC_OPP_LIMIT_HAL:
		mt6879_aputop_opp_limit(aputop, OPP_LIMIT_HAL);
		break;
	case APUTOP_FUNC_OPP_LIMIT_DBG:
		mt6879_aputop_opp_limit(aputop, OPP_LIMIT_DEBUG);
		break;
	...
	case APUTOP_FUNC_DRV_CFG:
		mt6879_drv_cfg_remote_sync(aputop);
		break;
...
const struct apupwr_plat_data mt6879_plat_data = {
	.plat_name = "mt6879_apupwr",
	.plat_aputop_on = mt6879_apu_top_on,
	...
	.plat_aputop_dbg_write = mt6879_apu_top_dbg_write,
#endif
	.plat_rpmsg_callback = mt6879_apu_top_rpmsg_cb,
	.bypass_pwr_on = 0,
	.bypass_pwr_off = 0,
};
