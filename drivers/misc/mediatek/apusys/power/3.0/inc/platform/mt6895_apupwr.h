...
#ifndef __MT6895_APUPWR_H__
#define __MT6895_APUPWR_H__
...
#define APU_PWR_SOC_PATH	(1)	// 1: do not run apu pll/acc init
...
#define BUCK_VAPU_PMIC_REG_EN_SET_ADDR	MT6368_PMIC_RG_BUCK_VBUCK4_EN_ADDR_SET
#define BUCK_VAPU_PMIC_REG_EN_CLR_ADDR	MT6368_PMIC_RG_BUCK_VBUCK4_EN_ADDR_CLR
#define BUCK_VAPU_PMIC_REG_EN_SHIFT	MT6368_PMIC_RG_BUCK_VBUCK4_EN_SHIFT
