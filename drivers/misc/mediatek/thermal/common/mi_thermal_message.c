...
/* N17 code for HQ-295011 by wangshuai at 2023/07/25 start */
static atomic_t modem_limit = ATOMIC_INIT(0);
/* N17 code for HQ-295011 by wangshuai at 2023/07/25 end */
		 ...
		 size_t len)
{
	unsigned int cpu;
	unsigned int max;
 /*N17 code for HQHW-4095 by p-shenzhengang at 2023/6/7 start*/
	unsigned int cpu_cluster = 0;
	struct cpu_topology *cpu_topo;
 /*N17 code for HQHW-4095 by p-shenzhengang at 2023/6/7 end*/
 ...
 /*N17 code for HQHW-4095 by p-shenzhengang at 2023/6/7 start*/
	...
	cpu_cluster = cpu_topo->package_id < 0 ? 0 : cpu_topo ->package_id;
	pr_info("%s: cpu%u is belong to %u cluster.\n", __func__, cpu, cpu_cluster);

	mt_ppm_sysboost_set_freq_limit(BOOST_BY_XM_THERMAL, cpu_cluster, -1, max);
 /*N17 code for HQHW-4095 by p-shenzhengang at 2023/6/7 end*/
	return len;
}
