			     ...
			     loff_t *data)
{
	...
	if (sscanf
		...
		tsallts_dprintk("[tsallts_write2] g_THERMAL_TRIP_0=%d,g_THERMAL_TRIP_1=%d,g_THERMAL_TRIP_2=%d,",
		...
		tsallts_dprintk("[tsallts_write2] cooldev0=%s,cooldev1=%s,cooldev2=%s,cooldev3=%s,",
