...
//add by xujia for add backlight ntc begin
#define AUX_IN4_NTC (4)
//add by xujia for add backlight ntc end
...
#define BTS_BLKNTC_RAP_NTC_TABLE			7			/* default is NCP15WF104F03RC(100K) */
#define BTS_BLKNTC_RAP_ADC_CHANNEL			AUX_IN4_NTC	/* default is 1 */
//add by xujia for add backlight ntc end
