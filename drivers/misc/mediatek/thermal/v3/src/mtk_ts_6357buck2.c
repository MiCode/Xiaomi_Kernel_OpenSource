...
static int mt6357tsbuck2_change_mode(struct thermal_zone_device *thermal,
...
static struct thermal_zone_device_ops mt6357tsbuck2_dev_ops = {
	...
	.change_mode = mt6357tsbuck2_change_mode,
...
static const struct proc_ops mt6357tsbuck2_fops = {
	.proc_open = mt6357tsbuck2_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mt6357tsbuck2_write,
...
int mt6357tsbuck2_init(void)
{
	return platform_driver_register(&mt6357_ts_buck2_driver);
}

void mt6357tsbuck2_exit(void)
{
	mtktspmic_info("[%s]\n", __func__);
	mt6357tsbuck2_unregister_thermal();
	mt6357tsbuck2_unregister_cooler();
