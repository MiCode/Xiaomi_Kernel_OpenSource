...
static long long mt6357tsbuck1_cur_temp;
/*
...
static int mt6357tsbuck1_change_mode(struct thermal_zone_device *thermal, enum thermal_device_mode mode)
{
	kernelmode = mode;
	return 0;
}
...
static struct thermal_zone_device_ops mt6357tsbuck1_dev_ops = {
	...
	.change_mode = mt6357tsbuck1_change_mode,
...
static const struct proc_ops mt6357tsbuck1_fops = {
	.proc_open = mt6357tsbuck1_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mt6357tsbuck1_write,
...
int mt6357tsbuck1_init(void)
{
	return platform_driver_register(&mt6357_ts_buck1_driver);
}
void mt6357tsbuck1_exit(void)
{
