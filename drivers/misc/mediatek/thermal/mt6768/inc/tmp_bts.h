...
#define CPUM_RAP_PULL_UP_R		22000 /* 22K, pull up resister */
#define CPUM_TCPU_OVER_CRITICAL_LOW		4397119 /* base on 100K NTC temp
							* default value -40 deg
							*/
#define CPUM_RCPU_PULL_UP_VOLTAGE    1800 /* 1.8V ,pull up voltage */
#define CPUM_RCPU_NTC_TABLE         7 /* default is NCP15WF104F03RC(100K) */
#define CPUM_RCPU_ADC_CHANNEL			AUX_IN0_NTC /* default is 0 */
