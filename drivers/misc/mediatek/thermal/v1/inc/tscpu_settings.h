...
#define CONFIG_LVTS_ERROR_AEE_WARNING (0)
#endif
#define LVTS_REFINE_MANUAL_RCK_WITH_EFUSE  (0)
...
struct thermal_controller {
	enum tsmcu_sensor_enum ts[TS_ENUM_MAX];
	int ts_number;
...
#endif
extern struct platform_device *lvts_dev;
...
extern int lvts_registers_ready(void);
