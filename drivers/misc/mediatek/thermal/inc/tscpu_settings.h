...
/*
 * 1 mt6768 TS_CON0 default is 2'b00, this is buffer off
...
/*
 * Please set TS_CON0[29:28]=2'b00 before perform thermal measurement.
 * It requires 100uS wait time
 *
 * After measurement is finished, Write TSCON0[29:28] =2'b11(turn off buffer)
 */
#define TS_TURN_OFF		0x30000000	/* turn off thermal*/

/* chip dependent */
/* TODO: change to new reg addr. */
#define ADDRESS_INDEX_0  1
...
/* TSCON0 bit table */
#define TSCON0bit28_29_00   0x00000000  /* TSCON0[28:29]=2'b00*/
#define TSCON0bit28_29_01   0x10000000  /* TSCON0[28:29]=2'b01*/
#define TSCON0bit28_29_10   0x20000000  /* TSCON0[28:29]=2'b10*/
#define TSCON0bit28_29_11   0x30000000  /* TSCON0[28:29]=2'b11*/
#define TSCON0bit28_29_MASK 0x30000000


/* TSCON1 bit table */
#define TSCON1_bit_0_3_0000 0x00  /*TSCON1[3:0]=3'b0000*/
#define TSCON1_bit_0_3_0001 0x01  /*TSCON1[3:0]=3'b0001*/
#define TSCON1_bit_0_3_0010 0x02  /*TSCON1[3:0]=3'b0010*/
#define TSCON1_bit_0_3_0011 0x03  /*TSCON1[3:0]=3'b0011*/
#define TSCON1_bit_0_3_0100 0x04  /*TSCON1[3:0]=3'b0100*/
#define TSCON1_bit_0_3_0101 0x05  /*TSCON1[3:0]=3'b0101*/
#define TSCON1_bit_0_3_0110 0x06  /*TSCON1[3:0]=3'b0110*/
#define TSCON1_bit_0_3_0111 0x07  /*TSCON1[3:0]=3'b0111*/
#define TSCON1_bit_0_3_MASK 0x07


/* ADC value to mcu */
/*chip dependent*/
#define TEMPADC_MCU1 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0000))
#define TEMPADC_MCU2 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0001))
#define TEMPADC_MCU3 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0010))
#define TEMPADC_MCU4 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0011))
#define TEMPADC_MCU5 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0100))
#define TEMPADC_MCU6 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0101))
#define TEMPADC_MCU7 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0110))
#define TEMPADC_MCU8 ((0x30000000&TSCON0bit28_29_00)|(0x07&TSCON1_bit_0_3_0111))
//#define TEMPADC_ABB     ((0x30&TSCON1_bit_4_5_01)|(0x07&TSCON1_bit_0_3_000))
...
extern void tscpu_thermal_cal_prepare(struct platform_device *dev);
