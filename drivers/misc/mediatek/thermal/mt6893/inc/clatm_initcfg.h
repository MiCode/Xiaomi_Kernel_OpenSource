...
#define CLATM_INIT_CFG_0_MIN_CPU_PWR		(700)
#define CLATM_INIT_CFG_0_MAX_CPU_PWR		(5000)
#define CLATM_INIT_CFG_0_MIN_GPU_PWR		(400)
...
#define CLATM_INIT_CFG_1_MIN_GPU_PWR		(300)
#define CLATM_INIT_CFG_1_MAX_GPU_PWR		(2000)

#define CLATM_INIT_CFG_2_TARGET_TJ		(55000)
...
#define CLATM_INIT_CFG_2_MAX_CPU_PWR		(3000)
...
#define CLCTM_TARGET_TJ				(95000)
#define CLCTM_TPCB_1				(47000)
#define CLCTM_TPCB_2				(56000)
