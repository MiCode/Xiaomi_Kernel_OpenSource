...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM mtk_interconnect

#if !defined(_TRACE_MTK_INTERCONNECT_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_MTK_INTERCONNECT_H
...
TRACE_EVENT(mtk_icc_set_bw_end,
...
#endif /* _TRACE_MTK_INTERCONNECT_H */
