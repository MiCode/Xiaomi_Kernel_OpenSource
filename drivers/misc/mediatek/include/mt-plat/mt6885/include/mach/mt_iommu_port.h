...
int mtk_iommu_larb_distance[] = {
	0, 13, 26, 32, 38, //0~4
	49, -1, 57, 84, 111, //5~9
	-1, 140, -1, 169, 181, //10~14
	-1, 187, 202, 217, 232,//15~19
	236, 242, 244, 245 //20~23
};
...
struct mtk_iommu_port iommu_port[] = {
	...
	MTK_IOMMU_PORT_INIT("L0_DISP_RDMA2", 0,
	...
	MTK_IOMMU_PORT_INIT("L1_UFBDC_RDMA1", 0,
		SLAVE_L1, 1, TF_LARB_L1, 1),
	MTK_IOMMU_PORT_INIT("L1_UFBDC_RDMA3", 0,
	...
	MTK_IOMMU_PORT_INIT("L1_OVL_2L_RDMA3_HDR", 0,
	...
	MTK_IOMMU_PORT_INIT("L1_OVL_2L_RDMA3", 0,
	...
	MTK_IOMMU_PORT_INIT("L1_DISP_RDMA3", 0,
	...
	MTK_IOMMU_PORT_INIT("L9_IMG_UFOYW_MDP", 1,
		SLAVE_L9, 9, TF_LARB_L9, 9),
	MTK_IOMMU_PORT_INIT("L9_IMG_UFOCW_MDP", 1,
		SLAVE_L9, 9, TF_LARB_L9, 10),
	MTK_IOMMU_PORT_INIT("L9_IMG_UFOYR_MDP", 1,
		SLAVE_L9, 9, TF_LARB_L9, 11),
	MTK_IOMMU_PORT_INIT("L9_IMG_UFOCR_MDP", 1,
		SLAVE_L9, 9, TF_LARB_L9, 12),
	MTK_IOMMU_PORT_INIT("L9_IMG_UFOY2R_MDP", 1,
		SLAVE_L9, 9, TF_LARB_L9, 13),
	MTK_IOMMU_PORT_INIT("L9_IMG_UFOC2R_MDP", 1,
	...
	MTK_IOMMU_PORT_INIT("L9_IMG_PVRYR_MDP", 1,
		SLAVE_L9, 9, TF_LARB_L9, 19),
	MTK_IOMMU_PORT_INIT("L9_IMG_PVRCR_MDP", 1,
	...
	MTK_IOMMU_PORT_INIT("L11_IMG_UFOYW_DISP", 0,
		SLAVE_L11, 11, TF_LARB_L11, 9),
	MTK_IOMMU_PORT_INIT("L11_IMG_UFOCW_DISP", 0,
		SLAVE_L11, 11, TF_LARB_L11, 10),
	MTK_IOMMU_PORT_INIT("L11_IMG_UFOYR_DISP", 0,
		SLAVE_L11, 11, TF_LARB_L11, 11),
	MTK_IOMMU_PORT_INIT("L11_IMG_UFOCR_DISP", 0,
		SLAVE_L11, 11, TF_LARB_L11, 12),
	MTK_IOMMU_PORT_INIT("L11_IMG_UFOY2R_DISP", 0,
		SLAVE_L11, 11, TF_LARB_L11, 13),
	MTK_IOMMU_PORT_INIT("L11_IMG_UFOC2R_DISP", 0,
	...
	MTK_IOMMU_PORT_INIT("L11_IMG_PVRYR_DISP", 0,
		SLAVE_L11, 11, TF_LARB_L11, 19),
	MTK_IOMMU_PORT_INIT("L11_IMG_PVRCR_DISP", 0,
	...
	MTK_IOMMU_PORT_INIT("L16_CAM_RAWI_R5_A_MDP", 1,
	...
	MTK_IOMMU_PORT_INIT("L17_CAM_RAWI_R5_B_DISP", 0,
	...
	MTK_IOMMU_PORT_INIT("L18_CAM_RAWI_R5_C_MDP", 1,
