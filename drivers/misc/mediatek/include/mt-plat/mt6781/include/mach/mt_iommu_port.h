...
int mtk_iommu_larb_distance[] = {
	...
	-1, -1, 28, -1, 41, //5~9
	-1, 70, -1, 99, 111, //10~14
	-1, 117, 134, 151, 168,//15~19
	172, 178, 181, 182 //20~23
};
...
struct mtk_iommu_port iommu_port[] = {
	...
	MTK_IOMMU_PORT_INIT("L4_MINI_MDP_R0_EXT", 0,
		SLAVE_L4, 4, TF_LARB_L4, 12),
	MTK_IOMMU_PORT_INIT("L4_MINI_MDP_W0_EXT", 0,
		SLAVE_L4, 4, TF_LARB_L4, 13),
	/* Larb7 --13(41) */
