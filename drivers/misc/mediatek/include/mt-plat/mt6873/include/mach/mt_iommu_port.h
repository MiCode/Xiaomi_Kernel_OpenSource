...
int mtk_iommu_larb_distance[] = {
	0, 6, 14, -1, 19, //0~4
	30, -1, 38, 53, 80, //5~9
	-1, 109, -1, 138, 150, //10~14
	-1, 156, 173, 190, 207,//15~19
	211, 217, 220, 221 //20~23
};
...
struct mtk_iommu_port iommu_port[] = {
	...
	MTK_IOMMU_PORT_INIT("L1_DISP_MDP_RDMA4", 0,
		SLAVE_L1, 1, TF_LARB_L1, 4),
	MTK_IOMMU_PORT_INIT("L1_DISP_RDMA4", 0,
		SLAVE_L1, 1, TF_LARB_L1, 5),
	MTK_IOMMU_PORT_INIT("L1_DISP_UFBC_WDMA0", 0,
	...
	MTK_IOMMU_PORT_INIT("L4_VDEC_VLD2_EXT_", 0,
		SLAVE_L4, 4, TF_LARB_L4, 8),
	MTK_IOMMU_PORT_INIT("L4_VDEC_AVC_MV_EXT_", 0,
	...
	MTK_IOMMU_PORT_INIT("L5_VDEC_LAT0_AVC_MV_EXT", 0,
		SLAVE_L5, 5, TF_LARB_L5, 2),
	MTK_IOMMU_PORT_INIT("L5_VDEC_LAT0_PRED_RD_EXT", 0,
		SLAVE_L5, 5, TF_LARB_L5, 3),
	MTK_IOMMU_PORT_INIT("L5_VDEC_LAT0_TILE_EXT", 0,
		SLAVE_L5, 5, TF_LARB_L5, 4),
	MTK_IOMMU_PORT_INIT("L5_VDEC_LAT0_WDMA_EXT", 0,
		SLAVE_L5, 5, TF_LARB_L5, 5),
	MTK_IOMMU_PORT_INIT("L5_VDEC_LAT0_RG_CTRL_DMA_EXT", 0,
	...
	MTK_IOMMU_PORT_INIT("L7_JPGENC_Q_RDMA", 0,
		SLAVE_L7, 7, TF_LARB_L7, 10),
	MTK_IOMMU_PORT_INIT("L7_JPGENC_C_TABLE", 0,
		SLAVE_L7, 7, TF_LARB_L7, 11),
	MTK_IOMMU_PORT_INIT("L7_JPGENC_BSDMA", 0,
		SLAVE_L7, 7, TF_LARB_L7, 12),
	MTK_IOMMU_PORT_INIT("L7_VENC_SUB_R_LUMA", 0,
	...
	MTK_IOMMU_PORT_INIT("L8_VENC_BSDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 2),
	MTK_IOMMU_PORT_INIT("L8_VENC_SUB_W_LUMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 3),
	MTK_IOMMU_PORT_INIT("L8_VENC_SV_COMV", 0,
		SLAVE_L8, 8, TF_LARB_L8, 4),
	MTK_IOMMU_PORT_INIT("L8_VENC_RD_COMV", 0,
		SLAVE_L8, 8, TF_LARB_L8, 5),
	MTK_IOMMU_PORT_INIT("L8_VENC_NBM_RDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 6),
	MTK_IOMMU_PORT_INIT("L8_VENC_NBM_RDMA_LITE", 0,
		SLAVE_L8, 8, TF_LARB_L8, 7),
	MTK_IOMMU_PORT_INIT("L8_VENC_FCS_NBM_RDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 8),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_Y_RDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 9),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_C_RDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 10),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_Q_TABLE", 0,
		SLAVE_L8, 8, TF_LARB_L8, 11),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_BSDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 12),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_HUFF_OFFSET0", 0,
		SLAVE_L8, 8, TF_LARB_L8, 13),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_WDMA0", 0,
		SLAVE_L8, 8, TF_LARB_L8, 14),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_BSDMA0", 0,
		SLAVE_L8, 8, TF_LARB_L8, 15),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_HUFF_OFFSET1", 0,
		SLAVE_L8, 8, TF_LARB_L8, 16),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_WDMA1", 0,
		SLAVE_L8, 8, TF_LARB_L8, 17),
	MTK_IOMMU_PORT_INIT("L8_JPGENC_BSDMA1", 0,
		SLAVE_L8, 8, TF_LARB_L8, 18),
	MTK_IOMMU_PORT_INIT("L8_VENC_NBM_WDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 19),
	MTK_IOMMU_PORT_INIT("L8_VENC_NBM_WDMA_LITE", 0,
		SLAVE_L8, 8, TF_LARB_L8, 20),
	MTK_IOMMU_PORT_INIT("L8_VENC_FCS_NBM_WDMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 21),
	MTK_IOMMU_PORT_INIT("L8_VENC_SUB_R_LUMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 22),
	MTK_IOMMU_PORT_INIT("L8_VENC_CUR_LUMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 23),
	MTK_IOMMU_PORT_INIT("L8_VENC_CUR_CHROMA", 0,
		SLAVE_L8, 8, TF_LARB_L8, 24),
	MTK_IOMMU_PORT_INIT("L8_VENC_REF_LUMA", 0,
	...
	MTK_IOMMU_PORT_INIT("L13_CAM_CAMSV1", 0,
		SLAVE_L13, 13, TF_LARB_L13, 3),
	MTK_IOMMU_PORT_INIT("L13_CAM_CAMSV2", 0,
		SLAVE_L13, 13, TF_LARB_L13, 4),
	MTK_IOMMU_PORT_INIT("L13_CAM_CAMSV3", 0,
	...
	MTK_IOMMU_PORT_INIT("L14_CAM_CAMSV0", 0,
