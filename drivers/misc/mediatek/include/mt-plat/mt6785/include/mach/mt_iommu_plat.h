...
char *smi_clk_name[MTK_IOMMU_LARB_NR] = {
	"iommu_disp_larb0", "iommu_disp_larb1", "iommu_disp_larb2",
	"iommu_disp_larb3", "iommu_null_larb4", "iommu_disp_larb5",
	"iommu_disp_larb6", "iommu_null_larb7", "iommu_null_larb8",
};

unsigned int port_size_not_aligned[] = {
	M4U_PORT_VPU,
};
const char *smi_larb_id = "mediatek,smi-id";
...
#define F_MMU_PT_BASE_ADDR_BIT32	F_MSK(1, 0)
...
#define F_RP_PA_REG_BIT32    F_MSK(1, 0)
...
#endif
#define F_MMU_FAULT_PA_BIT32   F_MSK(7, 6)
...
#if (CONFIG_MTK_IOMMU_PGTABLE_EXT > 32)
#define F_MMU_RS_VA_BIT32	F_MSK(1, 0)
#endif
...
const struct mtk_iova_domain_data mtk_domain_array[MTK_IOVA_DOMAIN_COUNT] = {
	...
	{ // boundary(0~4GB) IOVA space for OVL
	 ...
	 .port_mask = {0x1ff, 0x3fff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
#else
	...
	{ // boundary(4GB~8GB) IOVA space for CODEC
	 ...
	 .resv_type = IOVA_REGION_UNDEFINE,
	 .port_mask = {0x0, 0x0, 0xfff, 0x7ffff,
			0x0, 0x3ffffff, 0x7fee7fff, 0x8},
	},
	...
	{ //CCU IOVA space
	 ...
	 .resv_type = IOVA_REGION_UNDEFINE,
	 .port_mask = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x118000, 0x3},
	},
	{ //VPU CODE IOVA space
	 .boundary = 3,
	 ...
	 .resv_type = IOVA_REGION_UNDEFINE,
	 .port_mask = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4},
	},
};

#else
#define RESERVED_IOVA_ADDR_CCU (0x40000000U)
#define RESERVED_IOVA_SIZE_CCU (0x8000000U)
#define RESERVED_IOVA_ADDR_APU_CODE (0x7da00000U)
#define RESERVED_IOVA_SIZE_APU_CODE (0x4c00000U)
#define RESERVED_IOVA_ADDR_APU_DATA (0x7fc00000U)
#define RESERVED_IOVA_SIZE_APU_DATA (0x500000U)
const struct mtk_iova_domain_data mtk_domain_array[MTK_IOVA_DOMAIN_COUNT] = {
#if (defined(CONFIG_MTK_SEC_VIDEO_PATH_SUPPORT) || \
	defined(CONFIG_MTK_CAM_SECURITY_SUPPORT))
	{
	 ...
	 .resv_type = IOVA_REGION_UNDEFINE,
	 .port_mask = {0x1ff, 0x3fff, 0xfff, 0x7ffff,
			0x0, 0x3ffffff, 0x7fee7fff, 0x0, 0x2},
	},
#else
	{
	 .min_iova = SZ_4K,
...
#endif
	{
	 ...
	 .max_iova = RESERVED_IOVA_ADDR_CCU +
			RESERVED_IOVA_SIZE_CCU - 1,
	 .resv_type = IOVA_REGION_UNDEFINE,
	 .port_mask = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x118000, 0x3, 0x0},
	},
	{
	 .min_iova = RESERVED_IOVA_ADDR_APU_CODE,
	 .max_iova = RESERVED_IOVA_ADDR_APU_CODE +
			RESERVED_IOVA_SIZE_APU_CODE - 1,
	 .resv_type = IOVA_REGION_UNDEFINE,
	 .port_mask = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1},
	}
};
#endif
