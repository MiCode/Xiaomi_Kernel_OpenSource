						   ...
						   char *test_desc)
{
	...
	ret = tmem_core_alloc_chunk(TRUSTED_MEM_SVP, 0, SIZE_64K,
	...
	ret = tmem_core_alloc_chunk(TRUSTED_MEM_2D_FR, 0, SIZE_64K,
				    &fr_ref_count, &fr_handle, NULL, 0, 0);
	...
	ret = tmem_core_alloc_chunk(TRUSTED_MEM_PROT, 0, SIZE_64K,
