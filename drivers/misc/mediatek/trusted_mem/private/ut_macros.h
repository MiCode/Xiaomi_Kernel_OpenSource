...
#define fr_minmal_chunk_size() tmem_core_get_min_chunk_size(TRUSTED_MEM_2D_FR)
#define fr_session_open() tmem_core_session_open(TRUSTED_MEM_2D_FR)
#define fr_session_close() tmem_core_session_close(TRUSTED_MEM_2D_FR)
#define fr_ssmr_allocate() tmem_core_ssmr_allocate(TRUSTED_MEM_2D_FR)
#define fr_ssmr_release() tmem_core_ssmr_release(TRUSTED_MEM_2D_FR)
#define fr_alloc_chunk(...)                                                    \
	tmem_core_alloc_chunk(TRUSTED_MEM_2D_FR, ##__VA_ARGS__)
#define fr_unref_chunk(...)                                                    \
	tmem_core_unref_chunk(TRUSTED_MEM_2D_FR, ##__VA_ARGS__)
#define fr_is_regmgr_region_on()                                               \
	tmem_core_is_regmgr_region_on(TRUSTED_MEM_2D_FR)
#define fr_get_regmgr_region_online_cnt()                                      \
	tmem_core_get_regmgr_region_online_cnt(TRUSTED_MEM_2D_FR)
#define fr_get_regmgr_region_ref_cnt()                                         \
	tmem_core_get_regmgr_region_ref_cnt(TRUSTED_MEM_2D_FR)
#define fr_regmgr_online() tmem_core_regmgr_online(TRUSTED_MEM_2D_FR)
#define fr_regmgr_offline() tmem_core_regmgr_offline(TRUSTED_MEM_2D_FR)
#define is_fr_registered() tmem_core_is_device_registered(TRUSTED_MEM_2D_FR)
