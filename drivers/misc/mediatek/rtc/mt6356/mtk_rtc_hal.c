...
void rtc_enable_k_eosc(void)
{
	...
	/* Set RTC_EMBCK_SEL_EOSC setting but RTC_EMBCK_SEL_K_EOSC
	 *is for HW hard code bug
	 */
	rtc_xosc_write((osc32 & ~RTC_EMBCK_SEL_HW) | RTC_EMBCK_SEL_EOSC |
		       RTC_EMBCK_SRC_SEL, true);
