...
#define	PMIC_SPAR_SW_MASK				0x1
#define	PMIC_RESET_SPAR_SHIFT			2
#define	PMIC_RESET_SPAR_MASK			0x1
#define	PMIC_RESET_ALARM_SHIFT			3
#define	PMIC_RESET_ALARM_MASK			0x1

/* RTC registers */
#define RTC_BBPU					(PMIC_BBPU_ADDR)
#define RTC_BBPU_PWREN \
	(PMIC_PWREN_MASK << PMIC_PWREN_SHIFT)
#define RTC_BBPU_SPAR_SW \
	(PMIC_SPAR_SW_MASK << PMIC_SPAR_SW_SHIFT)
#define RTC_BBPU_RESET_SPAR \
	(PMIC_RESET_SPAR_MASK << PMIC_RESET_SPAR_SHIFT)
#define RTC_BBPU_RESET_ALARM \
	(PMIC_RESET_ALARM_MASK << PMIC_RESET_ALARM_SHIFT)
...
#define RTC_BBPU_2SEC_MODE_MSK \
	(PMIC_BBPU_2SEC_MODE_MASK << PMIC_BBPU_2SEC_MODE_SHIFT)
#define RTC_BBPU_2SEC_MODE_SHIFT \
...
#define RTC_AL_MIN_MASK	(PMIC_AL_MINUTE_MASK << PMIC_AL_MINUTE_SHIFT)
...
#define RTC_CALI_MASK		(PMIC_RTC_CALI_MASK << PMIC_RTC_CALI_SHIFT)
...
#define RTC_CON_F32KOB		(PMIC_F32KOB_MASK << PMIC_F32KOB_SHIFT)
...
/* 32K was stopped */
#define RTC_CON_LPSTA_RAW	(PMIC_LPSTA_RAW_MASK << PMIC_LPSTA_RAW_SHIFT)
