...
static int __init ssc_v1_init(void)
{
	int ret;
...
static void __exit ssc_v1_exit(void)
{
...
module_init(ssc_v1_init);
module_exit(ssc_v1_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("ssc v1 debug module");
