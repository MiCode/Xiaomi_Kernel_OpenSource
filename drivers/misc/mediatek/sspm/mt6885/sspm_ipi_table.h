...
/* the following will use mbox 0 */
	{0, IPIS_C_SPM_SUSPEND_OUT_OFFSET, 1, 0, IPIS_C_SPM_SUSPEND_OUT_SIZE,
...
/* the following will use mbox 1 */
	{1, IPIS_C_THERMAL_OUT_OFFSET, 1, 0, IPIS_C_THERMAL_OUT_SIZE,
	 IPIS_C_THERMAL_OUT_OFFSET, IPIS_C_THERMAL,
	 { { 0 } }, { 0 }, { { { { 0 } } } } },
	{1, IPIS_C_GPU_DVFS_OUT_OFFSET, 1, 0, IPIS_C_GPU_DVFS_OUT_SIZE,
