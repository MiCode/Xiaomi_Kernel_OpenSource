...
#define ACCDET_CON02                                                           \
	((unsigned int)(ACCDET_BASE + 0x230C)) /* ACCDET_STATE_SWCTRL */
#define ACCDET_CON03                                                           \
	((unsigned int)(ACCDET_BASE + 0x230E)) /* ACCDET_PWM_WIDTH */
#define ACCDET_CON04                                                           \
	((unsigned int)(ACCDET_BASE + 0x2310)) /* ACCDET_PWM_THRESH */
#define ACCDET_CON05                                                           \
	((unsigned int)(ACCDET_BASE + 0x2312)) /* ACCDET_EN_DELAY_NUM */
#define ACCDET_CON06                                                           \
	((unsigned int)(ACCDET_BASE + 0x2314)) /* ACCDET_DEBOUNCE0 */
#define ACCDET_CON07                                                           \
	((unsigned int)(ACCDET_BASE + 0x2316)) /* ACCDET_DEBOUNCE1 */
#define ACCDET_CON08                                                           \
	((unsigned int)(ACCDET_BASE + 0x2318)) /* ACCDET_DEBOUNCE2 */
#define ACCDET_CON09                                                           \
	((unsigned int)(ACCDET_BASE + 0x231A)) /* ACCDET_DEBOUNCE3 */
#define ACCDET_CON10                                                           \
	((unsigned int)(ACCDET_BASE + 0x231C)) /* ACCDET_DEBOUNCE4 */
#define ACCDET_CON11                                                           \
	((unsigned int)(ACCDET_BASE + 0x231E)) /* ACCDET_DEFAULT_STATUS */
#define ACCDET_CON12                                                           \
	((unsigned int)(ACCDET_BASE + 0x2320)) /* ACCDET_IRQ_STATUS */
#define ACCDET_CON13                                                           \
	((unsigned int)(ACCDET_BASE + 0x2322)) /* ACCDET_SW_CONTROL */
#define ACCDET_CON14                                                           \
	((unsigned int)(ACCDET_BASE + 0x2324)) /* ACCDET_STATE_RG */
#define ACCDET_CON15                                                           \
	((unsigned int)(ACCDET_BASE + 0x2326)) /* ACCDET_EINT0_CONTROL */
#define ACCDET_CON16                                                           \
	((unsigned int)(ACCDET_BASE + 0x2328)) /* ACCDET_EINT0_PWM_DELAY */
#define ACCDET_CON17                                                           \
	((unsigned int)(ACCDET_BASE + 0x232A)) /* ACCDET_TEST_DEBUG */
#define ACCDET_CON18                                                           \
	((unsigned int)(ACCDET_BASE + 0x232C)) /* ACCDET_EINT0_FSM_STATE */
#define ACCDET_CON19 ((unsigned int)(ACCDET_BASE + 0x232E)) /* ACCDET_CUR_DEB*/
#define ACCDET_CON20                                                           \
	((unsigned int)(ACCDET_BASE + 0x2330)) /* ACCDET_EINT0_CUR_DEB */
#define ACCDET_CON21                                                           \
	((unsigned int)(ACCDET_BASE + 0x2332)) /* ACCDET_MONITOR_FLAG */
#define ACCDET_CON22                                                           \
	((unsigned int)(ACCDET_BASE + 0x2334)) /* ACCDET_RSV_CON1 */
#define ACCDET_CON23                                                           \
	((unsigned int)(ACCDET_BASE + 0x2336)) /* ACCDET_AUXADC_CONNECT_TIME */
#define ACCDET_CON24 ((unsigned int)(ACCDET_BASE + 0x2338)) /* ACCDET_HW_SET*/
#define ACCDET_CON25                                                           \
	((unsigned int)(ACCDET_BASE + 0x233A)) /* ACCDET_EINT1_CONTROL */
#define ACCDET_CON26                                                           \
	((unsigned int)(ACCDET_BASE + 0x233C)) /* ACCDET_EINT1_PWM_DELAY */
#define ACCDET_CON27                                                           \
	((unsigned int)(ACCDET_BASE + 0x233E)) /* ACCDET_EINT1_FSM_STATE */
#define ACCDET_CON28                                                           \
	((unsigned int)(ACCDET_BASE + 0x2340)) /* ACCDET_EINT1_CUR_DEB */
#if 0
...
/* analog RG */
#define AUDENC_ANA_CON6                                                        \
	((unsigned int)(ACCDET_BASE + 0x2194)) /* ACCDET_FAST_DISCHARGE_REG */
#define AUDENC_ANA_CON9                                                        \
	((unsigned int)(ACCDET_BASE + 0x219A)) /* ACCDET_MOISTURE_REG */
#define AUDENC_ANA_CON10                                                       \
	((unsigned int)(ACCDET_BASE + 0x219C)) /* ACCDET_MICBIAS_REG */
#define AUDENC_ANA_CON11                                                       \
	((unsigned int)(ACCDET_BASE + 0x219E)) /* ACCDET_ADC_REG */
/* efuse RG */
#define AUXADC_RQST0                                                           \
	((unsigned int)(ACCDET_BASE + 0x110E)) /* AUXADC_CHN_RQST0 */
#define AUXADC_RQST0_SET                                                       \
	((unsigned int)(ACCDET_BASE + 0x1110)) /* AUXADC_RQST0_CH_SET */
#define AUXADC_RQST0_CLR                                                       \
	((unsigned int)(ACCDET_BASE + 0x1112)) /* AUXADC_RQST0_CH_CLR */
#define AUXADC_ACCDET                                                          \
	((unsigned int)(ACCDET_BASE + 0x1198)) /* ACCDET_AUXADC_AUTO_SPL */
#define AUXADC_ADC5                                                            \
	((unsigned int)(ACCDET_BASE + 0x1092)) /* ACCDET_AUXADC_REG CH5 */
#define AUXADC_CON2                                                            \
	((unsigned int)(ACCDET_BASE + 0x1128)) /* AUXADC_AVG_NUM_SEL */

#define PMIC_REG_BASE_START                                                    \
	((unsigned int)(0x0000)) /* MT6357 register base address start */
#define PMIC_REG_BASE_END                                                      \
	((unsigned int)(ACCDET_BASE +                                          \
			0x2340)) /* MT6357 register base address end */
...
#define AUXADC_ACCDET_AUTO_SPL_DISEN                                           \
	(0x00 << 0) /* ACCDET auto request disable */
...
#define ACCDET_EINT_IVAL_SEL                                                   \
	(ACCDET_EINT0_IVAL_SEL_B14 | ACCDET_EINT1_IVAL_SEL_B15)
...
#define RG_MBIAS_MODE_6                                                        \
	(RG_AUD_MBIAS1_DC_SW_1P | RG_AUD_MBIAS1_DC_SW_3P)/* mic_bias_mode= 6*/
...
#define RG_MICBIAS1_LOWPEN_OUTVOL                                              \
	(RG_MBIAS_LOWPOWER_EN | RG_MBIAS_OUTPUT_2V7) /* add */
