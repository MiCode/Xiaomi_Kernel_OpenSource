...
static const struct mtk_iommu_port mm_port_mt6893[] = {
	...
	MM_IOMMU_PORT_INIT("L2_MDP_WROT0", 1,
		2, 0x0, 2),
	MM_IOMMU_PORT_INIT("L2_MDP_WROT1", 1,
		2, 0x0, 3),
	MM_IOMMU_PORT_INIT("L2_MDP_DISP_FAKE0", 1,
		2, 0x0, 4),
	/*Larb4 */
	MM_IOMMU_PORT_INIT("L4_VDEC_MC_EXT", 1,
		4, 0x8, 0),
	MM_IOMMU_PORT_INIT("L4_VDEC_UFO_EXT", 1,
		4, 0x8, 1),
	MM_IOMMU_PORT_INIT("L4_VDEC_PP_EXT", 1,
		4, 0x8, 2),
	MM_IOMMU_PORT_INIT("L4_VDEC_PRED_RD_EXT", 1,
		4, 0x8, 3),
	MM_IOMMU_PORT_INIT("L4_VDEC_PRED_WR_EXT", 1,
		4, 0x8, 4),
	MM_IOMMU_PORT_INIT("L4_VDEC_PPWRAP_EXT", 1,
		4, 0x8, 5),
	MM_IOMMU_PORT_INIT("L4_VDEC_TILE_EXT", 1,
		4, 0x8, 6),
	MM_IOMMU_PORT_INIT("L4_VDEC_VLD_EXT", 1,
		4, 0x8, 7),
	MM_IOMMU_PORT_INIT("L4_VDEC_VLD2_EXT", 1,
		4, 0x8, 8),
	MM_IOMMU_PORT_INIT("L4_VDEC_AVC_MV_EXT", 1,
		4, 0x8, 9),
	MM_IOMMU_PORT_INIT("L4_VDEC_RG_CTRL_DMA_EXT", 1,
		4, 0x8, 10),
	/*Larb5 */
	MM_IOMMU_PORT_INIT("L5_VDEC_LAT0_VLD_EXT", 0,
		5, 0x8, 0),
	MM_IOMMU_PORT_INIT("L5_VDEC_LAT0_VLD2_EXT", 0,
		5, 0x8, 1),
	MM_IOMMU_PORT_INIT("L5_VDEC_LAT0_AVC_MV_EXT", 0,
		5, 0x8, 2),
	MM_IOMMU_PORT_INIT("L5_VDEC_LAT0_PRED_RD_EXT", 0,
		5, 0x8, 3),
	MM_IOMMU_PORT_INIT("L5_VDEC_LAT0_TILE_EXT", 0,
		5, 0x8, 4),
	MM_IOMMU_PORT_INIT("L5_VDEC_LAT0_WDMA_EXT", 0,
		5, 0x8, 5),
	MM_IOMMU_PORT_INIT("L5_VDEC_LAT0_RG_CTRL_DMA_EXT", 0,
		5, 0x8, 6),
	MM_IOMMU_PORT_INIT("L5_VDEC_UFO_ENC_EXT", 0,
		5, 0x8, 7),
	/*Larb7 */
	MM_IOMMU_PORT_INIT("L7_VENC_RCPU", 0,
		7, 0xc, 0),
	MM_IOMMU_PORT_INIT("L7_VENC_REC", 0,
		7, 0xc, 1),
	MM_IOMMU_PORT_INIT("L7_VENC_BSDMA", 0,
		7, 0xc, 2),
	MM_IOMMU_PORT_INIT("L7_VENC_SV_COMV", 0,
		7, 0xc, 3),
	MM_IOMMU_PORT_INIT("L7_VENC_RD_COMV", 0,
		7, 0xc, 4),
	MM_IOMMU_PORT_INIT("L7_VENC_CUR_LUMA", 0,
		7, 0xc, 5),
	MM_IOMMU_PORT_INIT("L7_VENC_CUR_CHROMA", 0,
		7, 0xc, 6),
	MM_IOMMU_PORT_INIT("L7_VENC_REF_LUMA", 0,
		7, 0xc, 7),
	MM_IOMMU_PORT_INIT("L7_VENC_REF_CHROMA", 0,
		7, 0xc, 8),
	MM_IOMMU_PORT_INIT("L7_JPGENC_Y_RDMA", 0,
		7, 0xc, 9),
	MM_IOMMU_PORT_INIT("L7_JPGENC_Q_RDMA", 0,
		7, 0xc, 10),
	MM_IOMMU_PORT_INIT("L7_JPGENC_C_TABLE", 0,
		7, 0xc, 11),
	MM_IOMMU_PORT_INIT("L7_JPGENC_BSDMA", 0,
		7, 0xc, 12),
	MM_IOMMU_PORT_INIT("L7_VENC_SUB_R_LUMA", 0,
		7, 0xc, 13),
	MM_IOMMU_PORT_INIT("L7_VENC_SUB_W_LUMA", 0,
		7, 0xc, 14),
	/*Larb9 */
	MM_IOMMU_PORT_INIT("L9_IMG_IMGI_D1", 1,
		9, 0x10, 0),
	MM_IOMMU_PORT_INIT("L9_IMG_IMGBI_D1", 1,
		9, 0x10, 1),
	MM_IOMMU_PORT_INIT("L9_IMG_DMGI_D1", 1,
		9, 0x10, 2),
	MM_IOMMU_PORT_INIT("L9_IMG_DEPI_D1", 1,
		9, 0x10, 3),
	MM_IOMMU_PORT_INIT("L9_IMG_ICE_D1", 1,
		9, 0x10, 4),
	MM_IOMMU_PORT_INIT("L9_IMG_SMTI_D1", 1,
		9, 0x10, 5),
	MM_IOMMU_PORT_INIT("L9_IMG_SMTO_D2", 1,
		9, 0x10, 6),
	MM_IOMMU_PORT_INIT("L9_IMG_SMTO_D1", 1,
		9, 0x10, 7),
	MM_IOMMU_PORT_INIT("L9_IMG_CRZO_D1", 1,
		9, 0x10, 8),
	MM_IOMMU_PORT_INIT("L9_IMG_IMG3O_D1", 1,
		9, 0x10, 9),
	MM_IOMMU_PORT_INIT("L9_IMG_VIPI_D1", 1,
		9, 0x10, 10),
	MM_IOMMU_PORT_INIT("L9_IMG_SMTI_D5", 1,
		9, 0x10, 11),
	MM_IOMMU_PORT_INIT("L9_IMG_TIMGO_D1", 1,
		9, 0x10, 12),
	MM_IOMMU_PORT_INIT("L9_IMG_UFBC_W0", 1,
		9, 0x10, 13),
	MM_IOMMU_PORT_INIT("L9_IMG_UFBC_R0", 1,
		9, 0x10, 14),
	/*Larb11 */
	MM_IOMMU_PORT_INIT("L11_IMG_IMGI_D1", 0,
		11, 0x10, 0),
	MM_IOMMU_PORT_INIT("L11_IMG_IMGBI_D1", 0,
		11, 0x10, 1),
	MM_IOMMU_PORT_INIT("L11_IMG_DMGI_D1", 0,
		11, 0x10, 2),
	MM_IOMMU_PORT_INIT("L11_IMG_DEPI_D1", 0,
		11, 0x10, 3),
	MM_IOMMU_PORT_INIT("L11_IMG_ICE_D1", 0,
		11, 0x10, 4),
	MM_IOMMU_PORT_INIT("L11_IMG_SMTI_D1", 0,
		11, 0x10, 5),
	MM_IOMMU_PORT_INIT("L11_IMG_SMTO_D2", 0,
		11, 0x10, 6),
	MM_IOMMU_PORT_INIT("L11_IMG_SMTO_D1", 0,
		11, 0x10, 7),
	MM_IOMMU_PORT_INIT("L11_IMG_CRZO_D1", 0,
		11, 0x10, 8),
	MM_IOMMU_PORT_INIT("L11_IMG_IMG3O_D1", 0,
		11, 0x10, 9),
	MM_IOMMU_PORT_INIT("L11_IMG_VIPI_D1", 0,
		11, 0x10, 10),
	MM_IOMMU_PORT_INIT("L11_IMG_SMTI_D5", 0,
		11, 0x10, 11),
	MM_IOMMU_PORT_INIT("L11_IMG_TIMGO_D1", 0,
		11, 0x10, 12),
	MM_IOMMU_PORT_INIT("L11_IMG_UFBC_W0", 0,
		11, 0x10, 13),
	MM_IOMMU_PORT_INIT("L11_IMG_UFBC_R0", 0,
		11, 0x10, 14),
	MM_IOMMU_PORT_INIT("L11_IMG_WPE_RDMA1", 0,
		11, 0x10, 15),
	MM_IOMMU_PORT_INIT("L11_IMG_WPE_RDMA0", 0,
		11, 0x10, 16),
	MM_IOMMU_PORT_INIT("L11_IMG_WPE_WDMA", 0,
		11, 0x10, 17),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_RDMA0", 0,
		11, 0x10, 18),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_RDMA1", 0,
		11, 0x10, 19),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_RDMA2", 0,
		11, 0x10, 20),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_RDMA3", 0,
		11, 0x10, 21),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_RDMA4", 0,
		11, 0x10, 22),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_RDMA5", 0,
		11, 0x10, 23),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_WDMA0", 0,
		11, 0x10, 24),
	MM_IOMMU_PORT_INIT("L11_IMG_MFB_WDMA1", 0,
		11, 0x10, 25),
	MM_IOMMU_PORT_INIT("L11_IMG_RESERVE6", 0,
		11, 0x10, 26),
	MM_IOMMU_PORT_INIT("L11_IMG_RESERVE7", 0,
		11, 0x10, 27),
	MM_IOMMU_PORT_INIT("L11_IMG_RESERVE8", 0,
		11, 0x10, 28),
	/*Larb13 */
	MM_IOMMU_PORT_INIT("L13_CAM_MRAWI", 1,
		13, 0x19, 0),
	MM_IOMMU_PORT_INIT("L13_CAM_MRAWO0", 1,
		13, 0x19, 1),
	MM_IOMMU_PORT_INIT("L13_CAM_MRAWO1", 1,
		13, 0x19, 2),
	MM_IOMMU_PORT_INIT("L13_CAM_CAMSV1", 1,
		13, 0x19, 3),
	MM_IOMMU_PORT_INIT("L13_CAM_CAMSV2", 1,
		13, 0x19, 4),
	MM_IOMMU_PORT_INIT("L13_CAM_CAMSV3", 1,
		13, 0x19, 5),
	MM_IOMMU_PORT_INIT("L13_CAM_CAMSV4", 1,
		13, 0x19, 6),
	MM_IOMMU_PORT_INIT("L13_CAM_CAMSV5", 1,
		13, 0x19, 7),
	MM_IOMMU_PORT_INIT("L13_CAM_CAMSV6", 1,
		13, 0x19, 8),
	MM_IOMMU_PORT_INIT("L13_CAM_CCUI", 1,
		13, 0x19, 9),
	MM_IOMMU_PORT_INIT("L13_CAM_CCUO", 1,
		13, 0x19, 10),
	MM_IOMMU_PORT_INIT("L13_CAM_FAKE", 1,
		13, 0x19, 11),
	/*Larb14 */
	MM_IOMMU_PORT_INIT("L14_CAM_RESERVE1", 0,
		14, 0x19, 0),
	MM_IOMMU_PORT_INIT("L14_CAM_RESERVE2", 0,
		14, 0x19, 1),
	MM_IOMMU_PORT_INIT("L14_CAM_RESERVE3", 0,
		14, 0x19, 2),
	MM_IOMMU_PORT_INIT("L14_CAM_CAMSV0", 0,
		14, 0x19, 3),
	MM_IOMMU_PORT_INIT("L14_CAM_CCUI", 0,
		14, 0x19, 4),
	MM_IOMMU_PORT_INIT("L14_CAM_CCUO", 0,
		14, 0x19, 5),
	/*Larb16 */
	MM_IOMMU_PORT_INIT("L16_CAM_IMGO_R1_A", 1,
		16, 0x1c, 0),
	MM_IOMMU_PORT_INIT("L16_CAM_RRZO_R1_A", 1,
		16, 0x1c, 1),
	MM_IOMMU_PORT_INIT("L16_CAM_CQI_R1_A", 1,
		16, 0x1c, 2),
	MM_IOMMU_PORT_INIT("L16_CAM_BPCI_R1_A", 1,
		16, 0x1c, 3),
	MM_IOMMU_PORT_INIT("L16_CAM_YUVO_R1_A", 1,
		16, 0x1c, 4),
	MM_IOMMU_PORT_INIT("L16_CAM_UFDI_R2_A", 1,
		16, 0x1c, 5),
	MM_IOMMU_PORT_INIT("L16_CAM_RAWI_R2_A", 1,
		16, 0x1c, 6),
	MM_IOMMU_PORT_INIT("L16_CAM_RAWI_R3_A", 1,
		16, 0x1c, 7),
	MM_IOMMU_PORT_INIT("L16_CAM_AAO_R1_A", 1,
		16, 0x1c, 8),
	MM_IOMMU_PORT_INIT("L16_CAM_AFO_R1_A", 1,
		16, 0x1c, 9),
	MM_IOMMU_PORT_INIT("L16_CAM_FLKO_R1_A", 1,
		16, 0x1c, 10),
	MM_IOMMU_PORT_INIT("L16_CAM_LCESO_R1_A", 1,
		16, 0x1c, 11),
	MM_IOMMU_PORT_INIT("L16_CAM_CRZO_R1_A", 1,
		16, 0x1c, 12),
	MM_IOMMU_PORT_INIT("L16_CAM_LTMSO_R1_A", 1,
		16, 0x1c, 13),
	MM_IOMMU_PORT_INIT("L16_CAM_RSSO_R1_A", 1,
		16, 0x1c, 14),
	MM_IOMMU_PORT_INIT("L16_CAM_AAHO_R1_A", 1,
		16, 0x1c, 15),
	MM_IOMMU_PORT_INIT("L16_CAM_LSCI_R1_A", 1,
		16, 0x1c, 16),
	/*Larb17 */
	MM_IOMMU_PORT_INIT("L17_CAM_IMGO_R1_B", 0,
		17, 0x1c, 0),
	MM_IOMMU_PORT_INIT("L17_CAM_RRZO_R1_B", 0,
		17, 0x1c, 1),
	MM_IOMMU_PORT_INIT("L17_CAM_CQI_R1_B", 0,
		17, 0x1c, 2),
	MM_IOMMU_PORT_INIT("L17_CAM_BPCI_R1_B", 0,
		17, 0x1c, 3),
	MM_IOMMU_PORT_INIT("L17_CAM_YUVO_R1_B", 0,
		17, 0x1c, 4),
	MM_IOMMU_PORT_INIT("L17_CAM_UFDI_R2_B", 0,
		17, 0x1c, 5),
	MM_IOMMU_PORT_INIT("L17_CAM_RAWI_R2_B", 0,
		17, 0x1c, 6),
	MM_IOMMU_PORT_INIT("L17_CAM_RAWI_R3_B", 0,
		17, 0x1c, 7),
	MM_IOMMU_PORT_INIT("L17_CAM_AAO_R1_B", 0,
		17, 0x1c, 8),
	MM_IOMMU_PORT_INIT("L17_CAM_AFO_R1_B", 0,
		17, 0x1c, 9),
	MM_IOMMU_PORT_INIT("L17_CAM_FLKO_R1_B", 0,
		17, 0x1c, 10),
	MM_IOMMU_PORT_INIT("L17_CAM_LCESO_R1_B", 0,
		17, 0x1c, 11),
	MM_IOMMU_PORT_INIT("L17_CAM_CRZO_R1_B", 0,
		17, 0x1c, 12),
	MM_IOMMU_PORT_INIT("L17_CAM_LTMSO_R1_B", 0,
		17, 0x1c, 13),
	MM_IOMMU_PORT_INIT("L17_CAM_RSSO_R1_B", 0,
		17, 0x1c, 14),
	MM_IOMMU_PORT_INIT("L17_CAM_AAHO_R1_B", 0,
		17, 0x1c, 15),
	MM_IOMMU_PORT_INIT("L17_CAM_LSCI_R1_B", 0,
		17, 0x1c, 16),
	/*Larb18 */
	MM_IOMMU_PORT_INIT("L18_CAM_IMGO_R1_C", 1,
		18, 0x14, 0),
	MM_IOMMU_PORT_INIT("L18_CAM_RRZO_R1_C", 1,
		18, 0x14, 1),
	MM_IOMMU_PORT_INIT("L18_CAM_CQI_R1_C", 1,
		18, 0x14, 2),
	MM_IOMMU_PORT_INIT("L18_CAM_BPCI_R1_C", 1,
		18, 0x14, 3),
	MM_IOMMU_PORT_INIT("L18_CAM_YUVO_R1_C", 1,
		18, 0x14, 4),
	MM_IOMMU_PORT_INIT("L18_CAM_UFDI_R2_C", 1,
		18, 0x14, 5),
	MM_IOMMU_PORT_INIT("L18_CAM_RAWI_R2_C", 1,
		18, 0x14, 6),
	MM_IOMMU_PORT_INIT("L18_CAM_RAWI_R3_C", 1,
		18, 0x14, 7),
	MM_IOMMU_PORT_INIT("L18_CAM_AAO_R1_C", 1,
		18, 0x14, 8),
	MM_IOMMU_PORT_INIT("L18_CAM_AFO_R1_C", 1,
		18, 0x14, 9),
	MM_IOMMU_PORT_INIT("L18_CAM_FLKO_R1_C", 1,
		18, 0x14, 10),
	MM_IOMMU_PORT_INIT("L18_CAM_LCESO_R1_C", 1,
		18, 0x14, 11),
	MM_IOMMU_PORT_INIT("L18_CAM_CRZO_R1_C", 1,
		18, 0x14, 12),
	MM_IOMMU_PORT_INIT("L18_CAM_LTMSO_R1_C", 1,
		18, 0x14, 13),
	MM_IOMMU_PORT_INIT("L18_CAM_RSSO_R1_C", 1,
		18, 0x14, 14),
	MM_IOMMU_PORT_INIT("L18_CAM_AAHO_R1_C", 1,
		18, 0x14, 15),
	MM_IOMMU_PORT_INIT("L18_CAM_LSCI_R1_C", 1,
		18, 0x14, 16),
	/*Larb19 */
	MM_IOMMU_PORT_INIT("L19_IPE_DVS_RDMA", 0,
		19, 0x14, 0),
	MM_IOMMU_PORT_INIT("L19_IPE_DVS_WDMA", 0,
		19, 0x14, 1),
	MM_IOMMU_PORT_INIT("L19_IPE_DVP_RDMA", 0,
		19, 0x14, 2),
	MM_IOMMU_PORT_INIT("L19_IPE_DVP_WDMA", 0,
		19, 0x14, 3),
	/*Larb20 */
	MM_IOMMU_PORT_INIT("L20_IPE_FDVT_RDA", 0,
		20, 0x15, 0),
	MM_IOMMU_PORT_INIT("L20_IPE_FDVT_RDB", 0,
		20, 0x15, 1),
	MM_IOMMU_PORT_INIT("L20_IPE_FDVT_WRA", 0,
		20, 0x15, 2),
	MM_IOMMU_PORT_INIT("L20_IPE_FDVT_WRB", 0,
		20, 0x15, 3),
	MM_IOMMU_PORT_INIT("L20_IPE_RSC_RDMA0", 0,
		20, 0x15, 4),
	MM_IOMMU_PORT_INIT("L20_IPE_RSC_WDMA", 0,
		20, 0x15, 5),
	/*Larb21 */
	MM_IOMMU_PORT_INIT("L21_CCU0", 0,
		22, 0x18, 0),
	MM_IOMMU_PORT_INIT("L21_CCU1", 0,
		23, 0x18, 0),
...
static const struct mtk_iommu_port apu_port_mt6893[] = {
	/*Larb22 */
	MM_IOMMU_PORT_INIT("L22_APU_VPU", 0,
		21, 0x0, 0),
	MM_IOMMU_PORT_INIT("L22_APU_DATA", 0,
		21, 0x0, 0),
	MM_IOMMU_PORT_INIT("L22_APU_VLM", 0,
		21, 0x0, 0),
