...
static void et7480_enable_switch_handler(unsigned long data)
{
	int ret = 0;
			 ...
			 const struct i2c_device_id *id)
{
	...
	setup_timer(&et7480_enable_timer, et7480_enable_switch_handler, (unsigned long)et_priv);
	...
	setup_timer(&et7480_delay_init_timer, delay_init_timer_callback, 0);
