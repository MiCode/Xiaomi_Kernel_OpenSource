...
#define WL2866D_ID1  0x4b
#define AW_I2C_RETRIES 2
#define AW_I2C_RETRY_DELAY 4
...
static const struct  wl2866d_map  wl2866d_on_config[] = {
	{0x03, 0x4B},    //DVDD1    1.05 V
	{0x04, 0x64},    //DVDD2    1.2 V
...
static const struct  wl2866d_map  wl2866d_reset_config[] = {
	{0x01, 0x00},
	{0x02, 0x00},
	{0x03, 0x64},
	{0x04, 0x64},
...
static int wl2866d_software_reset(struct  wl2866d_chip *chip)
{
	unsigned char reg_val = 0;
	int ret = 0;
	int i ;
	...
	for(i=0; i<WL2866D_RESET_CONFIG_NUM; i++){
		...
		if (ret < 0){
			pr_err("wl2866d software reseting fail\n");
			return ret;
		}
	}
	for(i=0; i<WL2866D_RESET_CONFIG_NUM; i++){
				 ...
				 const struct i2c_device_id *id)
{
	...
	ret = wl2866d_software_reset(chip);
	if (ret < 0)	{
		dev_err(&client->dev, "wl2866d software reseting fail\n");
		ret = -1;
		goto software_reseting_err;
	}
