...
#include <linux/platform_data/stm32-fwu-i2c.h>
			       ...
			       const struct firmware *fw)
{
	...
	stm32_add = STM32_FLASH_START + STM32_FLASH_VECTOR_AND_RESERVE_SIZE;
	size = fw->size - STM32_FLASH_VECTOR_AND_RESERVE_SIZE;
	fw_ptr = fw->data + STM32_FLASH_VECTOR_AND_RESERVE_SIZE;
