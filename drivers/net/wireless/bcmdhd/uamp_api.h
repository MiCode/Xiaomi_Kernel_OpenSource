...
******************************************************************************
*/
typedef void (*tUAMP_CBACK) (tUAMP_ID amp_id, tUAMP_EVT amp_evt,
			     tUAMP_EVT_DATA *p_amp_evt_data);
...
******************************************************************************
*/
	BT_API UINT16 UAMP_Write(tUAMP_ID amp_id, uint8 *p_buf,
				 UINT16 num_bytes, tUAMP_CH channel);
...
******************************************************************************
*/
	BT_API UINT16 UAMP_Read(tUAMP_ID amp_id, uint8 *p_buf, UINT16 buf_size,
				tUAMP_CH channel);
