...
/* bcm_prefetch_32B */
static inline void bcm_prefetch_32B(const uint8 *addr,
				    const int cachelines_32B)
{
...
#define R_REG(osh, r) (\
	SELECT_BUS_READ(osh, \
		({ \
			...
			case sizeof(uint32): \
					__osl_v = \
					readl_relaxed((volatile uint32 *)(r)); break; \
			} \
			__osl_v; \
		}), \
		OSL_READ_REG(osh, r)) \
...
#define W_REG(osh, r, v) do { \
	SELECT_BUS_WRITE(osh, \
		...
		case sizeof(uint32): \
			writel_relaxed((uint32)(v), (volatile uint32 *)(r)); break; \
		}, \
