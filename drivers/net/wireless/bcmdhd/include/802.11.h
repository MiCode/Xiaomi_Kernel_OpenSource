...
#define EXT_MNG_SHORT_SSID_ID			58u	/* SHORT SSID IE, 6GHz */
...
/* Short SSID length */
#define DOT11_SHORT_SSID_LEN 4

/* Set by STA in probe when short ssid used */
#define UNKNOWN_SSID_DEFAULT_VAL 0x80
