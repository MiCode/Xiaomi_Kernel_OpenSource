...
extern void *si_d11_switch_addrbase(si_t *sih, uint coreunit);
...
extern uint32 si_gci_preinit_upd_indirect(uint32 regidx, uint32 setval,
					  uint32 mask);
...
extern void si_survive_perst_war(si_t *sih, bool reset, uint32 sperst_mask,
				 uint32 spert_val);
