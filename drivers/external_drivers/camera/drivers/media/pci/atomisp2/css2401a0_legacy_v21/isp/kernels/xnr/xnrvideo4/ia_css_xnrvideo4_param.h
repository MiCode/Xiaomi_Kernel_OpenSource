...
#ifndef __IA_CSS_XNRVIDEO4_PARAM_H
#define __IA_CSS_XNRVIDEO4_PARAM_H
...
struct sh_css_xnrvideo4_alpha_params {
	int32_t y0;
	int32_t u0;
	int32_t v0;
	int32_t ydiff;
 ...
 * for dark areas, and a scaled diff towards the value for bright areas. */
struct sh_css_xnrvideo4_coring_params {
	int32_t u0;
	int32_t v0;
	int32_t udiff;
	int32_t vdiff;
...
/* XNR3 ISP parameters */
struct sh_css_isp_xnrvideo4_params {
	struct sh_css_xnrvideo4_alpha_params  alpha;
	struct sh_css_xnrvideo4_coring_params coring;
};

#endif  /*__IA_CSS_XNRVIDEO4_PARAM_H */
