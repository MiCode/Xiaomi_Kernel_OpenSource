...
#ifndef __IA_CSS_XNRVIDEO4_TYPES_H
#define __IA_CSS_XNRVIDEO4_TYPES_H
 ...
 */
#define IA_CSS_XNRVIDEO4_SIGMA_SCALE  (1 << 10)

/**
 * \brief Scale of the XNR coring parameters.
 * \details The define specifies which fixed-point value represents 1.0.
 */
#define IA_CSS_XNRVIDEO4_CORING_SCALE (1 << 15)
 ...
 * IA_CSS_XNRVIDEO4_SIGMA_SCALE.
 */
struct ia_css_xnrvideo4_sigma_params {
...
/**
 * \brief XNRVIDEO4 Coring Parameters
 ...
 * with IA_CSS_XNRVIDEO4_CORING_SCALE. The ineffective value is 0.
 */
struct ia_css_xnrvideo4_coring_params {
 ...
 * from the CSS API.
 */
struct ia_css_xnrvideo4_config {
	struct ia_css_xnrvideo4_sigma_params  sigma;   /**< XNR3 sigma parameters */
	struct ia_css_xnrvideo4_coring_params coring;  /**< XNR3 coring parameters */
};

#endif /* __IA_CSS_XNRVIDEO4_TYPES_H */
