...
#ifndef __PINCTRL_MTK_MT6781_H
#define __PINCTRL_MTK_MT6781_H

#include "pinctrl-paris.h"

static const struct mtk_pin_desc mtk_pins_mt6781[] = {
	MTK_PIN(
		0, "GPIO0",
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "BPI_BUS17_PA_VM0"),
		MTK_FUNCTION(4, "CONN_MCU_TDI"),
		MTK_FUNCTION(5, "ANT_SEL3"),
		MTK_FUNCTION(6, "SPI2_CLK"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "BPI_BUS18_PA_VM1"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "BPI_BUS19_OLAT0"),
		MTK_FUNCTION(4, "CONN_MCU_TDO"),
		MTK_FUNCTION(5, "ANT_SEL5"),
		MTK_FUNCTION(6, "SPI2_CSB"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "BPI_BUS20_OLAT1"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "BPI_BUS21_OLAT2"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "BPI_BUS22_OLAT3"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "SCP_JTAG_TDI"),
		MTK_FUNCTION(4, "ADSP_JTAG_TDI"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "SCP_JTAG_TRSTN"),
		MTK_FUNCTION(4, "ADSP_JTAG_TRSTN"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "SCP_JTAG_TCK"),
		MTK_FUNCTION(4, "ADSP_JTAG_TCK"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "SCP_JTAG_TDO"),
		MTK_FUNCTION(4, "ADSP_JTAG_TDO"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "SCP_JTAG_TMS"),
		MTK_FUNCTION(4, "ADSP_JTAG_TMS"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "CONN_DSP_L5_JCK"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "CONN_DSP_L5_JINTP"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "CONN_DSP_L5_JDI"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "CONN_DSP_L5_JMS"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "CONN_DSP_L5_JDO"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(4, "CONN_BPI_BUS11_OLAT0"),
		MTK_FUNCTION(5, "ANT_SEL11")
	),
	MTK_PIN(
		112, "GPIO112",
		...
		MTK_FUNCTION(4, "CONN_BPI_BUS12_OLAT1"),
		MTK_FUNCTION(5, "ANT_SEL12")
	),
	MTK_PIN(
		113, "GPIO113",
		...
		MTK_FUNCTION(4, "CONN_BPI_BUS13_OLAT2")
	),
	MTK_PIN(
		114, "GPIO114",
		...
		MTK_FUNCTION(4, "CONN_BPI_BUS14_OLAT3")
	),
	MTK_PIN(
		115, "GPIO115",
		...
		MTK_FUNCTION(4, "CONN_BPI_BUS15_OLAT4")
	),
	MTK_PIN(
		116, "GPIO116",
	...
	MTK_PIN(
		...
		MTK_FUNCTION(2, "MIPI5_SDATA"),
		MTK_FUNCTION(3, "PCM1_DO2"),
		MTK_FUNCTION(4, "CONN_BPI_BUS17_ANT0"),
		MTK_FUNCTION(5, "CONN_MIPI1_SDATA")
	),
	MTK_PIN(
		118, "GPIO118",
