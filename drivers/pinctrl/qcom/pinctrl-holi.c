...
static const struct pinctrl_pin_desc holi_pins[] = {
...
static const char * const gpio_groups[] = {
	...
	"gpio55", "gpio56", "gpio57", "gpio58", "gpio58", "gpio59", "gpio59",
	...
	"gpio87", "gpio88", "gpio89", "gpio90", "gpio91", "gpio92", "gpio93",
...
static const struct msm_function holi_functions[] = {
	FUNCTION(ibi_i3c),
	FUNCTION(gpio),
	FUNCTION(cri_trng),
	FUNCTION(qup00),
 ...
 */
static const struct msm_pingroup holi_groups[] = {
	...
	[11] = PINGROUP(11, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C008, 1),
	...
	[16] = PINGROUP(16, qup10, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C00C, 6),
	...
	[52] = PINGROUP(52, CCI_ASYNC, GP_PDM1, NA, phase_flag21, qdss_gpio12,
			NA, NA, NA, NA, 0x9C00C, 13),
	[53] = PINGROUP(53, CCI_ASYNC, NA, phase_flag22, qdss_gpio13, NA, NA,
			NA, NA, NA, 0x9C00C, 14),
	[54] = PINGROUP(54, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C00C, 15),
	[55] = PINGROUP(55, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C010, 0),
	...
	[68] = PINGROUP(68, btfm_slimbus, mi2s_1, GP_PDM0, NA, phase_flag31,
			NA, NA, NA, NA, 0, -1),
	[69] = PINGROUP(69, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C010, 1),
	...
	[73] = PINGROUP(73, mi2s_2, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 7),
	...
	[87] = PINGROUP(87, btfm_slimbus, mi2s_1, adsp_ext, NA, qdss_cti,
			atest_usb13, ddr_pxi1, NA, NA, 0x9C000, 8),
	[88] = PINGROUP(88, mi2s_0, NA, qdss_gpio4, NA, atest_usb2, ddr_pxi2,
			tsense_pwm1, tsense_pwm2, NA, 0x9C000, 9),
	[89] = PINGROUP(89, mi2s_0, AGERA_PLL, NA, qdss_gpio5, NA,
			vsense_trigger, atest_usb20, ddr_pxi3, NA, 0x9C000, 10),
	[90] = PINGROUP(90, mi2s_0, JITTER_BIST, NA, qdss_gpio6, NA,
			wlan1_adc0, atest_usb21, ddr_pxi0, NA, 0x9C000, 11),
	[91] = PINGROUP(91, mi2s_0, NA, qdss_gpio7, NA, wlan2_adc0,
			atest_usb22, ddr_pxi1, NA, NA, 0x9C000, 12),
	[92] = PINGROUP(92, NA, qdss_gpio8, atest_tsens, wlan1_adc1,
			atest_usb23, ddr_pxi2, NA, NA, NA, 0x9C000, 13),
	[93] = PINGROUP(93, MCLK, lpass_ext, NA, qdss_gpio9, atest_tsens2,
			wlan2_adc1, ddr_pxi3, NA, NA, 0x9C000, 14),
	[94] = PINGROUP(94, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C008, 8),
	...
	[99] = PINGROUP(99, NA, atest_char3, NA, NA, NA, NA, NA, NA, NA,
			0x9C010, 11),
	[100] = PINGROUP(100, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C010, 12),
	...
	[110] = PINGROUP(110, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C010, 15),
	[111] = PINGROUP(111, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[112] = PINGROUP(112, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C014, 0),
	[113] = PINGROUP(113, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[114] = PINGROUP(114, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C014, 1),
	[115] = PINGROUP(115, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[116] = PINGROUP(116, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C014, 2),
	...
	[122] = PINGROUP(122, PCIE0_CLK, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C018, 13),
	[123] = PINGROUP(123, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C018, 14),
	[124] = PINGROUP(124, USB_PHY, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C014, 4),
	[125] = PINGROUP(125, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C014, 5),
	[126] = PINGROUP(126, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[127] = PINGROUP(127, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[128] = PINGROUP(128, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 15),
	[129] = PINGROUP(129, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 0),
	[130] = PINGROUP(130, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[131] = PINGROUP(131, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 1),
	[132] = PINGROUP(132, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[133] = PINGROUP(133, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 2),
	[134] = PINGROUP(134, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 3),
	[135] = PINGROUP(135, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[136] = PINGROUP(136, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 4),
	[137] = PINGROUP(137, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 5),
	[138] = PINGROUP(138, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 6),
	[139] = PINGROUP(139, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 7),
	[140] = PINGROUP(140, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 8),
	[141] = PINGROUP(141, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[142] = PINGROUP(142, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 9),
	[143] = PINGROUP(143, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[144] = PINGROUP(144, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 10),
	[145] = PINGROUP(145, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[146] = PINGROUP(146, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[147] = PINGROUP(147, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C004, 11),
...
{
	return msm_pinctrl_probe(pdev, &holi_pinctrl);
}

static const struct of_device_id holi_pinctrl_of_match[] = {
	{ .compatible = "qcom,holi-pinctrl", },
	{ },
};

static struct platform_driver holi_pinctrl_driver = {
	.driver = {
		.name = "holi-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = holi_pinctrl_of_match,
	},
	.probe = holi_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init holi_pinctrl_init(void)
{
	return platform_driver_register(&holi_pinctrl_driver);
}
arch_initcall(holi_pinctrl_init);

static void __exit holi_pinctrl_exit(void)
{
	platform_driver_unregister(&holi_pinctrl_driver);
}
module_exit(holi_pinctrl_exit);

MODULE_DESCRIPTION("QTI holi pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, holi_pinctrl_of_match);
