...
static const char * const gpio_groups[] = {
	...
	"gpio8", "gpio9", "gpio10", "gpio11", "gpio12", "gpio14", "gpio15",
	"gpio18", "gpio19", "gpio20", "gpio21", "gpio22", "gpio23", "gpio24",
	"gpio25", "gpio26", "gpio27", "gpio28", "gpio29", "gpio30", "gpio31",
	"gpio32", "gpio49", "gpio50", "gpio51", "gpio52", "gpio53", "gpio54",
	"gpio55", "gpio56", "gpio57", "gpio58", "gpio59", "gpio60", "gpio61",
	"gpio62", "gpio63", "gpio64", "gpio65", "gpio66", "gpio67", "gpio68",
	"gpio69", "gpio70", "gpio71", "gpio72", "gpio75", "gpio76", "gpio77",
	"gpio78", "gpio79", "gpio80", "gpio81", "gpio82", "gpio83", "gpio84",
	"gpio85", "gpio86", "gpio87", "gpio88", "gpio93", "gpio89", "gpio90",
	"gpio91", "gpio94", "gpio95", "gpio98", "gpio99", "gpio100", "gpio101",
...
static const char * const dummy1_groups[] = {
	"gpio68",
};
...
static const char * const dummy2_groups[] = {
	"gpio70",
};
...
static const char * const lcd_en_groups[] = {
	"gpio92",
};
...
static const char * const usbc_irq_groups[] = {
	"gpio93",
};
...
static const char * const uim3_ldo_groups[] = {
	"gpio96",
};
...
static const char * const dummy0_groups[] = {
	"gpio104",
};
...
static const char * const dummy3_groups[] = {
	"gpio124",
};
static const char * const dummy4_groups[] = {
	"gpio125",
};

static const struct msm_function msm8952_functions[] = {
	FUNCTION(blsp_uart1),
	FUNCTION(mipi_dsi0),
	FUNCTION(blsp_spi1),
	FUNCTION(smb_int),
...
static const struct msm_pingroup msm8952_groups[] = {
	...
	PINGROUP(67, atest_char1, ebi_cdc, NA, atest_combodac_to_gpio_native,
		 NA, NA, NA, NA, NA),
	PINGROUP(68, atest_char0, dummy1, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(69, cdc_pdm0, pri_mi2s_mclk_b, ebi_cdc, NA, NA, NA, NA, NA,
		 NA),
	PINGROUP(70, lpass_slimbus, cdc_pdm0, NA, dummy2, NA, NA, NA, NA, NA),
	...
	PINGROUP(104, NA, dummy0, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGROUP(124, NA, dummy3, NA, NA, NA, NA, NA, NA, NA),
	PINGROUP(125, NA, dummy4, NA, NA, NA, NA, NA, NA, NA),
