...
static const char * const qdss_cti_groups[] = {
	"gpio80", "gpio81", "gpio82", "gpio83", "gpio84", "gpio85", "gpio89",
	"gpio90",
};
...
static const struct msm_pingroup waipio_groups[] = {
	...
	[2] = PINGROUP(2, qup0, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 0),
	...
	[7] = PINGROUP(7, qup1, phase_flag28, NA, NA, NA, NA, NA, NA, NA,
		       0xD2000, 2),
	[8] = PINGROUP(8, qup2, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[9] = PINGROUP(9, qup2, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[21] = PINGROUP(21, qup6, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[22] = PINGROUP(22, qup6, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[23] = PINGROUP(23, qup6, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 6),
	[24] = PINGROUP(24, qup7, qup_l4, jitter_bist, dbg_out, NA, NA, NA, NA,
			NA, 0, -1),
	[25] = PINGROUP(25, qup7, qup_l5, phase_flag17, NA, NA, NA, NA, NA, NA,
			0, -1),
	[26] = PINGROUP(26, qup7, qup_l6, phase_flag16, NA, NA, NA, NA, NA, NA,
			0xD2000, 7),
	[27] = PINGROUP(27, qup7, NA, NA, NA, NA, NA, NA, NA, NA, 0xD2000, 8),
	...
	[44] = PINGROUP(44, qup12, ddr_pxi3, NA, NA, NA, NA, NA, NA, NA,
			0xD2014, 10),
	[45] = PINGROUP(45, qup12, ddr_pxi2, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[54] = PINGROUP(54, qup14, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[55] = PINGROUP(55, qup14, qspi_cs, atest_usb03, NA, NA, NA, NA, NA,
			NA, 0xD2014, 15),
	...
	[62] = PINGROUP(62, qup16, qup_l6, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[86] = PINGROUP(86, mdp_vsync, mdp_vsync0, mdp_vsync1, gcc_gp1,
			atest_char, NA, NA, NA, NA, 0xD2018, 0),
	[87] = PINGROUP(87, mdp_vsync, mdp_vsync2, mdp_vsync3, gcc_gp2,
			atest_char3, NA, NA, NA, NA, 0xD2018, 1),
	[88] = PINGROUP(88, mdp_vsync, gcc_gp3, atest_char2, NA, NA, NA, NA,
			NA, NA, 0xD2018, 2),
	[89] = PINGROUP(89, vfr_0, qdss_cti, atest_char1, NA, NA, NA, NA, NA,
			NA, 0xD2018, 3),
	[90] = PINGROUP(90, usb2phy_ac, qdss_cti, atest_char0, NA, NA, NA, NA,
			NA, NA, 0xD2018, 4),
	[91] = PINGROUP(91, usb_phy, tsense_pwm1, tsense_pwm2, NA, NA, NA, NA,
			NA, NA, 0xD2018, 5),
	[92] = PINGROUP(92, phase_flag11, NA, NA, NA, NA, NA, NA, NA, NA,
			0xD200C, 15),
	[93] = PINGROUP(93, sd_write, phase_flag10, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	...
	[106] = PINGROUP(106, cam_mclk, qdss_gpio11, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[107] = PINGROUP(107, cam_mclk, qdss_gpio12, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	...
	[188] = PINGROUP(188, qdss_gpio0, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xD2004, 13),
	[189] = PINGROUP(189, qdss_gpio1, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[190] = PINGROUP(190, qdss_gpio2, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xD2004, 14),
	[191] = PINGROUP(191, qdss_gpio3, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[192] = PINGROUP(192, qdss_gpio4, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xD2004, 15),
	[193] = PINGROUP(193, qdss_gpio5, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[194] = PINGROUP(194, qdss_gpio6, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[195] = PINGROUP(195, qdss_gpio7, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xD2008, 0),
	[196] = PINGROUP(196, qdss_gpio, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[197] = PINGROUP(197, qdss_gpio, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[198] = PINGROUP(198, qdss_gpio8, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[199] = PINGROUP(199, qdss_gpio9, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[200] = PINGROUP(200, qdss_gpio10, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[201] = PINGROUP(201, qdss_gpio11, NA, NA, NA, NA, NA, NA, NA, NA,
			 0xD2008, 1),
