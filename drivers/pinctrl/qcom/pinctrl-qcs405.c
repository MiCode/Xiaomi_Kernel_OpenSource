...
static const struct pinctrl_pin_desc qcs405_pins[] = {
...
static const struct msm_function qcs405_functions[] = {
	FUNCTION(gpio),
	FUNCTION(hdmi_cec),
	FUNCTION(hdmi_ddc),
 ...
 */
static const struct msm_pingroup qcs405_groups[] = {
	[0] = PINGROUP(0, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[1] = PINGROUP(1, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[2] = PINGROUP(2, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[3] = PINGROUP(3, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[4] = PINGROUP(4, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[5] = PINGROUP(5, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[6] = PINGROUP(6, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[7] = PINGROUP(7, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[8] = PINGROUP(8, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[9] = PINGROUP(9, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[10] = PINGROUP(10, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[11] = PINGROUP(11, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[12] = PINGROUP(12, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[13] = PINGROUP(13, SOUTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[14] = PINGROUP(14, SOUTH, hdmi_cec, NA, NA, NA, NA, NA, NA, NA, NA),
	[15] = PINGROUP(15, SOUTH, hdmi_ddc, NA, NA, NA, NA, NA, NA, NA, NA),
	[16] = PINGROUP(16, SOUTH, hdmi_ddc, NA, NA, NA, NA, NA, NA, NA, NA),
	[17] = PINGROUP(17, NORTH, blsp_uart_tx_a2, blsp_spi2, m_voc, NA, NA,
			NA, NA, NA, NA),
	[18] = PINGROUP(18, NORTH, blsp_uart_rx_a2, blsp_spi2, NA, NA, NA, NA,
			NA, qdss_tracectl_a, NA),
	[19] = PINGROUP(19, NORTH, blsp_uart2, aud_cdc, blsp_i2c_sda_a2,
			blsp_spi2, NA, qdss_tracedata_a, NA, NA, NA),
	[20] = PINGROUP(20, NORTH, blsp_uart2, aud_cdc, blsp_i2c_scl_a2,
			blsp_spi2, NA, NA, NA, NA, NA),
	[21] = PINGROUP(21, SOUTH, m_voc, NA, NA, NA, NA, NA, NA, NA,
			qdss_cti_trig_in_b0),
	[22] = PINGROUP(22, NORTH, blsp_uart1, blsp_spi_mosi_a1, NA, NA, NA,
			NA, NA, NA, NA),
	[23] = PINGROUP(23, NORTH, blsp_uart1, blsp_spi_miso_a1, NA, NA, NA,
			NA, NA, qdss_tracedata_b, NA),
	[24] = PINGROUP(24, NORTH, blsp_uart1, blsp_i2c1, blsp_spi_cs_n_a1,
			gcc_plltest, NA, NA, NA, NA, NA),
	[25] = PINGROUP(25, NORTH, blsp_uart1, blsp_i2c1, blsp_spi_clk_a1,
			gcc_plltest, NA, NA, NA, NA, NA),
	[26] = PINGROUP(26, EAST, rgb_data0, blsp_uart5, blsp_spi5, adsp_ext,
			NA, NA, NA, NA, NA),
	[27] = PINGROUP(27, EAST, rgb_data1, blsp_uart5, blsp_spi5, prng_rosc,
			NA, NA, NA, NA, NA),
	[28] = PINGROUP(28, EAST, rgb_data2, blsp_uart5, blsp_i2c5, blsp_spi5,
			gcc_gp1_clk_b, NA, NA, NA, NA),
	[29] = PINGROUP(29, EAST, rgb_data3, blsp_uart5, blsp_i2c5, blsp_spi5,
			gcc_gp2_clk_b, NA, NA, NA, NA),
	[30] = PINGROUP(30, NORTH, blsp_spi0, blsp_uart0, gcc_gp3_clk_b, NA,
			NA, NA, NA, NA, NA),
	[31] = PINGROUP(31, NORTH, blsp_spi0, blsp_uart0, NA, NA, NA, NA, NA,
			NA, NA),
	[32] = PINGROUP(32, NORTH, blsp_spi0, blsp_uart0, blsp_i2c0, NA, NA,
			NA, NA, NA, NA),
	[33] = PINGROUP(33, NORTH, blsp_spi0, blsp_uart0, blsp_i2c0, NA, NA,
			NA, NA, NA, NA),
	[34] = PINGROUP(34, SOUTH, NA, qdss_traceclk_b, NA, NA, NA, NA, NA, NA,
			NA),
	[35] = PINGROUP(35, SOUTH, pcie_clk, NA, qdss_tracedata_b, NA, NA, NA,
			NA, NA, NA),
	[36] = PINGROUP(36, NORTH, NA, NA, NA, NA, NA, NA, qdss_tracedata_a,
			NA, NA),
	[37] = PINGROUP(37, NORTH, nfc_irq, blsp_spi4, NA, NA, NA, NA, NA, NA,
			NA),
	[38] = PINGROUP(38, NORTH, nfc_dwl, blsp_spi4, audio_ts, NA, NA, NA,
			NA, NA, NA),
	[39] = PINGROUP(39, EAST, rgb_data4, spi_lcd, blsp_uart_tx_b2,
			gcc_gp3_clk_a, qdss_tracedata_a, NA, NA, NA, NA),
	[40] = PINGROUP(40, EAST, rgb_data5, spi_lcd, blsp_uart_rx_b2, NA,
			qdss_tracedata_b, NA, NA, NA, NA),
	[41] = PINGROUP(41, EAST, rgb_data0, blsp_i2c_sda_b2, NA,
			qdss_tracedata_b, NA, NA, NA, NA, NA),
	[42] = PINGROUP(42, EAST, rgb_data1, blsp_i2c_scl_b2, NA, NA, NA, NA,
			NA, qdss_tracedata_a, NA),
	[43] = PINGROUP(43, EAST, rgb_data2, pwm_led11, NA, NA, NA, NA, NA, NA,
			NA),
	[44] = PINGROUP(44, EAST, rgb_data3, pwm_led12, blsp_spi5, NA, NA, NA,
			NA, NA, NA),
	[45] = PINGROUP(45, EAST, rgb_data4, pwm_led13, blsp_spi5,
			qdss_tracedata_b, NA, NA, NA, NA, NA),
	[46] = PINGROUP(46, EAST, rgb_data5, pwm_led14, blsp_spi5,
			qdss_tracedata_b, NA, wlan1_adc1, NA, NA, NA),
	[47] = PINGROUP(47, EAST, rgb_data_b0, pwm_led15, blsp_spi_mosi_b1,
			qdss_tracedata_b, NA, wlan1_adc0, NA, NA, NA),
	[48] = PINGROUP(48, EAST, rgb_data_b1, pwm_led16, blsp_spi_miso_b1, NA,
			qdss_cti_trig_out_b0, NA, wlan2_adc1, NA, NA),
	[49] = PINGROUP(49, EAST, rgb_data_b2, pwm_led17, blsp_spi_cs_n_b1, NA,
			qdss_tracedata_b, NA, wlan2_adc0, NA, NA),
	[50] = PINGROUP(50, EAST, rgb_data_b3, pwm_led18, blsp_spi_clk_b1,
			qdss_tracedata_b, NA, NA, NA, NA, NA),
	[51] = PINGROUP(51, EAST, rgb_data_b4, pwm_led19, ext_mclk1_b,
			qdss_traceclk_a, NA, NA, NA, NA, NA),
	[52] = PINGROUP(52, EAST, rgb_data_b5, pwm_led20, atest_char3,
			i2s_3_sck_b, ldo_update, bimc_dte0, NA, NA, NA),
	[53] = PINGROUP(53, EAST, rgb_hsync, pwm_led21, i2s_3_ws_b, dbg_out,
			NA, NA, NA, NA, NA),
	[54] = PINGROUP(54, EAST, rgb_vsync, i2s_3_data0_b, ldo_en, bimc_dte0,
			NA, hdmi_dtest, NA, NA, NA),
	[55] = PINGROUP(55, EAST, rgb_de, i2s_3_data1_b, NA, qdss_tracedata_b,
			NA, hdmi_lbk9, NA, NA, NA),
	[56] = PINGROUP(56, EAST, rgb_clk, atest_char1, i2s_3_data2_b, ebi_cdc,
			NA, hdmi_lbk8, NA, NA, NA),
	[57] = PINGROUP(57, EAST, rgb_mdp, atest_char0, i2s_3_data3_b, NA,
			hdmi_lbk7, NA, NA, NA, NA),
	[58] = PINGROUP(58, EAST, rgb_data_b6, NA, ebi_cdc, NA, NA, NA, NA, NA,
			NA),
	[59] = PINGROUP(59, EAST, rgb_data_b7, NA, hdmi_lbk6, NA, NA, NA, NA,
			NA, NA),
	[60] = PINGROUP(60, NORTH, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	[61] = PINGROUP(61, NORTH, rgmii_int, cri_trng1, qdss_tracedata_b, NA,
			NA, NA, NA, NA, NA),
	[62] = PINGROUP(62, NORTH, rgmii_wol, cri_trng0, qdss_tracedata_b,
			gcc_tlmm, NA, NA, NA, NA, NA),
	[63] = PINGROUP(63, NORTH, rgmii_ck, NA, NA, NA, NA, NA, NA, NA, NA),
	[64] = PINGROUP(64, NORTH, rgmii_tx, NA, hdmi_lbk5, NA, NA, NA, NA, NA,
			NA),
	[65] = PINGROUP(65, NORTH, rgmii_tx, NA, hdmi_pixel, NA, NA, NA, NA,
			NA, NA),
	[66] = PINGROUP(66, NORTH, rgmii_tx, NA, hdmi_rcv, NA, NA, NA, NA, NA,
			NA),
	[67] = PINGROUP(67, NORTH, rgmii_tx, NA, hdmi_lbk4, NA, NA, NA, NA, NA,
			NA),
	[68] = PINGROUP(68, NORTH, rgmii_ctl, NA, NA, NA, NA, NA, NA, NA, NA),
	[69] = PINGROUP(69, NORTH, rgmii_ck, ext_lpass, NA, NA, NA, NA, NA, NA,
			NA),
	[70] = PINGROUP(70, NORTH, rgmii_rx, cri_trng, NA, NA, NA, NA, NA, NA,
			NA),
	[71] = PINGROUP(71, NORTH, rgmii_rx, NA, hdmi_lbk3, NA, NA, NA, NA, NA,
			NA),
	[72] = PINGROUP(72, NORTH, rgmii_rx, NA, hdmi_lbk2, NA, NA, NA, NA, NA,
			NA),
	[73] = PINGROUP(73, NORTH, rgmii_rx, NA, NA, NA, NA,
			qdss_cti_trig_out_b1, NA, NA, NA),
	[74] = PINGROUP(74, NORTH, rgmii_ctl, NA, NA, NA, NA, NA, NA, NA, NA),
	[75] = PINGROUP(75, NORTH, rgmii_mdio, NA, hdmi_lbk1, NA, NA, NA, NA,
			NA, NA),
	[76] = PINGROUP(76, NORTH, rgmii_mdc, NA, NA, NA, NA, NA, hdmi_lbk0,
			NA, NA),
	[77] = PINGROUP(77, NORTH, ir_in, wsa_en, NA, NA, NA, NA, NA, NA, NA),
	[78] = PINGROUP(78, EAST, rgb_data6, NA, NA, NA, NA, NA, NA, NA, NA),
	[79] = PINGROUP(79, EAST, rgb_data7, NA, NA, NA, NA, NA, NA, NA, NA),
	[80] = PINGROUP(80, EAST, rgb_data6, atest_char2, NA, NA, NA, NA, NA,
			NA, NA),
	[81] = PINGROUP(81, EAST, rgb_data7, ebi_ch0, NA, NA, NA, NA, NA, NA,
			NA),
	[82] = PINGROUP(82, NORTH, blsp_uart3, blsp_spi3, sd_write, NA, NA, NA,
			NA, NA, qdss_tracedata_a),
	[83] = PINGROUP(83, NORTH, blsp_uart3, blsp_spi3, NA, NA, NA, NA,
			qdss_tracedata_a, NA, NA),
	[84] = PINGROUP(84, NORTH, blsp_uart3, blsp_i2c3, blsp_spi3,
			gcc_gp1_clk_a, qdss_cti_trig_in_b1, NA, NA, NA, NA),
	[85] = PINGROUP(85, NORTH, blsp_uart3, blsp_i2c3, blsp_spi3,
	...
	[95] = PINGROUP(95, EAST, i2s_1, pwm_led1, i2s_1, NA,
			qdss_cti_trig_out_a1, NA, NA, NA, NA),
	[96] = PINGROUP(96, EAST, i2s_1, pwm_led2, NA, NA, NA, NA, NA, NA, NA),
	[97] = PINGROUP(97, EAST, i2s_2, NA, NA, NA, NA, NA, NA, NA, NA),
	[98] = PINGROUP(98, EAST, i2s_2, NA, NA, NA, NA, NA, NA, NA, NA),
	[99] = PINGROUP(99, EAST, i2s_2, NA, NA, NA, NA, NA, NA, NA, NA),
	[100] = PINGROUP(100, EAST, i2s_2, pll_bist, NA, NA, NA, NA, NA, NA,
			 NA),
	[101] = PINGROUP(101, EAST, i2s_2, NA, NA, NA, NA, NA, NA, NA, NA),
	[102] = PINGROUP(102, EAST, i2s_2, NA, NA, NA, NA, NA, NA, NA, NA),
	[103] = PINGROUP(103, EAST, ext_mclk1_a, mclk_in2, bimc_dte1, NA, NA,
			 NA, NA, NA, NA),
	[104] = PINGROUP(104, EAST, i2s_3_sck_a, NA, NA, NA, NA, NA, NA, NA,
			 NA),
	[105] = PINGROUP(105, EAST, i2s_3_ws_a, NA, NA, NA, NA, NA, NA, NA, NA),
	[106] = PINGROUP(106, EAST, i2s_3_data0_a, ebi2_lcd, hdmi_hot, NA,
			ebi_cdc, NA, NA, NA, NA),
	[107] = PINGROUP(107, EAST, i2s_3_data1_a, ebi2_lcd, NA, NA, ebi_cdc,
			 NA, NA, NA, NA),
	[108] = PINGROUP(108, EAST, i2s_3_data2_a, ebi2_lcd, atest_char,
			 pwm_led3, ebi_cdc, NA, NA, NA, NA),
	[109] = PINGROUP(109, EAST, i2s_3_data3_a, ebi2_lcd, pwm_led4,
			 bimc_dte1, NA, NA, NA, NA, NA),
	[110] = PINGROUP(110, EAST, i2s_4_sck, ebi2_a, dsd_clk_b, pwm_led5,
			 NA, NA, NA, NA, NA),
	[111] = PINGROUP(111, EAST, i2s_4_ws, i2s_4_data0_dsd0, pwm_led6,
			 ebi_cdc, NA, NA, NA, NA, NA),
	[112] = PINGROUP(112, EAST, i2s_4_data0, i2s_4_data1_dsd1, pwm_led7,
			 NA, NA, NA, NA, NA, NA),
	[113] = PINGROUP(113, EAST, i2s_4_data1, i2s_4_data2_dsd2, pwm_led8,
			 NA, NA, NA, NA, NA, NA),
	[114] = PINGROUP(114, EAST, i2s_4_data2, i2s_4_data3_dsd3, pwm_led24,
			 NA, NA, NA, NA, NA, NA),
	[115] = PINGROUP(115, EAST, i2s_4_data3, i2s_4_data4_dsd4, NA, NA,
			 NA, NA, NA, NA, NA),
	[116] = PINGROUP(116, EAST, i2s_4_data5_dsd5, spkr_dac0, NA, NA, NA,
			 NA, NA, NA, NA),
	[117] = PINGROUP(117, NORTH, blsp_i2c4, blsp_spi4, pwm_led9, NA, NA,
			 NA, NA, NA, NA),
	[118] = PINGROUP(118, NORTH, blsp_i2c4, blsp_spi4, pwm_led10, NA, NA,
			 NA, NA, NA, NA),
	[119] = PINGROUP(119, EAST, spdifrx_opt, NA, NA, NA, NA, NA, NA, NA,
			 NA),
...
static const struct msm_pinctrl_soc_data qcs405_pinctrl = {
	...
	.functions = qcs405_functions,
	.nfunctions = ARRAY_SIZE(qcs405_functions),
...
{
	return msm_pinctrl_probe(pdev, &qcs405_pinctrl);
}

static const struct of_device_id qcs405_pinctrl_of_match[] = {
	{ .compatible = "qcom,qcs405-pinctrl", },
	{ },
};

static struct platform_driver qcs405_pinctrl_driver = {
	.driver = {
		.name = "qcs405-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = qcs405_pinctrl_of_match,
	},
	.probe = qcs405_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init qcs405_pinctrl_init(void)
{
	return platform_driver_register(&qcs405_pinctrl_driver);
}
arch_initcall(qcs405_pinctrl_init);

static void __exit qcs405_pinctrl_exit(void)
{
	platform_driver_unregister(&qcs405_pinctrl_driver);
}
module_exit(qcs405_pinctrl_exit);

MODULE_DESCRIPTION("QTI qcs405 pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, qcs405_pinctrl_of_match);
