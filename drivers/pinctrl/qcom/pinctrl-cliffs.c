...
#define QUP_1_I3C_0_MODE_OFFSET 0xC7000
#define QUP_0_I3C_1_MODE_OFFSET 0xC8000
#define QUP_0_I3C_4_MODE_OFFSET 0xC9000
#define QUP_0_I3C_6_MODE_OFFSET 0xCA000
#define QUP_1_I3C_1_MODE_OFFSET 0xCB000

static const struct pinctrl_pin_desc cliffs_pins[] = {
...
static const char *const gpio_groups[] = {
	...
	"gpio60",  "gpio61",  "gpio62",  "gpio64",  "gpio65",  "gpio66",
	"gpio67",  "gpio68",  "gpio69",  "gpio70",  "gpio71",  "gpio72",
	"gpio73",  "gpio74",  "gpio75",  "gpio76",  "gpio77",  "gpio78",
	...
	"gpio115", "gpio116", "gpio117", "gpio118", "gpio119", "gpio121",
...
static const char *const egpio_groups[] = {
	"gpio0",   "gpio1",   "gpio2",   "gpio3",   "gpio139", "gpio140",
	"gpio141", "gpio142", "gpio143", "gpio144", "gpio145", "gpio146",
	"gpio147", "gpio148", "gpio149", "gpio150", "gpio151", "gpio152",
	"gpio153", "gpio154", "gpio155", "gpio156", "gpio157", "gpio158",
	"gpio159", "gpio160", "gpio161", "gpio162", "gpio163", "gpio164",
...
static const char *const ibi_i3c_groups[] = {
	"gpio0",  "gpio1",  "gpio4",  "gpio5",  "gpio16",
	"gpio17", "gpio24", "gpio25", "gpio36", "gpio37",
};
...
static const char *const qdss_cti_groups[] = {
	"gpio24", "gpio25", "gpio40", "gpio41",
	"gpio42", "gpio43", "gpio56", "gpio59",
};
...
static const struct msm_function cliffs_functions[] = {
	FUNCTION(gpio),
...
static const struct msm_pingroup cliffs_groups[] = {
	...
	[4] = PINGROUP(4, qup0_se1_l0, ibi_i3c, gcc_gp3, qdss_gpio15, NA, NA,
		       NA, NA, NA, NA, NA, 0, -1),
	[5] = PINGROUP(5, qup0_se1_l1, ibi_i3c, qdss_gpio13, NA, NA, NA, NA, NA,
		       NA, NA, NA, 0, -1),
	[6] = PINGROUP(6, qup0_se1_l2, NA, phase_flag31, NA, NA, NA, NA, NA, NA,
		       NA, NA, 0, -1),
	[7] = PINGROUP(7, qup0_se1_l3, NA, phase_flag30, NA, NA, NA, NA, NA, NA,
		       NA, NA, 0, -1),
	[8] = PINGROUP(8, qup0_se2_l0, NA, phase_flag29, NA, NA, NA, NA, NA, NA,
		       NA, NA, 0, -1),
	[9] = PINGROUP(9, qup0_se2_l1, NA, phase_flag28, NA, NA, NA, NA, NA, NA,
		       NA, NA, 0, -1),
	[10] = PINGROUP(10, qup0_se2_l2, NA, phase_flag27, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[11] = PINGROUP(11, qup0_se2_l3, NA, phase_flag26, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[12] = PINGROUP(12, cci_timer2, qup0_se3_l0, qup0_se1_l4, NA,
			phase_flag25, qdss_gpio, NA, NA, NA, NA, NA, 0, -1),
	[13] = PINGROUP(13, cci_timer3, qup0_se3_l1, qup0_se1_l5, NA,
			phase_flag24, qdss_gpio, NA, NA, NA, NA, NA, 0, -1),
	[14] = PINGROUP(14, cci_timer1, cci_async_in2, qup0_se3_l2, qup0_se1_l6,
			NA, phase_flag23, NA, NA, NA, NA, NA, 0, -1),
	[15] = PINGROUP(15, cci_timer4, cci_async_in1, qup0_se3_l3,
			tgu_ch2_trigout, NA, phase_flag22, qdss_gpio14, NA, NA,
			NA, NA, 0, -1),
	[16] = PINGROUP(16, qup0_se4_l0, ibi_i3c, NA, phase_flag21, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[17] = PINGROUP(17, qup0_se4_l1, ibi_i3c, NA, phase_flag20, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[18] = PINGROUP(18, qup0_se4_l2, NA, phase_flag19, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[19] = PINGROUP(19, qup0_se4_l3, NA, NA, phase_flag18, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[20] = PINGROUP(20, qup0_se5_l0, cci_i2c_sda3, qup0_se2_l4, NA, NA,
			phase_flag17, NA, NA, NA, NA, NA, 0, -1),
	[21] = PINGROUP(21, qup0_se5_l1, cci_i2c_scl3, qup0_se2_l5, NA, NA,
			phase_flag16, NA, NA, NA, NA, NA, 0, -1),
	[22] = PINGROUP(22, qup0_se5_l2, qup0_se2_l6, jitter_bist, NA,
			vsense_trigger_mirnat, atest_usb0, ddr_pxi0, NA, NA, NA,
			NA, 0, -1),
	[23] = PINGROUP(23, qup0_se5_l3, pll_bist_sync, NA, atest_usb00,
			ddr_pxi0, NA, NA, NA, NA, NA, NA, 0, -1),
	[24] = PINGROUP(24, qup0_se6_l0, ibi_i3c, tgu_ch0_trigout, qdss_cti,
			atest_usb01, ddr_pxi1, NA, NA, NA, NA, NA, 0, -1),
	[25] = PINGROUP(25, qup0_se6_l1, ibi_i3c, tgu_ch1_trigout, qdss_cti,
			atest_usb02, ddr_pxi1, NA, NA, NA, NA, NA, 0, -1),
	[26] = PINGROUP(26, qup0_se6_l2, pll_clk_aux, atest_usb03, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[27] = PINGROUP(27, qup0_se6_l3, NA, tsense_pwm1, tsense_pwm2,
			tsense_pwm3, NA, NA, NA, NA, NA, NA, 0, -1),
	[28] = PINGROUP(28, qup0_se7_l0, aoss_cti, tgu_ch3_trigout, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[29] = PINGROUP(29, qup0_se7_l1, aoss_cti, sd_write_protect, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[30] = PINGROUP(30, qup0_se7_l2, cci_async_in0, aoss_cti, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[31] = PINGROUP(31, qup0_se7_l3, aoss_cti, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[32] = PINGROUP(32, qup1_se5_l0, gcc_gp1, gnss_adc0, ddr_pxi2, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[33] = PINGROUP(33, qup1_se5_l1, gcc_gp2, gnss_adc1, ddr_pxi2, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[34] = PINGROUP(34, qup1_se5_l2, gcc_gp3, dbg_out_clk, gnss_adc0,
			ddr_pxi3, NA, NA, NA, NA, NA, NA, 0, -1),
	[35] = PINGROUP(35, qup1_se5_l3, gcc_gp1, gnss_adc1, ddr_pxi3, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[36] = PINGROUP(36, qup1_se1_l0, ibi_i3c, qup1_se1_l2, gcc_gp2, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	...
	[40] = PINGROUP(40, qup1_se2_l0, NA, phase_flag13, qdss_cti, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[41] = PINGROUP(41, qup1_se2_l1, NA, phase_flag12, qdss_cti, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[42] = PINGROUP(42, qup1_se2_l2, NA, phase_flag11, qdss_cti, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[43] = PINGROUP(43, qup1_se2_l3, NA, NA, phase_flag10, qdss_cti, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[44] = PINGROUP(44, qup1_se3_l0, NA, NA, phase_flag9, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[45] = PINGROUP(45, qup1_se3_l1, mdp_vsync_e, NA, NA, phase_flag8, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[46] = PINGROUP(46, qup1_se3_l2, NA, phase_flag7, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	...
	[51] = PINGROUP(51, sdc2_cmd, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			-1),
	[52] = PINGROUP(52, qup0_se0_l0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[53] = PINGROUP(53, qup0_se0_l1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[54] = PINGROUP(54, qup0_se0_l2, nav_gpio3, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[55] = PINGROUP(55, qup0_se0_l3, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[56] = PINGROUP(56, qup1_se6_l0, NA, qdss_cti, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[57] = PINGROUP(57, qup1_se6_l1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[58] = PINGROUP(58, qup1_se6_l2, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[59] = PINGROUP(59, qup1_se6_l3, NA, qdss_cti, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[60] = PINGROUP(60, qup1_se7_l0, qup1_se7_l2, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[61] = PINGROUP(61, qup1_se7_l1, qup1_se7_l3, vfr_0, ddr_bist_fail, NA,
			phase_flag5, NA, NA, NA, NA, NA, 0, -1),
	[62] = PINGROUP(62, sdc2_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			-1),
	[63] = PINGROUP(63, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[64] = PINGROUP(64, cam_mclk, cri_trng0, qdss_gpio0, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[65] = PINGROUP(65, cam_mclk, cri_trng1, qdss_gpio1, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[66] = PINGROUP(66, cam_mclk, prng_rosc0, qdss_gpio2, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[67] = PINGROUP(67, cam_mclk, qdss_gpio3, NA, NA, NA, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[68] = PINGROUP(68, cam_aon_mclk4, prng_rosc1, qdss_gpio4, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[69] = PINGROUP(69, cam_mclk, tmess_prng3, qdss_gpio5, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	[70] = PINGROUP(70, cci_i2c_sda0, tmess_prng2, qdss_gpio6, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[71] = PINGROUP(71, cci_i2c_scl0, qdss_gpio7, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[72] = PINGROUP(72, cci_i2c_sda1, tmess_prng1, qdss_gpio8, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[73] = PINGROUP(73, cci_i2c_scl1, tmess_prng0, qdss_gpio9, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[74] = PINGROUP(74, cci_i2c_sda2, prng_rosc3, qdss_gpio10, NA, NA, NA,
			NA, NA, NA, NA, NA, 0, -1),
	[75] = PINGROUP(75, cci_i2c_scl2, qdss_gpio11, NA, NA, NA, NA, NA, NA,
			NA, NA, NA, 0, -1),
	[76] = PINGROUP(76, cci_timer0, prng_rosc2, qdss_gpio12, NA, NA, NA, NA,
			NA, NA, NA, NA, 0, -1),
	...
	[79] = PINGROUP(79, qspi0_clk, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[80] = PINGROUP(80, atest_char3, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	...
	[121] = PINGROUP(121, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			 -1),
	[122] = PINGROUP(122, usb0_phy_ps, NA, phase_flag0, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[123] = PINGROUP(123, i2s1_sck, qdss_gpio4, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[124] = PINGROUP(124, i2s1_data0, qdss_gpio10, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[125] = PINGROUP(125, i2s1_ws, qdss_gpio14, NA, NA, NA, NA, NA, NA, NA,
			 NA, NA, 0, -1),
	[126] = PINGROUP(126, i2s1_data1, audio_ext_mclk1, audio_ref_clk, NA,
			 NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[127] = PINGROUP(127, audio_ext_mclk0, dp0_hot, NA, NA, NA, NA, NA, NA,
			 NA, NA, NA, 0, -1),
	[128] = PINGROUP(128, i2s0_sck, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[129] = PINGROUP(129, i2s0_ws, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[130] = PINGROUP(130, i2s0_data0, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	[131] = PINGROUP(131, i2s0_data1, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
	...
	[136] = PINGROUP(136, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0,
			 -1),
	[137] = PINGROUP(137, ddr_bist_complete, NA, phase_flag3, NA, NA, NA,
			 NA, NA, NA, NA, NA, 0, -1),
	[138] = PINGROUP(138, qspi0_cs1_n, NA, NA, NA, NA, NA, NA, NA, NA, NA,
			 NA, 0, -1),
...
static struct pinctrl_qup cliffs_qup_regs[] = {
	...
	QUP_I3C(3, QUP_0_I3C_4_MODE_OFFSET),
	QUP_I3C(4, QUP_0_I3C_6_MODE_OFFSET),
	QUP_I3C(5, QUP_1_I3C_1_MODE_OFFSET),
};

static const struct msm_gpio_wakeirq_map cliffs_pdc_map[] = {
	{ 0, 56 },    { 3, 100 },   { 4, 57 },    { 7, 58 },    { 11, 64 },
	{ 12, 61 },   { 14, 59 },   { 15, 62 },   { 16, 60 },   { 19, 63 },
	{ 20, 75 },   { 21, 88 },   { 22, 66 },   { 23, 67 },   { 24, 68 },
	{ 27, 69 },   { 29, 70 },   { 31, 55 },   { 32, 76 },   { 34, 53 },
	{ 35, 77 },   { 36, 78 },   { 39, 116 },  { 40, 79 },   { 43, 80 },
	{ 44, 81 },   { 47, 86 },   { 49, 115 },  { 51, 117 },  { 52, 89 },
	{ 54, 90 },   { 55, 84 },   { 56, 72 },   { 59, 96 },   { 60, 97 },
	{ 61, 98 },   { 69, 92 },   { 76, 104 },  { 77, 106 },  { 78, 107 },
	{ 80, 54 },   { 81, 91 },   { 83, 108 },  { 87, 109 },  { 91, 110 },
	{ 92, 111 },  { 95, 112 },  { 99, 125 },  { 100, 51 },  { 101, 114 },
	{ 111, 144 }, { 112, 73 },  { 113, 124 }, { 115, 52 },  { 116, 145 },
	{ 117, 65 },  { 118, 146 }, { 121, 118 }, { 122, 119 }, { 128, 120 },
	{ 129, 121 }, { 130, 122 }, { 131, 123 }, { 133, 105 }, { 135, 93 },
	{ 136, 74 },  { 137, 71 },  { 138, 82 },  { 140, 126 }, { 143, 127 },
	{ 145, 128 }, { 146, 129 }, { 148, 102 }, { 150, 130 }, { 151, 95 },
	{ 152, 113 }, { 155, 103 }, { 157, 131 }, { 158, 132 }, { 160, 133 },
	{ 161, 134 }, { 162, 135 }, { 163, 136 }, { 165, 137 }, { 166, 138 },
	{ 167, 139 }, { 168, 85 },  { 169, 94 },  { 170, 140 }, { 171, 141 },
	{ 172, 143 }, { 173, 142 }, { 174, 99 },  { 175, 101 }, { 176, 87 },
	{ 177, 83 },
};

static const struct msm_pinctrl_soc_data cliffs_pinctrl = {
	.pins = cliffs_pins,
	...
	.nwakeirq_map = ARRAY_SIZE(cliffs_pdc_map),
	.egpio_func = 11,
};
...
static int cliffs_pinctrl_probe(struct platform_device *pdev)
{
...
static struct platform_driver cliffs_pinctrl_driver = {
	.driver = {
		.name = "cliffs-pinctrl",
...
static int __init cliffs_pinctrl_init(void)
{
	return platform_driver_register(&cliffs_pinctrl_driver);
}
arch_initcall(cliffs_pinctrl_init);

static void __exit cliffs_pinctrl_exit(void)
{
	platform_driver_unregister(&cliffs_pinctrl_driver);
}
module_exit(cliffs_pinctrl_exit);
