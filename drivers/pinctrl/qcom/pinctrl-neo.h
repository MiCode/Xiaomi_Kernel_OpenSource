...
static const unsigned int sdc1_clk_pins[] = { 156 };
static const unsigned int sdc1_cmd_pins[] = { 157 };
static const unsigned int sdc1_data_pins[] = { 158 };
...
static const char * const qdss_cti_groups[] = {
	"gpio28", "gpio29", "gpio38", "gpio38", "gpio47", "gpio48", "gpio53",
	"gpio53", "gpio105", "gpio106", "gpio154", "gpio155",
};
...
static const struct msm_pingroup neo_groups[] = {
	...
	[3] = PINGROUP(3, qup0_se0, qup0_se1, phase_flag28, NA, NA, NA, NA, NA,
		       NA, 0x9C014, 1),
	[4] = PINGROUP(4, qup1_se1, ddr_bist, qdss_gpio6, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	[5] = PINGROUP(5, qup1_se1, ddr_bist, qdss_gpio7, NA, NA, NA, NA, NA,
		       NA, 0, -1),
	[6] = PINGROUP(6, qup1_se1, qdss_gpio8, NA, NA, NA, NA, NA, NA, NA,
		       0x9C008, 3),
	[7] = PINGROUP(7, qup1_se1, qdss_gpio9, NA, NA, NA, NA, NA, NA, NA,
		       0x9C008, 4),
	[8] = PINGROUP(8, qup1_se2, pll_bist, NA, NA, NA, NA, NA, NA, NA,
		       0, -1),
	[9] = PINGROUP(9, qup1_se2, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[10] = PINGROUP(10, qup1_se2, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C008, 5),
	[11] = PINGROUP(11, qup1_se2, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C008, 6),
	...
	[24] = PINGROUP(24, qup1_se4, qdss_gpio0, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[25] = PINGROUP(25, qup1_se4, qdss_gpio1, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[26] = PINGROUP(26, qup1_se4, qdss_gpio2, atest_usb0, NA, NA, NA, NA,
			NA, NA, 0, -1),
	[27] = PINGROUP(27, qup1_se4, qdss_gpio3, atest_usb02, NA, NA, NA, NA,
			NA, NA, 0x9C008, 9),
	...
	[35] = PINGROUP(35, qspi0_cs0, qup1_se3, dp0_hot, NA, NA, NA, NA, NA,
			NA, 0x9C008, 15),
	[36] = PINGROUP(36, qspi02, NA, vsense_trigger, NA, NA, NA, NA, NA, NA,
			0, -1),
	[37] = PINGROUP(37, qspi03, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C00C, 0),
	...
	[42] = PINGROUP(42, qdss_gpio13, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C00C, 3),
	[43] = PINGROUP(43, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 2),
	[44] = PINGROUP(44, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C000, 3),
	[45] = PINGROUP(45, qdss_gpio14, ddr_pxi1, NA, NA, NA, NA, NA, NA, NA,
			0x9C00C, 4),
	[46] = PINGROUP(46, qdss_gpio15, ddr_pxi3, NA, NA, NA, NA, NA, NA, NA,
			0x9C00C, 5),
	...
	[54] = PINGROUP(54, pll_clk, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C000, 5),
	[55] = PINGROUP(55, ddr_pxi2, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[56] = PINGROUP(56, PCIE0_CLK, ddr_pxi0, NA, NA, NA, NA, NA, NA, NA,
			0x9C00C, 8),
	[57] = PINGROUP(57, ddr_pxi0, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C00C, 9),
	[58] = PINGROUP(58, phase_flag4, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	...
	[65] = PINGROUP(65, qdss_gpio0, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C014, 12),
	[66] = PINGROUP(66, qdss_gpio1, NA, NA, NA, NA, NA, NA, NA, NA,
			0x9C014, 13),
	...
	[72] = PINGROUP(72, cam_mclk, prng_rosc0, NA, NA, NA, NA, NA, NA, NA,
			0x9C010, 1),
	[73] = PINGROUP(73, cam_mclk, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[74] = PINGROUP(74, cam_mclk, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[75] = PINGROUP(75, cam_mclk, prng_rosc1, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[76] = PINGROUP(76, cam_mclk, tmess_prng3, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[77] = PINGROUP(77, cci_timer0, tmess_prng2, qdss_gpio4, NA, NA, NA,
			NA, NA, NA, 0x9C018, 0),
	[78] = PINGROUP(78, cci_timer1, cci_i2c, qdss_gpio5, NA, NA, NA, NA,
			NA, NA, 0x9C018, 1),
	[79] = PINGROUP(79, cci_timer2, cci_i2c, tmess_prng1, qdss_gpio6, NA,
			NA, NA, NA, NA, 0x9C018, 2),
	[80] = PINGROUP(80, cci_timer3, cci_i2c, cci_async, tmess_prng0,
			qdss_gpio7, NA, NA, NA, NA, 0, -1),
	[81] = PINGROUP(81, cci_timer4, cci_i2c, cci_async, prng_rosc3,
			qdss_gpio8, NA, NA, NA, NA, 0, -1),
	[82] = PINGROUP(82, cci_async, qdss_gpio9, NA, NA, NA, NA, NA, NA, NA,
			0, -1),
	[83] = PINGROUP(83, cci_i2c, prng_rosc2, qdss_gpio10, NA, NA, NA, NA,
			NA, NA, 0x9C018, 3),
	...
	[92] = PINGROUP(92, cci_i2c, qup1_se0, ibi_i3c, NA, NA, NA, NA, NA, NA,
			0, -1),
	[93] = PINGROUP(93, qup0_se0, phase_flag11, NA, atest_char, NA, NA, NA,
			NA, NA, 0, -1),
	...
	[113] = PINGROUP(113, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C010, 4),
	...
	[124] = PINGROUP(124, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C018, 15),
	...
	[128] = PINGROUP(128, phase_flag1, NA, NA, NA, NA, NA, NA, NA, NA,
			 0, -1),
	[129] = PINGROUP(129, gcc_gp1, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C01C, 1),
	[130] = PINGROUP(130, gcc_gp2, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C01C, 2),
	...
	[139] = PINGROUP(139, phase_flag13, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C01C, 7),
	[140] = PINGROUP(140, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 8),
	[141] = PINGROUP(141, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 9),
	[142] = PINGROUP(142, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[143] = PINGROUP(143, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 10),
	[144] = PINGROUP(144, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 11),
	[145] = PINGROUP(145, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 12),
	[146] = PINGROUP(146, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C01C, 13),
	...
	[150] = PINGROUP(150, phase_flag5, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C01C, 15),
	[151] = PINGROUP(151, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C020, 0),
	[152] = PINGROUP(152, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0, -1),
	[153] = PINGROUP(153, NA, NA, NA, NA, NA, NA, NA, NA, NA, 0x9C020, 1),
	[154] = PINGROUP(154, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C020, 2),
	[155] = PINGROUP(155, qdss_cti, NA, NA, NA, NA, NA, NA, NA, NA,
			 0x9C020, 3),
	[156] = SDC_QDSD_PINGROUP(sdc1_clk, 0x1a0000, 13, 6),
	[157] = SDC_QDSD_PINGROUP(sdc1_cmd, 0x1a0000, 11, 3),
	[158] = SDC_QDSD_PINGROUP(sdc1_data, 0x1a0000, 9, 0),
};
