...
#include "mmqos-mtk.h"
static const struct mtk_node_desc node_descs_mt6789[] = {
...
MASTER_LARB_PORT(M4U_PORT_L4_MINI_MDP_R0_EXT), 8, false, 0x2, SLAVE_LARB(4)),
DEFINE_MNODE(hw_mini_mdp_w0_ext,
MASTER_LARB_PORT(M4U_PORT_L4_MINI_MDP_W0_EXT), 9, true, 0x2, SLAVE_LARB(4)),
/* larb7 */
...
static const char * const comm_muxes_mt6789[] = { "mm" };
static const char * const comm_icc_path_names_mt6789[] = { "icc-bw" };
static const char * const comm_icc_hrt_path_names_mt6789[] = { "icc-hrt-bw" };
static const struct mtk_mmqos_desc mmqos_desc_mt6789 = {
	.nodes = node_descs_mt6789,
	.num_nodes = ARRAY_SIZE(node_descs_mt6789),
	.comm_muxes = comm_muxes_mt6789,
	.comm_icc_path_names = comm_icc_path_names_mt6789,
...
static const struct of_device_id mtk_mmqos_mt6789_of_ids[] = {
{
.compatible = "mediatek,mt6789-mmqos",
.data = &mmqos_desc_mt6789,
},
{}
};
MODULE_DEVICE_TABLE(of, mtk_mmqos_mt6789_of_ids);
static struct platform_driver mtk_mmqos_mt6789_driver = {
.probe = mtk_mmqos_probe,
.remove = mtk_mmqos_remove,
.driver = {
.name = "mtk-mt6789-mmqos",
.of_match_table = mtk_mmqos_mt6789_of_ids,
},
};
module_platform_driver(mtk_mmqos_mt6789_driver);
