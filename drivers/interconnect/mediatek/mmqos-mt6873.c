...
static const struct mtk_node_desc node_descs_mt6873[] = {
	...
	DEFINE_MNODE(larb18, SLAVE_LARB(18), 0, false, 0x0, MASTER_COMMON_PORT(0, 7)),
	...
	DEFINE_MNODE(larb21, SLAVE_LARB(21), 0, true, 0x2, MASTER_COMMON_PORT(0, 7)),
	...
	DEFINE_MNODE(mdp_rdma4,
		MASTER_LARB_PORT(M4U_PORT_L1_DISP_MDP_RDMA4), 7, false, 0x2, SLAVE_LARB(1)),
	DEFINE_MNODE(disp_rdma4,
		MASTER_LARB_PORT(M4U_PORT_L1_DISP_RDMA4), 8, false, 0x2, SLAVE_LARB(1)),
	...
	DEFINE_MNODE(disp_fake0,
		MASTER_LARB_PORT(M4U_PORT_L2_MDP_DISP_FAKE0), false, 8, 0x2, SLAVE_LARB(2)),
	...
	MASTER_LARB_PORT(M4U_PORT_L5_VDEC_LAT0_RG_CTRL_DMA_EXT), 7, false, 0x2, SLAVE_LARB(5)),
	...
	DEFINE_MNODE(jpgenc_c_rdma,
		MASTER_LARB_PORT(M4U_PORT_L7_JPGENC_Q_RDMA), 7, false, 0x1, SLAVE_LARB(7)),
	DEFINE_MNODE(jpgenc_q_table,
		MASTER_LARB_PORT(M4U_PORT_L7_JPGENC_C_TABLE), 7, false, 0x1, SLAVE_LARB(7)),
	...
	DEFINE_MNODE(camsv_1,
		MASTER_LARB_PORT(M4U_PORT_L13_CAM_CAMSV1), 8, true, 0x2, SLAVE_LARB(13)),
	DEFINE_MNODE(camsv_2,
		MASTER_LARB_PORT(M4U_PORT_L13_CAM_CAMSV2), 8, true, 0x2, SLAVE_LARB(13)),
	DEFINE_MNODE(camsv_3,
		MASTER_LARB_PORT(M4U_PORT_L13_CAM_CAMSV3), 8, true, 0x2, SLAVE_LARB(13)),
	...
	DEFINE_MNODE(camsv_0,
		MASTER_LARB_PORT(M4U_PORT_L14_CAM_CAMSV0), 8, true, 0x1, SLAVE_LARB(14)),
	DEFINE_MNODE(ccui,
	...
	DEFINE_MNODE(imgo_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_IMGO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(rrzo_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_RRZO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(cqi_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_CQI_R1_C), 7, false, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(bpci_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_BPCI_R1_C), 7, false, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(yuvo_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_YUVO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(ufdi_r2_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_UFDI_R2_C), 7, false, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(rawi_r2_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_RAWI_R2_C), 7, false, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(rawi_r3_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_RAWI_R3_C), 7, false, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(aao_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_AAO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(afo_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_AFO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(flko_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_FLKO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(lceso_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_LCESO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(crzo_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_CRZO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(ltmso_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_LTMSO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(rsso_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_RSSO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(aaho_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_AAHO_R1_C), 8, true, 0x2, SLAVE_LARB(18)),
	DEFINE_MNODE(lsci_r1_c,
		MASTER_LARB_PORT(M4U_PORT_L18_CAM_LSCI_R1_C), 7, false, 0x2, SLAVE_LARB(18)),
