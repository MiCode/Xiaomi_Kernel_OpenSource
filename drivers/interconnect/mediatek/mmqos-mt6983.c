...
static const struct mtk_node_desc node_descs_mt6983[] = {
	...
	DEFINE_MNODE(imgi_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_IMGI_T1_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(ufdi_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_UFDI_T1_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(imgbi_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_IMGBI_T1_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(imgci_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_IMGCI_T1_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(smti_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_SMTI_T1_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(smti_t4_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_SMTI_T4_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(tncsti_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_TNCSTI_T1_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(tncsti_t4_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_TNCSTI_T4_A), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(yuvo_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_YUVO_T1_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(yuvbo_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_YUVBO_T1_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(yuvco_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_YUVCO_T1_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(timgo_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_TIMGO_T1_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(yuvo_t2_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_YUVO_T2_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(yuvo_t5_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_YUVO_T5_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(imgi_t1_b,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_IMGI_T1_B), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(imgbi_t1_b,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_IMGBI_T1_B), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(imgci_t1_b,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_IMGCI_T1_B), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(smti_t4_b,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_SMTI_T4_B), 8, false, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(tncso_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_TNCSO_T1_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(smto_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_SMTO_T1_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(smto_t4_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_SMTO_T4_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(tncsto_t1_a,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_TNCSTO_T1_A), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(yuvo_t2_b,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_YUVO_T2_B), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(yuvo_t5_b,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_YUVO_T5_B), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(smto_t4_b,
		MASTER_LARB_PORT(M4U_PORT_L9_IMG1_SMTO_T4_B), 9, true, 0x2, SLAVE_LARB(9)),
	DEFINE_MNODE(imgi_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_IMGI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(imgbi_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_IMGBI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(imgci_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_IMGCI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(imgdi_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_IMGDI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(depi_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_DEPI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(dmgi_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_DMGI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(smti_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_SMTI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(reci_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_RECI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(reci_d1_n,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_RECI_D1_N), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(tnrwi_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_TNRWI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(tnrci_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_TNRCI_D1), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(tnrci_d1_n,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_TNRCI_D1_N), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(img4o_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_IMG4O_D1), 9, true, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(img4bo_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_IMG4BO_D1), 9, true, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(smti_d8,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_SMTI_D8), 8, false, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(smto_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_SMTO_D1), 9, true, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(tnrmo_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_TNRMO_D1), 9, true, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(tnrmo_d1_n,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_TNRMO_D1_N), 9, true, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(smto_d8,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_SMTO_D8), 9, true, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(dbgo_d1,
		MASTER_LARB_PORT(M4U_PORT_L10_IMG2_DBGO_D1), 9, true, 0x2, SLAVE_LARB(10)),
	DEFINE_MNODE(l11_wpe_rdma_0,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_RDMA0), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wpe_rdma_1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_RDMA1), 7, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wpe_rdma_4p_0,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_RDMA_4P0), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wpe_rdma_4p_1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_RDMA_4P1), 7, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wpe_cq0,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_CQ0), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wpe_cq1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_CQ1), 9, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_pimgi_p1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_PIMGI_P1), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_pimgbi_p1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_PIMGBI_P1), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_pimgci_p1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_PIMGCI_P1), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_imgi_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_IMGI_T1_C), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_imgbi_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_IMGBI_T1_C), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_imgci_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_IMGCI_T1_C), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_smti_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_SMTI_T1_C), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_smti_t4_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_SMTI_T4_C), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_smti_t6_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_SMTI_T6_C), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_yuvo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_YUVO_T1_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_yuvbo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_YUVBO_T1_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_yuvco_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_YUVCO_T1_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wpe_wdma_0,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_WDMA0), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wpe_wdma_4p_0,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WPE_WDMA_4P0), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_wrot_p1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_WROT_P1), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_tccso_p1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_TCCSO_P1), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_tccsi_p1,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_TCCSI_P1), 8, false, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_timgo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_TIMGO_T1_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_yuvo_t2_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_YUVO_T2_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_yuvo_t5_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_YUVO_T5_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_smto_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_SMTO_T1_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_smto_t4_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_SMTO_T4_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_smto_t6_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_SMTO_T6_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l11_dbgo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L11_IMG2_DBGO_T1_C), 9, true, 0x2, SLAVE_LARB(11)),
	DEFINE_MNODE(l23_wpe_rdma_0,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_RDMA0), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wpe_rdma_1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_RDMA1), 7, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wpe_rdma_4p_0,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_RDMA_4P0), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wpe_rdma_4p_1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_RDMA_4P1), 7, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wpe_cq0,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_CQ0), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wpe_cq1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_CQ1), 9, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_pimgi_p1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_PIMGI_P1), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_pimgbi_p1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_PIMGBI_P1), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_pimgci_p1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_PIMGCI_P1), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_imgi_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_IMGI_T1_C), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_imgbi_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_IMGBI_T1_C), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_imgci_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_IMGCI_T1_C), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_smti_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_SMTI_T1_C), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_smti_t4_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_SMTI_T4_C), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_smti_t6_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_SMTI_T6_C), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_yuvo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_YUVO_T1_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_yuvbo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_YUVBO_T1_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_yuvco_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_YUVCO_T1_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wpe_wdma_0,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_WDMA0), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wpe_wdma_4p_0,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WPE_WDMA_4P0), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_wrot_p1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_WROT_P1), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_tccso_p1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_TCCSO_P1), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_tccsi_p1,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_TCCSI_P1), 8, false, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_timgo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_TIMGO_T1_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_yuvo_t2_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_YUVO_T2_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_yuvo_t5_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_YUVO_T5_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_smto_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_SMTO_T1_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_smto_t4_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_SMTO_T4_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_smto_t6_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_SMTO_T6_C), 9, true, 0x2, SLAVE_LARB(23)),
	DEFINE_MNODE(l23_dbgo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L23_IMG2_DBGO_T1_C), 9, true, 0x2, SLAVE_LARB(23)),
	...
	DEFINE_MNODE(imgadl_0_cqi_e1,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL0_CQI_E1), 8, false, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(imgadl_0_cqi_e2,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL0_CQI_E2), 8, false, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(imgadl_0_ipui_e1,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL0_IPUI_E1), 8, false, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(imgadl_0_ipuo_e1,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL0_IPUO_E1), 9, true, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(imgadl_1_cqi_e1,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL1_CQI_E1), 8, false, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(imgadl_1_cqi_e2,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL1_CQI_E2), 8, false, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(imgadl_1_ipui_e1,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL1_IPUI_E1), 8, false, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(imgadl_1_ipuo_e1,
		MASTER_LARB_PORT(M4U_PORT_L18_IMGADL1_IPUO_E1), 9, true, 0x12, SLAVE_LARB(18)),
	DEFINE_MNODE(vipi_d1,
		MASTER_LARB_PORT(M4U_PORT_L15_IMG2_VIP1_D1), 8, false, 0x12, SLAVE_LARB(15)),
	...
	DEFINE_MNODE(img3o_d1,
		MASTER_LARB_PORT(M4U_PORT_L15_IMG2_IMG3O_D1), 7, true, 0x12, SLAVE_LARB(15)),
	DEFINE_MNODE(img3bo_d1,
		MASTER_LARB_PORT(M4U_PORT_L15_IMG2_IMG3BO_D1), 7, true, 0x12, SLAVE_LARB(15)),
	DEFINE_MNODE(img3co_d1,
		MASTER_LARB_PORT(M4U_PORT_L15_IMG2_IMG3CO_D1), 7, true, 0x12, SLAVE_LARB(15)),
	DEFINE_MNODE(img2o_d1,
		MASTER_LARB_PORT(M4U_PORT_L15_IMG2_IMG2O_D1), 7, true, 0x12, SLAVE_LARB(15)),
	DEFINE_MNODE(smti_d9,
		MASTER_LARB_PORT(M4U_PORT_L15_IMG2_SMTI_D9), 7, false, 0x12, SLAVE_LARB(15)),
	DEFINE_MNODE(smto_d4,
		MASTER_LARB_PORT(M4U_PORT_L15_IMG2_SMTO_D4), 7, true, 0x12, SLAVE_LARB(15)),
	DEFINE_MNODE(feo_d1,
	...
	DEFINE_MNODE(fdvt_rda_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_RDA0), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(fdvt_rdb_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_RDB0), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(fdvt_wra_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_WRA0), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(fdvt_wrb_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_WR0B), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(me_rdma,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_ME_RDMA), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(me_wdma,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_ME_WDMA), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(dvs_rdma,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_DVS_RDMA), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(dvs_wdma,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_DVS_WDMA), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(dvp_rdma,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_DVP_RDMA), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(dvp_wdma,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_DVP_WDMA), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(fdvt_2nd_rda_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_2ND_RDA0), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(fdvt_2nd_rdb_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_2ND_RDB0), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(fdvt_2nd_wra_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_2ND_WRA0), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(fdvt_2nd_wrb_0,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_FDVT_2ND_WRB0), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(dhzei_e1,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_DHZEI_E1), 8, false, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(dhzeo_e1,
		MASTER_LARB_PORT(M4U_PORT_L12_IPE_DHZEO_E1), 9, true, 0x12, SLAVE_LARB(12)),
	DEFINE_MNODE(l22_wpe_rdma_0,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_RDMA0), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wpe_rdma_1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_RDMA1), 7, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wpe_rdma_4p_0,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_RDMA_4P0), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wpe_rdma_4p_1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_RDMA_4P1), 7, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wpe_cq0,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_CQ0), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wpe_cq1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_CQ1), 9, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_pimgi_p1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_PIMGI_P1), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_pimgbi_p1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_PIMGBI_P1), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_pimgci_p1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_PIMGCI_P1), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_imgi_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_IMGI_T1_C), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_imgbi_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_IMGBI_T1_C), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_imgci_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_IMGCI_T1_C), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_smti_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_SMTI_T1_C), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_smti_t4_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_SMTI_T4_C), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_smti_t6_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_SMTI_T6_C), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_yuvo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_YUVO_T1_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_yuvbo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_YUVBO_T1_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_yuvco_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_YUVCO_T1_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wpe_wdma_0,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_WDMA0), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wpe_wdma_4p_0,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WPE_WDMA_4P0), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_wrot_p1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_WROT_P1), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_tccso_p1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_TCCSO_P1), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_tccsi_p1,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_TCCSI_P1), 8, false, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_timgo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_TIMGO_T1_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_yuvo_t2_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_YUVO_T2_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_yuvo_t5_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_YUVO_T5_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_smto_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_SMTO_T1_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_smto_t4_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_SMTO_T4_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_smto_t6_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_SMTO_T6_C), 9, true, 0x12, SLAVE_LARB(22)),
	DEFINE_MNODE(l22_dbgo_t1_c,
		MASTER_LARB_PORT(M4U_PORT_L22_IMG2_DBGO_T1_C), 9, true, 0x12, SLAVE_LARB(22)),
