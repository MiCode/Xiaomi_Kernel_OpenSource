...
static const struct mtk_node_desc node_descs_mt6985[] = {
	...
	DEFINE_MNODE(larb32_disp_postmask0_r,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_POSTMASK0), 7, false, 0x11, SLAVE_LARB(32)),
	...
	DEFINE_MNODE(larb32_disp_oddmr0_dmrr_w,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_ODDMR0_DMRR), 8, false, 0x11, SLAVE_LARB(32)),
	DEFINE_MNODE(larb32_disp_oddmr0_odr_w,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_ODDMR0_ODR), 8, false, 0x11, SLAVE_LARB(32)),
	DEFINE_MNODE(larb32_disp_oddmr0_odw_r,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_ODDMR0_ODW), 9, true, 0x11, SLAVE_LARB(32)),
	DEFINE_MNODE(larb32_disp_wdma1_r,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_WDMA1), 9, true, 0x11, SLAVE_LARB(32)),
	DEFINE_MNODE(larb32_disp_ufbc_wdma1_w,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_UFBC_WDMA1), 9, true, 0x11, SLAVE_LARB(32)),
	/* LARB20 */
