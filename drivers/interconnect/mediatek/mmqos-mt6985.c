...
static const struct mtk_node_desc node_descs_mt6985[] = {
	...
	DEFINE_MNODE(larb22, SLAVE_LARB(22), 0, false, 0x0, MASTER_COMMON_PORT(0, 5)), //LARB11_u1
	...
	DEFINE_MNODE(larb11, SLAVE_LARB(11), 0, false, 0x11, MASTER_COMMON_PORT(1, 5)),
	...
	DEFINE_MNODE(larb3_mdp_rdma0_r,
		MASTER_LARB_PORT(M4U_PORT_L3_MDP_RDMA0), 8, false, 0x11, SLAVE_LARB(3)),
	...
	DEFINE_MNODE(larb3_mdp_rdma2_r,
		MASTER_LARB_PORT(M4U_PORT_L3_MDP_RDMA2), 8, false, 0x11, SLAVE_LARB(3)),
