		...
		struct fpga_phy_instance *instance)
{
	...
	dev_info(u3phy->dev, "a60931 u3phy init\n");
		...
		struct fpga_phy_instance *instance)
{
	...
	dev_info(u3phy->dev, "a60810 u3phy init\n");
...
MODULE_DESCRIPTION("Mediatek usb fpga phy driver");
MODULE_LICENSE("GPL");
