...
#include "phy-qcom-ufs-qmp-v4-parrot.h"

#define UFS_PHY_NAME "ufs_phy_qmp_v4_parrot"
...
static struct platform_driver ufs_qcom_phy_qmp_v4_driver = {
	...
	.driver = {
		...
		.name = "ufs_qcom_phy_qmp_v4_parrot",
	},
};

module_platform_driver(ufs_qcom_phy_qmp_v4_driver);

MODULE_DESCRIPTION("Universal Flash Storage (UFS) QCOM PHY QMP v4 PARROT");
