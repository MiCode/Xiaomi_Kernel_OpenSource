...
#ifndef _SPRD_CORESIGHT_CORESIGHT_ETM_H
#define _SPRD_CORESIGHT_CORESIGHT_ETM_H
...
#define read_etm4x_sysreg_offset(offset, _64bit)				\
	({									\
		...
		if (__builtin_constant_p((offset)))				\
			...
			__val = sprd_etm4x_sysreg_read((offset), true, (_64bit));	\
		__val;								\
	 })
...
#define write_etm4x_sysreg_offset(val, offset, _64bit)			\
	do {								\
		if (__builtin_constant_p((offset)))			\
			...
			sprd_etm4x_sysreg_write((val), (offset), true,	\
					   (_64bit));			\
	} while (0)
...
void sprd_etm4_config_trace_mode(struct etmv4_config *config);

u64 sprd_etm4x_sysreg_read(u32 offset, bool _relaxed, bool _64bit);
void sprd_etm4x_sysreg_write(u64 val, u32 offset, bool _relaxed, bool _64bit);
