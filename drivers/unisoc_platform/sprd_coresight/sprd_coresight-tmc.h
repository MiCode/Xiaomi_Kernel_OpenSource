...
#ifndef _SPRD_CORESIGHT_TMC_H
#define _SPRD_CORESIGHT_TMC_H
...
/* ETB/ETF functions */
int sprd_tmc_read_prepare_etb(struct tmc_drvdata *drvdata);
int sprd_tmc_read_unprepare_etb(struct tmc_drvdata *drvdata);
extern const struct coresight_ops tmc_etb_cs_ops;
extern const struct coresight_ops tmc_etf_cs_ops;

ssize_t sprd_tmc_etb_get_sysfs_trace(struct tmc_drvdata *drvdata,
				loff_t pos, size_t len, char **bufpp);
/* ETR functions */
int tmc_read_prepare_etr(struct tmc_drvdata *drvdata);
int tmc_read_unprepare_etr(struct tmc_drvdata *drvdata);
void sprd_tmc_etr_disable_hw(struct tmc_drvdata *drvdata);
extern const struct coresight_ops tmc_etr_cs_ops;
ssize_t sprd_tmc_etr_get_sysfs_trace(struct tmc_drvdata *drvdata,
				loff_t pos, size_t len, char **bufpp);
...
void sprd_tmc_etr_set_catu_ops(const struct etr_buf_operations *catu);
void sprd_tmc_etr_remove_catu_ops(void);
