...
#include "ufsffu.h"
#include "sd.h"
#include "hynix_A003.h"
#include "hynix_A002.h"
/* N17 code for HQ-295520 by gaoshilin at 20230512 start */
#include "KM8L9001JM_B624_0700_UFS2_2.h"
/* N17 code for HQ-295520 by gaoshilin at 20230512 end */
/* N17 code for HQ-295517 by gaoshilin at 20230512 start */
#include "MICRON_FW_0107.h"
/* N17 code for HQ-295517 by gaoshilin at 20230512 end */
/* N17 code for HQ-295521 by gaoshilin at 20230512 start */
#include "KM8F9001JM_B813_0700_UFS2_2.h"
/* N17 code for HQ-295521 by gaoshilin at 20230512 end */
...
static struct fw_update_checklist need_update_k[] = {
	...
	{"SKhynix", "H9QT0GECN6X145", "A002", "A003",
	(uint64_t)HYNIX_FW_A003, sizeof(HYNIX_FW_A003)},
	{"SKhynix", "H9QT0GECN6X145", "A001", "A002",
	(uint64_t)HYNIX_FW_A002, sizeof(HYNIX_FW_A002)},
	{"SKhynix", "H9QT0G6CN6X146", "A002", "A003",
	(uint64_t)HYNIX_FW_A003, sizeof(HYNIX_FW_A003)},
	...
	(uint64_t)HYNIX_FW_A002, sizeof(HYNIX_FW_A002)},
	/* N17 code for HQ-295520 by gaoshilin at 20230512 start */
	{"SAMSUNG", "KM8L9001JM-B624", "0300","0700",
	(uint64_t)KM8L9001JM_B624_0700_UFS2_2, sizeof(KM8L9001JM_B624_0700_UFS2_2)},
	/* N17 code for HQ-295520 by gaoshilin at 20230512 end */
	/* N17 code for HQ-295517 by gaoshilin at 20230512 start */
	{"MICRON", "MT128GAXAU2U227X", "0101", "0107",
	(uint64_t)MICRON_FW_0107, sizeof(MICRON_FW_0107)},
	/* N17 code for HQ-295517 by gaoshilin at 20230512 end */
	/* N17 code for HQ-295521 by gaoshilin at 20230512 start */
	{"SAMSUNG", "KM8F9001JM-B813", "0100","0700",
	(uint64_t)KM8F9001JM_B813_0700_UFS2_2, sizeof(KM8F9001JM_B813_0700_UFS2_2)},
	/* N17 code for HQ-295521 by gaoshilin at 20230512 end */
};
...
static bool get_ffu_partition_info(struct ffu_data *ffudata)
{
	...
	pr_err("[ufs_ffu] ptbl->len = %d, part_number = %d\n",ptbl->len,part_number);
