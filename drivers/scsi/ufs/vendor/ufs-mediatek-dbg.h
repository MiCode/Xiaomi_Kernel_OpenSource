...
void probe_ufshcd_tm_command_trace(struct ufs_hba *hba,
						 unsigned int tag, const char *str);
void probe_ufshcd_utp_command_trace(const char *dev_name,
				 const char *str, unsigned int tag,
				 u32 doorbell, int transfer_len,
				 u32 intr, u64 lba, u8 opcode, u8 group_id);
void probe_ufshcd_uic_command_trace(const char *dev_name,
				     const char *str, u32 cmd,
				     u32 arg1, u32 arg2, u32 arg3);
void probe_ufshcd_clk_gating_trace(const char *dev_name,
				    int state);
