...
static const struct of_device_id of_match_clk_mt6886_bus[] = {
	{
		.compatible = "mediatek,mt6886-infracfg_ao",
		.data = &ifrao_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6886_bus_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6886_bus_drv = {
	.probe = clk_mt6886_bus_grp_probe,
	.driver = {
		.name = "clk-mt6886-bus",
		.of_match_table = of_match_clk_mt6886_bus,
	},
};

module_platform_driver(clk_mt6886_bus_drv);
MODULE_LICENSE("GPL");
