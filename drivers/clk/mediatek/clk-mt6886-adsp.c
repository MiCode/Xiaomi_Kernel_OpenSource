...
static const struct of_device_id of_match_clk_mt6886_adsp[] = {
	{
		.compatible = "mediatek,mt6886-audiosys",
		.data = &afe_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6886_adsp_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6886_adsp_drv = {
	.probe = clk_mt6886_adsp_grp_probe,
	.driver = {
		.name = "clk-mt6886-adsp",
		.of_match_table = of_match_clk_mt6886_adsp,
	},
};

module_platform_driver(clk_mt6886_adsp_drv);
MODULE_LICENSE("GPL");
