...
static int __init clk_mt6853_mm_init(void)
{
	return platform_driver_register(&clk_mt6853_mm_drv);
}

static void __exit clk_mt6853_mm_exit(void)
{
	platform_driver_unregister(&clk_mt6853_mm_drv);
}

arch_initcall(clk_mt6853_mm_init);
module_exit(clk_mt6853_mm_exit);
MODULE_LICENSE("GPL");
