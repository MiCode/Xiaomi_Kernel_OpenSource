...
static const struct mtk_gate mm_clks[] = {
	GATE_MM(CLK_MM_DISP_MUTEX0, "mm_disp_mutex0",
			"disp_ck"/* parent */, 0),
	GATE_MM(CLK_MM_APB_BUS, "mm_apb_bus",
			"disp_ck"/* parent */, 1),
	GATE_MM(CLK_MM_DISP_OVL0, "mm_disp_ovl0",
			"disp_ck"/* parent */, 2),
	GATE_MM(CLK_MM_DISP_RDMA0, "mm_disp_rdma0",
			"disp_ck"/* parent */, 3),
	GATE_MM(CLK_MM_DISP_OVL0_2L, "mm_disp_ovl0_2l",
			"disp_ck"/* parent */, 4),
	GATE_MM(CLK_MM_DISP_WDMA0, "mm_disp_wdma0",
			"disp_ck"/* parent */, 5),
	GATE_MM(CLK_MM_DISP_CCORR1, "mm_disp_ccorr1",
			"disp_ck"/* parent */, 6),
	GATE_MM(CLK_MM_DISP_RSZ0, "mm_disp_rsz0",
			"disp_ck"/* parent */, 7),
	...
	GATE_MM(CLK_MM_DISP_COLOR0, "mm_disp_color0",
			"disp_ck"/* parent */, 10),
	GATE_MM(CLK_MM_SMI_INFRA, "mm_smi_infra",
			"disp_ck"/* parent */, 11),
	GATE_MM(CLK_MM_DISP_DSC_WRAP, "mm_disp_dsc_wrap",
			"disp_ck"/* parent */, 12),
	GATE_MM(CLK_MM_DISP_GAMMA0, "mm_disp_gamma0",
			"disp_ck"/* parent */, 13),
	GATE_MM(CLK_MM_DISP_POSTMASK0, "mm_disp_postmask0",
			"disp_ck"/* parent */, 14),
	GATE_MM(CLK_MM_DISP_SPR0, "mm_disp_spr0",
			"disp_ck"/* parent */, 15),
	GATE_MM(CLK_MM_DISP_DITHER0, "mm_disp_dither0",
			"disp_ck"/* parent */, 16),
	GATE_MM(CLK_MM_SMI_COMMON, "mm_smi_common",
			"disp_ck"/* parent */, 17),
	GATE_MM(CLK_MM_DISP_CM0, "mm_disp_cm0",
			"disp_ck"/* parent */, 18),
	GATE_MM(CLK_MM_DSI0, "mm_dsi0",
			"disp_ck"/* parent */, 19),
	GATE_MM(CLK_MM_DISP_FAKE_ENG0, "mm_disp_fake_eng0",
			"disp_ck"/* parent */, 20),
	GATE_MM(CLK_MM_DISP_FAKE_ENG1, "mm_disp_fake_eng1",
			"disp_ck"/* parent */, 21),
	GATE_MM(CLK_MM_SMI_GALS, "mm_smi_gals",
			"disp_ck"/* parent */, 22),
	GATE_MM(CLK_MM_SMI_IOMMU, "mm_smi_iommu",
			"disp_ck"/* parent */, 24),
};
...
arch_initcall_sync(clk_mt6853_mm_platform_init);
