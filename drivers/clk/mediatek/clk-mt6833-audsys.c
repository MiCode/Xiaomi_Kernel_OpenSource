...
static int clk_mt6833_audsys_probe(struct platform_device *pdev)
{
...
static const struct of_device_id of_match_clk_mt6833_audsys[] = {
	{ .compatible = "mediatek,mt6833-audio", },
	{}
};
...
builtin_platform_driver(clk_mt6833_audsys_drv);
...
static int __init clk_mt6833_audsys_platform_init(void)
{
	return platform_driver_register(&clk_mt6833_audsys_drv);
}
arch_initcall(clk_mt6833_audsys_platform_init);
