...
static int __init clk_mt8192_cam_rawb_init(void)
{
	return platform_driver_register(&clk_mt8192_cam_rawb_drv);
}

static void __exit clk_mt8192_cam_rawb_exit(void)
{
	platform_driver_unregister(&clk_mt8192_cam_rawb_drv);
}

arch_initcall(clk_mt8192_cam_rawb_init);
module_exit(clk_mt8192_cam_rawb_exit);
MODULE_LICENSE("GPL");
