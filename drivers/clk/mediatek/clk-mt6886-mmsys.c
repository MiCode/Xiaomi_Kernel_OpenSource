...
static const struct mtk_gate mm_clks[] = {
	...
	GATE_MM0(CLK_MM_DISP_DSC_WRAP0, "mm_disp_dsc_wrap0",
			"disp0_ck"/* parent */, 27),
	GATE_MM0(CLK_MM_FMM_DISP_DSI0, "mm_fmm_clk0",
			"disp0_ck"/* parent */, 29),
	...
	GATE_MM1(CLK_MM_DISP_DLI_ASYNC3, "mm_disp_dli_async3",
			"disp0_ck"/* parent */, 9),
	GATE_MM1(CLK_MM_DISP_DLO_ASYNC3, "mm_disp_dlo_async3",
			"disp0_ck"/* parent */, 10),
	...
	GATE_MM1(CLK_MM_SMI_COMMON, "mm_smi_common",
			"disp0_ck"/* parent */, 20),
	/* MM2 */
	GATE_MM2(CLK_MM_DISP_DSI0, "mm_clk0",
			"f26m_ck"/* parent */, 0),
...
static const struct of_device_id of_match_clk_mt6886_mmsys[] = {
	{
		.compatible = "mediatek,mt6886-mmsys0",
		.data = &mm_mcd,
	}, {
		.compatible = "mediatek,mt6886-mminfra_config",
...
static int clk_mt6886_mmsys_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6886_mmsys_drv = {
	.probe = clk_mt6886_mmsys_grp_probe,
	.driver = {
		.name = "clk-mt6886-mmsys",
		.of_match_table = of_match_clk_mt6886_mmsys,
	},
};

module_platform_driver(clk_mt6886_mmsys_drv);
MODULE_LICENSE("GPL");
