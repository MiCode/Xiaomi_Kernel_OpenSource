...
static const struct of_device_id of_match_clk_mt6833_audiosys[] = {
	{
		.compatible = "mediatek,mt6833-afe",
		.data = &afe_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6833_audiosys_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6833_audiosys_drv = {
	.probe = clk_mt6833_audiosys_grp_probe,
	.driver = {
		.name = "clk-mt6833-audiosys",
		.of_match_table = of_match_clk_mt6833_audiosys,
	},
};

module_platform_driver(clk_mt6833_audiosys_drv);
MODULE_LICENSE("GPL");
