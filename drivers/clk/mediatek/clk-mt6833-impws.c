...
builtin_platform_driver(clk_mt6833_impws_drv);
...
static int __init clk_mt6833_impws_platform_init(void)
{
	return platform_driver_register(&clk_mt6833_impws_drv);
}
arch_initcall(clk_mt6833_impws_platform_init);
