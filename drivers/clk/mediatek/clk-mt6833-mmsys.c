...
static const struct of_device_id of_match_clk_mt6833_mmsys[] = {
	{
...
static int clk_mt6833_mmsys_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6833_mmsys_drv = {
	.probe = clk_mt6833_mmsys_grp_probe,
	.driver = {
		.name = "clk-mt6833-mmsys",
		.of_match_table = of_match_clk_mt6833_mmsys,
	},
};

module_platform_driver(clk_mt6833_mmsys_drv);
MODULE_LICENSE("GPL");
