...
#define TOP_MUX_DSP1_SHIFT			9
#define TOP_MUX_DSP2_SHIFT			10
#define TOP_MUX_DSP3_SHIFT			11
#define TOP_MUX_DSP4_SHIFT			12
#define TOP_MUX_DSP5_SHIFT			13
#define TOP_MUX_DSP6_SHIFT			14
#define TOP_MUX_DSP7_SHIFT			15
#define TOP_MUX_IPU_IF_SHIFT			16
#define TOP_MUX_CAMTG_SHIFT			17
...
#define TOP_MUX_UART_SHIFT			23
#define TOP_MUX_SPI_SHIFT			24
#define TOP_MUX_MSDC_MACRO_SHIFT		25
#define TOP_MUX_MSDC30_1_SHIFT			26
...
#define TOP_MUX_UFS_MBIST_SHIFT			13
#define TOP_MUX_AUD_1_SHIFT			14
#define TOP_MUX_AUD_2_SHIFT			15
#define TOP_MUX_ADSP_SHIFT			16
#define TOP_MUX_DPMAIF_MAIN_SHIFT		17
#define TOP_MUX_VENC_SHIFT			18
#define TOP_MUX_VDEC_SHIFT			19
#define TOP_MUX_PWM_SHIFT			20
#define TOP_MUX_AUDIO_H_SHIFT			21
#define TOP_MUX_MCUPM_SHIFT			22
#define TOP_MUX_MEM_SUB_SHIFT			25
#define TOP_MUX_MEM_SUB_PERI_SHIFT		26
#define TOP_MUX_MEM_SUB_UFS_SHIFT		27
#define TOP_MUX_EMI_N_SHIFT			28
#define TOP_MUX_DSI_OCC_SHIFT			30
#define TOP_MUX_CCU_AHB_SHIFT			0
#define TOP_MUX_AP2CONN_HOST_SHIFT		2
#define TOP_MUX_MCU_ACP_SHIFT			3
#define TOP_MUX_DPI_SHIFT			4
#define TOP_MUX_IMG1_SHIFT			5
#define TOP_MUX_IPE_SHIFT			6
#define TOP_MUX_CAM_SHIFT			7
#define TOP_MUX_CCUSYS_SHIFT			8
#define TOP_MUX_CAMTM_SHIFT			9
#define TOP_MUX_SCP_SHIFT			0
#define TOP_MUX_PWRAP_ULPOSC_SHIFT		1
#define TOP_MUX_APXGPT66M_BCLK_SHIFT		2
...
static DEFINE_SPINLOCK(mt6879_clk_lock);
...
static const struct mtk_mux vlp_ck_muxes[] = {
	...
	MUX_CLR_SET_UPD(CLK_VLP_CK_GPT_BCLK_SEL/* dts */, "vlp_gpt_bclk_sel",
		...
		CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_APXGPT66M_BCLK_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_VLP_CK_DXCC_VLP_SEL/* dts */, "vlp_dxcc_vlp_sel",
		...
		CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_DXCC_VLP_SHIFT/* upd shift */),
	/* VLP_CLK_CFG_1 */
	...
	MUX_CLR_SET_UPD(CLK_VLP_CK_APEINT_66M_SEL/* dts */, "vlp_apeint_66m_sel",
		...
		CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_APEINT_66M_SHIFT/* upd shift */),
	...
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_GPT_BCLK_SEL/* dts */, "vlp_gpt_bclk_sel",
		vlp_gpt_bclk_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 16/* lsb */, 1/* width */,
		23/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_APXGPT66M_BCLK_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_DXCC_VLP_SEL/* dts */, "vlp_dxcc_vlp_sel",
		vlp_dxcc_vlp_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_DXCC_VLP_SHIFT/* upd shift */),
	/* VLP_CLK_CFG_1 */
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_SPMI_P_MST_SEL/* dts */, "vlp_spmi_p_mst_sel",
		vlp_spmi_p_mst_parents/* parent */, VLP_CLK_CFG_1, VLP_CLK_CFG_1_SET,
		VLP_CLK_CFG_1_CLR/* set parent */, 0/* lsb */, 4/* width */,
		7/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SPMI_P_MST_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_SPMI_M_MST_SEL/* dts */, "vlp_spmi_m_mst_sel",
		vlp_spmi_m_mst_parents/* parent */, VLP_CLK_CFG_1, VLP_CLK_CFG_1_SET,
		VLP_CLK_CFG_1_CLR/* set parent */, 8/* lsb */, 4/* width */,
		15/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
	...
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_APEINT_66M_SEL/* dts */, "vlp_apeint_66m_sel",
		vlp_apeint_66m_parents/* parent */, VLP_CLK_CFG_3, VLP_CLK_CFG_3_SET,
		VLP_CLK_CFG_3_CLR/* set parent */, 8/* lsb */, 2/* width */,
		15/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_APEINT_66M_SHIFT/* upd shift */),
...
static const struct mtk_mux top_muxes[] = {
	...
	MUX_CLR_SET_UPD(CLK_TOP_DSP2_SEL/* dts */, "dsp2_sel",
		dsp2_parents/* parent */, CLK_CFG_2, CLK_CFG_2_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_DSP3_SEL/* dts */, "dsp3_sel",
		dsp3_parents/* parent */, CLK_CFG_2, CLK_CFG_2_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_DSP6_SEL/* dts */, "dsp6_sel",
		dsp6_parents/* parent */, CLK_CFG_3, CLK_CFG_3_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_DSP7_SEL/* dts */, "dsp7_sel",
		dsp7_parents/* parent */, CLK_CFG_3, CLK_CFG_3_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_DXCC_SEL/* dts */, "dxcc_sel",
		dxcc_parents/* parent */, CLK_CFG_9, CLK_CFG_9_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_ADSP_SEL/* dts */, "adsp_sel",
		adsp_parents/* parent */, CLK_CFG_11, CLK_CFG_11_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_MEM_SUBP_SEL/* dts */, "mem_subp_sel",
		mem_subp_parents/* parent */, CLK_CFG_14, CLK_CFG_14_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_MEM_SUB_U_SEL/* dts */, "mem_sub_u_sel",
		mem_sub_u_parents/* parent */, CLK_CFG_14, CLK_CFG_14_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_AP2CONN_HOST_SEL/* dts */, "ap2conn_host_sel",
		...
		CLK_CFG_16_CLR/* set parent */, 0/* lsb */, 1/* width */,
	...
	MUX_CLR_SET_UPD(CLK_TOP_DPI_SEL/* dts */, "dpi_sel",
		dpi_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
		CLK_CFG_16_CLR/* set parent */, 16/* lsb */, 3/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_DPI_SHIFT/* upd shift */),
	...
	MUX_CLR_SET_UPD(CLK_TOP_CAMTM_SEL/* dts */, "camtm_sel",
		camtm_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_AXI_U_SEL/* dts */, "axi_u_sel",
		...
		CLK_CFG_0_CLR/* set parent */, 16/* lsb */, 3/* width */,
		23/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_AXI_UFS_SHIFT/* upd shift */),
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_DPI_SEL/* dts */, "dpi_sel",
		dpi_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
		CLK_CFG_16_CLR/* set parent */, 16/* lsb */, 3/* width */,
		23/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
...
int clk_mt6879_pll_registration(enum subsys_id id,
...
static int clk_mt6879_apmixed_probe(struct platform_device *pdev)
{
...
{
	return clk_mt6879_pll_registration(MFG_PLL_CTRL, mfg_ao_plls,
			pdev, ARRAY_SIZE(mfg_ao_plls));
}

int clk_mt6879_mux_registration(enum subsys_id id,
		...
		int num_muxes)
{
	...
	clk_data = mtk_alloc_clk_data(num_muxes);

	mtk_clk_register_muxes(muxes, num_muxes, node,
			&mt6879_clk_lock, clk_data);
...
static int clk_mt6879_top_probe(struct platform_device *pdev)
{
	struct clk_onecell_data *clk_data;
	int r;
	struct device_node *node = pdev->dev.of_node;
...
static int clk_mt6879_vlp_ck_probe(struct platform_device *pdev)
{
	struct clk_onecell_data *clk_data;
	int r;
	struct device_node *node = pdev->dev.of_node;
...
static const struct of_device_id of_match_clk_mt6879[] = {
	{
		...
		.compatible = "mediatek,mt6879-topckgen",
		.data = clk_mt6879_top_probe,
	}, {
		.compatible = "mediatek,mt6879-vlp_cksys",
		.data = clk_mt6879_vlp_ck_probe,
	}, {
		/* sentinel */
	}
};

static int clk_mt6879_probe(struct platform_device *pdev)
{
...
static struct platform_driver clk_mt6879_drv = {
	.probe = clk_mt6879_probe,
	.driver = {
		.name = "clk-mt6879",
		.owner = THIS_MODULE,
		.of_match_table = of_match_clk_mt6879,
	},
};

static int __init clk_mt6879_init(void)
{
	return platform_driver_register(&clk_mt6879_drv);
}

static void __exit clk_mt6879_exit(void)
{
	platform_driver_unregister(&clk_mt6879_drv);
}

arch_initcall(clk_mt6879_init);
module_exit(clk_mt6879_exit);
MODULE_LICENSE("GPL");
