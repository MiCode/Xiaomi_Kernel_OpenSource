...
static struct mtk_gate apu0_clks[] __initdata = {
	/* CORE_CG */
	GATE(APU0_APU_CG, "apu0_apu_cg", "dsp1_sel",
			apu0_core_cg_regs, 0, 0),
	GATE(APU0_AXI_M_CG, "apu0_axi_m_cg", "dsp1_sel",
			apu0_core_cg_regs, 1, 0),
	GATE(APU0_JTAG_CG, "apu0_jtag_cg", "dsp1_sel",
...
static struct mtk_gate apu1_clks[] __initdata = {
	/* CORE_CG */
	GATE(APU1_APU_CG, "apu1_apu_cg", "dsp2_sel",
			 apu1_core_cg_regs, 0, 0),
	GATE(APU1_AXI_M_CG, "apu1_axi_m_cg", "dsp2_sel",
			 apu1_core_cg_regs, 1, 0),
	GATE(APU1_JTAG_CG, "apu1_jtag_cg", "dsp2_sel",
...
static struct mtk_gate apu2_clks[] __initdata = {
	/* CORE_CG */
	GATE(APU2_APU_CG, "apu2_apu_cg", "dsp3_sel",
			 apu2_core_cg_regs, 0, 0),
	GATE(APU2_AXI_M_CG, "apu2_axi_m_cg", "dsp3_sel",
			 apu2_core_cg_regs, 1, 0),
	GATE(APU2_JTAG_CG, "apu2_jtag_cg", "dsp3_sel",
...
static struct mtk_gate apusys_vcore_clks[] __initdata = {
	/* APUSYS_VCORE_CG */
	GATE(APUSYS_VCORE_AHB_CG, "apusys_vcore_ahb_cg", "ipu_if_sel",
			 apusys_vcore_apusys_vcore_cg_regs, 0, 0),
	GATE(APUSYS_VCORE_AXI_CG, "apusys_vcore_axi_cg", "ipu_if_sel",
			 apusys_vcore_apusys_vcore_cg_regs, 1, 0),
	GATE(APUSYS_VCORE_ADL_CG, "apusys_vcore_adl_cg", "ipu_if_sel",
			 apusys_vcore_apusys_vcore_cg_regs, 2, 0),
	GATE(APUSYS_VCORE_QOS_CG, "apusys_vcore_qos_cg", "ipu_if_sel",
...
static struct mtk_gate apu_conn_clks[] __initdata = {
	/* APU_CONN_CG */
	GATE(APU_CONN_AHB_CG, "apu_conn_ahb_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 1, 0),
	GATE(APU_CONN_AXI_CG, "apu_conn_axi_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 2, 0),
	GATE(APU_CONN_ISP_CG, "apu_conn_isp_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 3, 0),
	GATE(APU_CONN_CAM_ADL_CG, "apu_conn_cam_adl_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 4, 0),
	GATE(APU_CONN_IMG_ADL_CG, "apu_conn_img_adl_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 5, 0),
	GATE(APU_CONN_EMI_26M_CG, "apu_conn_emi_26m_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 6, 0),
	GATE(APU_CONN_VPU_UDI_CG, "apu_conn_vpu_udi_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 7, 0),
	GATE(APU_CONN_EDMA_0_CG, "apu_conn_edma_0_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 8, 0),
	GATE(APU_CONN_EDMA_1_CG, "apu_conn_edma_1_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 9, 0),
	GATE(APU_CONN_EDMAL_0_CG, "apu_conn_edmal_0_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 10, 0),
	GATE(APU_CONN_EDMAL_1_CG, "apu_conn_edmal_1_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 11, 0),
	GATE(APU_CONN_MNOC_CG, "apu_conn_mnoc_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 12, 0),
	GATE(APU_CONN_TCM_CG, "apu_conn_tcm_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 13, 0),
	GATE(APU_CONN_MD32_CG, "apu_conn_md32_cg", "dsp_sel",
			 apu_conn_apu_conn_cg_regs, 14, 0),
	GATE(APU_CONN_IOMMU_0_CG, "apu_conn_iommu_0_cg", "dsp7_sel",
			 apu_conn_apu_conn_cg_regs, 15, 0),
	GATE(APU_CONN_IOMMU_1_CG, "apu_conn_iommu_1_cg", "dsp7_sel",
			 apu_conn_apu_conn_cg_regs, 16, 0),
	GATE(APU_CONN_MD32_32K_CG, "apu_conn_md32_32k_cg", "dsp_sel",
...
static struct mtk_gate apu_mdla0_clks[] __initdata = {
	/* MDLA_CG */
	GATE(APU_MDLA0_MDLA_CG0, "apu_mdla0_mdla_cg0", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 0, 0),
	GATE(APU_MDLA0_MDLA_CG1, "apu_mdla0_mdla_cg1", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 1, 0),
	GATE(APU_MDLA0_MDLA_CG2, "apu_mdla0_mdla_cg2", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 2, 0),
	GATE(APU_MDLA0_MDLA_CG3, "apu_mdla0_mdla_cg3", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 3, 0),
	GATE(APU_MDLA0_MDLA_CG4, "apu_mdla0_mdla_cg4", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 4, 0),
	GATE(APU_MDLA0_MDLA_CG5, "apu_mdla0_mdla_cg5", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 5, 0),
	GATE(APU_MDLA0_MDLA_CG6, "apu_mdla0_mdla_cg6", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 6, 0),
	GATE(APU_MDLA0_MDLA_CG7, "apu_mdla0_mdla_cg7", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 7, 0),
	GATE(APU_MDLA0_MDLA_CG8, "apu_mdla0_mdla_cg8", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 8, 0),
	GATE(APU_MDLA0_MDLA_CG9, "apu_mdla0_mdla_cg9", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 9, 0),
	GATE(APU_MDLA0_MDLA_CG10, "apu_mdla0_mdla_cg10", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 10, 0),
	GATE(APU_MDLA0_MDLA_CG11, "apu_mdla0_mdla_cg11", "dsp6_sel",
			 apu_mdla0_mdla_cg_regs, 11, 0),
	GATE(APU_MDLA0_MDLA_CG12, "apu_mdla0_mdla_cg12", "dsp6_sel",
...
static struct mtk_gate apu_mdla1_clks[] __initdata = {
	/* MDLA_CG */
	GATE(APU_MDLA1_MDLA_CG0, "apu_mdla1_mdla_cg0", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 0, 0),
	GATE(APU_MDLA1_MDLA_CG1, "apu_mdla1_mdla_cg1", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 1, 0),
	GATE(APU_MDLA1_MDLA_CG2, "apu_mdla1_mdla_cg2", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 2, 0),
	GATE(APU_MDLA1_MDLA_CG3, "apu_mdla1_mdla_cg3", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 3, 0),
	GATE(APU_MDLA1_MDLA_CG4, "apu_mdla1_mdla_cg4", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 4, 0),
	GATE(APU_MDLA1_MDLA_CG5, "apu_mdla1_mdla_cg5", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 5, 0),
	GATE(APU_MDLA1_MDLA_CG6, "apu_mdla1_mdla_cg6", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 6, 0),
	GATE(APU_MDLA1_MDLA_CG7, "apu_mdla1_mdla_cg7", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 7, 0),
	GATE(APU_MDLA1_MDLA_CG8, "apu_mdla1_mdla_cg8", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 8, 0),
	GATE(APU_MDLA1_MDLA_CG9, "apu_mdla1_mdla_cg9", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 9, 0),
	GATE(APU_MDLA1_MDLA_CG10, "apu_mdla1_mdla_cg10", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 10, 0),
	GATE(APU_MDLA1_MDLA_CG11, "apu_mdla1_mdla_cg11", "dsp6_sel",
			 apu_mdla1_mdla_cg_regs, 11, 0),
	GATE(APU_MDLA1_MDLA_CG12, "apu_mdla1_mdla_cg12", "dsp6_sel",
...
static const struct mtk_gate infra_clks[] __initconst = {
	...
	GATE_INV(INFRACFG_AO_AUXADC_CG, "infracfg_ao_auxadc_cg",
			"f26m_sel",	/* Invert */
			 infracfg_ao_module_sw_cg_1_regs, 10, 1),
	...
	GATE_INV(INFRACFG_AO_AUXADC_MD_CG, "infracfg_ao_auxadc_md_cg",
			"f26m_sel",	/* Invert */
			 infracfg_ao_module_sw_cg_1_regs, 14, 1),
