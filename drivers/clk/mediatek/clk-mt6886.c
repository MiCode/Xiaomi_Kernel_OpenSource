...
#define TOP_MUX_UART_SHIFT			22
#define TOP_MUX_SPI_SHIFT			23
#define TOP_MUX_MSDC_MACRO_SHIFT		24
#define TOP_MUX_MSDC30_1_SHIFT			25
#define TOP_MUX_MSDC30_2_SHIFT			26
#define TOP_MUX_AUDIO_SHIFT			27
#define TOP_MUX_AUD_INTBUS_SHIFT		28
#define TOP_MUX_ATB_SHIFT			29
#define TOP_MUX_DISP_PWM_SHIFT			30
#define TOP_MUX_USB_TOP_SHIFT			0
#define TOP_MUX_SSUSB_XHCI_SHIFT		1
#define TOP_MUX_I2C_SHIFT			4
#define TOP_MUX_SENINF_SHIFT			5
#define TOP_MUX_SENINF1_SHIFT			6
#define TOP_MUX_SENINF2_SHIFT			7
#define TOP_MUX_SENINF3_SHIFT			8
#define TOP_MUX_AUD_ENGEN1_SHIFT		10
#define TOP_MUX_AUD_ENGEN2_SHIFT		11
#define TOP_MUX_AES_UFSFDE_SHIFT		12
#define TOP_MUX_UFS_SHIFT			13
#define TOP_MUX_UFS_MBIST_SHIFT			14
#define TOP_MUX_AUD_1_SHIFT			16
#define TOP_MUX_AUD_2_SHIFT			17
#define TOP_MUX_ADSP_SHIFT			18
...
#define TOP_MUX_PERI_HF_FMEM_SHIFT		26
#define TOP_MUX_UFS_HF_FMEM_SHIFT		27
#define TOP_MUX_EMI_N_SHIFT			28
#define TOP_MUX_DSI_OCC_SHIFT			29
#define TOP_MUX_CCU_AHB_SHIFT			30
#define TOP_MUX_AP2CONN_HOST_SHIFT		0
#define TOP_MUX_IMG1_SHIFT			1
#define TOP_MUX_IPE_SHIFT			2
#define TOP_MUX_CAM_SHIFT			3
#define TOP_MUX_CCUSYS_SHIFT			4
#define TOP_MUX_CAMTM_SHIFT			5
#define TOP_MUX_MCU_ACP_SHIFT			6
#define TOP_MUX_CSI_OCC_SCAN_SHIFT		7
#define TOP_MUX_IPSWEST_SHIFT			8
#define TOP_MUX_IPSNORTH_SHIFT			9
#define TOP_MUX_AXI_L3GIC_SHIFT			11
#define TOP_MUX_SCP_VLP_SHIFT			0
#define TOP_MUX_PWRAP_ULPOSC_SHIFT		1
#define TOP_MUX_26M_APXGPT_CLK_VLP_SHIFT	2
...
#define TOP_MUX_DBGAO_26M_VLP_SHIFT		9
#define TOP_MUX_SYSTIMER_26M_VLP_SHIFT		10
#define TOP_MUX_SSPM_VLP_SHIFT			11
#define TOP_MUX_SSPM_F26M_SHIFT			12
#define TOP_MUX_SRCK_SHIFT			13
#define TOP_MUX_SCP_SPI_SHIFT			14
#define TOP_MUX_SCP_IIC_SHIFT			15
#define TOP_MUX_PSVLP_SHIFT			16
...
#define UFSPLL_CON0				0x248
#define UFSPLL_CON1				0x24C
#define UFSPLL_CON2				0x250
#define UFSPLL_CON3				0x254
...
static DEFINE_SPINLOCK(mt6886_clk_lock);
...
static const struct mtk_fixed_factor top_divs[] = {
	...
	FACTOR(CLK_TOP_OSC_D2, "osc_d2",
			"ulposc", 1, 2),
	FACTOR(CLK_TOP_OSC_D2P5, "osc_d2p5",
			"ulposc", 2, 5),
	...
	FACTOR(CLK_TOP_OSC_D20, "osc_d20",
			"ulposc", 1, 20),
	FACTOR(CLK_TOP_OSC2_D4, "osc2_d4",
			"ulposc2", 1, 4),
	FACTOR(CLK_TOP_F26M, "f26m_ck",
			"clk26m", 1, 1),
	FACTOR(CLK_TOP_AXI, "axi_ck",
			"axi_sel", 1, 1),
	FACTOR(CLK_TOP_P_AXI, "peri_axi_ck",
			"peri_axi_sel", 1, 1),
...
static const char * const vlp_26m_gpt_vlp_parents[] = {
	"tck_26m_mx9_ck",
	"osc_d10"
};
...
static const char * const vlp_dbg_26m_vlp_parents[] = {
	"tck_26m_mx9_ck",
	"osc_d10"
};

static const char * const vlp_stmr26m_vlp_parents[] = {
	"tck_26m_mx9_ck",
	"osc_d10"
};

static const char * const vlp_sspm_vlp_parents[] = {
	"tck_26m_mx9_ck",
	"osc_d10",
	"mainpll_d5_d2",
	"osc_ck",
...
static const char * const vlp_psvlp_parents[] = {
	"tck_26m_mx9_ck",
	"univpll_d3",
	"mainpll_d7"
};
...
static const struct mtk_mux vlp_ck_muxes[] = {
	...
	/* VLP_CLK_CFG_0 */
	MUX_CLR_SET_UPD(CLK_VLP_CK_SCP_VLP_SEL/* dts */, "vlp_scp_vlp_sel",
		vlp_scp_vlp_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 0/* lsb */, 4/* width */,
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_SCP_VLP_SHIFT/* upd shift */),
	...
	MUX_CLR_SET_UPD(CLK_VLP_CK_26M_GPT_VLP_SEL/* dts */, "vlp_26m_gpt_vlp_sel",
		vlp_26m_gpt_vlp_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 16/* lsb */, 1/* width */,
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_26M_APXGPT_CLK_VLP_SHIFT/* upd shift */),
	...
	MUX_CLR_SET_UPD(CLK_VLP_CK_DBG_26M_VLP_SEL/* dts */, "vlp_dbg_26m_vlp_sel",
		vlp_dbg_26m_vlp_parents/* parent */, VLP_CLK_CFG_2, VLP_CLK_CFG_2_SET,
		VLP_CLK_CFG_2_CLR/* set parent */, 8/* lsb */, 1/* width */,
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_DBGAO_26M_VLP_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_VLP_CK_STMR26M_VLP_SEL/* dts */, "vlp_stmr26m_vlp_sel",
		vlp_stmr26m_vlp_parents/* parent */, VLP_CLK_CFG_2, VLP_CLK_CFG_2_SET,
		VLP_CLK_CFG_2_CLR/* set parent */, 16/* lsb */, 1/* width */,
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_SYSTIMER_26M_VLP_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_VLP_CK_SSPM_VLP_SEL/* dts */, "vlp_sspm_vlp_sel",
		vlp_sspm_vlp_parents/* parent */, VLP_CLK_CFG_2, VLP_CLK_CFG_2_SET,
		VLP_CLK_CFG_2_CLR/* set parent */, 24/* lsb */, 3/* width */,
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_SSPM_VLP_SHIFT/* upd shift */),
	/* VLP_CLK_CFG_3 */
	...
	/* VLP_CLK_CFG_4 */
	MUX_CLR_SET_UPD(CLK_VLP_CK_PSVLP_SEL/* dts */, "vlp_psvlp_sel",
		vlp_psvlp_parents/* parent */, VLP_CLK_CFG_4, VLP_CLK_CFG_4_SET,
		VLP_CLK_CFG_4_CLR/* set parent */, 0/* lsb */, 2/* width */,
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_PSVLP_SHIFT/* upd shift */),
#else
	/* VLP_CLK_CFG_0 */
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_SCP_VLP_SEL/* dts */, "vlp_scp_vlp_sel",
		vlp_scp_vlp_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 0/* lsb */, 4/* width */,
		7/* pdn */, VLP_CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SCP_VLP_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_VLP_CK_PWRAP_ULPOSC_SEL/* dts */, "vlp_pwrap_ulposc_sel",
		vlp_pwrap_ulposc_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 8/* lsb */, 3/* width */,
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_PWRAP_ULPOSC_SHIFT/* upd shift */),
	...
	MUX_CLR_SET_UPD(CLK_VLP_CK_SCP_IIC_SEL/* dts */, "vlp_scp_iic_sel",
		...
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_SCP_IIC_SHIFT/* upd shift */),
	/* VLP_CLK_CFG_4 */
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_PSVLP_SEL/* dts */, "vlp_psvlp_sel",
		vlp_psvlp_parents/* parent */, VLP_CLK_CFG_4, VLP_CLK_CFG_4_SET,
		VLP_CLK_CFG_4_CLR/* set parent */, 0/* lsb */, 2/* width */,
		7/* pdn */, VLP_CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_PSVLP_SHIFT/* upd shift */),
#endif
};
...
static const char * const csi_occ_scan_parents[] = {
	"univpll_d6_d2",
	"univpll_d4_d2",
	"univpll_d7"
};
...
static const char * const ipsnorth_parents[] = {
	"tck_26m_mx9_ck",
	"univpll_d3",
	"univpll_d4",
	"univpll_d4_d2"
...
static const char * const axi_l3gic_parents[] = {
	"tck_26m_mx9_ck",
	"mainpll_d7_d2"
};
...
static const struct mtk_mux top_muxes[] = {
	...
	MUX_CLR_SET_UPD(CLK_TOP_P_AXI_SEL/* dts */, "peri_axi_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_CAMTG2_SEL/* dts */, "camtg2_sel",
		camtg2_parents/* parent */, CLK_CFG_4, CLK_CFG_4_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_CAMTG3_SEL/* dts */, "camtg3_sel",
		camtg3_parents/* parent */, CLK_CFG_4, CLK_CFG_4_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_CAMTG6_SEL/* dts */, "camtg6_sel",
		camtg6_parents/* parent */, CLK_CFG_5, CLK_CFG_5_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPI_SEL/* dts */, "spi_sel",
		spi_parents/* parent */, CLK_CFG_5, CLK_CFG_5_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_AUDIO_SEL/* dts */, "audio_sel",
		audio_parents/* parent */, CLK_CFG_6, CLK_CFG_6_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_U_MBIST_SEL/* dts */, "ufs_mbist_sel",
		ufs_mbist_parents/* parent */, CLK_CFG_11, CLK_CFG_11_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_P_MEM_SEL/* dts */, "peri_mem_sel",
		peri_mem_parents/* parent */, CLK_CFG_14, CLK_CFG_14_SET,
		CLK_CFG_14_CLR/* set parent */, 8/* lsb */, 3/* width */,
		CLK_CFG_UPDATE1/* upd ofs */, TOP_MUX_PERI_HF_FMEM_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_TOP_U_MEM_SEL/* dts */, "ufs_mem_sel",
		ufs_mem_parents/* parent */, CLK_CFG_14, CLK_CFG_14_SET,
		CLK_CFG_14_CLR/* set parent */, 16/* lsb */, 3/* width */,
		CLK_CFG_UPDATE1/* upd ofs */, TOP_MUX_UFS_HF_FMEM_SHIFT/* upd shift */),
	...
	MUX_CLR_SET_UPD(CLK_TOP_CCU_AHB_SEL/* dts */, "ccu_ahb_sel",
		...
		CLK_CFG_UPDATE1/* upd ofs */, TOP_MUX_CCU_AHB_SHIFT/* upd shift */),
	...
	MUX_CLR_SET_UPD(CLK_TOP_CAM_SEL/* dts */, "cam_sel",
		cam_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_CCUSYS_SEL/* dts */, "ccusys_sel",
		ccusys_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
		CLK_CFG_16_CLR/* set parent */, 16/* lsb */, 4/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_CCUSYS_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_TOP_CAMTM_SEL/* dts */, "camtm_sel",
		camtm_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_MCU_ACP_SEL/* dts */, "mcu_acp_sel",
		mcu_acp_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 0/* lsb */, 3/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_MCU_ACP_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_TOP_CSI_OCC_SCAN_SEL/* dts */, "csi_occ_scan_sel",
		csi_occ_scan_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 8/* lsb */, 2/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_CSI_OCC_SCAN_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_TOP_IPSWEST_SEL/* dts */, "ipswest_sel",
		ipswest_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 16/* lsb */, 2/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_IPSWEST_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_TOP_IPSNORTH_SEL/* dts */, "ipsnorth_sel",
		ipsnorth_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 24/* lsb */, 2/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_IPSNORTH_SHIFT/* upd shift */),
	/* CLK_CFG_18 */
	MUX_CLR_SET_UPD(CLK_TOP_AXI_L3GIC_SEL/* dts */, "axi_l3gic_sel",
		axi_l3gic_parents/* parent */, CLK_CFG_18, CLK_CFG_18_SET,
		CLK_CFG_18_CLR/* set parent */, 8/* lsb */, 1/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_AXI_L3GIC_SHIFT/* upd shift */),
#else
	/* CLK_CFG_0 */
	MUX_CLR_SET_UPD(CLK_TOP_AXI_SEL/* dts */, "axi_sel",
		axi_parents/* parent */, CLK_CFG_0, CLK_CFG_0_SET,
	...
	MUX_HWV(CLK_TOP_DSP_SEL/* dts */, "dsp_sel", dsp_parents/* parent */,
		...
		HWV_CG_0_DONE, HWV_CG_0_SET, HWV_CG_0_CLR, /* hwv */
		0/* lsb */, 3/* width */,
		7/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
	...
	MUX_CLR_SET_UPD(CLK_TOP_MCU_ACP_SEL/* dts */, "mcu_acp_sel",
		...
		CLK_CFG_17_CLR/* set parent */, 0/* lsb */, 3/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_MCU_ACP_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_CSI_OCC_SCAN_SEL/* dts */, "csi_occ_scan_sel",
		csi_occ_scan_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 8/* lsb */, 2/* width */,
		15/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_CSI_OCC_SCAN_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_IPSWEST_SEL/* dts */, "ipswest_sel",
		ipswest_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 16/* lsb */, 2/* width */,
		23/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_IPSWEST_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_IPSNORTH_SEL/* dts */, "ipsnorth_sel",
		ipsnorth_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 24/* lsb */, 2/* width */,
		31/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_IPSNORTH_SHIFT/* upd shift */),
	/* CLK_CFG_18 */
	MUX_CLR_SET_UPD(CLK_TOP_AXI_L3GIC_SEL/* dts */, "axi_l3gic_sel",
		axi_l3gic_parents/* parent */, CLK_CFG_18, CLK_CFG_18_SET,
		CLK_CFG_18_CLR/* set parent */, 8/* lsb */, 1/* width */,
...
#define MT6886_PLL_FMAX		(3800UL * MHZ)
#define MT6886_PLL_FMIN		(1500UL * MHZ)
#define MT6886_INTEGER_BITS	8
...
#define PLL(_id, _name, _reg, _en_reg, _en_mask, _pll_en_bit,		\
		...
		.fmax = MT6886_PLL_FMAX,				\
		.fmin = MT6886_PLL_FMIN,				\
		.pd_reg = _pd_reg,					\
		.pd_shift = _pd_shift,					\
...
static const struct mtk_pll_data apmixed_plls[] = {
	...
	PLL(CLK_APMIXED_UFSPLL, "ufspll", UFSPLL_CON0/*base*/,
		UFSPLL_CON0, 0, 0/*en*/,
		UFSPLL_CON3/*pwr*/, 0, BIT(0)/*rstb*/,
		UFSPLL_CON1, 24/*pd*/,
		0, 0, 0/*tuner*/,
...
static int clk_mt6886_pll_registration(enum subsys_id id,
...
static int clk_mt6886_apmixed_probe(struct platform_device *pdev)
{
	return clk_mt6886_pll_registration(APMIXEDSYS, apmixed_plls,
			pdev, ARRAY_SIZE(apmixed_plls));
}

static int clk_mt6886_cpu_bl_probe(struct platform_device *pdev)
{
	return clk_mt6886_pll_registration(ARMPLL_BL_PLL_CTRL, cpu_bl_plls,
			pdev, ARRAY_SIZE(cpu_bl_plls));
}

static int clk_mt6886_cpu_ll_probe(struct platform_device *pdev)
{
	return clk_mt6886_pll_registration(ARMPLL_LL_PLL_CTRL, cpu_ll_plls,
			pdev, ARRAY_SIZE(cpu_ll_plls));
}

static int clk_mt6886_cci_probe(struct platform_device *pdev)
{
	return clk_mt6886_pll_registration(CCIPLL_PLL_CTRL, cci_plls,
			pdev, ARRAY_SIZE(cci_plls));
}

static int clk_mt6886_mfg_ao_probe(struct platform_device *pdev)
{
	return clk_mt6886_pll_registration(MFGPLL_PLL_CTRL, mfg_ao_plls,
			pdev, ARRAY_SIZE(mfg_ao_plls));
}

static int clk_mt6886_mfgsc_ao_probe(struct platform_device *pdev)
{
	return clk_mt6886_pll_registration(MFGSCPLL_PLL_CTRL, mfgsc_ao_plls,
			pdev, ARRAY_SIZE(mfgsc_ao_plls));
}

static int clk_mt6886_ptp_probe(struct platform_device *pdev)
{
	return clk_mt6886_pll_registration(PTPPLL_PLL_CTRL, ptp_plls,
			pdev, ARRAY_SIZE(ptp_plls));
}

static int clk_mt6886_top_probe(struct platform_device *pdev)
{
	struct clk_onecell_data *clk_data;
	int r;
	struct device_node *node = pdev->dev.of_node;
...
static int clk_mt6886_vlp_ck_probe(struct platform_device *pdev)
{
	struct clk_onecell_data *clk_data;
	int r;
	struct device_node *node = pdev->dev.of_node;
...
void mt6886_pll_force_off(void)
{
	int i;
...
EXPORT_SYMBOL_GPL(mt6886_pll_force_off);

static const struct of_device_id of_match_clk_mt6886[] = {
	{
		.compatible = "mediatek,mt6886-apmixedsys",
		.data = clk_mt6886_apmixed_probe,
	}, {
		.compatible = "mediatek,mt6886-armpll_bl_pll_ctrl",
		.data = clk_mt6886_cpu_bl_probe,
	}, {
		.compatible = "mediatek,mt6886-armpll_ll_pll_ctrl",
		.data = clk_mt6886_cpu_ll_probe,
	}, {
		.compatible = "mediatek,mt6886-ccipll_pll_ctrl",
		.data = clk_mt6886_cci_probe,
	}, {
		.compatible = "mediatek,mt6886-mfgpll_pll_ctrl",
		.data = clk_mt6886_mfg_ao_probe,
	}, {
		.compatible = "mediatek,mt6886-mfgscpll_pll_ctrl",
		.data = clk_mt6886_mfgsc_ao_probe,
	}, {
		.compatible = "mediatek,mt6886-ptppll_pll_ctrl",
		.data = clk_mt6886_ptp_probe,
	}, {
		.compatible = "mediatek,mt6886-topckgen",
		.data = clk_mt6886_top_probe,
	}, {
		.compatible = "mediatek,mt6886-vlp_cksys",
		.data = clk_mt6886_vlp_ck_probe,
	}, {
		/* sentinel */
	}
};

static int clk_mt6886_probe(struct platform_device *pdev)
{
...
static struct platform_driver clk_mt6886_drv = {
	.probe = clk_mt6886_probe,
	.driver = {
		.name = "clk-mt6886",
		.owner = THIS_MODULE,
		.of_match_table = of_match_clk_mt6886,
	},
};

module_platform_driver(clk_mt6886_drv);
MODULE_LICENSE("GPL");
