...
static const struct of_device_id of_match_clk_mt6853_audsys[] = {
	{ .compatible = "mediatek,mt6853-audio", },
	{}
};
...
static int __init clk_mt6853_audsys_platform_init(void)
{
	return platform_driver_register(&clk_mt6853_audsys_drv);
}
arch_initcall(clk_mt6853_audsys_platform_init);
