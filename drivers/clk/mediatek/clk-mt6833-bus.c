...
static const struct mtk_gate ifrao_clks[] = {
	...
	GATE_IFRAO2(CLK_IFRAO_UNIPRO_SYSCLK, "ifrao_unipro_sysclk",
			"ufs_ck"/* parent */, 11),
	GATE_IFRAO2(CLK_IFRAO_U_SAP_BCLK, "ifrao_u_bclk",
			"f26m_ck"/* parent */, 13),
	...
	GATE_IFRAO2(CLK_IFRAO_UFS, "ifrao_ufs",
			"ufs_ck"/* parent */, 28),
	GATE_IFRAO2(CLK_IFRAO_U_AES, "ifrao_u_aes",
			"aes_ufsfde_ck"/* parent */, 29),
	GATE_IFRAO2(CLK_IFRAO_USB_XHCI, "ifrao_usb_xhci",
			"ssusb_xhci_ck"/* parent */, 31),
	/* IFRAO3 */
...
static const struct of_device_id of_match_clk_mt6833_bus[] = {
	{
...
static int clk_mt6833_bus_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6833_bus_drv = {
	.probe = clk_mt6833_bus_grp_probe,
	.driver = {
		.name = "clk-mt6833-bus",
		.of_match_table = of_match_clk_mt6833_bus,
	},
};

module_platform_driver(clk_mt6833_bus_drv);
MODULE_LICENSE("GPL");
