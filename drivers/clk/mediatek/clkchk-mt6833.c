...
static struct regbase rb[] = {
	...
	[impc] = REGBASE_V(0x11007000, impc, PD_NULL, CLK_NULL),
	[afe] = REGBASE_V(0x11210000, afe, MT6833_POWER_DOMAIN_AUDIO, CLK_NULL),
	[msdc0] = REGBASE_V(0x11230000, msdc0, PD_NULL, CLK_NULL),
	[impe] = REGBASE_V(0x11CB1000, impe, PD_NULL, CLK_NULL),
	[imps] = REGBASE_V(0x11D02000, imps, PD_NULL, CLK_NULL),
	[impws] = REGBASE_V(0x11D23000, impws, PD_NULL, CLK_NULL),
	[impw] = REGBASE_V(0x11E03000, impw, PD_NULL, CLK_NULL),
	...
	[vde2] = REGBASE_V(0x1602f000, vde2, PD_NULL, CLK_NULL),
...
static struct pvd_msk pvd_pwr_mask[] = {
	...
	{"vdec_gcon_base", PWR_STA, 0x00000000},
