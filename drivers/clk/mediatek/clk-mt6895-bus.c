...
static const struct mtk_gate ifrao_clks[] = {
	/* IFRAO0 */
	GATE_IFRAO0(CLK_IFRAO_BUS_HRE, "ifrao_bus_hre",
			"axi_ck"/* parent */, 0),
	/* IFRAO1 */
	GATE_IFRAO1(CLK_IFRAO_INFRA_DCM_RG_FORCE, "ifrao_infra_force",
			"axi_ck"/* parent */, 2),
	/* IFRAO2 */
	...
	GATE_IFRAO3(CLK_IFRAO_DXCC_SEC_CORE, "ifrao_secore",
			"dxcc_ck"/* parent */, 27),
	GATE_IFRAO3(CLK_IFRAO_DXCC_AO, "ifrao_dxcc_ao",
			"dxcc_ck"/* parent */, 28),
	GATE_IFRAO3(CLK_IFRAO_DBG_TRACE, "ifrao_dbg_trace",
			"axi_ck"/* parent */, 29),
	/* IFRAO4 */
	...
	GATE_IFRAO5(CLK_IFRAO_CCIF4_MD, "ifrao_ccif4_md",
			"axi_ck"/* parent */, 29),
	/* IFRAO6 */
	GATE_IFRAO6(CLK_IFRAO_RG_MMW_DPMAIF26M_CK, "ifrao_dpmaif_26m",
			"f26m_ck"/* parent */, 17),
	GATE_IFRAO6(CLK_IFRAO_RG_MEM_SUB_CK, "ifrao_mem_sub_ck",
