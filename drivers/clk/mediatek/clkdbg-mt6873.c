...
device_initcall(clkdbg_mt6873_init);

/*
 * MT6873: for mtcmos debug
 */
static struct regbase rb_mt6873[] = {
	[topckgen] = REGBASE_V(0x10000000, topckgen),
	[infracfg] = REGBASE_V(0x10001000, infracfg),
	[scpsys]   = REGBASE_V(0x10006000, scpsys),
	[apmixed]  = REGBASE_V(0x1000c000, apmixed),
...
#define REGNAME_MT6873(_base, _ofs, _name)	\
	{ .base = &rb_mt6873[_base], .ofs = _ofs, .name = #_name }

static struct regname rn_mt6873[] = {
	REGNAME_MT6873(topckgen,  0x010, CLK_CFG_0),
	REGNAME_MT6873(topckgen,  0x020, CLK_CFG_1),
	REGNAME_MT6873(topckgen,  0x030, CLK_CFG_2),
	REGNAME_MT6873(topckgen,  0x040, CLK_CFG_3),
	REGNAME_MT6873(topckgen,  0x050, CLK_CFG_4),
	REGNAME_MT6873(topckgen,  0x060, CLK_CFG_5),
	REGNAME_MT6873(topckgen,  0x070, CLK_CFG_6),
	REGNAME_MT6873(topckgen,  0x080, CLK_CFG_7),
	REGNAME_MT6873(topckgen,  0x090, CLK_CFG_8),
	REGNAME_MT6873(topckgen,  0x0A0, CLK_CFG_9),
	REGNAME_MT6873(topckgen,  0x0B0, CLK_CFG_10),
	REGNAME_MT6873(topckgen,  0x0C0, CLK_CFG_11),
	REGNAME_MT6873(topckgen,  0x0D0, CLK_CFG_12),
	REGNAME_MT6873(topckgen,  0x0E0, CLK_CFG_13),
	REGNAME_MT6873(topckgen,  0x0F0, CLK_CFG_14),
	REGNAME_MT6873(topckgen,  0x100, CLK_CFG_15),
	REGNAME_MT6873(topckgen,  0x110, CLK_CFG_16),

	REGNAME_MT6873(apmixed, 0x050, PLLON_CON0),
	REGNAME_MT6873(apmixed, 0x054, PLLON_CON1),
	REGNAME_MT6873(apmixed, 0x058, PLLON_CON2),
	REGNAME_MT6873(apmixed, 0x05C, PLLON_CON3),
	REGNAME_MT6873(apmixed, 0x208, ARMPLL_LL_CON0),
	REGNAME_MT6873(apmixed, 0x20C, ARMPLL_LL_CON1),
	REGNAME_MT6873(apmixed, 0x210, ARMPLL_LL_CON2),
	REGNAME_MT6873(apmixed, 0x214, ARMPLL_LL_CON3),
	REGNAME_MT6873(apmixed, 0x218, ARMPLL_BL0_CON0),
	REGNAME_MT6873(apmixed, 0x21C, ARMPLL_BL0_CON1),
	REGNAME_MT6873(apmixed, 0x220, ARMPLL_BL0_CON2),
	REGNAME_MT6873(apmixed, 0x224, ARMPLL_BL0_CON3),
	REGNAME_MT6873(apmixed, 0x228, ARMPLL_BL1_CON0),
	REGNAME_MT6873(apmixed, 0x22C, ARMPLL_BL1_CON1),
	REGNAME_MT6873(apmixed, 0x230, ARMPLL_BL1_CON2),
	REGNAME_MT6873(apmixed, 0x234, ARMPLL_BL1_CON3),
	REGNAME_MT6873(apmixed, 0x238, ARMPLL_BL2_CON0),
	REGNAME_MT6873(apmixed, 0x23C, ARMPLL_BL2_CON1),
	REGNAME_MT6873(apmixed, 0x240, ARMPLL_BL2_CON2),
	REGNAME_MT6873(apmixed, 0x244, ARMPLL_BL2_CON3),
	REGNAME_MT6873(apmixed, 0x248, ARMPLL_BL3_CON0),
	REGNAME_MT6873(apmixed, 0x24C, ARMPLL_BL3_CON1),
	REGNAME_MT6873(apmixed, 0x250, ARMPLL_BL3_CON2),
	REGNAME_MT6873(apmixed, 0x254, ARMPLL_BL3_CON3),
	REGNAME_MT6873(apmixed, 0x258, CCIPLL_CON0),
	REGNAME_MT6873(apmixed, 0x25C, CCIPLL_CON1),
	REGNAME_MT6873(apmixed, 0x260, CCIPLL_CON2),
	REGNAME_MT6873(apmixed, 0x264, CCIPLL_CON3),
	REGNAME_MT6873(apmixed, 0x268, MFGPLL_CON0),
	REGNAME_MT6873(apmixed, 0x26C, MFGPLL_CON1),
	REGNAME_MT6873(apmixed, 0x274, MFGPLL_CON3),
	REGNAME_MT6873(apmixed, 0x308, UNIVPLL_CON0),
	REGNAME_MT6873(apmixed, 0x30C, UNIVPLL_CON1),
	REGNAME_MT6873(apmixed, 0x314, UNIVPLL_CON3),
	REGNAME_MT6873(apmixed, 0x318, APLL1_CON0),
	REGNAME_MT6873(apmixed, 0x31C, APLL1_CON1),
	REGNAME_MT6873(apmixed, 0x320, APLL1_CON2),
	REGNAME_MT6873(apmixed, 0x324, APLL1_CON3),
	REGNAME_MT6873(apmixed, 0x328, APLL1_CON4),
	REGNAME_MT6873(apmixed, 0x32C, APLL2_CON0),
	REGNAME_MT6873(apmixed, 0x330, APLL2_CON1),
	REGNAME_MT6873(apmixed, 0x334, APLL2_CON2),
	REGNAME_MT6873(apmixed, 0x338, APLL2_CON3),
	REGNAME_MT6873(apmixed, 0x33C, APLL2_CON4),
	REGNAME_MT6873(apmixed, 0x340, MAINPLL_CON0),
	REGNAME_MT6873(apmixed, 0x344, MAINPLL_CON1),
	REGNAME_MT6873(apmixed, 0x34C, MAINPLL_CON3),
	REGNAME_MT6873(apmixed, 0x350, MSDCPLL_CON0),
	REGNAME_MT6873(apmixed, 0x354, MSDCPLL_CON1),
	REGNAME_MT6873(apmixed, 0x35C, MSDCPLL_CON3),
	REGNAME_MT6873(apmixed, 0x360, MMPLL_CON0),
	REGNAME_MT6873(apmixed, 0x364, MMPLL_CON1),
	REGNAME_MT6873(apmixed, 0x36C, MMPLL_CON3),
	REGNAME_MT6873(apmixed, 0x370, ADSPPLL_CON0),
	REGNAME_MT6873(apmixed, 0x374, ADSPPLL_CON1),
	REGNAME_MT6873(apmixed, 0x37C, ADSPPLL_CON3),
	REGNAME_MT6873(apmixed, 0x380, TVDPLL_CON0),
	REGNAME_MT6873(apmixed, 0x384, TVDPLL_CON1),
	REGNAME_MT6873(apmixed, 0x38C, TVDPLL_CON3),
	REGNAME_MT6873(apmixed, 0x390, MPLL_CON0),
	REGNAME_MT6873(apmixed, 0x394, MPLL_CON1),
	REGNAME_MT6873(apmixed, 0x39C, MPLL_CON3),
	REGNAME_MT6873(apmixed, 0x3A0, APUPLL_CON0),
	REGNAME_MT6873(apmixed, 0x3A4, APUPLL_CON1),
	REGNAME_MT6873(apmixed, 0x3AC, APUPLL_CON3),

	REGNAME_MT6873(scpsys, 0x0000, POWERON_CONFIG_EN),
	REGNAME_MT6873(scpsys, 0x016C, PWR_STATUS),
	REGNAME_MT6873(scpsys, 0x0170, PWR_STATUS_2ND),
	REGNAME_MT6873(scpsys, 0x0178, OTHER_PWR_STATUS),
	REGNAME_MT6873(scpsys, 0x300, MD1_PWR_CON),
	REGNAME_MT6873(scpsys, 0x304, CONN_PWR_CON),
	REGNAME_MT6873(scpsys, 0x308, MFG0_PWR_CON),
	REGNAME_MT6873(scpsys, 0x30C, MFG1_PWR_CON),
	REGNAME_MT6873(scpsys, 0x310, MFG2_PWR_CON),
	REGNAME_MT6873(scpsys, 0x314, MFG3_PWR_CON),
	REGNAME_MT6873(scpsys, 0x318, MFG4_PWR_CON),
	REGNAME_MT6873(scpsys, 0x31C, MFG5_PWR_CON),
	REGNAME_MT6873(scpsys, 0x320, MFG6_PWR_CON),
	REGNAME_MT6873(scpsys, 0x324, IFR_PWR_CON),
	REGNAME_MT6873(scpsys, 0x328, IFR_SUB_PWR_CON),
	REGNAME_MT6873(scpsys, 0x32C, DPY_PWR_CON),
	REGNAME_MT6873(scpsys, 0x330, ISP_PWR_CON),
	REGNAME_MT6873(scpsys, 0x334, ISP2_PWR_CON),
	REGNAME_MT6873(scpsys, 0x338, IPE_PWR_CON),
	REGNAME_MT6873(scpsys, 0x33C, VDE_PWR_CON),
	REGNAME_MT6873(scpsys, 0x340, VDE2_PWR_CON),
	REGNAME_MT6873(scpsys, 0x344, VEN_PWR_CON),
	REGNAME_MT6873(scpsys, 0x348, VEN_CORE1_PWR_CON),
	REGNAME_MT6873(scpsys, 0x34C, MDP_PWR_CON),
	REGNAME_MT6873(scpsys, 0x350, DIS_PWR_CON),
	REGNAME_MT6873(scpsys, 0x354, AUDIO_PWR_CON),
	REGNAME_MT6873(scpsys, 0x358, ADSP_PWR_CON),
	REGNAME_MT6873(scpsys, 0x35C, CAM_PWR_CON),
	REGNAME_MT6873(scpsys, 0x360, CAM_RAWA_PWR_CON),
	REGNAME_MT6873(scpsys, 0x364, CAM_RAWB_PWR_CON),
	REGNAME_MT6873(scpsys, 0x368, CAM_RAWC_PWR_CON),
	REGNAME_MT6873(scpsys, 0x3AC, DP_TX_PWR_CON),
	REGNAME_MT6873(scpsys, 0x3C4, DPY2_PWR_CON),
	REGNAME_MT6873(scpsys, 0x398, MD_EXT_BUCK_ISO_CON),

	REGNAME_MT6873(audio, 0x0000, AUDIO_TOP_CON0),
	REGNAME_MT6873(audio, 0x0004, AUDIO_TOP_CON1),
	REGNAME_MT6873(audio, 0x0008, AUDIO_TOP_CON2),

	REGNAME_MT6873(camsys, 0x0000, CAMSYS_CG_CON),
	REGNAME_MT6873(cam_rawa_sys, 0x0000, CAMSYS_RAWA_CG_CON),
	REGNAME_MT6873(cam_rawb_sys, 0x0000, CAMSYS_RAWB_CG_CON),
	REGNAME_MT6873(cam_rawc_sys, 0x0000, CAMSYS_RAWC_CG_CON),

	REGNAME_MT6873(img1sys, 0x0000, IMG1_CG_CON),
	REGNAME_MT6873(img2sys, 0x0000, IMG2_CG_CON),
	REGNAME_MT6873(ipesys, 0x0000, IPE_CG_CON),

	REGNAME_MT6873(infracfg,  0x090, MODULE_SW_CG_0),
	REGNAME_MT6873(infracfg,  0x094, MODULE_SW_CG_1),
	REGNAME_MT6873(infracfg,  0x0ac, MODULE_SW_CG_2),
	REGNAME_MT6873(infracfg,  0x0c8, MODULE_SW_CG_3),

#if 0
/*
 *	REGNAME_MT6873(ipu0,  0x000, IPU0_CORE_CG),
 *	REGNAME_MT6873(ipu1,  0x000, IPU1_CORE_CG),
 *	REGNAME_MT6873(ipu2,  0x000, IPU2_CORE_CG),
 *	REGNAME_MT6873(ipu_conn,  0x000, IPU_CONN_CG),
 *	REGNAME_MT6873(ipu_vcore,  0x000, IPU_VCORE_CG),
 */
#endif

	REGNAME_MT6873(mfgsys, 0x0000, MFG_CG_CON),

	REGNAME_MT6873(mmsys, 0x100, MM_CG_CON0),
	REGNAME_MT6873(mmsys, 0x110, MM_CG_CON1),
	REGNAME_MT6873(mmsys, 0x1a0, MM_CG_CON2),

	REGNAME_MT6873(mdpsys, 0x100, MDP_CG_CON0),
	REGNAME_MT6873(mdpsys, 0x104, MDP_CG_SET0),
	REGNAME_MT6873(mdpsys, 0x114, MDP_CG_SET1),
	REGNAME_MT6873(mdpsys, 0x124, MDP_CG_SET2),


	REGNAME_MT6873(vdecsys, 0x0000, VDEC_CKEN_SET),
	REGNAME_MT6873(vdecsys, 0x0008, VDEC_LARB1_CKEN_SET),
	REGNAME_MT6873(vdecsys, 0x0200, VDEC_LAT_CKEN_SET),

	REGNAME_MT6873(vdec_soc_sys, 0x0000, VDEC_SOC_CKEN_SET),
	REGNAME_MT6873(vdec_soc_sys, 0x0008, VDEC_SOC_LARB1_CKEN_SET),
	REGNAME_MT6873(vdec_soc_sys, 0x0200, VDEC_SOC_LAT_CKEN_SET),

	REGNAME_MT6873(venc_c1_sys, 0x0000, VENC_C1_CG_CON),

	REGNAME_MT6873(vencsys, 0x0000, VENC_CG_CON),
	{}
};
...
void init_regbase_mt6873(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(rb_mt6873); i++)
		rb_mt6873[i].virt = ioremap_nocache(rb_mt6873[i].phys,
								PAGE_SIZE);
}
...
static struct regbase *lookup_regbase(char *name)
{
	...
	for (i = 0; i < ARRAY_SIZE(rb_mt6873); i++) {
		if (!strcmp(name, rb_mt6873[i].name))
			return &rb_mt6873[i];
	}
	return NULL;
}
...
{
	struct regbase *rb;
	const struct regname *rns = &rn_mt6873[0];
