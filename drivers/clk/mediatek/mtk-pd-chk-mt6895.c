...
struct pd_check_swcg cam_main_r1a_swcgs[] = {
	...
	SWCG("_gcamsvj_con"),
	SWCG("_camsv_con"),
	SWCG("_camsv_cq_a_con"),
	SWCG("_camsv_cq_b_con"),
	SWCG("_camsv_cq_c_con"),
	SWCG("_adl_con"),
	SWCG("_asg_con"),
	SWCG("_pda0_con"),
	SWCG("_pda1_con"),
	SWCG("_pda2_con"),
	SWCG("_fake_eng_con"),
	SWCG("_cam2mm0_gals_con"),
	SWCG("_cam2mm1_gals_con"),
	SWCG("_cam2sys_gals_con"),
	SWCG(NULL),
};
/* ccu_main */
...
struct pd_check_swcg mdpsys1_config_swcgs[] = {
	...
	SWCG("mdp1_mdp_dl_relay0"),
	SWCG("mdp1_mdp_dl_relay1"),
	SWCG("mdp1_mdp_rdma1"),
	SWCG("mdp1_mdp_hdr1"),
	SWCG("mdp1_mdp_aal1"),
	SWCG("mdp1_mdp_rsz1"),
...
struct subsys_cgs_check mtk_subsys_check[] = {
	...
	{MT6895_POWER_DOMAIN_CAM_MRAW, camsys_yuva_swcgs, cam_ya},
	{MT6895_POWER_DOMAIN_CAM_MRAW, camsys_yuvb_swcgs, cam_yb},
	{MT6895_POWER_DOMAIN_CAM_MRAW, camsys_yuvc_swcgs, cam_yc},
	{MT6895_POWER_DOMAIN_CAM_MRAW, cam_main_r1a_swcgs, cam_m},
	{MT6895_POWER_DOMAIN_CAM_VCORE, ccu_main_swcgs, ccu},
	{MT6895_POWER_DOMAIN_ISP_MAIN, dip_nr_dip1_swcgs, dip_nr_dip1},
	{MT6895_POWER_DOMAIN_ISP_MAIN, dip_top_dip1_swcgs, dip_top_dip1},
	...
	{MT6895_POWER_DOMAIN_ISP_MAIN, ipesys_swcgs, ipe},
	{MT6895_POWER_DOMAIN_DISP, mdpsys1_config_swcgs, mdp1},
	{MT6895_POWER_DOMAIN_DISP, mdpsys_config_swcgs, mdp},
	{MT6895_POWER_DOMAIN_MM_INFRA, mminfra_config_swcgs, mminfra_config},
	{MT6895_POWER_DOMAIN_DISP, mmsys0_config_swcgs, mm0},
	{MT6895_POWER_DOMAIN_DISP, mmsys1_config_swcgs, mm1},
	{MT6895_POWER_DOMAIN_VDE0, vdec_gcon_base_swcgs, vde2},
	{MT6895_POWER_DOMAIN_VDE1, vdec_soc_gcon_base_swcgs, vde1},
	{MT6895_POWER_DOMAIN_VEN0, venc_gcon_swcgs, ven1},
	{MT6895_POWER_DOMAIN_VEN1, venc_gcon_core1_swcgs, ven2},
	{MT6895_POWER_DOMAIN_ISP_MAIN, wpe1_dip1_swcgs, wpe1_dip1},
	{MT6895_POWER_DOMAIN_ISP_MAIN, wpe2_dip1_swcgs, wpe2_dip1},
	{MT6895_POWER_DOMAIN_ISP_MAIN, wpe3_dip1_swcgs, wpe3_dip1},
};
...
static struct pd_sta pd_pwr_msk[] = {
	...
	{MT6895_POWER_DOMAIN_UFS0_SHUTDOWN, PWR_STA, 0x00000020},
	{MT6895_POWER_DOMAIN_AUDIO, PWR_STA, 0x00000080},
	{MT6895_POWER_DOMAIN_ADSP_TOP_DORMANT, PWR_STA, 0x00000100},
	{MT6895_POWER_DOMAIN_ADSP_INFRA, PWR_STA, 0x00000200},
	{MT6895_POWER_DOMAIN_ISP_MAIN, PWR_STA, 0x00000800},
	{MT6895_POWER_DOMAIN_ISP_DIP1, PWR_STA, 0x00001000},
	{MT6895_POWER_DOMAIN_ISP_IPE, PWR_STA, 0x00002000},
	{MT6895_POWER_DOMAIN_ISP_VCORE, PWR_STA, 0x00004000},
	{MT6895_POWER_DOMAIN_VDE0, PWR_STA, 0x00008000},
	{MT6895_POWER_DOMAIN_VDE1, PWR_STA, 0x00010000},
	{MT6895_POWER_DOMAIN_VEN0, PWR_STA, 0x00020000},
	{MT6895_POWER_DOMAIN_VEN1, PWR_STA, 0x00040000},
	{MT6895_POWER_DOMAIN_CAM_MAIN, PWR_STA, 0x00080000},
	{MT6895_POWER_DOMAIN_CAM_MRAW, PWR_STA, 0x00100000},
	{MT6895_POWER_DOMAIN_CAM_SUBA, PWR_STA, 0x00200000},
	{MT6895_POWER_DOMAIN_CAM_SUBB, PWR_STA, 0x00400000},
	{MT6895_POWER_DOMAIN_CAM_SUBC, PWR_STA, 0x00800000},
	{MT6895_POWER_DOMAIN_CAM_VCORE, PWR_STA, 0x01000000},
	{MT6895_POWER_DOMAIN_MDP0, PWR_STA, 0x02000000},
	{MT6895_POWER_DOMAIN_MDP1, PWR_STA, 0x04000000},
	{MT6895_POWER_DOMAIN_DISP, PWR_STA, 0x08000000},
	{MT6895_POWER_DOMAIN_DISP1, PWR_STA, 0x10000000},
	{MT6895_POWER_DOMAIN_MM_INFRA, PWR_STA, 0x20000000},
	{MT6895_POWER_DOMAIN_MM_PROC_DORMANT, PWR_STA, 0x40000000},
	{MT6895_POWER_DOMAIN_DP_TX, PWR_STA, 0x80000000},
