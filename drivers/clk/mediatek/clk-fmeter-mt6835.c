...
static const struct fmeter_clk fclks[] = {
	...
	FMCLK2(CKGEN, FM_UART_CK, "fm_uart_ck", 0x0040, 7, 1),
	FMCLK2(CKGEN, FM_SPI_CK, "fm_spi_ck", 0x0040, 15, 1),
	FMCLK2(CKGEN, FM_MSDC_0P_MACRO_CK, "fm_msdc_0p_macro_ck", 0x0040, 23, 1),
	FMCLK2(CKGEN, FM_MSDC5HCLK_CK, "fm_msdc5hclk_ck", 0x0040, 31, 1),
	FMCLK2(CKGEN, FM_MSDC50_0_CK, "fm_msdc50_0_ck", 0x0050, 7, 1),
	FMCLK2(CKGEN, FM_AES_MSDCFDE_CK, "fm_aes_msdcfde_ck", 0x0050, 15, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_CK, "fm_msdc_macro_ck", 0x0050, 23, 1),
	FMCLK2(CKGEN, FM_MSDC30_1_CK, "fm_msdc30_1_ck", 0x0050, 31, 1),
	FMCLK2(CKGEN, FM_AUDIO_CK, "fm_audio_ck", 0x0060, 7, 1),
	FMCLK2(CKGEN, FM_AUD_INTBUS_CK, "fm_aud_intbus_ck", 0x0060, 15, 1),
	...
	FMCLK2(CKGEN, FM_SENINF_CK, "fm_seninf_ck", 0x0070, 23, 1),
	FMCLK2(CKGEN, FM_SENINF1_CK, "fm_seninf1_ck", 0x0070, 31, 1),
	FMCLK2(CKGEN, FM_SENINF2_CK, "fm_seninf2_ck", 0x0080, 7, 1),
	FMCLK2(CKGEN, FM_DXCC_CK, "fm_dxcc_ck", 0x0080, 15, 1),
	FMCLK2(CKGEN, FM_AUD_ENGEN1_CK, "fm_aud_engen1_ck", 0x0080, 23, 1),
	FMCLK2(CKGEN, FM_AUD_ENGEN2_CK, "fm_aud_engen2_ck", 0x0080, 31, 1),
	FMCLK2(CKGEN, FM_AES_UFSFDE_CK, "fm_aes_ufsfde_ck", 0x0090, 7, 1),
	FMCLK2(CKGEN, FM_U_CK, "fm_u_ck", 0x0090, 15, 1),
	FMCLK2(CKGEN, FM_AUD_1_CK, "fm_aud_1_ck", 0x0090, 23, 1),
	FMCLK2(CKGEN, FM_AUD_2_CK, "fm_aud_2_ck", 0x0090, 31, 1),
	FMCLK2(CKGEN, FM_DPMAIF_MAIN_CK, "fm_dpmaif_main_ck", 0x00A0, 7, 1),
	FMCLK2(CKGEN, FM_VENC_CK, "fm_venc_ck", 0x00A0, 15, 1),
	FMCLK2(CKGEN, FM_VDEC_CK, "fm_vdec_ck", 0x00A0, 23, 1),
	FMCLK2(CKGEN, FM_PWM_CK, "fm_pwm_ck", 0x00A0, 31, 1),
	FMCLK2(CKGEN, FM_AUDIO_H_CK, "fm_audio_h_ck", 0x00B0, 7, 1),
	FMCLK2(CKGEN, FM_MCUPM_CK, "fm_mcupm_ck", 0x00B0, 15, 1),
	FMCLK2(CKGEN, FM_MEM_SUB_CK, "fm_mem_sub_ck", 0x00B0, 23, 1),
	FMCLK2(CKGEN, FM_MEM_SUBP_CK, "fm_mem_subp_ck", 0x00B0, 31, 1),
	FMCLK2(CKGEN, FM_MEM_SUB_U_CK, "fm_mem_sub_u_ck", 0x00C0, 7, 1),
	FMCLK2(CKGEN, FM_AP2CONN_HOST_CK, "fm_ap2conn_host_ck", 0x00C0, 15, 1),
	FMCLK2(CKGEN, FM_MCU_ACP_CK, "fm_mcu_acp_ck", 0x00C0, 23, 1),
	FMCLK2(CKGEN, FM_IMG1_CK, "fm_img1_ck", 0x00C0, 31, 1),
	FMCLK2(CKGEN, FM_IPE_CK, "fm_ipe_ck", 0x00D0, 7, 1),
	FMCLK2(CKGEN, FM_CAM_CK, "fm_cam_ck", 0x00D0, 15, 1),
	FMCLK2(CKGEN, FM_CAMTM_CK, "fm_camtm_ck", 0x00D0, 23, 1),
	FMCLK2(CKGEN, FM_MSDC_1P_RX_CK, "fm_msdc_1p_rx_ck", 0x00D0, 31, 1),
	FMCLK2(CKGEN, FM_NFI1X_CK, "fm_nfi1x_ck", 0x00E0, 7, 1),
	FMCLK2(CKGEN, FM_DBI_CK, "fm_dbi_ck", 0x00E0, 15, 1),
	FMCLK2(CKGEN, FM_MFG_REF_CK, "fm_mfg_ref_ck", 0x00E0, 23, 1),
	FMCLK2(CKGEN, FM_EMI_INTERFACE_546_CK, "fm_emi_interface_546_ck", 0x00E0, 31, 1),
	FMCLK2(CKGEN, FM_EMI_INTERFACE_624_CK, "fm_emi_interface_624_ck", 0x00F0, 7, 1),
	/* ABIST Part */
	...
	FMCLK(ABIST, FM_ULPOSC_MON_NONAOC20_CK, "fm_ulposc_mon_nonaoc20_ck", 1),
	...
	FMCLK3(ABIST, FM_MFGPLL_OPP_CKDIV_CK, "fm_mfgpll_opp_ckdiv_ck", 0x03C4, 1, 8),
	...
	FMCLK2(VLPCK, FM_DBGAO_26M_CK, "fm_dbgao_26m_ck", 0x0014, 23, 1),
	FMCLK2(VLPCK, FM_SYSTIMER_26M_CK, "fm_systimer_26m_ck", 0x0014, 31, 1),
	FMCLK2(VLPCK, FM_SSPM_CK, "fm_sspm_ck", 0x0020, 7, 1),
	FMCLK2(VLPCK, FM_SSPM_F26M_CK, "fm_sspm_f26m_ck", 0x0020, 15, 1),
	FMCLK2(VLPCK, FM_SRCK_CK_2, "fm_srck_ck_2", 0x0020, 23, 1),
	FMCLK2(VLPCK, FM_SRAMRC_CK, "fm_sramrc_ck", 0x0020, 31, 1),
	...
	FMCLK(VLPCK, FM_VLP_F26M_COM_CK, "fm_vlp_f26m_com_ck", 1),
	FMCLK(VLPCK, FM_VLP_F32K_COM_CK, "fm_vlp_f32k_com_ck", 1),
	FMCLK(VLPCK, FM_RTC32K_NO_SCAN, "fm_rtc32k_no_scan", 1),
	FMCLK(VLPCK, FM_SYS26M_NO_SCAN, "fm_sys26m_no_scan", 1),
	FMCLK(VLPCK, FM_OSC26M_NO_SCAN, "fm_osc26m_no_scan", 1),
	FMCLK(VLPCK, FM_MD_OSC26M_VLP_CK, "fm_md_osc26m_vlp_ck", 1),
	FMCLK(VLPCK, FM_F32K_VLP_CK, "fm_f32k_vlp_ck", 1),
	FMCLK(VLPCK, FM_F32K_VCORE_CK_2, "fm_f32k_vcore_ck_2", 1),
	{},
};
...
const struct fmeter_clk *mt6835_get_fmeter_clks(void)
{
	return fm_all_clks;
}
...
{
	unsigned int temp, clk_dbg_cfg, clk_misc_cfg_0, clk26cali_1 = 0, ap_pllgpl1;
	...
	ap_pllgpl1 = clk_readl(AP_PLLGP1_CON0);
	clk_writel(AP_PLLGP1_CON0, (ap_pllgpl1 | 0x00FFC000));
	...
	clk_writel(AP_PLLGP1_CON0, ap_pllgpl1);
...
static unsigned int mt6835_get_ckgen_freq(unsigned int ID)
{
	return __mt_get_freq(ID, CKGEN);
}

static unsigned int mt6835_get_abist_freq(unsigned int ID)
{
	return __mt_get_freq(ID, ABIST);
}

static unsigned int mt6835_get_abist2_freq(unsigned int ID)
{
	return __mt_get_freq(ID, ABIST_2);
}

static unsigned int mt6835_get_vlpck_freq(unsigned int ID)
{
	return __mt_get_freq2(VLP_CK_CON0, VLP_CK_CON1, ID, VLPCK);
}

static unsigned int mt6835_get_subsys_freq(unsigned int ID)
{
	int output = 0;
	unsigned long flags;
...
static unsigned int mt6835_get_fmeter_freq(unsigned int id,
		enum FMETER_TYPE type)
{
	if (type == CKGEN)
		return mt6835_get_ckgen_freq(id);
	else if (type == ABIST)
		return mt6835_get_abist_freq(id);
	else if (type == ABIST_2)
		return mt6835_get_abist2_freq(id);
	else if (type == SUBSYS)
		return mt6835_get_subsys_freq(id);
	else if (type == VLPCK)
		return mt6835_get_vlpck_freq(id);
	return FT_NULL;
}

static int mt6835_subsys_freq_register(struct fm_subsys *fm, unsigned int size)
{
...
static int mt6835_get_fmeter_id(enum FMETER_ID fid)
{
	if (fid == FID_DISP_PWM)
...
static struct fmeter_ops fm_ops = {
	.get_fmeter_clks = mt6835_get_fmeter_clks,
	.get_fmeter_freq = mt6835_get_fmeter_freq,
	.subsys_freq_register = mt6835_subsys_freq_register,
	.get_fmeter_id = mt6835_get_fmeter_id,
};

static int clk_fmeter_mt6835_probe(struct platform_device *pdev)
{
	int i;

	topck_base = get_base_from_comp("mediatek,mt6835-topckgen");
	if (IS_ERR(topck_base))
		goto ERR;

	apmixed_base = get_base_from_comp("mediatek,mt6835-apmixedsys");
	if (IS_ERR(apmixed_base))
		goto ERR;

	spm_base = get_base_from_comp("mediatek,mt6835-scpsys");
	if (IS_ERR(spm_base))
		goto ERR;

	vlp_ck_base = get_base_from_comp("mediatek,mt6835-vlp_cksys");
...
static struct platform_driver clk_fmeter_mt6835_drv = {
	.probe = clk_fmeter_mt6835_probe,
	.driver = {
		.name = "clk-fmeter-mt6835",
		.owner = THIS_MODULE,
	},
};
...
static int __init clk_fmeter_init(void)
{
	...
	clk_fmeter_dev = platform_device_register_simple("clk-fmeter-mt6835", -1, NULL, 0);
	if (IS_ERR(clk_fmeter_dev))
		pr_warn("unable to register clk-fmeter device");

	return platform_driver_register(&clk_fmeter_mt6835_drv);
}

static void __exit clk_fmeter_exit(void)
{
	platform_driver_unregister(&clk_fmeter_mt6835_drv);
}
