...
static const struct mtk_fixed_factor top_divs[] __initconst = {
	...
	FACTOR(TOP_AD_OSC2_CK, "ad_osc2_ck", "osc2", 1,
		1),
	FACTOR(TOP_OSC2_D2, "osc2_d2", "osc2", 1,
		2),
...
static const struct mtk_mux top_muxes[] __initconst = {
#if MT_CCF_BRINGUP
	/* CLK_CFG_0 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AXI, "axi_sel",
		axi_parents, CK_CFG_0, CK_CFG_0_SET,
		CK_CFG_0_CLR, 0, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_MM, "mm_sel",
		mm_parents, CK_CFG_0, CK_CFG_0_SET,
		K_CFG_0_CLR, 8, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SCP, "scp_sel", scp_parents,
		CK_CFG_0, CK_CFG_0_SET, CK_CFG_0_CLR,
		16, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_1 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_IMG, "img_sel", img_parents,
		CK_CFG_1, CK_CFG_1_SET, CK_CFG_1_CLR,
		0, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_IPE, "ipe_sel", ipe_parents,
		CK_CFG_1, CK_CFG_1_SET, CK_CFG_1_CLR,
		8, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DPE, "dpe_sel", dpe_parents,
		CK_CFG_1, CK_CFG_1_SET, CK_CFG_1_CLR,
		16, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CAM, "cam_sel", cam_parents,
		CK_CFG_1, CK_CFG_1_SET, CK_CFG_1_CLR,
		24, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_2 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CCU, "ccu_sel", ccu_parents,
		CK_CFG_2, CK_CFG_2_SET, CK_CFG_2_CLR,
		0, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DSP, "dsp_sel", dsp_parents,
		CK_CFG_2, CK_CFG_2_SET, CK_CFG_2_CLR,
		8, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DSP1, "dsp1_sel", dsp1_parents,
		CK_CFG_2, CK_CFG_2_SET, CK_CFG_2_CLR,
		16, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DSP2, "dsp2_sel", dsp2_parents,
		CK_CFG_2, CK_CFG_2_SET, CK_CFG_2_CLR,
		24, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_3 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DSP3, "dsp3_sel", dsp3_parents,
		CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
		0, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_IPU_IF, "ipu_if_sel", ipu_if_parents,
		CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
		8, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_MFG, "mfg_sel", mfg_parents,
		CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
		16, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_F52M_MFG, "f52m_mfg_sel",
		f52m_mfg_parents, CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
		24, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_4 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CAMTG, "camtg_sel", camtg_parents,
		CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR,
		0, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CAMTG2, "camtg2_sel", camtg2_parents,
		CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR,
		8, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CAMTG3, "camtg3_sel", camtg3_parents,
		CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR,
		16, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CAMTG4, "camtg4_sel", camtg4_parents,
		CK_CFG_4, CK_CFG_4_SET, CK_CFG_4_CLR,
		24, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_5 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_UART, "uart_sel", uart_parents,
		CK_CFG_5, CK_CFG_5_SET, CK_CFG_5_CLR,
		0, 1, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SPI, "spi_sel", spi_parents,
		CK_CFG_5, CK_CFG_5_SET, CK_CFG_5_CLR,
		8, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_MSDC50_0_HCLK, "msdc50_hclk_sel",
		msdc50_hclk_parents,
		CK_CFG_5, CK_CFG_5_SET, CK_CFG_5_CLR,
		16, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_MSDC50_0, "msdc50_0_sel",
		msdc50_0_parents, CK_CFG_5, CK_CFG_5_SET, CK_CFG_5_CLR,
		24, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_6 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_MSDC30_1, "msdc30_1_sel",
		msdc30_1_parents, CK_CFG_6, CK_CFG_6_SET, CK_CFG_6_CLR,
		0, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AUDIO, "audio_sel", audio_parents,
		CK_CFG_6, CK_CFG_6_SET, CK_CFG_6_CLR,
		8, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AUD_INTBUS, "aud_intbus_sel",
		aud_intbus_parents,
		CK_CFG_6, CK_CFG_6_SET, CK_CFG_6_CLR,
		16, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_FPWRAP_ULPOSC, "fpwrap_ulposc_sel",
	...
	/* CLK_CFG_7 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_ATB, "atb_sel", atb_parents,
		CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR,
		0, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SSPM, "sspm_sel", sspm_parents,
		CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR,
		8, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DPI0, "dpi0_sel", dpi0_parents,
		CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR,
		16, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SCAM, "scam_sel", scam_parents,
		CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR,
		24, 1, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_8 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DISP_PWM, "disppwm_sel",
		disppwm_parents, CK_CFG_8, CK_CFG_8_SET, CK_CFG_8_CLR,
		0, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_USB_TOP, "usb_top_sel",
		usb_top_parents, CK_CFG_8, CK_CFG_8_SET, CK_CFG_8_CLR,
		8, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SSUSB_TOP_XHCI, "ssusb_top_xhci_sel",
		ssusb_top_xhci_parents,
		CK_CFG_8, CK_CFG_8_SET, CK_CFG_8_CLR,
		16, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SPM, "spm_sel", spm_parents,
		CK_CFG_8, CK_CFG_8_SET, CK_CFG_8_CLR,
		24, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_9 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_I2C, "i2c_sel", i2c_parents,
		CK_CFG_9, CK_CFG_9_SET, CK_CFG_9_CLR,
		0, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SENINF, "seninf_sel", seninf_parents,
		CK_CFG_9, CK_CFG_9_SET, CK_CFG_9_CLR,
		8, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SENINF1, "seninf1_sel",
		seninf1_parents, CK_CFG_9, CK_CFG_9_SET, CK_CFG_9_CLR,
		16, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SENINF2, "seninf2_sel",
		seninf2_parents, CK_CFG_9, CK_CFG_9_SET, CK_CFG_9_CLR,
		24, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_10 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DXCC, "dxcc_sel", dxcc_parents,
		CK_CFG_10, CK_CFG_10_SET, CK_CFG_10_CLR,
		0, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AUD_ENG1, "aud_eng1_sel",
		aud_engen1_parents, CK_CFG_10, CK_CFG_10_SET,
		CK_CFG_10_CLR, 8, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AUD_ENG2, "aud_eng2_sel",
		aud_engen2_parents, CK_CFG_10, CK_CFG_10_SET,
		CK_CFG_10_CLR, 16, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_FAES_UFSFDE, "faes_ufsfde_sel",
		faes_ufsfde_parents,
		CK_CFG_10, CK_CFG_10_SET, CK_CFG_10_CLR,
		24, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),
	...
	/* CLK_CFG_11 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_FUFS, "fufs_sel", fufs_parents,
		CK_CFG_11, CK_CFG_11_SET, CK_CFG_11_CLR,
		0, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AUD_1, "aud_1_sel", aud_1_parents,
		CK_CFG_11, CK_CFG_11_SET, CK_CFG_11_CLR,
		8, 1, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AUD_2, "aud_2_sel", aud_2_parents,
		CK_CFG_11, CK_CFG_11_SET, CK_CFG_11_CLR,
		16, 1, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_ADSP, "adsp_sel", adsp_parents,
		CK_CFG_11, CK_CFG_11_SET, CK_CFG_11_CLR,
		24, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_12 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_DPMAIF, "dpmaif_sel", dpmaif_parents,
		CK_CFG_12, CK_CFG_12_SET, CK_CFG_12_CLR,
		0, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_VENC, "venc_sel", venc_parents,
		CK_CFG_12, CK_CFG_12_SET, CK_CFG_12_CLR,
		8, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_VDEC, "vdec_sel", vdec_parents,
		CK_CFG_12, CK_CFG_12_SET, CK_CFG_12_CLR,
		16, 4, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CAMTM, "camtm_sel", camtm_parents,
		CK_CFG_12, CK_CFG_12_SET, CK_CFG_12_CLR,
		24, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	/* CLK_CFG_13 */
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_PWM, "pwm_sel", pwm_parents,
		CK_CFG_13, CK_CFG_13_SET, CK_CFG_13_CLR,
		0, 1, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AUDIO_H, "audio_h_sel",
		audio_h_parents, CK_CFG_13, CK_CFG_13_SET,
		CK_CFG_13_CLR, 8, 2, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),

	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_CAMTG5, "camtg5_sel", camtg5_parents,
		CK_CFG_13, CK_CFG_13_SET, CK_CFG_13_CLR,
		24, 3, INVALID_MUX_GATE,
		INVALID_UPDATE_REG, INVALID_UPDATE_SHIFT, 0),
#else
	...
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_AXI, "axi_sel", axi_parents,
		CK_CFG_0, CK_CFG_0_SET, CK_CFG_0_CLR,
		0, 2, 7,
		CK_CFG_UPDATE, 0, CLK_IS_CRITICAL),
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_IPE, "ipe_sel", ipe_parents,
		CK_CFG_1, CK_CFG_1_SET, CK_CFG_1_CLR,
		8, 3, 15,
		CK_CFG_UPDATE, 5),

	MUX_GATE_CLR_SET_UPD(TOP_MUX_DPE, "dpe_sel", dpe_parents,
		CK_CFG_1, CK_CFG_1_SET, CK_CFG_1_CLR,
		16, 3, 23,
		CK_CFG_UPDATE, 6),
	...
	/* CLK_CFG_2 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_CCU, "ccu_sel", ccu_parents,
		CK_CFG_2, CK_CFG_2_SET, CK_CFG_2_CLR,
		0, 4, 7,
		CK_CFG_UPDATE, 8),
	...
	/* CLK_CFG_3 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_DSP3, "dsp3_sel", dsp3_parents,
		CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
		0, 4, 7,
		CK_CFG_UPDATE, 12),
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_F52M_MFG, "f52m_mfg_sel", f52m_mfg_parents,
		CK_CFG_3, CK_CFG_3_SET, CK_CFG_3_CLR,
		24, 2, 31,
		CK_CFG_UPDATE, 15),
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_MSDC50_0, "msdc50_0_sel", msdc50_0_parents,
		CK_CFG_5, CK_CFG_5_SET, CK_CFG_5_CLR,
		24, 3, 31,
		CK_CFG_UPDATE, 23),

	/* CLK_CFG_6 */
	MUX_GATE_CLR_SET_UPD(TOP_MUX_MSDC30_1, "msdc30_1_sel", msdc30_1_parents,
		CK_CFG_6, CK_CFG_6_SET, CK_CFG_6_CLR,
		0, 3, 7,
		CK_CFG_UPDATE, 24),
	...
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SSPM, "sspm_sel", sspm_parents,
		CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR,
		8, 3, 15,
		CK_CFG_UPDATE, 29, CLK_IS_CRITICAL),
	...
	MUX_GATE_CLR_SET_UPD(TOP_MUX_SCAM, "scam_sel", scam_parents,
		CK_CFG_7, CK_CFG_7_SET, CK_CFG_7_CLR,
		24, 1, 31,
		CK_CFG_UPDATE1, 0),
	...
	MUX_GATE_CLR_SET_UPD_FLAGS(TOP_MUX_SPM, "spm_sel", spm_parents,
		CK_CFG_8, CK_CFG_8_SET, CK_CFG_8_CLR,
		24, 2, 31,
		CK_CFG_UPDATE1, 4, CLK_IS_CRITICAL),
...
static const struct mtk_gate infra_clks[] __initconst = {
	...
	GATE_INFRA1_DUMMY(INFRACFG_AO_XIU_CG, "infra_xiu",
		"axi_sel", 19),
	GATE_INFRA1_DUMMY(INFRACFG_AO_DEVICE_APC_CG, "infra_device_apc",
		"axi_sel", 20),
...
static const struct mtk_gate cam_clks[] __initconst = {
#if MT_CCF_BRINGUP
	GATE_CAM_DUMMY(CAMSYS_LARB10_CGPDN, "camsys_larb10", "cam_sel", 0),
	GATE_CAM_DUMMY(CAMSYS_DFP_VAD_CGPDN, "camsys_dfp_vad", "cam_sel", 1),
	GATE_CAM_DUMMY(CAMSYS_LARB11_CGPDN, "camsys_larb11", "cam_sel", 2),
	GATE_CAM_DUMMY(CAMSYS_LARB9_CGPDN, "camsys_larb9", "cam_sel", 3),
	...
	GATE_CAM_DUMMY(CAMSYS_CAMSV3_CGPDN, "camsys_camsv3", "cam_sel", 12),
	GATE_CAM_DUMMY(CAMSYS_CCU_CGPDN, "camsys_ccu", "cam_sel", 13),
	GATE_CAM_DUMMY(CAMSYS_FAKE_ENG_CGPDN, "camsys_fake_eng", "cam_sel", 14),
#else
	GATE_CAM_DUMMY(CAMSYS_LARB10_CGPDN, "camsys_larb10", "cam_sel", 0),
	...
	GATE_CAM_DUMMY(CAMSYS_CAMSV3_CGPDN, "camsys_camsv3", "cam_sel", 12),
	GATE_CAM_DUMMY(CAMSYS_CCU_CGPDN, "camsys_ccu", "cam_sel", 13),
	GATE_CAM(CAMSYS_FAKE_ENG_CGPDN, "camsys_fake_eng", "cam_sel", 14),
#endif
};
...
static const struct mtk_gate img_clks[] __initconst = {
	...
	GATE_IMG_DUMMY(IMG_LARB6, "imgsys_larb6", "img_sel", 1),
...
static const struct mtk_gate ipe_clks[] __initconst = {
#if MT_CCF_BRINGUP
	GATE_IPE_DUMMY(IPE_LARB7, "ipe_larb7", "ipe_sel", 0),
	GATE_IPE_DUMMY(IPE_LARB8, "ipe_larb8", "ipe_sel", 1),
	GATE_IPE_DUMMY(IPE_SMI_SUBCOM, "ipe_smi_subcom", "ipe_sel", 2),
	GATE_IPE_DUMMY(IPE_FD, "ipe_fd", "ipe_sel", 3),
	GATE_IPE_DUMMY(IPE_FE, "ipe_fe", "ipe_sel", 4),
	GATE_IPE_DUMMY(IPE_RSC, "ipe_rsc", "ipe_sel", 5),
	GATE_IPE_DUMMY(IPE_DPE, "ipe_dpe", "ipe_sel", 6),
#else
	GATE_IPE_DUMMY(IPE_LARB7, "ipe_larb7", "ipe_sel", 0),
	GATE_IPE_DUMMY(IPE_LARB8, "ipe_larb8", "ipe_sel", 1),
	GATE_IPE(IPE_SMI_SUBCOM, "ipe_smi_subcom", "ipe_sel", 2),
	GATE_IPE(IPE_FD, "ipe_fd", "ipe_sel", 3),
	GATE_IPE(IPE_FE, "ipe_fe", "ipe_sel", 4),
	GATE_IPE(IPE_RSC, "ipe_rsc", "ipe_sel", 5),
	GATE_IPE(IPE_DPE, "ipe_dpe", "ipe_sel", 6),
#endif
};
...
static const struct mtk_gate_regs mdla_cg_regs = {
	.set_ofs = 0x4,
	.clr_ofs = 0x8,
	.sta_ofs = 0x0,
};

#define GATE_MDLA(_id, _name, _parent, _shift) {	\
		.id = _id,			\
		.name = _name,			\
		.parent_name = _parent,		\
		.regs = &mdla_cg_regs,		\
...
#define GATE_MDLA_DUMMY(_id, _name, _parent, _shift) {	\
		.id = _id,			\
		.name = _name,			\
		.parent_name = _parent,		\
		.regs = &mdla_cg_regs,		\
...
static const struct mtk_gate mdla_clks[] __initconst = {
/*MT_CCF_BRINGUP*/
	GATE_MDLA_DUMMY(APU_MDLA_CG_B0, "mdla_b0", "dsp3_sel", 0),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B1, "mdla_b1", "dsp3_sel", 1),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B2, "mdla_b2", "dsp3_sel", 2),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B3, "mdla_b3", "dsp3_sel", 3),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B4, "mdla_b4", "dsp3_sel", 4),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B5, "mdla_b5", "dsp3_sel", 5),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B6, "mdla_b6", "dsp3_sel", 6),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B7, "mdla_b7", "dsp3_sel", 7),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B8, "mdla_b8", "dsp3_sel", 8),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B9, "mdla_b9", "dsp3_sel", 9),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B10, "mdla_b10", "dsp3_sel", 10),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B11, "mdla_b11", "dsp3_sel", 11),
	GATE_MDLA_DUMMY(APU_MDLA_CG_B12, "mdla_b12", "dsp3_sel", 12),
	GATE_MDLA_DUMMY(APU_MDLA_APB_CG, "mdla_apb", "dsp3_sel", 13),
};
...
#define MT6779_INTEGER_BITS		8

/*#define CON0_MT6779_RST_BAR	BIT(24)*/
...
static void __init mtk_ipesys_init(struct device_node *node)
{
	...
	clk_data = mtk_alloc_clk_data(IPE_NR_CLK);
...
static void __init mtk_apu_mdla_init(struct device_node *node)
{
	...
	clk_data = mtk_alloc_clk_data(APU_MDLA_NR_CLK);

	mtk_clk_register_gates(node, mdla_clks,
		ARRAY_SIZE(mdla_clks), clk_data);
