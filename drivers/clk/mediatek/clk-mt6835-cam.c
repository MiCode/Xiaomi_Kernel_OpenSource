...
static const struct of_device_id of_match_clk_mt6835_cam[] = {
	{
		.compatible = "mediatek,mt6835-camsys_main",
		.data = &cam_m_mcd,
	}, {
		.compatible = "mediatek,mt6835-camsys_rawa",
		.data = &cam_ra_mcd,
	}, {
		.compatible = "mediatek,mt6835-camsys_rawb",
		.data = &cam_rb_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6835_cam_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6835_cam_drv = {
	.probe = clk_mt6835_cam_grp_probe,
	.driver = {
		.name = "clk-mt6835-cam",
		.of_match_table = of_match_clk_mt6835_cam,
	},
};

module_platform_driver(clk_mt6835_cam_drv);
MODULE_LICENSE("GPL");
