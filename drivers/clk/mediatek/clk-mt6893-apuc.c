...
static const struct mtk_gate apuc_clks[] = {
	...
	GATE_APUC(CLK_APUC_IOMMU_0, "apuc_iommu_0",
			"dsp7_ck"/* parent */, 15),
	GATE_APUC(CLK_APUC_IOMMU_1, "apuc_iommu_1",
			"dsp7_ck"/* parent */, 16),
	GATE_APUC(CLK_APUC_MD32_32K, "apuc_md32_32k",
			"dsp_ck"/* parent */, 17),
};

static int clk_mt6893_apuc_probe(struct platform_device *pdev)
{
...
static const struct of_device_id of_match_clk_mt6893_apuc[] = {
...
static struct platform_driver clk_mt6893_apuc_drv = {
	.probe = clk_mt6893_apuc_probe,
	.driver = {
		.name = "clk-mt6893-apuc",
		.of_match_table = of_match_clk_mt6893_apuc,
	},
};

builtin_platform_driver(clk_mt6893_apuc_drv);
...
static int __init clk_mt6893_apuc_init(void)
{
	return platform_driver_register(&clk_mt6893_apuc_drv);
}

static void __exit clk_mt6893_apuc_exit(void)
{
	platform_driver_unregister(&clk_mt6893_apuc_drv);
}

arch_initcall(clk_mt6893_apuc_init);
module_exit(clk_mt6893_apuc_exit);
MODULE_LICENSE("GPL");
