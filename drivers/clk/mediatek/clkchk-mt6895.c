...
static struct regbase rb[] = {
	...
	[dip_top_dip1] = REGBASE_V(0x15110000,
			...
			MT6895_POWER_DOMAIN_ISP_MAIN,
			CLK_NULL),
	[dip_nr_dip1] = REGBASE_V(0x15130000,
			dip_nr_dip1,
			MT6895_POWER_DOMAIN_ISP_MAIN,
			CLK_NULL),
	[wpe1_dip1] = REGBASE_V(0x15220000,
			wpe1_dip1,
			MT6895_POWER_DOMAIN_ISP_DIP1,
			CLK_NULL),
	[ipe] = REGBASE_V(0x15330000,
			ipe,
			MT6895_POWER_DOMAIN_ISP_MAIN,
			CLK_NULL),
	[wpe2_dip1] = REGBASE_V(0x15520000,
			wpe2_dip1,
			MT6895_POWER_DOMAIN_ISP_DIP1,
			CLK_NULL),
	[wpe3_dip1] = REGBASE_V(0x15620000,
			wpe3_dip1,
			MT6895_POWER_DOMAIN_ISP_DIP1,
			CLK_NULL),
	...
	[cam_m] = REGBASE_V(0x1a000000,
			cam_m,
			MT6895_POWER_DOMAIN_CAM_MRAW,
			CLK_NULL),
	[cam_ra] = REGBASE_V(0x1a04f000,
			cam_ra,
			MT6895_POWER_DOMAIN_CAM_SUBA,
			CLK_NULL),
	[cam_ya] = REGBASE_V(0x1a06f000,
			cam_ya,
			MT6895_POWER_DOMAIN_CAM_SUBA,
			CLK_NULL),
	[cam_rb] = REGBASE_V(0x1a08f000,
			cam_rb,
			MT6895_POWER_DOMAIN_CAM_SUBB,
			CLK_NULL),
	[cam_yb] = REGBASE_V(0x1a0af000,
			cam_yb,
			MT6895_POWER_DOMAIN_CAM_SUBB,
			CLK_NULL),
	[cam_rc] = REGBASE_V(0x1a0cf000,
			cam_rc,
			MT6895_POWER_DOMAIN_CAM_SUBC,
			CLK_NULL),
	[cam_yc] = REGBASE_V(0x1a0ef000,
			cam_yc,
			MT6895_POWER_DOMAIN_CAM_SUBC,
			CLK_NULL),
	[cam_mr] = REGBASE_V(0x1a170000,
			cam_mr,
			MT6895_POWER_DOMAIN_CAM_MRAW,
			CLK_NULL),
	[ccu] = REGBASE_V(0x1b200000, ccu, PD_NULL, CLK_NULL),
	[afe] = REGBASE_V(0x1e100000, afe, MT6895_POWER_DOMAIN_AUDIO, CLK_NULL),
	[mminfra_config] = REGBASE_V(0x1e800000,
			mminfra_config,
			MT6895_POWER_DOMAIN_MM_INFRA,
			CLK_NULL),
	[gce_d] = REGBASE_V(0x1e980000,
			gce_d,
			MT6895_POWER_DOMAIN_MM_INFRA,
			CLK_NULL),
	[gce_m] = REGBASE_V(0x1e990000,
			gce_m,
			MT6895_POWER_DOMAIN_MM_INFRA,
			CLK_NULL),
	[mdp] = REGBASE_V(0x1f000000, mdp, MT6895_POWER_DOMAIN_DISP, CLK_NULL),
	[mdp1] = REGBASE_V(0x1f800000,
			mdp1,
...
static struct pvd_msk pvd_pwr_mask[] = {
	...
	{"camsys_yuva", PWR_STA, 0x00200000},
	{"camsys_yuvb", PWR_STA, 0x00400000},
	{"camsys_yuvc", PWR_STA, 0x00800000},
	...
	{"gce_m", PWR_STA, 0x20000000},
	{"imgsys_main", PWR_STA, 0x00000800},
	...
	{"wpe1_dip1", PWR_STA, 0x00001000},
	{"wpe2_dip1", PWR_STA, 0x00001000},
	{"wpe3_dip1", PWR_STA, 0x00001000},
	{},
};
...
static struct mtk_vf vf_table[] = {
	...
	MTK_VF_TABLE("msdc_macro_sel", 416000, 416000, 416000, 416000),
	MTK_VF_TABLE("msdc30_1_sel", 208000, 208000, 208000, 208000),
	MTK_VF_TABLE("msdc30_2_sel", 208000, 208000, 208000),
