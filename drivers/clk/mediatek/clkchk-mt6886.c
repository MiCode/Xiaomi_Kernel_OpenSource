...
static struct regbase rb[] = {
	...
	[impes] = REGBASE_V(0x11C73000, impes, PD_NULL, CLK_NULL),
	[impw] = REGBASE_V(0x11E02000, impw, PD_NULL, CLK_NULL),
	[impe] = REGBASE_V(0x11E83000, impe, PD_NULL, CLK_NULL),
...
{
	if (idx < 0 || idx >= MT6886_CHK_PD_NUM)
		return 0;
...
static void dump_hwv_pll_reg(struct regmap *regmap, u32 shift)
{
	...
	set_subsys_reg_dump_mt6886(hwv_pll_dump_id);
