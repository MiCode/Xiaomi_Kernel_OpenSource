...
struct clk *mtk_clk_register_mux_upd(const struct mtk_mux_upd *mu,
...
void mtk_clk_register_mux_upds(const struct mtk_mux_upd *mus,
...
void mtk_clk_register_mux_clr_set_upds(const struct mtk_mux_clr_set_upd *mus,
		int num, void __iomem *base, spinlock_t *lock,
		struct clk_onecell_data *clk_data)
{
	struct clk *clk;
