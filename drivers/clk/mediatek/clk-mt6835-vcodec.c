...
static const struct of_device_id of_match_clk_mt6835_vcodec[] = {
	{
		.compatible = "mediatek,mt6835-vdec_gcon_base",
		.data = &vde2_mcd,
	}, {
		.compatible = "mediatek,mt6835-vencsys",
		.data = &ven1_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6835_vcodec_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6835_vcodec_drv = {
	.probe = clk_mt6835_vcodec_grp_probe,
	.driver = {
		.name = "clk-mt6835-vcodec",
		.of_match_table = of_match_clk_mt6835_vcodec,
	},
};

module_platform_driver(clk_mt6835_vcodec_drv);
MODULE_LICENSE("GPL");
