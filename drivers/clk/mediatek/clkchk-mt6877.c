...
static struct mtk_vf vf_table[] = {
	...
	MTK_VF_TABLE("dsp3_sel", 624000, 624000, 624000, 624000, 624000),
	MTK_VF_TABLE("dsp4_sel", 687500, 687500, 687500, 687500, 687500),
	MTK_VF_TABLE("dsp5_sel", 687500, 687500, 687500, 687500, 687500),
	MTK_VF_TABLE("dsp6_sel", 687500, 687500, 687500, 687500, 687500),
	...
	MTK_VF_TABLE("scam_sel", 109200, 109200, 109200, 109200, 109200),
