...
static int clk_mt6886_ccu_probe(struct platform_device *pdev)
{
	int r;
...
static const struct of_device_id of_match_clk_mt6886_ccu[] = {
	{
		.compatible = "mediatek,mt6886-ccu",
		.data = &ccu_mcd,
	},
	{}
};

static struct platform_driver clk_mt6886_ccu_drv = {
	.probe = clk_mt6886_ccu_probe,
	.driver = {
		.name = "clk-mt6886-ccu",
		.of_match_table = of_match_clk_mt6886_ccu,
	},
};

module_platform_driver(clk_mt6886_ccu_drv);
MODULE_LICENSE("GPL");
