...
static const struct mtk_mux vlp_ck_muxes[] = {
	...
	MUX_CLR_SET_UPD(CLK_VLP_CK_GPT_BCLK_SEL/* dts */, "vlp_gpt_bclk_sel",
		...
		VLP_CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_APXGPT66M_BCLK_SHIFT/* upd shift */),
	...
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_DXCC_SEL/* dts */, "vlp_dxcc_sel",
		vlp_dxcc_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 24/* lsb */, 3/* width */,
...
static const struct mtk_mux top_muxes[] = {
	...
	MUX_CLR_SET_UPD(CLK_TOP_UART_SEL/* dts */, "uart_sel",
		uart_parents/* parent */, CLK_CFG_7, CLK_CFG_7_SET,
		CLK_CFG_7_CLR/* set parent */, 8/* lsb */, 1/* width */,
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOPP_AXI_SEL/* dts */, "peri_axi_sel",
		peri_axi_parents/* parent */, CLK_CFG_0, CLK_CFG_0_SET,
		CLK_CFG_0_CLR/* set parent */, 8/* lsb */, 3/* width */,
		15/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_PERI_HD_FAXI_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_U_HAXI_SEL/* dts */, "ufs_haxi_sel",
		ufs_haxi_parents/* parent */, CLK_CFG_0, CLK_CFG_0_SET,
		CLK_CFG_0_CLR/* set parent */, 16/* lsb */, 3/* width */,
	...
	/* CLK_CFG_18 */
	MUX_GATE_CLR_SET_UPD(CLK_TOPP_MEM_SEL/* dts */, "peri_mem_sel",
		peri_mem_parents/* parent */, CLK_CFG_18, CLK_CFG_18_SET,
		CLK_CFG_18_CLR/* set parent */, 0/* lsb */, 3/* width */,
		7/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_PERI_HF_FMEM_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_U_MEM_SEL/* dts */, "ufs_mem_sel",
		ufs_mem_parents/* parent */, CLK_CFG_18, CLK_CFG_18_SET,
		CLK_CFG_18_CLR/* set parent */, 8/* lsb */, 3/* width */,
		15/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
	...
	/* CLK_CFG_19 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_EMI_S_SEL/* dts */, "emi_s_sel",
		emi_s_parents/* parent */, CLK_CFG_19, CLK_CFG_19_SET,
		CLK_CFG_19_CLR/* set parent */, 0/* lsb */, 2/* width */,
		7/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
...
static const struct mtk_pll_data apmixed_plls[] = {
	...
	PLL(CLK_APMIXED_ARMPLL_B, "armpll_b", ARMPLL_B_CON0/*base*/,
		...
		ARMPLL_B_CON3/*pwr*/, 0, BIT(0)/*rstb*/,
		ARMPLL_B_CON1, 24/*pd*/,
		0, 0, 0/*tuner*/,
