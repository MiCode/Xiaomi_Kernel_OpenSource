...
static const struct of_device_id of_match_clk_mt6886_cam[] = {
	{
		.compatible = "mediatek,mt6886-camsys_main",
		.data = &cam_m_mcd,
	}, {
		.compatible = "mediatek,mt6886-camsys_mraw",
		.data = &cam_mr_mcd,
	}, {
		.compatible = "mediatek,mt6886-camsys_rawa",
		.data = &cam_ra_mcd,
	}, {
		.compatible = "mediatek,mt6886-camsys_rawb",
		.data = &cam_rb_mcd,
	}, {
		.compatible = "mediatek,mt6886-camsys_yuva",
		.data = &cam_ya_mcd,
	}, {
		.compatible = "mediatek,mt6886-camsys_yuvb",
		.data = &cam_yb_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6886_cam_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6886_cam_drv = {
	.probe = clk_mt6886_cam_grp_probe,
	.driver = {
		.name = "clk-mt6886-cam",
		.of_match_table = of_match_clk_mt6886_cam,
	},
};

module_platform_driver(clk_mt6886_cam_drv);
MODULE_LICENSE("GPL");
