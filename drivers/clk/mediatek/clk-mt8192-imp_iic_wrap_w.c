...
static const struct mtk_gate imp_iic_wrap_w_clks[] = {
	GATE_IMP_IIC_WRAP_W(CLK_IMP_IIC_WRAP_W_I2C5, "imp_iic_wrap_w_i2c5",
			"infra_i2c0", 0),
};
...
static int clk_mt8192_imp_iic_wrap_w_probe(struct platform_device *pdev)
{
	...
	mtk_clk_register_gates(node, imp_iic_wrap_w_clks,
...
static int __init clk_mt8192_imp_iic_wrap_w_init(void)
{
	return platform_driver_register(&clk_mt8192_imp_iic_wrap_w_drv);
}

static void __exit clk_mt8192_imp_iic_wrap_w_exit(void)
{
	platform_driver_unregister(&clk_mt8192_imp_iic_wrap_w_drv);
}

arch_initcall(clk_mt8192_imp_iic_wrap_w_init);
module_exit(clk_mt8192_imp_iic_wrap_w_exit);
MODULE_LICENSE("GPL");
