...
static const struct of_device_id of_match_clk_mt6835_img[] = {
	{
		.compatible = "mediatek,mt6835-ipesys",
		.data = &ipe_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6835_img_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6835_img_drv = {
	.probe = clk_mt6835_img_grp_probe,
	.driver = {
		.name = "clk-mt6835-img",
		.of_match_table = of_match_clk_mt6835_img,
	},
};

module_platform_driver(clk_mt6835_img_drv);
MODULE_LICENSE("GPL");
