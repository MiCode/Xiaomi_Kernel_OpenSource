...
static const struct mtk_gate mdp_clks[] = {
	...
	GATE_MDP1(CLK_MDP_IMG_DL_ASYNC2, "mdp_img_dl_async2",
			"mdp_ck"/* parent */, 7),
	GATE_MDP1(CLK_MDP_SMI1, "mdp_smi1",
			"mdp_ck"/* parent */, 8),
	...
	GATE_MDP1(CLK_MDP_RESERVED43, "mdp_reserved43",
			"mdp_ck"/* parent */, 11),
	GATE_MDP1(CLK_MDP_SMI2, "mdp_smi2",
			"mdp_ck"/* parent */, 12),
...
builtin_platform_driver(clk_mt6893_mdp_drv);
...
arch_initcall(clk_mt6893_mdp_init);
