...
static struct clk_debug_mux gcc_debug_mux = {
	...
	MUX_SRC_LIST(
		...
		{ "cam_cc_qdss_debug_clk", 0x55, 1, CAM_CC,
			0x3D, 0xFF, 0, 0xF, 0, 4, 0xD000, 0xD004, 0xD008 },
		{ "cam_cc_qdss_debug_xo_clk", 0x55, 1, CAM_CC,
		...
		{ "gcc_boot_rom_ahb_clk", 0xA0, 1, GCC,
		...
		{ "gcc_cpuss_dvm_bus_clk", 0xE5, 1, GCC,
			0xE5, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_cpuss_gnoc_clk", 0xE1, 1, GCC,
		...
		{ "gcc_qmip_camera_nrt_ahb_clk", 0x47, 1, GCC,
			0x47, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_qmip_camera_rt_ahb_clk", 0x48, 1, GCC,
			0x48, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_qmip_disp_ahb_clk", 0x49, 1, GCC,
			0x49, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_qmip_video_cvp_ahb_clk", 0x45, 1, GCC,
			0x45, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_qmip_video_vcodec_ahb_clk", 0x46, 1, GCC,
		...
		{ "gcc_qupv3_wrap_0_m_ahb_clk", 0x82, 1, GCC,
			0x82, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_qupv3_wrap_0_s_ahb_clk", 0x83, 1, GCC,
			0x83, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_qupv3_wrap_1_m_ahb_clk", 0x8E, 1, GCC,
			0x8E, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		{ "gcc_qupv3_wrap_1_s_ahb_clk", 0x8F, 1, GCC,
		...
		{ "gcc_tsif_inactivity_timers_clk", 0x9E, 1, GCC,
		...
		{ "gcc_usb30_prim_sleep_clk", 0x6C, 1, GCC,
			0x6C, 0x3FF, 0, 0xF, 0, 1, 0x62000, 0x62004, 0x62008 },
		...
		{ "gcc_usb30_sec_sleep_clk", 0x73, 1, GCC,
...
static int clk_debug_sdm855_probe(struct platform_device *pdev)
{
	struct clk *clk;
	int ret = 0;
...
int __init clk_debug_sdm855_init(void)
{
	return platform_driver_register(&clk_debug_driver);
}
fs_initcall(clk_debug_sdm855_init);

MODULE_DESCRIPTION("QTI DEBUG CC SDM855 Driver");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("platform:debugcc-sdm855");
