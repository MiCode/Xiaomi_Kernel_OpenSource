...
static const struct freq_tbl ftbl_cam_cc_ipe_0_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(400000000, P_CAM_CC_PLL1_OUT_EVEN, 1, 0, 0),
	F(475000000, P_CAM_CC_PLL1_OUT_EVEN, 1, 0, 0),
	F(570000000, P_CAM_CC_PLL1_OUT_EVEN, 1, 0, 0),
...
static struct clk_regmap *cam_cc_sdm855_clocks[] = {
...
static const struct regmap_config cam_cc_sdm855_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
	.max_register	= 0xe004,
...
static const struct qcom_cc_desc cam_cc_sdm855_desc = {
	.config = &cam_cc_sdm855_regmap_config,
	.clks = cam_cc_sdm855_clocks,
	.num_clks = ARRAY_SIZE(cam_cc_sdm855_clocks),
};

static const struct of_device_id cam_cc_sdm855_match_table[] = {
	{ .compatible = "qcom,camcc-sdm855" },
	{ }
};
MODULE_DEVICE_TABLE(of, cam_cc_sdm855_match_table);
...
static int cam_cc_sdm855_probe(struct platform_device *pdev)
{
	...
	ret = qcom_cc_really_probe(pdev, &cam_cc_sdm855_desc, regmap);
	if (ret) {
...
static struct platform_driver cam_cc_sdm855_driver = {
	.probe		= cam_cc_sdm855_probe,
	.driver		= {
		.name	= "cam_cc-sdm855",
		.of_match_table = cam_cc_sdm855_match_table,
	},
};

static int __init cam_cc_sdm855_init(void)
{
	return platform_driver_register(&cam_cc_sdm855_driver);
}
subsys_initcall(cam_cc_sdm855_init);

static void __exit cam_cc_sdm855_exit(void)
{
	platform_driver_unregister(&cam_cc_sdm855_driver);
}
module_exit(cam_cc_sdm855_exit);

MODULE_DESCRIPTION("QTI CAM_CC SDM855 Driver");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("platform:cam_cc-sdm855");
