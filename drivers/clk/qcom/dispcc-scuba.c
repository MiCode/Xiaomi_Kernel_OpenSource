...
static struct clk_vdd_class *disp_cc_scuba_regulators[] = {
	&vdd_cx,
};
...
static const struct qcom_cc_desc disp_cc_scuba_desc = {
	...
	.clk_regulators = disp_cc_scuba_regulators,
	.num_clk_regulators = ARRAY_SIZE(disp_cc_scuba_regulators),
};
...
static void disp_cc_scuba_sync_state(struct device *dev)
{
	qcom_cc_sync_state(dev, &disp_cc_scuba_desc);
}
...
static struct platform_driver disp_cc_scuba_driver = {
	...
	.driver = {
		...
		.sync_state = disp_cc_scuba_sync_state,
	},
};
