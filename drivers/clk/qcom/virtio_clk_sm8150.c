...
static const char * const sm8150_gcc_virtio_clocks[] = {
...
const struct clk_virtio_desc clk_virtio_sm8150_gcc = {
	.clk_names = sm8150_gcc_virtio_clocks,
...
static const char * const sm8150_scc_virtio_clocks[] = {
...
const struct clk_virtio_desc clk_virtio_sm8150_scc = {
	.clk_names = sm8150_scc_virtio_clocks,
