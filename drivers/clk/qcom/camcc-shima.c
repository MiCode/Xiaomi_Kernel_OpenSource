...
static const struct clk_div_table post_div_table_cam_cc_pll2_out_early[] = {
	{ }
};

static struct clk_alpha_pll_postdiv cam_cc_pll2_out_early = {
	.offset = 0x2000,
	.post_div_shift = 8,
	.post_div_table = post_div_table_cam_cc_pll2_out_early,
	.num_post_div = ARRAY_SIZE(post_div_table_cam_cc_pll2_out_early),
	.width = 2,
	.regs = clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_ZONDA_5LPE],
	.clkr.hw.init = &(struct clk_init_data){
...
static const struct clk_parent_data cam_cc_parent_data_1[] = {
	...
	{ .hw = &cam_cc_pll2_out_early.clkr.hw },
	{ .fw_name = "core_bi_pll_test_se", .name = "core_bi_pll_test_se" },
};
...
static const struct freq_tbl ftbl_cam_cc_camnoc_axi_clk_src[] = {
	...
	F(342857143, P_CAM_CC_PLL0_OUT_MAIN, 3.5, 0, 0),
...
static struct clk_regmap *cam_cc_shima_clocks[] = {
...
static const struct regmap_config cam_cc_shima_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
	.max_register = 0xf008,
...
static const struct qcom_cc_desc cam_cc_shima_desc = {
	.config = &cam_cc_shima_regmap_config,
	.clks = cam_cc_shima_clocks,
	.num_clks = ARRAY_SIZE(cam_cc_shima_clocks),
};

static const struct of_device_id cam_cc_shima_match_table[] = {
	{ .compatible = "qcom,shima-camcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, cam_cc_shima_match_table);

static int cam_cc_shima_probe(struct platform_device *pdev)
{
	...
	regmap = qcom_cc_map(pdev, &cam_cc_shima_desc);
	if (IS_ERR(regmap))
...
static struct platform_driver cam_cc_shima_driver = {
	.probe = cam_cc_shima_probe,
	.driver = {
		.name = "cam_cc-shima",
...
static int __init cam_cc_shima_init(void)
{
	return platform_driver_register(&cam_cc_shima_driver);
}
subsys_initcall(cam_cc_shima_init);

static void __exit cam_cc_shima_exit(void)
{
	platform_driver_unregister(&cam_cc_shima_driver);
}
module_exit(cam_cc_shima_exit);

MODULE_DESCRIPTION("QTI CAM_CC SHIMA Driver");
