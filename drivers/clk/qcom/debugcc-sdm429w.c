...
static struct clk_debug_mux gcc_debug_mux = {
	...
	MUX_SRC_LIST(
		...
		{ "gcc_blsp2_uart1_apps_clk", 0x9C, 1, GCC, 0x9C, 0x1FF, 0, 0xF,
			 12, 1, 0x74000, 0x74000, 0x74000 },
		{ "gcc_blsp2_uart2_apps_clk", 0x9A, 1, GCC, 0x9A, 0x1FF, 0, 0xF,
			 12, 1, 0x74000, 0x74000, 0x74000 },
		...
		{ "gcc_mdss_byte1_clk", 0x1FC, 1, GCC, 0x1FC, 0x1FF, 0, 0xF,
			 12, 1, 0x74000, 0x74000, 0x74000 },
		{ "gcc_mdss_esc0_clk", 0x1E5, 1, GCC, 0x1E5, 0x1FF, 0, 0xF, 12,
			 1, 0x74000, 0x74000, 0x74000 },
		{ "gcc_mdss_esc1_clk", 0x1FD, 1, GCC, 0x1FD, 0x1FF, 0, 0xF, 12,
			 1, 0x74000, 0x74000, 0x74000 },
