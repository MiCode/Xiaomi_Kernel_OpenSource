...
static struct clk_branch gcc_aggre_ufs_card_axi_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_aggre_ufs_card_axi_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
...
static struct clk_branch gcc_aggre_ufs_phy_axi_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_aggre_ufs_phy_axi_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
...
static struct clk_branch gcc_ufs_card_axi_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_ufs_card_axi_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
...
static struct clk_branch gcc_ufs_card_ice_core_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_ufs_card_ice_core_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
...
static struct clk_branch gcc_ufs_card_phy_aux_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_ufs_card_phy_aux_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
...
static struct clk_branch gcc_ufs_card_unipro_core_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_ufs_card_unipro_core_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
...
static struct clk_branch gcc_ufs_phy_axi_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_ufs_phy_axi_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
...
static struct clk_branch gcc_ufs_phy_ice_core_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_ufs_phy_ice_core_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
...
static struct clk_branch gcc_ufs_phy_phy_aux_hw_ctl_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_ufs_phy_phy_aux_clk.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_hw_ctl_ops,
