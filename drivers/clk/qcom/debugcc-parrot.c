...
static int cam_cc_debug_mux_sels[] = {
	...
	0xE,		/* cam_cc_bps_clk */
	0x3C,		/* cam_cc_camnoc_atb_clk */
	0x3A,		/* cam_cc_camnoc_axi_clk */
	0x37,		/* cam_cc_camnoc_axi_hf_clk */
	0x36,		/* cam_cc_camnoc_axi_sf_clk */
	0x33,		/* cam_cc_cci_0_clk */
	0x34,		/* cam_cc_cci_1_clk */
	0x3E,		/* cam_cc_core_ahb_clk */
	0x35,		/* cam_cc_cpas_ahb_clk */
	0x40,		/* cam_cc_cre_ahb_clk */
	0x3F,		/* cam_cc_cre_clk */
	...
	0x2C,		/* cam_cc_icp_atb_clk */
	0x30,		/* cam_cc_icp_clk */
	0x2D,		/* cam_cc_icp_cti_clk */
	0x2E,		/* cam_cc_icp_ts_clk */
	...
	0x3D,		/* cam_cc_soc_ahb_clk */
	0x32,		/* cam_cc_sys_tmr_clk */
	0x1F,		/* cam_cc_tfe_0_ahb_clk */
	0x18,		/* cam_cc_tfe_0_clk */
	0x1E,		/* cam_cc_tfe_0_cphy_rx_clk */
	0x1B,		/* cam_cc_tfe_0_csid_clk */
	0x25,		/* cam_cc_tfe_1_ahb_clk */
	0x20,		/* cam_cc_tfe_1_clk */
	0x24,		/* cam_cc_tfe_1_cphy_rx_clk */
	0x22,		/* cam_cc_tfe_1_csid_clk */
	0x2B,		/* cam_cc_tfe_2_ahb_clk */
	0x26,		/* cam_cc_tfe_2_clk */
	0x2A,		/* cam_cc_tfe_2_cphy_rx_clk */
	0x28,		/* cam_cc_tfe_2_csid_clk */
};
...
static int disp_cc_debug_mux_sels[] = {
	...
	0x1D,		/* disp_cc_mdss_dptx0_aux_clk */
	0x1A,		/* disp_cc_mdss_dptx0_crypto_clk */
	0x17,		/* disp_cc_mdss_dptx0_link_clk */
	0x19,		/* disp_cc_mdss_dptx0_link_intf_clk */
	0x1B,		/* disp_cc_mdss_dptx0_pixel0_clk */
	0x1C,		/* disp_cc_mdss_dptx0_pixel1_clk */
	0x18,		/* disp_cc_mdss_dptx0_usb_router_link_intf_clk */
	0x24,		/* disp_cc_mdss_dptx1_aux_clk */
	0x23,		/* disp_cc_mdss_dptx1_crypto_clk */
	0x20,		/* disp_cc_mdss_dptx1_link_clk */
	0x22,		/* disp_cc_mdss_dptx1_link_intf_clk */
	0x1E,		/* disp_cc_mdss_dptx1_pixel0_clk */
	0x1F,		/* disp_cc_mdss_dptx1_pixel1_clk */
	0x21,		/* disp_cc_mdss_dptx1_usb_router_link_intf_clk */
	0x2A,		/* disp_cc_mdss_dptx2_aux_clk */
	0x29,		/* disp_cc_mdss_dptx2_crypto_clk */
	0x27,		/* disp_cc_mdss_dptx2_link_clk */
	0x28,		/* disp_cc_mdss_dptx2_link_intf_clk */
	0x25,		/* disp_cc_mdss_dptx2_pixel0_clk */
	0x26,		/* disp_cc_mdss_dptx2_pixel1_clk */
	0x2E,		/* disp_cc_mdss_dptx3_aux_clk */
	0x2F,		/* disp_cc_mdss_dptx3_crypto_clk */
	0x2C,		/* disp_cc_mdss_dptx3_link_clk */
	0x2D,		/* disp_cc_mdss_dptx3_link_intf_clk */
	0x2B,		/* disp_cc_mdss_dptx3_pixel0_clk */
...
static const char *const gcc_debug_mux_parent_names[] = {
	...
	"measure_only_gcc_qdss_wlan_at_clk",
	...
	"measure_only_gcc_wcss_at_clk",
	"measure_only_gcc_west_at_clk",
	"measure_only_gcc_west_trig_clk",
...
static int gcc_debug_mux_sels[] = {
	...
	0x1C7,		/* gcc_pcie_0_pipe_div2_clk */
	...
	0x1C5,		/* gcc_qupv3_wrap0_qspi0_clk */
	...
	0x1C6,		/* gcc_qupv3_wrap1_qspi0_clk */
	...
	0x1C1,		/* gcc_sdcc1_ahb_clk */
	0x1C2,		/* gcc_sdcc1_apps_clk */
	0x1C3,		/* gcc_sdcc1_ice_core_clk */
	...
	0x73,		/* gcc_video_throttle_core_clk */
	...
	0x1CE,		/* measure_only_gcc_qdss_wlan_at_clk */
	...
	0x1D3,		/* measure_only_gcc_sdcc1_at_clk */
	...
	0x1CC,		/* measure_only_gcc_wcss_at_clk */
	0x82,		/* measure_only_gcc_west_at_clk */
	0x1A2,		/* measure_only_gcc_west_trig_clk */
...
static int video_cc_debug_mux_sels[] = {
	0x12,		/* measure_only_gcc_video_ahb_clk */
...
static struct clk_dummy measure_only_gcc_qdss_wlan_at_clk = {
	.rrate = 1000,
	.hw.init = &(const struct clk_init_data){
		.name = "measure_only_gcc_qdss_wlan_at_clk",
		.ops = &clk_dummy_ops,
	},
};
...
static struct clk_dummy measure_only_gcc_wcss_at_clk = {
	.rrate = 1000,
	.hw.init = &(const struct clk_init_data){
		.name = "measure_only_gcc_wcss_at_clk",
		.ops = &clk_dummy_ops,
	},
};
...
static struct clk_dummy measure_only_gcc_west_trig_clk = {
	.rrate = 1000,
	.hw.init = &(const struct clk_init_data){
		.name = "measure_only_gcc_west_trig_clk",
		.ops = &clk_dummy_ops,
	},
};
...
static struct clk_hw *debugcc_parrot_hws[] = {
	...
	&measure_only_gcc_qdss_wlan_at_clk.hw,
...
static const struct of_device_id clk_debug_match_table[] = {
	{ .compatible = "qcom,parrot-debugcc" },
	{ }
};

static int clk_debug_parrot_probe(struct platform_device *pdev)
{
	struct clk *clk;
	int ret = 0, i;
...
static int __init clk_debug_parrot_init(void)
{
