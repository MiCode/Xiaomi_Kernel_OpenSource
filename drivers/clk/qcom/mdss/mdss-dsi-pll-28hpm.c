...
static struct clk_lookup mdss_dsi_pllcc[] = {
				...
				struct mdss_pll_resources *pll_res)
{
	...
	pr_info("Registering DSI PLL clocks\n");

	rc = of_msm_clock_register(pdev->dev.of_node, mdss_dsi_pllcc,
					 ARRAY_SIZE(mdss_dsi_pllcc));
	if (rc) {
