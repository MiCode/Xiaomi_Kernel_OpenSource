...
static struct clk_regmap_div gcc_pcie_2a_pipe_div_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_data = &(const struct clk_parent_data){
			.hw = &gcc_pcie_2a_pipe_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
...
static struct clk_regmap_div gcc_pcie_2b_pipe_div_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_data = &(const struct clk_parent_data){
			.hw = &gcc_pcie_2b_pipe_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_regmap_div_ro_ops,
...
static struct clk_regmap_div gcc_pcie_3a_pipe_div_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_data = &(const struct clk_parent_data){
			.hw = &gcc_pcie_3a_pipe_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_regmap_div_ro_ops,
...
static struct clk_regmap_div gcc_pcie_3b_pipe_div_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_data = &(const struct clk_parent_data){
			.hw = &gcc_pcie_3b_pipe_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_regmap_div_ro_ops,
...
static struct clk_regmap_div gcc_pcie_4_pipe_div_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_data = &(const struct clk_parent_data){
			.hw = &gcc_pcie_4_pipe_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_regmap_div_ro_ops,
...
static struct clk_regmap_div gcc_usb30_mp_mock_utmi_postdiv_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_data = &(const struct clk_parent_data){
			.hw = &gcc_usb30_mp_mock_utmi_clk_src.clkr.hw,
		},
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_regmap_div_ro_ops,
...
static struct clk_branch gcc_aggre_usb4_1_axi_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_1_master_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_aggre_usb4_axi_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_master_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_emac0_ptp_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_emac0_ptp_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_emac0_rgmii_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_emac0_rgmii_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_emac1_ptp_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_emac1_ptp_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_emac1_rgmii_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_emac1_rgmii_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie2a_phy_rchng_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_2a_phy_rchng_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie2b_phy_rchng_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_2b_phy_rchng_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie3a_phy_rchng_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_3a_phy_rchng_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie3b_phy_rchng_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_3b_phy_rchng_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie4_phy_rchng_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_4_phy_rchng_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_2a_aux_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_2a_aux_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_2a_pipediv2_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_2a_pipe_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_2b_aux_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_2b_aux_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_2b_pipediv2_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_2b_pipe_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_3a_aux_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_3a_aux_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_3a_pipediv2_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_3a_pipe_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_3b_aux_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_3b_aux_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_3b_pipediv2_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_3b_pipe_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_4_aux_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_4_aux_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_4_pipediv2_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_4_pipe_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_pcie_rscc_xo_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_pcie_rscc_xo_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_qupv3_wrap0_s4_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_qupv3_wrap0_s4_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_qupv3_wrap1_s4_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_qupv3_wrap1_s4_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_qupv3_wrap2_s4_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_qupv3_wrap2_s4_div_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb3_mp_phy_pipe_0_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb3_mp_phy_pipe_0_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb3_mp_phy_pipe_1_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb3_mp_phy_pipe_1_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb3_prim_phy_pipe_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb34_prim_phy_pipe_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb3_sec_phy_pipe_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb34_sec_phy_pipe_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_1_dp_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_1_phy_dp_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_1_phy_rx0_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_1_phy_rx0_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_1_phy_rx1_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_1_phy_rx1_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_1_sb_if_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_1_sb_if_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_1_sys_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_1_phy_sys_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_1_tmu_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_1_tmu_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_dp_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_phy_dp_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_phy_p2rr2p_pipe_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_phy_p2rr2p_pipe_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_phy_rx0_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_phy_rx0_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_phy_rx1_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_phy_rx1_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_sb_if_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_sb_if_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_sys_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_phy_sys_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
...
static struct clk_branch gcc_usb4_tmu_clk = {
	...
	.clkr = {
		...
		.hw.init = &(struct clk_init_data){
			...
			.parent_data = &(const struct clk_parent_data){
				.hw = &gcc_usb4_tmu_clk_src.clkr.hw,
			},
			.num_parents = 1,
			.flags = CLK_SET_RATE_PARENT,
			.ops = &clk_branch2_ops,
