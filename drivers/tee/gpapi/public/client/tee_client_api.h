...
/**
 *  Standard defined error codes. Type is TEEC_Result
 */
...
/* Reserved for future or implementation use 0xFFFF0011 – 0xFFFFFFFF */
...
/* Reserved for implementation-defined connection methods 0x80000000 – 0xFFFFFFFF */

/**
 * Defines the number of available memory references in an open session or
 * invoke command operation payload.
 */
#define TEEC_OPERATION_PARAM_COUNT 4


/**
 * This type is used to contain return codes which are the results of invoking
 * TEE Client API functions.
 */
typedef uint32_t TEEC_Result;

/**
 * TEEC_UUID contains a Universally Unique Resource Identifier (UUID) type as
...
/**
 * TEEC_Context - Represents a connection between a client application
 * and a TEE.
 * All members are Implementation-Defined.
 */
struct TEEC_Context {
	/*
	 * Implementation-Defined
	 * Below placeholder need to be compatible with multiple TEE
	 * implementations.
	 */
	uint8_t      reserved[8];
	/* MTK defined */
...
/**
 * TEEC_Session - Represents a connection between a client application
...
/**
 * TEEC_SharedMemory - Memory to transfer data between a client
...
/**
 * TEEC_TempMemoryReference - Temporary memory to transfer data between
...
/**
 * TEEC_RegisteredMemoryReference - use a pre-registered or
...
/**
 * TEEC_Value - Small raw data container
 *
...
/**
 * TEEC_Operation - Holds information and memory references used in
 * TEEC_InvokeCommand().
 *
...
struct TEEC_Operation {
	uint32_t             started;
	uint32_t             paramTypes;
	union TEEC_Parameter params[TEEC_OPERATION_PARAM_COUNT];
