...
static struct regulator *buck = NULL;;
...
//struct TEEC_UUID uuid_ta_fpc = { 0xf13010e0, 0x2ae1, 0x11e5, \
//	            { 0x89, 0x6a, 0x00, 0x02, 0xa5, 0xd5, 0xc5, 0x1d }
//};
...
static void fpc1022_get_irqNum(struct fpc1022_data *fpc1022)
{
	...
	node = of_find_compatible_node(NULL, NULL, "fpc,fpc1022");
