 ...
 * Melvin cao 2022/10/29  0.4.0      Return whether support poweroff
 *
 */
...
static nav_keymap_t keymap[] = {
    { NAV_KEY_UP,       KEY_SELECT,         }, /* KEY_RESERVED, ignore this key */
    { NAV_KEY_DOWN,     KEY_SELECT,       },
    { NAV_KEY_RIGHT,    KEY_SELECT,      },
    { NAV_KEY_LEFT,     KEY_SELECT,       },
    { NAV_KEY_CLICK,    KEY_SELECT,   },
    { NAV_KEY_DCLICK,   BTN_C,   },
    { NAV_KEY_LONGPRESS,KEY_SELECT,   },
};
