...
#define VDDIO_MIN 1800000
  ...
  #define SIL_EVENT_BLANK         DRM_EVENT_BLANK
  #define SIL_EVENT_UNBLANK       DRM_BLANK_UNBLANK
  #define SIL_EVENT_POWERDOWN     DRM_BLANK_POWERDOWN
  #define SIL_REGISTER_CLIENT(a)  do{ drm_register_client(a); }while(0)
#else
