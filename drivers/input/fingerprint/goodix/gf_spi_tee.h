...
struct gf_device {
	...
	struct pinctrl_state *fpsensor_goodix_power_on, *fpsensor_goodix_power_off, *pins_reset_high, *pins_reset_low, *pins_spi_cs_high, *pins_spi_cs_low;
#endif
};
