...
static const unsigned char aw86927_reg_access[AW86927_REG_MAX] = {
	[AW86927_REG_RSTCFG] = REG_RD_ACCESS,
	[AW86927_REG_SYSST] = REG_RD_ACCESS,
	[AW86927_REG_SYSINT] = REG_RD_ACCESS,
	[AW86927_REG_SYSINTM] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_SYSST2] = REG_RD_ACCESS,
	[AW86927_REG_SYSER] = REG_RD_ACCESS,
	[AW86927_REG_PLAYCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_PLAYCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_PLAYCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_PLAYCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG5] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG6] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG7] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG8] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG9] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG10] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG11] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG12] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_WAVCFG13] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG5] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG6] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG7] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG8] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG9] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG10] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG11] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG12] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG13] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_CONTCFG14] = REG_RD_ACCESS,
	[AW86927_REG_CONTCFG15] = REG_RD_ACCESS,
	[AW86927_REG_CONTCFG16] = REG_RD_ACCESS,
	[AW86927_REG_CONTCFG17] = REG_RD_ACCESS,
	[AW86927_REG_CONTCFG18] = REG_RD_ACCESS,
	[AW86927_REG_CONTCFG19] = REG_RD_ACCESS,
	[AW86927_REG_CONTCFG20] = REG_RD_ACCESS,
	[AW86927_REG_CONTCFG21] = REG_RD_ACCESS,
	[AW86927_REG_RTPCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_RTPCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_RTPCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_RTPCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_RTPCFG5] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_RTPDATA] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG5] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG6] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG7] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRGCFG8] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_GLBCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_GLBCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_GLBCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_GLBCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_GLBRD5] = REG_RD_ACCESS,
	[AW86927_REG_RAMADDRH] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_RAMADDRL] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_RAMDATA] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_SYSCTRL1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_SYSCTRL2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_SYSCTRL3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_SYSCTRL4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_SYSCTRL5] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_PWMCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_PWMCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_PWMCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_PWMCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_VBATCTRL] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_DETCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_DETCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_DETRD1] = REG_RD_ACCESS,
	[AW86927_REG_DETRD2] = REG_RD_ACCESS,
	[AW86927_REG_DETRD3] = REG_RD_ACCESS,
	[AW86927_REG_TRIMCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRIMCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRIMCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_TRIMCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_IDH] = REG_RD_ACCESS,
	[AW86927_REG_IDL] = REG_RD_ACCESS,
	[AW86927_REG_AUTOSIN1] = REG_RD_ACCESS,
	[AW86927_REG_AUTOSIN2] = REG_RD_ACCESS,
	[AW86927_REG_TMCFG] = REG_WR_ACCESS,
	[AW86927_REG_EFCFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_EFCFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_EFCFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_EFCFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_EFCFG5] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_EFCFG6] = REG_RD_ACCESS,
	[AW86927_REG_EFCFG7] = REG_RD_ACCESS,
	[AW86927_REG_EFCFG8] = REG_RD_ACCESS,
	[AW86927_REG_EFCFG9] = REG_RD_ACCESS,
	[AW86927_REG_TESTR] = REG_RD_ACCESS,
	[AW86927_REG_ANACFG1] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG2] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG3] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG4] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG5] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG6] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG7] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG8] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG9] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG10] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG11] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG12] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG13] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG14] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG15] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG16] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG17] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG18] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG19] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG20] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_BSTTEST] = REG_RD_ACCESS,
	[AW86927_REG_ANACFG21] = REG_RD_ACCESS | REG_WR_ACCESS,
	[AW86927_REG_ANACFG22] = REG_RD_ACCESS | REG_WR_ACCESS,
...
int aw86927_check_qualify(struct aw86927 *aw86927)
{
	...
	pr_info("%s enter!\n", __func__);
	ret = aw86927_i2c_read(aw86927, AW86927_REG_TESTR, &reg_val);
	if (ret < 0)
		return ret;
	if (!(reg_val & AW86927_BIT_TESTR_BIST_DONE)) {
		pr_err("The chip was not tested in mass production\n");
		return -ERANGE;
	}

	if ((reg_val & AW86927_BIT_TESTR_BIST_FAIL)) {
		pr_err("The chip mass production test is fialed\n");
		return -ERANGE;
	}

	if ((reg_val & AW86927_BIT_TESTR_BIST_OVP2S)) {
		pr_err("Over voltage of boost\n");
		return -ERANGE;
	}

	if (!(reg_val & AW86927_BIT_TESTR_BST_SS_FINISH)) {
		pr_err("Boost mode not turned on\n");
		return -ERANGE;
	}
	return 0;
}
				  ...
				  struct aw86927_container *aw86927_cont)
{
	...
	pr_info("%s enter!\n", __func__);
	aw86927_set_base_addr(aw86927);
	shift = aw86927->ram.ram_shift;
	for (i = shift; i < aw86927_cont->len; i++) {
		aw86927_i2c_read(aw86927, AW86927_REG_RAMDATA, &reg_val);
		if (reg_val != aw86927_cont->data[i]) {
			pr_err("%s: ram check error addr=0x%04x, file_data=0x%02X, ram_data=0x%02X\n",
				__func__, i, aw86927_cont->data[i], reg_val);
		}
		check_sum += reg_val;
	}
	aw86927_i2c_read(aw86927, AW86927_REG_RTPCFG1, &reg_val);
	check_sum += (reg_val & 0x1f);
	aw86927_i2c_read(aw86927, AW86927_REG_RTPCFG2, &reg_val);
	check_sum += reg_val;
	if (check_sum != aw86927->ram.check_sum) {
...
void aw86927_interrupt_setup(struct aw86927 *aw86927)
{
	...
	aw86927_i2c_write_bits(aw86927, AW86927_REG_SYSINTM,
				...
				AW86927_BIT_SYSINTM_BST_SCPM_OFF);
	aw86927_i2c_write_bits(aw86927, AW86927_REG_SYSINTM,
			       AW86927_BIT_SYSINTM_BST_OVPM_MASK,
			       AW86927_BIT_SYSINTM_BST_OVPM_ON);
	aw86927_i2c_write_bits(aw86927, AW86927_REG_SYSINTM,
				      ...
				      unsigned int flag)
{
	...
	case AW86927_WRITE_ZERO:
		pr_info("%s write zero to trim_lra!\n",
			    __func__);
		aw86927_i2c_write_bits(aw86927, AW86927_REG_ANACFG20,
				       AW86927_BIT_ANACFG20_TRIM_LRA_MASK,
				       0x00);
		break;
...
static void aw86927_haptic_misc_para_init(struct aw86927 *aw86927)
{
	...
	aw86927_i2c_write_bits(aw86927, AW86927_REG_TRIMCFG1,
				AW86927_BIT_TRIMCFG1_RL_TRIM_SRC_MASK,
				AW86927_BIT_TRIMCFG1_RL_TRIM_SRC_REG);
				...
				struct device_attribute *attr, char *buf)
{
	...
	for (i = 0; i < AW86927_REG_MAX; i++) {
		if (!(aw86927_reg_access[i] & REG_RD_ACCESS))
			continue;
		aw86927_i2c_read(aw86927, i, &reg_val);
		len += snprintf(buf + len, PAGE_SIZE - len,
				"reg:0x%02X=0x%02X\n", i, reg_val);
	}
	return len;
				 ...
				 size_t count)
{
	...
	if (sscanf(buf, "%x %x", &databuf[0], &databuf[1]) == 2) {
		if (aw86927_reg_access[databuf[0]] & REG_WR_ACCESS)
				     ...
				     struct aw86927_container *aw86927_cont)
{
	...
	ret = aw86927_check_ram_data(aw86927, aw86927_cont);
	if (ret < 0)
		pr_info("%s: ram data check sum error", __func__);
#endif
	/* RAMINIT Disable */
	aw86927_haptic_raminit(aw86927, false);
	mutex_unlock(&aw86927->lock);
...
static int aw86927_haptic_rtp_play(struct aw86927 *aw86927)
{
	...
	pm_qos_add_request(&pm_qos_req_vb, PM_QOS_CPU_DMA_LATENCY,
			   PM_QOS_VALUE_VB);
	timeout_us = aw86927_rtp->len / 24 * 1000;
	...
	while ((!aw86927_haptic_rtp_get_fifo_afs(aw86927)) &&
		...
		if (aw86927->is_custom_wave == 0) {
			...
			buf_len = read_rb(aw86927_rtp->data,  period_size*2);
			aw86927_i2c_writes(aw86927, AW86927_REG_RTPDATA,
...
irqreturn_t aw86927_irq(int irq, void *data)
{
	...
	if ((ret & AW86927_SYSINT_FF_AEI) && aw86927->rtp_init) {
		...
		while ((!aw86927_haptic_rtp_get_fifo_afs(aw86927)) &&
			...
			mutex_lock(&aw86927->rtp_lock);
			if (!aw86927->rtp_cnt) {
				pr_info("%s:aw86927->rtp_cnt is 0!\n",
					__func__);
				mutex_unlock(&aw86927->rtp_lock);
				break;
			}
