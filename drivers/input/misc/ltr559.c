...
#if defined(DYNAMIC_CALIBRATE) || defined(CONFIG_PSENSOR_ONDEMAND_STATE)
...
{
    struct ltr559_data *data = container_of(proximity_sensor_dev, struct ltr559_data, ps_cdev);
    struct i2c_client *client = data->client;
    int contr_data;
