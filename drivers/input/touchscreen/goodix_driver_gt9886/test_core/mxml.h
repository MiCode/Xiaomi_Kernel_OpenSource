...
/**** An XML element attribute value. @private@ ****/
	char *name;			/* Attribute name */
	char *value;		/* Attribute value */
} mxml_attr_t;

typedef struct mxml_element_s {
/**** An XML element value. @private@ ****/
...
extern void mxmlElementSetAttrf(mxml_node_t *node, const char *name, const char *format, ...)
#ifdef __GNUC__
...
extern mxml_node_t *mxmlFindElement(mxml_node_t *node,
		mxml_node_t *top, const char *element,
...
extern mxml_index_t *mxmlIndexNew(mxml_node_t *node,
