...
#endif
#define HIMAX_DRIVER_VER "0.2.5.0_ABCD1234_01"
...
struct himax_ts_data {
	...
	uint8_t irq_enabled;
	uint8_t selftest_type; /* 0:Open 1:Micro-Open 2:Short */
	uint8_t diag_self[50];
	uint8_t lockdown_info[HIMAX_LOCKDOWN_SIZE + 2];
