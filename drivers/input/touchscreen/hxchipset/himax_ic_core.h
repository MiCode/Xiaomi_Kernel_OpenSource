...
#if defined(HX_TP_PROC_GUEST_INFO)
#define HX_GUEST_INFO_FLASH_SADDR 0x40000
#define HX_LOCKDOWN_INFO_FLASH_SADDR 0x40008
...
enum bin_desc_map_table {
	...
	#define	game_enter_passwrd		0xA5
	#define	game_leave_passwrd		0x00
	#define game_mode_touchfunc_addr	0x10007FE0
	#define screen_orientation_addr		0x10007F3C
	#define horizontal_notch_left_size	0xA11AA11A
	#define horizontal_notch_right_size	0xA33AA33A
	#define verital_normal			0xA55AA55A
	#define verital_reverse			0xA77AA77A
#endif
	...
	#define pen_charge_detect_addr		0x10007FE4
#endif
...
#if defined(XM_GAME_MODE)
	int (*fp_game_mode_set)(uint8_t *touchfeature);
	int (*fp_Screen_orientation_set)(uint8_t direction);
#endif

#if defined(HX_PEN_DETECT_GLOBAL)
	int (*fp_pen_charge_mode_set)(int enable);
#endif
};
