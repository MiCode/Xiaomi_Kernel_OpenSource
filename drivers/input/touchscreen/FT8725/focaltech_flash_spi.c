...
/* N19 code for HQ-355103 by liaoxianguo at 2023/12/22 end */
/*****************************************************************************
...
/* N19 code for HQ-351812 by liaoxianguo at 2024/3/20 start */
static u8 fw_version;
static char tp_version_info[128] = "";
/* N19 code for HQ-351812 by liaoxianguo at 2024/3/20 end */
...
static int fts_get_fw_file_via_request_firmware(struct fts_upgrade *upg)
{
    ...
    if (0 == ret) {
        ...
        FTS_INFO("ft8725_firmware(%s) request fail,ret=%d", fwname, ret);
    }
...
/* N19 code for HQ-351812 by liaoxianguo at 2024/3/20 start */
        ...
        sprintf(tp_version_info,"[Vendor]Huaxing [TP-IC]:FT8725, [FW]0x%x\n",fw_version);
/* N19 code for HQ-351812 by liaoxianguo at 2024/3/20 end */
    }
}
...
{
    seq_printf(m, "[Vendor]:Huaxing [TP-IC]:FT8725 [FW]:0x%02x\n", fw_version);
    return 0;
}
