...
static int __init rmi4_incell_f54_module_init(void)
{
	synaptics_rmi4_incell_new_function(&f54_module, true);

	return 0;
}

static void __exit rmi4_incell_f54_module_exit(void)
{
	synaptics_rmi4_incell_new_function(&f54_module, false);
...
module_init(rmi4_incell_f54_module_init);
module_exit(rmi4_incell_f54_module_exit);
