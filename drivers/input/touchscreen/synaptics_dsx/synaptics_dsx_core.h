...
#define HAND_GRIP_NOGESTURE	0
#define HAND_GRIP_LEFT		1
#define HAND_GRIP_RIGHT		2
#define SIDE_TAP_LEFT		3
#define SIDE_TAP_RIGHT		4
#define SIDE_SWIPE_LEFT		5
#define SIDE_SWIPE_RIGHT	6
#define SIDE_DBL_TAP_LEFT	7
#define SIDE_DBL_TAP_RIGHT	8
#define SIDE_DBL_TAP_BOTH	9
#define SIDE_DBL_SWIPE_BOTH	10
