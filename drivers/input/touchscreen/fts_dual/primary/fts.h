...
#define PINCTRL_STATE_ACTIVE		"pmx_ts0_active"
#define PINCTRL_STATE_SUSPEND		"pmx_ts0_suspend"
#define PINCTRL_STATE_RELEASE		"pmx_ts0_release"
...
struct fts_ts_info {
	...
	struct proc_dir_entry *tp_pure_raw_proc;
	...
	struct mutex orientation_update_mutex;
