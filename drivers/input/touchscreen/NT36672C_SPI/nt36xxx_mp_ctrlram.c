 ...
 *
 * $Revision: 126062 $
 * $Date: 2023-09-20 17:50:42 +0800 (週三, 20 九月 2023) $
 *
...
static void nvt_print_criteria(void)
{
	...
	nvt_print_data_array(PS_Config_Lmt_Short_Rawdata_P, X_Channel,
			     Y_Channel);
	printk("PS_Config_Lmt_Short_Rawdata_N:\n");
	nvt_print_data_array(PS_Config_Lmt_Short_Rawdata_N, X_Channel,
			     Y_Channel);

	//---PS_Config_Lmt_Open_Rawdata---
	printk("PS_Config_Lmt_Open_Rawdata_P:\n");
	nvt_print_data_array(PS_Config_Lmt_Open_Rawdata_P, X_Channel,
			     Y_Channel);
	printk("PS_Config_Lmt_Open_Rawdata_N:\n");
	nvt_print_data_array(PS_Config_Lmt_Open_Rawdata_N, X_Channel,
			     Y_Channel);
	...
	if (ts->pen_support) {
		...
		nvt_print_data_array(PS_Config_Lmt_PenTipX_FW_Raw_P, ts->x_num,
				     ts->y_gang_num);
		printk("PS_Config_Lmt_PenTipX_FW_Raw_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenTipX_FW_Raw_N, ts->x_num,
				     ts->y_gang_num);

		//---PS_Config_Lmt_PenTipY_FW_Raw---
		printk("PS_Config_Lmt_PenTipY_FW_Raw_P:\n");
		nvt_print_data_array(PS_Config_Lmt_PenTipY_FW_Raw_P,
				     ts->x_gang_num, ts->y_num);
		printk("PS_Config_Lmt_PenTipY_FW_Raw_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenTipY_FW_Raw_N,
				     ts->x_gang_num, ts->y_num);

		//---PS_Config_Lmt_PenRingX_FW_Raw---
		printk("PS_Config_Lmt_PenRingX_FW_Raw_P:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingX_FW_Raw_P, ts->x_num,
				     ts->y_gang_num);
		printk("PS_Config_Lmt_PenRingX_FW_Raw_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingX_FW_Raw_N, ts->x_num,
				     ts->y_gang_num);

		//---PS_Config_Lmt_PenRingY_FW_Raw---
		printk("PS_Config_Lmt_PenRingY_FW_Raw_P:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingY_FW_Raw_P,
				     ts->x_gang_num, ts->y_num);
		printk("PS_Config_Lmt_PenRingY_FW_Raw_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingY_FW_Raw_N,
				     ts->x_gang_num, ts->y_num);

		//---PS_Config_Lmt_PenTipX_FW_Diff---
		printk("PS_Config_Lmt_PenTipX_FW_Diff_P:\n");
		nvt_print_data_array(PS_Config_Lmt_PenTipX_FW_Diff_P, ts->x_num,
				     ts->y_gang_num);
		printk("PS_Config_Lmt_PenTipX_FW_Diff_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenTipX_FW_Diff_N, ts->x_num,
				     ts->y_gang_num);

		//---PS_Config_Lmt_PenTipY_FW_Diff---
		printk("PS_Config_Lmt_PenTipY_FW_Diff_P:\n");
		nvt_print_data_array(PS_Config_Lmt_PenTipY_FW_Diff_P,
				     ts->x_gang_num, ts->y_num);
		printk("PS_Config_Lmt_PenTipY_FW_Diff_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenTipY_FW_Diff_N,
				     ts->x_gang_num, ts->y_num);

		//---PS_Config_Lmt_PenRingX_FW_Diff---
		printk("PS_Config_Lmt_PenRingX_FW_Diff_P:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingX_FW_Diff_P,
				     ts->x_num, ts->y_gang_num);
		printk("PS_Config_Lmt_PenRingX_FW_Diff_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingX_FW_Diff_N,
				     ts->x_num, ts->y_gang_num);

		//---PS_Config_Lmt_PenRingY_FW_Diff---
		printk("PS_Config_Lmt_PenRingY_FW_Diff_P:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingY_FW_Diff_P,
				     ts->x_gang_num, ts->y_num);
		printk("PS_Config_Lmt_PenRingY_FW_Diff_N:\n");
		nvt_print_data_array(PS_Config_Lmt_PenRingY_FW_Diff_N,
				     ts->x_gang_num, ts->y_num);
	} /* if (ts->pen_support) */
				       ...
				       uint32_t offset)
{
	...
	printk("%s:++\n", __func__);
	fbufp = (char *)kzalloc(
		x_ch * y_ch * 7 + y_ch * 2 + Key_Channel * 7 + 1, GFP_KERNEL);
	if (!fbufp) {
	...
	for (y = 0; y < y_ch; y++) {
		for (x = 0; x < x_ch; x++) {
			...
			sprintf(fbufp + iArrayIndex * 7 + y * 2, "%6d,",
				rawdata[iArrayIndex]);
		}
	...
	for (k = 0; k < Key_Channel; k++) {
		...
		sprintf(fbufp + keydata_output_offset + k * 7, "%6d,",
			rawdata[iArrayIndex]);
	}
...
static int32_t nvt_read_fw_noise(int32_t *xdata)
{
	...
	if (ts->pen_support) {
		...
		csv_pen_noise_offset +=
			ts->y_gang_num * ts->x_num * 7 + ts->y_gang_num * 2;
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenTipX_DiffMax, ts->x_num,
				     ts->y_gang_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		...
		csv_pen_noise_offset +=
			ts->y_gang_num * ts->x_num * 7 + ts->y_gang_num * 2;
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenTipX_DiffMin, ts->x_num,
				     ts->y_gang_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
...
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenTipY_DiffMax, ts->x_gang_num,
				     ts->y_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		...
		csv_pen_noise_offset +=
			ts->y_num * ts->x_gang_num * 7 + ts->y_num * 2;
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenTipY_DiffMin, ts->x_gang_num,
				     ts->y_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		...
		csv_pen_noise_offset +=
			ts->y_gang_num * ts->x_num * 7 + ts->y_gang_num * 2;
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenRingX_DiffMax, ts->x_num,
				     ts->y_gang_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		...
		csv_pen_noise_offset +=
			ts->y_gang_num * ts->x_num * 7 + ts->y_gang_num * 2;
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenRingX_DiffMin, ts->x_num,
				     ts->y_gang_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		...
		csv_pen_noise_offset +=
			ts->y_num * ts->x_gang_num * 7 + ts->y_num * 2;
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenRingY_DiffMax, ts->x_gang_num,
				     ts->y_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
...
#else /* #if NVT_SAVE_TEST_DATA_IN_FILE */
		nvt_print_data_array(RawData_PenRingY_DiffMin, ts->x_gang_num,
				     ts->y_num);
#endif /* #if NVT_SAVE_TEST_DATA_IN_FILE */
	} /* if (ts->pen_support) */
...
return:
	n.a.
*******************************************************/
void print_selftest_result(int32_t TestResult, uint8_t RecordResult[],
...
/* N19A code for HQ-364604 by p-huangyunbiao at 2024/1/8 start */
...
/* N19A code for HQ-364604 by p-huangyunbiao at 2024/1/8 end */
...
/* N19A code for HQ-378484 by p-huangyunbiao at 2024/3/20 start */
	if (nvt_update_firmware(MP_FW_LOAD) < 0) {
...
int32_t nvt_mp_proc_init(void)
{
	...
	NVT_proc_selftest_entry = proc_create(NVT_SELFTEST, 0664, NVT_proc_android_touch_entry,
						&nvt_selftest_fops);
...
/* N19A code for HQ-378484 by p-huangyunbiao at 2024/3/20 end */
	...
	if ((TestResult_FW_Rawdata == 0) && (TestResult_Noise == 0) &&
	    (TestResult_Short == 0) && (TestResult_Open == 0)) {
