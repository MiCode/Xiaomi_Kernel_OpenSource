...
*
* File Name: Focaltech_test_ft8720.c
*
...
#define FACTORY_REG_OPEN_ADDR                   0x89
...
*****************************************************************************/
int ft8720_short_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
...
int ft8720_open_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
    bool tmp_result = false;
