...
/* add begin by zhangchaofan firmware upgrade with update_tp_info, 2019-01-07*/
...
/* add end by zhangchaofan firmware upgrade with update_tp_info, 2019-01-07 */
...
void fts_fwupg_auto_upgrade(struct fts_ts_data *ts_data)
{
	...
	ts_data->touch_state = TOUCH_STATE_UPGRADING;    /* modify by zhangchaofan@longcheer.com Touch state, 2019-01-14 */
	...
	ts_data->touch_state = TOUCH_STATE_WORKING;  /* modify by zhangchaofan@longcheer.com Touch state, 2019-01-14 */
