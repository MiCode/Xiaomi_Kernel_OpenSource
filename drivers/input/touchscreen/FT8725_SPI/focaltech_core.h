...
//extern char Tp_name[HARDWARE_MAX_ITEM_LONGTH];        //HARDWARE_MAX_ITEM_LONGTH
/*****************************************************************************
...
#endif
#if IS_ENABLED(FTS_DRM_PANEL_NOTIFY)
	struct notifier_block drm_panel_notif;
#elif IS_ENABLED(FTS_MSM_DRM_NOTIFY)
	struct notifier_block drm_notif;
#elif IS_ENABLED(FTS_FB_NOTIFY)
	struct notifier_block fb_notif;
#elif IS_ENABLED(FTS_EARLYSUSPEND_NOTIFY)
	struct early_suspend early_suspend;
#elif IS_ENABLED(FTS_MTK_DRM_NOTIFY)
...
extern void panel_gesture_mode_set_by_ft8725(bool gst_mode);
/* N19A code for HQ-348470 by p-xielihui at 2024/1/2 end */
/* N19A code for HQ-364908 by p-huangyunbiao at 2024/1/8 start */
extern void panel_proximity_mode_set_by_ft8725(bool prx_mode);
