#ifndef __AAABBB__TOUCH_H
#define __AAABBB__TOUCH_H
...
struct aaabbb_touch_pdata{
	struct aaabbb_touch *device;
	struct aaabbb_touch_interface *touch_data;
	int palm_value;
	bool palm_changed;
	const char *name;
};
...
extern struct class *get_aaabbb_touch_class(void);

extern struct device *get_aaabbb_touch_dev(void);
