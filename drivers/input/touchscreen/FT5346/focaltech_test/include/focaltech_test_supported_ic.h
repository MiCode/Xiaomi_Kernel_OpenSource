...
struct stCfg_FT8716_TestItem {
	...
	bool LCD_NOISE_TEST;
	bool GPIO_TEST;
	bool RESETDETECTION_TEST;
	bool ERASE_TEST;
	bool RAWDATA_UNIFORMITY_TEST;
	bool VIRTUAL_DIFFER_TEST;
...
struct stCfg_FT8716_BasicThreshold {
	...
	bool RawDataUniformityTest_Check_FIXCB;
	bool RawDataUniformityTest_Check_CHX;
	bool RawDataUniformityTest_Check_CHY;
	int RawDataUniformityTest_CHX_Hole;
	int RawDataUniformityTest_CHY_Hole;
...
enum enumTestItem_FT8716 {
	...
	Code_FT8716_GPIO_TEST,
	Code_FT8716_IC_TYPE_TEST,
	Code_FT8716_RESET_DETECT_TEST,
	Code_FT8716_ERASE_SECTOR_TEST,
	Code_FT8716_RAWDATA_UNIFORMITY_TEST,
	Code_FT8716_VIRTUAL_DIFFER_TEST,
};
...
#elif (FT5X46_TEST)
/*-----------------------------------------------
FT5X46 and FT5X46 is the same series of chips
FT5422\FT5X46  is the chip code for internally develope
...
struct stCfg_FT5822_BasicThreshold {
	...
	BYTE NoiseTest_NoiseMode;
	BYTE NoiseTest_ShowTip;
	BYTE NoiseTest_ShowTipAfter;
	bool bNoiseTest_GloveMode;
	int NoiseTest_RawdataMin;
	bool bNoiseTest_FWMode;
	int NoiseTest_SetFrequency;
	unsigned char Set_Frequency;
	bool bNoiseThreshold_Choose;
	int NoiseTest_Threshold;
	int NoiseTest_MinNgFrame;
	int NoiseTest_Max_Value;
	int WeakShortTest_CG;
	int WeakShortTest_CC;
...
enum enumTestItem_FTE736 {
	Code_FTE736_ENTER_FACTORY_MODE,
	...
	Code_FTE736_LCD_NOISE_TEST,
	Code_FTE736_CB_DECREASE_TEST,
	Code_FTE736_VREF_DECREASE_TEST,
	Code_FTE736_IC_TYPE_TEST,
};
