...
int gtp_hardwareinfo_set(void)
{
	...
	printk("IC Config Version: %d, 0x%02x", cfg_version, cfg_version);
	sprintf(tp_string_version, "%s, GT915L_%x, V%d, %s", vendor, IC_Version, cfg_version, color);
