...
#include "../lct_tp/lct_tp_gesture.h"

#include "../lct_tp/lct_tp_proximity_switch.h"

#include "../xiaomi_tp/xiaomi_touch.h"
...
extern int lct_fts_set_charger_mode(bool en);
...
extern int lct_fts_set_earphone_mode(bool en);
