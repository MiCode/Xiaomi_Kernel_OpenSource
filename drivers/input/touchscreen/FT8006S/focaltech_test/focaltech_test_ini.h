...
#define BASIC_THRESHOLD_INCELL      { \
	...
	"OpenTest_K1Threshold", "OpenTest_Check_K2", "OpenTest_K2Threshold", \
	...
	"LCD_NoiseTest_Frame", \
	"LCD_NoiseTest_Coefficient", "LCD_NoiseTest_Coefficient_key", \
}
...
#define BASIC_THRESHOLD_MC_SC       { \
	...
	"RawDataTest_High_Max", "RawDataTest_HighFreq", \
	...
	"SCapCbTest_OFF_Min", "SCapCbTest_OFF_Max", \
	"ScapCBTest_SetWaterproof_OFF", \
	"SCapCbTest_ON_Min", "SCapCbTest_ON_Max", \
	"ScapCBTest_SetWaterproof_ON", \
	"SCapRawDataTest_OFF_Min", \
	"SCapRawDataTest_OFF_Max", "SCapRawDataTest_SetWaterproof_OFF", \
	"SCapRawDataTest_ON_Min", \
	"SCapRawDataTest_ON_Max", "SCapRawDataTest_SetWaterproof_ON", \
...
#define BASIC_THRESHOLD_SC          { \
	...
	"DeltaCbTest_Deviation_S2", "DeltaCbTest_Deviation_S3", \
	"DeltaCbTest_Deviation_S4", \
	"DeltaCbTest_Deviation_S5", "DeltaCbTest_Deviation_S6", \
	"DeltaCbTest_Set_Critical", \
	"DeltaCbTest_Critical_S1", "DeltaCbTest_Critical_S2", \
