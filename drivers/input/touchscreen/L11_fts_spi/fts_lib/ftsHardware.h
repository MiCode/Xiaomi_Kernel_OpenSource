...
#ifdef SALIXP
#define FLASH_NUM_PAGE				48	/* /< number of pages in main flash */
#else
...
/* SYSTEM RESET INFO */
#define ADDR_SYSTEM_RESET			((u64)0x0000000020000024) /* /< address of System control reg in FTI */
#define SYSTEM_RESET_VALUE			0x81						/* /< value to write in SYSTEM_RESET_ADDRESS to perform a system reset in FTM5 */

/* REMAP REGISTER */
#define ADDR_BOOT_OPTION			((u64)0x0000000020000025) /* /< address of Boot option register */
...
/* CRC ADDR */
#define ADDR_CRC				((u64)0x0000000020000078) /* /< address of CRC control register in FTI */
