...
extern FTS_I2C_READ_FUNCTION fts_i2c_read_test_sharp;
extern FTS_I2C_WRITE_FUNCTION fts_i2c_write_test_sharp;
...
///////////////////////about test
int set_param_data_sharp(char *TestParamData);//load config
boolean start_test_tp_sharp(void);//test entry
int get_test_data_sharp(char *pTestData);//test result data. (pTestData, External application for memory, buff size >= 1024*80)
...
extern struct StruScreenSeting g_ScreenSetParam_sharp; //set screen param
struct stTestItem
{
...
extern struct stCfg_MCap_DetailThreshold g_stCfg_MCap_DetailThreshold_sharp;
extern struct stCfg_SCap_DetailThreshold g_stCfg_SCap_DetailThreshold_sharp;
extern struct stCfg_Incell_DetailThreshold g_stCfg_Incell_DetailThreshold;
//extern struct structSCapConf g_stSCapConf;

extern int g_TestItemNum_sharp;/*test item num*/
extern char g_strIcName_sharp[20];/*IC Name*/
