...
int FT8607_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT8607_get_test_data_sharp;
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT8716_get_test_data_sharp;
...
int FT3D47_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT3D47_get_test_data_sharp;
...
int FT5X46_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT5X46_get_test_data_sharp;
...
int FT6X36_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT6X36_get_test_data_sharp;
...
int FT5822_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT5822_get_test_data_sharp;
...
int FT8006_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT8006_get_test_data_sharp;
...
int FT8736_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT8736_get_test_data_sharp;
...
int FTE716_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FTE716_get_test_data_sharp;
...
int FT8606_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT8606_get_test_data_sharp;
...
int FT3C47_get_test_data_sharp(char *pTestData);
...
void fts_test_funcs(void)
{
	...
	g_stTestFuncs.get_test_data_sharp = FT3C47_get_test_data_sharp;
