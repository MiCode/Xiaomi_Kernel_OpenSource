...
#ifdef CONFIG_ACPI
#define FT5X46_ACPI_NAME "FTSC0001"
#endif
...
#elif CONFIG_ACPI
static const struct acpi_device_id ft5x46_acpi_match[] = {
	{ FT5X46_ACPI_NAME , 0 },
	{},
};
MODULE_DEVICE_TABLE(acpi, ft5x46_acpi_match);
#else
...
static struct i2c_driver ft5x46_i2c_driver = {
	.driver = {
		...
		.owner = THIS_MODULE,
#ifdef CONFIG_ACPI
		.acpi_match_table = ACPI_PTR(ft5x46_acpi_match),
#else
