...
int ft8006m_i2c_write_reg(struct i2c_client *client, u8 regaddr, u8 regvalue)
{
	...
	buf[0] = regaddr;
	buf[1] = regvalue;
	return ft8006m_i2c_write(client, buf, sizeof(buf));
}

/************************************************************************
* Name: ft8006m_i2c_read_reg
* Brief: read register
* Input: i2c info, reg address, reg value
...
{
	return ft8006m_i2c_read(client, &regaddr, 1, regvalue, 1);
}

/************************************************************************
* Name: ft8006m_i2c_init
* Brief: fts i2c init
* Input:
* Output:
* Return:
