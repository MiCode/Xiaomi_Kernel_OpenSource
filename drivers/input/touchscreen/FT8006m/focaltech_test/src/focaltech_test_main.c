...
int ft8006m_focaltech_test_main_exit(void)
{
    ...
    /*  if(NULL != ft8006m_g_testparamstring)
        {
            FTS_TEST_DBG("[FTS] release memory ft8006m_g_testparamstring.");
            Ft8006m_fts_free(ft8006m_g_testparamstring);
            ft8006m_g_testparamstring = NULL;
        }
    */
