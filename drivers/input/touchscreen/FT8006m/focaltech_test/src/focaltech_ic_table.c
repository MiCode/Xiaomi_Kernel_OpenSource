...
unsigned int ft8006m_ic_table_get_ic_code_from_ic_name(char *strIcName)
{
...
void ft8006m_ic_table_get_ic_name_from_ic_code(unsigned int ucIcCode, char *strIcName)
{
	if (NULL == strIcName)
		return;
...
unsigned int ft8006m_ic_table_get_ic_code_from_chip_id(unsigned char chip_id, unsigned char chip_id2)
{
...
unsigned int ft8006m_ic_table_get_chip_id_from_ic_code(unsigned int ic_code, unsigned char *chip_id, unsigned char *chip_id2)
{
...
int ft8006m_ic_table_need_chip_id2(unsigned int chip_id)
{
	int b_need_id2 = -1;
	switch (chip_id) {
	case 0x86:
