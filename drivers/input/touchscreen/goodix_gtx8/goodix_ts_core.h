...
struct goodix_ts_core {
	...
	struct notifier_block aod_notif;
...
int proc_node_init(struct goodix_ts_core *core_data);
int goodix_get_lockdown_info(struct goodix_ts_core *core_data);
...
extern int aod_notifier_chain_register(struct notifier_block *n);
extern int aod_notifier_call_chain(unsigned long val, void *v);
extern int aod_notifier_chain_unregister(struct notifier_block *n);
