...
/*		board_print_info("chip version:");
		for (i=0;i<p_ver_param->ver_param_len;i++) {
			board_print_info("0x%02x,",p_ver_test_res->cur_ver_data[i]);
		}
		board_print_info("\n");
		board_print_info("ini version:");
		for (i=0;i<p_ver_param->ver_param_len;i++) {
			board_print_info("0x%02x,",p_ver_param->ver_param_str[i]);
		}
		board_print_info("\n");
*/
	}
