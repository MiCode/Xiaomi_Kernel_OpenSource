...
#define TEST_CODE_VERSION			"tp_test_v1.0.6"
/* test switch */
...
#define GTX8_TEST_FILE_NAME				"J10_test_limits"
...
struct gtx8_ts_test {
	...
	struct ts_test_rawdata rawdata_arr[TOTAL_FRAME_NUM];
...
static int gtx8_cache_origconfig(struct gtx8_ts_test *ts_test)
{
	...
	if (core_data->ts_dev->hw_ops->read_config) {
		...
		if (core_data->ts_dev->ic_type == IC_TYPE_YELLOWSTONE) {
			...
			ts_test->orig_config.data[3] = (u8)(0 -
