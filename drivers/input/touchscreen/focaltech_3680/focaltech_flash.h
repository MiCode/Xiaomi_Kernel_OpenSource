...
struct upgrade_func {
	...
	u8 *pramboot;
	u32 pb_length;
	int (*init)(u8 *var, u32 param);
	int (*write_pramboot_private)(void);
	int (*upgrade)(u8 *var, u32 param);
	int (*get_hlic_ver)(u8 *var);
	int (*lic_upgrade)(u8 *var, u32 param);
	int (*param_upgrade)(u8 *var, u32 param);
	int (*force_upgrade)(u8 *var, u32 param);
};
