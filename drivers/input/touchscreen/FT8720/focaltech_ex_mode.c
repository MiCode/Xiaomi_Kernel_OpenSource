...
#define FTS_USB_LEFT     2
#define FTS_USB_VERTICAL_CMD 0x00
#define FTS_USB_RIGHT_CMD    0X01
#define FTS_USB_LEFT_CMD     0X02
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	FTS_DEBUG("edge mode:%d,edge_mode_data:%d",ts_data->edge_mode,edge_mode_data);
	return count;
}
