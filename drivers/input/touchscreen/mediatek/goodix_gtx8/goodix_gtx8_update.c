...
static DEVICE_ATTR(progress, 0444, goodix_sysfs_update_progress_show, NULL);
static DEVICE_ATTR(result, 0444, goodix_sysfs_update_result_show, NULL);
static DEVICE_ATTR(fwversion, 0444,
		goodix_sysfs_update_fwversion_show, NULL);
static DEVICE_ATTR(fwsize, 0664, goodix_sysfs_fwsize_show,
		goodix_sysfs_fwsize_store);
static DEVICE_ATTR(force_update, 0220, NULL,
