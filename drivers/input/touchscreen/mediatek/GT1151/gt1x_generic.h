...
#endif
#define GT1X_CONFIG_PROC_FILE "gt1x_config"

#define CONFIG_GTP_GESTURE_WAKEUP    1  // gesture wakeup module
...
//for tp_capacitace_data
#define GT1X_OS_TEST_PROC_FILE        "tp_capacitace_data"
...
#define GTP_VENDOR_INFO             "[Vendor]Truly(TP) + CSOT(LCD), [TP-IC]GT1151Q, [FW-CFG]Ver"
