		...
		bool enable)
{
	...
	if (enable) {
		...
		if (!rmi4_data->irq_enabled) {
			...
			mt_eint_set_sens(CUST_EINT_TOUCH_PANEL_NUM, 1);///CUST_EINT_LEVEL_SENSITIVE
			mt_eint_set_hw_debounce(CUST_EINT_TOUCH_PANEL_NUM, CUST_EINT_TOUCH_PANEL_DEBOUNCE_CN);
			//mt65xx_eint_set_sens(CUST_EINT_TOUCH_PANEL_NUM, 1);//lixh10  CUST_EINT_LEVEL_SENSITIVE
			//mt65xx_eint_set_hw_debounce(CUST_EINT_TOUCH_PANEL_NUM, CUST_EINT_TOUCH_PANEL_DEBOUNCE_CN);
			//mt65xx_eint_registration(CUST_EINT_TOUCH_PANEL_NUM, CUST_EINT_TOUCH_PANEL_DEBOUNCE_EN, 0, tpd_eint_handler, 0);//lixh10
			mt_eint_registration(CUST_EINT_TOUCH_PANEL_NUM, CUST_EINTF_TRIGGER_FALLING, tpd_eint_handler, 1);
			}
		mt_eint_unmask(CUST_EINT_TOUCH_PANEL_NUM);
...
{
       /* lenovo-sw zhangrc2 resolve build error */
