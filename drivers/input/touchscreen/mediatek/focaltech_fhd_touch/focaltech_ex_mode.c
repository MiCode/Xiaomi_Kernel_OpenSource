 ...
 */
static DEVICE_ATTR(fts_glove_mode, 0644, fts_glove_mode_show,
		   fts_glove_mode_store);

static DEVICE_ATTR(fts_cover_mode, 0644, fts_cover_mode_show,
		   fts_cover_mode_store);

static DEVICE_ATTR(fts_charger_mode, 0644, fts_charger_mode_show,
