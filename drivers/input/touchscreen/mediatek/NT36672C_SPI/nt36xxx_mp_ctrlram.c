...
#define FW_RAWDATA_CSV_FILE "/data/vendor/fac_sources/FWRawdataTest.csv"
...
#define PEN_FW_RAW_TEST_CSV_FILE "/data/vendor/fac_sources/PenFWRawTest.csv"
#define PEN_NOISE_TEST_CSV_FILE "/data/vendor/fac_sources/PenNoiseTest.csv"
...
int nvt_factory_test(void)
{
	...
	ret = dev_mkdir("/data/vendor/fac_sources", S_IRWXU | S_IRWXG | S_IRWXO);
	if (ret != 0) {
		NVT_ERR("MKDIR fac_sources error\n");
	}
	...
	//add for wt TP openshort test	 0:PASS, -1:FAIL
