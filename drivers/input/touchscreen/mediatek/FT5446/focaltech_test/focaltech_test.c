...
u32 fts_ic_table_get_ic_code_from_ic_name(char *ic_name)
{
	...
	printk("FTS ic_name = %s, ic_types[0].ic_name = %s\n",ic_name,ic_types[0].ic_name);
...
static int fts_ito_test_show(struct seq_file *file, void* data)
{
    ...
    /*test_result_bmp[I2C_COMMUNICATION] =
        ((test_data.test_item[FT5X46_ENTER_FACTORY_MODE].testresult)?'P':'F');*/
...
int fts_test_init(struct i2c_client *client)
{
	...
	fts_ito_test_proc = proc_create(FTS_ITO_TEST, 0666,
                       ...
                       size_t count, loff_t *pos)
{
    ...
    int retval = 0;
    int test_case = 0;
    char fwname1[128] = "Conf_MultipleTest_f9_ft5446_CSOT.ini";
...
static struct proc_dir_entry *tp_selftest = NULL;
