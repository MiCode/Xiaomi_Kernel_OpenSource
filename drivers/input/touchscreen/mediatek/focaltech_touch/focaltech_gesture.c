 ...
 *
 */
static DEVICE_ATTR(fts_gesture_mode, 0644, fts_gesture_show, fts_gesture_store);
/*
 *   read example: cat fts_gesture_buf        --- read gesture buf
 */
static DEVICE_ATTR(fts_gesture_buf, 0644, fts_gesture_buf_show,
 ...
 *        It will be called this function every interrupt
 *		  when FTS_GESTURE_EN = 1
