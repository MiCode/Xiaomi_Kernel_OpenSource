...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[1]  = { {  384000, HFPLL, 2,  40 }, LVL_NOM,  1050000, 1 },
	[2]  = { {  460800, HFPLL, 2,  48 }, LVL_NOM,  1050000, 1 },
...
static struct acpu_level acpu_freq_tbl[] __initdata = {
	...
	{ 1, {  384000, HFPLL, 2,  40 }, L2(0),   950000, 3200000 },
	{ 1, {  460800, HFPLL, 2,  48 }, L2(0),   950000, 3200000 },
	{ 1, {  537600, HFPLL, 1,  28 }, L2(0),   950000, 3200000 },
	{ 1, {  576000, HFPLL, 1,  30 }, L2(0),   950000, 3200000 },
	{ 1, {  652800, HFPLL, 1,  34 }, L2(16),  950000, 3200000 },
	{ 1, {  729600, HFPLL, 1,  38 }, L2(16),  950000, 3200000 },
