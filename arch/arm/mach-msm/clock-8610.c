...
static struct clk_lookup msm_clocks_8610[] = {
	...
	CLK_LOOKUP("xo",	cxo_lpass_pil_clk.c, "fe200000.qti,lpass"),
	CLK_LOOKUP("xo",        cxo_lpm_clk.c, "fc4281d0.qcom,mpm"),

	CLK_LOOKUP("xo",	       cxo_mss_pil_clk.c, "fc880000.qti,mss"),
	...
	CLK_LOOKUP("xo",    cxo_pil_pronto_clk.c, "fb21b000.qti,pronto"),
	...
	CLK_LOOKUP("iface_clk",           vfe_ahb_clk.c, "fd890000.qti,iommu"),
	CLK_LOOKUP("core_clk",            vfe_axi_clk.c, "fd890000.qti,iommu"),
	CLK_LOOKUP("iface_clk",           mdp_ahb_clk.c, "fd860000.qti,iommu"),
	CLK_LOOKUP("core_clk",            mdp_axi_clk.c, "fd860000.qti,iommu"),
	CLK_LOOKUP("iface_clk",           mdp_ahb_clk.c, "fd870000.qti,iommu"),
	CLK_LOOKUP("core_clk",            mdp_axi_clk.c, "fd870000.qti,iommu"),
	CLK_LOOKUP("iface_clk",         oxili_ahb_clk.c, "fd880000.qti,iommu"),
	CLK_LOOKUP("core_clk",           bimc_gfx_clk.c, "fd880000.qti,iommu"),
	CLK_LOOKUP("alt_core_clk",  gcc_bimc_smmu_clk.c, "fd880000.qti,iommu"),
	CLK_LOOKUP("iface_clk", gcc_lpss_smmu_ahb_clk.c, "fd000000.qti,iommu"),
	CLK_LOOKUP("core_clk",   gcc_lpass_q6_axi_clk.c, "fd000000.qti,iommu"),
	CLK_LOOKUP("iface_clk", gcc_copss_smmu_ahb_clk.c,
							 "fd010000.qti,iommu"),
	CLK_LOOKUP("core_clk",         pnoc_iommu_clk.c, "fd010000.qti,iommu"),
	...
	CLK_LOOKUP("core_clk",         q6ss_xo_clk.c,  "fe200000.qti,lpass"),
	CLK_LOOKUP("bus_clk", gcc_lpass_q6_axi_clk.c,  "fe200000.qti,lpass"),
	CLK_LOOKUP("iface_clk", q6ss_ahb_lfabif_clk.c, "fe200000.qti,lpass"),
	CLK_LOOKUP("reg_clk",        q6ss_ahbm_clk.c,  "fe200000.qti,lpass"),
...
static struct clk_lookup msm_clocks_8610_rumi[] = {
	...
	CLK_DUMMY("iface_clk",  NULL, "fd890000.qti,iommu", OFF),
	CLK_DUMMY("core_clk",   NULL, "fd890000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk",  NULL, "fd860000.qti,iommu", OFF),
	CLK_DUMMY("core_clk",   NULL, "fd860000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk",  NULL, "fd870000.qti,iommu", OFF),
	CLK_DUMMY("core_clk",   NULL, "fd870000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk",  NULL, "fd880000.qti,iommu", OFF),
	CLK_DUMMY("core_clk",   NULL, "fd880000.qti,iommu", OFF),
	CLK_DUMMY("alt_core_clk",   NULL, "fd880000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk",  NULL, "fd000000.qti,iommu", OFF),
	CLK_DUMMY("core_clk",   NULL, "fd000000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk",  NULL, "fd010000.qti,iommu", OFF),
	CLK_DUMMY("core_clk",   NULL, "fd010000.qti,iommu", OFF),
