...
/*
	CLK_LOOKUP("bus_clk",  vcap_hdmi_bus_clk.c, "fdf98000.qcom,hdmi_rx"),
	CLK_LOOKUP("pixel_clk", vcap_hdmi_rx_clk.c, "fdf98000.qcom,hdmi_rx"),
	CLK_LOOKUP("audio_clk", vcap_audio_clk.c, "fdf98000.qcom,hdmi_rx"),
*/
	...
	CLK_LOOKUP("bcc_vbif_tspp2_clk",	bcc_vbif_tspp2_clk.c,
						"fc724000.msm_tspp2"),
	CLK_LOOKUP("mem_clk", bcc_vbif_dem_core_clk.c, "fc600000.msm-demod"),
	...
	CLK_LOOKUP("mem_vbif_clk", bcc_vbif_axi_clk.c, "fc600000.msm-demod"),
