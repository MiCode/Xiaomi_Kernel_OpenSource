...
static struct clk_lookup msm_clocks_rpm_8974[] = {
	...
	CLK_LOOKUP_OF("xo",  cxo_pil_lpass_clk,      "fe200000.qti,lpass"),
	CLK_LOOKUP_OF("xo",    cxo_pil_mss_clk,        "fc880000.qti,mss"),
	CLK_LOOKUP_OF("xo",       cxo_wlan_clk, "fb000000.qcom,wcnss-wlan"),
	CLK_LOOKUP_OF("rf_clk",         cxo_a2, "fb000000.qcom,wcnss-wlan"),
	CLK_LOOKUP_OF("xo", cxo_pil_pronto_clk,     "fb21b000.qti,pronto"),
