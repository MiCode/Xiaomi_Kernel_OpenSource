...
static struct clk_lookup apq_clocks_8084_rumi[] = {
	...
	CLK_DUMMY("iface_clk",	oxilicx_ahb_clk.c,
				     "fdb00000.qcom,kgsl-3d0", OFF),
	CLK_DUMMY("iface_clk", NULL, "fda64000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fda64000.qti,iommu", OFF),
	CLK_DUMMY("alt_core_clk", NULL, "fda64000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fda44000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fda44000.qti,iommu", OFF),
	CLK_DUMMY("alt_core_clk", NULL, "fda44000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fd928000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fd928000.qti,iommu", oFF),
	CLK_DUMMY("core_clk", NULL, "fdb10000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fdb10000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fdc84000.qti,iommu", OFF),
	CLK_DUMMY("alt_core_clk", NULL, "fdc84000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fdc84000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "f9bc4000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "f9bc4000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fdee4000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fdee4000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fe054000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fe054000.qti,iommu", OFF),
	CLK_DUMMY("iface_clk", NULL, "fe064000.qti,iommu", OFF),
	CLK_DUMMY("core_clk", NULL, "fe064000.qti,iommu", OFF),
};

static struct clk_lookup apq_clocks_8084[] = {
	CLK_DUMMY("iface_clk", lcc_q6_smmu_cfg_clk.c, "fe054000.qti,iommu",
									OFF),
	CLK_DUMMY("iface_clk", lcc_core_smmu_cfg_clk.c, "fe064000.qti,iommu",
									OFF),
	CLK_DUMMY("core_clk",  gcc_lpass_mport_axi_clk.c, "fe064000.qti,iommu",
									OFF),

	CLK_LOOKUP("xo",  cxo_pil_lpass_clk.c,      "fe200000.qti,lpass"),
	...
	CLK_LOOKUP("bus_clk",	gcc_lpass_q6_axi_clk.c,	"fe200000.qti,lpass"),
	...
	CLK_LOOKUP("core_clk", camss_jpeg_jpeg_axi_clk.c,
						"fda64000.qti,iommu"),
	CLK_LOOKUP("alt_core_clk", camss_top_ahb_clk.c, "fda64000.qti,iommu"),
	...
	CLK_LOOKUP("iface_clk",	venus0_ahb_clk.c, "fdce0000.qti,venus"),
	CLK_LOOKUP("bus_clk",	venus0_axi_clk.c, "fdce0000.qti,venus"),
	...
	CLK_LOOKUP("iface_clk", vpu_ahb_clk.c, "fde0b000.qti,vpu"),
	CLK_LOOKUP("bus_clk", vpu_axi_clk.c, "fde0b000.qti,vpu"),
	CLK_LOOKUP("vdp_clk", vpu_vdp_clk.c, "fde0b000.qti,vpu"),
	CLK_LOOKUP("vdp_bus_clk", vpu_bus_clk.c, "fde0b000.qti,vpu"),
	...
	CLK_LOOKUP("vdp_bus_clk", vpu_bus_clk.c, "fde0b000.qti,pil-vpu"),
	CLK_LOOKUP("cxo_clk", vpu_cxo_clk.c, "fde0b000.qti,pil-vpu"),
	CLK_LOOKUP("core_clk", vpu_maple_clk.c, "fde0b000.qti,pil-vpu"),
	CLK_LOOKUP("sleep_clk", vpu_sleep_clk.c, "fde0b000.qti,pil-vpu"),
	CLK_LOOKUP("maple_bus_clk", gcc_mmss_vpu_maple_sys_noc_axi_clk.c,
						"fde0b000.qti,pil-vpu"),
	...
	CLK_LOOKUP("alt_iface_clk", camss_ahb_clk.c,
						"fda44000.qti,iommu"),
	CLK_LOOKUP("iface_clk", mdss_ahb_clk.c , "fd928000.qti,iommu"),
	CLK_LOOKUP("core_clk", mdss_axi_clk.c , "fd928000.qti,iommu"),
	CLK_LOOKUP("core_clk", oxili_gfx3d_clk.c, "fdb10000.qti,iommu"),
	CLK_LOOKUP("iface_clk", oxilicx_ahb_clk.c, "fdb10000.qti,iommu"),
	CLK_LOOKUP("iface_clk", venus0_ahb_clk.c, "fdc84000.qti,iommu"),
	CLK_LOOKUP("alt_core_clk", venus0_vcodec0_clk.c, "fdc84000.qti,iommu"),
	CLK_LOOKUP("core_clk", venus0_axi_clk.c, "fdc84000.qti,iommu"),
	CLK_LOOKUP("iface_clk", gcc_copss_smmu_ahb_clk.c,
						"f9bc4000.qti,iommu"),
	CLK_LOOKUP("core_clk", gcc_copss_smmu_axi_clk.c, "f9bc4000.qti,iommu"),
	CLK_LOOKUP("iface_clk", vpu_ahb_clk.c, "fdee4000.qti,iommu"),
	CLK_LOOKUP("core_clk", vpu_axi_clk.c, "fdee4000.qti,iommu"),
	CLK_LOOKUP("alt_core_clk", vpu_bus_clk.c, "fdee4000.qti,iommu"),
	CLK_LOOKUP("core_clk", gcc_lpass_q6_axi_clk.c, "fe054000.qti,iommu"),
