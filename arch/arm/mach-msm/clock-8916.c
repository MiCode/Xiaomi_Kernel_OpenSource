...
static struct clk_lookup msm_clocks_8916[] = {
	...
	CLK_DUMMY("core_clk",   BLSP1_UART_CLK, "78b0000.serial", OFF),
	CLK_DUMMY("iface_clk",  BLSP1_UART_CLK, "78b0000.serial", OFF),
	...
	CLK_DUMMY("iface_clk", mdss_ahb_clk.c, "1a00000.qcom,mdss_mdp", OFF),
	CLK_DUMMY("bus_clk", mdss_axi_clk.c, "1a00000.qcom,mdss_mdp", OFF),
	CLK_DUMMY("core_clk_src", mdp_clk_src.c, "1a00000.qcom,mdss_mdp", OFF),
	CLK_DUMMY("core_clk", mdss_mdp_clk.c, "1a00000.qcom,mdss_mdp", OFF),
	CLK_DUMMY("lut_clk", mdss_mdp_lut_clk.c, "1a00000.qcom,mdss_mdp", OFF),
	CLK_DUMMY("vsync_clk", mdss_vsync_clk.c, "1a00000.qcom,mdss_mdp", OFF),
	CLK_DUMMY("byte_clk", byte0_clk_src.c, "1a98000.qcom,mdss_dsi", OFF),
	CLK_DUMMY("core_clk", esc0_clk_src.c, "1a98000.qcom,mdss_dsi", OFF),
	CLK_DUMMY("pixel_clk", pixel0_clk_src.c, "1a98000.qcom,mdss_dsi", OFF),
	CLK_DUMMY("mdp_core_clk", mdss_mdp_clk.c, "1a98000.qcom,mdss_dsi", OFF),
	CLK_DUMMY("iface_clk", mdss_ahb_clk.c, "1a98000.qcom,mdss_dsi", OFF),
	CLK_DUMMY("bus_clk", mdss_axi_clk.c, "1a98000.qcom,mdss_dsi", OFF),
	CLK_DUMMY("core_clk", mdss_mdp_clk.c, "184d078.qcom,gdsc", OFF),
	CLK_DUMMY("lut_clk", mdss_mdp_lut_clk.c, "184d078.qcom,gdsc", OFF),
	...
	CLK_DUMMY("core_clk", qdss_clk.c, "869000.funnel", OFF),
	CLK_DUMMY("core_clk", qdss_clk.c, "868000.funnel", OFF),
	CLK_DUMMY("core_clk", qdss_clk.c, "86c000.hwevent", OFF),
	...
	CLK_DUMMY("core_a_clk", qdss_a_clk.c, "869000.funnel", OFF),
	CLK_DUMMY("core_a_clk", qdss_a_clk.c, "868000.funnel", OFF),
	CLK_DUMMY("core_a_clk", qdss_a_clk.c, "86c000.hwevent", OFF),
