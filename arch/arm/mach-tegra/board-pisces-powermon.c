/*
 * arch/arm/mach-tegra/board-pisces-powermon.c
 *
...
static const struct i2c_board_info pisces_i2c1_ina230_board_info[] = {
	{
		I2C_BOARD_INFO("ina230", 0x40),
		.platform_data = &power_mon_info_0[PM_VDD_CELL],
		.irq = -1,
...
int __init pluto_pmon_init(void)
{
	...
	i2c_register_board_info(0,
			pisces_i2c1_ina230_board_info,
			ARRAY_SIZE(pisces_i2c1_ina230_board_info));
