/*
 * arch/arm/mach-tegra/board-pisces-power.c
 *
...
static struct regulator_consumer_supply palmas_smps10_supply[] = {
	...
	REGULATOR_SUPPLY("usb_vbus", "0-0039"),
...
PALMAS_REGS_PDATA(smps6, 850, 850, NULL, 0, 0, 1, NORMAL, 0, 0, 0, 0, 0);
PALMAS_REGS_PDATA(smps7, 1200, 1200, NULL, 0, 0, 1, NORMAL, 0, 0, 0, 0, 0);
PALMAS_REGS_PDATA(smps8, 1800, 1800, NULL, 1, 1, 1, NORMAL, 0, 0, 0, 0, 0);
PALMAS_REGS_PDATA(smps9, 2800, 2800, NULL, 1, 0, 1, NORMAL, 0, 0, 0, 0, 0);
PALMAS_REGS_PDATA(smps10, 5000, 5000, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0);
PALMAS_REGS_PDATA(ldo1, 1050, 1050, palmas_rails(smps7), 0, 1, 1, 0,
		0, PALMAS_EXT_CONTROL_NSLEEP, 0, 0, 0);
PALMAS_REGS_PDATA(ldo2, 2800, 3000, NULL, 0, 1, 0, 0,
		0, PALMAS_EXT_CONTROL_NSLEEP, 0, 0, 0);
...
PALMAS_REGS_PDATA(ldo5, 2700, 2700, NULL, 0, 0, 1, 0,
		0, PALMAS_EXT_CONTROL_NSLEEP, 0, 0, 0);
PALMAS_REGS_PDATA(ldo6, 3000, 3000, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 0);
PALMAS_REGS_PDATA(ldo7, 2800, 2800, NULL, 0, 0, 1, 0,
		0, PALMAS_EXT_CONTROL_NSLEEP, 0, 0, 0);
PALMAS_REGS_PDATA(ldo8, 900, 900, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 0);
...
PALMAS_REGS_PDATA(ldousb, 3300, 3300, NULL, 0, 0, 1, 0,
		0, PALMAS_EXT_CONTROL_NSLEEP, 0, 0, 0);
PALMAS_REGS_PDATA(regen1, 4300, 4300, NULL, 0, 0, 0, 0, 0, 0, 0, 0, 0);
...
FIXED_REG(0, battery, battery, NULL, 0, 1, -1, false, true, 0, 3300, 0);

FIXED_REG(1, vdd_1v8_cam, vdd_1v8_cam,
		palmas_rails(smps8), 0, 0,
		PALMAS_TEGRA_GPIO_BASE + PALMAS_GPIO1, false, true, 0, 1800, 0);

FIXED_REG(2, vdd_1v2_cam, vdd_1v2_cam,
		palmas_rails(smps7), 0, 0,
		PALMAS_TEGRA_GPIO_BASE + PALMAS_GPIO2, false, true, 0, 1200, 0);

FIXED_REG(3, avdd_usb3_1v05, avdd_usb3_1v05,
		palmas_rails(smps8), 0, 0, TEGRA_GPIO_PK5, false, true, 0, 1050, 0);

FIXED_REG(5, vdd_lcd_1v8, vdd_lcd_1v8,
		palmas_rails(smps8), 0, 1,
		PALMAS_TEGRA_GPIO_BASE + PALMAS_GPIO4, false, true, 0, 1800, 0);
...
FIXED_REG(7, vdd_1v8_mic, vdd_1v8_mic,
		palmas_rails(smps8), 0, 0, -1, false, true, 0, 1800, 0);

FIXED_REG(8, vdd_hdmi_5v0, vdd_hdmi_5v0,
		NULL, 0, 0, TEGRA_GPIO_PK6, true, true, 0, 5000, 5000);

FIXED_REG(9, vpp_fuse, vpp_fuse,
		palmas_rails(smps8), 0, 0, TEGRA_GPIO_PX5, false, true, 0, 1800, 0);
...
static struct platform_device *pfixed_reg_devs[] = {
	E1580_COMMON_FIXED_REG E1580_T114_FIXED_REG
};
...
static struct palmas_gpadc_platform_data adc_platform_data = {
	.channel0_current_uA = 20,
};
...
struct palmas_backup_battery_init_data palmas_bb_idata = {
	.sleep_power_mode = 0,
	.off_power_mode = 0,
	.power_mode = 0,
	.charge_current = 1,
...
int __init pluto_regulator_init(void)
{
	...
	i2c_register_board_info(4, palma_device, ARRAY_SIZE(palma_device));
...
static struct soctherm_platform_data pluto_soctherm_data = {
	...
	.throttle = {
		...
		[THROTTLE_OC2] = {
			.throt_mode = BRIEF,
			/*
			 * On the platform using the INA230 device, we don't
			 * need set the SOC_THERM period if INA230's ALERT pin
			 * is not latch enabled.
			*/
			.period = 0,
			.polarity = 1,
			.intr = true,
