...
static int dsi_a_1200_800_8_0_gpio_get(void)
{
	int err = 0;
	...
	err = gpio_request(dsi_a_1200_800_8_0_pdata.dsi_panel_rst_gpio,
		"panel rst");
	if (err < 0) {
	...
	/* free pwm GPIO */
	err = gpio_request(dsi_a_1200_800_8_0_pdata.dsi_panel_bl_pwm_gpio,
		"panel pwm");
	if (err < 0) {
	...
	gpio_free(dsi_a_1200_800_8_0_pdata.dsi_panel_bl_pwm_gpio);
	gpio_requested = true;
	return 0;
fail:
	return err;
...
static int dsi_a_1200_800_8_0_enable(struct device *dev)
{
	...
	err = dsi_a_1200_800_8_0_gpio_get();
	if (err < 0) {
...
static struct tegra_dc_mode dsi_a_1200_800_8_0_modes[] = {
	{
		.pclk = 74880000,
		.h_ref_to_sync = 4,
		.v_ref_to_sync = 1,
...
static struct tegra_dc_cmu dsi_a_1200_800_8_0_cmu = {
...
static int dsi_a_1200_800_8_0_bl_notify(struct device *unused, int brightness)
{
	...
	if (brightness > 255)
		...
		brightness = dsi_a_1200_800_8_0_bl_output_measured[brightness];
...
static struct platform_pwm_backlight_data dsi_a_1200_800_8_0_bl_data = {
	.pwm_id		= 1,
	.max_brightness	= 255,
	.dft_brightness	= 224,
...
static struct platform_device __maybe_unused
	...
	.id	= -1,
	.dev	= {
		.platform_data = &dsi_a_1200_800_8_0_bl_data,
	},
};
...
static int  __init dsi_a_1200_800_8_0_register_bl_dev(void)
{
	int err = 0;
	err = platform_add_devices(dsi_a_1200_800_8_0_bl_devices,
				ARRAY_SIZE(dsi_a_1200_800_8_0_bl_devices));
	if (err) {
...
static void dsi_a_1200_800_8_0_set_disp_device(
	struct platform_device *display_device)
{
	disp_device = display_device;
}

static void dsi_a_1200_800_8_0_dc_out_init(struct tegra_dc_out *dc)
{
	dc->dsi = &dsi_a_1200_800_8_0_pdata;
	dc->parent_clk = "pll_d_out0";
	dc->modes = dsi_a_1200_800_8_0_modes;
	dc->n_modes = ARRAY_SIZE(dsi_a_1200_800_8_0_modes);
...
static void dsi_a_1200_800_8_0_fb_data_init(struct tegra_fb_data *fb)
{
	fb->xres = dsi_a_1200_800_8_0_modes[0].h_active;
