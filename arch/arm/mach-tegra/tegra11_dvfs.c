...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vi",     -1,  0, 1, KHZ,   144000, 216000, 240000, 408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("vi",     -1,  1, 1, KHZ,   144000, 216000, 240000, 408000,  408000,  408000,  408000,  408000,  408000,  408000),

	CORE_DVFS("2d",      0,  0, 1, KHZ,   192000, 228000, 300000, 396000,  492000,  516000,  552000,  552000,  600000,  756000),
	CORE_DVFS("3d",      0,  0, 1, KHZ,   192000, 228000, 300000, 396000,  492000,  516000,  552000,  552000,  600000,  756000),
	CORE_DVFS("epp",     0,  0, 1, KHZ,   192000, 228000, 300000, 396000,  492000,  516000,  552000,  552000,  600000,  756000),

	CORE_DVFS("2d",      0,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  600000,  600000,  600000,  756000),
	CORE_DVFS("3d",      0,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  600000,  600000,  600000,  756000),
	CORE_DVFS("epp",     0,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  600000,  600000,  600000,  756000),
	...
	CORE_DVFS("tsec",    0,  0, 1, KHZ,   144000, 182000, 240000, 312000,  384000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("vde",     0,  0, 1, KHZ,   144000, 182000, 240000, 312000,  384000,  408000,  408000,  408000,  408000,  408000),

	CORE_DVFS("msenc",   0,  1, 1, KHZ,   204000, 252000, 324000, 408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("se",      0,  1, 1, KHZ,   204000, 252000, 324000, 408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("tsec",    0,  1, 1, KHZ,   204000, 252000, 324000, 408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("vde",     0,  1, 1, KHZ,   204000, 252000, 324000, 408000,  408000,  408000,  408000,  408000,  408000,  408000),
	...
	CORE_DVFS("c2bus",   0,  0, 1, KHZ,   192000, 228000, 300000, 396000,  492000,  516000,  552000,  552000,  600000,  756000),
	CORE_DVFS("c2bus",   0,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  600000,  600000,  600000,  756000),
	...
	CORE_DVFS("c3bus",   0,  1, 1, KHZ,   204000, 252000, 324000, 408000,  408000,  408000,  408000,  408000,  408000,  408000),
...
static int __init get_core_nominal_mv_index(int speedo_id)
{
	...
	if ((core_edp_voltage <= TEGRA11_CORE_VOLTAGE_CAP) ||
	    ((tegra_sku_id != 0x4) && (tegra_sku_id != 0x6) &&
	     (tegra_sku_id != 0x8)))
