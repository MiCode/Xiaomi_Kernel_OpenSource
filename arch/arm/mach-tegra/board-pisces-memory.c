...
#define MEMORY_HYNIX     1
#define MEMORY_SAMSUNG   2
#define MEMORY_HYNIX_TALBR    3
#define MEMORY_ELPIDA    0

static struct tegra11_emc_table e1580_k3qf2f200a_ntm_AP40_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
...
static struct tegra11_emc_table e1580_h9ccnnn8ktalbr_ntm_AP40_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0xf0120099, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x0000000d, /* EMC_DLL_XFORM_DQS4 */
			0x0000000d, /* EMC_DLL_XFORM_DQS5 */
			0x0000000d, /* EMC_DLL_XFORM_DQS6 */
			0x0000000d, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE4 */
			0x00000000, /* EMC_DLL_XFORM_QUSE5 */
			0x00000000, /* EMC_DLL_XFORM_QUSE6 */
			0x00000000, /* EMC_DLL_XFORM_QUSE7 */
		...
		},
		{
			...
			0x0000000d, /* EMC_DLL_XFORM_DQS1 */
			0x0000000d, /* EMC_DLL_XFORM_DQS2 */
			0x0000000d, /* EMC_DLL_XFORM_DQS3 */
			0x0000400b, /* EMC_DLL_XFORM_DQ1 */
			0x0000400b, /* EMC_DLL_XFORM_DQ2 */
	...
	},
	{
		...
		},
		{
			...
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000015, /* EMC_RDV */
			0x00249248, /* EMC_XM2DQSPADCTRL4 */
			0x14514621, /* EMC_XM2DQSPADCTRL3 */
			0x0000400a, /* EMC_DLL_XFORM_DQ0 */
			0xa0f10f0f, /* EMC_AUTO_CAL_CONFIG */
			0x007fc00e, /* EMC_DLL_XFORM_ADDR0 */
			0x00000909, /* EMC_XM2CLKPADCTRL2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x007fc00e, /* EMC_DLL_XFORM_ADDR2 */
			0x007fc00c, /* EMC_DLL_XFORM_DQS1 */
	...
	},
	{
		...
		},
		{
			...
			0x0000000a, /* EMC_DLL_XFORM_DQS1 */
			0x007fc00c, /* EMC_DLL_XFORM_DQS2 */
			0x007fc00d, /* EMC_DLL_XFORM_DQS3 */
		...
		},
		{
			...
			0x00010000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000018, /* EMC_RDV */
			0x00249209, /* EMC_XM2DQSPADCTRL4 */
			0x14518521, /* EMC_XM2DQSPADCTRL3 */
			0x0000000d, /* EMC_DLL_XFORM_DQ0 */
			0xa8f10f0f, /* EMC_AUTO_CAL_CONFIG */
...
static struct tegra11_emc_pdata e1580_HYNIX_A01P_AP40_pdata = {
...
static struct tegra11_emc_pdata e1580_SAMSUNG_AP40_pdata = {
	.description = "e1580_k3qf2f200a_ntm_AP40",
	.tables = e1580_k3qf2f200a_ntm_AP40_table,
	.num_tables = ARRAY_SIZE(e1580_k3qf2f200a_ntm_AP40_table),
};

static struct tegra11_emc_pdata e1580_HYNIX_A02P_AP40_pdata = {
	.description = "e1580_h9ccnnn8ktalbr_ntm_AP40",
	.tables = e1580_h9ccnnn8ktalbr_ntm_AP40_table,
	.num_tables = ARRAY_SIZE(e1580_h9ccnnn8ktalbr_ntm_AP40_table),
};
...
static struct tegra11_emc_pdata *pluto_get_emc_data(void)
{
	...
	/* Load AP40 Table */
	if (board_info.board_id == BOARD_E1580 && (tegra_sku_id == 0x6 || tegra_sku_id == 0x8)) {
		memory_type = tegra_get_memory_type();
		pr_info("memory id = %d\n", memory_type);
		update_hardware_info(TYPE_DDR, memory_type);
		switch (memory_type) {
		case MEMORY_HYNIX:
			return &e1580_HYNIX_A01P_AP40_pdata;
			break;
		case MEMORY_SAMSUNG:
		case MEMORY_ELPIDA:
			return &e1580_SAMSUNG_AP40_pdata;
			break;
		case MEMORY_HYNIX_TALBR:
			return &e1580_HYNIX_A02P_AP40_pdata;
			break;
		default:
			pr_warn("non-supported memory type\n");
			return &e1580_SAMSUNG_AP40_pdata;
			break;
		}
	}
