...
ifeq ($(TARGET_PRODUCT), $(filter $(TARGET_PRODUCT), alioth thyme))

ifeq ($(FACTORY_BUILD),1)
KERNEL_CONFIG_OVERRIDE_DEBUGFS := CONFIG_DEBUG_FS=y
KERNEL_CONFIG_OVERRIDE_MSM_TZ_LOG := CONFIG_MSM_TZ_LOG=y
endif
