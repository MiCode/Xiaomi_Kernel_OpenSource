...
ifeq ($(TARGET_PRODUCT), $(filter $(TARGET_PRODUCT), sweet sweetin courbet courbetin))

ifeq ($(FACTORY_BUILD),1)
OVERRIDE_DEBUG_FS := true
endif

ifeq ($(strip $(WT_COMPILE_FACTORY_VERSION)), yes)
KERNEL_MAKE_ENV += WT_COMPILE_FACTORY_VERSION=yes
endif
...
ifeq ($(ENABLE_SYSTEM_MTBF),true)
OVERRIDE_DEBUG_FS := true
endif

SKIP_OVERRIDE_DEBUG_FS := false

else

SKIP_OVERRIDE_DEBUG_FS := true
...
$(KERNEL_OUT): link_ext $(KERNEL_DEBUGFS)
	mkdir -p $(KERNEL_OUT)
...
$(KERNEL_DEBUGFS):
	...
	SKIP_ENABLE_DEBUG_FS=$(SKIP_OVERRIDE_DEBUG_FS) \
	DISABLE_DEBUGFS=$(KERNEL_DISABLE_DEBUGFS) \
	ENABLE_DEBUG_FS=$(OVERRIDE_DEBUG_FS) \
