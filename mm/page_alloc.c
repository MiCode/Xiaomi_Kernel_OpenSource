...
void __weak reclaimed_time_trace_begin(u64 delta) {};
void __weak reclaimed_time_trace_end(u64 delta) {};
...
#ifdef CONFIG_PACKAGE_RUNTIME_INFO
	time_stamp = reclaimed_time_clock();
	reclaimed_time_trace_begin(time_stamp);
#endif
