...
/* IMP_IIC_WRAP_N */
#define IMP_IIC_WRAP_N_AP_I2C6_CG_RO 1
#define IMP_IIC_WRAP_N_NR_CLK 2
/* IMP_IIC_WRAP_S */
#define IMP_IIC_WRAP_S_AP_I2C5_CG_RO 1
#define IMP_IIC_WRAP_S_AP_I2C7_CG_RO 2
#define IMP_IIC_WRAP_S_AP_I2C8_CG_RO 3
#define IMP_IIC_WRAP_S_AP_I2C9_CG_RO 4
#define IMP_IIC_WRAP_S_NR_CLK 5
/* IMP_IIC_WRAP_W */
#define IMP_IIC_WRAP_W_AP_I2C0_CG_RO 1
#define IMP_IIC_WRAP_W_NR_CLK 2
/* IMP_IIC_WRAP_WS */
#define IMP_IIC_WRAP_WS_AP_I2C0_CG_RO 1
#define IMP_IIC_WRAP_WS_AP_I2C1_CG_RO 2
#define IMP_IIC_WRAP_WS_AP_I2C2_CG_RO 3
#define IMP_IIC_WRAP_WS_AP_I2C4_CG_RO 4
#define IMP_IIC_WRAP_WS_NR_CLK 5
