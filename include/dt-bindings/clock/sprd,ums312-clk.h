...
#ifndef _DT_BINDINGS_CLK_UMS312_H_
#define _DT_BINDINGS_CLK_UMS312_H_
...
#define CLK_AHB_CKG_EB			5
#define CLK_AP_AHB_GATE_NUM		(CLK_AHB_CKG_EB + 1)
...
#endif /* _DT_BINDINGS_CLK_UMS312_H_ */
