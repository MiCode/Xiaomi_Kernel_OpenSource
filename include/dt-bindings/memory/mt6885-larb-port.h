...
#define M4U_PORT_L0_UFBDC_RDMA0		MTK_M4U_ID(0, 1)
#define M4U_PORT_L0_UFBDC_RDMA2		MTK_M4U_ID(0, 2)
#define M4U_PORT_L0_OVL_RDMA0_HDR	MTK_M4U_ID(0, 3)
#define M4U_PORT_L0_OVL_2L_RDMA0_HDR	MTK_M4U_ID(0, 4)
#define M4U_PORT_L0_OVL_2L_RDMA2_HDR	MTK_M4U_ID(0, 5)
#define M4U_PORT_L0_OVL_RDMA0		MTK_M4U_ID(0, 6)
#define M4U_PORT_L0_OVL_2L_RDMA0	MTK_M4U_ID(0, 7)
#define M4U_PORT_L0_OVL_2L_RDMA2	MTK_M4U_ID(0, 8)
#define M4U_PORT_L0_DISP_WDMA0		MTK_M4U_ID(0, 9)
#define M4U_PORT_L0_DISP_RDMA0		MTK_M4U_ID(0, 10)
#define M4U_PORT_L0_DISP_RDMA2		MTK_M4U_ID(0, 11)
#define M4U_PORT_L0_DISP_FAKE0		MTK_M4U_ID(0, 12)
/* larb1 -- 13*/
#define M4U_PORT_L1_DISP_POSTMASK1	MTK_M4U_ID(1, 0)
#define M4U_PORT_L1_UFBDC_RDMA1		MTK_M4U_ID(1, 1)
#define M4U_PORT_L1_UFBDC_RDMA3		MTK_M4U_ID(1, 2)
#define M4U_PORT_L1_OVL_RDMA1_HDR	MTK_M4U_ID(1, 3)
#define M4U_PORT_L1_OVL_2L_RDMA1_HDR	MTK_M4U_ID(1, 4)
#define M4U_PORT_L1_OVL_2L_RDMA3_HDR	MTK_M4U_ID(1, 5)
#define M4U_PORT_L1_OVL_RDMA1		MTK_M4U_ID(1, 6)
#define M4U_PORT_L1_OVL_2L_RDMA1	MTK_M4U_ID(1, 7)
#define M4U_PORT_L1_OVL_2L_RDMA3	MTK_M4U_ID(1, 8)
#define M4U_PORT_L1_DISP_WDMA1		MTK_M4U_ID(1, 9)
#define M4U_PORT_L1_DISP_RDMA1		MTK_M4U_ID(1, 10)
#define M4U_PORT_L1_DISP_RDMA3		MTK_M4U_ID(1, 11)
#define M4U_PORT_L1_DISP_FAKE1		MTK_M4U_ID(1, 12)
/* larb2 -- 6*/
...
#define M4U_PORT_L7_VENC_SUB_W_LUMA_DISP	MTK_M4U_ID(7, 3)
#define M4U_PORT_L7_VENC_SV_COMV_DISP		MTK_M4U_ID(7, 4)
#define M4U_PORT_L7_VENC_RD_COMV_DISP		MTK_M4U_ID(7, 5)
#define M4U_PORT_L7_VENC_NBM_RDMA_DISP		MTK_M4U_ID(7, 6)
#define M4U_PORT_L7_VENC_NBM_RDMA_LITE_DISP	MTK_M4U_ID(7, 7)
#define M4U_PORT_L7_VENC_FCS_NBM_RDMA_DISP	MTK_M4U_ID(7, 8)
#define M4U_PORT_L7_JPGENC_Y_RDMA_DISP		MTK_M4U_ID(7, 9)
#define M4U_PORT_L7_JPGENC_C_RDMA_DISP		MTK_M4U_ID(7, 10)
#define M4U_PORT_L7_JPGENC_Q_TABLE_DISP		MTK_M4U_ID(7, 11)
#define M4U_PORT_L7_JPGENC_BSDMA_DISP		MTK_M4U_ID(7, 12)
#define M4U_PORT_L7_JPGENC_HUFF_OFFSET0_DISP	MTK_M4U_ID(7, 13)
#define M4U_PORT_L7_JPGENC_WDMA0_DISP		MTK_M4U_ID(7, 14)
#define M4U_PORT_L7_JPGENC_BSDMA0_DISP		MTK_M4U_ID(7, 15)
#define M4U_PORT_L7_JPGENC_HUFF_OFFSET1_DISP	MTK_M4U_ID(7, 16)
#define M4U_PORT_L7_JPGENC_WDMA1_DISP		MTK_M4U_ID(7, 17)
#define M4U_PORT_L7_JPGENC_BSDMA1_DISP		MTK_M4U_ID(7, 18)
#define M4U_PORT_L7_VENC_NBM_WDMA_DISP		MTK_M4U_ID(7, 19)
#define M4U_PORT_L7_VENC_NBM_WDMA_LITE_DISP	MTK_M4U_ID(7, 20)
#define M4U_PORT_L7_VENC_FCS_NBM_WDMA_DISP	MTK_M4U_ID(7, 21)
#define M4U_PORT_L7_VENC_SUB_R_LUMA_DISP	MTK_M4U_ID(7, 22)
#define M4U_PORT_L7_VENC_CUR_LUMA_DISP		MTK_M4U_ID(7, 23)
#define M4U_PORT_L7_VENC_CUR_CHROMA_DISP	MTK_M4U_ID(7, 24)
#define M4U_PORT_L7_VENC_REF_LUMA_DISP		MTK_M4U_ID(7, 25)
#define M4U_PORT_L7_VENC_REF_CHROMA_DISP	MTK_M4U_ID(7, 26)
/* larb8 -- 27*/
...
#define M4U_PORT_L8_VENC_SUB_W_LUMA_MDP		MTK_M4U_ID(8, 3)
#define M4U_PORT_L8_VENC_SV_COMV_MDP		MTK_M4U_ID(8, 4)
#define M4U_PORT_L8_VENC_RD_COMV_MDP		MTK_M4U_ID(8, 5)
#define M4U_PORT_L8_VENC_NBM_RDMA_MDP		MTK_M4U_ID(8, 6)
#define M4U_PORT_L8_VENC_NBM_RDMA_LITE_MDP	MTK_M4U_ID(8, 7)
#define M4U_PORT_L8_VENC_FCS_NBM_RDMA_MDP	MTK_M4U_ID(8, 8)
#define M4U_PORT_L8_JPGENC_Y_RDMA_MDP		MTK_M4U_ID(8, 9)
#define M4U_PORT_L8_JPGENC_C_RDMA_MDP		MTK_M4U_ID(8, 10)
#define M4U_PORT_L8_JPGENC_Q_TABLE_MDP		MTK_M4U_ID(8, 11)
#define M4U_PORT_L8_JPGENC_BSDMA_MDP		MTK_M4U_ID(8, 12)
#define M4U_PORT_L8_JPGENC_HUFF_OFFSET0_MDP	MTK_M4U_ID(8, 13)
#define M4U_PORT_L8_JPGENC_WDMA0_MDP		MTK_M4U_ID(8, 14)
#define M4U_PORT_L8_JPGENC_BSDMA0_MDP		MTK_M4U_ID(8, 15)
#define M4U_PORT_L8_JPGENC_HUFF_OFFSET1_MDP	MTK_M4U_ID(8, 16)
#define M4U_PORT_L8_JPGENC_WDMA1_MDP		MTK_M4U_ID(8, 17)
#define M4U_PORT_L8_JPGENC_BSDMA1_MDP		MTK_M4U_ID(8, 18)
#define M4U_PORT_L8_VENC_NBM_WDMA_MDP		MTK_M4U_ID(8, 19)
#define M4U_PORT_L8_VENC_NBM_WDMA_LITE_MDP	MTK_M4U_ID(8, 20)
#define M4U_PORT_L8_VENC_FCS_NBM_WDMA_MDP	MTK_M4U_ID(8, 21)
#define M4U_PORT_L8_VENC_SUB_R_LUMA_MDP		MTK_M4U_ID(8, 22)
#define M4U_PORT_L8_VENC_CUR_LUMA_MDP		MTK_M4U_ID(8, 23)
#define M4U_PORT_L8_VENC_CUR_CHROMA_MDP		MTK_M4U_ID(8, 24)
#define M4U_PORT_L8_VENC_REF_LUMA_MDP		MTK_M4U_ID(8, 25)
#define M4U_PORT_L8_VENC_REF_CHROMA_MDP		MTK_M4U_ID(8, 26)
/* larb9 -- 29*/
#define M4U_PORT_L9_IMG_IMGI_D1_MDP	MTK_M4U_ID(9, 0)
#define M4U_PORT_L9_IMG_IMGCI_D1_MDP	MTK_M4U_ID(9, 1)
#define M4U_PORT_L9_IMG_DMGI_D1_MDP	MTK_M4U_ID(9, 2)
#define M4U_PORT_L9_IMG_UFDI_D1_MDP	MTK_M4U_ID(9, 3)
...
#define M4U_PORT_L9_IMG_UFOYW_MDP	MTK_M4U_ID(9, 9)
#define M4U_PORT_L9_IMG_UFOCW_MDP	MTK_M4U_ID(9, 10)
#define M4U_PORT_L9_IMG_UFOYR_MDP	MTK_M4U_ID(9, 11)
#define M4U_PORT_L9_IMG_UFOCR_MDP	MTK_M4U_ID(9, 12)
#define M4U_PORT_L9_IMG_UFOY2R_MDP	MTK_M4U_ID(9, 13)
#define M4U_PORT_L9_IMG_UFOC2R_MDP	MTK_M4U_ID(9, 14)
...
#define M4U_PORT_L9_IMG_TIMGO_D1_MDP	MTK_M4U_ID(9, 18)
#define M4U_PORT_L9_IMG_PVRYR_MDP	MTK_M4U_ID(9, 19)
#define M4U_PORT_L9_IMG_PVRCR_MDP	MTK_M4U_ID(9, 20)
#define M4U_PORT_L9_IMG_MFB_RDMA0_MDP	MTK_M4U_ID(9, 21)
#define M4U_PORT_L9_IMG_MFB_RDMA1_MDP	MTK_M4U_ID(9, 22)
#define M4U_PORT_L9_IMG_MFB_RDMA2_MDP	MTK_M4U_ID(9, 23)
#define M4U_PORT_L9_IMG_MFB_RDMA3_MDP	MTK_M4U_ID(9, 24)
#define M4U_PORT_L9_IMG_MFB_RDMA4_MDP	MTK_M4U_ID(9, 25)
#define M4U_PORT_L9_IMG_MFB_RDMA5_MDP	MTK_M4U_ID(9, 26)
#define M4U_PORT_L9_IMG_MFB_WDMA0_MDP	MTK_M4U_ID(9, 27)
#define M4U_PORT_L9_IMG_MFB_WDMA1_MDP	MTK_M4U_ID(9, 28)
/* larb10 -- not existed*/
/* larb11 -- 29*/
#define M4U_PORT_L11_IMG_IMGI_D1_DISP	MTK_M4U_ID(11, 0)
#define M4U_PORT_L11_IMG_IMGCI_D1_DISP	MTK_M4U_ID(11, 1)
#define M4U_PORT_L11_IMG_DMGI_D1_DISP	MTK_M4U_ID(11, 2)
#define M4U_PORT_L11_IMG_UFDI_D1_DISP	MTK_M4U_ID(11, 3)
...
#define M4U_PORT_L11_IMG_UFOYW_DISP	MTK_M4U_ID(11, 9)
#define M4U_PORT_L11_IMG_UFOCW_DISP	MTK_M4U_ID(11, 10)
#define M4U_PORT_L11_IMG_UFOYR_DISP	MTK_M4U_ID(11, 11)
#define M4U_PORT_L11_IMG_UFOCR_DISP	MTK_M4U_ID(11, 12)
#define M4U_PORT_L11_IMG_UFOY2R_DISP	MTK_M4U_ID(11, 13)
#define M4U_PORT_L11_IMG_UFOC2R_DISP	MTK_M4U_ID(11, 14)
...
#define M4U_PORT_L11_IMG_TIMGO_D1_DISP	MTK_M4U_ID(11, 18)
#define M4U_PORT_L11_IMG_PVRYR_DISP	MTK_M4U_ID(11, 19)
#define M4U_PORT_L11_IMG_PVRCR_DISP	MTK_M4U_ID(11, 20)
#define M4U_PORT_L11_IMG_MFB_RDMA0_DISP	MTK_M4U_ID(11, 21)
#define M4U_PORT_L11_IMG_MFB_RDMA1_DISP	MTK_M4U_ID(11, 22)
#define M4U_PORT_L11_IMG_MFB_RDMA2_DISP	MTK_M4U_ID(11, 23)
#define M4U_PORT_L11_IMG_MFB_RDMA3_DISP	MTK_M4U_ID(11, 24)
#define M4U_PORT_L11_IMG_MFB_RDMA4_DISP	MTK_M4U_ID(11, 25)
#define M4U_PORT_L11_IMG_MFB_RDMA5_DISP	MTK_M4U_ID(11, 26)
#define M4U_PORT_L11_IMG_MFB_WDMA0_DISP	MTK_M4U_ID(11, 27)
#define M4U_PORT_L11_IMG_MFB_WDMA1_DISP	MTK_M4U_ID(11, 28)
/* larb12 -- not existed*/
/* larb13 -- 12*/
...
#define M4U_PORT_L16_CAM_LSCI_R1_A_MDP	MTK_M4U_ID(16, 2)
...
#define M4U_PORT_L16_CAM_RAWI_R5_A_MDP	MTK_M4U_ID(16, 7)
...
#define M4U_PORT_L17_CAM_LSCI_R1_B_DISP		MTK_M4U_ID(17, 2)
...
#define M4U_PORT_L17_CAM_RAWI_R5_B_DISP		MTK_M4U_ID(17, 7)
...
#define M4U_PORT_L18_CAM_LSCI_R1_C_MDP	MTK_M4U_ID(18, 2)
...
#define M4U_PORT_L18_CAM_RAWI_R5_C_MDP	MTK_M4U_ID(18, 7)
...
#define M4U_PORT_L21_APU_FAKE_CODE  MTK_M4U_ID(21, 0)
#define M4U_PORT_L21_APU_FAKE_DATA  MTK_M4U_ID(21, 1)
