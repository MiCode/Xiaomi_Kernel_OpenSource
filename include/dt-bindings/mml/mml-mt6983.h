...
#ifndef _DT_BINDINGS_MML_MT6983_H
#define _DT_BINDINGS_MML_MT6983_H

/* MML engines in mt6983 */
...
/* MML SYS mux registers in mt6983 */
#define MML_DLI0_SEL_IN		(MML_MUX_SLIN DLI0_SEL_IN)
#define MML_DLI1_SEL_IN		(MML_MUX_SLIN DLI1_SEL_IN)
...
#define MML_DLO0_SOUT_SEL	(MML_MUX_SOUT DLO0_SOUT_SEL)
#define MML_DLO1_SOUT_SEL	(MML_MUX_SOUT DLO1_SOUT_SEL)
#define MML_BYP0_MOUT_EN	(MML_MUX_MOUT BYP0_MOUT_EN)
#define MML_BYP1_MOUT_EN	(MML_MUX_MOUT BYP1_MOUT_EN)
#define MML_BYP0_SEL_IN		(MML_MUX_SLIN BYP0_SEL_IN)
#define MML_BYP1_SEL_IN		(MML_MUX_SLIN BYP1_SEL_IN)
