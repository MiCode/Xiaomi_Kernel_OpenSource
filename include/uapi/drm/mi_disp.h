...
/*N19A code for HQ-384348 by p-xielihui at 2024/4/29 start*/
#define NT36672C_TIANMA_PRIVATE     0x11
#define NT36672C_TIANMA_COMMON      0xB0
#define FT8725_HUAXING_PRIVATE      0x15
#define FT8725_HUAXING_COMMON       0x41
#define NT36672S_TRULY_PANEL        0x50

/*According to Xiaomi's burning specifications,
the DA register represents the batch,
the DB register is used to distinguish between glass and IC,
and the burning specifications for the N19A DB register are:
1011 Tianma(XiaMen)
0100 CSOT
0101 Truly
0000 Nova
0001 Focal
For example, 0101 0000 is 0X50, it indicates Truly+Nova
The private screen uses M19A mass-produced screens,
and the burning specification is M19A requirements*/
/*N19A code for HQ-384348 by p-xielihui at 2024/4/29 end*/
