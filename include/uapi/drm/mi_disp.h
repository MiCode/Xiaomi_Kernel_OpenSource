...
enum disp_feature_id {
	...
	DISP_FEATURE_HBM_L1,//DISP_FEATURE_LOW_BRIGHTNESS_FOD,
	DISP_FEATURE_HBM_L2,//DISP_FEATURE_FP_STATUS,
	DISP_FEATURE_HBM_L3,//DISP_FEATURE_NATURE_FLAT_MODE,
	DISP_FEATURE_HBM_OFF,//DISP_FEATURE_SPR_RENDER,
	DISP_FEATURE_CABC,//DISP_FEATURE_BRIGHTNESS,
...
static inline const char *get_disp_feature_id_name(int feature_id)
{
	...
	case DISP_FEATURE_SENSOR_LUX:
		return "sensor_lux";
	case DISP_FEATURE_HBM_L1://DISP_FEATURE_LOW_BRIGHTNESS_FOD:
		return "hbm_level1";
	case DISP_FEATURE_HBM_L2://DISP_FEATURE_FP_STATUS:
		return "hbm_level2";
	case DISP_FEATURE_HBM_L3://DISP_FEATURE_NATURE_FLAT_MODE:
		return "hbm_level3";
