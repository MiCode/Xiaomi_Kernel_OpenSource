/*
 * bq2589x_charger.h - Charger driver for TI BQ24190/191/192/192I
 *
...
extern int bq2589x_vbus_enable(void);
extern int bq2589x_vbus_disable(void);
#else
