...
#define HARDWARE_FRONT_CAM_EFUSEID_GET           _IOWR(HARDWARE_ID, 0x27, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_FRONT_SUBCAM_EFUSEID_GET        _IOWR(HARDWARE_ID, 0x28, char[HARDWARE_MAX_ITEM_LONGTH])
...
#define HARDWARE_WIDE_ANGLE_CAM_GET                  _IOWR(HARDWARE_ID, 0x34, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_WIDE_ANGLE_CAM_MOUDULE_ID_GET        _IOWR(HARDWARE_ID, 0x35, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_WIDE_ANGLE_CAM_EFUSEID_GET            _IOWR(HARDWARE_ID, 0x36, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_WIDE_ANGLE_CAM_SENSORID_GET         _IOWR(HARDWARE_ID, 0x37, char[HARDWARE_MAX_ITEM_LONGTH])
