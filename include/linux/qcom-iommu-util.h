...
#define DOMAIN_ATTR_USE_UPSTREAM_HINT		(5)
#define DOMAIN_ATTR_EARLY_MAP			(6)
#define DOMAIN_ATTR_PAGE_TABLE_IS_COHERENT	(7)
#define DOMAIN_ATTR_PAGE_TABLE_FORCE_COHERENT	(8)
#define DOMAIN_ATTR_USE_LLC_NWA			(9)
#define DOMAIN_ATTR_SPLIT_TABLES		(10)
#define DOMAIN_ATTR_FAULT_MODEL_NO_CFRE		(11)
#define DOMAIN_ATTR_FAULT_MODEL_NO_STALL	(12)
#define DOMAIN_ATTR_FAULT_MODEL_HUPCF		(13)
#define DOMAIN_ATTR_EXTENDED_MAX		(14)
