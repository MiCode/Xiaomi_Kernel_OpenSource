...
int fscrypt_ioctl_decrypt_filename(struct file *, struct encrypt_fname *);
int fscrypt_ioctl_decrypt_filename_v1(struct file *, void __user *);
int fscrypt_ioctl_decrypt_filename_v2(struct file *, void __user *);
