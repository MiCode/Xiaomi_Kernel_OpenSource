...
#define TAS2562_DRIVER_ID           "2.0.0"
...
int spk_l_control;
int spk_r_control;
int (*read)(struct tas2562_priv *pTAS2562, enum channel chn,
	unsigned int reg, unsigned int *pValue);
int (*write)(struct tas2562_priv *pTAS2562, enum channel chn,
	unsigned int reg, unsigned int Value);
int (*bulk_read)(struct tas2562_priv *pTAS2562, enum channel chn,
	unsigned int reg, unsigned char *pData, unsigned int len);
int (*bulk_write)(struct tas2562_priv *pTAS2562, enum channel chn,
	unsigned int reg, unsigned char *pData, unsigned int len);
int (*update_bits)(struct tas2562_priv *pTAS2562, enum channel chn,
