...
uint32_t tlk_generic_smc(uint32_t arg0, uint32_t arg1, uint32_t arg2)
{
	...
	retval = tegra_sm_generic(arg0, arg1, arg2);
	while (retval == 0xFFFFFFFD)
		retval = tegra_sm_generic((60 << 24), 0, 0);
...
static long tlk_generic_smc_on_cpu0(void *args)
{
	...
	retval = tegra_sm_generic(work->arg0, work->arg1, work->arg2);
	while (retval == 0xFFFFFFFD)
		retval = tegra_sm_generic((60 << 24), 0, 0);
	return retval;
}
