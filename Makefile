...
LINK_DUM_SCHED :=$(shell if [ ! -L "$(abspath $(srctree))/include/linux/sched_opt.h" ]; then \
		ln -s -f $(abspath $(srctree))/include/dum/sched_opt.h $(abspath $(srctree))/include/linux/sched_opt.h; \
                mkdir -p $(abspath $(srctree))/drivers/staging/sched; \
                touch $(abspath $(srctree))/drivers/staging/sched/Kconfig; \
                touch $(abspath $(srctree))/drivers/staging/sched/Makefile; fi;)
