...
$(TARGET_KERNEL_CONFIG): $(KERNEL_MAKE_DEPENDENCIES)
	...
	$(warning xiaomi WT_COMPILE_FACTORY_VERSION $(WT_COMPILE_FACTORY_VERSION))
	$(warning xiaomi MIUI_BUILD_REGION $(MIUI_BUILD_REGION))
	$(warning xiaomi international $@)
ifeq (yes,$(WT_COMPILE_FACTORY_VERSION))
	@echo "CONFIG_MTK_MD1_SUPPORT=25" >> $@
endif
ifeq (CN,$(MIUI_BUILD_REGION))
	@echo "CONFIG_MTK_MD1_SUPPORT=25" >> $@
endif
