...
static int aw_pid_1852_dev_init(struct aw882xx *aw882xx, int index)
{
	...
	aw_pa->pwmdelay_desc.reg = AW_REG_NONE;
...
static int aw_pid_2113_dev_init(struct aw882xx *aw882xx, int index)
{
	...
	aw_pa->pwmdelay_desc.reg = AW_PID_2113_PWMCTRL1_REG;
	aw_pa->pwmdelay_desc.pwmdela_reg_mask = AW_PID_2113_PWMDELA_MASK;
	aw_pa->pwmdelay_desc.pwmdelb_reg_mask = AW_PID_2113_PWMDELB_MASK;
