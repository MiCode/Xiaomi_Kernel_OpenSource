...
struct aw_pwmdelay_desc {
	unsigned int reg;
	unsigned int pwmdela_reg_mask;
	unsigned int pwmdelb_reg_mask;
};
...
struct aw_device {
	...
	unsigned int pwmdelaya_val;
	unsigned int pwmdelayb_val;
	...
	struct aw_pwmdelay_desc pwmdelay_desc;
