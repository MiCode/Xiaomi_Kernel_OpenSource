...
#if defined(CONFIG_TARGET_PRODUCT_MATISSE) || defined(CONFIG_TARGET_PRODUCT_RUBENS) || defined(CONFIG_TARGET_PRODUCT_XAGA) || defined(CONFIG_TARGET_PRODUCT_REMBRANDT)
