...
#define TFA9894_NAMETABLE                                                      \
	static struct TfaBfName Tfa9894DatasheetNames[] = {                    \
		{ 0x0, "PWDN" },	   { 0x10, "I2CR" },                   \
		{ 0x20, "CFE" },	   { 0x30, "AMPE" },                   \
		{ 0x40, "DCA" },	   { 0x50, "SBSL" },                   \
		{ 0x60, "AMPC" },	  { 0x71, "INTP" },                   \
		...
		{ 0x11b0, "TDMLUTER" },    { 0x1200, "OCPOAP" },               \
		{ 0x1210, "OCPOAN" },      { 0x1220, "OCPOBP" },               \
		{ 0x1230, "OCPOBN" },      { 0x1240, "CLIPS" },                \
		{ 0x1250, "MANMUTE" },     { 0x1260, "MANOPER" },              \
		{ 0x1270, "LP1" },	 { 0x1280, "LA" },                   \
		{ 0x1290, "VDDPH" },       { 0x1402, "TDMSTAT" },              \
		{ 0x1433, "MANSTATE" },    { 0x14b1, "DCMODE" },               \
		{ 0x1509, "BATS" },	{ 0x1608, "TEMPS" },                \
		{ 0x1709, "VDDPS" },       { 0x2000, "TDME" },                 \
		{ 0x2010, "TDMSPKE" },     { 0x2020, "TDMDCE" },               \
		{ 0x2030, "TDMCSE" },      { 0x2040, "TDMVSE" },               \
		{ 0x2050, "TDMCFE" },      { 0x2060, "TDMCF2E" },              \
		{ 0x2070, "TDMCLINV" },    { 0x2080, "TDMFSPOL" },             \
		{ 0x2090, "TDMDEL" },      { 0x20a0, "TDMADJ" },               \
		{ 0x20b1, "TDMOOMP" },     { 0x2103, "TDMNBCK" },              \
		{ 0x2143, "TDMFSLN" },     { 0x2183, "TDMSLOTS" },             \
		{ 0x21c1, "TDMTXDFO" },    { 0x21e1, "TDMTXUS0" },             \
		{ 0x2204, "TDMSLLN" },     { 0x2254, "TDMBRMG" },              \
		{ 0x22a4, "TDMSSIZE" },    { 0x2303, "TDMSPKS" },              \
		{ 0x2343, "TDMDCS" },      { 0x2381, "TDMCFSEL" },             \
		{ 0x23a1, "TDMCF2SEL" },   { 0x2403, "TDMCSS" },               \
		{ 0x2443, "TDMVSS" },      { 0x2483, "TDMCFS" },               \
		{ 0x24c3, "TDMCF2S" },     { 0x4000, "ISTVDDS" },              \
		{ 0x4010, "ISTBSTOC" },    { 0x4020, "ISTOTDS" },              \
		{ 0x4030, "ISTOCPR" },     { 0x4040, "ISTUVDS" },              \
		{ 0x4050, "ISTMANALARM" }, { 0x4060, "ISTTDMER" },             \
		{ 0x4070, "ISTNOCLK" },    { 0x4080, "ISTCFMER" },             \
		{ 0x4090, "ISTCFMAC" },    { 0x40a0, "ISTSPKS" },              \
		{ 0x40b0, "ISTACS" },      { 0x40c0, "ISTWDS" },               \
		{ 0x40d0, "ISTBODNOK" },   { 0x40e0, "ISTLP1" },               \
		{ 0x40f0, "ISTCLKOOR" },   { 0x4400, "ICLVDDS" },              \
		{ 0x4410, "ICLBSTOC" },    { 0x4420, "ICLOTDS" },              \
		{ 0x4430, "ICLOCPR" },     { 0x4440, "ICLUVDS" },              \
		{ 0x4450, "ICLMANALARM" }, { 0x4460, "ICLTDMER" },             \
		{ 0x4470, "ICLNOCLK" },    { 0x4480, "ICLCFMER" },             \
		{ 0x4490, "ICLCFMAC" },    { 0x44a0, "ICLSPKS" },              \
		{ 0x44b0, "ICLACS" },      { 0x44c0, "ICLWDS" },               \
		{ 0x44d0, "ICLBODNOK" },   { 0x44e0, "ICLLP1" },               \
		{ 0x44f0, "ICLCLKOOR" },   { 0x4800, "IEVDDS" },               \
		{ 0x4810, "IEBSTOC" },     { 0x4820, "IEOTDS" },               \
		{ 0x4830, "IEOCPR" },      { 0x4840, "IEUVDS" },               \
		{ 0x4850, "IEMANALARM" },  { 0x4860, "IETDMER" },              \
		{ 0x4870, "IENOCLK" },     { 0x4880, "IECFMER" },              \
		{ 0x4890, "IECFMAC" },     { 0x48a0, "IESPKS" },               \
		{ 0x48b0, "IEACS" },       { 0x48c0, "IEWDS" },                \
		{ 0x48d0, "IEBODNOK" },    { 0x48e0, "IELP1" },                \
		{ 0x48f0, "IECLKOOR" },    { 0x4c00, "IPOVDDS" },              \
		{ 0x4c10, "IPOBSTOC" },    { 0x4c20, "IPOOTDS" },              \
		{ 0x4c30, "IPOOCPR" },     { 0x4c40, "IPOUVDS" },              \
		{ 0x4c50, "IPOMANALARM" }, { 0x4c60, "IPOTDMER" },             \
		{ 0x4c70, "IPONOCLK" },    { 0x4c80, "IPOCFMER" },             \
		{ 0x4c90, "IPOCFMAC" },    { 0x4ca0, "IPOSPKS" },              \
		{ 0x4cb0, "IPOACS" },      { 0x4cc0, "IPOWDS" },               \
		{ 0x4cd0, "IPOBODNOK" },   { 0x4ce0, "IPOLP1" },               \
		{ 0x4cf0, "IPOCLKOOR" },   { 0x5001, "BSSCR" },                \
		{ 0x5023, "BSST" },	{ 0x5061, "BSSRL" },                \
		{ 0x5082, "BSSRR" },       { 0x50b1, "BSSHY" },                \
		{ 0x50e0, "BSSR" },	{ 0x50f0, "BSSBY" },                \
		{ 0x5130, "CFSM" },	{ 0x5187, "VOL" },                  \
		{ 0x5202, "CLIPCTRL" },    { 0x5230, "SLOPEE" },               \
		{ 0x5240, "SLOPESET" },    { 0x5287, "AMPGAIN" },              \
		...
		{ 0x7204, "DCTRIP" },      { 0x7254, "DCTRIP2" },              \
		{ 0x72a4, "DCTRIPT" },     { 0x72f0, "DCTRIPHYSTE" },          \
		{ 0x7304, "DCHOLD" },      { 0x9000, "RST" },                  \
		{ 0x9011, "DMEM" },	{ 0x9030, "AIF" },                  \
		{ 0x9040, "CFINT" },       { 0x9050, "CFCGATE" },              \
		{ 0x9080, "REQCMD" },      { 0x9090, "REQRST" },               \
		{ 0x90a0, "REQMIPS" },     { 0x90b0, "REQMUTED" },             \
		{ 0x90c0, "REQVOL" },      { 0x90d0, "REQDMG" },               \
		{ 0x90e0, "REQCAL" },      { 0x90f0, "REQRSV" },               \
		{ 0x910f, "MADD" },	{ 0x920f, "MEMA" },                 \
		{ 0x9307, "ERR" },	 { 0x9380, "ACKCMD" },               \
		{ 0x9390, "ACKRST" },      { 0x93a0, "ACKMIPS" },              \
		{ 0x93b0, "ACKMUTED" },    { 0x93c0, "ACKVOL" },               \
		{ 0x93d0, "ACKDMG" },      { 0x93e0, "ACKCAL" },               \
		{ 0x93f0, "ACKRSV" },      { 0xa107, "MTPK" },                 \
		{ 0xa200, "KEY1LOCKED" },  { 0xa210, "KEY2LOCKED" },           \
		{ 0xa350, "CMTPI" },       { 0xa360, "CIMTP" },                \
		{ 0xa50f, "MTPRDMSB" },    { 0xa60f, "MTPRDLSB" },             \
		{ 0xb108, "EXTTS" },       { 0xb190, "TROS" },                 \
...
#define TFA9894_BITNAMETABLE                                      \
	static struct TfaBfName Tfa9894BitNames[] = {             \
		{ 0x0, "powerdown" },                             \
		{ 0x10, "reset" },                                \
		{ 0x20, "enbl_coolflux" },                        \
		{ 0x30, "enbl_amplifier" },                       \
...
enum tfa9894_irq { tfa9894_irq_max = -1, tfa9894_irq_all = -1 };
