...
#define RT5659_NO_JACK		BIT(0)
#define RT5659_HEADSET_DET	BIT(1)
#define RT5659_HEADPHO_DET	BIT(2)
...
int rt5659_set_jack_detect(struct snd_soc_codec *, struct snd_soc_jack *);
