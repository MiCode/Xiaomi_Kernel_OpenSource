...
RT_REG_DECL(RT5509_REG_BST_TH1, 2, RT_NORMAL_WR_ONCE, {});
RT_REG_DECL(RT5509_REG_BST_TH2, 2, RT_NORMAL_WR_ONCE, {});
RT_REG_DECL(RT5509_REG_BST_TH3, 2, RT_NORMAL_WR_ONCE, {});
...
RT_REG_DECL(RT5509_REG_IDAC1TST, 1, RT_WBITS_WR_ONCE, {0x7f});
RT_REG_DECL(RT5509_REG_IDAC2TST, 1, RT_WBITS_WR_ONCE, {0x7f});
RT_REG_DECL(RT5509_REG_IDAC3TST, 1, RT_WBITS_WR_ONCE, {0x7f});
RT_REG_DECL(RT5509_REG_IDACTSTEN, 1, RT_WBITS_WR_ONCE, {0x87});
RT_REG_DECL(RT5509_REG_CCMAX, 1, RT_WBITS_WR_ONCE, {0x7f});
RT_REG_DECL(RT5509_REG_OCPMAX, 1, RT_WBITS_WR_ONCE, {0x7f});
...
RT_REG_DECL(RT5509_REG_DSPKCONF6, 1, RT_NORMAL_WR_ONCE, {});
