...
extern void wcd9xxx_enable_irq(int irq);
extern void wcd9xxx_disable_irq(int irq);
extern int wcd9xxx_request_irq(int irq, irq_handler_t handler,
				const char *name, void *priv);
extern int wcd9xxx_free_irq(int irq, void *priv);
...
bool wcd9xxx_lock_sleep(void);
void wcd9xxx_unlock_sleep(void);
