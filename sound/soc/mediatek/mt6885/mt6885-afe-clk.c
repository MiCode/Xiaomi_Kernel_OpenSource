...
/*
 *  mt6885-afe-clk.c  --  Mediatek 6885 afe clock ctrl
 *
...
{
	return (apll == MT6885_APLL1) ? 180633600 : 196608000;
}

int mt6885_get_apll_by_rate(struct mtk_base_afe *afe, int rate)
{
	return ((rate % 8000) == 0) ? MT6885_APLL2 : MT6885_APLL1;
}
...
static int mt6885_afe_idle_notify_call(struct notifier_block *nfb,
				       unsigned long id,
				       void *arg)
{
	switch (id) {
...
static struct notifier_block mt6885_afe_idle_nfb = {
	.notifier_call = mt6885_afe_idle_notify_call,
};
#endif
