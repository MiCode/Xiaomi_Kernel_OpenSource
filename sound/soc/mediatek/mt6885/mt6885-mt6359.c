...
/*
 *  mt6885-mt6359.c  --  mt6885 mt6359 ALSA SoC machine driver
 *
...
static const struct snd_soc_dapm_widget mt6885_mt6359_widgets[] = {
	SND_SOC_DAPM_SPK(EXT_SPK_AMP_W_NAME, mt6885_mt6359_spk_amp_event),
};

static const struct snd_soc_dapm_route mt6885_mt6359_routes[] = {
 ...
 * BE i2s need assign snd_soc_ops = mt6885_mt6359_i2s_ops
 */
static int mt6885_mt6359_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6885_mt6359_i2s_ops = {
	.hw_params = mt6885_mt6359_i2s_hw_params,
};
...
static int mt6885_mt6359_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	if (afe_priv->mtkaif_protocol == MTKAIF_PROTOCOL_2_CLK_P2)
		mt6885_mt6359_mtkaif_calibration(rtd);
...
static const struct snd_pcm_hardware mt6885_mt6359_vow_hardware = {
...
static int mt6885_mt6359_vow_startup(struct snd_pcm_substream *substream)
{
	...
	dev_info(afe->dev, "%s(), start\n", __func__);
	snd_soc_set_runtime_hwparams(substream, &mt6885_mt6359_vow_hardware);
...
static const struct snd_soc_ops mt6885_mt6359_vow_ops = {
	.startup = mt6885_mt6359_vow_startup,
	.shutdown = mt6885_mt6359_vow_shutdown,
};
#endif  // #ifdef CONFIG_MTK_VOW_SUPPORT

static struct snd_soc_dai_link mt6885_mt6359_dai_links[] = {
	/* Front End DAI links */
	{
		.name = "Playback_1",
...
static struct snd_soc_card mt6885_mt6359_soc_card = {
	...
	.num_dapm_widgets = ARRAY_SIZE(mt6885_mt6359_widgets),
	.dapm_routes = mt6885_mt6359_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6885_mt6359_routes),
};
...
static int mt6885_mt6359_dev_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < card->num_links; i++) {
		if (mt6885_mt6359_dai_links[i].platform_name)
			continue;
		/* no platform assign and with dsp playback node. */
		name = mt6885_mt6359_dai_links[i].name;
		if (!strncmp(name, "DSP", strlen("DSP")) &&
		    mt6885_mt6359_dai_links[i].platform_name == NULL) {
			mt6885_mt6359_dai_links[i].platform_of_node = dsp_node;
			continue;
		}
		mt6885_mt6359_dai_links[i].platform_of_node = platform_node;
	}
...
#ifdef CONFIG_OF
static const struct of_device_id mt6885_mt6359_dt_match[] = {
	{.compatible = "mediatek,mt6885-mt6359-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6885_mt6359_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6885_mt6359_driver = {
	.driver = {
		.name = "mt6885-mt6359",
#ifdef CONFIG_OF
		.of_match_table = mt6885_mt6359_dt_match,
#endif
		.pm = &mt6885_mt6359_pm_ops,
	},
	.probe = mt6885_mt6359_dev_probe,
};

module_platform_driver(mt6885_mt6359_driver);

/* Module information */
MODULE_DESCRIPTION("MT6885 MT6359 ALSA SoC machine driver");
MODULE_AUTHOR("Shane Chien <shane.chien@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6885 mt6359 soc card");
