...
enum AUDIO_ANALOG_AUDIOANALOG_INPUT {
...
enum AUDIO_ANALOGUL_POWER_MODE {
...
struct mt6323_Codec_Data_Priv {
	int32_t mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_TYPE_MAX];
	int32_t mAudio_Ana_Mux[AUDIO_ANALOG_MAX_MUX_TYPE];
	int32_t mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_MAX];
	int32_t mAudio_BackUpAna_DevicePower[AUDIO_ANALOG_DEVICE_MAX];
};
