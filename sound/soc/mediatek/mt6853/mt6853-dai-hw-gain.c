				  ...
				  struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt6853_rate_transform(afe->dev, rate, dai->id);
	...
	regmap_update_bits(afe->regmap,
			   ...
			   (dai->id == MT6853_DAI_HW_GAIN_1 ? 0x40 : 0x0) <<
