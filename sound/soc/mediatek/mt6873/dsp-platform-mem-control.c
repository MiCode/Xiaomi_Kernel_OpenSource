...
EXPORT_SYMBOL_GPL(mtk_get_adsp_sharemem_block);
...
EXPORT_SYMBOL_GPL(mtk_get_adsp_task_attr);
...
EXPORT_SYMBOL_GPL(mtk_adsp_dai_id_support_share_mem);
...
EXPORT_SYMBOL_GPL(mtk_get_core_id);

bool get_mtk_enable_common_mem_mpu(void)
{
	return true;
}
EXPORT_SYMBOL_GPL(get_mtk_enable_common_mem_mpu);

MODULE_DESCRIPTION("MTK AUDIO DSP SOC Driver");
