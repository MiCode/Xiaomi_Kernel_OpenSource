...
/*
 *  mt6873-mt6359p.c  --  mt6873 mt6359p ALSA SoC machine driver
 *
...
static int mt6873_mt6359p_spk_amp_event(struct snd_soc_dapm_widget *w,
...
static const struct snd_soc_dapm_widget mt6873_mt6359p_widgets[] = {
	SND_SOC_DAPM_SPK(EXT_SPK_AMP_W_NAME, mt6873_mt6359p_spk_amp_event),
};

static const struct snd_soc_dapm_route mt6873_mt6359p_routes[] = {
...
static const struct snd_kcontrol_new mt6873_mt6359p_controls[] = {
 ...
 * BE i2s need assign snd_soc_ops = mt6873_mt6359p_i2s_ops
 */
static int mt6873_mt6359p_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6873_mt6359p_i2s_ops = {
	.hw_params = mt6873_mt6359p_i2s_hw_params,
};

static int mt6873_mt6359p_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
...
static int mt6873_mt6359p_init(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	if (afe_priv->mtkaif_protocol == MTKAIF_PROTOCOL_2_CLK_P2)
		mt6873_mt6359p_mtkaif_calibration(rtd);
...
static struct snd_soc_card mt6873_mt6359p_soc_card = {
	.name = "mt6873-mt6359p",
	.owner = THIS_MODULE,
	.dai_link = mt6873_mt6359p_dai_links,
	.num_links = ARRAY_SIZE(mt6873_mt6359p_dai_links),

	.controls = mt6873_mt6359p_controls,
	.num_controls = ARRAY_SIZE(mt6873_mt6359p_controls),
	.dapm_widgets = mt6873_mt6359p_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6873_mt6359p_widgets),
	.dapm_routes = mt6873_mt6359p_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6873_mt6359p_routes),
};

static int
mt6873_mt6359p_headset_init(struct snd_soc_component *component)
{
...
static struct snd_soc_aux_dev mt6873_mt6359p_headset_dev = {
	.dlc = COMP_EMPTY(),
	.init = mt6873_mt6359p_headset_init,
};
...
static int mt6873_mt6359p_dev_probe(struct platform_device *pdev)
{
	...
	card->dev = &pdev->dev;
	mt6873_mt6359p_headset_dev.dlc.of_node =
		of_parse_phandle(pdev->dev.of_node,
				"mediatek,headset-codec", 0);
	if (mt6873_mt6359p_headset_dev.dlc.of_node) {
		card->aux_dev = &mt6873_mt6359p_headset_dev;
		card->num_aux_devs = 1;
	} else
		dev_err(&pdev->dev,
...
static const struct of_device_id mt6873_mt6359p_dt_match[] = {
	{.compatible = "mediatek,mt6873-mt6359p-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6873_mt6359p_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6873_mt6359p_driver = {
	.driver = {
		.name = "mt6873-mt6359p",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6873_mt6359p_dt_match,
#endif
		.pm = &mt6873_mt6359p_pm_ops,
	},
	.probe = mt6873_mt6359p_dev_probe,
};

module_platform_driver(mt6873_mt6359p_driver);

/* Module information */
MODULE_DESCRIPTION("MT6873 MT6359p ALSA SoC machine driver");
MODULE_AUTHOR("Shane Chien <shane.chien@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6873 mt6359p soc card");
