...
EXPORT_SYMBOL(mt6985_enable_dc_compensation);
...
EXPORT_SYMBOL(mt6985_set_lch_dc_compensation);
...
EXPORT_SYMBOL(mt6985_set_rch_dc_compensation);
...
EXPORT_SYMBOL(mt6985_adda_dl_gain_control);
