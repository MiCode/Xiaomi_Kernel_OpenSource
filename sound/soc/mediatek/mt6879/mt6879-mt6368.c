...
/*
 *  mt6879-mt6368.c  --  mt6879 mt6368 ALSA SoC machine driver
 *
 ...
 * mt6879_mt6368_spk_amp_event()
 */
#define EXT_SPK_AMP_W_NAME "Ext_Speaker_Amp"

static const char *const mt6879_spk_type_str[] = {MTK_SPK_NOT_SMARTPA_STR,
						  MTK_SPK_RICHTEK_RT5509_STR,
						  MTK_SPK_MEDIATEK_MT6660_STR,
						  MTK_SPK_RICHTEK_RT5512_STR,
						  MTK_SPK_GOODIX_TFA98XX_STR};
static const char *const
	mt6879_spk_i2s_type_str[] = {MTK_SPK_I2S_0_STR,
				     MTK_SPK_I2S_1_STR,
				     MTK_SPK_I2S_2_STR,
				     MTK_SPK_I2S_3_STR,
				     MTK_SPK_I2S_5_STR,
...
static const struct soc_enum mt6879_spk_type_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6879_spk_type_str),
			    mt6879_spk_type_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6879_spk_i2s_type_str),
			    mt6879_spk_i2s_type_str),
};

static int mt6879_spk_type_get(struct snd_kcontrol *kcontrol,
...
static int mt6879_spk_i2s_out_type_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6879_spk_i2s_in_type_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6879_mt6368_spk_amp_event(struct snd_soc_dapm_widget *w,
...
static const struct snd_soc_dapm_widget mt6879_mt6368_widgets[] = {
	SND_SOC_DAPM_SPK(EXT_SPK_AMP_W_NAME, mt6879_mt6368_spk_amp_event),
};

static const struct snd_soc_dapm_route mt6879_mt6368_routes[] = {
...
static const struct snd_kcontrol_new mt6879_mt6368_controls[] = {
	SOC_DAPM_PIN_SWITCH(EXT_SPK_AMP_W_NAME),
	SOC_ENUM_EXT("MTK_SPK_TYPE_GET", mt6879_spk_type_enum[0],
		     mt6879_spk_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_OUT_TYPE_GET", mt6879_spk_type_enum[1],
		     mt6879_spk_i2s_out_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_IN_TYPE_GET", mt6879_spk_type_enum[1],
		     mt6879_spk_i2s_in_type_get, NULL),
};

/*
 * define mtk_spk_i2s_mck node in dts when need mclk,
 * BE i2s need assign snd_soc_ops = mt6879_mt6368_i2s_ops
 */
static int mt6879_mt6368_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6879_mt6368_i2s_ops = {
	.hw_params = mt6879_mt6368_i2s_hw_params,
};

static int mt6879_mt6368_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	miso0_need_calib = mt6879_afe_gpio_is_prepared(MT6879_AFE_GPIO_DAT_MISO0_ON);
	miso1_need_calib = mt6879_afe_gpio_is_prepared(MT6879_AFE_GPIO_DAT_MISO1_ON);
	miso2_need_calib = mt6879_afe_gpio_is_prepared(MT6879_AFE_GPIO_DAT_MISO2_ON);

	mt6879_afe_gpio_request(afe, true, MT6879_DAI_ADDA, 1);
	mt6879_afe_gpio_request(afe, true, MT6879_DAI_ADDA, 0);
	mt6879_afe_gpio_request(afe, true, MT6879_DAI_ADDA_CH34, 1);
	mt6879_afe_gpio_request(afe, true, MT6879_DAI_ADDA_CH34, 0);
	...
	mt6879_afe_gpio_request(afe, false, MT6879_DAI_ADDA, 1);
	mt6879_afe_gpio_request(afe, false, MT6879_DAI_ADDA, 0);
	mt6879_afe_gpio_request(afe, false, MT6879_DAI_ADDA_CH34, 1);
	mt6879_afe_gpio_request(afe, false, MT6879_DAI_ADDA_CH34, 0);
...
static int mt6879_mt6368_init(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	ops.enable_dc_compensation = mt6879_enable_dc_compensation;
	ops.set_lch_dc_compensation = mt6879_set_lch_dc_compensation;
	ops.set_rch_dc_compensation = mt6879_set_rch_dc_compensation;
	ops.adda_dl_gain_control = mt6879_adda_dl_gain_control;
	...
	/* mtkaif calibration */
	mt6879_mt6368_mtkaif_calibration(rtd);
...
static int mt6879_i2s_hw_params_fixup(struct snd_soc_pcm_runtime *rtd,
				      struct snd_pcm_hw_params *params)
{
...
static const struct snd_pcm_hardware mt6879_mt6368_vow_hardware = {
...
static int mt6879_mt6368_vow_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	dev_info(afe->dev, "%s(), start\n", __func__);
	snd_soc_set_runtime_hwparams(substream, &mt6879_mt6368_vow_hardware);

	mt6879_afe_gpio_request(afe, true, MT6879_DAI_VOW, 0);
...
static void mt6879_mt6368_vow_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	mt6879_afe_gpio_request(afe, false, MT6879_DAI_VOW, 0);
...
static const struct snd_soc_ops mt6879_mt6368_vow_ops = {
	.startup = mt6879_mt6368_vow_startup,
	.shutdown = mt6879_mt6368_vow_shutdown,
};
...
static struct snd_soc_dai_link mt6879_mt6368_dai_links[] = {
	/* Front End DAI links */
	{
		.name = "Playback_1",
	...
	},
	{
		...
		.ops = &mt6879_mt6368_i2s_ops,
		.no_pcm = 1,
		.dpcm_capture = 1,
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		.be_hw_params_fixup = mt6879_i2s_hw_params_fixup,
...
static struct snd_soc_card mt6879_mt6368_soc_card = {
	.name = "mt6879-mt6368",
	.owner = THIS_MODULE,
	.dai_link = mt6879_mt6368_dai_links,
	.num_links = ARRAY_SIZE(mt6879_mt6368_dai_links),

	.controls = mt6879_mt6368_controls,
	.num_controls = ARRAY_SIZE(mt6879_mt6368_controls),
	.dapm_widgets = mt6879_mt6368_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6879_mt6368_widgets),
	.dapm_routes = mt6879_mt6368_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6879_mt6368_routes),
};

#if IS_ENABLED(CONFIG_SND_SOC_MT6368_ACCDET)

static int mt6879_mt6368_headset_init(struct snd_soc_component *component)
{
...
static struct snd_soc_aux_dev mt6879_mt6368_headset_dev = {
	.dlc = COMP_EMPTY(),
	.init = mt6879_mt6368_headset_init,
};
#endif
static int mt6879_mt6368_dev_probe(struct platform_device *pdev)
{
	...
	card->dev = &pdev->dev;
#if IS_ENABLED(CONFIG_SND_SOC_MT6368_ACCDET)
	mt6879_mt6368_headset_dev.dlc.of_node =
		of_parse_phandle(pdev->dev.of_node,
				"mediatek,headset-codec", 0);
	if (mt6879_mt6368_headset_dev.dlc.of_node) {
		card->aux_dev = &mt6879_mt6368_headset_dev;
		card->num_aux_devs = 1;
	} else
		dev_err(&pdev->dev,
...
static const struct of_device_id mt6879_mt6368_dt_match[] = {
	{.compatible = "mediatek,mt6879-mt6368-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6879_mt6368_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6879_mt6368_driver = {
	.driver = {
		.name = "mt6879-mt6368",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6879_mt6368_dt_match,
#endif
		.pm = &mt6879_mt6368_pm_ops,
	},
	.probe = mt6879_mt6368_dev_probe,
};

module_platform_driver(mt6879_mt6368_driver);

/* Module information */
MODULE_DESCRIPTION("MT6879 mt6368 ALSA SoC machine driver");
MODULE_AUTHOR("Shane Chien <shane.chien@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6879 mt6368 soc card");
