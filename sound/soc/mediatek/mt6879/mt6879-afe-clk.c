...
/*
 *  mt6879-afe-clk.c  --  Mediatek 6879 afe clock ctrl
 *
...
#include "mt6879-afe-common.h"
#include "mt6879-afe-clk.h"

#if defined(CONFIG_FPGA_EARLY_PORTING)
int mt6879_init_clock(struct mtk_base_afe *afe) { return 0; }
int mt6879_afe_enable_clock(struct mtk_base_afe *afe) { return 0; }
void mt6879_afe_disable_clock(struct mtk_base_afe *afe) {}
int mt6879_afe_dram_request(struct device *dev) { return 0; }
int mt6879_afe_dram_release(struct device *dev) { return 0; }
int mt6879_apll1_enable(struct mtk_base_afe *afe) { return 0; }
void mt6879_apll1_disable(struct mtk_base_afe *afe) {}
int mt6879_apll2_enable(struct mtk_base_afe *afe) { return 0; }
void mt6879_apll2_disable(struct mtk_base_afe *afe) {}
int mt6879_get_apll_rate(struct mtk_base_afe *afe, int apll) { return 0; }
int mt6879_get_apll_by_rate(struct mtk_base_afe *afe, int rate) { return 0; }
int mt6879_get_apll_by_name(struct mtk_base_afe *afe, const char *name) { return 0; }
int mt6879_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate) { return 0; }
void mt6879_mck_disable(struct mtk_base_afe *afe, int mck_id) {}
int mt6879_set_audio_int_bus_parent(struct mtk_base_afe *afe, int clk_id) { return 0; }
#else
...
static const char *aud_clks[CLK_NUM] = {
	[CLK_AFE] = "aud_afe_clk",
	[CLK_DAC] = "aud_dac_clk",
	[CLK_DAC_PREDIS] = "aud_adc_clk",
	[CLK_ADC] = "aud_adda6_adc_clk",
	[CLK_ADDA6_ADC] = "aud_apll24m_clk",
...
int mt6879_set_audio_int_bus_parent(struct mtk_base_afe *afe,
				    int clk_id)
{
...
int mt6879_afe_enable_clock(struct mtk_base_afe *afe)
{
	struct mt6879_afe_private *afe_priv = afe->platform_priv;
	int ret = 0;
	...
	ret = mt6879_set_audio_int_bus_parent(afe, CLK_CLK26M);
...
void mt6879_afe_disable_clock(struct mtk_base_afe *afe)
{
	...
	mt6879_set_audio_int_bus_parent(afe, CLK_CLK26M);
	clk_disable_unprepare(afe_priv->clk[CLK_MUX_AUDIOINTBUS]);
	clk_disable_unprepare(afe_priv->clk[CLK_MUX_AUDIO]);
}

int mt6879_afe_dram_request(struct device *dev)
{
...
int mt6879_afe_dram_release(struct device *dev)
{
	struct mtk_base_afe *afe = dev_get_drvdata(dev);
	struct mt6879_afe_private *afe_priv = afe->platform_priv;
#if !defined(SKIP_SB)
...
int mt6879_apll1_enable(struct mtk_base_afe *afe)
{
	struct mt6879_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
int mt6879_apll2_enable(struct mtk_base_afe *afe)
{
	struct mt6879_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
int mt6879_get_apll_rate(struct mtk_base_afe *afe, int apll)
{
	return (apll == MT6879_APLL1) ? 180633600 : 196608000;
}

int mt6879_get_apll_by_rate(struct mtk_base_afe *afe, int rate)
{
	return ((rate % 8000) == 0) ? MT6879_APLL2 : MT6879_APLL1;
}

int mt6879_get_apll_by_name(struct mtk_base_afe *afe, const char *name)
{
...
static const struct mt6879_mck_div mck_div[MT6879_MCK_NUM] = {
	[MT6879_I2S0_MCK] = {
...
int mt6879_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate)
{
	struct mt6879_afe_private *afe_priv = afe->platform_priv;
...
int mt6879_init_clock(struct mtk_base_afe *afe)
{
	struct mt6879_afe_private *afe_priv = afe->platform_priv;
	int i = 0;
	int ret = 0;
