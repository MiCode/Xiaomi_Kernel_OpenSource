...
EXPORT_SYMBOL(mt6983_enable_dc_compensation);
...
EXPORT_SYMBOL(mt6983_set_lch_dc_compensation);
...
EXPORT_SYMBOL(mt6983_set_rch_dc_compensation);
...
EXPORT_SYMBOL(mt6983_adda_dl_gain_control);
