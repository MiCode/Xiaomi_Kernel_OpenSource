...
static struct mtk_adsp_task_attr adsp_task_attr[AUDIO_TASK_DAI_NUM] = {
	[AUDIO_TASK_VOIP_ID] = {true, MT6833_MEMIF_DL12, -1, -1,
				VOIP_FEATURE_ID, false},
	[AUDIO_TASK_PRIMARY_ID] = {true, MT6833_MEMIF_DL1, -1, -1,
				   PRIMARY_FEATURE_ID, false},
	[AUDIO_TASK_OFFLOAD_ID] = {true, MT6833_MEMIF_DL3, -1, -1,
				   OFFLOAD_FEATURE_ID, false},
	[AUDIO_TASK_DEEPBUFFER_ID] = {false, -1, -1, -1,
				      DEEPBUF_FEATURE_ID, false},
	[AUDIO_TASK_PLAYBACK_ID] = {false, MT6833_MEMIF_DL4,
				    MT6833_MEMIF_VUL4,
				    MT6833_MEMIF_AWB2,
	...
	[AUDIO_TASK_CALL_FINAL_ID] = {true, MT6833_MEMIF_DL4,
				      MT6833_MEMIF_VUL4,
				      MT6833_MEMIF_AWB2,
				      CALL_FINAL_FEATURE_ID, false},
	[AUDIO_TASK_FAST_ID] = {false, -1, -1, -1,
				FAST_FEATURE_ID, false},
	[AUDIO_TASK_KTV_ID] = {true, MT6833_MEMIF_DL8,
				      MT6833_MEMIF_VUL6,
				      -1,
...
{
	switch (dai_id) {
	case MT6833_MEMIF_DL1:
	case MT6833_MEMIF_DL12:
	case MT6833_MEMIF_DL2:
	case MT6833_MEMIF_DL3:
	case MT6833_MEMIF_DL4:
	case MT6833_MEMIF_DL5:
	case MT6833_MEMIF_DL6:
	case MT6833_MEMIF_DL7:
	case MT6833_MEMIF_DL8:
	case MT6833_MEMIF_VUL12:
	case MT6833_MEMIF_VUL2:
	case MT6833_MEMIF_VUL3:
	case MT6833_MEMIF_VUL4:
	case MT6833_MEMIF_VUL5:
	case MT6833_MEMIF_VUL6:
	case MT6833_MEMIF_AWB:
	case MT6833_MEMIF_AWB2:
	case MT6833_MEMIF_NUM:
		return true;
	case MT6833_MEMIF_DAI:
	case MT6833_MEMIF_DAI2:
	case MT6833_MEMIF_MOD_DAI:
	case MT6833_MEMIF_HDMI:
		return false;
	default:
		return false;
	}
