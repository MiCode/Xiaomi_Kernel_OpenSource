...
#ifndef MT6833_DSP_MEM_CONTROL_H
#define MT6833_DSP_MEM_CONTROL_H
...
/* clk relate */
#include "../../mt6833/mt6833-afe-clk.h"
#include "../../mt6833/mt6833-afe-common.h"

#define MEMIF_NUM_MAX MT6833_MEMIF_NUM
