				   ...
				   unsigned int rate, int aud_blk)
{
	...
	default:
		return mt6789_general_rate_transform(dev, rate);
	}
}
...
EXPORT_SYMBOL(mt6789_enable_dc_compensation);
...
EXPORT_SYMBOL(mt6789_set_lch_dc_compensation);
...
EXPORT_SYMBOL(mt6789_set_rch_dc_compensation);
...
EXPORT_SYMBOL(mt6789_adda_dl_gain_control);
