...
static const char * const mt6789_sgen_mode_str[] = {
	"I0I1",   "I2",     "I3I4",   "I5I6",
...
static const int mt6789_sgen_rate_idx[] = {
	0, 1, 2, 4,
	5, 6, 8, 9,
	10, 11, 12, 13,
	14
...
static const char * const mt6789_sgen_amp_str[] = {
	"1/128", "1/64", "1/32", "1/16", "1/8", "1/4", "1/2", "1" };

static const char * const mt6789_sgen_mute_str[] = {
	"Off", "On"
};
			   ...
			   struct snd_ctl_elem_value *ucontrol)
{
	...
	mode_idx = mt6789_sgen_mode_idx[mode];
				...
				struct snd_ctl_elem_value *ucontrol)
{
	...
	regmap_update_bits(afe->regmap, AFE_SINEGEN_CON0,
			   ...
			   mt6789_sgen_rate_idx[rate] << SINE_MODE_CH1_SFT);

	regmap_update_bits(afe->regmap, AFE_SINEGEN_CON0,
			   SINE_MODE_CH2_MASK_SFT,
			   mt6789_sgen_rate_idx[rate] << SINE_MODE_CH2_SFT);
...
static const struct soc_enum mt6789_afe_sgen_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6789_sgen_mode_str),
			    mt6789_sgen_mode_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6789_sgen_rate_str),
			    mt6789_sgen_rate_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6789_sgen_amp_str),
			    mt6789_sgen_amp_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6789_sgen_mute_str),
			    mt6789_sgen_mute_str),
};

static const struct snd_kcontrol_new mt6789_afe_sgen_controls[] = {
	SOC_ENUM_EXT("Audio_SineGen_Switch", mt6789_afe_sgen_enum[0],
		     mt6789_sgen_get, mt6789_sgen_set),
	SOC_ENUM_EXT("Audio_SineGen_SampleRate", mt6789_afe_sgen_enum[1],
		     mt6789_sgen_rate_get, mt6789_sgen_rate_set),
	SOC_ENUM_EXT("Audio_SineGen_Amplitude", mt6789_afe_sgen_enum[2],
		     mt6789_sgen_amplitude_get, mt6789_sgen_amplitude_set),
	SOC_ENUM_EXT(SGEN_MUTE_CH1_KCONTROL_NAME, mt6789_afe_sgen_enum[3],
		     mt6789_sgen_mute_get, mt6789_sgen_mute_set),
	SOC_ENUM_EXT(SGEN_MUTE_CH2_KCONTROL_NAME, mt6789_afe_sgen_enum[3],
		     mt6789_sgen_mute_get, mt6789_sgen_mute_set),
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	int ul_id = MT6789_MEMIF_MOD_DAI;
	...
	if (enable) {
		...
		mtk_memif_set_pbuf_size(afe, dl_id,
					MT6789_MEMIF_PBUF_SIZE_32_BYTES);
...
static const struct snd_kcontrol_new mt6789_afe_usb_controls[] = {
	SOC_SINGLE_EXT("usb_call_echo_ref", SND_SOC_NOPM, 0, 0xFFFFFFFF, 0,
		       mt6789_usb_echo_ref_get, mt6789_usb_echo_ref_set),
};

/* speech mixctrl instead property usage */
static void *get_sph_property_by_name(struct mt6789_afe_private *afe_priv,
				      const char *name)
{
...
static const struct snd_kcontrol_new mt6789_afe_speech_controls[] = {
...
int mt6789_add_misc_control(struct snd_soc_component *component)
{
	...
	snd_soc_add_component_controls(component,
				      mt6789_afe_sgen_controls,
				      ARRAY_SIZE(mt6789_afe_sgen_controls));

	snd_soc_add_component_controls(component,
				      mt6789_afe_usb_controls,
				      ARRAY_SIZE(mt6789_afe_usb_controls));
