...
/*
 *  mt6886-afe-clk.c  --  Mediatek 6886 afe clock ctrl
 *
...
int mt6886_init_clock(struct mtk_base_afe *afe) { return 0; }
int mt6886_afe_enable_clock(struct mtk_base_afe *afe) { return 0; }
void mt6886_afe_disable_clock(struct mtk_base_afe *afe) {}
int mt6886_afe_sram_request(struct mtk_base_afe *afe) { return 0; }
void mt6886_afe_sram_release(struct mtk_base_afe *afe) {}
int mt6886_afe_dram_request(struct device *dev) { return 0; }
int mt6886_afe_dram_release(struct device *dev) { return 0; }
int mt6886_apll1_enable(struct mtk_base_afe *afe) { return 0; }
void mt6886_apll1_disable(struct mtk_base_afe *afe) {}
int mt6886_apll2_enable(struct mtk_base_afe *afe) { return 0; }
void mt6886_apll2_disable(struct mtk_base_afe *afe) {}
int mt6886_get_apll_rate(struct mtk_base_afe *afe, int apll) { return 0; }
int mt6886_get_apll_by_rate(struct mtk_base_afe *afe, int rate) { return 0; }
int mt6886_get_apll_by_name(struct mtk_base_afe *afe, const char *name) { return 0; }
int mt6886_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate) { return 0; }
void mt6886_mck_disable(struct mtk_base_afe *afe, int mck_id) {}
int mt6886_set_audio_int_bus_parent(struct mtk_base_afe *afe, int clk_id) { return 0; }
#else
...
int mt6886_set_audio_int_bus_parent(struct mtk_base_afe *afe,
				    int clk_id)
{
...
int mt6886_afe_enable_clock(struct mtk_base_afe *afe)
{
	struct mt6886_afe_private *afe_priv = afe->platform_priv;
	int ret = 0;
	...
	ret = mt6886_set_audio_int_bus_parent(afe, CLK_CLK26M);
...
void mt6886_afe_disable_clock(struct mtk_base_afe *afe)
{
	...
	mt6886_set_audio_int_bus_parent(afe, CLK_CLK26M);
	clk_disable_unprepare(afe_priv->clk[CLK_MUX_AUDIOINTBUS]);
	clk_disable_unprepare(afe_priv->clk[CLK_MUX_AUDIO]);
}

int mt6886_afe_dram_request(struct device *dev)
{
...
int mt6886_afe_dram_release(struct device *dev)
{
	struct mtk_base_afe *afe = dev_get_drvdata(dev);
	struct mt6886_afe_private *afe_priv = afe->platform_priv;
#if !defined(SKIP_SMCC_SB)
...
int mt6886_afe_sram_request(struct mtk_base_afe *afe)
{
	struct arm_smccc_res res;
...
int mt6886_apll1_enable(struct mtk_base_afe *afe)
{
	struct mt6886_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
int mt6886_apll2_enable(struct mtk_base_afe *afe)
{
	struct mt6886_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
int mt6886_get_apll_rate(struct mtk_base_afe *afe, int apll)
{
	return (apll == MT6886_APLL1) ? 180633600 : 196608000;
}

int mt6886_get_apll_by_rate(struct mtk_base_afe *afe, int rate)
{
	return ((rate % 8000) == 0) ? MT6886_APLL2 : MT6886_APLL1;
}

int mt6886_get_apll_by_name(struct mtk_base_afe *afe, const char *name)
{
...
static const struct mt6886_mck_div mck_div[MT6886_MCK_NUM] = {
	[MT6886_I2S0_MCK] = {
...
int mt6886_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate)
{
	struct mt6886_afe_private *afe_priv = afe->platform_priv;
	int apll = mt6886_get_apll_by_rate(afe, rate);
	int apll_clk_id = apll == MT6886_APLL1 ?
...
void mt6886_mck_disable(struct mtk_base_afe *afe, int mck_id)
{
	...
	if (mck_id == MT6886_I2S5_MCK) /* i2s5 */
		div_clk_id = mck_div[mck_id].div_msb_clk_id;
	else
		div_clk_id = mck_div[mck_id].div_clk_id;
...
int mt6886_init_clock(struct mtk_base_afe *afe)
{
	struct mt6886_afe_private *afe_priv = afe->platform_priv;
	int i = 0;
	int ret = 0;
