...
EXPORT_SYMBOL(mt6886_enable_dc_compensation);
...
EXPORT_SYMBOL(mt6886_set_lch_dc_compensation);
...
EXPORT_SYMBOL(mt6886_set_rch_dc_compensation);
...
EXPORT_SYMBOL(mt6886_adda_dl_gain_control);
