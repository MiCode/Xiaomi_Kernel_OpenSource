...
/*
 *  mt6855-afe-clk.c  --  Mediatek 6855 afe clock ctrl
 *
...
int mt6855_init_clock(struct mtk_base_afe *afe) { return 0; }
int mt6855_afe_enable_clock(struct mtk_base_afe *afe) { return 0; }
void mt6855_afe_disable_clock(struct mtk_base_afe *afe) {}
int mt6855_afe_dram_request(struct device *dev) { return 0; }
int mt6855_afe_dram_release(struct device *dev) { return 0; }
int mt6855_apll1_enable(struct mtk_base_afe *afe) { return 0; }
void mt6855_apll1_disable(struct mtk_base_afe *afe) {}
int mt6855_apll2_enable(struct mtk_base_afe *afe) { return 0; }
void mt6855_apll2_disable(struct mtk_base_afe *afe) {}
int mt6855_get_apll_rate(struct mtk_base_afe *afe, int apll) { return 0; }
int mt6855_get_apll_by_rate(struct mtk_base_afe *afe, int rate) { return 0; }
int mt6855_get_apll_by_name(struct mtk_base_afe *afe, const char *name) { return 0; }
int mt6855_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate) { return 0; }
void mt6855_mck_disable(struct mtk_base_afe *afe, int mck_id) {}
int mt6855_set_audio_int_bus_parent(struct mtk_base_afe *afe, int clk_id) { return 0; }
#else
...
int mt6855_afe_enable_clock(struct mtk_base_afe *afe)
{
	...
	ret = mt6855_set_audio_int_bus_parent(afe, CLK_CLK26M);
...
{
	return (apll == MT6855_APLL1) ? 180633600 : 196608000;
}

int mt6855_get_apll_by_rate(struct mtk_base_afe *afe, int rate)
{
	return ((rate % 8000) == 0) ? MT6855_APLL2 : MT6855_APLL1;
}
...
static const struct mt6855_mck_div mck_div[MT6855_MCK_NUM] = {
	[MT6855_I2S0_MCK] = {
...
{
	struct mt6855_afe_private *afe_priv = afe->platform_priv;
	int apll = mt6855_get_apll_by_rate(afe, rate);
	int apll_clk_id = apll == MT6855_APLL1 ?
			  CLK_TOP_MUX_AUD_1 : CLK_TOP_MUX_AUD_2;
	int m_sel_id = 0;
	int div_clk_id = 0;
	int ret;

	if (mck_id >= 0 && mck_id < MT6855_MCK_NUM) {
