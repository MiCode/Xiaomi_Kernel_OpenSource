...
int et7480_rust_detection_init(struct charger_device *chgdev)
{
	...
	regmap_write(et_priv->regmap, ET7480_FUNCTION_ENABLE, (0x40 | reg_val_enable)); //检测范围10K~2560k
	regmap_write(et_priv->regmap, ET7480_RES_DET_THRESHOLD, 0x1E); //中断阈值300K
