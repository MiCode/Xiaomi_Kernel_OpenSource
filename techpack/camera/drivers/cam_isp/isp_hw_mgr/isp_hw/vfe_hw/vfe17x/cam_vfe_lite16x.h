...
static struct cam_irq_controller_reg_info vfe16x_top_irq_reg_info = {
	.num_registers = 2,
	.irq_reg_set = vfe16x_top_irq_reg_set,
	.global_clear_offset  = 0x00000058,
	.global_clear_bitmask = 0x00000001,
};

static struct cam_vfe_top_ver2_reg_offset_common vfe16x_top_common_reg = {
...
static struct cam_vfe_rdi_ver2_reg vfe16x_rdi_reg = {
	.reg_update_cmd           = 0x000004AC,
};

static struct cam_vfe_rdi_common_reg_data vfe16x_rdi_reg_data = {
...
static struct cam_vfe_top_ver2_hw_info vfe16x_top_hw_info = {
	.common_reg = &vfe16x_top_common_reg,
	.camif_hw_info = {
		.common_reg = NULL,
		.camif_reg  = NULL,
		.reg_data   = NULL,
	...
	.rdi_hw_info = {
		.common_reg = &vfe16x_top_common_reg,
		.rdi_reg    = &vfe16x_rdi_reg,
		.common_reg_data = &vfe16x_rdi_reg_data,
		.reg_data = {
			&vfe16x_rdi_0_data,
			&vfe16x_rdi_1_data,
			&vfe16x_rdi_2_data,
		...
		.rdi_irq_status  = &vfe16x_rdi_irq_status,
		},
	.num_mux = 4,
	.mux_type = {
		CAM_VFE_RDI_VER_1_0,
...
static struct cam_irq_register_set vfe16x_bus_irq_reg[3] = {
		{
...
static struct cam_vfe_bus_ver2_hw_info vfe16x_bus_hw_info = {
	.common_reg = {
		...
		.irq_reg_info = {
			.num_registers        = 3,
			.irq_reg_set          = vfe16x_bus_irq_reg,
...
static struct cam_vfe_hw_info cam_vfe_lite16x_hw_info = {
	.irq_reg_info                  = &vfe16x_top_irq_reg_info,

	.bus_version                   = CAM_VFE_BUS_VER_2_0,
	.bus_hw_info                   = &vfe16x_bus_hw_info,

	.top_version                   = CAM_VFE_TOP_VER_2_0,
	.top_hw_info                   = &vfe16x_top_hw_info,
