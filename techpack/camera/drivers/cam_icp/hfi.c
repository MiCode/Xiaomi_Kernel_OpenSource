	...
	void __iomem *icp_base, bool debug)
{
	...
	/*cam_io_w_mb((uint32_t)hfi_mem->io_mem_discard.iova,
		icp_base + HFI_REG_IO_REGION_DISCARD_IOVA);
	cam_io_w_mb((uint32_t)hfi_mem->io_mem_discard.len,
		icp_base + HFI_REG_IO_REGION_DISCARD_SIZE);*/
