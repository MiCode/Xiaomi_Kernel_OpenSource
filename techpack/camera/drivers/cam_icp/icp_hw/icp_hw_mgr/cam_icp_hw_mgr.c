...
static int cam_icp_get_io_mem_info(void)
{
	int rc;
	size_t len;
	dma_addr_t iova, discard_iova_start, discard_iova_end;

	rc = cam_smmu_get_io_region_info(icp_hw_mgr.iommu_hdl,
		&iova, &len, &discard_iova_start, &discard_iova_end);
	if (rc)
		return rc;
	...
	icp_hw_mgr.hfi_mem.io_mem.discard_iova_end = discard_iova_end;

	CAM_DBG(CAM_ICP, "iova: %llx, len: %zu discard %llx to %llx",
		iova, len, discard_iova_start, discard_iova_end);
...
static int cam_icp_mgr_hfi_resume(struct cam_icp_hw_mgr *hw_mgr)
{
	...
	/*hfi_mem.io_mem_discard.iova =
		icp_hw_mgr.hfi_mem.io_mem.discard_iova_start;
	hfi_mem.io_mem_discard.len =
		icp_hw_mgr.hfi_mem.io_mem.discard_iova_end -
		icp_hw_mgr.hfi_mem.io_mem.discard_iova_start;*/
