...
exit:
	...
	mutex_unlock(&panel->panel_lock);
	DISP_UTC_INFO("DSI_CMD_SET_NOLP\n");
	return rc;
}
...
int dsi_panel_switch(struct dsi_panel *panel)
{
	...
	mutex_unlock(&panel->panel_lock);
	DISP_UTC_INFO("DSI_CMD_SET_TIMING_SWITCH\n");
	return rc;
}
