	...
	if(pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)
	{
		switch(ElementID)
		{
			case ODM_H2C_RA_PARA_ADJUST:
					...
					FillH2CCmd(Adapter, H2C_RA_PARA_ADJUST, CmdLen, pCmdBuffer);
				#else
					#if((RTL8812A_SUPPORT==1) ||(RTL8821A_SUPPORT==1))
					FillH2CCmd_8812(Adapter, H2C_8812_RA_PARA_ADJUST, CmdLen, pCmdBuffer);
					#endif
				#endif
					break;
	...
	else if(pDM_Odm->SupportICType == ODM_RTL8192E)
	{
		switch(ElementID)
		{
			case ODM_H2C_RA_PARA_ADJUST:
					...
					FillH2CCmd_8192E(Adapter, H2C_8192E_RA_PARA_ADJUST, CmdLen, pCmdBuffer);
					#endif
				#endif
					break;
	...
	else if(pDM_Odm->SupportICType == ODM_RTL8723B)
	{
		switch(ElementID)
		{
			...
			case ODM_H2C_RA_PARA_ADJUST:
				...
				#else
					#if(RTL8723B_SUPPORT==1)
					FillH2CCmd8723B(Adapter, H2C_8723B_RA_PARA_ADJUST, CmdLen, pCmdBuffer);
					#endif
				#endif
					break;
